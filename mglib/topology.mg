...
- prove singleton_basis X c= Power X.
  let s. assume Hs.
  claim Hex : exists x :e X, s = {x,x}.
  { exact (ReplE X (fun x0 : set => {x0,x0}) s Hs). }
  let x. assume Hpair.
  claim HxX : x :e X.
  { exact (andEL (x :e X) (s = {x,x}) Hpair). }
  claim Hseq : s = {x,x}.
  { exact (andER (x :e X) (s = {x,x}) Hpair). }
  rewrite Hseq.
  apply PowerI.
  let y. assume Hy.
...
- apply andI.
  ...
  + prove forall b1 :e singleton_basis X, forall b2 :e singleton_basis X, forall x:set,
    ...
    let b1 b2 x. assume Hb1 Hb2 Hx1 Hx2.
    claim Hex1 : exists x1 :e X, b1 = {x1,x1}.
    { exact (ReplE X (fun x0 : set => {x0,x0}) b1 Hb1). }
    claim Hex2 : exists x2 :e X, b2 = {x2,x2}.
    { exact (ReplE X (fun x0 : set => {x0,x0}) b2 Hb2). }
    let x1. assume Hpair1.
    let x2. assume Hpair2.
    claim Hx1X : x1 :e X.
    { exact (andEL (x1 :e X) (b1 = {x1,x1}) Hpair1). }
    claim Hx2X : x2 :e X.
    { exact (andEL (x2 :e X) (b2 = {x2,x2}) Hpair2). }
    claim Hb1eq : b1 = {x1,x1}.
    { exact (andER (x1 :e X) (b1 = {x1,x1}) Hpair1). }
    claim Hb2eq : b2 = {x2,x2}.
    { exact (andER (x2 :e X) (b2 = {x2,x2}) Hpair2). }
    ...
    * apply andI.
      ...
      { prove {x,x} c= b1 :/\: b2.
        ...
        - assume Hyx. rewrite Hyx.
          apply andI.
          { rewrite Hb1eq. apply UPairI1. }
          { rewrite Hb2eq. apply UPairI1. }
        - assume Hyx. rewrite Hyx.
          apply andI.
          { rewrite Hb1eq. apply UPairI1. }
          { rewrite Hb2eq. apply UPairI1. } } }
