...
(** auxiliary aliases for existing example topologies **)
...
(** from §13: basis property used to show openness **)
...
(** from §13: open set equals union of basis elements contained in it **)
