...
prove (((generated_topology X B c= Power X /\ Empty :e generated_topology X B) /\ X :e generated_topology X B) /\ (forall UFam :e Power (generated_topology X B), Union UFam :e generated_topology X B)) /\ (forall U :e generated_topology X B, forall V :e generated_topology X B, U :/\: V :e generated_topology X B).
apply andI.
- prove (generated_topology X B c= Power X /\ Empty :e generated_topology X B) /\ X :e generated_topology X B /\ (forall UFam :e Power (generated_topology X B), Union UFam :e generated_topology X B).
  ...
  * prove X :e generated_topology X B /\ (forall UFam :e Power (generated_topology X B), Union UFam :e generated_topology X B).
    apply andI.
