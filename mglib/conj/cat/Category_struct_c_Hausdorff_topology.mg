...
Definition struct_c_Hausdorff_topology : set -> prop
 := fun X => struct_c X
      /\ unpack_c_o X
          (fun X' Open => 
	        Open (fun x => x :e X') 
	     ...
	     /\ (forall a b :e X', a <> b -> exists U V:set -> prop, 
	     Open U /\ Open V /\ U a /\ V b /\ (forall x, U x -> ~V x))).

Theorem MetaCat_struct_c_Hausdorff_topology: MetaCat struct_c_Hausdorff_topology Hom_struct_c struct_id struct_comp.
claim L1: forall X, struct_c_Hausdorff_topology X -> struct_c X.
{ let X. assume HX. apply HX. assume H _. exact H. }
exact MetaCat_struct_c_gen struct_c_Hausdorff_topology L1.
Qed.

Theorem MetaCat_struct_c_Hausdorff_topology_Forgetful: MetaFunctor struct_c_Hausdorff_topology Hom_struct_c
...
claim L1: forall X, struct_c_Hausdorff_topology X -> struct_c X.
{ let X. assume HX. apply HX. assume H _. exact H. }
exact MetaCat_struct_c_Forgetful_gen struct_c_Hausdorff_topology L1.
Qed.

Proposition MetaCat_struct_c_Hausdorff_topology_initial: exists Y:set, exists uniqa:set -> set,
  initial_p struct_c_Hausdorff_topology Hom_struct_c struct_id struct_comp Y uniqa.
Admitted.

Proposition MetaCat_struct_c_Hausdorff_topology_terminal: exists Y:set, exists uniqa:set -> set,
  terminal_p struct_c_Hausdorff_topology Hom_struct_c struct_id struct_comp Y uniqa.
Admitted.
...
Proposition MetaCat_struct_c_Hausdorff_topology_coproduct_constr:
  ...
  coproduct_constr_p struct_c_Hausdorff_topology Hom_struct_c struct_id struct_comp coprod i0 i1 copair.
Admitted.
...
Proposition MetaCat_struct_c_Hausdorff_topology_product_constr:
  ...
  product_constr_p struct_c_Hausdorff_topology Hom_struct_c struct_id struct_comp prod pi0 pi1 pair.
Admitted.
...
Proposition MetaCat_struct_c_Hausdorff_topology_coequalizer_constr:
  ...
  coequalizer_constr_p struct_c_Hausdorff_topology Hom_struct_c struct_id struct_comp quot canonmap fac.
Admitted.
...
Proposition MetaCat_struct_c_Hausdorff_topology_equalizer_constr:
  ...
  exists canonmap:set -> set -> set -> set -> set,
  exists fac:set -> set -> set -> set -> set -> set -> set,
  equalizer_constr_p struct_c_Hausdorff_topology Hom_struct_c struct_id struct_comp quot canonmap fac.
Admitted.
...
Proposition MetaCat_struct_c_Hausdorff_topology_pushout_constr:
  ...
  pushout_constr_p struct_c_Hausdorff_topology Hom_struct_c struct_id struct_comp po i0 i1 copair.
Admitted.
...
Proposition MetaCat_struct_c_Hausdorff_topology_pullback_constr:
  ...
  pullback_constr_p struct_c_Hausdorff_topology Hom_struct_c struct_id struct_comp pb pi0 pi1 pair.
Admitted.
...
Proposition MetaCat_struct_c_Hausdorff_topology_product_exponent:
  ...
  product_exponent_constr_p struct_c_Hausdorff_topology Hom_struct_c struct_id struct_comp prod pi0 pi1 pair exp a lm.
Admitted.
...
Proposition MetaCat_struct_c_Hausdorff_topology_subobject_classifier:
  ...
  subobject_classifier_p struct_c_Hausdorff_topology Hom_struct_c struct_id struct_comp one uniqa Omega tru ch constr.
Admitted.
...
Proposition MetaCat_struct_c_Hausdorff_topology_nno:
  ...
  nno_p struct_c_Hausdorff_topology Hom_struct_c struct_id struct_comp one uniqa N zer suc rec.
Admitted.
...
Proposition MetaCat_struct_c_Hausdorff_topology_left_adjoint_forgetful:
  ...
  MetaAdjunction_strict
       (fun _ => True) SetHom
       (fun X => (lam_id X)) (fun X Y Z f g => (lam_comp X f g))
       struct_c_Hausdorff_topology Hom_struct_c struct_id struct_comp
