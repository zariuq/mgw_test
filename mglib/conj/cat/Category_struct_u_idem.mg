...
Definition struct_u_idem : set -> prop
 := fun X => struct_u X /\ unpack_u_o X (fun X' h => forall x :e X', h (h x) = h x).

Theorem MetaCat_struct_u_idem: MetaCat struct_u_idem Hom_struct_u struct_id struct_comp.
claim L1: forall X, struct_u_idem X -> struct_u X.
{ let X. assume HX. apply HX. assume H _. exact H. }
exact MetaCat_struct_u_gen struct_u_idem L1.
Qed.

Theorem MetaCat_struct_u_idem_Forgetful: MetaFunctor struct_u_idem Hom_struct_u
...
claim L1: forall X, struct_u_idem X -> struct_u X.
{ let X. assume HX. apply HX. assume H _. exact H. }
exact MetaCat_struct_u_Forgetful_gen struct_u_idem L1.
Qed.

Proposition MetaCat_struct_u_idem_initial: exists Y:set, exists uniqa:set -> set,
  initial_p struct_u_idem Hom_struct_u struct_id struct_comp Y uniqa.
Admitted.

Proposition MetaCat_struct_u_idem_terminal: exists Y:set, exists uniqa:set -> set,
  terminal_p struct_u_idem Hom_struct_u struct_id struct_comp Y uniqa.
Admitted.
...
Proposition MetaCat_struct_u_idem_coproduct_constr:
  ...
  coproduct_constr_p struct_u_idem Hom_struct_u struct_id struct_comp coprod i0 i1 copair.
Admitted.
...
Proposition MetaCat_struct_u_idem_product_constr:
  ...
  product_constr_p struct_u_idem Hom_struct_u struct_id struct_comp prod pi0 pi1 pair.
Admitted.
...
Proposition MetaCat_struct_u_idem_coequalizer_constr:
  ...
  coequalizer_constr_p struct_u_idem Hom_struct_u struct_id struct_comp quot canonmap fac.
Admitted.
...
Proposition MetaCat_struct_u_idem_equalizer_constr:
  ...
  exists canonmap:set -> set -> set -> set -> set,
  exists fac:set -> set -> set -> set -> set -> set -> set,
  equalizer_constr_p struct_u_idem Hom_struct_u struct_id struct_comp quot canonmap fac.
Admitted.
...
Proposition MetaCat_struct_u_idem_pushout_constr:
  ...
  pushout_constr_p struct_u_idem Hom_struct_u struct_id struct_comp po i0 i1 copair.
Admitted.
...
Proposition MetaCat_struct_u_idem_pullback_constr:
  ...
  pullback_constr_p struct_u_idem Hom_struct_u struct_id struct_comp pb pi0 pi1 pair.
Admitted.
...
Proposition MetaCat_struct_u_idem_product_exponent:
  ...
  product_exponent_constr_p struct_u_idem Hom_struct_u struct_id struct_comp prod pi0 pi1 pair exp a lm.
Admitted.
...
Proposition MetaCat_struct_u_idem_subobject_classifier:
  ...
  subobject_classifier_p struct_u_idem Hom_struct_u struct_id struct_comp one uniqa Omega tru ch constr.
Admitted.
...
Proposition MetaCat_struct_u_idem_nno:
  ...
  nno_p struct_u_idem Hom_struct_u struct_id struct_comp one uniqa N zer suc rec.
Admitted.
...
Proposition MetaCat_struct_u_idem_left_adjoint_forgetful:
  ...
  MetaAdjunction_strict
       (fun _ => True) SetHom
       (fun X => (lam_id X)) (fun X Y Z f g => (lam_comp X f g))
       struct_u_idem Hom_struct_u struct_id struct_comp
