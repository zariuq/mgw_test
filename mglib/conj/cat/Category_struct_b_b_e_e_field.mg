...
Theorem MetaCat_struct_b_b_e_e_field: MetaCat Field Hom_struct_b_b_e_e struct_id struct_comp.
claim L1: forall X, Field X -> struct_b_b_e_e X.
{ let X. assume HX. apply HX. assume H _. exact H. }
exact MetaCat_struct_b_b_e_e_gen Field L1.
Qed.

Theorem MetaCat_struct_b_b_e_e_field_Forgetful: MetaFunctor Field Hom_struct_b_b_e_e
...
claim L1: forall X, Field X -> struct_b_b_e_e X.
{ let X. assume HX. apply HX. assume H _. exact H. }
exact MetaCat_struct_b_b_e_e_Forgetful_gen Field L1.
Qed.

Proposition MetaCat_struct_b_b_e_e_field_initial: exists Y:set, exists uniqa:set -> set,
  initial_p Field Hom_struct_b_b_e_e struct_id struct_comp Y uniqa.
Admitted.

Proposition MetaCat_struct_b_b_e_e_field_terminal: exists Y:set, exists uniqa:set -> set,
  terminal_p Field Hom_struct_b_b_e_e struct_id struct_comp Y uniqa.
Admitted.
...
Proposition MetaCat_struct_b_b_e_e_field_coproduct_constr:
  ...
  coproduct_constr_p Field Hom_struct_b_b_e_e struct_id struct_comp coprod i0 i1 copair.
Admitted.
...
Proposition MetaCat_struct_b_b_e_e_field_product_constr:
  ...
  product_constr_p Field Hom_struct_b_b_e_e struct_id struct_comp prod pi0 pi1 pair.
Admitted.
...
Proposition MetaCat_struct_b_b_e_e_field_coequalizer_constr:
  ...
  coequalizer_constr_p Field Hom_struct_b_b_e_e struct_id struct_comp quot canonmap fac.
Admitted.
...
Proposition MetaCat_struct_b_b_e_e_field_equalizer_constr:
  ...
  exists canonmap:set -> set -> set -> set -> set,
  exists fac:set -> set -> set -> set -> set -> set -> set,
  equalizer_constr_p Field Hom_struct_b_b_e_e struct_id struct_comp quot canonmap fac.
Admitted.
...
Proposition MetaCat_struct_b_b_e_e_field_pushout_constr:
  ...
  pushout_constr_p Field Hom_struct_b_b_e_e struct_id struct_comp po i0 i1 copair.
Admitted.
...
Proposition MetaCat_struct_b_b_e_e_field_pullback_constr:
  ...
  pullback_constr_p Field Hom_struct_b_b_e_e struct_id struct_comp pb pi0 pi1 pair.
Admitted.
...
Proposition MetaCat_struct_b_b_e_e_field_product_exponent:
  ...
  product_exponent_constr_p Field Hom_struct_b_b_e_e struct_id struct_comp prod pi0 pi1 pair exp a lm.
Admitted.
...
Proposition MetaCat_struct_b_b_e_e_field_subobject_classifier:
  ...
  subobject_classifier_p Field Hom_struct_b_b_e_e struct_id struct_comp one uniqa Omega tru ch constr.
Admitted.
...
Proposition MetaCat_struct_b_b_e_e_field_nno:
  ...
  nno_p Field Hom_struct_b_b_e_e struct_id struct_comp one uniqa N zer suc rec.
Admitted.
...
Proposition MetaCat_struct_b_b_e_e_field_left_adjoint_forgetful:
  ...
  MetaAdjunction_strict
       (fun _ => True) SetHom
       (fun X => (lam_id X)) (fun X Y Z f g => (lam_comp X f g))
       Field Hom_struct_b_b_e_e struct_id struct_comp
