...
Proposition MetaCat_struct_u_initial: exists Y:set, exists uniqa:set -> set,
  initial_p struct_u Hom_struct_u struct_id struct_comp Y uniqa.
Admitted.

Proposition MetaCat_struct_u_terminal: exists Y:set, exists uniqa:set -> set,
  terminal_p struct_u Hom_struct_u struct_id struct_comp Y uniqa.
Admitted.
...
Proposition MetaCat_struct_u_coproduct_constr:
  ...
  coproduct_constr_p struct_u Hom_struct_u struct_id struct_comp coprod i0 i1 copair.
Admitted.
...
Proposition MetaCat_struct_u_product_constr:
  ...
  product_constr_p struct_u Hom_struct_u struct_id struct_comp prod pi0 pi1 pair.
Admitted.
...
Proposition MetaCat_struct_u_coequalizer_constr:
  ...
  coequalizer_constr_p struct_u Hom_struct_u struct_id struct_comp quot canonmap fac.
Admitted.
...
Proposition MetaCat_struct_u_equalizer_constr:
  ...
  exists canonmap:set -> set -> set -> set -> set,
  exists fac:set -> set -> set -> set -> set -> set -> set,
  equalizer_constr_p struct_u Hom_struct_u struct_id struct_comp quot canonmap fac.
Admitted.
...
Proposition MetaCat_struct_u_pushout_constr:
  ...
  pushout_constr_p struct_u Hom_struct_u struct_id struct_comp po i0 i1 copair.
Admitted.
...
Proposition MetaCat_struct_u_pullback_constr:
  ...
  pullback_constr_p struct_u Hom_struct_u struct_id struct_comp pb pi0 pi1 pair.
Admitted.
...
Proposition MetaCat_struct_u_product_exponent:
  ...
  product_exponent_constr_p struct_u Hom_struct_u struct_id struct_comp prod pi0 pi1 pair exp a lm.
Admitted.
...
Proposition MetaCat_struct_u_subobject_classifier:
  ...
  subobject_classifier_p struct_u Hom_struct_u struct_id struct_comp one uniqa Omega tru ch constr.
Admitted.
...
Proposition MetaCat_struct_u_nno:
  ...
  nno_p struct_u Hom_struct_u struct_id struct_comp one uniqa N zer suc rec.
Admitted.
...
Proposition MetaCat_struct_u_left_adjoint_forgetful:
  ...
  MetaAdjunction_strict
       (fun _ => True) SetHom
       (fun X => (lam_id X)) (fun X Y Z f g => (lam_comp X f g))
       struct_u Hom_struct_u struct_id struct_comp
