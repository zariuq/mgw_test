...
Definition struct_r_wellord : set -> prop
 := fun X => struct_r X 
     /\ unpack_r_o X
          (fun X' r => 
	        (forall x :e X', ~r x x)
	     ...
	     /\ (forall p:set -> prop, (forall y :e X', (forall x :e X', r x y -> p x) -> p y) -> forall x :e X', p x)).

Theorem MetaCat_struct_r_wellord: MetaCat struct_r_wellord Hom_struct_r struct_id struct_comp.
claim L1: forall X, struct_r_wellord X -> struct_r X.
{ let X. assume HX. apply HX. assume H _. exact H. }
exact MetaCat_struct_r_gen struct_r_wellord L1.
Qed.

Theorem MetaCat_struct_r_wellord_Forgetful: MetaFunctor struct_r_wellord Hom_struct_r
...
claim L1: forall X, struct_r_wellord X -> struct_r X.
{ let X. assume HX. apply HX. assume H _. exact H. }
exact MetaCat_struct_r_Forgetful_gen struct_r_wellord L1.
Qed.

Proposition MetaCat_struct_r_wellord_initial: exists Y:set, exists uniqa:set -> set,
  initial_p struct_r_wellord Hom_struct_r struct_id struct_comp Y uniqa.
Admitted.

Proposition MetaCat_struct_r_wellord_terminal: exists Y:set, exists uniqa:set -> set,
  terminal_p struct_r_wellord Hom_struct_r struct_id struct_comp Y uniqa.
Admitted.
...
Proposition MetaCat_struct_r_wellord_coproduct_constr:
  ...
  coproduct_constr_p struct_r_wellord Hom_struct_r struct_id struct_comp coprod i0 i1 copair.
Admitted.
...
Proposition MetaCat_struct_r_wellord_product_constr:
  ...
  product_constr_p struct_r_wellord Hom_struct_r struct_id struct_comp prod pi0 pi1 pair.
Admitted.
...
Proposition MetaCat_struct_r_wellord_coequalizer_constr:
  ...
  coequalizer_constr_p struct_r_wellord Hom_struct_r struct_id struct_comp quot canonmap fac.
Admitted.
...
Proposition MetaCat_struct_r_wellord_equalizer_constr:
  ...
  exists canonmap:set -> set -> set -> set -> set,
  exists fac:set -> set -> set -> set -> set -> set -> set,
  equalizer_constr_p struct_r_wellord Hom_struct_r struct_id struct_comp quot canonmap fac.
Admitted.
...
Proposition MetaCat_struct_r_wellord_pushout_constr:
  ...
  pushout_constr_p struct_r_wellord Hom_struct_r struct_id struct_comp po i0 i1 copair.
Admitted.
...
Proposition MetaCat_struct_r_wellord_pullback_constr:
  ...
  pullback_constr_p struct_r_wellord Hom_struct_r struct_id struct_comp pb pi0 pi1 pair.
Admitted.
...
Proposition MetaCat_struct_r_wellord_product_exponent:
  ...
  product_exponent_constr_p struct_r_wellord Hom_struct_r struct_id struct_comp prod pi0 pi1 pair exp a lm.
Admitted.
...
Proposition MetaCat_struct_r_wellord_subobject_classifier:
  ...
  subobject_classifier_p struct_r_wellord Hom_struct_r struct_id struct_comp one uniqa Omega tru ch constr.
Admitted.
...
Proposition MetaCat_struct_r_wellord_nno:
  ...
  nno_p struct_r_wellord Hom_struct_r struct_id struct_comp one uniqa N zer suc rec.
Admitted.
...
Proposition MetaCat_struct_r_wellord_left_adjoint_forgetful:
  ...
  MetaAdjunction_strict
       (fun _ => True) SetHom
       (fun X => (lam_id X)) (fun X Y Z f g => (lam_comp X f g))
       struct_r_wellord Hom_struct_r struct_id struct_comp
