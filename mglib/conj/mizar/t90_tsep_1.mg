...
Theorem t90_tsep_1:
 ...
 forall k4_subset_1:set -> set -> set -> set,
  ...
  -> (forall X5 X6 X3 X4 X1 X2, (v2_struct_0 X2 -> False) -> (r2_tsep_1 X2 X5 X6 -> False) -> (k4_subset_1 (u1_struct_0 X2) X5 X6) = (u1_struct_0 X2) -> (k4_subset_1 (u1_struct_0 X2) X5 X6) = (k4_subset_1 (u1_struct_0 X2) (k4_subset_1 (u1_struct_0 X2) X1 X3) X4) -> v2_pre_topc X2 -> l1_pre_topc X2 -> v3_pre_topc X3 X2 -> v3_pre_topc X1 X2 -> v4_pre_topc X4 X2 -> r1_tarski X3 X6 -> r1_tarski X1 X5 -> m1_subset_1 X6 (k1_zfmisc_1 (u1_struct_0 X2)) -> m1_subset_1 X5 (k1_zfmisc_1 (u1_struct_0 X2)) -> m1_subset_1 X4 (k1_zfmisc_1 (u1_struct_0 X2)) -> m1_subset_1 X3 (k1_zfmisc_1 (u1_struct_0 X2)) -> m1_subset_1 X1 (k1_zfmisc_1 (u1_struct_0 X2)) -> r1_tarski X4 (k9_subset_1 (u1_struct_0 X2) X5 X6) -> False)
  ...
  -> (forall X2 X1 X3, (v2_struct_0 X3 -> False) -> (v2_struct_0 X2 -> False) -> (v2_struct_0 X1 -> False) -> (k1_tsep_1 esk1_0 (k1_tsep_1 esk1_0 X2 X3) X1) = esk1_0 -> m1_pre_topc X3 esk1_0 -> m1_pre_topc X3 esk3_0 -> m1_pre_topc X2 esk1_0 -> m1_pre_topc X2 esk2_0 -> m1_pre_topc X1 esk1_0 -> v1_tsep_1 X3 esk1_0 -> v1_tsep_1 X2 esk1_0 -> v1_borsuk_1 X1 esk1_0 -> r4_tsep_1 esk1_0 esk2_0 esk3_0 -> m1_pre_topc X1 (k2_tsep_1 esk1_0 esk2_0 esk3_0) -> False)
  ...
  -> (forall X2 X3 X1, (v2_struct_0 X1 -> False) -> (r1_tarski X3 X2 -> False) -> (r1_tarski X2 X3 -> False) -> (v3_pre_topc (esk44_3 X1 X2 X3) X1 -> False) -> (k4_subset_1 (u1_struct_0 X1) X2 X3) = (u1_struct_0 X1) -> v2_pre_topc X1 -> l1_pre_topc X1 -> r2_tsep_1 X1 X2 X3 -> m1_subset_1 X3 (k1_zfmisc_1 (u1_struct_0 X1)) -> m1_subset_1 X2 (k1_zfmisc_1 (u1_struct_0 X1)) -> False)
  -> (forall X2 X3 X1, (v2_struct_0 X1 -> False) -> (r1_tarski X3 X2 -> False) -> (r1_tarski X2 X3 -> False) -> (v3_pre_topc (esk43_3 X1 X2 X3) X1 -> False) -> (k4_subset_1 (u1_struct_0 X1) X2 X3) = (u1_struct_0 X1) -> v2_pre_topc X1 -> l1_pre_topc X1 -> r2_tsep_1 X1 X2 X3 -> m1_subset_1 X3 (k1_zfmisc_1 (u1_struct_0 X1)) -> m1_subset_1 X2 (k1_zfmisc_1 (u1_struct_0 X1)) -> False)
  ...
  -> (forall X2 X3 X1, (v2_struct_0 X1 -> False) -> (v4_pre_topc (esk42_3 X1 X2 X3) X1 -> False) -> (k4_subset_1 (u1_struct_0 X1) X2 X3) = (u1_struct_0 X1) -> v2_pre_topc X1 -> l1_pre_topc X1 -> r2_tsep_1 X1 X2 X3 -> m1_subset_1 X3 (k1_zfmisc_1 (u1_struct_0 X1)) -> m1_subset_1 X2 (k1_zfmisc_1 (u1_struct_0 X1)) -> False)
  -> (forall X2 X3 X1, (v2_struct_0 X1 -> False) -> (v3_pre_topc (esk41_3 X1 X2 X3) X1 -> False) -> (k4_subset_1 (u1_struct_0 X1) X2 X3) = (u1_struct_0 X1) -> v2_pre_topc X1 -> l1_pre_topc X1 -> r2_tsep_1 X1 X2 X3 -> m1_subset_1 X3 (k1_zfmisc_1 (u1_struct_0 X1)) -> m1_subset_1 X2 (k1_zfmisc_1 (u1_struct_0 X1)) -> False)
  -> (forall X2 X3 X1, (v2_struct_0 X1 -> False) -> (v3_pre_topc (esk40_3 X1 X2 X3) X1 -> False) -> (k4_subset_1 (u1_struct_0 X1) X2 X3) = (u1_struct_0 X1) -> v2_pre_topc X1 -> l1_pre_topc X1 -> r2_tsep_1 X1 X2 X3 -> m1_subset_1 X3 (k1_zfmisc_1 (u1_struct_0 X1)) -> m1_subset_1 X2 (k1_zfmisc_1 (u1_struct_0 X1)) -> False)
  ...
  -> (forall X1 X2, (v2_struct_0 X2 -> False) -> (v2_struct_0 X1 -> False) -> (k1_tsep_1 esk1_0 X1 X2) = esk1_0 -> m1_pre_topc X2 esk1_0 -> m1_pre_topc X2 esk3_0 -> m1_pre_topc X1 esk1_0 -> m1_pre_topc X1 esk2_0 -> v1_tsep_1 X2 esk1_0 -> v1_tsep_1 X1 esk1_0 -> r4_tsep_1 esk1_0 esk2_0 esk3_0 -> False)
  ...
  -> (((k1_tsep_1 esk1_0 esk4_0 esk5_0) = esk1_0 -> False) -> (m1_pre_topc esk2_0 esk3_0 -> False) -> (m1_pre_topc esk3_0 esk2_0 -> False) -> (v1_borsuk_1 esk6_0 esk1_0 -> False) -> (r4_tsep_1 esk1_0 esk2_0 esk3_0 -> False) -> False)
  ...
  -> ((m1_pre_topc esk2_0 esk3_0 -> False) -> (m1_pre_topc esk3_0 esk2_0 -> False) -> (v1_tsep_1 esk5_0 esk1_0 -> False) -> (r4_tsep_1 esk1_0 esk2_0 esk3_0 -> False) -> False)
  -> ((m1_pre_topc esk2_0 esk3_0 -> False) -> (m1_pre_topc esk3_0 esk2_0 -> False) -> (v1_tsep_1 esk4_0 esk1_0 -> False) -> (r4_tsep_1 esk1_0 esk2_0 esk3_0 -> False) -> False)
