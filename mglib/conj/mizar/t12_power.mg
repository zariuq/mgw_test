...
Theorem t12_power:
 ...
 forall k3_prepower:set -> set -> set,
 forall k10_real_1:set -> set -> set,
 forall np__1:set,
 forall k2_prepower:set -> set -> set,
     (forall X2 X1, ((k3_prepower X2 (k10_real_1 np__1 X1)) = (k10_real_1 np__1 (k2_prepower X2 X1)) -> False) -> (r1_xxreal_0 X1 k6_numbers -> False) -> v1_xreal_0 X1 -> r1_xxreal_0 np__1 X2 -> m2_subset_1 X2 k1_numbers k5_numbers -> False)
  ...
  -> (forall X2 X1, (m1_subset_1 (k3_prepower X1 X2) k1_numbers -> False) -> m1_subset_1 X2 k1_numbers -> m1_subset_1 X1 k5_numbers -> False)
  ...
  -> (forall X2 X1, ((k3_prepower X1 X2) = (k2_prepower X1 X2) -> False) -> m1_subset_1 X2 k1_numbers -> m1_subset_1 X1 k5_numbers -> False)
  ...
  -> (forall X2 X1, ((k4_xcmplx_0 (k7_xcmplx_0 X1 X2)) = (k7_xcmplx_0 X1 (k4_xcmplx_0 X2)) -> False) -> v1_xcmplx_0 X2 -> v1_xcmplx_0 X1 -> False)
  ...
  -> (forall X1, (r1_xxreal_0 k6_numbers X1 -> False) -> v1_xreal_0 X1 -> r1_xxreal_0 (k4_xcmplx_0 X1) k6_numbers -> False)
  ...
  -> (forall X1, (r1_xxreal_0 (k4_xcmplx_0 X1) k6_numbers -> False) -> v1_xreal_0 X1 -> r1_xxreal_0 k6_numbers X1 -> False)
  ...
  -> (v1_abian esk2_0 -> r1_xxreal_0 esk1_0 k6_numbers -> False)
  ...
  -> (esk1_0 = k6_numbers -> r1_xxreal_0 esk1_0 k6_numbers -> False)
  ...
  -> ((r1_xxreal_0 np__1 esk2_0 -> False) -> v1_abian esk2_0 -> False)
  -> (forall X1, v7_ordinal1 X1 -> v3_xxreal_0 X1 -> False)
  -> ((r1_xxreal_0 np__1 esk2_0 -> False) -> esk1_0 = k6_numbers -> False)
  ...
  -> ((k10_real_1 np__1 (k1_power esk2_0 esk1_0)) = (k2_power esk2_0 (k10_real_1 np__1 esk1_0)) -> False)
