...
Theorem t25_diff_3:
 ...
 forall k6_xcmplx_0:set -> set -> set,
     (forall X1 X3 X6 X4 X5 X2, ((k1_funct_1 (k46_valued_1 X4 X1 X2 X3 X5) X6) = (k6_xcmplx_0 (k1_funct_1 X3 X6) (k1_funct_1 X5 X6)) -> False) -> (v1_xboole_0 X2 -> False) -> (v1_xboole_0 X1 -> False) -> v1_funct_1 X5 -> v1_funct_1 X3 -> v1_membered X2 -> v1_membered X1 -> m1_subset_1 X6 X4 -> v1_funct_2 X5 X4 X2 -> v1_funct_2 X3 X4 X1 -> m1_subset_1 X5 (k1_zfmisc_1 (k2_zfmisc_1 X4 X2)) -> m1_subset_1 X3 (k1_zfmisc_1 (k2_zfmisc_1 X4 X1)) -> False)
  ...
  -> ((k9_diff_1 (k47_valued_1 k1_numbers k1_numbers k1_numbers esk3_0 esk4_0) esk1_0 esk2_0) = (k9_real_1 (k9_diff_1 esk3_0 esk1_0 esk2_0) (k9_diff_1 esk4_0 esk1_0 esk2_0)) -> False)
