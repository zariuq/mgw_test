...
Theorem t20_radix_6:
 forall k10_radix_6:set -> set -> set -> set,
 forall esk5_4:set -> set -> set -> set -> set,
 forall k9_radix_6:set -> set -> set -> set,
 forall k8_radix_6:set -> set -> set -> set,
 ...
 forall np__2:set,
 forall r2_radix_6:set -> set -> set -> set -> prop,
 ...
 forall k8_radix_1:set -> set -> set -> set,
     (forall X1 X3 X4 X2, (r1_xxreal_0 (k8_radix_1 X1 X2 X4) (k8_radix_1 X1 X2 X3) -> False) -> v7_ordinal1 X2 -> v7_ordinal1 X1 -> v3_card_1 X4 X1 -> v3_card_1 X3 X1 -> r1_xxreal_0 np__1 X1 -> m2_finseq_1 X4 (k3_radix_1 X2) -> m2_finseq_1 X3 (k3_radix_1 X2) -> r1_xxreal_0 (k4_radix_1 (esk30_4 X1 X2 X3 X4) X2 X1 X4) (k4_radix_1 (esk30_4 X1 X2 X3 X4) X2 X1 X3) -> False)
  -> (forall X2 X4 X1 X3, (X4 = (k10_radix_6 X1 X2 X3) -> False) -> (k4_radix_1 (esk5_4 X1 X2 X3 X4) X3 X1 X4) = (k9_radix_6 (esk5_4 X1 X2 X3 X4) X2 X3) -> v7_ordinal1 X3 -> v7_ordinal1 X2 -> v7_ordinal1 X1 -> v3_card_1 X4 X1 -> m2_finseq_1 X4 (k3_radix_1 X3) -> False)
  -> (forall X2 X4 X1 X3, (r2_radix_6 X1 X2 X3 X4 -> False) -> (k4_radix_1 (esk6_4 X1 X2 X3 X4) X3 (k2_xcmplx_0 X2 np__2) X4) = k6_numbers -> v7_ordinal1 X3 -> v7_ordinal1 X2 -> v7_ordinal1 X1 -> m2_finseq_1 X4 (k3_radix_1 X3) -> v3_card_1 X4 (k2_xcmplx_0 X2 np__2) -> False)
  -> (forall X2 X4 X1 X3, (r2_radix_6 X1 X2 X3 X4 -> False) -> v7_ordinal1 X3 -> v7_ordinal1 X2 -> v7_ordinal1 X1 -> m2_finseq_1 X4 (k3_radix_1 X3) -> v3_card_1 X4 (k2_xcmplx_0 X2 np__2) -> r1_xxreal_0 (esk6_4 X1 X2 X3 X4) X1 -> False)
  -> (forall X1 X3 X4 X2, (r2_hidden (esk30_4 X1 X2 X3 X4) (k2_finseq_1 X1) -> False) -> (r1_xxreal_0 (k8_radix_1 X1 X2 X4) (k8_radix_1 X1 X2 X3) -> False) -> v7_ordinal1 X2 -> v7_ordinal1 X1 -> v3_card_1 X4 X1 -> v3_card_1 X3 X1 -> r1_xxreal_0 np__1 X1 -> m2_finseq_1 X4 (k3_radix_1 X2) -> m2_finseq_1 X3 (k3_radix_1 X2) -> False)
  -> (forall X1 X3 X4 X2, (v7_ordinal1 (esk30_4 X1 X2 X3 X4) -> False) -> (r1_xxreal_0 (k8_radix_1 X1 X2 X4) (k8_radix_1 X1 X2 X3) -> False) -> v7_ordinal1 X2 -> v7_ordinal1 X1 -> v3_card_1 X4 X1 -> v3_card_1 X3 X1 -> r1_xxreal_0 np__1 X1 -> m2_finseq_1 X4 (k3_radix_1 X2) -> m2_finseq_1 X3 (k3_radix_1 X2) -> False)
  -> (forall X2 X4 X1 X3, (r2_radix_6 X1 X2 X3 X4 -> False) -> (v7_ordinal1 (esk6_4 X1 X2 X3 X4) -> False) -> v7_ordinal1 X3 -> v7_ordinal1 X2 -> v7_ordinal1 X1 -> m2_finseq_1 X4 (k3_radix_1 X3) -> v3_card_1 X4 (k2_xcmplx_0 X2 np__2) -> False)
  -> (forall X1 X5 X4 X2 X3, ((k4_radix_1 X5 X3 (k2_xcmplx_0 X2 np__2) X4) = k6_numbers -> False) -> (r1_xxreal_0 X5 X1 -> False) -> v7_ordinal1 X5 -> v7_ordinal1 X3 -> v7_ordinal1 X2 -> v7_ordinal1 X1 -> m2_finseq_1 X4 (k3_radix_1 X3) -> r2_radix_6 X1 X2 X3 X4 -> v3_card_1 X4 (k2_xcmplx_0 X2 np__2) -> False)
  -> (forall X2 X4 X1 X3, (X4 = (k10_radix_6 X1 X2 X3) -> False) -> (r2_hidden (esk5_4 X1 X2 X3 X4) (k2_finseq_1 X1) -> False) -> v7_ordinal1 X3 -> v7_ordinal1 X2 -> v7_ordinal1 X1 -> v3_card_1 X4 X1 -> m2_finseq_1 X4 (k3_radix_1 X3) -> False)
  -> (forall X2 X4 X1 X3, (X4 = (k10_radix_6 X1 X2 X3) -> False) -> (v7_ordinal1 (esk5_4 X1 X2 X3 X4) -> False) -> v7_ordinal1 X3 -> v7_ordinal1 X2 -> v7_ordinal1 X1 -> v3_card_1 X4 X1 -> m2_finseq_1 X4 (k3_radix_1 X3) -> False)
  ...
  -> (forall X5 X4 X3 X2 X1, ((k4_radix_1 X5 X4 X2 X1) = (k9_radix_6 X5 X3 X4) -> False) -> X1 = (k10_radix_6 X2 X3 X4) -> v7_ordinal1 X5 -> v7_ordinal1 X4 -> v7_ordinal1 X3 -> v7_ordinal1 X2 -> v3_card_1 X1 X2 -> m2_finseq_1 X1 (k3_radix_1 X4) -> r2_hidden X5 (k2_finseq_1 X2) -> False)
  -> (forall X2 X4 X1 X3, ((k4_radix_1 X1 X3 X2 X4) = (k1_funct_1 X4 X1) -> False) -> v7_ordinal1 X3 -> v7_ordinal1 X2 -> v7_ordinal1 X1 -> v3_card_1 X4 X2 -> m2_finseq_1 X4 (k3_radix_1 X3) -> r2_hidden X1 (k2_finseq_1 X2) -> False)
  -> (forall X3 X4 X2 X1, ((k4_radix_1 X1 X2 X3 X4) = k6_numbers -> False) -> X1 = k6_numbers -> v7_ordinal1 X3 -> v7_ordinal1 X2 -> v7_ordinal1 X1 -> v3_card_1 X4 X3 -> m2_finseq_1 X4 (k3_radix_1 X2) -> False)
  -> (forall X2 X1 X3, ((k8_radix_1 X1 X3 (k10_radix_6 X1 X2 X3)) = np__1 -> False) -> v7_ordinal1 X3 -> v7_ordinal1 X2 -> v7_ordinal1 X1 -> r1_xxreal_0 np__1 X1 -> r1_xxreal_0 np__2 X3 -> r2_hidden X2 (k2_finseq_1 X1) -> False)
  -> (forall X1 X3 X2, (v3_card_1 (k8_radix_6 X1 X2 X3) (k2_xcmplx_0 X1 np__2) -> False) -> v7_ordinal1 X2 -> v7_ordinal1 X1 -> m1_finseq_1 X3 (k3_radix_1 X2) -> v3_card_1 X3 (k2_xcmplx_0 X1 np__2) -> False)
  -> (forall X1 X3 X2, (m2_finseq_1 (k8_radix_6 X1 X2 X3) (k3_radix_1 X2) -> False) -> v7_ordinal1 X2 -> v7_ordinal1 X1 -> m1_finseq_1 X3 (k3_radix_1 X2) -> v3_card_1 X3 (k2_xcmplx_0 X1 np__2) -> False)
  -> (forall X2 X1 X4 X3, (m2_subset_1 (k1_funct_1 X4 X1) k4_numbers (k3_radix_1 X3) -> False) -> v7_ordinal1 X3 -> v7_ordinal1 X2 -> v7_ordinal1 X1 -> v3_card_1 X4 X2 -> m2_finseq_1 X4 (k3_radix_1 X3) -> r2_hidden X1 (k2_finseq_1 X2) -> False)
  ...
  -> (forall X3 X1 X2, (X1 = X2 -> False) -> ((k9_radix_6 X1 X2 X3) = (k2_xcmplx_0 (k4_xcmplx_0 (k1_radix_1 X3)) np__1) -> False) -> v7_ordinal1 X3 -> v7_ordinal1 X2 -> v7_ordinal1 X1 -> r1_xxreal_0 X1 X2 -> r1_xxreal_0 np__2 X3 -> False)
  -> (forall X1 X2 X3, (m1_subset_1 (k9_radix_6 X1 X2 X3) (k3_radix_1 X3) -> False) -> v7_ordinal1 X3 -> v7_ordinal1 X2 -> v7_ordinal1 X1 -> False)
  -> (forall X1 X2 X3, (m2_finseq_1 (k10_radix_6 X1 X2 X3) (k3_radix_1 X3) -> False) -> v7_ordinal1 X3 -> v7_ordinal1 X2 -> v7_ordinal1 X1 -> False)
  -> (forall X1 X2 X3, (v3_card_1 (k10_radix_6 X1 X2 X3) X1 -> False) -> v7_ordinal1 X3 -> v7_ordinal1 X2 -> v7_ordinal1 X1 -> False)
  ...
  -> (forall X2 X1, (r1_xxreal_0 (k2_xcmplx_0 (k4_xcmplx_0 (k1_radix_1 X1)) np__1) X2 -> False) -> v7_ordinal1 X1 -> v1_int_1 X2 -> r2_hidden X2 (k2_radix_1 X1) -> False)
  -> (forall X2 X1 X3, (v1_xboole_0 X3 -> False) -> (v1_xboole_0 X2 -> False) -> (m2_subset_1 X1 X3 X2 -> False) -> m1_subset_1 X1 X2 -> m1_subset_1 X2 (k1_zfmisc_1 X3) -> False)
  -> (forall X3 X2 X1, (v1_relat_1 X1 -> False) -> m1_subset_1 X1 (k1_zfmisc_1 (k2_zfmisc_1 X2 X3)) -> False)
  -> (forall X3 X1 X2, ((k9_radix_6 X1 X2 X3) = k6_numbers -> False) -> (r1_xxreal_0 X1 X2 -> False) -> v7_ordinal1 X3 -> v7_ordinal1 X2 -> v7_ordinal1 X1 -> r1_xxreal_0 np__2 X3 -> False)
  ...
  -> (forall X3 X1 X2, ((k9_radix_6 X1 X2 X3) = np__1 -> False) -> X1 = X2 -> v7_ordinal1 X3 -> v7_ordinal1 X2 -> v7_ordinal1 X1 -> r1_xxreal_0 np__2 X3 -> False)
  -> (forall X1 X2, (r1_xxreal_0 X1 (k6_xcmplx_0 (k1_radix_1 X2) np__1) -> False) -> v7_ordinal1 X2 -> v1_int_1 X1 -> r2_hidden X1 (k2_radix_1 X2) -> False)
  ...
  -> (forall X2 X1, (r1_xxreal_0 X2 X1 -> False) -> (r1_xxreal_0 (k3_real_1 X1 np__1) X2 -> False) -> v1_int_1 X2 -> v1_int_1 X1 -> False)
  ...
  -> (forall X1, ((k1_finseq_1 X1) = (k2_finseq_1 X1) -> False) -> v7_ordinal1 X1 -> False)
  ...
  -> (r1_xxreal_0 (k4_radix_1 esk2_0 esk3_0 (k2_xcmplx_0 esk1_0 np__2) (k8_radix_6 esk1_0 esk3_0 esk4_0)) k6_numbers -> False)
  ...
  -> ((r1_xxreal_0 (k8_radix_1 (k2_xcmplx_0 esk1_0 np__2) esk3_0 (k8_radix_6 esk1_0 esk3_0 esk4_0)) k6_numbers -> False) -> False)
  -> ((r2_radix_6 esk2_0 esk1_0 esk3_0 (k8_radix_6 esk1_0 esk3_0 esk4_0) -> False) -> False)
  -> (forall X2 X1, (m1_subset_1 (esk13_2 X1 X2) (k1_zfmisc_1 (k2_zfmisc_1 X1 X2)) -> False) -> False)
  -> ((r2_hidden esk2_0 (k2_finseq_1 (k2_xcmplx_0 esk1_0 np__2)) -> False) -> False)
  ...
  -> ((v3_card_1 esk4_0 (k2_xcmplx_0 esk1_0 np__2) -> False) -> False)
  ...
  -> ((m2_finseq_1 esk4_0 (k3_radix_1 esk3_0) -> False) -> False)
  ...
  -> ((r1_xxreal_0 np__2 esk3_0 -> False) -> False)
