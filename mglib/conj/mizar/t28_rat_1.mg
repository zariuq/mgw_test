...
Theorem t28_rat_1:
 ...
 forall k6_numbers:set,
     (forall X2 X3 X1, (X1 = k6_numbers -> False) -> (m2_subset_1 (esk25_3 X1 X2 X3) k1_numbers k5_numbers -> False) -> X3 = (k6_real_1 X2 X1) -> v1_int_1 X2 -> v1_rat_1 X3 -> m2_subset_1 X1 k1_numbers k5_numbers -> False)
  -> (forall X3 X2 X1, (X1 = k6_numbers -> False) -> ((k4_nat_1 (k1_rat_1 X2) (esk25_3 X1 X3 X2)) = X1 -> False) -> X2 = (k6_real_1 X3 X1) -> v1_int_1 X3 -> v1_rat_1 X2 -> m2_subset_1 X1 k1_numbers k5_numbers -> False)
  -> (forall X1 X2 X3, (X3 = k6_numbers -> False) -> ((k4_real_1 (k2_rat_1 X2) (esk25_3 X3 X1 X2)) = X1 -> False) -> X2 = (k6_real_1 X1 X3) -> v1_int_1 X1 -> v1_rat_1 X2 -> m2_subset_1 X3 k1_numbers k5_numbers -> False)
  ...
  -> (forall X1, (k3_xcmplx_0 (k2_rat_1 esk3_0) X1) = esk1_0 -> (k8_real_1 (k1_rat_1 esk3_0) X1) = esk2_0 -> v1_int_1 X1 -> False)
  ...
  -> (((k7_xcmplx_0 esk1_0 esk2_0) = esk3_0 -> False) -> False)
