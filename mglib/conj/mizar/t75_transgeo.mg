...
Theorem t75_transgeo:
 ...
 forall r2_relset_1:set -> set -> set -> set -> prop,
  ...
  -> (forall X1 X4 X2 X3, (X2 = X3 -> False) -> (v7_struct_0 X1 -> False) -> (r2_funct_2 (u1_struct_0 X1) (u1_struct_0 X1) X4 (k4_relat_1 (u1_struct_0 X1)) -> False) -> (k3_funct_2 (u1_struct_0 X1) (u1_struct_0 X1) X4 X3) = X3 -> (k3_funct_2 (u1_struct_0 X1) (u1_struct_0 X1) X4 X2) = X2 -> v1_diraf X1 -> l1_analoaf X1 -> v1_funct_1 X4 -> v6_transgeo X4 X1 -> m1_subset_1 X3 (u1_struct_0 X1) -> m1_subset_1 X2 (u1_struct_0 X1) -> v1_funct_2 X4 (u1_struct_0 X1) (u1_struct_0 X1) -> v3_funct_2 X4 (u1_struct_0 X1) (u1_struct_0 X1) -> m1_subset_1 X4 (k1_zfmisc_1 (k2_zfmisc_1 (u1_struct_0 X1) (u1_struct_0 X1))) -> False)
  ...
  -> (forall X3 X2 X1, (v7_struct_0 X1 -> False) -> (v6_transgeo (k1_transgeo (u1_struct_0 X1) X3 X2) X1 -> False) -> v1_diraf X1 -> l1_analoaf X1 -> v1_funct_1 X3 -> v1_funct_1 X2 -> v6_transgeo X3 X1 -> v6_transgeo X2 X1 -> v1_funct_2 X3 (u1_struct_0 X1) (u1_struct_0 X1) -> v1_funct_2 X2 (u1_struct_0 X1) (u1_struct_0 X1) -> v3_funct_2 X3 (u1_struct_0 X1) (u1_struct_0 X1) -> v3_funct_2 X2 (u1_struct_0 X1) (u1_struct_0 X1) -> m1_subset_1 X3 (k1_zfmisc_1 (k2_zfmisc_1 (u1_struct_0 X1) (u1_struct_0 X1))) -> m1_subset_1 X2 (k1_zfmisc_1 (k2_zfmisc_1 (u1_struct_0 X1) (u1_struct_0 X1))) -> False)
  ...
  -> ((v6_transgeo esk5_0 esk1_0 -> False) -> False)
  -> ((v6_transgeo esk4_0 esk1_0 -> False) -> False)
