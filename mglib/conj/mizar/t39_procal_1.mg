...
Theorem t39_procal_1:
 ...
 forall m1_qc_lang1:set -> prop,
     (forall X4 X3 X2 X1, (r2_hidden (k8_cqc_lang X1 (k8_cqc_lang X1 X2 X3) (k8_cqc_lang X1 (k8_cqc_lang X1 X2 X4) (k8_cqc_lang X1 X2 (k7_cqc_lang X1 X3 X4)))) (k4_cqc_the1 X1) -> False) -> m1_qc_lang1 X1 -> m2_subset_1 X4 (k9_qc_lang1 X1) (k3_cqc_lang X1) -> m2_subset_1 X3 (k9_qc_lang1 X1) (k3_cqc_lang X1) -> m2_subset_1 X2 (k9_qc_lang1 X1) (k3_cqc_lang X1) -> False)
  -> (forall X4 X3 X2 X1, (r2_hidden (k8_cqc_lang X1 (k8_cqc_lang X1 X2 (k8_cqc_lang X1 X3 X4)) (k8_cqc_lang X1 (k7_cqc_lang X1 X2 X3) X4)) (k4_cqc_the1 X1) -> False) -> m1_qc_lang1 X1 -> m2_subset_1 X4 (k9_qc_lang1 X1) (k3_cqc_lang X1) -> m2_subset_1 X3 (k9_qc_lang1 X1) (k3_cqc_lang X1) -> m2_subset_1 X2 (k9_qc_lang1 X1) (k3_cqc_lang X1) -> False)
  -> (forall X2 X3 X1, (r2_hidden (k8_cqc_lang X1 (k6_cqc_lang X1 (k9_cqc_lang X1 X2 X3)) (k7_cqc_lang X1 (k6_cqc_lang X1 X2) (k6_cqc_lang X1 X3))) (k4_cqc_the1 X1) -> False) -> m1_qc_lang1 X1 -> m2_subset_1 X3 (k9_qc_lang1 X1) (k3_cqc_lang X1) -> m2_subset_1 X2 (k9_qc_lang1 X1) (k3_cqc_lang X1) -> False)
  -> (forall X2 X3 X1, (r2_hidden (k8_cqc_lang X1 (k6_cqc_lang X1 (k8_cqc_lang X1 X2 (k6_cqc_lang X1 X3))) (k7_cqc_lang X1 X2 X3)) (k4_cqc_the1 X1) -> False) -> m1_qc_lang1 X1 -> m2_subset_1 X3 (k9_qc_lang1 X1) (k3_cqc_lang X1) -> m2_subset_1 X2 (k9_qc_lang1 X1) (k3_cqc_lang X1) -> False)
  -> (forall X4 X2 X3 X1, (r2_hidden (k8_cqc_lang X1 X3 (k8_cqc_lang X1 X2 X4)) (k4_cqc_the1 X1) -> False) -> m1_qc_lang1 X1 -> m2_subset_1 X4 (k9_qc_lang1 X1) (k3_cqc_lang X1) -> m2_subset_1 X3 (k9_qc_lang1 X1) (k3_cqc_lang X1) -> m2_subset_1 X2 (k9_qc_lang1 X1) (k3_cqc_lang X1) -> r2_hidden (k8_cqc_lang X1 X2 (k8_cqc_lang X1 X3 X4)) (k4_cqc_the1 X1) -> False)
  ...
  -> (r2_hidden (k8_cqc_lang esk1_0 (k7_cqc_lang esk1_0 esk2_0 (k9_cqc_lang esk1_0 esk3_0 esk4_0)) (k9_cqc_lang esk1_0 (k7_cqc_lang esk1_0 esk2_0 esk3_0) (k7_cqc_lang esk1_0 esk2_0 esk4_0))) (k4_cqc_the1 esk1_0) -> False)
