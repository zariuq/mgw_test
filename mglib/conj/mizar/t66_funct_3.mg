...
Theorem t66_funct_3:
 ...
 forall esk31_4:set -> set -> set -> set -> set,
     (forall X3 X2 X1 X4, (X1 = X4 -> False) -> (k9_xtuple_0 X4) = (k2_zfmisc_1 X2 X3) -> (k9_xtuple_0 X1) = (k2_zfmisc_1 X2 X3) -> (k1_binop_1 X1 (esk31_4 X2 X3 X1 X4) (esk32_4 X2 X3 X1 X4)) = (k1_binop_1 X4 (esk31_4 X2 X3 X1 X4) (esk32_4 X2 X3 X1 X4)) -> v1_relat_1 X4 -> v1_relat_1 X1 -> v1_funct_1 X4 -> v1_funct_1 X1 -> False)
  -> (forall X2 X1 X3, (X1 = (k15_funct_3 X2 X3) -> False) -> (k9_xtuple_0 X1) = (k2_zfmisc_1 (k9_xtuple_0 X2) (k9_xtuple_0 X3)) -> (k2_tarski (k2_tarski (k1_funct_1 X2 (esk8_3 X2 X3 X1)) (k1_funct_1 X3 (esk9_3 X2 X3 X1))) (k1_tarski (k1_funct_1 X2 (esk8_3 X2 X3 X1)))) = (k1_binop_1 X1 (esk8_3 X2 X3 X1) (esk9_3 X2 X3 X1)) -> v1_relat_1 X3 -> v1_relat_1 X2 -> v1_relat_1 X1 -> v1_funct_1 X3 -> v1_funct_1 X2 -> v1_funct_1 X1 -> False)
  ...
  -> (forall X2 X1 X3 X4, (X3 = X4 -> False) -> (r2_hidden (esk32_4 X1 X2 X3 X4) X2 -> False) -> (k9_xtuple_0 X4) = (k2_zfmisc_1 X1 X2) -> (k9_xtuple_0 X3) = (k2_zfmisc_1 X1 X2) -> v1_relat_1 X4 -> v1_relat_1 X3 -> v1_funct_1 X4 -> v1_funct_1 X3 -> False)
  -> (forall X2 X1 X3 X4, (X3 = X4 -> False) -> (r2_hidden (esk31_4 X1 X2 X3 X4) X1 -> False) -> (k9_xtuple_0 X4) = (k2_zfmisc_1 X1 X2) -> (k9_xtuple_0 X3) = (k2_zfmisc_1 X1 X2) -> v1_relat_1 X4 -> v1_relat_1 X3 -> v1_funct_1 X4 -> v1_funct_1 X3 -> False)
  -> (forall X3 X2 X1, (X1 = (k10_funct_3 X2 X3) -> False) -> (k9_xtuple_0 X1) = (k2_zfmisc_1 X2 X3) -> (k1_binop_1 X1 (esk5_3 X2 X3 X1) (esk6_3 X2 X3 X1)) = (esk6_3 X2 X3 X1) -> v1_relat_1 X1 -> v1_funct_1 X1 -> False)
  -> (forall X3 X2 X1, (X1 = (k9_funct_3 X2 X3) -> False) -> (k9_xtuple_0 X1) = (k2_zfmisc_1 X2 X3) -> (k1_binop_1 X1 (esk3_3 X2 X3 X1) (esk4_3 X2 X3 X1)) = (esk3_3 X2 X3 X1) -> v1_relat_1 X1 -> v1_funct_1 X1 -> False)
  ...
  -> (forall X2 X1 X3, (X3 = (k13_funct_3 X1 X2) -> False) -> (r2_hidden (esk7_3 X1 X2 X3) (k9_xtuple_0 X3) -> False) -> (k9_xtuple_0 X3) = (k3_xboole_0 (k9_xtuple_0 X1) (k9_xtuple_0 X2)) -> v1_relat_1 X3 -> v1_relat_1 X2 -> v1_relat_1 X1 -> v1_funct_1 X3 -> v1_funct_1 X2 -> v1_funct_1 X1 -> False)
  -> (forall X2 X1 X3, (X3 = (k15_funct_3 X1 X2) -> False) -> (r2_hidden (esk9_3 X1 X2 X3) (k9_xtuple_0 X2) -> False) -> (k9_xtuple_0 X3) = (k2_zfmisc_1 (k9_xtuple_0 X1) (k9_xtuple_0 X2)) -> v1_relat_1 X3 -> v1_relat_1 X2 -> v1_relat_1 X1 -> v1_funct_1 X3 -> v1_funct_1 X2 -> v1_funct_1 X1 -> False)
  -> (forall X2 X1 X3, (X3 = (k15_funct_3 X1 X2) -> False) -> (r2_hidden (esk8_3 X1 X2 X3) (k9_xtuple_0 X1) -> False) -> (k9_xtuple_0 X3) = (k2_zfmisc_1 (k9_xtuple_0 X1) (k9_xtuple_0 X2)) -> v1_relat_1 X3 -> v1_relat_1 X2 -> v1_relat_1 X1 -> v1_funct_1 X3 -> v1_funct_1 X2 -> v1_funct_1 X1 -> False)
  ...
  -> (forall X2 X1 X3, (X3 = (k10_funct_3 X1 X2) -> False) -> (r2_hidden (esk6_3 X1 X2 X3) X2 -> False) -> (k9_xtuple_0 X3) = (k2_zfmisc_1 X1 X2) -> v1_relat_1 X3 -> v1_funct_1 X3 -> False)
  -> (forall X2 X1 X3, (X3 = (k10_funct_3 X1 X2) -> False) -> (r2_hidden (esk5_3 X1 X2 X3) X1 -> False) -> (k9_xtuple_0 X3) = (k2_zfmisc_1 X1 X2) -> v1_relat_1 X3 -> v1_funct_1 X3 -> False)
  -> (forall X2 X1 X3, (X3 = (k9_funct_3 X1 X2) -> False) -> (r2_hidden (esk4_3 X1 X2 X3) X2 -> False) -> (k9_xtuple_0 X3) = (k2_zfmisc_1 X1 X2) -> v1_relat_1 X3 -> v1_funct_1 X3 -> False)
  -> (forall X2 X1 X3, (X3 = (k9_funct_3 X1 X2) -> False) -> (r2_hidden (esk3_3 X1 X2 X3) X1 -> False) -> (k9_xtuple_0 X3) = (k2_zfmisc_1 X1 X2) -> v1_relat_1 X3 -> v1_funct_1 X3 -> False)
  ...
  -> ((k13_funct_3 (k3_relat_1 (k9_funct_3 (k9_xtuple_0 esk1_0) (k9_xtuple_0 esk2_0)) esk1_0) (k3_relat_1 (k10_funct_3 (k9_xtuple_0 esk1_0) (k9_xtuple_0 esk2_0)) esk2_0)) = (k15_funct_3 esk1_0 esk2_0) -> False)
  ...
  -> (forall X2 X1, (r1_tarski (k10_xtuple_0 (k10_funct_3 X1 X2)) X2 -> False) -> False)
  -> (forall X1 X2, (r1_tarski (k10_xtuple_0 (k9_funct_3 X1 X2)) X1 -> False) -> False)
