...
Theorem t43_rat_1:
 ...
 forall k6_numbers:set,
     (forall X3 X2 X1, (X1 = k6_numbers -> False) -> (m2_subset_1 (esk26_3 X1 X2 X3) k1_numbers k5_numbers -> False) -> X3 = (k6_real_1 X2 X1) -> v1_rat_1 X3 -> v1_int_1 X2 -> m2_subset_1 X1 k1_numbers k5_numbers -> False)
  -> (forall X2 X3 X1, (X1 = k6_numbers -> False) -> ((k4_nat_1 (k1_rat_1 X2) (esk26_3 X1 X3 X2)) = X1 -> False) -> X2 = (k6_real_1 X3 X1) -> v1_rat_1 X2 -> v1_int_1 X3 -> m2_subset_1 X1 k1_numbers k5_numbers -> False)
  -> (forall X2 X1 X3, (X3 = k6_numbers -> False) -> ((k4_real_1 (k2_rat_1 X2) (esk26_3 X3 X1 X2)) = X1 -> False) -> X2 = (k6_real_1 X1 X3) -> v1_rat_1 X2 -> v1_int_1 X1 -> m2_subset_1 X3 k1_numbers k5_numbers -> False)
  -> (forall X4 X1 X3 X2, (X2 = k6_numbers -> False) -> (r1_xxreal_0 X4 X2 -> False) -> X4 = (k1_rat_1 X3) -> X3 = (k6_real_1 X1 X2) -> v1_rat_1 X3 -> v1_int_1 X1 -> m2_subset_1 X4 k1_numbers k5_numbers -> m2_subset_1 X2 k1_numbers k5_numbers -> False)
  -> (forall X1 X3 X2, (X2 = k6_numbers -> False) -> (X2 = (k1_rat_1 X1) -> False) -> (m2_subset_1 (esk4_2 X1 X2) k1_numbers k5_numbers -> False) -> X1 = (k6_real_1 X3 X2) -> v1_rat_1 X1 -> v1_int_1 X3 -> m2_subset_1 X2 k1_numbers k5_numbers -> False)
  -> (forall X1 X3 X2, (X2 = k6_numbers -> False) -> (X2 = (k1_rat_1 X1) -> False) -> ((k6_real_1 (esk3_2 X1 X2) (esk4_2 X1 X2)) = X1 -> False) -> X1 = (k6_real_1 X3 X2) -> v1_rat_1 X1 -> v1_int_1 X3 -> m2_subset_1 X2 k1_numbers k5_numbers -> False)
  -> (forall X2 X3 X1, (X1 = k6_numbers -> False) -> (X1 = (k1_rat_1 X2) -> False) -> X2 = (k6_real_1 X3 X1) -> v1_rat_1 X2 -> v1_int_1 X3 -> r1_xxreal_0 X1 (esk4_2 X2 X1) -> m2_subset_1 X1 k1_numbers k5_numbers -> False)
  -> (forall X1 X3 X2, (X2 = k6_numbers -> False) -> (X2 = (k1_rat_1 X1) -> False) -> (v1_int_1 (esk3_2 X1 X2) -> False) -> X1 = (k6_real_1 X3 X2) -> v1_rat_1 X1 -> v1_int_1 X3 -> m2_subset_1 X2 k1_numbers k5_numbers -> False)
  -> (forall X1 X3 X2, (X2 = k6_numbers -> False) -> (X2 = (k1_rat_1 X1) -> False) -> X1 = (k6_real_1 X3 X2) -> (esk4_2 X1 X2) = k6_numbers -> v1_rat_1 X1 -> v1_int_1 X3 -> m2_subset_1 X2 k1_numbers k5_numbers -> False)
  -> (forall X1 X3 X2, (v1_xboole_0 X2 -> False) -> (v1_xboole_0 X1 -> False) -> (m1_subset_1 X3 X1 -> False) -> m2_subset_1 X3 X1 X2 -> m1_subset_1 X2 (k1_zfmisc_1 X1) -> False)
  -> (forall X2 X1 X3, (v1_xboole_0 X3 -> False) -> (v1_xboole_0 X2 -> False) -> (m1_subset_1 X1 X3 -> False) -> m2_subset_1 X1 X2 X3 -> m1_subset_1 X3 (k1_zfmisc_1 X2) -> False)
  -> (forall X1 X2, ((k6_real_1 (esk2_2 X1 X2) X2) = X1 -> False) -> X2 = (k1_rat_1 X1) -> v1_rat_1 X1 -> m2_subset_1 X2 k1_numbers k5_numbers -> False)
  ...
  -> (forall X1 X2, (v1_int_1 (esk2_2 X1 X2) -> False) -> X2 = (k1_rat_1 X1) -> v1_rat_1 X1 -> m2_subset_1 X2 k1_numbers k5_numbers -> False)
  ...
  -> (forall X1 X2, (X2 = np__1 -> False) -> (X1 = k6_numbers -> False) -> (k3_xcmplx_0 X2 X1) = X1 -> v1_xcmplx_0 X2 -> v1_xcmplx_0 X1 -> False)
  ...
  -> (forall X2 X1, (X1 = np__1 -> False) -> (k3_xcmplx_0 X1 X2) = np__1 -> v7_ordinal1 X2 -> v7_ordinal1 X1 -> False)
  -> ((k1_rat_1 (k4_xcmplx_0 esk1_0)) = (k1_rat_1 esk1_0) -> (k2_rat_1 (k4_xcmplx_0 esk1_0)) = (k4_xcmplx_0 (k2_rat_1 esk1_0)) -> False)
