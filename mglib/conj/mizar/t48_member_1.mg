...
Theorem t48_member_1:
 ...
 forall k2_xboole_0:set -> set -> set,
  ...
  -> (forall X2 X1 X3, ((k3_binop_2 (esk10_3 X1 X2 X3) (esk11_3 X1 X2 X3)) = X1 -> False) -> v1_membered X3 -> v1_membered X2 -> r2_hidden X1 (a_2_3_member_1 X2 X3) -> False)
  -> (forall X2 X1 X3, ((k1_xxreal_3 (esk8_3 X1 X2 X3) (esk9_3 X1 X2 X3)) = X1 -> False) -> v2_membered X3 -> v2_membered X2 -> r2_hidden X1 (a_2_0_member_1 X2 X3) -> False)
  -> (forall X2 X1 X3, (r2_hidden (esk11_3 X1 X2 X3) X3 -> False) -> v1_membered X3 -> v1_membered X2 -> r2_hidden X1 (a_2_3_member_1 X2 X3) -> False)
  -> (forall X2 X1 X3, (r2_hidden (esk10_3 X1 X2 X3) X2 -> False) -> v1_membered X3 -> v1_membered X2 -> r2_hidden X1 (a_2_3_member_1 X2 X3) -> False)
  -> (forall X2 X1 X3, (r2_hidden (esk9_3 X1 X2 X3) X3 -> False) -> v2_membered X3 -> v2_membered X2 -> r2_hidden X1 (a_2_0_member_1 X2 X3) -> False)
  -> (forall X2 X1 X3, (r2_hidden (esk8_3 X1 X2 X3) X2 -> False) -> v2_membered X3 -> v2_membered X2 -> r2_hidden X1 (a_2_0_member_1 X2 X3) -> False)
  -> (forall X2 X1 X3, (m1_subset_1 (esk11_3 X1 X2 X3) k2_numbers -> False) -> v1_membered X3 -> v1_membered X2 -> r2_hidden X1 (a_2_3_member_1 X2 X3) -> False)
  ...
  -> (forall X2 X1 X3, (m1_subset_1 (esk9_3 X1 X2 X3) k7_numbers -> False) -> v2_membered X3 -> v2_membered X2 -> r2_hidden X1 (a_2_0_member_1 X2 X3) -> False)
  ...
  -> (forall X3 X1 X2 X4, ((k8_member_1 X3 X4) = (k9_member_1 X1 X2) -> False) -> X2 = X4 -> X1 = X3 -> v2_membered X4 -> v2_membered X3 -> v3_membered X2 -> v3_membered X1 -> False)
  ...
  -> (forall X2 X1, ((k7_xcmplx_0 X1 X2) = (k3_xcmplx_0 X1 (k5_xcmplx_0 X2)) -> False) -> v1_xcmplx_0 X2 -> v1_xcmplx_0 X1 -> False)
  ...
  -> ((k2_xboole_0 (k9_member_1 esk1_0 esk2_0) (k9_member_1 esk1_0 esk3_0)) = (k9_member_1 esk1_0 (k2_xboole_0 esk2_0 esk3_0)) -> False)
  ...
  -> (v1_xreal_0 esk28_0 -> False)
  -> (v1_xreal_0 esk19_0 -> False)
  ...
  -> ((m1_subset_1 esk15_0 k1_numbers -> False) -> False)
  ...
  -> ((v1_xreal_0 esk32_0 -> False) -> False)
  ...
  -> ((v1_xcmplx_0 esk32_0 -> False) -> False)
