...
Theorem t6_metric_6:
 ...
 forall k1_metric_6:set -> set -> set,
 ...
 forall k1_metric_1:set -> set -> set -> set -> set -> set,
 forall k6_numbers:set,
 forall r1_pcomps_1:set -> set -> prop,
     (forall X1 X2, (r1_pcomps_1 X1 X2 -> False) -> (esk6_2 X1 X2) = (esk5_2 X1 X2) -> (k1_metric_1 X1 X1 X2 (esk5_2 X1 X2) (esk6_2 X1 X2)) = k6_numbers -> (k1_metric_1 X1 X1 X2 (esk6_2 X1 X2) (esk5_2 X1 X2)) = (k1_metric_1 X1 X1 X2 (esk5_2 X1 X2) (esk6_2 X1 X2)) -> v1_funct_1 X2 -> v1_funct_2 X2 (k2_zfmisc_1 X1 X1) k1_numbers -> m1_subset_1 X2 (k1_zfmisc_1 (k2_zfmisc_1 (k2_zfmisc_1 X1 X1) k1_numbers)) -> r1_xxreal_0 (k1_metric_1 X1 X1 X2 (esk5_2 X1 X2) (esk7_2 X1 X2)) (k7_real_1 (k1_metric_1 X1 X1 X2 (esk5_2 X1 X2) (esk6_2 X1 X2)) (k1_metric_1 X1 X1 X2 (esk6_2 X1 X2) (esk7_2 X1 X2))) -> False)
  -> (forall X1 X2, ((esk6_2 X1 X2) = (esk5_2 X1 X2) -> False) -> ((k1_metric_1 X1 X1 X2 (esk5_2 X1 X2) (esk6_2 X1 X2)) = k6_numbers -> False) -> (r1_pcomps_1 X1 X2 -> False) -> (k1_metric_1 X1 X1 X2 (esk6_2 X1 X2) (esk5_2 X1 X2)) = (k1_metric_1 X1 X1 X2 (esk5_2 X1 X2) (esk6_2 X1 X2)) -> v1_funct_1 X2 -> v1_funct_2 X2 (k2_zfmisc_1 X1 X1) k1_numbers -> m1_subset_1 X2 (k1_zfmisc_1 (k2_zfmisc_1 (k2_zfmisc_1 X1 X1) k1_numbers)) -> r1_xxreal_0 (k1_metric_1 X1 X1 X2 (esk5_2 X1 X2) (esk7_2 X1 X2)) (k7_real_1 (k1_metric_1 X1 X1 X2 (esk5_2 X1 X2) (esk6_2 X1 X2)) (k1_metric_1 X1 X1 X2 (esk6_2 X1 X2) (esk7_2 X1 X2))) -> False)
  -> (forall X3 X2 X1, (X2 = (k1_metric_6 X1 X3) -> False) -> (v1_xboole_0 X1 -> False) -> (k10_real_1 (k1_metric_1 X1 X1 X3 (esk3_3 X1 X3 X2) (esk4_3 X1 X3 X2)) (k7_real_1 np__1 (k1_metric_1 X1 X1 X3 (esk3_3 X1 X3 X2) (esk4_3 X1 X3 X2)))) = (k1_metric_1 X1 X1 X2 (esk3_3 X1 X3 X2) (esk4_3 X1 X3 X2)) -> v1_funct_1 X3 -> v1_funct_1 X2 -> v1_funct_2 X3 (k2_zfmisc_1 X1 X1) k1_numbers -> v1_funct_2 X2 (k2_zfmisc_1 X1 X1) k1_numbers -> m1_subset_1 X3 (k1_zfmisc_1 (k2_zfmisc_1 (k2_zfmisc_1 X1 X1) k1_numbers)) -> m1_subset_1 X2 (k1_zfmisc_1 (k2_zfmisc_1 (k2_zfmisc_1 X1 X1) k1_numbers)) -> False)
  -> (forall X1 X5 X3 X4 X2, (r1_xxreal_0 (k1_metric_1 X1 X1 X2 X3 X4) (k7_real_1 (k1_metric_1 X1 X1 X2 X3 X5) (k1_metric_1 X1 X1 X2 X5 X4)) -> False) -> v1_funct_1 X2 -> m1_subset_1 X5 X1 -> m1_subset_1 X4 X1 -> m1_subset_1 X3 X1 -> r1_pcomps_1 X1 X2 -> v1_funct_2 X2 (k2_zfmisc_1 X1 X1) k1_numbers -> m1_subset_1 X2 (k1_zfmisc_1 (k2_zfmisc_1 (k2_zfmisc_1 X1 X1) k1_numbers)) -> False)
  -> (forall X1 X3 X4 X5 X2, ((k1_metric_1 X2 X2 X1 X4 X5) = (k10_real_1 (k1_metric_1 X2 X2 X3 X4 X5) (k7_real_1 np__1 (k1_metric_1 X2 X2 X3 X4 X5))) -> False) -> (v1_xboole_0 X2 -> False) -> X1 = (k1_metric_6 X2 X3) -> v1_funct_1 X3 -> v1_funct_1 X1 -> m1_subset_1 X5 X2 -> m1_subset_1 X4 X2 -> v1_funct_2 X3 (k2_zfmisc_1 X2 X2) k1_numbers -> v1_funct_2 X1 (k2_zfmisc_1 X2 X2) k1_numbers -> m1_subset_1 X3 (k1_zfmisc_1 (k2_zfmisc_1 (k2_zfmisc_1 X2 X2) k1_numbers)) -> m1_subset_1 X1 (k1_zfmisc_1 (k2_zfmisc_1 (k2_zfmisc_1 X2 X2) k1_numbers)) -> False)
  -> (forall X5 X1 X2 X4 X3, ((k1_metric_1 X1 X1 X2 X3 X4) = (k1_metric_1 X1 X1 X2 X4 X3) -> False) -> v1_funct_1 X2 -> m1_subset_1 X5 X1 -> m1_subset_1 X4 X1 -> m1_subset_1 X3 X1 -> r1_pcomps_1 X1 X2 -> v1_funct_2 X2 (k2_zfmisc_1 X1 X1) k1_numbers -> m1_subset_1 X2 (k1_zfmisc_1 (k2_zfmisc_1 (k2_zfmisc_1 X1 X1) k1_numbers)) -> False)
  -> (forall X2 X3 X4 X1, (v1_xboole_0 X1 -> False) -> (r1_xxreal_0 k6_numbers (k1_metric_1 X1 X1 X2 X3 X4) -> False) -> v1_funct_1 X2 -> m1_subset_1 X4 X1 -> m1_subset_1 X3 X1 -> r1_pcomps_1 X1 X2 -> v1_funct_2 X2 (k2_zfmisc_1 X1 X1) k1_numbers -> m1_subset_1 X2 (k1_zfmisc_1 (k2_zfmisc_1 (k2_zfmisc_1 X1 X1) k1_numbers)) -> False)
  -> (forall X3 X5 X4 X2 X1, (m1_subset_1 (k1_metric_1 X2 X3 X1 X4 X5) k1_numbers -> False) -> v1_funct_1 X1 -> m1_subset_1 X5 X3 -> m1_subset_1 X4 X2 -> m1_subset_1 X1 (k1_zfmisc_1 (k2_zfmisc_1 (k2_zfmisc_1 X2 X3) k1_numbers)) -> False)
  -> (forall X2 X1 X5 X3 X4, (X3 = X4 -> False) -> (k1_metric_1 X1 X1 X2 X3 X4) = k6_numbers -> v1_funct_1 X2 -> m1_subset_1 X5 X1 -> m1_subset_1 X4 X1 -> m1_subset_1 X3 X1 -> r1_pcomps_1 X1 X2 -> v1_funct_2 X2 (k2_zfmisc_1 X1 X1) k1_numbers -> m1_subset_1 X2 (k1_zfmisc_1 (k2_zfmisc_1 (k2_zfmisc_1 X1 X1) k1_numbers)) -> False)
  -> (forall X5 X3 X4 X1 X2, ((k1_metric_1 X3 X3 X4 X1 X2) = k6_numbers -> False) -> X1 = X2 -> v1_funct_1 X4 -> m1_subset_1 X5 X3 -> m1_subset_1 X2 X3 -> m1_subset_1 X1 X3 -> r1_pcomps_1 X3 X4 -> v1_funct_2 X4 (k2_zfmisc_1 X3 X3) k1_numbers -> m1_subset_1 X4 (k1_zfmisc_1 (k2_zfmisc_1 (k2_zfmisc_1 X3 X3) k1_numbers)) -> False)
  -> (forall X3 X5 X4 X2 X1, ((k1_metric_1 X2 X3 X1 X4 X5) = (k1_binop_1 X1 X4 X5) -> False) -> v1_funct_1 X1 -> m1_subset_1 X5 X3 -> m1_subset_1 X4 X2 -> m1_subset_1 X1 (k1_zfmisc_1 (k2_zfmisc_1 (k2_zfmisc_1 X2 X3) k1_numbers)) -> False)
  -> (forall X3 X2 X1, (X3 = (k1_metric_6 X1 X2) -> False) -> (v1_xboole_0 X1 -> False) -> (m1_subset_1 (esk4_3 X1 X2 X3) X1 -> False) -> v1_funct_1 X3 -> v1_funct_1 X2 -> v1_funct_2 X3 (k2_zfmisc_1 X1 X1) k1_numbers -> v1_funct_2 X2 (k2_zfmisc_1 X1 X1) k1_numbers -> m1_subset_1 X3 (k1_zfmisc_1 (k2_zfmisc_1 (k2_zfmisc_1 X1 X1) k1_numbers)) -> m1_subset_1 X2 (k1_zfmisc_1 (k2_zfmisc_1 (k2_zfmisc_1 X1 X1) k1_numbers)) -> False)
  -> (forall X3 X2 X1, (X3 = (k1_metric_6 X1 X2) -> False) -> (v1_xboole_0 X1 -> False) -> (m1_subset_1 (esk3_3 X1 X2 X3) X1 -> False) -> v1_funct_1 X3 -> v1_funct_1 X2 -> v1_funct_2 X3 (k2_zfmisc_1 X1 X1) k1_numbers -> v1_funct_2 X2 (k2_zfmisc_1 X1 X1) k1_numbers -> m1_subset_1 X3 (k1_zfmisc_1 (k2_zfmisc_1 (k2_zfmisc_1 X1 X1) k1_numbers)) -> m1_subset_1 X2 (k1_zfmisc_1 (k2_zfmisc_1 (k2_zfmisc_1 X1 X1) k1_numbers)) -> False)
  -> (forall X2 X1, (v1_xboole_0 X1 -> False) -> (m1_subset_1 (k1_metric_6 X1 X2) (k1_zfmisc_1 (k2_zfmisc_1 (k2_zfmisc_1 X1 X1) k1_numbers)) -> False) -> v1_funct_1 X2 -> v1_funct_2 X2 (k2_zfmisc_1 X1 X1) k1_numbers -> m1_subset_1 X2 (k1_zfmisc_1 (k2_zfmisc_1 (k2_zfmisc_1 X1 X1) k1_numbers)) -> False)
  -> (forall X2 X1, (v1_xboole_0 X1 -> False) -> (v1_funct_2 (k1_metric_6 X1 X2) (k2_zfmisc_1 X1 X1) k1_numbers -> False) -> v1_funct_1 X2 -> v1_funct_2 X2 (k2_zfmisc_1 X1 X1) k1_numbers -> m1_subset_1 X2 (k1_zfmisc_1 (k2_zfmisc_1 (k2_zfmisc_1 X1 X1) k1_numbers)) -> False)
  -> (forall X1 X2, (r1_pcomps_1 X1 X2 -> False) -> (m1_subset_1 (esk7_2 X1 X2) X1 -> False) -> v1_funct_1 X2 -> v1_funct_2 X2 (k2_zfmisc_1 X1 X1) k1_numbers -> m1_subset_1 X2 (k1_zfmisc_1 (k2_zfmisc_1 (k2_zfmisc_1 X1 X1) k1_numbers)) -> False)
  -> (forall X1 X2, (r1_pcomps_1 X1 X2 -> False) -> (m1_subset_1 (esk6_2 X1 X2) X1 -> False) -> v1_funct_1 X2 -> v1_funct_2 X2 (k2_zfmisc_1 X1 X1) k1_numbers -> m1_subset_1 X2 (k1_zfmisc_1 (k2_zfmisc_1 (k2_zfmisc_1 X1 X1) k1_numbers)) -> False)
  -> (forall X1 X2, (r1_pcomps_1 X1 X2 -> False) -> (m1_subset_1 (esk5_2 X1 X2) X1 -> False) -> v1_funct_1 X2 -> v1_funct_2 X2 (k2_zfmisc_1 X1 X1) k1_numbers -> m1_subset_1 X2 (k1_zfmisc_1 (k2_zfmisc_1 (k2_zfmisc_1 X1 X1) k1_numbers)) -> False)
  -> (forall X2 X1, (v1_xboole_0 X1 -> False) -> (v1_funct_1 (k1_metric_6 X1 X2) -> False) -> v1_funct_1 X2 -> v1_funct_2 X2 (k2_zfmisc_1 X1 X1) k1_numbers -> m1_subset_1 X2 (k1_zfmisc_1 (k2_zfmisc_1 (k2_zfmisc_1 X1 X1) k1_numbers)) -> False)
  ...
  -> (forall X3 X2 X1, (v7_ordinal1 (k1_binop_1 X1 X2 X3) -> False) -> v1_funct_1 X1 -> v1_relat_1 X1 -> v4_valued_0 X1 -> False)
  ...
  -> (forall X1 X2, (X2 = k6_numbers -> False) -> (X1 = k6_numbers -> False) -> (k7_xcmplx_0 X1 X2) = k6_numbers -> v1_xcmplx_0 X2 -> v1_xcmplx_0 X1 -> False)
  ...
  -> (r1_pcomps_1 esk1_0 (k1_metric_6 esk1_0 esk2_0) -> False)
  ...
  -> ((m1_subset_1 esk2_0 (k1_zfmisc_1 (k2_zfmisc_1 (k2_zfmisc_1 esk1_0 esk1_0) k1_numbers)) -> False) -> False)
  ...
  -> ((v1_funct_2 esk2_0 (k2_zfmisc_1 esk1_0 esk1_0) k1_numbers -> False) -> False)
  ...
  -> (forall X1, (v5_relat_1 (esk21_1 X1) X1 -> False) -> False)
  ...
  -> ((r1_pcomps_1 esk1_0 esk2_0 -> False) -> False)
  ...
  -> (forall X1, (v5_ordinal1 (esk21_1 X1) -> False) -> False)
