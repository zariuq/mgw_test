...
Theorem t71_group_11:
 ...
 forall v2_struct_0:set -> prop,
     (forall X2 X3 X4 X1, (v2_struct_0 X1 -> False) -> v2_group_1 X1 -> v3_group_1 X1 -> l3_algstr_0 X1 -> m1_group_2 X4 X1 -> m1_group_2 X2 X1 -> r2_hidden X3 (a_3_3_group_11 X1 X4 X2) -> r1_xboole_0 (k13_group_2 X1 X2 (esk10_4 X3 X1 X4 X2)) (k8_group_2 X1 X4) -> False)
  ...
  -> (forall X4 X2 X3 X1, (v2_struct_0 X1 -> False) -> (r1_xboole_0 (k13_group_2 X1 X2 X4) (k8_group_2 X1 X3) -> False) -> (r2_hidden (esk25_4 X1 X2 X3 X4) (k13_group_2 X1 X2 X4) -> False) -> v2_group_1 X1 -> v3_group_1 X1 -> l3_algstr_0 X1 -> m1_group_2 X3 X1 -> m1_group_2 X2 X1 -> m1_subset_1 X4 (u1_struct_0 X1) -> False)
  -> (forall X3 X1 X4 X2, ((k6_algstr_0 X2 (esk22_4 X1 X2 X3 X4) X3) = X1 -> False) -> (v2_struct_0 X2 -> False) -> v2_group_1 X2 -> v3_group_1 X2 -> l3_algstr_0 X2 -> m1_group_2 X4 X2 -> m1_subset_1 X3 (u1_struct_0 X2) -> r2_hidden X1 (k14_group_2 X2 X4 X3) -> False)
  -> (forall X3 X1 X4 X2, ((k6_algstr_0 X2 X3 (esk21_4 X1 X2 X3 X4)) = X1 -> False) -> (v2_struct_0 X2 -> False) -> v2_group_1 X2 -> v3_group_1 X2 -> l3_algstr_0 X2 -> m1_group_2 X4 X2 -> m1_subset_1 X3 (u1_struct_0 X2) -> r2_hidden X1 (k13_group_2 X2 X4 X3) -> False)
  ...
  -> (forall X3 X1 X4 X2, (v2_struct_0 X2 -> False) -> (m1_subset_1 (esk22_4 X1 X2 X3 X4) (u1_struct_0 X2) -> False) -> v2_group_1 X2 -> v3_group_1 X2 -> l3_algstr_0 X2 -> m1_group_2 X4 X2 -> m1_subset_1 X3 (u1_struct_0 X2) -> r2_hidden X1 (k14_group_2 X2 X4 X3) -> False)
  -> (forall X3 X1 X4 X2, (v2_struct_0 X2 -> False) -> (m1_subset_1 (esk21_4 X1 X2 X3 X4) (u1_struct_0 X2) -> False) -> v2_group_1 X2 -> v3_group_1 X2 -> l3_algstr_0 X2 -> m1_group_2 X4 X2 -> m1_subset_1 X3 (u1_struct_0 X2) -> r2_hidden X1 (k13_group_2 X2 X4 X3) -> False)
  -> (forall X4 X2 X1 X3, (v2_struct_0 X3 -> False) -> (r1_struct_0 X1 (esk22_4 X2 X3 X4 X1) -> False) -> v2_group_1 X3 -> v3_group_1 X3 -> l3_algstr_0 X3 -> m1_group_2 X1 X3 -> m1_subset_1 X4 (u1_struct_0 X3) -> r2_hidden X2 (k14_group_2 X3 X1 X4) -> False)
  -> (forall X4 X2 X1 X3, (v2_struct_0 X3 -> False) -> (r1_struct_0 X1 (esk21_4 X2 X3 X4 X1) -> False) -> v2_group_1 X3 -> v3_group_1 X3 -> l3_algstr_0 X3 -> m1_group_2 X1 X3 -> m1_subset_1 X4 (u1_struct_0 X3) -> r2_hidden X2 (k13_group_2 X3 X1 X4) -> False)
  -> (forall X3 X1 X4 X2, (v2_struct_0 X2 -> False) -> (m1_subset_1 (esk10_4 X1 X2 X3 X4) (u1_struct_0 X2) -> False) -> v2_group_1 X2 -> v3_group_1 X2 -> l3_algstr_0 X2 -> m1_group_2 X4 X2 -> m1_group_2 X3 X2 -> r2_hidden X1 (a_3_3_group_11 X2 X3 X4) -> False)
  -> (forall X4 X2 X3 X1, (v2_struct_0 X1 -> False) -> (r1_xboole_0 (k13_group_2 X1 X2 X4) (k8_group_2 X1 X3) -> False) -> (m1_subset_1 (esk25_4 X1 X2 X3 X4) (u1_struct_0 X1) -> False) -> v2_group_1 X1 -> v3_group_1 X1 -> l3_algstr_0 X1 -> m1_group_2 X3 X1 -> m1_group_2 X2 X1 -> m1_subset_1 X4 (u1_struct_0 X1) -> False)
  -> (forall X4 X1 X3 X2, (v2_struct_0 X2 -> False) -> (r1_struct_0 X1 (esk25_4 X2 X3 X1 X4) -> False) -> (r1_xboole_0 (k13_group_2 X2 X3 X4) (k8_group_2 X2 X1) -> False) -> v2_group_1 X2 -> v3_group_1 X2 -> l3_algstr_0 X2 -> m1_group_2 X3 X2 -> m1_group_2 X1 X2 -> m1_subset_1 X4 (u1_struct_0 X2) -> False)
  ...
  -> (forall X3 X1 X4 X2, ((esk10_4 X1 X2 X3 X4) = X1 -> False) -> (v2_struct_0 X2 -> False) -> v2_group_1 X2 -> v3_group_1 X2 -> l3_algstr_0 X2 -> m1_group_2 X4 X2 -> m1_group_2 X3 X2 -> r2_hidden X1 (a_3_3_group_11 X2 X3 X4) -> False)
  ...
  -> (forall X1 X2, (v2_struct_0 X2 -> False) -> (v1_group_3 X1 X2 -> False) -> (k14_group_2 X2 X1 (esk23_2 X2 X1)) = (k13_group_2 X2 X1 (esk23_2 X2 X1)) -> v2_group_1 X2 -> v3_group_1 X2 -> l3_algstr_0 X2 -> m1_group_2 X1 X2 -> False)
  ...
  -> (forall X3 X1 X2, ((k14_group_2 X2 X1 X3) = (k13_group_2 X2 X1 X3) -> False) -> (v2_struct_0 X2 -> False) -> v2_group_1 X2 -> v3_group_1 X2 -> l3_algstr_0 X2 -> m1_group_2 X1 X2 -> v1_group_3 X1 X2 -> m1_subset_1 X3 (u1_struct_0 X2) -> False)
  ...
  -> (forall X1, (u1_struct_0 X1) = (k4_group_11 esk1_0 esk2_0 esk3_0) -> v15_algstr_0 X1 -> m1_group_2 X1 esk1_0 -> False)
  -> (forall X1 X2, (v2_struct_0 X2 -> False) -> (v1_group_3 X1 X2 -> False) -> (m1_subset_1 (esk23_2 X2 X1) (u1_struct_0 X2) -> False) -> v2_group_1 X2 -> v3_group_1 X2 -> l3_algstr_0 X2 -> m1_group_2 X1 X2 -> False)
