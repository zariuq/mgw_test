...
Theorem t38_ordinal4:
 ...
 forall r2_hidden:set -> set -> prop,
  ...
  -> (forall X1 X2, (r1_tarski (k10_xtuple_0 (esk3_2 X1 X2)) X1 -> False) -> v3_ordinal1 X2 -> v3_ordinal1 X1 -> r2_ordinal2 X1 X2 -> False)
  ...
  -> (forall X1 X2, ((k9_xtuple_0 (esk3_2 X1 X2)) = X2 -> False) -> v3_ordinal1 X2 -> v3_ordinal1 X1 -> r2_ordinal2 X1 X2 -> False)
  -> (forall X1 X2, ((k4_ordinal2 (esk3_2 X1 X2)) = X1 -> False) -> v3_ordinal1 X2 -> v3_ordinal1 X1 -> r2_ordinal2 X1 X2 -> False)
  -> (forall X1 X2, (v2_ordinal2 (esk3_2 X1 X2) -> False) -> v3_ordinal1 X2 -> v3_ordinal1 X1 -> r2_ordinal2 X1 X2 -> False)
  -> (forall X1 X2, (v1_ordinal2 (esk3_2 X1 X2) -> False) -> v3_ordinal1 X2 -> v3_ordinal1 X1 -> r2_ordinal2 X1 X2 -> False)
  -> (forall X1 X2, (v5_ordinal1 (esk3_2 X1 X2) -> False) -> v3_ordinal1 X2 -> v3_ordinal1 X1 -> r2_ordinal2 X1 X2 -> False)
  -> (forall X1 X2, (v1_relat_1 (esk3_2 X1 X2) -> False) -> v3_ordinal1 X2 -> v3_ordinal1 X1 -> r2_ordinal2 X1 X2 -> False)
  -> (forall X1 X2, (v1_funct_1 (esk3_2 X1 X2) -> False) -> v3_ordinal1 X2 -> v3_ordinal1 X1 -> r2_ordinal2 X1 X2 -> False)
  ...
  -> (forall X1, (v4_ordinal1 (k4_ordinal2 X1) -> False) -> v1_funct_1 X1 -> v1_relat_1 X1 -> v5_ordinal1 X1 -> v1_ordinal2 X1 -> v2_ordinal2 X1 -> v4_ordinal1 (k9_xtuple_0 X1) -> False)
  ...
  -> (v4_ordinal1 esk1_0 -> v4_ordinal1 esk2_0 -> False)
  -> (forall X1, (X1 = k1_xboole_0 -> False) -> v1_xboole_0 X1 -> False)
  -> ((v4_ordinal1 esk1_0 -> False) -> (v4_ordinal1 esk2_0 -> False) -> False)
