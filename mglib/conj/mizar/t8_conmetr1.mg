...
Theorem t8_conmetr1:
 forall esk24_8:set -> set -> set -> set -> set -> set -> set -> set -> set,
 ...
 forall esk23_8:set -> set -> set -> set -> set -> set -> set -> set -> set,
 forall esk22_8:set -> set -> set -> set -> set -> set -> set -> set -> set,
 forall r2_hidden:set -> set -> prop,
 forall epred1_8:set -> set -> set -> set -> set -> set -> set -> set -> prop,
     (forall X2 X4 X6 X7 X8 X5 X3 X1, (epred1_8 X8 X7 X5 X4 X2 X1 X3 X6 -> False) -> r2_hidden (esk22_8 X1 X2 X3 X4 X5 X6 X7 X8) (esk23_8 X1 X2 X3 X4 X5 X6 X7 X8) -> False)
  -> (forall X2 X4 X6 X7 X8 X5 X3 X1, (epred1_8 X8 X7 X5 X4 X2 X1 X3 X6 -> False) -> (r2_hidden (esk22_8 X1 X2 X3 X4 X5 X6 X7 X8) (esk24_8 X1 X2 X3 X4 X5 X6 X7 X8) -> False) -> False)
  -> (forall X1 X3 X5 X7 X8 X6 X4 X2, (epred1_8 X1 X8 X2 X3 X5 X4 X6 X7 -> False) -> r2_analoaf X1 X2 X3 X4 (esk22_8 X4 X5 X6 X3 X2 X7 X8 X1) -> False)
  -> (forall X1 X2 X4 X6 X8 X7 X5 X3, (epred1_8 X8 X1 X6 X5 X3 X2 X4 X7 -> False) -> r2_hidden X1 (esk24_8 X2 X3 X4 X5 X6 X7 X1 X8) -> False)
  -> (forall X1 X2 X4 X8 X7 X6 X5 X3, (epred1_8 X8 X7 X1 X5 X3 X2 X4 X6 -> False) -> r2_hidden X1 (esk24_8 X2 X3 X4 X5 X1 X6 X7 X8) -> False)
  -> (forall X1 X2 X4 X5 X8 X7 X6 X3, (epred1_8 X8 X7 X5 X1 X3 X2 X4 X6 -> False) -> r2_hidden X1 (esk23_8 X2 X3 X4 X1 X5 X6 X7 X8) -> False)
  -> (forall X1 X2 X3 X5 X8 X7 X6 X4, (epred1_8 X8 X7 X5 X4 X1 X2 X3 X6 -> False) -> r2_hidden X1 (esk23_8 X2 X1 X3 X4 X5 X6 X7 X8) -> False)
  -> (forall X1 X3 X5 X8 X7 X6 X4 X2, (epred1_8 X8 X7 X5 X4 X2 X1 X3 X6 -> False) -> r2_hidden X1 (esk24_8 X1 X2 X3 X4 X5 X6 X7 X8) -> False)
  -> (forall X1 X2 X5 X8 X7 X6 X4 X3, (epred1_8 X8 X7 X5 X4 X3 X2 X1 X6 -> False) -> r2_hidden X1 (esk24_8 X2 X3 X1 X4 X5 X6 X7 X8) -> False)
  -> (forall X1 X2 X4 X6 X8 X7 X5 X3, (epred1_8 X8 X7 X6 X5 X3 X2 X4 X1 -> False) -> r2_hidden X1 (esk23_8 X2 X3 X4 X5 X6 X1 X7 X8) -> False)
  -> (forall X1 X3 X6 X8 X7 X5 X4 X2, (epred1_8 X1 X2 X7 X3 X6 X5 X4 X8 -> False) -> (r2_analoaf X1 X2 X3 X4 (esk22_8 X5 X6 X4 X3 X7 X8 X2 X1) -> False) -> False)
  -> (forall X8 X2 X4 X6 X7 X5 X3 X1, (epred1_8 X8 X7 X5 X4 X2 X1 X3 X6 -> False) -> (m1_subset_1 (esk24_8 X1 X2 X3 X4 X5 X6 X7 X8) (k1_zfmisc_1 (u1_struct_0 X8)) -> False) -> False)
  -> (forall X8 X2 X4 X6 X7 X5 X3 X1, (epred1_8 X8 X7 X5 X4 X2 X1 X3 X6 -> False) -> (m1_subset_1 (esk23_8 X1 X2 X3 X4 X5 X6 X7 X8) (k1_zfmisc_1 (u1_struct_0 X8)) -> False) -> False)
  -> (forall X8 X2 X4 X6 X7 X5 X3 X1, (epred1_8 X8 X7 X5 X4 X2 X1 X3 X6 -> False) -> (m1_subset_1 (esk22_8 X1 X2 X3 X4 X5 X6 X7 X8) (u1_struct_0 X8) -> False) -> False)
  -> (forall X8 X2 X4 X6 X7 X5 X3 X1, (epred1_8 X8 X7 X5 X4 X2 X1 X3 X6 -> False) -> (v1_aff_1 (esk24_8 X1 X2 X3 X4 X5 X6 X7 X8) X8 -> False) -> False)
  -> (forall X8 X2 X4 X6 X7 X5 X3 X1, (epred1_8 X8 X7 X5 X4 X2 X1 X3 X6 -> False) -> (v1_aff_1 (esk23_8 X1 X2 X3 X4 X5 X6 X7 X8) X8 -> False) -> False)
  -> (forall X1 X2 X4 X6 X8 X7 X5 X3, (epred1_8 X8 X1 X6 X5 X3 X2 X4 X7 -> False) -> (r2_hidden X1 (esk23_8 X2 X3 X4 X5 X6 X7 X1 X8) -> False) -> False)
  -> (forall X1 X2 X4 X8 X7 X6 X5 X3, (epred1_8 X8 X7 X1 X5 X3 X2 X4 X6 -> False) -> (r2_hidden X1 (esk23_8 X2 X3 X4 X5 X1 X6 X7 X8) -> False) -> False)
  -> (forall X1 X2 X4 X5 X8 X7 X6 X3, (epred1_8 X8 X7 X5 X1 X3 X2 X4 X6 -> False) -> (r2_hidden X1 (esk24_8 X2 X3 X4 X1 X5 X6 X7 X8) -> False) -> False)
  -> (forall X1 X2 X3 X5 X8 X7 X6 X4, (epred1_8 X8 X7 X5 X4 X1 X2 X3 X6 -> False) -> (r2_hidden X1 (esk24_8 X2 X1 X3 X4 X5 X6 X7 X8) -> False) -> False)
  -> (forall X1 X3 X5 X8 X7 X6 X4 X2, (epred1_8 X8 X7 X5 X4 X2 X1 X3 X6 -> False) -> (r2_hidden X1 (esk23_8 X1 X2 X3 X4 X5 X6 X7 X8) -> False) -> False)
  -> (forall X1 X2 X5 X8 X7 X6 X4 X3, (epred1_8 X8 X7 X5 X4 X3 X2 X1 X6 -> False) -> (r2_hidden X1 (esk23_8 X2 X3 X1 X4 X5 X6 X7 X8) -> False) -> False)
  -> (forall X1 X2 X4 X6 X8 X7 X5 X3, (epred1_8 X8 X7 X6 X5 X3 X2 X4 X1 -> False) -> (r2_hidden X1 (esk24_8 X2 X3 X4 X5 X6 X1 X7 X8) -> False) -> False)
  -> (forall X8 X6 X4 X2 X1 X3 X5 X7 X11 X9 X10, (r2_hidden X9 X10 -> False) -> (r2_hidden X8 X10 -> False) -> (r2_hidden X7 X11 -> False) -> (r2_hidden X6 X11 -> False) -> (r2_hidden X5 X10 -> False) -> (r2_hidden X4 X10 -> False) -> (r2_hidden X3 X11 -> False) -> (r2_hidden X2 X11 -> False) -> (r2_analoaf X1 X3 X4 X6 X9 -> False) -> r2_hidden X9 X11 -> r2_hidden X8 X11 -> r2_hidden X7 X10 -> r2_hidden X6 X10 -> r2_hidden X5 X11 -> r2_hidden X4 X11 -> r2_hidden X3 X10 -> r2_hidden X2 X10 -> v1_aff_1 X11 X1 -> v1_aff_1 X10 X1 -> m1_subset_1 X9 (u1_struct_0 X1) -> r2_analoaf X1 X8 X2 X5 X7 -> r2_analoaf X1 X3 X8 X6 X5 -> r2_analoaf X1 X2 X4 X7 X9 -> m1_subset_1 X11 (k1_zfmisc_1 (u1_struct_0 X1)) -> m1_subset_1 X10 (k1_zfmisc_1 (u1_struct_0 X1)) -> epred1_8 X1 X2 X3 X4 X5 X6 X7 X8 -> False)
  -> (forall X1, (v7_struct_0 X1 -> False) -> (v3_conmetr1 X1 -> False) -> v1_diraf X1 -> v2_diraf X1 -> l1_analoaf X1 -> epred1_8 X1 (esk2_1 X1) (esk4_1 X1) (esk5_1 X1) (esk7_1 X1) (esk8_1 X1) (esk6_1 X1) (esk3_1 X1) -> False)
  -> (forall X7 X8 X6 X2 X5 X4 X3 X1, (r2_analoaf X1 X2 X3 X4 X5 -> False) -> (epred1_8 X1 X3 X6 X7 X4 X8 X5 X2 -> False) -> False)
  -> (forall X6 X7 X8 X2 X5 X4 X3 X1, (r2_analoaf X1 X2 X3 X4 X5 -> False) -> (epred1_8 X1 X6 X2 X7 X5 X4 X8 X3 -> False) -> False)
  -> (forall X8 X6 X4 X3 X2 X5 X7 X1, (v7_struct_0 X1 -> False) -> (epred1_8 X1 X2 X4 X5 X7 X8 X6 X3 -> False) -> v1_diraf X1 -> v2_diraf X1 -> l1_analoaf X1 -> v3_conmetr1 X1 -> m1_subset_1 X8 (u1_struct_0 X1) -> m1_subset_1 X7 (u1_struct_0 X1) -> m1_subset_1 X6 (u1_struct_0 X1) -> m1_subset_1 X5 (u1_struct_0 X1) -> m1_subset_1 X4 (u1_struct_0 X1) -> m1_subset_1 X3 (u1_struct_0 X1) -> m1_subset_1 X2 (u1_struct_0 X1) -> False)
  -> (forall X1 X2 X4 X6 X5 X3, (epred2_6 X1 X6 X5 X4 X3 X2 -> False) -> r2_analoaf X1 (esk25_6 X2 X3 X4 X5 X6 X1) (esk26_6 X2 X3 X4 X5 X6 X1) (esk28_6 X2 X3 X4 X5 X6 X1) (esk29_6 X2 X3 X4 X5 X6 X1) -> False)
  -> (forall X1 X3 X5 X6 X4 X2, (epred2_6 X1 X6 X5 X4 X3 X2 -> False) -> (r2_analoaf X1 X2 (esk26_6 X2 X3 X4 X5 X6 X1) (esk27_6 X2 X3 X4 X5 X6 X1) (esk29_6 X2 X3 X4 X5 X6 X1) -> False) -> False)
  -> (forall X1 X3 X5 X6 X4 X2, (epred2_6 X1 X6 X5 X4 X3 X2 -> False) -> (r2_analoaf X1 X2 (esk25_6 X2 X3 X4 X5 X6 X1) (esk27_6 X2 X3 X4 X5 X6 X1) (esk28_6 X2 X3 X4 X5 X6 X1) -> False) -> False)
  ...
  -> (forall X6 X2 X4 X5 X3 X1, (epred2_6 X6 X5 X4 X3 X2 X1 -> False) -> (m1_subset_1 (esk26_6 X1 X2 X3 X4 X5 X6) (u1_struct_0 X6) -> False) -> False)
  -> (forall X6 X2 X4 X5 X3 X1, (epred2_6 X6 X5 X4 X3 X2 X1 -> False) -> (m1_subset_1 (esk25_6 X1 X2 X3 X4 X5 X6) (u1_struct_0 X6) -> False) -> False)
  -> (forall X3 X2 X4 X5 X6 X1, (epred2_6 X6 X5 X4 X3 X2 X1 -> False) -> (r2_hidden (esk29_6 X1 X2 X3 X4 X5 X6) X3 -> False) -> False)
  -> (forall X4 X2 X5 X6 X3 X1, (epred2_6 X6 X5 X4 X3 X2 X1 -> False) -> (r2_hidden (esk28_6 X1 X2 X3 X4 X5 X6) X4 -> False) -> False)
  -> (forall X5 X2 X4 X6 X3 X1, (epred2_6 X6 X5 X4 X3 X2 X1 -> False) -> (r2_hidden (esk27_6 X1 X2 X3 X4 X5 X6) X5 -> False) -> False)
  -> (forall X3 X2 X4 X5 X6 X1, (epred2_6 X6 X5 X4 X3 X2 X1 -> False) -> (r2_hidden (esk26_6 X1 X2 X3 X4 X5 X6) X3 -> False) -> False)
  -> (forall X4 X2 X5 X6 X3 X1, (epred2_6 X6 X5 X4 X3 X2 X1 -> False) -> (r2_hidden (esk25_6 X1 X2 X3 X4 X5 X6) X4 -> False) -> False)
  -> (forall X1 X4 X5 X6 X3 X2, (epred2_6 X6 X5 X4 X3 X1 X2 -> False) -> (esk26_6 X2 X1 X3 X4 X5 X6) = X1 -> False)
  -> (forall X1 X4 X5 X6 X3 X2, (epred2_6 X6 X5 X4 X3 X1 X2 -> False) -> (esk25_6 X2 X1 X3 X4 X5 X6) = X1 -> False)
  ...
  -> (forall X1, (v7_struct_0 X1 -> False) -> (v4_aff_2 X1 -> False) -> v1_diraf X1 -> l1_analoaf X1 -> epred2_6 X1 (esk9_1 X1) (esk10_1 X1) (esk11_1 X1) (esk12_1 X1) (esk13_1 X1) -> False)
  ...
  -> (forall X1, (v7_struct_0 X1 -> False) -> (v4_aff_2 X1 -> False) -> (m1_subset_1 (esk10_1 X1) (k1_zfmisc_1 (u1_struct_0 X1)) -> False) -> v1_diraf X1 -> l1_analoaf X1 -> False)
  -> (forall X1, (v7_struct_0 X1 -> False) -> (v4_aff_2 X1 -> False) -> (m1_subset_1 (esk9_1 X1) (k1_zfmisc_1 (u1_struct_0 X1)) -> False) -> v1_diraf X1 -> l1_analoaf X1 -> False)
  -> (forall X2 X1 X3, v1_xboole_0 X3 -> r2_hidden X1 X2 -> m1_subset_1 X2 (k1_zfmisc_1 X3) -> False)
  -> (forall X1, (v7_struct_0 X1 -> False) -> (v3_conmetr1 X1 -> False) -> (m1_subset_1 (esk8_1 X1) (u1_struct_0 X1) -> False) -> v1_diraf X1 -> v2_diraf X1 -> l1_analoaf X1 -> False)
  -> (forall X1, (v7_struct_0 X1 -> False) -> (v3_conmetr1 X1 -> False) -> (m1_subset_1 (esk7_1 X1) (u1_struct_0 X1) -> False) -> v1_diraf X1 -> v2_diraf X1 -> l1_analoaf X1 -> False)
  -> (forall X1, (v7_struct_0 X1 -> False) -> (v3_conmetr1 X1 -> False) -> (m1_subset_1 (esk6_1 X1) (u1_struct_0 X1) -> False) -> v1_diraf X1 -> v2_diraf X1 -> l1_analoaf X1 -> False)
  -> (forall X1, (v7_struct_0 X1 -> False) -> (v3_conmetr1 X1 -> False) -> (m1_subset_1 (esk5_1 X1) (u1_struct_0 X1) -> False) -> v1_diraf X1 -> v2_diraf X1 -> l1_analoaf X1 -> False)
  -> (forall X1, (v7_struct_0 X1 -> False) -> (v3_conmetr1 X1 -> False) -> (m1_subset_1 (esk4_1 X1) (u1_struct_0 X1) -> False) -> v1_diraf X1 -> v2_diraf X1 -> l1_analoaf X1 -> False)
  -> (forall X1, (v7_struct_0 X1 -> False) -> (v3_conmetr1 X1 -> False) -> (m1_subset_1 (esk3_1 X1) (u1_struct_0 X1) -> False) -> v1_diraf X1 -> v2_diraf X1 -> l1_analoaf X1 -> False)
  -> (forall X1, (v7_struct_0 X1 -> False) -> (v3_conmetr1 X1 -> False) -> (m1_subset_1 (esk2_1 X1) (u1_struct_0 X1) -> False) -> v1_diraf X1 -> v2_diraf X1 -> l1_analoaf X1 -> False)
  ...
  -> (forall X1, (v7_struct_0 X1 -> False) -> (v4_aff_2 X1 -> False) -> (m1_subset_1 (esk13_1 X1) (u1_struct_0 X1) -> False) -> v1_diraf X1 -> l1_analoaf X1 -> False)
  -> (forall X1, (v7_struct_0 X1 -> False) -> (v4_aff_2 X1 -> False) -> (m1_subset_1 (esk12_1 X1) (u1_struct_0 X1) -> False) -> v1_diraf X1 -> l1_analoaf X1 -> False)
  -> (forall X2 X1, (r1_tarski X1 X2 -> False) -> m1_subset_1 X1 (k1_zfmisc_1 X2) -> False)
  -> (forall X2 X1, r2_hidden X2 X1 -> r2_hidden X1 X2 -> False)
  -> (forall X1, (v7_struct_0 X1 -> False) -> (v3_conmetr1 X1 -> False) -> v1_diraf X1 -> v2_diraf X1 -> l1_analoaf X1 -> v1_conmetr1 X1 -> v2_conmetr1 X1 -> False)
  -> (forall X2 X1, (m1_subset_1 X1 (k1_zfmisc_1 X2) -> False) -> r1_tarski X1 X2 -> False)
  -> (forall X1 X2, (v1_xboole_0 X2 -> False) -> (r2_hidden X1 X2 -> False) -> m1_subset_1 X1 X2 -> False)
  -> (forall X1, (v7_struct_0 X1 -> False) -> (v11_aff_2 X1 -> False) -> v1_diraf X1 -> v2_diraf X1 -> l1_analoaf X1 -> v12_aff_2 X1 -> False)
  -> (forall X1, (v7_struct_0 X1 -> False) -> (v2_conmetr1 X1 -> False) -> v1_diraf X1 -> v2_diraf X1 -> l1_analoaf X1 -> v3_conmetr1 X1 -> False)
  -> (forall X1, (v7_struct_0 X1 -> False) -> (v2_conmetr1 X1 -> False) -> v1_diraf X1 -> v2_diraf X1 -> l1_analoaf X1 -> v4_aff_2 X1 -> False)
  -> (forall X1, (v7_struct_0 X1 -> False) -> (v1_conmetr1 X1 -> False) -> v1_diraf X1 -> v2_diraf X1 -> l1_analoaf X1 -> v11_aff_2 X1 -> False)
  -> (forall X1, (v7_struct_0 X1 -> False) -> (v1_conmetr1 X1 -> False) -> v1_diraf X1 -> v2_diraf X1 -> l1_analoaf X1 -> v3_conmetr1 X1 -> False)
  -> (forall X1, (v7_struct_0 X1 -> False) -> (v12_aff_2 X1 -> False) -> v1_diraf X1 -> v2_diraf X1 -> l1_analoaf X1 -> v11_aff_2 X1 -> False)
  -> (forall X1, (v7_struct_0 X1 -> False) -> (v12_aff_2 X1 -> False) -> v1_diraf X1 -> v2_diraf X1 -> l1_analoaf X1 -> v8_aff_2 X1 -> False)
  -> (forall X1, (v7_struct_0 X1 -> False) -> (v8_aff_2 X1 -> False) -> v1_diraf X1 -> v2_diraf X1 -> l1_analoaf X1 -> v7_aff_2 X1 -> False)
  -> (forall X1, (v7_struct_0 X1 -> False) -> (v7_aff_2 X1 -> False) -> v1_diraf X1 -> v2_diraf X1 -> l1_analoaf X1 -> v4_aff_2 X1 -> False)
  ...
  -> (v4_aff_2 esk1_0 -> v3_conmetr1 esk1_0 -> False)
  -> ((v4_aff_2 esk1_0 -> False) -> (v3_conmetr1 esk1_0 -> False) -> False)
