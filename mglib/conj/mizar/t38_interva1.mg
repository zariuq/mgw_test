...
Theorem t38_interva1:
 ...
 forall v1_xboole_0:set -> prop,
     (forall X2 X4 X1 X3, (v1_xboole_0 X3 -> False) -> (v1_xboole_0 X2 -> False) -> (v1_xboole_0 X1 -> False) -> (r1_tarski (k7_subset_1 X1 (k7_interva1 X1 X2) (k8_interva1 X1 X3)) (esk12_4 X4 X1 X2 X3) -> False) -> v1_interva1 X3 X1 -> v1_interva1 X2 X1 -> m1_subset_1 X3 (k1_zfmisc_1 (k1_zfmisc_1 X1)) -> m1_subset_1 X2 (k1_zfmisc_1 (k1_zfmisc_1 X1)) -> r2_hidden X4 (a_3_1_interva1 X1 X2 X3) -> False)
  -> (forall X3 X1 X2 X4, (v1_xboole_0 X4 -> False) -> (v1_xboole_0 X3 -> False) -> (v1_xboole_0 X2 -> False) -> (r1_tarski (esk12_4 X1 X2 X3 X4) (k7_subset_1 X2 (k8_interva1 X2 X3) (k7_interva1 X2 X4)) -> False) -> v1_interva1 X4 X2 -> v1_interva1 X3 X2 -> m1_subset_1 X4 (k1_zfmisc_1 (k1_zfmisc_1 X2)) -> m1_subset_1 X3 (k1_zfmisc_1 (k1_zfmisc_1 X2)) -> r2_hidden X1 (a_3_1_interva1 X2 X3 X4) -> False)
  -> (forall X3 X2 X4 X1, ((k4_xboole_0 (esk5_4 X2 X3 X4 X1) (esk6_4 X2 X3 X4 X1)) = X1 -> False) -> X4 = (k4_setfam_1 X2 X3) -> r2_hidden X1 X4 -> False)
  ...
  -> (forall X3 X1 X2 X4, (v1_xboole_0 X4 -> False) -> (v1_xboole_0 X3 -> False) -> (v1_xboole_0 X2 -> False) -> (m1_subset_1 (esk12_4 X1 X2 X3 X4) (k1_zfmisc_1 X2) -> False) -> v1_interva1 X4 X2 -> v1_interva1 X3 X2 -> m1_subset_1 X4 (k1_zfmisc_1 (k1_zfmisc_1 X2)) -> m1_subset_1 X3 (k1_zfmisc_1 (k1_zfmisc_1 X2)) -> r2_hidden X1 (a_3_1_interva1 X2 X3 X4) -> False)
  -> (forall X3 X1 X2 X4, ((esk12_4 X1 X2 X3 X4) = X1 -> False) -> (v1_xboole_0 X4 -> False) -> (v1_xboole_0 X3 -> False) -> (v1_xboole_0 X2 -> False) -> v1_interva1 X4 X2 -> v1_interva1 X3 X2 -> m1_subset_1 X4 (k1_zfmisc_1 (k1_zfmisc_1 X2)) -> m1_subset_1 X3 (k1_zfmisc_1 (k1_zfmisc_1 X2)) -> r2_hidden X1 (a_3_1_interva1 X2 X3 X4) -> False)
  -> (forall X2 X1 X3 X4, (r2_hidden (esk6_4 X1 X2 X3 X4) X2 -> False) -> X3 = (k4_setfam_1 X1 X2) -> r2_hidden X4 X3 -> False)
  -> (forall X2 X1 X3 X4, (r2_hidden (esk5_4 X1 X2 X3 X4) X1 -> False) -> X3 = (k4_setfam_1 X1 X2) -> r2_hidden X4 X3 -> False)
  -> (forall X3 X2 X1, (X3 = (k4_setfam_1 X1 X2) -> False) -> ((k4_xboole_0 (esk8_3 X1 X2 X3) (esk9_3 X1 X2 X3)) = (esk7_3 X1 X2 X3) -> False) -> (r2_hidden (esk7_3 X1 X2 X3) X3 -> False) -> False)
  -> (forall X5 X4 X1 X2 X3, (X3 = (k4_setfam_1 X1 X2) -> False) -> (esk7_3 X1 X2 X3) = (k4_xboole_0 X4 X5) -> r2_hidden X5 X2 -> r2_hidden X4 X1 -> r2_hidden (esk7_3 X1 X2 X3) X3 -> False)
  -> (forall X2 X1 X3, (X1 = (k7_interva1 X2 X3) -> False) -> (v1_xboole_0 X3 -> False) -> v1_interva1 X3 X2 -> r2_hidden X1 X3 -> m1_subset_1 X3 (k1_zfmisc_1 (k1_zfmisc_1 X2)) -> r1_tarski X1 (esk13_3 X2 X3 X1) -> False)
  -> (forall X2 X3 X1, (X3 = (k4_setfam_1 X1 X2) -> False) -> (r2_hidden (esk7_3 X1 X2 X3) X3 -> False) -> (r2_hidden (esk9_3 X1 X2 X3) X2 -> False) -> False)
  -> (forall X1 X3 X2, (X3 = (k4_setfam_1 X1 X2) -> False) -> (r2_hidden (esk7_3 X1 X2 X3) X3 -> False) -> (r2_hidden (esk8_3 X1 X2 X3) X1 -> False) -> False)
  -> (forall X1 X3 X2, (X3 = (k7_interva1 X1 X2) -> False) -> (v1_xboole_0 X2 -> False) -> (r2_hidden (esk13_3 X1 X2 X3) X2 -> False) -> v1_interva1 X2 X1 -> r2_hidden X3 X2 -> m1_subset_1 X2 (k1_zfmisc_1 (k1_zfmisc_1 X1)) -> False)
  ...
  -> (forall X2 X3 X1, (v1_xboole_0 X1 -> False) -> (m1_subset_1 (k4_setfam_1 X2 X3) (k1_zfmisc_1 (k1_zfmisc_1 X1)) -> False) -> m1_subset_1 X3 (k1_zfmisc_1 (k1_zfmisc_1 X1)) -> m1_subset_1 X2 (k1_zfmisc_1 (k1_zfmisc_1 X1)) -> False)
  ...
  -> (forall X4 X1 X2 X3, (v1_xboole_0 X3 -> False) -> (r1_tarski X1 X4 -> False) -> X1 = (k7_interva1 X2 X3) -> v1_interva1 X3 X2 -> r2_hidden X4 X3 -> r2_hidden X1 X3 -> m1_subset_1 X3 (k1_zfmisc_1 (k1_zfmisc_1 X2)) -> False)
  ...
  -> (forall X4 X2 X1 X3 X5 X6, (r2_hidden X5 X6 -> False) -> X6 = (k4_setfam_1 X2 X4) -> X5 = (k4_xboole_0 X1 X3) -> r2_hidden X3 X4 -> r2_hidden X1 X2 -> False)
  ...
  -> ((a_3_1_interva1 esk1_0 esk2_0 esk3_0) = (k4_setfam_1 esk2_0 esk3_0) -> False)
  -> (forall X1, v1_subset_1 (esk19_1 X1) X1 -> False)
  -> (forall X1, v1_xboole_0 (esk16_1 X1) -> False)
  ...
  -> (forall X1, (m1_subset_1 (esk16_1 X1) (k1_zfmisc_1 (k1_zfmisc_1 X1)) -> False) -> False)
  -> (forall X2 X1, ((k3_xboole_0 X1 X2) = (k3_xboole_0 X2 X1) -> False) -> False)
  -> (forall X2 X1, ((k2_xboole_0 X1 X2) = (k2_xboole_0 X2 X1) -> False) -> False)
  -> (forall X1, (r1_tarski (k1_setfam_1 X1) (k3_tarski X1) -> False) -> False)
  ...
  -> (forall X1, (v1_interva1 (esk16_1 X1) X1 -> False) -> False)
