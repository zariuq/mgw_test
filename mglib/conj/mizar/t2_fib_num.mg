...
Theorem t2_fib_num:
 ...
 forall k3_int_2:set -> set -> set,
     (forall X2 X1 X3, (X3 = (k3_int_2 X1 X2) -> False) -> v7_ordinal1 X3 -> v7_ordinal1 X2 -> v7_ordinal1 X1 -> r1_nat_d X3 X2 -> r1_nat_d X3 X1 -> r1_nat_d (esk6_3 X1 X2 X3) X3 -> False)
  -> (forall X1 X3 X2 X5 X6 X4, ((k3_int_2 X4 (k4_nat_1 X5 X6)) = (k3_int_2 X4 X6) -> False) -> ((k3_int_2 X1 (k4_nat_1 X2 X3)) = (k3_int_2 X1 X3) -> False) -> (r1_xxreal_0 esk25_0 X1 -> False) -> (k3_int_2 X4 X5) = np__1 -> (k3_int_2 X1 X2) = np__1 -> v7_ordinal1 X4 -> v7_ordinal1 X1 -> m1_subset_1 X6 k5_numbers -> m1_subset_1 X5 k5_numbers -> m1_subset_1 X3 k5_numbers -> m1_subset_1 X2 k5_numbers -> False)
  -> (forall X2 X1 X3, (X3 = (k3_int_2 X1 X2) -> False) -> (r1_nat_d (esk6_3 X1 X2 X3) X1 -> False) -> v7_ordinal1 X3 -> v7_ordinal1 X2 -> v7_ordinal1 X1 -> r1_nat_d X3 X2 -> r1_nat_d X3 X1 -> False)
  -> (forall X2 X1 X3, (X3 = (k3_int_2 X1 X2) -> False) -> (r1_nat_d (esk6_3 X1 X2 X3) X2 -> False) -> v7_ordinal1 X3 -> v7_ordinal1 X2 -> v7_ordinal1 X1 -> r1_nat_d X3 X2 -> r1_nat_d X3 X1 -> False)
  -> (forall X2 X1 X3, (X3 = (k3_int_2 X1 X2) -> False) -> (v7_ordinal1 (esk6_3 X1 X2 X3) -> False) -> v7_ordinal1 X3 -> v7_ordinal1 X2 -> v7_ordinal1 X1 -> r1_nat_d X3 X2 -> r1_nat_d X3 X1 -> False)
  -> (forall X3 X2 X1, ((k3_int_2 X1 (k4_nat_1 X2 X3)) = (k3_int_2 X1 X3) -> False) -> (k3_int_2 X1 X2) = np__1 -> (k3_int_2 esk25_0 (k4_nat_1 esk26_0 esk27_0)) = (k3_int_2 esk25_0 esk27_0) -> v7_ordinal1 X1 -> m1_subset_1 X3 k5_numbers -> m1_subset_1 X2 k5_numbers -> False)
  -> (forall X1 X2 X3, ((k6_nat_d (k4_nat_1 X1 X2) (k4_nat_1 X1 X3)) = (k4_nat_1 X1 (k6_nat_d X2 X3)) -> False) -> m1_subset_1 X3 k5_numbers -> m1_subset_1 X2 k5_numbers -> m1_subset_1 X1 k5_numbers -> False)
  -> (forall X1 X3 X2, (v1_xboole_0 X2 -> False) -> (v1_xboole_0 X1 -> False) -> (m1_subset_1 X3 X1 -> False) -> m2_subset_1 X3 X1 X2 -> m1_subset_1 X2 (k1_zfmisc_1 X1) -> False)
  -> (forall X2 X1 X3, (v1_xboole_0 X3 -> False) -> (v1_xboole_0 X2 -> False) -> (m1_subset_1 X1 X3 -> False) -> m2_subset_1 X1 X2 X3 -> m1_subset_1 X3 (k1_zfmisc_1 X2) -> False)
  -> (forall X1 X2 X3, ((k3_int_2 X1 (k4_nat_1 X2 X3)) = (k3_int_2 X1 X3) -> False) -> (m1_subset_1 esk27_0 k5_numbers -> False) -> (k3_int_2 X1 X2) = np__1 -> v7_ordinal1 X1 -> m1_subset_1 X3 k5_numbers -> m1_subset_1 X2 k5_numbers -> False)
  -> (forall X1 X2 X3, ((k3_int_2 X1 (k4_nat_1 X2 X3)) = (k3_int_2 X1 X3) -> False) -> (m1_subset_1 esk26_0 k5_numbers -> False) -> (k3_int_2 X1 X2) = np__1 -> v7_ordinal1 X1 -> m1_subset_1 X3 k5_numbers -> m1_subset_1 X2 k5_numbers -> False)
  -> (forall X1 X2 X3, ((k3_int_2 esk25_0 esk26_0) = np__1 -> False) -> ((k3_int_2 X1 (k4_nat_1 X2 X3)) = (k3_int_2 X1 X3) -> False) -> (k3_int_2 X1 X2) = np__1 -> v7_ordinal1 X1 -> m1_subset_1 X3 k5_numbers -> m1_subset_1 X2 k5_numbers -> False)
  -> (forall X1 X2 X3, ((k3_int_2 X1 (k4_nat_1 X2 X3)) = (k3_int_2 X1 X3) -> False) -> (v7_ordinal1 esk25_0 -> False) -> (k3_int_2 X1 X2) = np__1 -> v7_ordinal1 X1 -> m1_subset_1 X3 k5_numbers -> m1_subset_1 X2 k5_numbers -> False)
  ...
  -> (forall X2 X1 X3, (r1_nat_d X1 X3 -> False) -> (r1_nat_d X1 X2 -> False) -> v7_ordinal1 X3 -> v7_ordinal1 X2 -> v7_ordinal1 X1 -> v1_int_2 X1 -> r1_nat_d X1 (k3_xcmplx_0 X2 X3) -> False)
  ...
  -> (forall X2 X1, (r1_xxreal_0 X1 k6_numbers -> False) -> v1_xreal_0 X2 -> v1_xreal_0 X1 -> r1_xxreal_0 (k2_xcmplx_0 X2 X1) X2 -> False)
  -> (forall X2 X1 X3, (r1_nat_d X1 X3 -> False) -> v7_ordinal1 X3 -> v7_ordinal1 X2 -> v7_ordinal1 X1 -> r1_nat_d X2 X3 -> r1_nat_d X1 X2 -> False)
  ...
  -> (forall X2 X1, ((k2_xcmplx_0 X1 (k4_xcmplx_0 X2)) = (k6_xcmplx_0 X1 X2) -> False) -> v1_xcmplx_0 X2 -> v1_xcmplx_0 X1 -> False)
  -> (forall X2 X1, (X1 = X2 -> False) -> (X1 = np__1 -> False) -> v7_ordinal1 X2 -> v7_ordinal1 X1 -> v1_int_2 X2 -> r1_int_1 X1 X2 -> False)
  -> (forall X1, (r1_int_1 (esk28_1 X1) X1 -> False) -> v7_ordinal1 X1 -> r1_xxreal_0 np__2 X1 -> False)
  -> (forall X2 X1, (r1_tarski X1 X2 -> False) -> m1_subset_1 X1 (k1_zfmisc_1 X2) -> False)
  -> (forall X1, (m1_subset_1 (esk28_1 X1) k5_numbers -> False) -> v7_ordinal1 X1 -> r1_xxreal_0 np__2 X1 -> False)
  -> (forall X2 X1, r2_hidden X2 X1 -> r2_hidden X1 X2 -> False)
  -> (forall X1, (v1_int_2 X1 -> False) -> (r1_xxreal_0 X1 np__1 -> False) -> (r1_int_1 (esk5_1 X1) X1 -> False) -> v7_ordinal1 X1 -> False)
  ...
  -> (forall X2 X1, ((k6_nat_d X1 X2) = (k3_int_2 X1 X2) -> False) -> v7_ordinal1 X2 -> v7_ordinal1 X1 -> False)
  ...
  -> (forall X1, (v1_int_2 (esk28_1 X1) -> False) -> v7_ordinal1 X1 -> r1_xxreal_0 np__2 X1 -> False)
  ...
  -> (forall X1, (v1_int_2 X1 -> False) -> (v7_ordinal1 (esk5_1 X1) -> False) -> (r1_xxreal_0 X1 np__1 -> False) -> v7_ordinal1 X1 -> False)
  -> (forall X1, v7_ordinal1 X1 -> v1_int_2 X1 -> r1_xxreal_0 X1 np__1 -> False)
  ...
  -> (forall X1, (v1_int_2 X1 -> False) -> (r1_xxreal_0 X1 np__1 -> False) -> (esk5_1 X1) = X1 -> v7_ordinal1 X1 -> False)
  ...
  -> (forall X1, (v1_int_2 X1 -> False) -> (r1_xxreal_0 X1 np__1 -> False) -> (esk5_1 X1) = np__1 -> v7_ordinal1 X1 -> False)
  ...
  -> (forall X1, (X1 = np__1 -> False) -> (X1 = k6_numbers -> False) -> v7_ordinal1 X1 -> r1_xxreal_0 X1 np__1 -> False)
  -> (forall X1 X2, v1_xboole_0 X2 -> r2_hidden X1 X2 -> False)
  -> (forall X1, (k6_numbers = X1 -> False) -> v7_ordinal1 X1 -> r1_xxreal_0 X1 k6_numbers -> False)
  -> (forall X1, (X1 = k6_numbers -> False) -> v1_int_1 X1 -> r1_int_1 k6_numbers X1 -> False)
  -> (forall X1, (X1 = np__1 -> False) -> v7_ordinal1 X1 -> r1_nat_d X1 np__1 -> False)
  ...
  -> (forall X1, (v2_setfam_1 X1 -> False) -> (m1_subset_1 (esk20_1 X1) X1 -> False) -> False)
  ...
  -> (forall X1, (r1_int_1 k6_numbers X1 -> False) -> X1 = k6_numbers -> v1_int_1 X1 -> False)
  ...
  -> (forall X1, (v2_setfam_1 X1 -> False) -> v1_xboole_0 (esk20_1 X1) -> False)
  ...
  -> (forall X1, ((k6_nat_d X1 np__1) = np__1 -> False) -> v7_ordinal1 X1 -> False)
  ...
  -> ((k3_int_2 esk1_0 (k4_nat_1 esk2_0 esk3_0)) = (k3_int_2 esk1_0 esk3_0) -> False)
  ...
  -> ((m1_subset_1 esk10_0 k1_numbers -> False) -> False)
  ...
  -> (((k3_int_2 esk1_0 esk2_0) = np__1 -> False) -> False)
  ...
  -> ((v5_finset_1 esk24_0 -> False) -> False)
