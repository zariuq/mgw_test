...
Theorem t45_wellord1:
 ...
 forall r3_wellord1:set -> set -> set -> prop,
  ...
  -> (forall X3 X1 X2, (r2_hidden (k2_tarski (k2_tarski X3 (k1_funct_1 X2 X3)) (k1_tarski X3)) X1 -> False) -> (k1_relat_1 X1) = (k9_xtuple_0 X2) -> (esk25_2 X1 X2) = (esk24_2 X1 X2) -> v1_relat_1 X2 -> v1_relat_1 X1 -> v2_wellord1 X1 -> v1_funct_1 X2 -> r2_hidden X3 (k1_relat_1 X1) -> r1_tarski (k10_xtuple_0 X2) (k1_relat_1 X1) -> False)
  ...
  -> (forall X1, (v4_relat_2 X1 -> False) -> (r2_hidden (k2_tarski (k2_tarski (esk14_1 X1) (esk13_1 X1)) (k1_tarski (esk14_1 X1))) X1 -> False) -> v1_relat_1 X1 -> False)
  -> (forall X1, (v4_relat_2 X1 -> False) -> (r2_hidden (k2_tarski (k2_tarski (esk13_1 X1) (esk14_1 X1)) (k1_tarski (esk13_1 X1))) X1 -> False) -> v1_relat_1 X1 -> False)
  ...
  -> (forall X3 X2 X1, ((k1_relat_1 X2) = (k9_xtuple_0 X1) -> False) -> v1_relat_1 X3 -> v1_relat_1 X2 -> v1_relat_1 X1 -> v1_funct_1 X1 -> r3_wellord1 X2 X3 X1 -> False)
  -> (forall X3 X2 X1, ((k1_relat_1 X2) = (k10_xtuple_0 X1) -> False) -> v1_relat_1 X3 -> v1_relat_1 X2 -> v1_relat_1 X1 -> v1_funct_1 X1 -> r3_wellord1 X3 X2 X1 -> False)
  ...
  -> (forall X1, (v4_relat_2 X1 -> False) -> (esk14_1 X1) = (esk13_1 X1) -> v1_relat_1 X1 -> False)
  ...
  -> ((r3_wellord1 esk1_0 esk2_0 esk4_0 -> False) -> False)
