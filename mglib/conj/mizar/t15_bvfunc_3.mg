...
Theorem t15_bvfunc_3:
 ...
 forall k9_bvfunc_1:set -> set -> set -> set,
  ...
  -> (forall X6 X5 X4 X1 X7 X3 X2, ((k3_funct_2 X1 k6_margrel1 (k9_bvfunc_1 X1 X2 X3) X7) = k8_margrel1 -> False) -> (v1_xboole_0 X1 -> False) -> (k3_funct_2 X1 k6_margrel1 (k6_bvfunc_2 X1 (k9_bvfunc_1 X1 X2 X3) X4 X5) X6) = k8_margrel1 -> v1_funct_1 X3 -> v1_funct_1 X2 -> m1_subset_1 X7 X1 -> m1_subset_1 X6 X1 -> m1_eqrel_1 X5 X1 -> v1_funct_2 X3 X1 k6_margrel1 -> v1_funct_2 X2 X1 k6_margrel1 -> m1_subset_1 X4 (k1_zfmisc_1 (k1_bvfunc_2 X1)) -> m1_subset_1 X3 (k1_zfmisc_1 (k2_zfmisc_1 X1 k6_margrel1)) -> m1_subset_1 X2 (k1_zfmisc_1 (k2_zfmisc_1 X1 k6_margrel1)) -> r2_hidden X7 (k15_bvfunc_1 X1 X6 (k5_bvfunc_2 X1 X5 X4)) -> False)
  ...
  -> (r1_bvfunc_1 esk1_0 (k6_bvfunc_2 esk1_0 (k9_bvfunc_1 esk1_0 esk3_0 esk4_0) esk2_0 esk5_0) (k9_bvfunc_1 esk1_0 (k7_bvfunc_2 esk1_0 esk3_0 esk2_0 esk5_0) (k7_bvfunc_2 esk1_0 esk4_0 esk2_0 esk5_0)) -> False)
