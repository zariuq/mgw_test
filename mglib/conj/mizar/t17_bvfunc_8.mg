...
Theorem t17_bvfunc_8:
 ...
 forall r2_funct_2:set -> set -> set -> set -> prop,
     (forall X1 X3 X2 X4, (r2_funct_2 X2 X3 X1 X4 -> False) -> (k1_funct_1 X1 (esk4_4 X2 X3 X1 X4)) = (k1_funct_1 X4 (esk4_4 X2 X3 X1 X4)) -> v1_funct_1 X4 -> v1_funct_1 X1 -> v1_funct_2 X4 X2 X3 -> v1_funct_2 X1 X2 X3 -> m1_subset_1 X4 (k1_zfmisc_1 (k2_zfmisc_1 X2 X3)) -> m1_subset_1 X1 (k1_zfmisc_1 (k2_zfmisc_1 X2 X3)) -> False)
  ...
  -> (forall X3 X2 X1 X4, (r2_funct_2 X1 X2 X3 X4 -> False) -> (m1_subset_1 (esk4_4 X1 X2 X3 X4) X1 -> False) -> v1_funct_1 X4 -> v1_funct_1 X3 -> v1_funct_2 X4 X1 X2 -> v1_funct_2 X3 X1 X2 -> m1_subset_1 X4 (k1_zfmisc_1 (k2_zfmisc_1 X1 X2)) -> m1_subset_1 X3 (k1_zfmisc_1 (k2_zfmisc_1 X1 X2)) -> False)
  ...
  -> (r2_funct_2 esk1_0 k6_margrel1 (k1_bvfunc_1 esk1_0 (k6_bvfunc_1 esk1_0 esk2_0 esk3_0)) (k6_bvfunc_1 esk1_0 esk2_0 (k1_bvfunc_1 esk1_0 esk3_0)) -> False)
