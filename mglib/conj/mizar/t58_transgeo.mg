...
Theorem t58_transgeo:
 ...
 forall v7_struct_0:set -> prop,
  ...
  -> (forall X1 X6 X4 X5 X2 X3, (X2 = X3 -> False) -> (v7_struct_0 X1 -> False) -> (r3_diraf X1 X2 X4 X5 -> False) -> (r2_analoaf X1 X4 X5 (k3_funct_2 (u1_struct_0 X1) (u1_struct_0 X1) X6 X5) (k3_funct_2 (u1_struct_0 X1) (u1_struct_0 X1) X6 X4) -> False) -> (k3_funct_2 (u1_struct_0 X1) (u1_struct_0 X1) X6 X2) = X2 -> v2_analoaf X1 -> l1_analoaf X1 -> v1_funct_1 X6 -> v4_transgeo X6 X1 -> m1_subset_1 X5 (u1_struct_0 X1) -> m1_subset_1 X4 (u1_struct_0 X1) -> m1_subset_1 X3 (u1_struct_0 X1) -> m1_subset_1 X2 (u1_struct_0 X1) -> v1_funct_2 X6 (u1_struct_0 X1) (u1_struct_0 X1) -> v3_funct_2 X6 (u1_struct_0 X1) (u1_struct_0 X1) -> m1_subset_1 X6 (k1_zfmisc_1 (k2_zfmisc_1 (u1_struct_0 X1) (u1_struct_0 X1))) -> r1_diraf X1 X3 X2 (k3_funct_2 (u1_struct_0 X1) (u1_struct_0 X1) X6 X3) -> False)
  ...
  -> (forall X1 X4 X5 X2 X3, (X2 = X3 -> False) -> (v7_struct_0 X1 -> False) -> (r1_diraf X1 X4 X2 (k3_funct_2 (u1_struct_0 X1) (u1_struct_0 X1) X5 X4) -> False) -> (k3_funct_2 (u1_struct_0 X1) (u1_struct_0 X1) X5 X2) = X2 -> v2_analoaf X1 -> l1_analoaf X1 -> v1_funct_1 X5 -> v4_transgeo X5 X1 -> m1_subset_1 X4 (u1_struct_0 X1) -> m1_subset_1 X3 (u1_struct_0 X1) -> m1_subset_1 X2 (u1_struct_0 X1) -> v1_funct_2 X5 (u1_struct_0 X1) (u1_struct_0 X1) -> v3_funct_2 X5 (u1_struct_0 X1) (u1_struct_0 X1) -> m1_subset_1 X5 (k1_zfmisc_1 (k2_zfmisc_1 (u1_struct_0 X1) (u1_struct_0 X1))) -> r1_diraf X1 X3 X2 (k3_funct_2 (u1_struct_0 X1) (u1_struct_0 X1) X5 X3) -> False)
  ...
  -> (forall X4 X3 X2 X1, (v7_struct_0 X1 -> False) -> (r2_diraf X1 X2 X3 X4 (esk25_4 X1 X2 X3 X4) -> False) -> v2_analoaf X1 -> l1_analoaf X1 -> m1_subset_1 X4 (u1_struct_0 X1) -> m1_subset_1 X3 (u1_struct_0 X1) -> m1_subset_1 X2 (u1_struct_0 X1) -> False)
  -> (forall X4 X3 X2 X1, (v7_struct_0 X1 -> False) -> (r2_diraf X1 X2 X3 X4 (esk25_4 X1 X2 X4 X3) -> False) -> v2_analoaf X1 -> l1_analoaf X1 -> m1_subset_1 X4 (u1_struct_0 X1) -> m1_subset_1 X3 (u1_struct_0 X1) -> m1_subset_1 X2 (u1_struct_0 X1) -> False)
  ...
  -> (forall X1 X2 X3, (X2 = X3 -> False) -> (v7_struct_0 X1 -> False) -> v2_analoaf X1 -> l1_analoaf X1 -> m1_subset_1 X3 (u1_struct_0 X1) -> m1_subset_1 X2 (u1_struct_0 X1) -> r3_diraf X1 X2 X3 (esk26_3 X1 X2 X3) -> False)
  -> (forall X4 X3 X2 X1, (v7_struct_0 X1 -> False) -> (m1_subset_1 (esk25_4 X1 X2 X3 X4) (u1_struct_0 X1) -> False) -> v2_analoaf X1 -> l1_analoaf X1 -> m1_subset_1 X4 (u1_struct_0 X1) -> m1_subset_1 X3 (u1_struct_0 X1) -> m1_subset_1 X2 (u1_struct_0 X1) -> False)
  ...
  -> (forall X1 X2 X3, (X2 = X3 -> False) -> (v7_struct_0 X1 -> False) -> (m1_subset_1 (esk26_3 X1 X2 X3) (u1_struct_0 X1) -> False) -> v2_analoaf X1 -> l1_analoaf X1 -> m1_subset_1 X3 (u1_struct_0 X1) -> m1_subset_1 X2 (u1_struct_0 X1) -> False)
  ...
  -> (r2_analoaf esk1_0 esk4_0 esk5_0 (k3_funct_2 (u1_struct_0 esk1_0) (u1_struct_0 esk1_0) esk6_0 esk5_0) (k3_funct_2 (u1_struct_0 esk1_0) (u1_struct_0 esk1_0) esk6_0 esk4_0) -> False)
  ...
  -> (esk3_0 = esk2_0 -> False)
  -> ((r1_diraf esk1_0 esk3_0 esk2_0 (k3_funct_2 (u1_struct_0 esk1_0) (u1_struct_0 esk1_0) esk6_0 esk3_0) -> False) -> False)
  -> (((k3_funct_2 (u1_struct_0 esk1_0) (u1_struct_0 esk1_0) esk6_0 esk2_0) = esk2_0 -> False) -> False)
  -> ((r3_diraf esk1_0 esk2_0 esk4_0 esk5_0 -> False) -> False)
  ...
  -> ((m1_subset_1 esk6_0 (k1_zfmisc_1 (k2_zfmisc_1 (u1_struct_0 esk1_0) (u1_struct_0 esk1_0))) -> False) -> False)
  ...
  -> ((v3_funct_2 esk6_0 (u1_struct_0 esk1_0) (u1_struct_0 esk1_0) -> False) -> False)
  -> ((v1_funct_2 esk6_0 (u1_struct_0 esk1_0) (u1_struct_0 esk1_0) -> False) -> False)
  ...
  -> ((v4_transgeo esk6_0 esk1_0 -> False) -> False)
