...
Theorem t41_waybel26:
 forall esk8_3:set -> set -> set -> set,
 forall esk7_3:set -> set -> set -> set,
 forall k9_xtuple_0:set -> set,
 forall esk3_3:set -> set -> set -> set,
 forall esk4_2:set -> set -> set,
 forall k6_waybel26:set -> set -> set,
 ...
 forall k2_card_3:set -> set,
 forall k2_relat_1:set -> set,
 forall v1_zfmisc_1:set -> prop,
 forall v4_funct_1:set -> prop,
 forall k5_waybel26:set -> set,
 ...
 forall k7_relat_1:set -> set -> set,
     (forall X2 X4 X3 X1, (r2_hidden (k2_tarski (k2_tarski (esk6_4 X1 X2 X3 X4) X4) (k1_tarski (esk6_4 X1 X2 X3 X4))) X1 -> False) -> X3 = (k7_relat_1 X1 X2) -> v1_relat_1 X1 -> r2_hidden X4 X3 -> False)
  -> (forall X3 X2 X1, (X3 = (k7_relat_1 X1 X2) -> False) -> (r2_hidden (esk7_3 X1 X2 X3) X3 -> False) -> (r2_hidden (k2_tarski (k2_tarski (esk8_3 X1 X2 X3) (esk7_3 X1 X2 X3)) (k1_tarski (esk8_3 X1 X2 X3))) X1 -> False) -> v1_relat_1 X1 -> False)
  -> (forall X1 X2, (X1 = X2 -> False) -> v1_relat_1 X2 -> v1_relat_1 X1 -> r2_hidden (k2_tarski (k2_tarski (esk10_2 X1 X2) (esk11_2 X1 X2)) (k1_tarski (esk10_2 X1 X2))) X2 -> r2_hidden (k2_tarski (k2_tarski (esk10_2 X1 X2) (esk11_2 X1 X2)) (k1_tarski (esk10_2 X1 X2))) X1 -> False)
  -> (forall X4 X1 X2 X3, (X3 = (k7_relat_1 X1 X2) -> False) -> v1_relat_1 X1 -> r2_hidden X4 X2 -> r2_hidden (esk7_3 X1 X2 X3) X3 -> r2_hidden (k2_tarski (k2_tarski X4 (esk7_3 X1 X2 X3)) (k1_tarski X4)) X1 -> False)
  -> (forall X2 X1, (X1 = X2 -> False) -> (r2_hidden (k2_tarski (k2_tarski (esk10_2 X1 X2) (esk11_2 X1 X2)) (k1_tarski (esk10_2 X1 X2))) X2 -> False) -> (r2_hidden (k2_tarski (k2_tarski (esk10_2 X1 X2) (esk11_2 X1 X2)) (k1_tarski (esk10_2 X1 X2))) X1 -> False) -> v1_relat_1 X2 -> v1_relat_1 X1 -> False)
  ...
  -> (forall X2 X4 X3 X1, (r2_hidden (esk6_4 X1 X2 X3 X4) X2 -> False) -> X3 = (k7_relat_1 X1 X2) -> v1_relat_1 X1 -> r2_hidden X4 X3 -> False)
  ...
  -> (forall X2 X1 X3, (X1 = (k6_waybel26 X2 X3) -> False) -> (k9_xtuple_0 X1) = X3 -> (k1_funct_1 X1 (esk12_3 X2 X3 X1)) = (k9_relat_1 X2 (esk12_3 X2 X3 X1)) -> v1_relat_1 X2 -> v1_relat_1 X1 -> v1_funct_1 X1 -> False)
  -> (forall X2 X3 X1, (X3 = (k7_relat_1 X1 X2) -> False) -> (r2_hidden (esk7_3 X1 X2 X3) X3 -> False) -> (r2_hidden (esk8_3 X1 X2 X3) X2 -> False) -> v1_relat_1 X1 -> False)
  ...
  -> (forall X1 X3 X2, (r2_hidden X1 (k1_funct_1 X2 X3) -> False) -> v1_relat_1 X2 -> v1_funct_1 X2 -> r2_hidden (k2_tarski (k2_tarski X3 X1) (k1_tarski X3)) (k5_waybel26 X2) -> False)
  -> (forall X3 X1 X2, (r2_hidden (k2_tarski (k2_tarski X1 X3) (k1_tarski X1)) (k5_waybel26 X2) -> False) -> v1_relat_1 X2 -> v1_funct_1 X2 -> r2_hidden X1 (k9_xtuple_0 X2) -> r2_hidden X3 (k1_funct_1 X2 X1) -> False)
  -> (forall X3 X1 X2, (r2_hidden X1 (k9_xtuple_0 X2) -> False) -> v1_relat_1 X2 -> v1_funct_1 X2 -> r2_hidden (k2_tarski (k2_tarski X1 X3) (k1_tarski X1)) (k5_waybel26 X2) -> False)
  -> (forall X3 X2 X1 X4, (r2_hidden X1 X4 -> False) -> X4 = (k9_xtuple_0 X3) -> r2_hidden (k2_tarski (k2_tarski X1 X2) (k1_tarski X1)) X3 -> False)
  -> (forall X2 X1 X3, (X3 = (k6_waybel26 X1 X2) -> False) -> (r2_hidden (esk12_3 X1 X2 X3) X2 -> False) -> (k9_xtuple_0 X3) = X2 -> v1_relat_1 X3 -> v1_relat_1 X1 -> v1_funct_1 X3 -> False)
  ...
  -> (forall X2 X3 X1 X4, ((k1_funct_1 X3 X1) = (k9_relat_1 X4 X1) -> False) -> X3 = (k6_waybel26 X4 X2) -> v1_relat_1 X4 -> v1_relat_1 X3 -> v1_funct_1 X3 -> r2_hidden X1 X2 -> False)
  ...
  -> (forall X2 X1, (v1_finset_1 (k7_relat_1 X1 X2) -> False) -> v1_relat_1 X1 -> v1_finset_1 X2 -> v1_funct_1 X1 -> False)
  -> (forall X1 X2, (v1_funct_1 X2 -> False) -> v1_relat_1 X1 -> v1_funct_1 X1 -> m1_subset_1 X2 (k1_zfmisc_1 X1) -> False)
  -> (forall X3 X1 X2, ((k9_xtuple_0 X1) = X2 -> False) -> X1 = (k6_waybel26 X3 X2) -> v1_relat_1 X3 -> v1_relat_1 X1 -> v1_funct_1 X1 -> False)
  ...
  -> (forall X1, ((k2_relat_1 (k3_card_3 (k2_card_3 X1))) = (k5_waybel26 X1) -> False) -> v1_relat_1 X1 -> v1_funct_1 X1 -> False)
  -> (forall X2 X1, (v1_funct_1 (k6_waybel26 X1 X2) -> False) -> v1_relat_1 X1 -> False)
  -> (forall X2 X1, (v1_relat_1 (k6_waybel26 X1 X2) -> False) -> v1_relat_1 X1 -> False)
  -> (forall X1, (v1_relat_1 (k3_card_3 (k2_card_3 X1)) -> False) -> v1_relat_1 X1 -> v1_funct_1 X1 -> False)
  ...
  -> (forall X1, (v1_funct_1 (k2_relat_1 X1) -> False) -> v1_relat_1 X1 -> v1_funct_1 X1 -> v2_funct_1 X1 -> False)
  -> (forall X1, (v1_relat_1 (k2_relat_1 X1) -> False) -> v1_relat_1 X1 -> v1_funct_1 X1 -> v2_funct_1 X1 -> False)
  ...
  -> (forall X1, (v1_funct_1 (k2_card_3 X1) -> False) -> v1_relat_1 X1 -> v1_funct_1 X1 -> False)
  -> (forall X1, (v1_finset_1 (k9_xtuple_0 X1) -> False) -> v1_relat_1 X1 -> v1_finset_1 X1 -> False)
  -> (forall X1, (v1_relat_1 (k2_card_3 X1) -> False) -> v1_relat_1 X1 -> v1_funct_1 X1 -> False)
  -> (forall X1, (v1_relat_1 (k5_waybel26 X1) -> False) -> v1_relat_1 X1 -> v1_funct_1 X1 -> False)
  ...
  -> ((k5_waybel26 (k6_waybel26 esk1_0 esk2_0)) = esk1_0 -> False)
  ...
  -> ((r1_tarski (k9_xtuple_0 esk1_0) esk2_0 -> False) -> False)
