...
Theorem t21_lpspace2:
 ...
 forall k6_numbers:set,
     (forall X2 X1 X3, (r1_xxreal_0 X3 k6_numbers -> False) -> (r1_xxreal_0 (k4_power (k18_complex1 (k7_real_1 X1 X2)) X3) (k4_power (k8_real_1 np__2 (k4_xxreal_0 (k18_complex1 X1) (k18_complex1 X2))) X3) -> False) -> m1_subset_1 X3 k1_numbers -> m1_subset_1 X2 k1_numbers -> m1_subset_1 X1 k1_numbers -> False)
  -> (forall X2 X1 X3, (r1_xxreal_0 X3 k6_numbers -> False) -> (r1_xxreal_0 (k4_power (k7_real_1 (k18_complex1 X1) (k18_complex1 X2)) X3) (k4_power (k8_real_1 np__2 (k4_xxreal_0 (k18_complex1 X1) (k18_complex1 X2))) X3) -> False) -> m1_subset_1 X3 k1_numbers -> m1_subset_1 X2 k1_numbers -> m1_subset_1 X1 k1_numbers -> False)
  -> (forall X2 X1 X3, (r1_xxreal_0 X3 k6_numbers -> False) -> (r1_xxreal_0 (k4_power (k18_complex1 (k7_real_1 X1 X2)) X3) (k4_power (k7_real_1 (k18_complex1 X1) (k18_complex1 X2)) X3) -> False) -> m1_subset_1 X3 k1_numbers -> m1_subset_1 X2 k1_numbers -> m1_subset_1 X1 k1_numbers -> False)
  -> (forall X1 X2 X3, (r1_xxreal_0 X3 k6_numbers -> False) -> (r1_xxreal_0 (k3_power (k4_xxreal_0 X1 X2) X3) (k7_real_1 (k4_power X1 X3) (k4_power X2 X3)) -> False) -> m1_subset_1 X3 k1_numbers -> m1_subset_1 X2 k1_numbers -> m1_subset_1 X1 k1_numbers -> r1_xxreal_0 k6_numbers X2 -> r1_xxreal_0 k6_numbers X1 -> False)
  -> (forall X1 X2 X3, ((k8_real_1 (k4_power X1 X3) (k4_power X2 X3)) = (k4_power (k8_real_1 X1 X2) X3) -> False) -> (r1_xxreal_0 X3 k6_numbers -> False) -> m1_subset_1 X3 k1_numbers -> m1_subset_1 X2 k1_numbers -> m1_subset_1 X1 k1_numbers -> r1_xxreal_0 k6_numbers X2 -> r1_xxreal_0 k6_numbers X1 -> False)
  ...
  -> (forall X2 X1, (v7_ordinal1 (k3_power X1 X2) -> False) -> v7_ordinal1 X2 -> v7_ordinal1 X1 -> False)
  -> (forall X2 X1, (v7_ordinal1 (k4_xxreal_0 X1 X2) -> False) -> v7_ordinal1 X2 -> v7_ordinal1 X1 -> False)
  ...
  -> (forall X2 X1, (v1_xreal_0 (k3_power X1 X2) -> False) -> v7_ordinal1 X2 -> v7_ordinal1 X1 -> False)
  ...
  -> (r1_xxreal_0 (k4_power (k18_complex1 (k7_real_1 esk1_0 esk2_0)) esk3_0) (k8_real_1 (k4_power np__2 esk3_0) (k7_real_1 (k4_power (k18_complex1 esk1_0) esk3_0) (k4_power (k18_complex1 esk2_0) esk3_0))) -> False)
