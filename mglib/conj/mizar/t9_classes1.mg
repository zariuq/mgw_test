...
Theorem t9_classes1:
 ...
 forall a_2_6_classes1:set -> set -> set,
 ...
 forall v3_ordinal1:set -> prop,
  ...
  -> (forall X1 X2 X3, (X3 = k1_xboole_0 -> False) -> ((k2_classes1 X2 X3) = (k3_xboole_0 (k3_tarski (k10_xtuple_0 X1)) (k1_classes1 X2)) -> False) -> (k9_xtuple_0 X1) = X3 -> (k2_classes1 X2 (esk17_3 X2 X3 X1)) = (k1_funct_1 X1 (esk17_3 X2 X3 X1)) -> v3_ordinal1 X3 -> v4_ordinal1 X3 -> v1_funct_1 X1 -> v1_relat_1 X1 -> v5_ordinal1 X1 -> False)
  -> (forall X2 X1 X3, (r2_hidden (esk15_3 X1 X2 X3) (k3_classes1 X2 (esk16_3 X1 X2 X3)) -> False) -> v3_ordinal1 X3 -> r2_hidden X1 (a_2_6_classes1 X2 X3) -> False)
  -> (forall X2 X1 X3, (r1_tarski (esk12_3 X1 X2 X3) (esk13_3 X1 X2 X3) -> False) -> v3_ordinal1 X3 -> r2_hidden X1 (a_2_0_classes1 X2 X3) -> False)
  ...
  -> (forall X3 X1 X2, (X2 = k1_xboole_0 -> False) -> ((k2_classes1 X1 X2) = (k3_xboole_0 (k3_tarski (k10_xtuple_0 X3)) (k1_classes1 X1)) -> False) -> (r2_hidden (esk17_3 X1 X2 X3) X2 -> False) -> (k9_xtuple_0 X3) = X2 -> v3_ordinal1 X2 -> v4_ordinal1 X2 -> v1_funct_1 X3 -> v1_relat_1 X3 -> v5_ordinal1 X3 -> False)
  -> (forall X2 X1 X3, (r2_hidden (esk14_3 X1 X2 X3) (k2_classes1 X2 X3) -> False) -> v3_ordinal1 X3 -> r2_hidden X1 (a_2_1_classes1 X2 X3) -> False)
  -> (forall X2 X1 X3, (r2_hidden (esk13_3 X1 X2 X3) (k2_classes1 X2 X3) -> False) -> v3_ordinal1 X3 -> r2_hidden X1 (a_2_0_classes1 X2 X3) -> False)
  -> (forall X3 X1 X2, (X2 = k1_xboole_0 -> False) -> ((k2_classes1 X1 X2) = (k3_xboole_0 (k3_tarski (k10_xtuple_0 X3)) (k1_classes1 X1)) -> False) -> (v3_ordinal1 (esk17_3 X1 X2 X3) -> False) -> (k9_xtuple_0 X3) = X2 -> v3_ordinal1 X2 -> v4_ordinal1 X2 -> v1_funct_1 X3 -> v1_relat_1 X3 -> v5_ordinal1 X3 -> False)
  ...
  -> (forall X2 X1 X3, (m1_subset_1 (esk15_3 X1 X2 X3) (k1_classes1 X2) -> False) -> v3_ordinal1 X3 -> r2_hidden X1 (a_2_6_classes1 X2 X3) -> False)
  -> (forall X2 X1 X3, (m1_subset_1 (esk14_3 X1 X2 X3) (k1_classes1 X2) -> False) -> v3_ordinal1 X3 -> r2_hidden X1 (a_2_1_classes1 X2 X3) -> False)
  -> (forall X2 X1 X3, (m1_subset_1 (esk13_3 X1 X2 X3) (k1_classes1 X2) -> False) -> v3_ordinal1 X3 -> r2_hidden X1 (a_2_0_classes1 X2 X3) -> False)
  -> (forall X2 X1 X3, (m1_subset_1 (esk12_3 X1 X2 X3) (k1_classes1 X2) -> False) -> v3_ordinal1 X3 -> r2_hidden X1 (a_2_0_classes1 X2 X3) -> False)
  -> (forall X2 X1 X3, (r2_hidden (esk16_3 X1 X2 X3) X3 -> False) -> v3_ordinal1 X3 -> r2_hidden X1 (a_2_6_classes1 X2 X3) -> False)
  -> (forall X2 X1 X3, ((k1_zfmisc_1 (esk14_3 X1 X2 X3)) = X1 -> False) -> v3_ordinal1 X3 -> r2_hidden X1 (a_2_1_classes1 X2 X3) -> False)
  -> (forall X2 X1 X3, (v3_ordinal1 (esk16_3 X1 X2 X3) -> False) -> v3_ordinal1 X3 -> r2_hidden X1 (a_2_6_classes1 X2 X3) -> False)
  -> (forall X1 X4 X2 X5 X3, (r2_hidden X3 (a_2_6_classes1 X2 X5) -> False) -> X1 = X3 -> v3_ordinal1 X5 -> v3_ordinal1 X4 -> r2_hidden X4 X5 -> m1_subset_1 X1 (k1_classes1 X2) -> r2_hidden X1 (k3_classes1 X2 X4) -> False)
  ...
  -> (forall X2 X1 X3, ((esk15_3 X1 X2 X3) = X1 -> False) -> v3_ordinal1 X3 -> r2_hidden X1 (a_2_6_classes1 X2 X3) -> False)
  -> (forall X2 X1 X3, ((esk12_3 X1 X2 X3) = X1 -> False) -> v3_ordinal1 X3 -> r2_hidden X1 (a_2_0_classes1 X2 X3) -> False)
  ...
  -> (forall X3 X1 X2, ((k1_funct_1 (esk38_2 X3 X2) X1) = (k3_classes1 X3 X1) -> False) -> v3_ordinal1 X2 -> v3_ordinal1 X1 -> r2_hidden X1 X2 -> False)
  ...
  -> (forall X1 X2, ((k9_xtuple_0 (esk38_2 X1 X2)) = X2 -> False) -> v3_ordinal1 X2 -> False)
  -> (forall X1 X2, (v5_ordinal1 (esk38_2 X1 X2) -> False) -> v3_ordinal1 X2 -> False)
  -> (forall X1 X2, (v1_relat_1 (esk38_2 X1 X2) -> False) -> v3_ordinal1 X2 -> False)
  -> (forall X2 X1, (v1_relat_1 (k3_xboole_0 X1 X2) -> False) -> v1_relat_1 X1 -> False)
  -> (forall X1 X2, (v1_funct_1 (esk38_2 X1 X2) -> False) -> v3_ordinal1 X2 -> False)
  ...
  -> ((a_2_6_classes1 esk1_0 esk2_0) = (k3_classes1 esk1_0 esk2_0) -> False)
  ...
  -> ((v4_ordinal1 esk2_0 -> False) -> False)
