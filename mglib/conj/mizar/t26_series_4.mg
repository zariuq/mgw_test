...
Theorem t26_series_4:
 ...
 forall k1_series_3:set -> set,
  ...
  -> (forall X2 X1, ((k1_seq_1 (k1_series_3 X1) X2) = (k7_xcmplx_0 np__1 (k9_newton (k2_nat_1 X2 np__1))) -> False) -> (k1_seq_1 (k1_series_3 X1) k6_numbers) = (k7_xcmplx_0 np__1 (k9_newton (k2_nat_1 k6_numbers np__1))) -> (k1_seq_1 (k1_series_3 X1) (k2_nat_1 (esk26_1 X1) np__1)) = (k7_xcmplx_0 np__1 (k9_newton (k2_nat_1 (k2_nat_1 (esk26_1 X1) np__1) np__1))) -> v1_funct_1 X1 -> v1_funct_2 X1 k5_numbers k1_numbers -> m2_subset_1 X2 k1_numbers k5_numbers -> m1_subset_1 X1 (k1_zfmisc_1 (k2_zfmisc_1 k5_numbers k1_numbers)) -> False)
  -> (forall X2 X1, ((k1_seq_1 (k1_series_3 X1) X2) = (k7_xcmplx_0 np__1 (k9_newton (k2_nat_1 X2 np__1))) -> False) -> ((k1_seq_1 (k1_series_3 X1) (esk26_1 X1)) = (k7_xcmplx_0 np__1 (k9_newton (k2_nat_1 (esk26_1 X1) np__1))) -> False) -> (k1_seq_1 (k1_series_3 X1) k6_numbers) = (k7_xcmplx_0 np__1 (k9_newton (k2_nat_1 k6_numbers np__1))) -> v1_funct_1 X1 -> v1_funct_2 X1 k5_numbers k1_numbers -> m2_subset_1 X2 k1_numbers k5_numbers -> m1_subset_1 X1 (k1_zfmisc_1 (k2_zfmisc_1 k5_numbers k1_numbers)) -> False)
  ...
  -> (forall X2 X1, ((k1_seq_1 (k1_series_3 X1) X2) = (k7_xcmplx_0 np__1 (k9_newton (k2_nat_1 X2 np__1))) -> False) -> (m2_subset_1 (esk26_1 X1) k1_numbers k5_numbers -> False) -> (k1_seq_1 (k1_series_3 X1) k6_numbers) = (k7_xcmplx_0 np__1 (k9_newton (k2_nat_1 k6_numbers np__1))) -> v1_funct_1 X1 -> v1_funct_2 X1 k5_numbers k1_numbers -> m2_subset_1 X2 k1_numbers k5_numbers -> m1_subset_1 X1 (k1_zfmisc_1 (k2_zfmisc_1 k5_numbers k1_numbers)) -> False)
  ...
  -> (forall X1 X2 X3, ((k3_xcmplx_0 X1 (k7_xcmplx_0 X2 X3)) = (k7_xcmplx_0 (k3_xcmplx_0 X1 X2) X3) -> False) -> v1_xcmplx_0 X3 -> v1_xcmplx_0 X2 -> v1_xcmplx_0 X1 -> False)
  -> (forall X1 X2 X3, ((k7_xcmplx_0 (k7_xcmplx_0 X1 X2) X3) = (k7_xcmplx_0 X1 (k3_xcmplx_0 X2 X3)) -> False) -> v1_xcmplx_0 X3 -> v1_xcmplx_0 X2 -> v1_xcmplx_0 X1 -> False)
  ...
  -> (forall X1, ((k7_xcmplx_0 np__1 (k2_nat_1 X1 np__1)) = (k1_seq_1 esk2_0 X1) -> False) -> m1_subset_1 X1 k5_numbers -> False)
  ...
  -> ((k7_xcmplx_0 np__1 (k9_newton (k2_nat_1 esk1_0 np__1))) = (k1_seq_1 (k1_series_3 esk2_0) esk1_0) -> False)
