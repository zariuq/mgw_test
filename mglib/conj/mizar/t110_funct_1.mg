...
Theorem t110_funct_1:
 ...
 forall r2_hidden:set -> set -> prop,
     (forall X3 X2 X1, (r2_hidden (k2_tarski (k2_tarski (esk3_3 X3 X2 X1) X1) (k1_tarski (esk3_3 X3 X2 X1))) X3 -> False) -> X2 = (k10_xtuple_0 X3) -> r2_hidden X1 X2 -> False)
  -> (forall X1 X2, (X2 = (k10_xtuple_0 X1) -> False) -> (r2_hidden (esk4_2 X1 X2) X2 -> False) -> (r2_hidden (k2_tarski (k2_tarski (esk5_2 X1 X2) (esk4_2 X1 X2)) (k1_tarski (esk5_2 X1 X2))) X1 -> False) -> False)
  -> (forall X3 X2 X1, (X2 = (k10_xtuple_0 X1) -> False) -> r2_hidden (esk4_2 X1 X2) X2 -> r2_hidden (k2_tarski (k2_tarski X3 (esk4_2 X1 X2)) (k1_tarski X3)) X1 -> False)
  ...
  -> (forall X1 X2, (v1_xboole_0 X2 -> False) -> (m1_subset_1 (esk14_2 X1 X2) X2 -> False) -> v4_funct_1 X2 -> r2_hidden X1 (a_1_2_funct_1 X2) -> False)
  -> (forall X1 X2, (v1_xboole_0 X2 -> False) -> (m1_subset_1 (esk13_2 X1 X2) X2 -> False) -> v4_funct_1 X2 -> r2_hidden X1 (a_1_1_funct_1 X2) -> False)
  -> (forall X1 X2, ((k10_xtuple_0 (esk14_2 X1 X2)) = X1 -> False) -> (v1_xboole_0 X2 -> False) -> v4_funct_1 X2 -> r2_hidden X1 (a_1_2_funct_1 X2) -> False)
  -> (forall X1 X2, ((k9_xtuple_0 (esk13_2 X1 X2)) = X1 -> False) -> (v1_xboole_0 X2 -> False) -> v4_funct_1 X2 -> r2_hidden X1 (a_1_1_funct_1 X2) -> False)
  -> (forall X3 X2 X1 X4, (r2_hidden X1 X4 -> False) -> X4 = (k3_tarski X3) -> r2_hidden X2 X3 -> r2_hidden X1 X2 -> False)
  -> (forall X3 X1 X2, (v1_xboole_0 X2 -> False) -> (r2_hidden X3 (a_1_2_funct_1 X2) -> False) -> X3 = (k10_xtuple_0 X1) -> v4_funct_1 X2 -> m1_subset_1 X1 X2 -> False)
  -> (forall X3 X1 X2, (v1_xboole_0 X2 -> False) -> (r2_hidden X3 (a_1_1_funct_1 X2) -> False) -> X3 = (k9_xtuple_0 X1) -> v4_funct_1 X2 -> m1_subset_1 X1 X2 -> False)
  ...
  -> ((k3_tarski (a_1_1_funct_1 esk1_0)) = (k9_xtuple_0 esk2_0) -> (k3_tarski (a_1_2_funct_1 esk1_0)) = (k10_xtuple_0 esk2_0) -> False)
  ...
  -> ((v4_funct_1 esk1_0 -> False) -> False)
  -> ((v1_xboole_0 esk17_0 -> False) -> False)
  -> ((v1_xboole_0 o_0_0_xboole_0 -> False) -> False)
  -> ((v1_xboole_0 k1_xboole_0 -> False) -> False)
  -> (((k3_tarski esk1_0) = esk2_0 -> False) -> False)
