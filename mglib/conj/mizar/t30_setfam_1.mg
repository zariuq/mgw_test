...
Theorem t30_setfam_1:
 ...
 forall r2_hidden:set -> set -> prop,
     (forall X3 X2 X4 X1, ((k6_subset_1 (esk9_4 X2 X3 X4 X1) (esk10_4 X2 X3 X4 X1)) = X1 -> False) -> X4 = (k4_setfam_1 X2 X3) -> r2_hidden X1 X4 -> False)
  -> (forall X2 X1 X3 X4, (r2_hidden (esk10_4 X1 X2 X3 X4) X2 -> False) -> X3 = (k4_setfam_1 X1 X2) -> r2_hidden X4 X3 -> False)
  -> (forall X2 X1 X3 X4, (r2_hidden (esk9_4 X1 X2 X3 X4) X1 -> False) -> X3 = (k4_setfam_1 X1 X2) -> r2_hidden X4 X3 -> False)
  -> (forall X1 X3 X2, (X3 = (k6_subset_1 X1 X2) -> False) -> (r2_hidden (esk8_3 X1 X2 X3) X2 -> False) -> r2_hidden (esk8_3 X1 X2 X3) X3 -> r2_hidden (esk8_3 X1 X2 X3) X1 -> False)
  -> (forall X3 X2 X1, (X3 = (k4_setfam_1 X1 X2) -> False) -> ((k6_subset_1 (esk12_3 X1 X2 X3) (esk13_3 X1 X2 X3)) = (esk11_3 X1 X2 X3) -> False) -> (r2_hidden (esk11_3 X1 X2 X3) X3 -> False) -> False)
  -> (forall X5 X4 X1 X2 X3, (X3 = (k4_setfam_1 X1 X2) -> False) -> (esk11_3 X1 X2 X3) = (k6_subset_1 X4 X5) -> r2_hidden X5 X2 -> r2_hidden X4 X1 -> r2_hidden (esk11_3 X1 X2 X3) X3 -> False)
  -> (forall X2 X3 X1, (X3 = (k6_subset_1 X1 X2) -> False) -> (r2_hidden (esk8_3 X1 X2 X3) X3 -> False) -> r2_hidden (esk8_3 X1 X2 X3) X2 -> False)
  -> (forall X1 X3 X2, (X3 = (k6_subset_1 X1 X2) -> False) -> (r2_hidden (esk8_3 X1 X2 X3) X3 -> False) -> (r2_hidden (esk8_3 X1 X2 X3) X1 -> False) -> False)
  -> (forall X2 X3 X1, (X3 = (k4_setfam_1 X1 X2) -> False) -> (r2_hidden (esk11_3 X1 X2 X3) X3 -> False) -> (r2_hidden (esk13_3 X1 X2 X3) X2 -> False) -> False)
  -> (forall X1 X3 X2, (X3 = (k4_setfam_1 X1 X2) -> False) -> (r2_hidden (esk11_3 X1 X2 X3) X3 -> False) -> (r2_hidden (esk12_3 X1 X2 X3) X1 -> False) -> False)
  ...
  -> (r1_tarski (k1_setfam_1 (k4_setfam_1 esk1_0 esk2_0)) (k6_subset_1 (k1_setfam_1 esk1_0) (k1_setfam_1 esk2_0)) -> False)
  ...
  -> (forall X1, (m1_subset_1 (o_1_0_setfam_1 X1) X1 -> False) -> False)
