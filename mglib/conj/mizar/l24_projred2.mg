...
Theorem l24_projred2:
 ...
 forall r1_incsp_1:set -> set -> set -> prop,
  ...
  -> (forall X8 X3 X7 X17 X9 X15 X13 X11 X12 X10 X16 X18 X14 X2 X5 X1 X4 X6, (X4 = X6 -> False) -> (X3 = X8 -> False) -> (r1_incsp_1 X1 X6 X8 -> False) -> (r1_incsp_1 X1 X6 X7 -> False) -> (r1_incsp_1 X1 X6 X5 -> False) -> (r1_incsp_1 X1 X4 X5 -> False) -> (r1_incsp_1 X1 X4 X3 -> False) -> (r1_projred2 X1 X3 X7 X5 -> False) -> r1_incsp_1 X1 X2 X14 -> r1_incsp_1 X1 X2 X3 -> m1_subset_1 X18 (u2_incsp_1 X1) -> m1_subset_1 X17 (u2_incsp_1 X1) -> m1_subset_1 X16 (u2_incsp_1 X1) -> m1_subset_1 X14 (u2_incsp_1 X1) -> m1_subset_1 X8 (u2_incsp_1 X1) -> m1_subset_1 X7 (u2_incsp_1 X1) -> m1_subset_1 X5 (u2_incsp_1 X1) -> r4_incsp_1 X1 (k7_domain_1 (u1_incsp_1 X1) X9 X15) X8 -> r4_incsp_1 X1 (k7_domain_1 (u1_incsp_1 X1) X9 X10) X3 -> r4_incsp_1 X1 (k8_domain_1 (u1_incsp_1 X1) X10 X15 X2) X18 -> r4_incsp_1 X1 (k8_domain_1 (u1_incsp_1 X1) X10 X11 X12) X7 -> r4_incsp_1 X1 (k8_domain_1 (u1_incsp_1 X1) X9 X12 X13) X5 -> r4_incsp_1 X1 (k8_domain_1 (u1_incsp_1 X1) X6 X13 X15) X17 -> r4_incsp_1 X1 (k8_domain_1 (u1_incsp_1 X1) X4 X10 X13) X16 -> r4_incsp_1 X1 (k8_domain_1 (u1_incsp_1 X1) X4 X6 X12) X14 -> epred2_11 X6 X2 X3 X10 X15 X13 X11 X12 X9 X1 X4 -> False)
  -> (forall X5 X3 X6 X17 X9 X15 X13 X11 X12 X10 X16 X18 X14 X2 X8 X1 X4 X7, (X4 = X7 -> False) -> (X3 = X5 -> False) -> (r1_incsp_1 X1 X7 X8 -> False) -> (r1_incsp_1 X1 X7 X6 -> False) -> (r1_incsp_1 X1 X7 X3 -> False) -> (r1_incsp_1 X1 X4 X6 -> False) -> (r1_incsp_1 X1 X4 X5 -> False) -> (r1_projred2 X1 X5 X8 X6 -> False) -> r1_incsp_1 X1 X2 X14 -> r1_incsp_1 X1 X2 X3 -> m1_subset_1 X18 (u2_incsp_1 X1) -> m1_subset_1 X17 (u2_incsp_1 X1) -> m1_subset_1 X16 (u2_incsp_1 X1) -> m1_subset_1 X14 (u2_incsp_1 X1) -> m1_subset_1 X8 (u2_incsp_1 X1) -> m1_subset_1 X6 (u2_incsp_1 X1) -> m1_subset_1 X3 (u2_incsp_1 X1) -> r4_incsp_1 X1 (k7_domain_1 (u1_incsp_1 X1) X9 X15) X3 -> r4_incsp_1 X1 (k7_domain_1 (u1_incsp_1 X1) X9 X10) X5 -> r4_incsp_1 X1 (k8_domain_1 (u1_incsp_1 X1) X10 X15 X2) X18 -> r4_incsp_1 X1 (k8_domain_1 (u1_incsp_1 X1) X10 X11 X12) X8 -> r4_incsp_1 X1 (k8_domain_1 (u1_incsp_1 X1) X9 X12 X13) X6 -> r4_incsp_1 X1 (k8_domain_1 (u1_incsp_1 X1) X7 X13 X15) X17 -> r4_incsp_1 X1 (k8_domain_1 (u1_incsp_1 X1) X4 X10 X13) X16 -> r4_incsp_1 X1 (k8_domain_1 (u1_incsp_1 X1) X4 X7 X12) X14 -> epred2_11 X7 X2 X5 X10 X15 X13 X11 X12 X9 X1 X4 -> False)
  -> (forall X4 X1 X7 X14 X17 X9 X15 X13 X11 X12 X10 X16 X18 X2 X6 X3 X5 X8, (X5 = X8 -> False) -> (X1 = X4 -> False) -> (r1_incsp_1 X3 X4 X6 -> False) -> (r1_incsp_1 X3 X4 X5 -> False) -> (r1_incsp_1 X3 X1 X8 -> False) -> (r1_incsp_1 X3 X1 X7 -> False) -> (r1_incsp_1 X3 X1 X6 -> False) -> (r1_projred2 X3 X5 X7 X6 -> False) -> X1 = X2 -> r1_incsp_1 X3 X2 X14 -> m1_subset_1 X18 (u2_incsp_1 X3) -> m1_subset_1 X17 (u2_incsp_1 X3) -> m1_subset_1 X16 (u2_incsp_1 X3) -> m1_subset_1 X14 (u2_incsp_1 X3) -> m1_subset_1 X8 (u2_incsp_1 X3) -> m1_subset_1 X7 (u2_incsp_1 X3) -> m1_subset_1 X6 (u2_incsp_1 X3) -> r4_incsp_1 X3 (k7_domain_1 (u1_incsp_1 X3) X9 X15) X8 -> r4_incsp_1 X3 (k7_domain_1 (u1_incsp_1 X3) X9 X10) X5 -> r4_incsp_1 X3 (k8_domain_1 (u1_incsp_1 X3) X10 X15 X2) X18 -> r4_incsp_1 X3 (k8_domain_1 (u1_incsp_1 X3) X10 X11 X12) X7 -> r4_incsp_1 X3 (k8_domain_1 (u1_incsp_1 X3) X9 X12 X13) X6 -> r4_incsp_1 X3 (k8_domain_1 (u1_incsp_1 X3) X4 X10 X13) X16 -> r4_incsp_1 X3 (k8_domain_1 (u1_incsp_1 X3) X4 X1 X12) X14 -> r4_incsp_1 X3 (k8_domain_1 (u1_incsp_1 X3) X1 X13 X15) X17 -> epred2_11 X1 X2 X5 X10 X15 X13 X11 X12 X9 X3 X4 -> False)
  -> (forall X10 X8 X6 X4 X3 X2 X5 X7 X9 X11 X1, (epred2_11 X3 X10 X11 X5 X9 X8 X6 X7 X4 X1 X2 -> False) -> v6_incsp_1 X1 -> v1_incproj X1 -> v2_incproj X1 -> v3_incproj X1 -> v4_incproj X1 -> v5_incproj X1 -> v9_incproj X1 -> l1_incsp_1 X1 -> m1_subset_1 X11 (u2_incsp_1 X1) -> m1_subset_1 X10 (u1_incsp_1 X1) -> m1_subset_1 X9 (u1_incsp_1 X1) -> m1_subset_1 X8 (u1_incsp_1 X1) -> m1_subset_1 X7 (u1_incsp_1 X1) -> m1_subset_1 X6 (u1_incsp_1 X1) -> m1_subset_1 X5 (u1_incsp_1 X1) -> m1_subset_1 X4 (u1_incsp_1 X1) -> m1_subset_1 X3 (u1_incsp_1 X1) -> m1_subset_1 X2 (u1_incsp_1 X1) -> False)
  ...
  -> (esk7_0 = esk4_0 -> False)
  -> (esk3_0 = esk2_0 -> False)
  -> ((r1_projred2 esk1_0 esk5_0 esk6_0 esk8_0 -> False) -> False)
