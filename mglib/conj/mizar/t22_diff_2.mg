...
Theorem t22_diff_2:
 ...
 forall r1_zfmisc_1:set -> set -> set -> prop,
 ...
 forall v1_relat_1:set -> prop,
     (forall X3 X2 X4 X1, ((k10_real_1 (k9_real_1 (k9_diff_1 X1 X2 X3) (k9_diff_1 X1 X3 X4)) (k6_xcmplx_0 X2 X4)) = (k10_diff_1 X1 X2 X3 X4) -> False) -> v1_relat_1 X1 -> v3_valued_0 X1 -> v1_xreal_0 X4 -> v1_xreal_0 X3 -> v1_xreal_0 X2 -> v1_funct_1 X1 -> False)
  -> (forall X3 X2 X4 X1, (m1_subset_1 (k10_diff_1 X1 X2 X3 X4) k1_numbers -> False) -> v1_relat_1 X1 -> v3_valued_0 X1 -> v1_xreal_0 X4 -> v1_xreal_0 X3 -> v1_xreal_0 X2 -> v1_funct_1 X1 -> False)
  ...
  -> (forall X4 X3 X1 X2, (X1 = X2 -> False) -> ((k9_diff_1 (k1_fcont_1 X3 X4) X1 X2) = X3 -> False) -> m1_subset_1 X4 k1_numbers -> m1_subset_1 X3 k1_numbers -> m1_subset_1 X2 k1_numbers -> m1_subset_1 X1 k1_numbers -> False)
  ...
  -> (forall X3 X1 X2, X1 = X2 -> r1_zfmisc_1 X1 X2 X3 -> False)
  -> (forall X3 X1 X2, X1 = X2 -> r1_zfmisc_1 X1 X3 X2 -> False)
  -> (forall X3 X1 X2, X1 = X2 -> r1_zfmisc_1 X3 X1 X2 -> False)
  ...
  -> (forall X1 X2 X3, (X2 = X3 -> False) -> (X1 = X3 -> False) -> (X1 = X2 -> False) -> (r1_zfmisc_1 X1 X2 X3 -> False) -> False)
  ...
  -> ((k10_diff_1 (k1_fcont_1 esk4_0 esk5_0) esk1_0 esk2_0 esk3_0) = k6_numbers -> False)
  ...
  -> ((r1_zfmisc_1 esk1_0 esk2_0 esk3_0 -> False) -> False)
