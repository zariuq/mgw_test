...
Theorem t66_setlim_2:
 ...
 forall k4_setlim_2:set -> set -> set -> set,
  ...
  -> (forall X1 X2 X3, (r1_tarski (k3_kurato_0 X2 (k4_setlim_2 X2 X1 X3)) (k5_subset_1 X2 (k3_kurato_0 X2 X1) (k3_kurato_0 X2 X3)) -> False) -> v1_funct_1 X3 -> v1_funct_1 X1 -> v3_kurato_0 X1 X2 -> v1_funct_2 X3 k5_numbers (k9_setfam_1 X2) -> v1_funct_2 X1 k5_numbers (k9_setfam_1 X2) -> m1_subset_1 X3 (k9_setfam_1 (k2_zfmisc_1 k5_numbers (k9_setfam_1 X2))) -> m1_subset_1 X1 (k9_setfam_1 (k2_zfmisc_1 k5_numbers (k9_setfam_1 X2))) -> False)
  -> (forall X1 X2 X3, (r1_tarski (k3_kurato_0 X2 (k4_setlim_2 X2 X3 X1)) (k5_subset_1 X2 (k3_kurato_0 X2 X3) (k3_kurato_0 X2 X1)) -> False) -> v1_funct_1 X3 -> v1_funct_1 X1 -> v3_kurato_0 X1 X2 -> v1_funct_2 X3 k5_numbers (k9_setfam_1 X2) -> v1_funct_2 X1 k5_numbers (k9_setfam_1 X2) -> m1_subset_1 X3 (k9_setfam_1 (k2_zfmisc_1 k5_numbers (k9_setfam_1 X2))) -> m1_subset_1 X1 (k9_setfam_1 (k2_zfmisc_1 k5_numbers (k9_setfam_1 X2))) -> False)
  ...
  -> ((k5_subset_1 esk1_0 (k3_kurato_0 esk1_0 esk2_0) (k3_kurato_0 esk1_0 esk3_0)) = (k3_kurato_0 esk1_0 (k4_setlim_2 esk1_0 esk2_0 esk3_0)) -> False)
