...
Theorem t15_tsp_2:
 ...
 forall k3_xboole_0:set -> set -> set,
  ...
  -> (forall X4 X3 X2 X1, (v2_struct_0 X1 -> False) -> (v3_pre_topc X3 X4 -> False) -> X2 = X3 -> X3 = (k8_subset_1 (u1_struct_0 X1) (k3_tex_4 X1 X2) (u1_struct_0 X4)) -> v2_pre_topc X1 -> l1_pre_topc X1 -> v2_tsp_2 X4 X1 -> m1_pre_topc X4 X1 -> v3_pre_topc (k3_tex_4 X1 X2) X1 -> m1_subset_1 X3 (k1_zfmisc_1 (u1_struct_0 X4)) -> m1_subset_1 X2 (k1_zfmisc_1 (u1_struct_0 X1)) -> False)
  ...
  -> (forall X3 X2 X1, (m1_pre_topc X2 X1 -> False) -> (k8_subset_1 (u1_struct_0 X1) X3 (u1_struct_0 X2)) = (esk6_2 X1 X2) -> l1_pre_topc X2 -> l1_pre_topc X1 -> v3_pre_topc X3 X1 -> v3_pre_topc (esk6_2 X1 X2) X2 -> m1_subset_1 X3 (k1_zfmisc_1 (u1_struct_0 X1)) -> r1_tarski (u1_struct_0 X2) (u1_struct_0 X1) -> False)
  -> (forall X3 X1 X4 X2, (X1 = (k8_subset_1 (u1_struct_0 X2) (k3_tex_4 X2 X3) (u1_struct_0 X4)) -> False) -> (v2_struct_0 X2 -> False) -> X1 = X3 -> v2_pre_topc X2 -> l1_pre_topc X2 -> v2_tsp_2 X4 X2 -> m1_pre_topc X4 X2 -> v3_pre_topc X1 X4 -> m1_subset_1 X3 (k1_zfmisc_1 (u1_struct_0 X2)) -> m1_subset_1 X1 (k1_zfmisc_1 (u1_struct_0 X4)) -> False)
  -> (forall X2 X1 X3, ((k8_subset_1 (u1_struct_0 X2) (esk5_3 X2 X3 X1) (u1_struct_0 X3)) = X1 -> False) -> l1_pre_topc X3 -> l1_pre_topc X2 -> m1_pre_topc X3 X2 -> v3_pre_topc X1 X3 -> m1_subset_1 X1 (k1_zfmisc_1 (u1_struct_0 X3)) -> False)
  -> (forall X1 X2 X3 X4, (v3_pre_topc X3 X4 -> False) -> X3 = (k8_subset_1 (u1_struct_0 X2) X1 (u1_struct_0 X4)) -> l1_pre_topc X4 -> l1_pre_topc X2 -> m1_pre_topc X4 X2 -> v3_pre_topc X1 X2 -> m1_subset_1 X3 (k1_zfmisc_1 (u1_struct_0 X4)) -> m1_subset_1 X1 (k1_zfmisc_1 (u1_struct_0 X2)) -> False)
  ...
  -> (forall X1 X3 X2, (m1_subset_1 (esk5_3 X1 X2 X3) (k1_zfmisc_1 (u1_struct_0 X1)) -> False) -> l1_pre_topc X2 -> l1_pre_topc X1 -> m1_pre_topc X2 X1 -> v3_pre_topc X3 X2 -> m1_subset_1 X3 (k1_zfmisc_1 (u1_struct_0 X2)) -> False)
  ...
  -> (forall X2 X4 X3 X1, (v2_struct_0 X1 -> False) -> (v3_pre_topc (k3_tex_4 X1 X2) X1 -> False) -> X2 = X3 -> v2_pre_topc X1 -> l1_pre_topc X1 -> v2_tsp_2 X4 X1 -> m1_pre_topc X4 X1 -> v3_pre_topc X3 X4 -> m1_subset_1 X3 (k1_zfmisc_1 (u1_struct_0 X4)) -> m1_subset_1 X2 (k1_zfmisc_1 (u1_struct_0 X1)) -> False)
  -> (forall X1 X3 X2, (v3_pre_topc (esk5_3 X1 X2 X3) X1 -> False) -> l1_pre_topc X2 -> l1_pre_topc X1 -> m1_pre_topc X2 X1 -> v3_pre_topc X3 X2 -> m1_subset_1 X3 (k1_zfmisc_1 (u1_struct_0 X2)) -> False)
  -> (forall X1 X2, ((k8_subset_1 (u1_struct_0 X1) (esk7_2 X1 X2) (u1_struct_0 X2)) = (esk6_2 X1 X2) -> False) -> (m1_pre_topc X2 X1 -> False) -> (v3_pre_topc (esk6_2 X1 X2) X2 -> False) -> l1_pre_topc X2 -> l1_pre_topc X1 -> r1_tarski (u1_struct_0 X2) (u1_struct_0 X1) -> False)
  ...
  -> (forall X1, (k3_tex_4 esk1_0 esk3_0) = esk3_0 -> X1 = (k8_subset_1 (u1_struct_0 esk1_0) esk3_0 (u1_struct_0 esk2_0)) -> v3_pre_topc X1 esk2_0 -> v3_pre_topc esk3_0 esk1_0 -> m1_subset_1 X1 (k1_zfmisc_1 (u1_struct_0 esk2_0)) -> False)
  -> (forall X1 X2, (m1_pre_topc X2 X1 -> False) -> (v3_pre_topc (esk6_2 X1 X2) X2 -> False) -> (m1_subset_1 (esk7_2 X1 X2) (k1_zfmisc_1 (u1_struct_0 X1)) -> False) -> l1_pre_topc X2 -> l1_pre_topc X1 -> r1_tarski (u1_struct_0 X2) (u1_struct_0 X1) -> False)
  ...
  -> (forall X1 X2, (m1_pre_topc X2 X1 -> False) -> (v3_pre_topc (esk6_2 X1 X2) X2 -> False) -> (v3_pre_topc (esk7_2 X1 X2) X1 -> False) -> l1_pre_topc X2 -> l1_pre_topc X1 -> r1_tarski (u1_struct_0 X2) (u1_struct_0 X1) -> False)
  ...
  -> (forall X2 X1, ((k3_tex_4 X1 X2) = X2 -> False) -> (v2_struct_0 X1 -> False) -> v2_pre_topc X1 -> l1_pre_topc X1 -> v3_pre_topc X2 X1 -> m1_subset_1 X2 (k1_zfmisc_1 (u1_struct_0 X1)) -> False)
  ...
  -> (forall X2 X1, (v2_struct_0 X1 -> False) -> (m1_subset_1 (u1_struct_0 X2) (k1_zfmisc_1 (u1_struct_0 X1)) -> False) -> l1_pre_topc X1 -> m1_pre_topc X2 X1 -> False)
  ...
  -> (forall X1 X2, (v2_struct_0 X2 -> False) -> (v2_struct_0 X1 -> False) -> (v6_pre_topc X2 -> False) -> (v1_tex_2 X1 X2 -> False) -> v2_pre_topc X2 -> l1_pre_topc X2 -> v6_pre_topc X1 -> m1_pre_topc X1 X2 -> False)
  -> (((k8_subset_1 (u1_struct_0 esk1_0) esk3_0 (u1_struct_0 esk2_0)) = esk4_0 -> False) -> (v3_pre_topc esk3_0 esk1_0 -> False) -> False)
  ...
  -> ((v3_pre_topc esk3_0 esk1_0 -> False) -> (m1_subset_1 esk4_0 (k1_zfmisc_1 (u1_struct_0 esk2_0)) -> False) -> False)
  ...
  -> ((v3_pre_topc esk3_0 esk1_0 -> False) -> (v3_pre_topc esk4_0 esk2_0 -> False) -> False)
  -> (((k3_tex_4 esk1_0 esk3_0) = esk3_0 -> False) -> (v3_pre_topc esk3_0 esk1_0 -> False) -> False)
