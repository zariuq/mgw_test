...
Theorem t36_diff_2:
 ...
 forall k6_numbers:set,
     (forall X4 X1 X2 X3 X5, (X5 = k6_numbers -> False) -> (X4 = k6_numbers -> False) -> (X3 = k6_numbers -> False) -> ((k10_diff_1 X1 X3 X4 X5) = (k10_real_1 X2 (k8_real_1 (k8_real_1 X3 X4) X5)) -> False) -> (k3_funct_2 k1_numbers k1_numbers X1 (esk23_5 X2 X3 X4 X5 X1)) = (k10_real_1 X2 (esk23_5 X2 X3 X4 X5 X1)) -> v1_funct_1 X1 -> m1_subset_1 X5 k1_numbers -> m1_subset_1 X4 k1_numbers -> m1_subset_1 X3 k1_numbers -> m1_subset_1 X2 k1_numbers -> r1_zfmisc_1 X3 X4 X5 -> v1_funct_2 X1 k1_numbers k1_numbers -> m1_subset_1 X1 (k1_zfmisc_1 (k2_zfmisc_1 k1_numbers k1_numbers)) -> False)
  ...
  -> (forall X3 X5 X1 X2 X4, (X4 = k6_numbers -> False) -> (X3 = k6_numbers -> False) -> (X2 = k6_numbers -> False) -> ((k10_diff_1 X5 X2 X3 X4) = (k10_real_1 X1 (k8_real_1 (k8_real_1 X2 X3) X4)) -> False) -> (m1_subset_1 (esk23_5 X1 X2 X3 X4 X5) k1_numbers -> False) -> v1_funct_1 X5 -> m1_subset_1 X4 k1_numbers -> m1_subset_1 X3 k1_numbers -> m1_subset_1 X2 k1_numbers -> m1_subset_1 X1 k1_numbers -> r1_zfmisc_1 X2 X3 X4 -> v1_funct_2 X5 k1_numbers k1_numbers -> m1_subset_1 X5 (k1_zfmisc_1 (k2_zfmisc_1 k1_numbers k1_numbers)) -> False)
  ...
  -> (forall X1, ((k3_funct_2 k1_numbers k1_numbers esk6_0 X1) = (k10_real_1 esk1_0 X1) -> False) -> m1_subset_1 X1 k1_numbers -> False)
  ...
  -> ((k1_real_1 (k10_real_1 esk1_0 (k8_real_1 (k8_real_1 (k8_real_1 esk2_0 esk3_0) esk4_0) esk5_0))) = (k11_diff_1 esk6_0 esk2_0 esk3_0 esk4_0 esk5_0) -> False)
