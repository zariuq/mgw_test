...
Theorem t19_transgeo:
 ...
 forall v1_xboole_0:set -> prop,
  ...
  -> (forall X4 X2 X5 X3 X1, (r2_hidden (k4_tarski X3 X5) X1 -> False) -> v1_relat_1 X1 -> r8_relat_2 X1 X2 -> r2_hidden X5 X2 -> r2_hidden X4 X2 -> r2_hidden X3 X2 -> r2_hidden (k4_tarski X4 X5) X1 -> r2_hidden (k4_tarski X3 X4) X1 -> False)
  ...
  -> (forall X2 X1, (r8_relat_2 X1 X2 -> False) -> v1_relat_1 X1 -> r2_hidden (k4_tarski (esk17_2 X1 X2) (esk19_2 X1 X2)) X1 -> False)
  ...
  -> (forall X2 X3 X4 X1, (r2_hidden (k4_tarski X4 X3) X1 -> False) -> v1_relat_1 X1 -> r3_relat_2 X1 X2 -> r2_hidden X4 X2 -> r2_hidden X3 X2 -> r2_hidden (k4_tarski X3 X4) X1 -> False)
  -> (forall X2 X1, (r8_relat_2 X1 X2 -> False) -> (r2_hidden (k4_tarski (esk18_2 X1 X2) (esk19_2 X1 X2)) X1 -> False) -> v1_relat_1 X1 -> False)
  -> (forall X2 X1, (r8_relat_2 X1 X2 -> False) -> (r2_hidden (k4_tarski (esk17_2 X1 X2) (esk18_2 X1 X2)) X1 -> False) -> v1_relat_1 X1 -> False)
  ...
  -> (forall X1 X2, (v1_xboole_0 X2 -> False) -> (v1_xboole_0 X1 -> False) -> (m1_subset_1 (esk29_2 X1 X2) (k1_zfmisc_1 (k2_zfmisc_1 X1 X2)) -> False) -> False)
  ...
  -> (forall X2 X1, (r8_relat_2 X1 X2 -> False) -> (r2_hidden (esk19_2 X1 X2) X2 -> False) -> v1_relat_1 X1 -> False)
  -> (forall X2 X1, (r8_relat_2 X1 X2 -> False) -> (r2_hidden (esk18_2 X1 X2) X2 -> False) -> v1_relat_1 X1 -> False)
  -> (forall X2 X1, (r8_relat_2 X1 X2 -> False) -> (r2_hidden (esk17_2 X1 X2) X2 -> False) -> v1_relat_1 X1 -> False)
  ...
  -> (forall X1, (m1_subset_1 (esk27_1 X1) (k1_zfmisc_1 (k2_zfmisc_1 X1 X1)) -> False) -> False)
  -> (forall X1, (v3_funct_2 (esk27_1 X1) X1 X1 -> False) -> False)
  -> (forall X1, (v1_funct_2 (esk27_1 X1) X1 X1 -> False) -> False)
  -> ((m1_subset_1 esk2_0 (k1_zfmisc_1 (k2_zfmisc_1 esk1_0 esk1_0)) -> False) -> False)
  -> ((r1_transgeo esk1_0 esk2_0 esk3_0 -> False) -> False)
  ...
  -> ((r8_relat_2 esk3_0 (k2_zfmisc_1 esk1_0 esk1_0) -> False) -> False)
  -> ((r3_relat_2 esk3_0 (k2_zfmisc_1 esk1_0 esk1_0) -> False) -> False)
  ...
  -> (forall X1 X2, (v1_xboole_0 (esk24_2 X1 X2) -> False) -> False)
  ...
  -> ((v2_funct_1 esk26_0 -> False) -> False)
