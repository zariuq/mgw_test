...
Theorem t48_power:
 ...
 forall k4_prepower:set -> set -> set,
     (forall X2 X1 X3, ((k4_prepower X2 (esk26_3 X2 X3 X1)) = X1 -> False) -> X1 = (k3_power X2 X3) -> v1_int_1 X3 -> epred1_3 X1 X3 X2 -> False)
  -> (forall X1 X3 X2, (v1_int_1 (esk26_3 X1 X2 X3) -> False) -> X3 = (k3_power X1 X2) -> v1_int_1 X2 -> epred1_3 X3 X2 X1 -> False)
  -> (forall X1 X3 X2, ((esk26_3 X1 X2 X3) = X2 -> False) -> X3 = (k3_power X1 X2) -> v1_int_1 X2 -> epred1_3 X3 X2 X1 -> False)
  ...
  -> (forall X3 X2 X1, (X1 = k6_numbers -> False) -> ((k3_xcmplx_0 (k4_prepower X1 X2) (k4_prepower X1 X3)) = (k4_prepower X1 (k2_xcmplx_0 X2 X3)) -> False) -> v1_xreal_0 X1 -> v1_int_1 X3 -> v1_int_1 X2 -> False)
  ...
  -> (forall X1, ((k2_xcmplx_0 (k3_xcmplx_0 np__2 (esk25_1 X1)) np__1) = X1 -> False) -> (v1_abian X1 -> False) -> v1_int_1 X1 -> False)
  ...
  -> (forall X1 X2, ((k3_power (k4_xcmplx_0 X1) X2) = (k3_power X1 X2) -> False) -> v1_xreal_0 X1 -> v1_int_1 X2 -> v1_abian X2 -> False)
  ...
  -> (forall X1, (v1_abian X1 -> False) -> (v1_int_1 (esk25_1 X1) -> False) -> v1_int_1 X1 -> False)
  -> (forall X1, (X1 = k6_numbers -> False) -> ((k3_power k6_numbers X1) = k6_numbers -> False) -> v1_int_1 X1 -> False)
  ...
  -> (forall X1, ((k4_prepower X1 np__1) = X1 -> False) -> v1_xreal_0 X1 -> False)
  ...
  -> ((k4_xcmplx_0 (k3_power esk1_0 esk2_0)) = (k3_power (k4_xcmplx_0 esk1_0) esk2_0) -> False)
