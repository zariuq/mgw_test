...
Theorem t33_fintopo2:
 ...
 forall v2_struct_0:set -> prop,
     (forall X1 X3 X4 X2, (v2_struct_0 X2 -> False) -> (r2_hidden X1 (a_2_1_fintopo2 X2 X3) -> False) -> (r1_xboole_0 (esk13_4 X1 X2 X3 X4) X3 -> False) -> (r1_xboole_0 (esk13_4 X1 X2 X3 X4) (k3_subset_1 (u1_struct_0 X2) X3) -> False) -> X1 = X4 -> l1_fintopo2 X2 -> m1_subset_1 X4 (u1_struct_0 X2) -> m1_subset_1 X3 (k1_zfmisc_1 (u1_struct_0 X2)) -> False)
  ...
  -> (forall X1 X3 X4 X2, (v2_struct_0 X2 -> False) -> (r2_hidden X1 (a_2_1_fintopo2 X2 X3) -> False) -> (r2_hidden (esk13_4 X1 X2 X3 X4) (k6_fintopo2 X2 X4) -> False) -> X1 = X4 -> l1_fintopo2 X2 -> m1_subset_1 X4 (u1_struct_0 X2) -> m1_subset_1 X3 (k1_zfmisc_1 (u1_struct_0 X2)) -> False)
  -> (forall X1 X3 X4 X2, (v2_struct_0 X2 -> False) -> (r2_hidden X1 (a_2_1_fintopo2 X2 X3) -> False) -> (m1_subset_1 (esk13_4 X1 X2 X3 X4) (k1_zfmisc_1 (u1_struct_0 X2)) -> False) -> X1 = X4 -> l1_fintopo2 X2 -> m1_subset_1 X4 (u1_struct_0 X2) -> m1_subset_1 X3 (k1_zfmisc_1 (u1_struct_0 X2)) -> False)
  -> (forall X1 X3 X4 X2, (v2_struct_0 X2 -> False) -> l1_fintopo2 X2 -> r2_hidden X4 (a_2_1_fintopo2 X2 X3) -> m1_subset_1 X3 (k1_zfmisc_1 (u1_struct_0 X2)) -> m1_subset_1 X1 (k1_zfmisc_1 (u1_struct_0 X2)) -> r1_xboole_0 X1 (k3_subset_1 (u1_struct_0 X2) X3) -> r2_hidden X1 (k6_fintopo2 X2 (esk12_3 X4 X2 X3)) -> False)
  -> (forall X4 X1 X2 X3, (v2_struct_0 X3 -> False) -> l1_fintopo2 X3 -> r1_xboole_0 X1 X2 -> r2_hidden X4 (a_2_1_fintopo2 X3 X2) -> m1_subset_1 X2 (k1_zfmisc_1 (u1_struct_0 X3)) -> m1_subset_1 X1 (k1_zfmisc_1 (u1_struct_0 X3)) -> r2_hidden X1 (k6_fintopo2 X3 (esk12_3 X4 X3 X2)) -> False)
  ...
  -> (forall X2 X3 X1, (v2_struct_0 X1 -> False) -> (r2_hidden X2 (k8_fintopo2 X1 X3) -> False) -> (r1_xboole_0 (esk26_3 X1 X2 X3) X3 -> False) -> (r1_xboole_0 (esk26_3 X1 X2 X3) (k3_subset_1 (u1_struct_0 X1) X3) -> False) -> l1_fintopo2 X1 -> m1_subset_1 X2 (u1_struct_0 X1) -> m1_subset_1 X3 (k1_zfmisc_1 (u1_struct_0 X1)) -> False)
  ...
  -> (forall X2 X1, ((k4_subset_1 (u1_struct_0 esk1_0) (k8_fintopo2 esk1_0 X1) (k8_fintopo2 esk1_0 X2)) = (k8_fintopo2 esk1_0 (k4_subset_1 (u1_struct_0 esk1_0) X1 X2)) -> False) -> m1_subset_1 X2 (k1_zfmisc_1 (u1_struct_0 esk1_0)) -> m1_subset_1 X1 (k1_zfmisc_1 (u1_struct_0 esk1_0)) -> False)
  ...
  -> (forall X1, m1_subset_1 X1 (k1_zfmisc_1 (u1_struct_0 esk1_0)) -> r2_hidden X1 (k6_fintopo2 esk1_0 esk2_0) -> r1_tarski X1 (k9_subset_1 (u1_struct_0 esk1_0) esk3_0 esk4_0) -> False)
  -> (forall X2 X3 X1, (v2_struct_0 X1 -> False) -> (r2_hidden X2 (k8_fintopo2 X1 X3) -> False) -> (r2_hidden (esk26_3 X1 X2 X3) (k6_fintopo2 X1 X2) -> False) -> l1_fintopo2 X1 -> m1_subset_1 X2 (u1_struct_0 X1) -> m1_subset_1 X3 (k1_zfmisc_1 (u1_struct_0 X1)) -> False)
  ...
  -> (forall X2 X3 X1, (v2_struct_0 X1 -> False) -> (r2_hidden X2 (k8_fintopo2 X1 X3) -> False) -> (m1_subset_1 (esk26_3 X1 X2 X3) (k1_zfmisc_1 (u1_struct_0 X1)) -> False) -> l1_fintopo2 X1 -> m1_subset_1 X2 (u1_struct_0 X1) -> m1_subset_1 X3 (k1_zfmisc_1 (u1_struct_0 X1)) -> False)
  ...
  -> (forall X1 X3 X2, (v2_struct_0 X2 -> False) -> (m1_subset_1 (esk12_3 X1 X2 X3) (u1_struct_0 X2) -> False) -> l1_fintopo2 X2 -> r2_hidden X1 (a_2_1_fintopo2 X2 X3) -> m1_subset_1 X3 (k1_zfmisc_1 (u1_struct_0 X2)) -> False)
  ...
  -> (forall X1 X3 X2, ((esk12_3 X1 X2 X3) = X1 -> False) -> (v2_struct_0 X2 -> False) -> l1_fintopo2 X2 -> r2_hidden X1 (a_2_1_fintopo2 X2 X3) -> m1_subset_1 X3 (k1_zfmisc_1 (u1_struct_0 X2)) -> False)
  -> (forall X3 X2 X1, (v2_struct_0 X1 -> False) -> (r2_hidden X2 X3 -> False) -> l1_fintopo2 X1 -> v2_fintopo2 X1 -> m1_subset_1 X2 (u1_struct_0 X1) -> r2_hidden X3 (k6_fintopo2 X1 X2) -> m1_subset_1 X3 (k1_zfmisc_1 (u1_struct_0 X1)) -> False)
  ...
  -> (forall X2 X1, ((a_2_1_fintopo2 X1 X2) = (k8_fintopo2 X1 X2) -> False) -> (v2_struct_0 X1 -> False) -> l1_fintopo2 X1 -> m1_subset_1 X2 (k1_zfmisc_1 (u1_struct_0 X1)) -> False)
  ...
  -> (forall X1, (v2_struct_0 X1 -> False) -> (v2_fintopo2 X1 -> False) -> (r2_hidden (esk8_1 X1) (k6_fintopo2 X1 (esk7_1 X1)) -> False) -> l1_fintopo2 X1 -> False)
  ...
  -> (forall X2 X1, (v1_xboole_0 X1 -> False) -> (v1_subset_1 X2 X1 -> False) -> v1_xboole_0 X2 -> m1_subset_1 X2 (k1_zfmisc_1 X1) -> False)
  -> (forall X1, (v2_struct_0 X1 -> False) -> (v2_fintopo2 X1 -> False) -> l1_fintopo2 X1 -> r2_hidden (esk7_1 X1) (esk8_1 X1) -> False)
  -> (forall X1 X2, (v1_xboole_0 X2 -> False) -> (v1_xboole_0 X1 -> False) -> v1_xboole_0 (k2_zfmisc_1 X1 X2) -> False)
  -> (forall X1, (v2_struct_0 X1 -> False) -> (v2_fintopo2 X1 -> False) -> (m1_subset_1 (esk8_1 X1) (k1_zfmisc_1 (u1_struct_0 X1)) -> False) -> l1_fintopo2 X1 -> False)
  ...
  -> (forall X1, (v2_struct_0 X1 -> False) -> (v2_fintopo2 X1 -> False) -> (m1_subset_1 (esk7_1 X1) (u1_struct_0 X1) -> False) -> l1_fintopo2 X1 -> False)
  ...
  -> ((r2_hidden esk4_0 (k6_fintopo2 esk1_0 esk2_0) -> False) -> False)
  -> ((r2_hidden esk3_0 (k6_fintopo2 esk1_0 esk2_0) -> False) -> False)
  ...
  -> ((v2_fintopo2 esk1_0 -> False) -> False)
