...
Theorem t8_pasch:
 ...
 forall esk10_5:set -> set -> set -> set -> set -> set,
     (forall X1 X2 X5 X3 X4, (X3 = X4 -> False) -> (v7_struct_0 X1 -> False) -> (r2_diraf X1 X2 X3 X3 (esk10_5 X1 X4 X3 X5 X2) -> False) -> v2_analoaf X1 -> l1_analoaf X1 -> m1_subset_1 X5 (u1_struct_0 X1) -> m1_subset_1 X4 (u1_struct_0 X1) -> m1_subset_1 X3 (u1_struct_0 X1) -> m1_subset_1 X2 (u1_struct_0 X1) -> r2_diraf X1 X4 X3 X3 X5 -> False)
  -> (forall X1 X4 X2 X3 X5, (X3 = X5 -> False) -> (v7_struct_0 X1 -> False) -> (r2_diraf X1 X2 X3 X4 (esk10_5 X1 X3 X5 X4 X2) -> False) -> v2_analoaf X1 -> l1_analoaf X1 -> m1_subset_1 X5 (u1_struct_0 X1) -> m1_subset_1 X4 (u1_struct_0 X1) -> m1_subset_1 X3 (u1_struct_0 X1) -> m1_subset_1 X2 (u1_struct_0 X1) -> r2_diraf X1 X3 X5 X5 X4 -> False)
  -> (forall X1 X5 X2 X3 X4 X6 X7, (X6 = X7 -> False) -> (v7_struct_0 X1 -> False) -> (r3_diraf X1 X2 X3 X4 -> False) -> v2_analoaf X1 -> l1_analoaf X1 -> m1_subset_1 X7 (u1_struct_0 X1) -> m1_subset_1 X6 (u1_struct_0 X1) -> m1_subset_1 X5 (u1_struct_0 X1) -> m1_subset_1 X4 (u1_struct_0 X1) -> m1_subset_1 X3 (u1_struct_0 X1) -> m1_subset_1 X2 (u1_struct_0 X1) -> r3_diraf X1 X2 X4 X5 -> r3_diraf X1 X2 X3 X7 -> r3_diraf X1 X2 X3 X6 -> r2_diraf X1 X3 X4 X5 X7 -> r2_diraf X1 X3 X4 X5 X6 -> False)
  ...
  -> (forall X1 X4 X5 X2 X3, (X2 = X3 -> False) -> (v7_struct_0 X1 -> False) -> (m1_subset_1 (esk10_5 X1 X2 X3 X4 X5) (u1_struct_0 X1) -> False) -> v2_analoaf X1 -> l1_analoaf X1 -> m1_subset_1 X5 (u1_struct_0 X1) -> m1_subset_1 X4 (u1_struct_0 X1) -> m1_subset_1 X3 (u1_struct_0 X1) -> m1_subset_1 X2 (u1_struct_0 X1) -> r2_diraf X1 X2 X3 X3 X4 -> False)
  ...
  -> (forall X2 X3 X1, (v7_struct_0 X1 -> False) -> (r2_diraf X1 X2 X3 X2 X3 -> False) -> v2_analoaf X1 -> l1_analoaf X1 -> m1_subset_1 X3 (u1_struct_0 X1) -> m1_subset_1 X2 (u1_struct_0 X1) -> False)
  -> (forall X2 X3 X1, (v7_struct_0 X1 -> False) -> (r2_diraf X1 X2 X3 X3 X2 -> False) -> v2_analoaf X1 -> l1_analoaf X1 -> m1_subset_1 X3 (u1_struct_0 X1) -> m1_subset_1 X2 (u1_struct_0 X1) -> False)
  -> (forall X4 X2 X3 X1, (v7_struct_0 X1 -> False) -> (r1_diraf X1 X3 X2 X4 -> False) -> (r1_diraf X1 X2 X4 X3 -> False) -> (r1_diraf X1 X2 X3 X4 -> False) -> v2_analoaf X1 -> l1_analoaf X1 -> m1_subset_1 X4 (u1_struct_0 X1) -> m1_subset_1 X3 (u1_struct_0 X1) -> m1_subset_1 X2 (u1_struct_0 X1) -> r3_diraf X1 X2 X3 X4 -> False)
  -> (forall X1 X4 X2 X3, (X2 = X3 -> False) -> (v7_struct_0 X1 -> False) -> v2_analoaf X1 -> l1_analoaf X1 -> m1_subset_1 X4 (u1_struct_0 X1) -> m1_subset_1 X3 (u1_struct_0 X1) -> m1_subset_1 X2 (u1_struct_0 X1) -> r1_diraf X1 X3 X2 X4 -> r1_diraf X1 X2 X3 X4 -> False)
  ...
  -> (r3_diraf esk1_0 esk2_0 esk5_0 esk3_0 -> False)
  -> (r1_diraf esk1_0 esk2_0 esk5_0 esk6_0 -> False)
  -> (v7_struct_0 esk1_0 -> False)
  -> ((r2_diraf esk1_0 esk5_0 esk3_0 esk4_0 esk6_0 -> False) -> False)
  -> ((r3_diraf esk1_0 esk2_0 esk5_0 esk6_0 -> False) -> False)
  -> ((r1_diraf esk1_0 esk2_0 esk3_0 esk4_0 -> False) -> False)
