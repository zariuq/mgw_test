...
Theorem t71_funct_3:
 ...
 forall esk24_4:set -> set -> set -> set -> set,
     (forall X3 X2 X1 X4, (X1 = X4 -> False) -> (k9_xtuple_0 X4) = (k2_zfmisc_1 X2 X3) -> (k9_xtuple_0 X1) = (k2_zfmisc_1 X2 X3) -> (k1_binop_1 X1 (esk24_4 X2 X3 X1 X4) (esk25_4 X2 X3 X1 X4)) = (k1_binop_1 X4 (esk24_4 X2 X3 X1 X4) (esk25_4 X2 X3 X1 X4)) -> v1_relat_1 X4 -> v1_relat_1 X1 -> v1_funct_1 X4 -> v1_funct_1 X1 -> False)
  ...
  -> (forall X2 X1 X3, (X1 = (k15_funct_3 X2 X3) -> False) -> (k9_xtuple_0 X1) = (k2_zfmisc_1 (k9_xtuple_0 X2) (k9_xtuple_0 X3)) -> (k2_tarski (k2_tarski (k1_funct_1 X2 (esk10_3 X2 X3 X1)) (k1_funct_1 X3 (esk11_3 X2 X3 X1))) (k1_tarski (k1_funct_1 X2 (esk10_3 X2 X3 X1)))) = (k1_binop_1 X1 (esk10_3 X2 X3 X1) (esk11_3 X2 X3 X1)) -> v1_relat_1 X3 -> v1_relat_1 X2 -> v1_relat_1 X1 -> v1_funct_1 X3 -> v1_funct_1 X2 -> v1_funct_1 X1 -> False)
  ...
  -> (forall X2 X1 X3 X4, (X3 = X4 -> False) -> (r2_hidden (esk25_4 X1 X2 X3 X4) X2 -> False) -> (k9_xtuple_0 X4) = (k2_zfmisc_1 X1 X2) -> (k9_xtuple_0 X3) = (k2_zfmisc_1 X1 X2) -> v1_relat_1 X4 -> v1_relat_1 X3 -> v1_funct_1 X4 -> v1_funct_1 X3 -> False)
  -> (forall X2 X1 X3 X4, (X3 = X4 -> False) -> (r2_hidden (esk24_4 X1 X2 X3 X4) X1 -> False) -> (k9_xtuple_0 X4) = (k2_zfmisc_1 X1 X2) -> (k9_xtuple_0 X3) = (k2_zfmisc_1 X1 X2) -> v1_relat_1 X4 -> v1_relat_1 X3 -> v1_funct_1 X4 -> v1_funct_1 X3 -> False)
  -> (forall X1 X4 X3 X2, ((k2_tarski (k2_tarski (k1_funct_1 X1 X3) (k1_funct_1 X2 X4)) (k1_tarski (k1_funct_1 X1 X3))) = (k1_binop_1 (k15_funct_3 X1 X2) X3 X4) -> False) -> v1_relat_1 X2 -> v1_relat_1 X1 -> v1_funct_1 X2 -> v1_funct_1 X1 -> r2_hidden (k2_tarski (k2_tarski X3 X4) (k1_tarski X3)) (k2_zfmisc_1 (k9_xtuple_0 X1) (k9_xtuple_0 X2)) -> False)
  ...
  -> (forall X2 X1 X3, (X3 = (k15_funct_3 X1 X2) -> False) -> (r2_hidden (esk11_3 X1 X2 X3) (k9_xtuple_0 X2) -> False) -> (k9_xtuple_0 X3) = (k2_zfmisc_1 (k9_xtuple_0 X1) (k9_xtuple_0 X2)) -> v1_relat_1 X3 -> v1_relat_1 X2 -> v1_relat_1 X1 -> v1_funct_1 X3 -> v1_funct_1 X2 -> v1_funct_1 X1 -> False)
  -> (forall X2 X1 X3, (X3 = (k15_funct_3 X1 X2) -> False) -> (r2_hidden (esk10_3 X1 X2 X3) (k9_xtuple_0 X1) -> False) -> (k9_xtuple_0 X3) = (k2_zfmisc_1 (k9_xtuple_0 X1) (k9_xtuple_0 X2)) -> v1_relat_1 X3 -> v1_relat_1 X2 -> v1_relat_1 X1 -> v1_funct_1 X3 -> v1_funct_1 X2 -> v1_funct_1 X1 -> False)
  ...
  -> ((k15_funct_3 (k3_relat_1 esk2_0 esk1_0) (k3_relat_1 esk4_0 esk3_0)) = (k3_relat_1 (k15_funct_3 esk2_0 esk4_0) (k15_funct_3 esk1_0 esk3_0)) -> False)
