...
Theorem t25_tex_4:
 ...
 forall a_2_6_tex_4:set -> set -> set,
 forall l1_pre_topc:set -> prop,
 forall v2_struct_0:set -> prop,
     (forall X1 X3 X2, (v2_struct_0 X2 -> False) -> (m1_subset_1 (esk8_3 X1 X2 X3) (k1_zfmisc_1 (u1_struct_0 X2)) -> False) -> l1_pre_topc X2 -> m1_subset_1 X3 (u1_struct_0 X2) -> r2_hidden X1 (a_2_6_tex_4 X2 X3) -> False)
  ...
  -> (forall X1 X3 X2, (v2_struct_0 X2 -> False) -> (v4_pre_topc (esk8_3 X1 X2 X3) X2 -> False) -> l1_pre_topc X2 -> m1_subset_1 X3 (u1_struct_0 X2) -> r2_hidden X1 (a_2_6_tex_4 X2 X3) -> False)
  -> (forall X2 X1 X3, (v2_struct_0 X3 -> False) -> (r2_hidden X1 (esk8_3 X2 X3 X1) -> False) -> l1_pre_topc X3 -> m1_subset_1 X1 (u1_struct_0 X3) -> r2_hidden X2 (a_2_6_tex_4 X3 X1) -> False)
  ...
  -> (forall X3 X4 X1 X2, (v2_struct_0 X2 -> False) -> (r2_hidden X3 (a_2_6_tex_4 X2 X4) -> False) -> X1 = X3 -> l1_pre_topc X2 -> r2_hidden X4 X1 -> v4_pre_topc X1 X2 -> m1_subset_1 X4 (u1_struct_0 X2) -> m1_subset_1 X1 (k1_zfmisc_1 (u1_struct_0 X2)) -> False)
  -> (forall X3 X2 X1, (v2_struct_0 X1 -> False) -> (r1_tarski (k2_tex_4 X1 X3) X2 -> False) -> l1_pre_topc X1 -> r2_hidden X3 X2 -> v4_pre_topc X2 X1 -> m1_subset_1 X3 (u1_struct_0 X1) -> m1_subset_1 X2 (k1_zfmisc_1 (u1_struct_0 X1)) -> False)
  ...
  -> (forall X1 X3 X2, ((esk8_3 X1 X2 X3) = X1 -> False) -> (v2_struct_0 X2 -> False) -> l1_pre_topc X2 -> m1_subset_1 X3 (u1_struct_0 X2) -> r2_hidden X1 (a_2_6_tex_4 X2 X3) -> False)
  ...
  -> (r1_tarski (k2_tex_4 esk1_0 esk2_0) (k1_setfam_1 (a_2_6_tex_4 esk1_0 esk2_0)) -> False)
