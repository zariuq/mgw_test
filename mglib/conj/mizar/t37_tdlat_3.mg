...
Theorem t37_tdlat_3:
 ...
 forall u1_struct_0:set -> set,
     (forall X3 X1 X2, ((k9_subset_1 (u1_struct_0 X1) (esk29_3 X2 X1 X3) (k2_struct_0 X1)) = X3 -> False) -> l1_pre_topc X2 -> m1_pre_topc X1 X2 -> v3_pre_topc X3 X1 -> m1_subset_1 X3 (k1_zfmisc_1 (u1_struct_0 X1)) -> False)
  -> (forall X1 X2 X4 X3, (v3_pre_topc X4 X3 -> False) -> (k9_subset_1 (u1_struct_0 X3) X1 (k2_struct_0 X3)) = X4 -> l1_pre_topc X2 -> m1_pre_topc X3 X2 -> v3_pre_topc X1 X2 -> m1_subset_1 X4 (k1_zfmisc_1 (u1_struct_0 X3)) -> m1_subset_1 X1 (k1_zfmisc_1 (u1_struct_0 X2)) -> False)
  -> (forall X2 X3 X1, (v2_struct_0 X1 -> False) -> (r1_xboole_0 (k2_pre_topc X1 X2) (k2_pre_topc X1 X3) -> False) -> v2_pre_topc X1 -> v4_tdlat_3 X1 -> l1_pre_topc X1 -> v3_pre_topc X3 X1 -> v3_pre_topc X2 X1 -> r1_xboole_0 X2 X3 -> m1_subset_1 X3 (k1_zfmisc_1 (u1_struct_0 X1)) -> m1_subset_1 X2 (k1_zfmisc_1 (u1_struct_0 X1)) -> False)
  -> (forall X3 X2 X1, (m1_subset_1 (esk29_3 X1 X2 X3) (k1_zfmisc_1 (u1_struct_0 X1)) -> False) -> l1_pre_topc X1 -> m1_pre_topc X2 X1 -> v3_pre_topc X3 X2 -> m1_subset_1 X3 (k1_zfmisc_1 (u1_struct_0 X2)) -> False)
  -> (forall X1 X2 X3 X4, ((k2_pre_topc X2 X4) = (k9_subset_1 (u1_struct_0 X2) (k2_pre_topc X1 X3) (k2_struct_0 X2)) -> False) -> X3 = X4 -> l1_pre_topc X1 -> m1_pre_topc X2 X1 -> m1_subset_1 X4 (k1_zfmisc_1 (u1_struct_0 X2)) -> m1_subset_1 X3 (k1_zfmisc_1 (u1_struct_0 X1)) -> False)
  -> (forall X3 X2 X1, (v3_pre_topc (esk29_3 X1 X2 X3) X1 -> False) -> l1_pre_topc X1 -> m1_pre_topc X2 X1 -> v3_pre_topc X3 X2 -> m1_subset_1 X3 (k1_zfmisc_1 (u1_struct_0 X2)) -> False)
  ...
  -> (forall X2 X1 X3, (X3 = k1_xboole_0 -> False) -> v2_pre_topc X2 -> l1_pre_topc X2 -> v1_tops_1 X1 X2 -> v3_pre_topc X3 X2 -> r1_xboole_0 X1 X3 -> m1_subset_1 X3 (k1_zfmisc_1 (u1_struct_0 X2)) -> m1_subset_1 X1 (k1_zfmisc_1 (u1_struct_0 X2)) -> False)
  -> (forall X1, (v2_struct_0 X1 -> False) -> (v4_tdlat_3 X1 -> False) -> v2_pre_topc X1 -> l1_pre_topc X1 -> r1_xboole_0 (k2_pre_topc X1 (esk30_1 X1)) (k2_pre_topc X1 (esk31_1 X1)) -> False)
  ...
  -> (forall X2 X1, (v1_tops_1 X2 X1 -> False) -> (m1_subset_1 (esk32_2 X1 X2) (k1_zfmisc_1 (u1_struct_0 X1)) -> False) -> v2_pre_topc X1 -> l1_pre_topc X1 -> m1_subset_1 X2 (k1_zfmisc_1 (u1_struct_0 X1)) -> False)
  ...
  -> (forall X2 X1, (v1_tops_1 X2 X1 -> False) -> (v3_pre_topc (esk32_2 X1 X2) X1 -> False) -> v2_pre_topc X1 -> l1_pre_topc X1 -> m1_subset_1 X2 (k1_zfmisc_1 (u1_struct_0 X1)) -> False)
  -> (forall X1 X2, (v1_tops_1 X1 X2 -> False) -> (r1_xboole_0 X1 (esk32_2 X2 X1) -> False) -> v2_pre_topc X2 -> l1_pre_topc X2 -> m1_subset_1 X1 (k1_zfmisc_1 (u1_struct_0 X2)) -> False)
  ...
  -> (forall X2 X1, (v1_tops_1 X2 X1 -> False) -> (esk32_2 X1 X2) = k1_xboole_0 -> v2_pre_topc X1 -> l1_pre_topc X1 -> m1_subset_1 X2 (k1_zfmisc_1 (u1_struct_0 X1)) -> False)
  ...
  -> (forall X1, (v2_struct_0 X1 -> False) -> (v4_tdlat_3 X1 -> False) -> (m1_subset_1 (esk31_1 X1) (k1_zfmisc_1 (u1_struct_0 X1)) -> False) -> v2_pre_topc X1 -> l1_pre_topc X1 -> False)
  -> (forall X1, (v2_struct_0 X1 -> False) -> (v4_tdlat_3 X1 -> False) -> (m1_subset_1 (esk30_1 X1) (k1_zfmisc_1 (u1_struct_0 X1)) -> False) -> v2_pre_topc X1 -> l1_pre_topc X1 -> False)
  ...
  -> (forall X2 X1, (v1_xboole_0 X1 -> False) -> (v1_subset_1 X2 X1 -> False) -> v1_xboole_0 X2 -> m1_subset_1 X2 (k1_zfmisc_1 X1) -> False)
  -> (forall X1, (v2_struct_0 X1 -> False) -> (m1_subset_1 (esk27_1 X1) (k1_zfmisc_1 (u1_struct_0 X1)) -> False) -> v2_pre_topc X1 -> l1_pre_topc X1 -> False)
  ...
  -> (forall X1, (v2_struct_0 X1 -> False) -> v2_pre_topc X1 -> l1_pre_topc X1 -> v2_tops_1 (esk26_1 X1) X1 -> False)
  ...
  -> (forall X1, (v2_struct_0 X1 -> False) -> (v4_tdlat_3 X1 -> False) -> (r1_xboole_0 (esk30_1 X1) (esk31_1 X1) -> False) -> v2_pre_topc X1 -> l1_pre_topc X1 -> False)
  ...
  -> (forall X1, (v2_struct_0 X1 -> False) -> (v4_tdlat_3 X1 -> False) -> (v3_pre_topc (esk31_1 X1) X1 -> False) -> v2_pre_topc X1 -> l1_pre_topc X1 -> False)
  -> (forall X1, (v2_struct_0 X1 -> False) -> (v4_tdlat_3 X1 -> False) -> (v3_pre_topc (esk30_1 X1) X1 -> False) -> v2_pre_topc X1 -> l1_pre_topc X1 -> False)
  ...
  -> (forall X1, (v2_struct_0 X1 -> False) -> (v4_pre_topc (esk27_1 X1) X1 -> False) -> v2_pre_topc X1 -> l1_pre_topc X1 -> False)
  -> (forall X1, (v2_struct_0 X1 -> False) -> (v4_pre_topc (esk18_1 X1) X1 -> False) -> v2_pre_topc X1 -> l1_pre_topc X1 -> False)
  -> (forall X1, (v2_struct_0 X1 -> False) -> (v3_pre_topc (esk18_1 X1) X1 -> False) -> v2_pre_topc X1 -> l1_pre_topc X1 -> False)
  ...
  -> (forall X1, (v2_struct_0 X1 -> False) -> v2_pre_topc X1 -> l1_pre_topc X1 -> v1_xboole_0 (esk27_1 X1) -> False)
  ...
  -> (forall X1, (v3_tops_1 (esk28_1 X1) X1 -> False) -> v2_pre_topc X1 -> l1_pre_topc X1 -> False)
  -> (forall X1, (v4_pre_topc (esk24_1 X1) X1 -> False) -> v2_pre_topc X1 -> l1_pre_topc X1 -> False)
  ...
  -> (forall X1, (v2_tops_1 (esk23_1 X1) X1 -> False) -> l1_pre_topc X1 -> False)
  -> (forall X1, (v1_tops_1 (esk21_1 X1) X1 -> False) -> l1_pre_topc X1 -> False)
  ...
  -> ((v1_tops_1 esk3_0 esk1_0 -> False) -> False)
  ...
  -> ((v4_tdlat_3 esk1_0 -> False) -> False)
  -> ((v2_pre_topc esk1_0 -> False) -> False)
  -> (((u1_struct_0 esk2_0) = esk3_0 -> False) -> False)
