...
Theorem t96_prepower:
 ...
 forall k9_real_1:set -> set -> set,
     (forall X2 X1 X3, (r1_int_1 X1 (k9_real_1 X2 X3) -> False) -> r1_nat_d X1 X3 -> r1_nat_d X1 X2 -> m2_subset_1 X3 k1_numbers k5_numbers -> m2_subset_1 X2 k1_numbers k5_numbers -> m2_subset_1 X1 k1_numbers k5_numbers -> False)
  -> (forall X2 X1 X3, (X3 = (k3_int_2 X1 X2) -> False) -> v7_ordinal1 X3 -> v7_ordinal1 X2 -> v7_ordinal1 X1 -> r1_nat_d X3 X2 -> r1_nat_d X3 X1 -> r1_nat_d (esk3_3 X1 X2 X3) X3 -> False)
  -> (forall X2 X1 X3, (X3 = (k3_int_2 X1 X2) -> False) -> (r1_nat_d (esk3_3 X1 X2 X3) X1 -> False) -> v7_ordinal1 X3 -> v7_ordinal1 X2 -> v7_ordinal1 X1 -> r1_nat_d X3 X2 -> r1_nat_d X3 X1 -> False)
  -> (forall X2 X1 X3, (X3 = (k3_int_2 X1 X2) -> False) -> (r1_nat_d (esk3_3 X1 X2 X3) X2 -> False) -> v7_ordinal1 X3 -> v7_ordinal1 X2 -> v7_ordinal1 X1 -> r1_nat_d X3 X2 -> r1_nat_d X3 X1 -> False)
  -> (forall X2 X1 X3, (X3 = (k3_int_2 X1 X2) -> False) -> (v7_ordinal1 (esk3_3 X1 X2 X3) -> False) -> v7_ordinal1 X3 -> v7_ordinal1 X2 -> v7_ordinal1 X1 -> r1_nat_d X3 X2 -> r1_nat_d X3 X1 -> False)
  ...
  -> (forall X2 X1 X3, (r1_nat_d X1 (k2_xcmplx_0 X2 X3) -> False) -> v7_ordinal1 X3 -> v7_ordinal1 X2 -> v7_ordinal1 X1 -> r1_nat_d X1 X3 -> r1_nat_d X1 X2 -> False)
  ...
  -> (forall X2 X1, (r1_int_1 X1 X2 -> False) -> epred1_2 X1 X2 -> r1_int_1 (k4_xcmplx_0 X1) (k4_xcmplx_0 X2) -> False)
  -> (forall X2 X1, (r1_int_1 (k4_xcmplx_0 X1) X2 -> False) -> epred1_2 X1 X2 -> r1_int_1 X1 (k4_xcmplx_0 X2) -> False)
  -> (forall X2 X1, (r1_int_1 X1 (k4_xcmplx_0 X2) -> False) -> epred1_2 X1 X2 -> r1_int_1 (k4_xcmplx_0 X1) X2 -> False)
  -> (forall X2 X1, (r1_int_1 (k4_xcmplx_0 X1) (k4_xcmplx_0 X2) -> False) -> r1_int_1 X1 X2 -> epred1_2 X1 X2 -> False)
  ...
  -> (forall X2 X1, (r1_int_1 X1 X2 -> False) -> epred1_2 X1 X2 -> r1_int_1 (k4_xcmplx_0 X1) X2 -> False)
  -> (forall X2 X1, (r1_int_1 X1 X2 -> False) -> epred1_2 X1 X2 -> r1_int_1 X1 (k4_xcmplx_0 X2) -> False)
  ...
  -> (forall X2 X1, (r1_int_1 (k4_xcmplx_0 X1) X2 -> False) -> r1_int_1 X1 X2 -> epred1_2 X1 X2 -> False)
  -> (forall X2 X1, (r1_int_1 X1 (k4_xcmplx_0 X2) -> False) -> r1_int_1 X1 X2 -> epred1_2 X1 X2 -> False)
  -> (forall X2 X1 X3, v1_xboole_0 X3 -> r2_hidden X1 X2 -> m1_subset_1 X2 (k1_zfmisc_1 X3) -> False)
  -> (forall X1 X2, (X1 = X2 -> False) -> v7_ordinal1 X2 -> v7_ordinal1 X1 -> r1_nat_d X2 X1 -> r1_nat_d X1 X2 -> False)
  ...
  -> (forall X2 X1, (epred1_2 X1 X2 -> False) -> v1_int_1 X2 -> v1_int_1 X1 -> False)
  ...
  -> ((k6_nat_d esk1_0 (k1_int_2 (k9_real_1 esk2_0 esk1_0))) = (k6_nat_d esk1_0 esk2_0) -> False)
