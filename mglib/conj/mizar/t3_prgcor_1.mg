...
Theorem t3_prgcor_1:
 ...
 forall k4_nat_d:set -> set -> set,
     (forall X1 X2, ((k6_xcmplx_0 (k4_nat_d X1 (k4_nat_1 np__2 X2)) X2) = (k4_nat_d X1 X2) -> False) -> (r1_xxreal_0 X2 k6_numbers -> False) -> m1_subset_1 X2 k5_numbers -> m1_subset_1 X1 k5_numbers -> r1_xxreal_0 X2 (k4_nat_d X1 (k4_nat_1 np__2 X2)) -> False)
  -> (forall X1 X2, ((k2_nat_1 (k4_nat_d X1 X2) X2) = (k4_nat_d X1 (k4_nat_1 np__2 X2)) -> False) -> (r1_xxreal_0 X2 k6_numbers -> False) -> m1_subset_1 X2 k5_numbers -> m1_subset_1 X1 k5_numbers -> r1_xxreal_0 X2 (k4_nat_d X1 (k4_nat_1 np__2 X2)) -> False)
  -> (forall X3 X2 X1, (X1 = k6_numbers -> False) -> X1 = (k1_nat_d X3 X2) -> v7_ordinal1 X3 -> v7_ordinal1 X2 -> v7_ordinal1 X1 -> r1_xxreal_0 X2 (esk3_3 X3 X2 X1) -> False)
  -> (forall X3 X2 X1, (X1 = k6_numbers -> False) -> X3 = (k1_nat_d X2 X1) -> v7_ordinal1 X3 -> v7_ordinal1 X2 -> v7_ordinal1 X1 -> r1_xxreal_0 X1 (esk3_3 X2 X1 X3) -> False)
  -> (forall X3 X2 X1, (X1 = k6_numbers -> False) -> ((k2_xcmplx_0 (k3_xcmplx_0 X1 X3) (esk3_3 X2 X1 X3)) = X2 -> False) -> X3 = (k1_nat_d X2 X1) -> v7_ordinal1 X3 -> v7_ordinal1 X2 -> v7_ordinal1 X1 -> False)
  -> (forall X3 X2 X1, (X1 = k6_numbers -> False) -> ((k2_xcmplx_0 (k3_xcmplx_0 X3 X1) (esk3_3 X2 X3 X1)) = X2 -> False) -> X1 = (k1_nat_d X2 X3) -> v7_ordinal1 X3 -> v7_ordinal1 X2 -> v7_ordinal1 X1 -> False)
  -> (forall X3 X2 X1, (X1 = k6_numbers -> False) -> (v7_ordinal1 (esk3_3 X2 X1 X3) -> False) -> X3 = (k1_nat_d X2 X1) -> v7_ordinal1 X3 -> v7_ordinal1 X2 -> v7_ordinal1 X1 -> False)
  -> (forall X3 X2 X1, (X1 = k6_numbers -> False) -> (v7_ordinal1 (esk3_3 X2 X3 X1) -> False) -> X1 = (k1_nat_d X2 X3) -> v7_ordinal1 X3 -> v7_ordinal1 X2 -> v7_ordinal1 X1 -> False)
  ...
  -> ((k2_nat_1 (k4_nat_1 (k3_nat_d esk1_0 (k4_nat_1 np__2 esk2_0)) np__2) np__1) = (k3_nat_d esk1_0 esk2_0) -> False)
