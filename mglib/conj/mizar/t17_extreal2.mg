...
Theorem t17_extreal2:
 ...
 forall k6_xxreal_3:set -> set -> set,
 ...
 forall k2_extreal1:set -> set -> set,
 ...
 forall v1_xboole_0:set -> prop,
  ...
  -> (forall X3 X1 X2 X4, ((k12_binop_2 X3 X4) = (k2_extreal1 X1 X2) -> False) -> X2 = X4 -> X1 = X3 -> m1_subset_1 X4 k1_numbers -> m1_subset_1 X3 k1_numbers -> m1_subset_1 X2 k7_numbers -> m1_subset_1 X1 k7_numbers -> False)
  ...
  -> (forall X2 X1, (m1_subset_1 (k2_extreal1 X1 X2) k7_numbers -> False) -> m1_subset_1 X2 k7_numbers -> m1_subset_1 X1 k7_numbers -> False)
  ...
  -> (forall X1 X2, (v2_xxreal_0 X2 -> False) -> (v2_xxreal_0 X1 -> False) -> v1_xxreal_0 X2 -> v1_xxreal_0 X1 -> v3_xxreal_0 (k6_xxreal_3 X1 X2) -> False)
  ...
  -> (forall X2 X1, (v3_xxreal_0 X1 -> False) -> (v2_xxreal_0 X2 -> False) -> v1_xxreal_0 X2 -> v1_xxreal_0 X1 -> v2_xxreal_0 (k6_xxreal_3 X1 X2) -> False)
  ...
  -> (forall X1 X2, (v3_xxreal_0 X2 -> False) -> (v2_xxreal_0 X1 -> False) -> v1_xxreal_0 X2 -> v1_xxreal_0 X1 -> v2_xxreal_0 (k6_xxreal_3 X1 X2) -> False)
  ...
  -> (forall X1 X2, (v3_xxreal_0 X2 -> False) -> (v3_xxreal_0 X1 -> False) -> v1_xxreal_0 X2 -> v1_xxreal_0 X1 -> v3_xxreal_0 (k6_xxreal_3 X1 X2) -> False)
  ...
  -> (forall X1 X2, (r1_xxreal_0 X2 X1 -> False) -> v1_xxreal_0 X2 -> v1_xxreal_0 X1 -> r1_xxreal_0 (k2_xxreal_3 X1) (k2_xxreal_3 X2) -> False)
  -> (forall X2 X1, ((k13_complex1 (k17_complex1 X1) (k17_complex1 X2)) = (k17_complex1 (k13_complex1 X1 X2)) -> False) -> v1_xcmplx_0 X2 -> v1_xcmplx_0 X1 -> False)
  ...
  -> (forall X2 X1, ((k2_extreal1 X1 X2) = (k6_xxreal_3 X1 X2) -> False) -> m1_subset_1 X2 k7_numbers -> m1_subset_1 X1 k7_numbers -> False)
  -> (forall X2 X1, (m1_subset_1 (k10_real_1 X1 X2) k1_numbers -> False) -> v1_xreal_0 X2 -> m1_subset_1 X1 k1_numbers -> False)
  -> (forall X3 X1 X2 X4, ((k7_xcmplx_0 X3 X4) = (k6_xxreal_3 X1 X2) -> False) -> X2 = X4 -> X1 = X3 -> v1_xcmplx_0 X4 -> v1_xcmplx_0 X3 -> v1_xreal_0 X2 -> v1_xreal_0 X1 -> False)
  ...
  -> (forall X1 X2, (r1_xxreal_0 (k2_xxreal_3 X2) (k2_xxreal_3 X1) -> False) -> v1_xxreal_0 X2 -> v1_xxreal_0 X1 -> r1_xxreal_0 X1 X2 -> False)
  ...
  -> (forall X1 X2, (v2_xxreal_0 X2 -> False) -> (v2_xxreal_0 X1 -> False) -> (v1_xxreal_0 (k6_xxreal_3 X1 X2) -> False) -> v1_xxreal_0 X2 -> v1_xxreal_0 X1 -> False)
  ...
  -> (forall X2 X1, (v3_xxreal_0 X1 -> False) -> (v2_xxreal_0 X2 -> False) -> (v1_xxreal_0 (k6_xxreal_3 X1 X2) -> False) -> v1_xxreal_0 X2 -> v1_xxreal_0 X1 -> False)
  -> (forall X1 X2, (v3_xxreal_0 X2 -> False) -> (v2_xxreal_0 X1 -> False) -> (v1_xxreal_0 (k6_xxreal_3 X1 X2) -> False) -> v1_xxreal_0 X2 -> v1_xxreal_0 X1 -> False)
  ...
  -> (forall X1 X2, (v3_xxreal_0 X2 -> False) -> (v3_xxreal_0 X1 -> False) -> (v1_xxreal_0 (k6_xxreal_3 X1 X2) -> False) -> v1_xxreal_0 X2 -> v1_xxreal_0 X1 -> False)
  ...
  -> (forall X1, (X1 = k6_numbers -> False) -> m1_subset_1 X1 k7_numbers -> r1_xxreal_0 (k3_extreal1 X1) k6_numbers -> False)
  ...
  -> (forall X2 X1, ((k4_xxreal_3 X1 (k5_xxreal_3 X2)) = (k6_xxreal_3 X1 X2) -> False) -> v1_xxreal_0 X2 -> v1_xxreal_0 X1 -> False)
  -> (forall X1, v1_xxreal_0 X1 -> r2_hidden X1 k1_numbers -> r1_xxreal_0 X1 k2_xxreal_0 -> False)
  -> (forall X2 X1, (r1_tarski X1 X2 -> False) -> m1_subset_1 X1 (k1_zfmisc_1 X2) -> False)
  -> (forall X1, ((k3_extreal1 X1) = X1 -> False) -> m1_subset_1 X1 k7_numbers -> r1_xxreal_0 k6_numbers X1 -> False)
  -> (forall X1, ((k3_extreal1 X1) = X1 -> False) -> m1_subset_1 X1 k7_numbers -> r1_xxreal_0 k6_numbers X1 -> False)
  -> (forall X2 X1, r2_hidden X2 X1 -> r2_hidden X1 X2 -> False)
  -> (forall X2 X1, (v1_xreal_0 (k7_xcmplx_0 X1 X2) -> False) -> v1_xreal_0 X2 -> v1_xreal_0 X1 -> False)
  -> (forall X2 X1, (v1_xreal_0 (k6_xxreal_3 X1 X2) -> False) -> v1_xreal_0 X2 -> v1_xreal_0 X1 -> False)
  ...
  -> (forall X2 X1, (v1_xxreal_0 (k6_xxreal_3 X1 X2) -> False) -> v1_xreal_0 X2 -> v1_xreal_0 X1 -> False)
  -> (forall X2 X1, (v1_xxreal_0 (k6_xxreal_3 X1 X2) -> False) -> v1_xxreal_0 X2 -> v1_xxreal_0 X1 -> False)
  ...
  -> (forall X1, ((k3_extreal1 X1) = (k2_supinf_2 X1) -> False) -> (r1_xxreal_0 k6_numbers X1 -> False) -> m1_subset_1 X1 k7_numbers -> False)
  -> (forall X1, ((k3_extreal1 X1) = (k2_supinf_2 X1) -> False) -> (r1_xxreal_0 k6_numbers X1 -> False) -> m1_subset_1 X1 k7_numbers -> False)
  -> (forall X1, (m1_subset_1 (k2_supinf_2 X1) k7_numbers -> False) -> m1_subset_1 X1 k7_numbers -> False)
  ...
  -> (forall X1, (k2_xxreal_0 = X1 -> False) -> ((k6_xxreal_3 k1_xxreal_0 X1) = k2_xxreal_0 -> False) -> (r1_xxreal_0 k6_numbers X1 -> False) -> v1_xxreal_0 X1 -> False)
  -> (forall X1, (k2_xxreal_0 = X1 -> False) -> ((k6_xxreal_3 k2_xxreal_0 X1) = k1_xxreal_0 -> False) -> (r1_xxreal_0 k6_numbers X1 -> False) -> v1_xxreal_0 X1 -> False)
  -> (forall X1, (X1 = k1_xxreal_0 -> False) -> ((k6_xxreal_3 k1_xxreal_0 X1) = k1_xxreal_0 -> False) -> (r1_xxreal_0 X1 k6_numbers -> False) -> v1_xxreal_0 X1 -> False)
  -> (forall X1, (X1 = k1_xxreal_0 -> False) -> ((k6_xxreal_3 k2_xxreal_0 X1) = k2_xxreal_0 -> False) -> (r1_xxreal_0 X1 k6_numbers -> False) -> v1_xxreal_0 X1 -> False)
  ...
  -> (forall X1, ((k2_supinf_2 (k2_supinf_2 X1)) = X1 -> False) -> m1_subset_1 X1 k7_numbers -> False)
  -> (forall X1 X2, v1_xboole_0 X2 -> r2_hidden X1 X2 -> False)
  -> (forall X2 X1, (r1_xxreal_0 X1 X1 -> False) -> v1_xxreal_0 X2 -> v1_xxreal_0 X1 -> False)
  -> (forall X1, ((k2_supinf_2 X1) = (k2_xxreal_3 X1) -> False) -> m1_subset_1 X1 k7_numbers -> False)
  ...
  -> (forall X2 X1, ((k5_xcmplx_0 X2) = (k5_xxreal_3 X1) -> False) -> X1 = X2 -> v1_xcmplx_0 X2 -> v1_xreal_0 X1 -> False)
  ...
  -> (esk1_0 = k1_supinf_1 -> esk2_0 = k1_supinf_1 -> False)
  -> (esk1_0 = k1_supinf_1 -> esk2_0 = k2_supinf_1 -> False)
  -> (esk1_0 = k2_supinf_1 -> esk2_0 = k1_supinf_1 -> False)
  -> (esk1_0 = k2_supinf_1 -> esk2_0 = k2_supinf_1 -> False)
  -> ((k2_extreal1 (k3_extreal1 esk1_0) (k3_extreal1 esk2_0)) = (k3_extreal1 (k2_extreal1 esk1_0 esk2_0)) -> False)
  ...
  -> ((v1_xboole_0 (k5_xxreal_3 k1_xxreal_0) -> False) -> False)
  -> ((v1_xboole_0 (k5_xxreal_3 k2_xxreal_0) -> False) -> False)
  -> ((v1_xxreal_0 (k5_xxreal_3 k1_xxreal_0) -> False) -> False)
  -> ((v1_xxreal_0 (k5_xxreal_3 k2_xxreal_0) -> False) -> False)
  ...
  -> (((k2_xxreal_3 k2_xxreal_0) = k1_xxreal_0 -> False) -> False)
