...
Theorem t70_setlim_2:
 ...
 forall k4_setlim_2:set -> set -> set -> set,
  ...
  -> (forall X4 X1 X2 X3, (r2_hidden X1 (k3_funct_2 k5_numbers (k9_setfam_1 X2) X3 (k2_nat_1 X4 (esk21_4 X2 X3 X1 X4))) -> False) -> v1_funct_1 X3 -> m1_subset_1 X4 k5_numbers -> r2_hidden X1 (k4_kurato_0 X2 X3) -> v1_funct_2 X3 k5_numbers (k9_setfam_1 X2) -> m1_subset_1 X3 (k9_setfam_1 (k2_zfmisc_1 k5_numbers (k9_setfam_1 X2))) -> False)
  -> (forall X1 X3 X4 X2, (r2_hidden X2 (k4_kurato_0 X3 X4) -> False) -> v1_funct_1 X4 -> m1_subset_1 X1 k5_numbers -> v1_funct_2 X4 k5_numbers (k9_setfam_1 X3) -> m1_subset_1 X4 (k9_setfam_1 (k2_zfmisc_1 k5_numbers (k9_setfam_1 X3))) -> r2_hidden X2 (k3_funct_2 k5_numbers (k9_setfam_1 X3) X4 (k2_nat_1 (esk22_3 X3 X4 X2) X1)) -> False)
  ...
  -> (forall X4 X3 X1 X2, (m1_subset_1 (esk21_4 X1 X2 X3 X4) k5_numbers -> False) -> v1_funct_1 X2 -> m1_subset_1 X4 k5_numbers -> r2_hidden X3 (k4_kurato_0 X1 X2) -> v1_funct_2 X2 k5_numbers (k9_setfam_1 X1) -> m1_subset_1 X2 (k9_setfam_1 (k2_zfmisc_1 k5_numbers (k9_setfam_1 X1))) -> False)
  ...
  -> (forall X3 X1 X2, (r2_hidden X3 (k4_kurato_0 X1 X2) -> False) -> (m1_subset_1 (esk22_3 X1 X2 X3) k5_numbers -> False) -> v1_funct_1 X2 -> v1_funct_2 X2 k5_numbers (k9_setfam_1 X1) -> m1_subset_1 X2 (k9_setfam_1 (k2_zfmisc_1 k5_numbers (k9_setfam_1 X1))) -> False)
  ...
  -> (r1_tarski (k5_subset_1 esk1_0 (k4_kurato_0 esk1_0 esk2_0) (k4_kurato_0 esk1_0 esk3_0)) (k4_kurato_0 esk1_0 (k4_setlim_2 esk1_0 esk2_0 esk3_0)) -> False)
