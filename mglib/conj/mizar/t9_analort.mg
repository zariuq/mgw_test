...
Theorem t9_analort:
 ...
 forall k3_geomtrap:set -> set -> set -> set -> set,
 forall k1_rlvect_1:set -> set -> set -> set,
 forall k2_geomtrap:set -> set -> set -> set -> set,
 forall k1_real_1:set -> set,
 forall k2_analort:set -> set -> set -> set -> set,
     (forall X2 X3 X4 X1, ((k3_rlvect_1 X1 (k1_rlvect_1 X1 X2 (k3_geomtrap X1 X2 X3 X4)) (k1_rlvect_1 X1 X3 (k1_real_1 (k2_geomtrap X1 X2 X3 X4)))) = (k2_analort X1 X2 X3 X4) -> False) -> (v2_struct_0 X1 -> False) -> v13_algstr_0 X1 -> v2_rlvect_1 X1 -> v3_rlvect_1 X1 -> v4_rlvect_1 X1 -> v5_rlvect_1 X1 -> v6_rlvect_1 X1 -> v7_rlvect_1 X1 -> v8_rlvect_1 X1 -> l1_rlvect_1 X1 -> m1_subset_1 X4 (u1_struct_0 X1) -> m1_subset_1 X3 (u1_struct_0 X1) -> m1_subset_1 X2 (u1_struct_0 X1) -> False)
  -> (forall X4 X3 X2 X1, ((k3_rlvect_1 X1 (k1_rlvect_1 X1 X2 (k2_geomtrap X1 X2 X3 X4)) (k1_rlvect_1 X1 X3 (k3_geomtrap X1 X2 X3 X4))) = X4 -> False) -> (v2_struct_0 X1 -> False) -> v13_algstr_0 X1 -> v2_rlvect_1 X1 -> v3_rlvect_1 X1 -> v4_rlvect_1 X1 -> v5_rlvect_1 X1 -> v6_rlvect_1 X1 -> v7_rlvect_1 X1 -> v8_rlvect_1 X1 -> l1_rlvect_1 X1 -> r1_analmetr X1 X2 X3 -> m1_subset_1 X4 (u1_struct_0 X1) -> m1_subset_1 X3 (u1_struct_0 X1) -> m1_subset_1 X2 (u1_struct_0 X1) -> False)
  -> (forall X6 X3 X4 X5 X2 X1, (X1 = (k2_geomtrap X2 X3 X4 X5) -> False) -> (v2_struct_0 X2 -> False) -> X5 = (k3_rlvect_1 X2 (k1_rlvect_1 X2 X3 X1) (k1_rlvect_1 X2 X4 X6)) -> v13_algstr_0 X2 -> v2_rlvect_1 X2 -> v3_rlvect_1 X2 -> v4_rlvect_1 X2 -> v5_rlvect_1 X2 -> v6_rlvect_1 X2 -> v7_rlvect_1 X2 -> v8_rlvect_1 X2 -> l1_rlvect_1 X2 -> m1_subset_1 X6 k1_numbers -> m1_subset_1 X1 k1_numbers -> r1_analmetr X2 X3 X4 -> m1_subset_1 X5 (u1_struct_0 X2) -> m1_subset_1 X4 (u1_struct_0 X2) -> m1_subset_1 X3 (u1_struct_0 X2) -> False)
  -> (forall X6 X3 X4 X5 X2 X1, (X1 = (k3_geomtrap X2 X3 X4 X5) -> False) -> (v2_struct_0 X2 -> False) -> X5 = (k3_rlvect_1 X2 (k1_rlvect_1 X2 X3 X6) (k1_rlvect_1 X2 X4 X1)) -> v13_algstr_0 X2 -> v2_rlvect_1 X2 -> v3_rlvect_1 X2 -> v4_rlvect_1 X2 -> v5_rlvect_1 X2 -> v6_rlvect_1 X2 -> v7_rlvect_1 X2 -> v8_rlvect_1 X2 -> l1_rlvect_1 X2 -> m1_subset_1 X6 k1_numbers -> m1_subset_1 X1 k1_numbers -> r1_analmetr X2 X3 X4 -> m1_subset_1 X5 (u1_struct_0 X2) -> m1_subset_1 X4 (u1_struct_0 X2) -> m1_subset_1 X3 (u1_struct_0 X2) -> False)
  -> (forall X2 X3 X4 X1, (v2_struct_0 X1 -> False) -> (m1_subset_1 (k2_analort X1 X2 X3 X4) (u1_struct_0 X1) -> False) -> v13_algstr_0 X1 -> v2_rlvect_1 X1 -> v3_rlvect_1 X1 -> v4_rlvect_1 X1 -> v5_rlvect_1 X1 -> v6_rlvect_1 X1 -> v7_rlvect_1 X1 -> v8_rlvect_1 X1 -> l1_rlvect_1 X1 -> m1_subset_1 X4 (u1_struct_0 X1) -> m1_subset_1 X3 (u1_struct_0 X1) -> m1_subset_1 X2 (u1_struct_0 X1) -> False)
  -> (forall X2 X3 X4 X1, (v2_struct_0 X1 -> False) -> (m1_subset_1 (k2_geomtrap X1 X2 X3 X4) k1_numbers -> False) -> v13_algstr_0 X1 -> v2_rlvect_1 X1 -> v3_rlvect_1 X1 -> v4_rlvect_1 X1 -> v5_rlvect_1 X1 -> v6_rlvect_1 X1 -> v7_rlvect_1 X1 -> v8_rlvect_1 X1 -> l1_rlvect_1 X1 -> m1_subset_1 X4 (u1_struct_0 X1) -> m1_subset_1 X3 (u1_struct_0 X1) -> m1_subset_1 X2 (u1_struct_0 X1) -> False)
  -> (forall X2 X3 X4 X1, (v2_struct_0 X1 -> False) -> (m1_subset_1 (k3_geomtrap X1 X2 X3 X4) k1_numbers -> False) -> v13_algstr_0 X1 -> v2_rlvect_1 X1 -> v3_rlvect_1 X1 -> v4_rlvect_1 X1 -> v5_rlvect_1 X1 -> v6_rlvect_1 X1 -> v7_rlvect_1 X1 -> v8_rlvect_1 X1 -> l1_rlvect_1 X1 -> m1_subset_1 X4 (u1_struct_0 X1) -> m1_subset_1 X3 (u1_struct_0 X1) -> m1_subset_1 X2 (u1_struct_0 X1) -> False)
  ...
  -> (forall X3 X1 X2, ((k1_rlvect_1 X2 (k4_algstr_0 X2 X3) X1) = (k4_algstr_0 X2 (k1_rlvect_1 X2 X3 X1)) -> False) -> (v2_struct_0 X2 -> False) -> v13_algstr_0 X2 -> v2_rlvect_1 X2 -> v3_rlvect_1 X2 -> v4_rlvect_1 X2 -> v5_rlvect_1 X2 -> v6_rlvect_1 X2 -> v7_rlvect_1 X2 -> v8_rlvect_1 X2 -> l1_rlvect_1 X2 -> v1_xreal_0 X1 -> m1_subset_1 X3 (u1_struct_0 X2) -> False)
  -> (forall X1, (m1_subset_1 (u1_rlvect_1 X1) (k1_zfmisc_1 (k2_zfmisc_1 (k2_zfmisc_1 k1_numbers (u1_struct_0 X1)) (u1_struct_0 X1))) -> False) -> l1_rlvect_1 X1 -> False)
  -> (forall X3 X1 X2, ((k1_rlvect_1 X2 (k4_algstr_0 X2 X3) X1) = (k1_rlvect_1 X2 X3 (k4_xcmplx_0 X1)) -> False) -> (v2_struct_0 X2 -> False) -> v13_algstr_0 X2 -> v2_rlvect_1 X2 -> v3_rlvect_1 X2 -> v4_rlvect_1 X2 -> v5_rlvect_1 X2 -> v6_rlvect_1 X2 -> v7_rlvect_1 X2 -> v8_rlvect_1 X2 -> l1_rlvect_1 X2 -> v1_xreal_0 X1 -> m1_subset_1 X3 (u1_struct_0 X2) -> False)
  ...
  -> (forall X2 X3 X1, (v2_struct_0 X1 -> False) -> (m1_subset_1 (k1_rlvect_1 X1 X2 X3) (u1_struct_0 X1) -> False) -> l1_rlvect_1 X1 -> v1_xreal_0 X3 -> m1_subset_1 X2 (u1_struct_0 X1) -> False)
  -> (forall X2 X3 X1, ((k1_binop_1 (u1_rlvect_1 X1) X3 X2) = (k1_rlvect_1 X1 X2 X3) -> False) -> (v2_struct_0 X1 -> False) -> l1_rlvect_1 X1 -> v1_xreal_0 X3 -> m1_subset_1 X2 (u1_struct_0 X1) -> False)
  ...
  -> (forall X1, (v1_funct_2 (u1_rlvect_1 X1) (k2_zfmisc_1 k1_numbers (u1_struct_0 X1)) (u1_struct_0 X1) -> False) -> l1_rlvect_1 X1 -> False)
  ...
  -> (forall X1, (v1_funct_1 (u1_rlvect_1 X1) -> False) -> l1_rlvect_1 X1 -> False)
  ...
  -> ((k2_analort esk1_0 esk2_0 esk3_0 (k4_algstr_0 esk1_0 esk4_0)) = (k4_algstr_0 esk1_0 (k2_analort esk1_0 esk2_0 esk3_0 esk4_0)) -> False)
  ...
  -> ((l2_struct_0 esk9_0 -> False) -> False)
  -> ((l2_algstr_0 esk8_0 -> False) -> False)
  -> ((l1_algstr_0 esk5_0 -> False) -> False)
  ...
  -> ((v7_struct_0 esk14_0 -> False) -> False)
  -> ((l1_struct_0 esk7_0 -> False) -> False)
  -> ((l1_rlvect_1 esk6_0 -> False) -> False)
