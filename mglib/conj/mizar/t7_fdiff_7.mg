...
Theorem t7_fdiff_7:
 ...
 forall esk1_0:set,
     ((k1_real_1 (k10_real_1 (k1_fdiff_1 esk2_0 esk1_0) (k7_square_1 (k9_real_1 np__1 (k5_square_1 (k1_seq_1 esk2_0 esk1_0)))))) = (k1_fdiff_1 (k1_partfun1 k1_numbers k1_numbers k1_numbers k1_numbers esk2_0 k4_sin_cos6) esk1_0) -> r1_fdiff_1 (k1_partfun1 k1_numbers k1_numbers k1_numbers k1_numbers esk2_0 k4_sin_cos6) esk1_0 -> False)
  -> (forall X1 X3 X2, ((k8_real_1 (k1_fdiff_1 X2 (k1_seq_1 X1 X3)) (k1_fdiff_1 X1 X3)) = (k1_fdiff_1 (k1_partfun1 k1_numbers k1_numbers k1_numbers k1_numbers X1 X2) X3) -> False) -> v1_funct_1 X2 -> v1_funct_1 X1 -> r1_fdiff_1 X1 X3 -> m1_subset_1 X3 k1_numbers -> r1_fdiff_1 X2 (k1_seq_1 X1 X3) -> m1_subset_1 X2 (k1_zfmisc_1 (k2_zfmisc_1 k1_numbers k1_numbers)) -> m1_subset_1 X1 (k1_zfmisc_1 (k2_zfmisc_1 k1_numbers k1_numbers)) -> False)
  ...
  -> (forall X1 X3 X2, (r1_fdiff_1 (k1_partfun1 k1_numbers k1_numbers k1_numbers k1_numbers X1 X2) X3 -> False) -> v1_funct_1 X2 -> v1_funct_1 X1 -> r1_fdiff_1 X1 X3 -> m1_subset_1 X3 k1_numbers -> r1_fdiff_1 X2 (k1_seq_1 X1 X3) -> m1_subset_1 X2 (k1_zfmisc_1 (k2_zfmisc_1 k1_numbers k1_numbers)) -> m1_subset_1 X1 (k1_zfmisc_1 (k2_zfmisc_1 k1_numbers k1_numbers)) -> False)
  ...
  -> (forall X2 X1, (r2_fdiff_1 X1 X2 -> False) -> v1_funct_1 X1 -> v3_rcomp_1 X2 -> m1_subset_1 X2 (k1_zfmisc_1 k1_numbers) -> r1_fdiff_1 X1 (esk15_2 X2 X1) -> r1_tarski X2 (k1_relset_1 k1_numbers X1) -> m1_subset_1 X1 (k1_zfmisc_1 (k2_zfmisc_1 k1_numbers k1_numbers)) -> False)
  -> (forall X2 X1 X3, v1_xxreal_0 X3 -> v1_xxreal_0 X2 -> r2_hidden X1 (a_2_1_rcomp_1 X2 X3) -> r1_xxreal_0 (esk5_3 X1 X2 X3) X2 -> False)
  -> (forall X1 X2 X3, v1_xxreal_0 X3 -> v1_xxreal_0 X1 -> r2_hidden X2 (a_2_1_rcomp_1 X3 X1) -> r1_xxreal_0 X1 (esk5_3 X2 X3 X1) -> False)
  -> (forall X1 X2, (r2_fdiff_1 X2 X1 -> False) -> (r2_hidden (esk15_2 X1 X2) X1 -> False) -> v1_funct_1 X2 -> v3_rcomp_1 X1 -> m1_subset_1 X1 (k1_zfmisc_1 k1_numbers) -> r1_tarski X1 (k1_relset_1 k1_numbers X2) -> m1_subset_1 X2 (k1_zfmisc_1 (k2_zfmisc_1 k1_numbers k1_numbers)) -> False)
  -> (forall X1 X2, (r2_fdiff_1 X2 X1 -> False) -> (m1_subset_1 (esk15_2 X1 X2) k1_numbers -> False) -> v1_funct_1 X2 -> v3_rcomp_1 X1 -> m1_subset_1 X1 (k1_zfmisc_1 k1_numbers) -> r1_tarski X1 (k1_relset_1 k1_numbers X2) -> m1_subset_1 X2 (k1_zfmisc_1 (k2_zfmisc_1 k1_numbers k1_numbers)) -> False)
  ...
  -> (forall X2 X3 X1, (r1_fdiff_1 X3 X1 -> False) -> v1_funct_1 X3 -> v3_rcomp_1 X2 -> r2_hidden X1 X2 -> r2_fdiff_1 X3 X2 -> m1_subset_1 X1 k1_numbers -> m1_subset_1 X2 (k1_zfmisc_1 k1_numbers) -> m1_subset_1 X3 (k1_zfmisc_1 (k2_zfmisc_1 k1_numbers k1_numbers)) -> False)
  -> (forall X2 X1 X3, (m1_subset_1 (esk5_3 X1 X2 X3) k1_numbers -> False) -> v1_xxreal_0 X3 -> v1_xxreal_0 X2 -> r2_hidden X1 (a_2_1_rcomp_1 X2 X3) -> False)
  -> (forall X1 X2, (r1_tarski X1 (k1_relset_1 k1_numbers X2) -> False) -> v1_funct_1 X2 -> v3_rcomp_1 X1 -> r2_fdiff_1 X2 X1 -> m1_subset_1 X1 (k1_zfmisc_1 k1_numbers) -> m1_subset_1 X2 (k1_zfmisc_1 (k2_zfmisc_1 k1_numbers k1_numbers)) -> False)
  -> (forall X2 X1, (m1_subset_1 (k1_fdiff_1 X1 X2) k1_numbers -> False) -> v1_funct_1 X1 -> v1_xreal_0 X2 -> m1_subset_1 X1 (k1_zfmisc_1 (k2_zfmisc_1 k1_numbers k1_numbers)) -> False)
  ...
  -> (forall X2 X1 X3, ((esk5_3 X1 X2 X3) = X1 -> False) -> v1_xxreal_0 X3 -> v1_xxreal_0 X2 -> r2_hidden X1 (a_2_1_rcomp_1 X2 X3) -> False)
  ...
  -> (r1_xxreal_0 (k1_seq_1 esk2_0 esk1_0) (k1_real_1 np__1) -> False)
  ...
  -> (r1_xxreal_0 np__1 (k1_seq_1 esk2_0 esk1_0) -> False)
  ...
  -> ((r1_fdiff_1 esk2_0 esk1_0 -> False) -> False)
