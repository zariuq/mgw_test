...
Theorem t62_funct_5:
 ...
 forall r2_hidden:set -> set -> prop,
  ...
  -> (forall X2 X1 X3, (X3 = (k1_funct_4 X1 X2) -> False) -> (k9_xtuple_0 X3) = (k2_xboole_0 (k9_xtuple_0 X1) (k9_xtuple_0 X2)) -> (k1_funct_1 X2 (esk5_3 X1 X2 X3)) = (k1_funct_1 X3 (esk5_3 X1 X2 X3)) -> v1_funct_1 X3 -> v1_funct_1 X2 -> v1_funct_1 X1 -> v1_relat_1 X3 -> v1_relat_1 X2 -> v1_relat_1 X1 -> r2_hidden (esk5_3 X1 X2 X3) (k9_xtuple_0 X2) -> False)
  -> (forall X2 X1 X3, (X1 = (k1_funct_4 X2 X3) -> False) -> (r2_hidden (esk5_3 X2 X3 X1) (k9_xtuple_0 X3) -> False) -> (k9_xtuple_0 X1) = (k2_xboole_0 (k9_xtuple_0 X2) (k9_xtuple_0 X3)) -> (k1_funct_1 X1 (esk5_3 X2 X3 X1)) = (k1_funct_1 X2 (esk5_3 X2 X3 X1)) -> v1_funct_1 X3 -> v1_funct_1 X2 -> v1_funct_1 X1 -> v1_relat_1 X3 -> v1_relat_1 X2 -> v1_relat_1 X1 -> False)
  -> ((k1_card_1 (k2_zfmisc_1 (k1_funct_2 esk1_0 esk4_0) (k1_funct_2 esk2_0 esk4_0))) = (k1_card_1 (k1_funct_2 (k2_xboole_0 esk1_0 esk2_0) esk4_0)) -> r2_wellord2 (k1_funct_2 (k2_xboole_0 esk1_0 esk2_0) esk3_0) (k2_zfmisc_1 (k1_funct_2 esk1_0 esk3_0) (k1_funct_2 esk2_0 esk3_0)) -> False)
  ...
  -> (forall X4 X2 X3 X1, ((k1_funct_1 (esk39_3 X2 X3 X4) X1) = (k2_tarski (k2_tarski (k5_relat_1 X1 X2) (k5_relat_1 X1 X3)) (k1_tarski (k5_relat_1 X1 X2))) -> False) -> v1_funct_1 X1 -> v1_relat_1 X1 -> r2_hidden X1 (k1_funct_2 (k2_xboole_0 X2 X3) X4) -> False)
  ...
  -> (forall X2 X1 X3, (X3 = (k1_funct_4 X1 X2) -> False) -> (r2_hidden (esk5_3 X1 X2 X3) (k2_xboole_0 (k9_xtuple_0 X1) (k9_xtuple_0 X2)) -> False) -> (k9_xtuple_0 X3) = (k2_xboole_0 (k9_xtuple_0 X1) (k9_xtuple_0 X2)) -> v1_funct_1 X3 -> v1_funct_1 X2 -> v1_funct_1 X1 -> v1_relat_1 X3 -> v1_relat_1 X2 -> v1_relat_1 X1 -> False)
  ...
  -> (forall X4 X2 X1 X3, ((k1_funct_1 X2 X1) = (k1_funct_1 X3 X1) -> False) -> X3 = (k1_funct_4 X4 X2) -> v1_funct_1 X4 -> v1_funct_1 X3 -> v1_funct_1 X2 -> v1_relat_1 X4 -> v1_relat_1 X3 -> v1_relat_1 X2 -> r2_hidden X1 (k9_xtuple_0 X2) -> r2_hidden X1 (k2_xboole_0 (k9_xtuple_0 X4) (k9_xtuple_0 X2)) -> False)
  ...
  -> (forall X2 X3 X1 X4, ((k1_funct_1 X3 X1) = (k1_funct_1 X4 X1) -> False) -> (r2_hidden X1 (k9_xtuple_0 X2) -> False) -> X3 = (k1_funct_4 X4 X2) -> v1_funct_1 X4 -> v1_funct_1 X3 -> v1_funct_1 X2 -> v1_relat_1 X4 -> v1_relat_1 X3 -> v1_relat_1 X2 -> r2_hidden X1 (k2_xboole_0 (k9_xtuple_0 X4) (k9_xtuple_0 X2)) -> False)
  ...
  -> (forall X1 X2, (r1_tarski (k10_xtuple_0 (k1_funct_4 X1 X2)) (k2_xboole_0 (k10_xtuple_0 X1) (k10_xtuple_0 X2)) -> False) -> v1_funct_1 X2 -> v1_funct_1 X1 -> v1_relat_1 X2 -> v1_relat_1 X1 -> False)
  ...
  -> (forall X1 X2, ((k5_relat_1 (k1_funct_4 X1 X2) (k9_xtuple_0 X1)) = X1 -> False) -> v1_funct_1 X2 -> v1_funct_1 X1 -> v1_relat_1 X2 -> v1_relat_1 X1 -> r1_xboole_0 (k9_xtuple_0 X1) (k9_xtuple_0 X2) -> False)
  ...
  -> (forall X2 X1 X3, ((k9_xtuple_0 X1) = (k2_xboole_0 (k9_xtuple_0 X2) (k9_xtuple_0 X3)) -> False) -> X1 = (k1_funct_4 X2 X3) -> v1_funct_1 X3 -> v1_funct_1 X2 -> v1_funct_1 X1 -> v1_relat_1 X3 -> v1_relat_1 X2 -> v1_relat_1 X1 -> False)
  ...
  -> (forall X1 X2, ((k5_relat_1 (k1_funct_4 X1 X2) (k9_xtuple_0 X2)) = X2 -> False) -> v1_funct_1 X2 -> v1_funct_1 X1 -> v1_relat_1 X2 -> v1_relat_1 X1 -> False)
  ...
  -> (forall X2 X1 X3, ((k9_xtuple_0 (esk39_3 X1 X2 X3)) = (k1_funct_2 (k2_xboole_0 X1 X2) X3) -> False) -> False)
