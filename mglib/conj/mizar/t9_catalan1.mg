...
Theorem t9_catalan1:
 ...
 forall k4_newton:set -> set -> set,
     (forall X1 X2 X3, (X1 = (k4_newton X3 X2) -> False) -> (k10_real_1 (k3_newton X2) (k8_real_1 (k3_newton X3) (k3_newton (esk2_3 X3 X2 X1)))) = X1 -> v7_ordinal1 X3 -> v7_ordinal1 X2 -> r1_xxreal_0 X3 X2 -> False)
  -> (forall X1, ((k10_real_1 (k9_newton (k7_nat_d (k4_nat_1 np__2 X1) np__2)) (k4_nat_1 (k9_newton (k7_nat_d X1 np__1)) (k9_newton X1))) = (k1_catalan1 X1) -> False) -> (r1_xxreal_0 X1 np__1 -> False) -> v7_ordinal1 X1 -> False)
  -> (forall X1, ((k10_real_1 (k6_newton (k7_nat_d X1 np__1) (k7_nat_d (k4_nat_1 np__2 X1) np__2)) X1) = (k1_catalan1 X1) -> False) -> v7_ordinal1 X1 -> False)
  -> (forall X1 X3 X2 X4, (X1 = (k10_real_1 (k3_newton X3) (k8_real_1 (k3_newton X2) (k3_newton X4))) -> False) -> X4 = (k6_xcmplx_0 X3 X2) -> X1 = (k4_newton X2 X3) -> v7_ordinal1 X4 -> v7_ordinal1 X3 -> v7_ordinal1 X2 -> r1_xxreal_0 X2 X3 -> False)
  -> (forall X3 X1 X2, (X3 = (k4_newton X1 X2) -> False) -> (v7_ordinal1 (esk2_3 X1 X2 X3) -> False) -> v7_ordinal1 X2 -> v7_ordinal1 X1 -> r1_xxreal_0 X1 X2 -> False)
  -> (forall X1 X2 X3, (r1_xxreal_0 X2 X3 -> False) -> (r1_xxreal_0 X2 X1 -> False) -> v7_ordinal1 X3 -> v7_ordinal1 X2 -> v7_ordinal1 X1 -> r1_xxreal_0 (k7_nat_d X2 X3) (k7_nat_d X1 X3) -> False)
  ...
  -> (forall X1, (r1_xxreal_0 X1 np__1 -> False) -> (r1_xxreal_0 (k7_nat_d X1 np__1) (k7_nat_d (k4_nat_1 np__2 X1) np__3) -> False) -> v7_ordinal1 X1 -> False)
  ...
  -> (forall X3 X1 X2, (X3 = (k4_newton X1 X2) -> False) -> ((esk2_3 X1 X2 X3) = (k6_xcmplx_0 X2 X1) -> False) -> v7_ordinal1 X2 -> v7_ordinal1 X1 -> r1_xxreal_0 X1 X2 -> False)
  ...
  -> (forall X2 X1, (m2_subset_1 (k6_newton X1 X2) k1_numbers k5_numbers -> False) -> v7_ordinal1 X2 -> v7_ordinal1 X1 -> False)
  ...
  -> (forall X1, ((k2_nat_1 (k7_nat_d X1 np__2) np__1) = (k7_nat_d X1 np__1) -> False) -> (r1_xxreal_0 X1 np__1 -> False) -> v7_ordinal1 X1 -> False)
  ...
  -> (forall X1 X2, ((k1_xreal_0 X2 X1) = (k6_xcmplx_0 X2 X1) -> False) -> v1_xreal_0 X2 -> v1_xreal_0 X1 -> r1_xxreal_0 X1 X2 -> False)
  ...
  -> (forall X3 X2 X1, (X1 = k6_numbers -> False) -> (r1_xxreal_0 X2 X3 -> False) -> X1 = (k4_newton X2 X3) -> v7_ordinal1 X3 -> v7_ordinal1 X2 -> False)
  ...
  -> (forall X1 X2 X3, (X1 = (k4_newton X2 X3) -> False) -> (r1_xxreal_0 X2 X3 -> False) -> X1 = k6_numbers -> v7_ordinal1 X3 -> v7_ordinal1 X2 -> False)
  ...
  -> (forall X2 X1, ((k1_xreal_0 X1 X2) = (k7_nat_d X1 X2) -> False) -> v7_ordinal1 X2 -> v7_ordinal1 X1 -> False)
  -> (forall X2 X1, ((k4_newton X1 X2) = (k6_newton X1 X2) -> False) -> v7_ordinal1 X2 -> v7_ordinal1 X1 -> False)
  ...
  -> (forall X1, (m1_subset_1 (k1_catalan1 X1) k1_numbers -> False) -> v7_ordinal1 X1 -> False)
  ...
  -> ((k9_real_1 (k4_nat_1 np__4 (k6_newton (k7_nat_d esk1_0 np__1) (k7_nat_d (k4_nat_1 np__2 esk1_0) np__3))) (k6_newton (k7_nat_d esk1_0 np__1) (k7_nat_d (k4_nat_1 np__2 esk1_0) np__1))) = (k1_catalan1 esk1_0) -> False)
