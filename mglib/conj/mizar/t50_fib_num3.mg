...
Theorem t50_fib_num3:
 ...
 forall k4_nat_1:set -> set -> set,
     (forall X2 X1, ((k3_fib_num3 k6_numbers X1 X2) = (k4_nat_1 X1 (k1_pre_ff X2)) -> False) -> (k3_fib_num3 k6_numbers X1 k6_numbers) = (k4_nat_1 X1 (k1_pre_ff k6_numbers)) -> (k3_fib_num3 k6_numbers X1 np__1) = (k4_nat_1 X1 (k1_pre_ff np__1)) -> (k3_fib_num3 k6_numbers X1 (k1_nat_1 (esk29_1 X1) np__2)) = (k4_nat_1 X1 (k1_pre_ff (k1_nat_1 (esk29_1 X1) np__2))) -> v7_ordinal1 X2 -> m1_subset_1 X1 k5_numbers -> False)
  -> (forall X2 X1, ((k3_fib_num3 k6_numbers X1 X2) = (k4_nat_1 X1 (k1_pre_ff X2)) -> False) -> ((k3_fib_num3 k6_numbers X1 (k1_nat_1 (esk29_1 X1) np__1)) = (k4_nat_1 X1 (k1_pre_ff (k1_nat_1 (esk29_1 X1) np__1))) -> False) -> (k3_fib_num3 k6_numbers X1 k6_numbers) = (k4_nat_1 X1 (k1_pre_ff k6_numbers)) -> (k3_fib_num3 k6_numbers X1 np__1) = (k4_nat_1 X1 (k1_pre_ff np__1)) -> v7_ordinal1 X2 -> m1_subset_1 X1 k5_numbers -> False)
  ...
  -> (forall X2 X1, ((k3_fib_num3 k6_numbers X1 X2) = (k4_nat_1 X1 (k1_pre_ff X2)) -> False) -> ((k3_fib_num3 k6_numbers X1 (esk29_1 X1)) = (k4_nat_1 X1 (k1_pre_ff (esk29_1 X1))) -> False) -> (k3_fib_num3 k6_numbers X1 k6_numbers) = (k4_nat_1 X1 (k1_pre_ff k6_numbers)) -> (k3_fib_num3 k6_numbers X1 np__1) = (k4_nat_1 X1 (k1_pre_ff np__1)) -> v7_ordinal1 X2 -> m1_subset_1 X1 k5_numbers -> False)
  ...
  -> (forall X2 X1, ((k3_fib_num3 k6_numbers X1 X2) = (k4_nat_1 X1 (k1_pre_ff X2)) -> False) -> (v7_ordinal1 (esk29_1 X1) -> False) -> (k3_fib_num3 k6_numbers X1 k6_numbers) = (k4_nat_1 X1 (k1_pre_ff k6_numbers)) -> (k3_fib_num3 k6_numbers X1 np__1) = (k4_nat_1 X1 (k1_pre_ff np__1)) -> v7_ordinal1 X2 -> m1_subset_1 X1 k5_numbers -> False)
  ...
  -> ((k3_fib_num3 k6_numbers esk1_0 esk2_0) = (k4_nat_1 esk1_0 (k1_pre_ff esk2_0)) -> False)
