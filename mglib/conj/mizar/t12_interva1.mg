...
Theorem t12_interva1:
 ...
 forall a_5_0_interva1:set -> set -> set -> set -> set -> set,
 forall m1_subset_1:set -> set -> prop,
 forall k1_zfmisc_1:set -> set,
 forall v1_xboole_0:set -> prop,
     (forall X6 X4 X1 X3 X5 X2, (v1_xboole_0 X2 -> False) -> (r1_tarski (esk15_6 X1 X2 X3 X4 X5 X6) (k9_subset_1 X2 X4 X6) -> False) -> m1_subset_1 X6 (k1_zfmisc_1 X2) -> m1_subset_1 X5 (k1_zfmisc_1 X2) -> m1_subset_1 X4 (k1_zfmisc_1 X2) -> m1_subset_1 X3 (k1_zfmisc_1 X2) -> r2_hidden X1 (a_5_0_interva1 X2 X3 X4 X5 X6) -> False)
  -> (forall X6 X3 X4 X2 X5 X1, (v1_xboole_0 X1 -> False) -> (r1_tarski (k9_subset_1 X1 X2 X3) (esk15_6 X4 X1 X2 X5 X3 X6) -> False) -> m1_subset_1 X6 (k1_zfmisc_1 X1) -> m1_subset_1 X5 (k1_zfmisc_1 X1) -> m1_subset_1 X3 (k1_zfmisc_1 X1) -> m1_subset_1 X2 (k1_zfmisc_1 X1) -> r2_hidden X4 (a_5_0_interva1 X1 X2 X5 X3 X6) -> False)
  -> (forall X6 X4 X1 X3 X5 X2, (v1_xboole_0 X2 -> False) -> (m1_subset_1 (esk15_6 X1 X2 X3 X4 X5 X6) (k1_zfmisc_1 X2) -> False) -> m1_subset_1 X6 (k1_zfmisc_1 X2) -> m1_subset_1 X5 (k1_zfmisc_1 X2) -> m1_subset_1 X4 (k1_zfmisc_1 X2) -> m1_subset_1 X3 (k1_zfmisc_1 X2) -> r2_hidden X1 (a_5_0_interva1 X2 X3 X4 X5 X6) -> False)
  -> (forall X6 X4 X1 X3 X5 X2, ((esk15_6 X1 X2 X3 X4 X5 X6) = X1 -> False) -> (v1_xboole_0 X2 -> False) -> m1_subset_1 X6 (k1_zfmisc_1 X2) -> m1_subset_1 X5 (k1_zfmisc_1 X2) -> m1_subset_1 X4 (k1_zfmisc_1 X2) -> m1_subset_1 X3 (k1_zfmisc_1 X2) -> r2_hidden X1 (a_5_0_interva1 X2 X3 X4 X5 X6) -> False)
  -> (forall X3 X6 X5 X7 X4 X1 X2, (v1_xboole_0 X2 -> False) -> (r2_hidden X3 (a_5_0_interva1 X2 X4 X6 X5 X7) -> False) -> X1 = X3 -> m1_subset_1 X7 (k1_zfmisc_1 X2) -> m1_subset_1 X6 (k1_zfmisc_1 X2) -> m1_subset_1 X5 (k1_zfmisc_1 X2) -> m1_subset_1 X4 (k1_zfmisc_1 X2) -> m1_subset_1 X1 (k1_zfmisc_1 X2) -> r1_tarski X1 (k9_subset_1 X2 X6 X7) -> r1_tarski (k9_subset_1 X2 X4 X5) X1 -> False)
  ...
  -> ((k3_setfam_1 (k2_interva1 esk1_0 esk2_0 esk3_0) (k2_interva1 esk1_0 esk4_0 esk5_0)) = (a_5_0_interva1 esk1_0 esk2_0 esk3_0 esk4_0 esk5_0) -> False)
