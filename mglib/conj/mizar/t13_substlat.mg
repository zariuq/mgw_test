...
Theorem t13_substlat:
 ...
 forall a_3_0_substlat:set -> set -> set -> set,
  ...
  -> (forall X4 X1 X2 X3, (r1_tarski (k3_substlat X2 X3 (k1_finsub_1 (k5_finsub_1 (k4_partfun1 X2 X3)) X1 X4)) (k1_finsub_1 (k5_finsub_1 (k4_partfun1 X2 X3)) (k3_substlat X2 X3 X1) X4) -> False) -> m1_subset_1 X4 (k5_finsub_1 (k4_partfun1 X2 X3)) -> m1_subset_1 X1 (k5_finsub_1 (k4_partfun1 X2 X3)) -> False)
  ...
  -> (forall X3 X1 X2 X4, (r2_hidden X4 (k3_substlat X1 X2 X3) -> False) -> (r1_tarski (esk31_4 X1 X2 X3 X4) X4 -> False) -> v1_finset_1 X4 -> r2_hidden X4 X3 -> m1_subset_1 X3 (k5_finsub_1 (k4_partfun1 X1 X2)) -> False)
  -> (forall X3 X1 X2 X4, (r2_hidden X4 (k3_substlat X1 X2 X3) -> False) -> (r2_hidden (esk31_4 X1 X2 X3 X4) X3 -> False) -> v1_finset_1 X4 -> r2_hidden X4 X3 -> m1_subset_1 X3 (k5_finsub_1 (k4_partfun1 X1 X2)) -> False)
  -> (forall X3 X1 X2 X4, (v1_finset_1 (esk31_4 X1 X2 X3 X4) -> False) -> (r2_hidden X4 (k3_substlat X1 X2 X3) -> False) -> v1_finset_1 X4 -> r2_hidden X4 X3 -> m1_subset_1 X3 (k5_finsub_1 (k4_partfun1 X1 X2)) -> False)
  -> (forall X3 X1 X2 X4, (r2_hidden (esk29_4 X1 X2 X3 X4) (k3_substlat X1 X2 X3) -> False) -> v1_finset_1 X4 -> r2_hidden X4 X3 -> m1_subset_1 X3 (k5_finsub_1 (k4_partfun1 X1 X2)) -> False)
  ...
  -> (forall X3 X1 X2 X4, (r2_hidden X4 (k3_substlat X1 X2 X3) -> False) -> (esk31_4 X1 X2 X3 X4) = X4 -> v1_finset_1 X4 -> r2_hidden X4 X3 -> m1_subset_1 X3 (k5_finsub_1 (k4_partfun1 X1 X2)) -> False)
  -> (forall X3 X1 X2 X4, (r1_tarski (esk29_4 X1 X2 X3 X4) X4 -> False) -> v1_finset_1 X4 -> r2_hidden X4 X3 -> m1_subset_1 X3 (k5_finsub_1 (k4_partfun1 X1 X2)) -> False)
  ...
  -> ((k3_substlat esk1_0 esk2_0 (k1_finsub_1 (k5_finsub_1 (k4_partfun1 esk1_0 esk2_0)) (k3_substlat esk1_0 esk2_0 esk3_0) esk4_0)) = (k3_substlat esk1_0 esk2_0 (k1_finsub_1 (k5_finsub_1 (k4_partfun1 esk1_0 esk2_0)) esk3_0 esk4_0)) -> False)
