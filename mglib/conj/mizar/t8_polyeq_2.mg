...
Theorem t8_polyeq_2:
 ...
 forall k2_xcmplx_0:set -> set -> set,
     (forall X10 X9 X4 X2 X1 X3 X8 X6 X5 X7, ((k2_xcmplx_0 (k2_xcmplx_0 (k2_xcmplx_0 X1 X2) X3) X4) = (k2_xcmplx_0 (k2_xcmplx_0 (k2_xcmplx_0 X5 X6) X7) X8) -> False) -> (k1_polyeq_2 X1 X2 X3 X4 X9 (esk22_10 X1 X2 X3 X4 X9 X5 X6 X7 X8 X10)) = (k1_polyeq_2 X5 X6 X7 X8 X10 (esk22_10 X1 X2 X3 X4 X9 X5 X6 X7 X8 X10)) -> v1_xreal_0 X10 -> v1_xreal_0 X9 -> v1_xreal_0 X8 -> v1_xreal_0 X7 -> v1_xreal_0 X6 -> v1_xreal_0 X5 -> v1_xreal_0 X4 -> v1_xreal_0 X3 -> v1_xreal_0 X2 -> v1_xreal_0 X1 -> False)
  -> (forall X10 X9 X4 X2 X1 X3 X8 X6 X5 X7, ((k6_xcmplx_0 (k2_xcmplx_0 (k6_xcmplx_0 X1 X2) X3) X4) = (k6_xcmplx_0 (k2_xcmplx_0 (k6_xcmplx_0 X5 X6) X7) X8) -> False) -> (k1_polyeq_2 X1 X2 X3 X4 X9 (esk22_10 X1 X2 X3 X4 X9 X5 X6 X7 X8 X10)) = (k1_polyeq_2 X5 X6 X7 X8 X10 (esk22_10 X1 X2 X3 X4 X9 X5 X6 X7 X8 X10)) -> v1_xreal_0 X10 -> v1_xreal_0 X9 -> v1_xreal_0 X8 -> v1_xreal_0 X7 -> v1_xreal_0 X6 -> v1_xreal_0 X5 -> v1_xreal_0 X4 -> v1_xreal_0 X3 -> v1_xreal_0 X2 -> v1_xreal_0 X1 -> False)
  ...
  -> (forall X10 X9 X4 X2 X1 X3 X8 X6 X5 X7, ((k2_xcmplx_0 (k2_xcmplx_0 (k2_xcmplx_0 X1 X2) X3) X4) = (k2_xcmplx_0 (k2_xcmplx_0 (k2_xcmplx_0 X5 X6) X7) X8) -> False) -> (v1_xreal_0 (esk22_10 X1 X2 X3 X4 X9 X5 X6 X7 X8 X10) -> False) -> v1_xreal_0 X10 -> v1_xreal_0 X9 -> v1_xreal_0 X8 -> v1_xreal_0 X7 -> v1_xreal_0 X6 -> v1_xreal_0 X5 -> v1_xreal_0 X4 -> v1_xreal_0 X3 -> v1_xreal_0 X2 -> v1_xreal_0 X1 -> False)
  -> (forall X10 X9 X4 X2 X1 X3 X8 X6 X5 X7, ((k6_xcmplx_0 (k2_xcmplx_0 (k6_xcmplx_0 X1 X2) X3) X4) = (k6_xcmplx_0 (k2_xcmplx_0 (k6_xcmplx_0 X5 X6) X7) X8) -> False) -> (v1_xreal_0 (esk22_10 X1 X2 X3 X4 X9 X5 X6 X7 X8 X10) -> False) -> v1_xreal_0 X10 -> v1_xreal_0 X9 -> v1_xreal_0 X8 -> v1_xreal_0 X7 -> v1_xreal_0 X6 -> v1_xreal_0 X5 -> v1_xreal_0 X4 -> v1_xreal_0 X3 -> v1_xreal_0 X2 -> v1_xreal_0 X1 -> False)
  ...
  -> ((k6_xcmplx_0 esk8_0 esk3_0) = (k6_xcmplx_0 esk1_0 esk6_0) -> (k6_xcmplx_0 esk9_0 esk4_0) = (k6_xcmplx_0 esk2_0 esk7_0) -> False)
