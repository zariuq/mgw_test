...
Theorem t144_member_1:
 forall v2_membered:set -> prop,
 forall a_2_0_member_1:set -> set -> set,
 ...
 forall k9_member_1:set -> set -> set,
 ...
 forall k8_member_1:set -> set -> set,
 ...
 forall k16_member_1:set -> set -> set,
 ...
 forall k17_member_1:set -> set -> set,
 forall v1_xcmplx_0:set -> prop,
 forall esk33_3:set -> set -> set -> set,
 forall esk10_3:set -> set -> set -> set,
 forall esk9_3:set -> set -> set -> set,
 forall k3_binop_2:set -> set -> set,
 forall a_2_3_member_1:set -> set -> set,
 forall r2_hidden:set -> set -> prop,
 forall v1_membered:set -> prop,
     (forall X2 X1 X3, ((k3_binop_2 (esk9_3 X1 X2 X3) (esk10_3 X1 X2 X3)) = X1 -> False) -> v1_membered X3 -> v1_membered X2 -> r2_hidden X1 (a_2_3_member_1 X2 X3) -> False)
  -> (forall X2 X1 X3, ((k1_xxreal_3 (esk7_3 X1 X2 X3) (esk8_3 X1 X2 X3)) = X1 -> False) -> v2_membered X3 -> v2_membered X2 -> r2_hidden X1 (a_2_0_member_1 X2 X3) -> False)
  -> (forall X2 X1 X3, ((k3_binop_2 X2 (esk33_3 X3 X2 X1)) = X1 -> False) -> v1_membered X3 -> v1_xcmplx_0 X2 -> r2_hidden X1 (k17_member_1 X3 X2) -> False)
  -> (forall X2 X3 X1, (r2_hidden (esk33_3 X1 X2 X3) X1 -> False) -> v1_membered X1 -> v1_xcmplx_0 X2 -> r2_hidden X3 (k17_member_1 X1 X2) -> False)
  -> (forall X2 X1 X3, (r2_hidden (esk10_3 X1 X2 X3) X3 -> False) -> v1_membered X3 -> v1_membered X2 -> r2_hidden X1 (a_2_3_member_1 X2 X3) -> False)
  -> (forall X2 X1 X3, (r2_hidden (esk9_3 X1 X2 X3) X2 -> False) -> v1_membered X3 -> v1_membered X2 -> r2_hidden X1 (a_2_3_member_1 X2 X3) -> False)
  -> (forall X2 X1 X3, (r2_hidden (esk8_3 X1 X2 X3) X3 -> False) -> v2_membered X3 -> v2_membered X2 -> r2_hidden X1 (a_2_0_member_1 X2 X3) -> False)
  -> (forall X2 X1 X3, (r2_hidden (esk7_3 X1 X2 X3) X2 -> False) -> v2_membered X3 -> v2_membered X2 -> r2_hidden X1 (a_2_0_member_1 X2 X3) -> False)
  -> (forall X2 X3 X1, (m1_subset_1 (esk33_3 X1 X2 X3) k2_numbers -> False) -> v1_membered X1 -> v1_xcmplx_0 X2 -> r2_hidden X3 (k17_member_1 X1 X2) -> False)
  -> (forall X2 X1 X3, (m1_subset_1 (esk10_3 X1 X2 X3) k2_numbers -> False) -> v1_membered X3 -> v1_membered X2 -> r2_hidden X1 (a_2_3_member_1 X2 X3) -> False)
  -> (forall X2 X1 X3, (m1_subset_1 (esk9_3 X1 X2 X3) k2_numbers -> False) -> v1_membered X3 -> v1_membered X2 -> r2_hidden X1 (a_2_3_member_1 X2 X3) -> False)
  -> (forall X2 X1 X3, (m1_subset_1 (esk8_3 X1 X2 X3) k7_numbers -> False) -> v2_membered X3 -> v2_membered X2 -> r2_hidden X1 (a_2_0_member_1 X2 X3) -> False)
  -> (forall X2 X1 X3, (m1_subset_1 (esk7_3 X1 X2 X3) k7_numbers -> False) -> v2_membered X3 -> v2_membered X2 -> r2_hidden X1 (a_2_0_member_1 X2 X3) -> False)
  -> (forall X2 X1 X4 X5 X3, (r2_hidden X3 (a_2_3_member_1 X4 X5) -> False) -> X3 = (k3_binop_2 X1 X2) -> v1_membered X5 -> v1_membered X4 -> r2_hidden X2 X5 -> r2_hidden X1 X4 -> m1_subset_1 X2 k2_numbers -> m1_subset_1 X1 k2_numbers -> False)
  -> (forall X2 X1 X4 X5 X3, (r2_hidden X3 (a_2_0_member_1 X4 X5) -> False) -> X3 = (k1_xxreal_3 X1 X2) -> v2_membered X5 -> v2_membered X4 -> r2_hidden X2 X5 -> r2_hidden X1 X4 -> m1_subset_1 X2 k7_numbers -> m1_subset_1 X1 k7_numbers -> False)
  -> (forall X1 X3 X2, (v1_xboole_0 X2 -> False) -> (v1_xboole_0 X1 -> False) -> (m1_subset_1 X3 X1 -> False) -> m2_subset_1 X3 X1 X2 -> m1_subset_1 X2 (k1_zfmisc_1 X1) -> False)
  -> (forall X2 X1 X3, (v1_xboole_0 X3 -> False) -> (v1_xboole_0 X2 -> False) -> (m1_subset_1 X1 X3 -> False) -> m2_subset_1 X1 X2 X3 -> m1_subset_1 X3 (k1_zfmisc_1 X2) -> False)
  -> (forall X3 X1 X2 X4, (r1_tarski (k9_member_1 X1 X3) (k9_member_1 X2 X4) -> False) -> v1_membered X4 -> v1_membered X3 -> v1_membered X2 -> v1_membered X1 -> r1_tarski X3 X4 -> r1_tarski X1 X2 -> False)
  ...
  -> (forall X3 X2 X1, (r2_hidden (k3_binop_2 X3 X2) (k17_member_1 X1 X3) -> False) -> v1_membered X1 -> v1_xcmplx_0 X3 -> v1_xcmplx_0 X2 -> r2_hidden X2 X1 -> False)
  -> (forall X1 X3 X2, r2_hidden X3 X2 -> r2_hidden X1 X2 -> r2_hidden X1 (esk34_2 X3 X2) -> False)
  -> (r1_tarski esk1_0 esk2_0 -> r1_tarski (k17_member_1 esk1_0 esk3_0) (k17_member_1 esk2_0 esk3_0) -> False)
  ...
  -> (forall X2 X1, (r1_tarski X1 X2 -> False) -> v1_membered X1 -> r2_hidden (esk4_2 X1 X2) X2 -> False)
  -> (forall X1 X3 X2, (r2_hidden X3 X2 -> False) -> v1_membered X1 -> v1_xcmplx_0 X3 -> r1_tarski X1 X2 -> r2_hidden X3 X1 -> False)
  ...
  -> (forall X1 X2, (v1_xboole_0 X2 -> False) -> (v1_xboole_0 X1 -> False) -> v2_membered X2 -> v2_membered X1 -> v1_xboole_0 (k8_member_1 X1 X2) -> False)
  ...
  -> (forall X1 X2, (v1_xboole_0 X2 -> False) -> (v1_xboole_0 X1 -> False) -> v1_membered X2 -> v1_membered X1 -> v1_xboole_0 (k9_member_1 X1 X2) -> False)
  ...
  -> (forall X2 X1, (v1_xboole_0 X1 -> False) -> v2_membered X1 -> v1_xxreal_0 X2 -> v1_xboole_0 (k16_member_1 X1 X2) -> False)
  -> (forall X2 X1, (v1_xboole_0 X1 -> False) -> v1_membered X1 -> v1_xcmplx_0 X2 -> v1_xboole_0 (k17_member_1 X1 X2) -> False)
  ...
  -> ((r1_tarski esk1_0 esk2_0 -> False) -> (r1_tarski (k17_member_1 esk1_0 esk3_0) (k17_member_1 esk2_0 esk3_0) -> False) -> False)
  -> (forall X2 X1 X3 X4, ((k16_member_1 X2 X4) = (k17_member_1 X1 X3) -> False) -> X3 = X4 -> X1 = X2 -> v2_membered X2 -> v1_xxreal_0 X4 -> v3_membered X1 -> v1_xreal_0 X3 -> False)
  -> (forall X3 X1 X2 X4, ((k9_member_1 X1 X2) = (k8_member_1 X3 X4) -> False) -> X2 = X4 -> X1 = X3 -> v2_membered X4 -> v2_membered X3 -> v3_membered X2 -> v3_membered X1 -> False)
  ...
  -> (forall X2 X1, (r1_tarski X1 X2 -> False) -> (r2_hidden (esk4_2 X1 X2) X1 -> False) -> v1_membered X1 -> False)
  ...
  -> (forall X2 X1, (r1_tarski X1 X2 -> False) -> (v1_xcmplx_0 (esk4_2 X1 X2) -> False) -> v1_membered X1 -> False)
  ...
  -> (forall X1 X2, ((k16_member_1 X1 X2) = (k8_member_1 (k1_tarski X2) X1) -> False) -> v2_membered X1 -> v1_xxreal_0 X2 -> False)
  -> (forall X1 X2, ((k9_member_1 (k1_tarski X2) X1) = (k17_member_1 X1 X2) -> False) -> v1_membered X1 -> v1_xcmplx_0 X2 -> False)
  -> (forall X2 X1, ((k3_xcmplx_0 X1 (k5_xcmplx_0 X2)) = (k7_xcmplx_0 X1 X2) -> False) -> v1_xcmplx_0 X2 -> v1_xcmplx_0 X1 -> False)
  -> (forall X2 X1, ((k2_xcmplx_0 X1 (k4_xcmplx_0 X2)) = (k6_xcmplx_0 X1 X2) -> False) -> v1_xcmplx_0 X2 -> v1_xcmplx_0 X1 -> False)
  -> (forall X2 X1, (r1_tarski X1 X2 -> False) -> m1_subset_1 X1 (k1_zfmisc_1 X2) -> False)
  -> (forall X2 X1, r2_hidden X2 X1 -> r2_hidden X1 X2 -> False)
  -> (forall X2 X1, (v1_xboole_0 (k16_member_1 X1 X2) -> False) -> v1_xxreal_0 X2 -> v1_xboole_0 X1 -> False)
  -> (forall X2 X1, (v1_xboole_0 (k9_member_1 X1 X2) -> False) -> v1_membered X2 -> v1_xboole_0 X1 -> False)
  -> (forall X2 X1, (v1_xboole_0 (k9_member_1 X2 X1) -> False) -> v1_membered X2 -> v1_xboole_0 X1 -> False)
  -> (forall X2 X1, (v1_xboole_0 (k8_member_1 X1 X2) -> False) -> v2_membered X2 -> v1_xboole_0 X1 -> False)
  -> (forall X2 X1, (v1_xboole_0 (k8_member_1 X2 X1) -> False) -> v2_membered X2 -> v1_xboole_0 X1 -> False)
  -> (forall X2 X1, (v1_xboole_0 (k17_member_1 X1 X2) -> False) -> v1_xcmplx_0 X2 -> v1_xboole_0 X1 -> False)
  ...
  -> (forall X2 X1, (v5_membered (k9_member_1 X1 X2) -> False) -> v5_membered X2 -> v5_membered X1 -> False)
  -> (forall X1 X2, (v5_membered (k17_member_1 X1 X2) -> False) -> v5_membered X1 -> v1_int_1 X2 -> False)
  ...
  -> (forall X2 X1, (v4_membered (k9_member_1 X1 X2) -> False) -> v4_membered X2 -> v4_membered X1 -> False)
  -> (forall X1 X2, (v4_membered (k17_member_1 X1 X2) -> False) -> v4_membered X1 -> v1_rat_1 X2 -> False)
  ...
  -> (forall X2 X1, (v3_membered (k9_member_1 X1 X2) -> False) -> v3_membered X2 -> v3_membered X1 -> False)
  -> (forall X1 X2, (v3_membered (k17_member_1 X1 X2) -> False) -> v3_membered X1 -> v1_xreal_0 X2 -> False)
  ...
  -> (forall X1 X2, (v2_membered (k16_member_1 X1 X2) -> False) -> v2_membered X1 -> v1_xxreal_0 X2 -> False)
  -> (forall X2 X1, (v2_membered (k8_member_1 X1 X2) -> False) -> v2_membered X2 -> v2_membered X1 -> False)
  -> (forall X2 X1, (v6_membered (k9_member_1 X1 X2) -> False) -> v6_membered X2 -> v6_membered X1 -> False)
  -> (forall X1 X2, (v6_membered (k17_member_1 X1 X2) -> False) -> v6_membered X1 -> v7_ordinal1 X2 -> False)
  ...
  -> (forall X2 X1, (v1_membered (k9_member_1 X1 X2) -> False) -> v1_membered X2 -> v1_membered X1 -> False)
  -> (forall X1 X2, (v1_membered (k17_member_1 X1 X2) -> False) -> v1_membered X1 -> v1_xcmplx_0 X2 -> False)
  ...
  -> (forall X2 X1, ((a_2_3_member_1 X1 X2) = (k9_member_1 X1 X2) -> False) -> v1_membered X2 -> v1_membered X1 -> False)
  -> (forall X2 X1, ((a_2_0_member_1 X1 X2) = (k8_member_1 X1 X2) -> False) -> v2_membered X2 -> v2_membered X1 -> False)
  -> (forall X2 X1, ((k9_member_1 X1 X2) = (k9_member_1 X2 X1) -> False) -> v1_membered X2 -> v1_membered X1 -> False)
  -> (forall X2 X1, ((k8_member_1 X1 X2) = (k8_member_1 X2 X1) -> False) -> v2_membered X2 -> v2_membered X1 -> False)
