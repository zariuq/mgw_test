...
Theorem t27_yellow10:
 ...
 forall k2_zfmisc_1:set -> set -> set,
  ...
  -> (forall X2 X1 X3 X4, (r1_orders_2 X1 X2 (esk5_4 X1 X3 X4 X2) -> False) -> X4 = (k3_waybel_0 X1 X3) -> l1_orders_2 X1 -> r2_hidden X2 X4 -> m1_subset_1 X2 (u1_struct_0 X1) -> m1_subset_1 X4 (k1_zfmisc_1 (u1_struct_0 X1)) -> m1_subset_1 X3 (k1_zfmisc_1 (u1_struct_0 X1)) -> False)
  -> (forall X4 X1 X2 X3, (m1_subset_1 (esk5_4 X1 X2 X3 X4) (u1_struct_0 X1) -> False) -> X3 = (k3_waybel_0 X1 X2) -> l1_orders_2 X1 -> r2_hidden X4 X3 -> m1_subset_1 X4 (u1_struct_0 X1) -> m1_subset_1 X3 (k1_zfmisc_1 (u1_struct_0 X1)) -> m1_subset_1 X2 (k1_zfmisc_1 (u1_struct_0 X1)) -> False)
  -> (forall X4 X1 X2 X3, (r2_hidden (esk5_4 X1 X2 X3 X4) X2 -> False) -> X3 = (k3_waybel_0 X1 X2) -> l1_orders_2 X1 -> r2_hidden X4 X3 -> m1_subset_1 X4 (u1_struct_0 X1) -> m1_subset_1 X3 (k1_zfmisc_1 (u1_struct_0 X1)) -> m1_subset_1 X2 (k1_zfmisc_1 (u1_struct_0 X1)) -> False)
  ...
  -> (forall X4 X1 X2 X3, (X3 = (k3_waybel_0 X1 X2) -> False) -> l1_orders_2 X1 -> r2_hidden X4 X2 -> m1_subset_1 X4 (u1_struct_0 X1) -> m1_subset_1 X3 (k1_zfmisc_1 (u1_struct_0 X1)) -> m1_subset_1 X2 (k1_zfmisc_1 (u1_struct_0 X1)) -> r2_hidden (esk6_3 X1 X2 X3) X3 -> r1_orders_2 X1 (esk6_3 X1 X2 X3) X4 -> False)
  ...
  -> (forall X2 X3 X1, (X3 = (k3_waybel_0 X1 X2) -> False) -> (r2_hidden (esk6_3 X1 X2 X3) X3 -> False) -> (r1_orders_2 X1 (esk6_3 X1 X2 X3) (esk7_3 X1 X2 X3) -> False) -> l1_orders_2 X1 -> m1_subset_1 X3 (k1_zfmisc_1 (u1_struct_0 X1)) -> m1_subset_1 X2 (k1_zfmisc_1 (u1_struct_0 X1)) -> False)
  ...
  -> (forall X2 X3 X1, (X3 = (k3_waybel_0 X1 X2) -> False) -> (r2_hidden (esk6_3 X1 X2 X3) X3 -> False) -> (m1_subset_1 (esk7_3 X1 X2 X3) (u1_struct_0 X1) -> False) -> l1_orders_2 X1 -> m1_subset_1 X3 (k1_zfmisc_1 (u1_struct_0 X1)) -> m1_subset_1 X2 (k1_zfmisc_1 (u1_struct_0 X1)) -> False)
  -> (forall X2 X3 X1, (X3 = (k3_waybel_0 X1 X2) -> False) -> (r2_hidden (esk6_3 X1 X2 X3) X3 -> False) -> (r2_hidden (esk7_3 X1 X2 X3) X2 -> False) -> l1_orders_2 X1 -> m1_subset_1 X3 (k1_zfmisc_1 (u1_struct_0 X1)) -> m1_subset_1 X2 (k1_zfmisc_1 (u1_struct_0 X1)) -> False)
  ...
  -> (forall X2 X3 X1, (X3 = (k3_waybel_0 X1 X2) -> False) -> (m1_subset_1 (esk6_3 X1 X2 X3) (u1_struct_0 X1) -> False) -> l1_orders_2 X1 -> m1_subset_1 X3 (k1_zfmisc_1 (u1_struct_0 X1)) -> m1_subset_1 X2 (k1_zfmisc_1 (u1_struct_0 X1)) -> False)
  ...
  -> ((k6_yellow_3 esk1_0 esk2_0 (k3_waybel_0 esk1_0 esk3_0) (k3_waybel_0 esk2_0 esk4_0)) = (k3_waybel_0 (k3_yellow_3 esk1_0 esk2_0) (k6_yellow_3 esk1_0 esk2_0 esk3_0 esk4_0)) -> False)
