...
Theorem t32_topgen_1:
 ...
 forall v2_struct_0:set -> prop,
     (forall X4 X3 X2 X1, (v2_struct_0 X1 -> False) -> (r2_hidden (esk33_4 X1 X2 X3 X4) (k9_subset_1 (u1_struct_0 X1) X2 X4) -> False) -> v2_pre_topc X1 -> l1_pre_topc X1 -> r2_hidden X3 X4 -> v3_pre_topc X4 X1 -> m1_subset_1 X3 (u1_struct_0 X1) -> r2_hidden X3 (k2_topgen_1 X1 X2) -> m1_subset_1 X4 (k1_zfmisc_1 (u1_struct_0 X1)) -> m1_subset_1 X2 (k1_zfmisc_1 (u1_struct_0 X1)) -> False)
  -> (forall X4 X3 X2 X1, (v2_struct_0 X1 -> False) -> (m1_subset_1 (esk33_4 X1 X2 X3 X4) (u1_struct_0 X1) -> False) -> v2_pre_topc X1 -> l1_pre_topc X1 -> r2_hidden X3 X4 -> v3_pre_topc X4 X1 -> m1_subset_1 X3 (u1_struct_0 X1) -> r2_hidden X3 (k2_topgen_1 X1 X2) -> m1_subset_1 X4 (k1_zfmisc_1 (u1_struct_0 X1)) -> m1_subset_1 X2 (k1_zfmisc_1 (u1_struct_0 X1)) -> False)
  -> (forall X2 X3 X1 X4, (X1 = X4 -> False) -> (v2_struct_0 X2 -> False) -> (r2_hidden X4 (k2_topgen_1 X2 X3) -> False) -> v2_pre_topc X2 -> l1_pre_topc X2 -> m1_subset_1 X4 (u1_struct_0 X2) -> m1_subset_1 X1 (u1_struct_0 X2) -> m1_subset_1 X3 (k1_zfmisc_1 (u1_struct_0 X2)) -> r2_hidden X1 (k9_subset_1 (u1_struct_0 X2) X3 (esk34_3 X2 X3 X4)) -> False)
  -> (forall X4 X1 X3 X2, (v2_struct_0 X2 -> False) -> (esk33_4 X2 X3 X1 X4) = X1 -> v2_pre_topc X2 -> l1_pre_topc X2 -> r2_hidden X1 X4 -> v3_pre_topc X4 X2 -> m1_subset_1 X1 (u1_struct_0 X2) -> r2_hidden X1 (k2_topgen_1 X2 X3) -> m1_subset_1 X4 (k1_zfmisc_1 (u1_struct_0 X2)) -> m1_subset_1 X3 (k1_zfmisc_1 (u1_struct_0 X2)) -> False)
  ...
  -> (forall X3 X2 X1, (v3_pre_topc (k7_subset_1 (u1_struct_0 X1) X2 X3) X1 -> False) -> v2_pre_topc X1 -> l1_pre_topc X1 -> v3_pre_topc X2 X1 -> v4_pre_topc X3 X1 -> m1_subset_1 X3 (k1_zfmisc_1 (u1_struct_0 X1)) -> m1_subset_1 X2 (k1_zfmisc_1 (u1_struct_0 X1)) -> False)
  -> (forall X2 X3 X1, (v2_struct_0 X1 -> False) -> (r2_hidden X3 (k2_topgen_1 X1 X2) -> False) -> (m1_subset_1 (esk34_3 X1 X2 X3) (k1_zfmisc_1 (u1_struct_0 X1)) -> False) -> v2_pre_topc X1 -> l1_pre_topc X1 -> m1_subset_1 X3 (u1_struct_0 X1) -> m1_subset_1 X2 (k1_zfmisc_1 (u1_struct_0 X1)) -> False)
  -> (forall X2 X3 X1, (v2_struct_0 X1 -> False) -> (r2_hidden X3 (k2_topgen_1 X1 X2) -> False) -> (v3_pre_topc (esk34_3 X1 X2 X3) X1 -> False) -> v2_pre_topc X1 -> l1_pre_topc X1 -> m1_subset_1 X3 (u1_struct_0 X1) -> m1_subset_1 X2 (k1_zfmisc_1 (u1_struct_0 X1)) -> False)
  -> (forall X3 X1 X2, (v2_struct_0 X2 -> False) -> (r2_hidden X1 (k2_topgen_1 X2 X3) -> False) -> (r2_hidden X1 (esk34_3 X2 X3 X1) -> False) -> v2_pre_topc X2 -> l1_pre_topc X2 -> m1_subset_1 X1 (u1_struct_0 X2) -> m1_subset_1 X3 (k1_zfmisc_1 (u1_struct_0 X2)) -> False)
  ...
  -> (forall X2 X1, ((k2_pre_topc X1 (k6_domain_1 (u1_struct_0 X1) X2)) = (k6_domain_1 (u1_struct_0 X1) X2) -> False) -> (v2_struct_0 X1 -> False) -> v2_pre_topc X1 -> l1_pre_topc X1 -> v7_pre_topc X1 -> m1_subset_1 X2 (u1_struct_0 X1) -> False)
  ...
  -> (forall X1, (v2_struct_0 X1 -> False) -> (v1_tdlat_3 X1 -> False) -> v2_pre_topc X1 -> l1_pre_topc X1 -> v7_pre_topc X1 -> v8_struct_0 X1 -> False)
  ...
  -> (r1_tarski (k2_topgen_1 esk1_0 (k2_topgen_1 esk1_0 esk2_0)) (k2_topgen_1 esk1_0 esk2_0) -> False)
  ...
  -> ((v7_pre_topc esk1_0 -> False) -> False)
