...
Theorem t52_cfunct_1:
 ...
 forall esk3_0:set,
 forall esk2_0:set,
     (r2_relset_1 esk2_0 k2_numbers (k2_partfun1 esk2_0 k2_numbers (k2_valued_1 esk2_0 k2_numbers k2_numbers esk3_0 esk4_0) esk1_0) (k2_valued_1 esk2_0 k2_numbers k2_numbers esk3_0 (k2_partfun1 esk2_0 k2_numbers esk4_0 esk1_0)) -> r2_relset_1 esk2_0 k2_numbers (k2_partfun1 esk2_0 k2_numbers (k2_valued_1 esk2_0 k2_numbers k2_numbers esk3_0 esk4_0) esk1_0) (k2_valued_1 esk2_0 k2_numbers k2_numbers (k2_partfun1 esk2_0 k2_numbers esk3_0 esk1_0) esk4_0) -> r2_relset_1 esk2_0 k2_numbers (k2_partfun1 esk2_0 k2_numbers (k2_valued_1 esk2_0 k2_numbers k2_numbers esk3_0 esk4_0) esk1_0) (k2_valued_1 esk2_0 k2_numbers k2_numbers (k2_partfun1 esk2_0 k2_numbers esk3_0 esk1_0) (k2_partfun1 esk2_0 k2_numbers esk4_0 esk1_0)) -> False)
  ...
  -> (forall X1 X2 X4 X3, (v1_xboole_0 X3 -> False) -> (v1_xboole_0 X1 -> False) -> (r2_relset_1 X3 X1 X2 X4 -> False) -> (k1_relset_1 X3 X2) = (k1_relset_1 X3 X4) -> (k7_partfun1 X1 X2 (esk16_4 X1 X3 X2 X4)) = (k7_partfun1 X1 X4 (esk16_4 X1 X3 X2 X4)) -> v1_funct_1 X4 -> v1_funct_1 X2 -> m1_subset_1 X4 (k1_zfmisc_1 (k2_zfmisc_1 X3 X1)) -> m1_subset_1 X2 (k1_zfmisc_1 (k2_zfmisc_1 X3 X1)) -> False)
  ...
  -> (forall X1 X3 X4 X2, (v1_xboole_0 X2 -> False) -> (v1_xboole_0 X1 -> False) -> (r2_relset_1 X2 X1 X3 X4 -> False) -> (r2_hidden (esk16_4 X1 X2 X3 X4) (k1_relset_1 X2 X3) -> False) -> (k1_relset_1 X2 X3) = (k1_relset_1 X2 X4) -> v1_funct_1 X4 -> v1_funct_1 X3 -> m1_subset_1 X4 (k1_zfmisc_1 (k2_zfmisc_1 X2 X1)) -> m1_subset_1 X3 (k1_zfmisc_1 (k2_zfmisc_1 X2 X1)) -> False)
  -> (forall X1 X3 X4 X2, (v1_xboole_0 X2 -> False) -> (v1_xboole_0 X1 -> False) -> (r2_relset_1 X2 X1 X3 X4 -> False) -> (m1_subset_1 (esk16_4 X1 X2 X3 X4) X2 -> False) -> (k1_relset_1 X2 X3) = (k1_relset_1 X2 X4) -> v1_funct_1 X4 -> v1_funct_1 X3 -> m1_subset_1 X4 (k1_zfmisc_1 (k2_zfmisc_1 X2 X1)) -> m1_subset_1 X3 (k1_zfmisc_1 (k2_zfmisc_1 X2 X1)) -> False)
