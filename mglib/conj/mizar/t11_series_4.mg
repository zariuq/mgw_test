...
Theorem t11_series_4:
 ...
 forall k3_series_1:set -> set,
     (forall X3 X1 X2, ((k1_seq_1 (k3_series_1 X1) X3) = (k7_xcmplx_0 (k6_xcmplx_0 (k1_newton (k7_xcmplx_0 np__1 X2) X3) X2) (k6_xcmplx_0 np__1 X2)) -> False) -> (k1_seq_1 (k3_series_1 X1) k6_numbers) = (k7_xcmplx_0 (k6_xcmplx_0 (k1_newton (k7_xcmplx_0 np__1 X2) k6_numbers) X2) (k6_xcmplx_0 np__1 X2)) -> (k1_seq_1 (k3_series_1 X1) (k2_nat_1 (esk27_2 X2 X1) np__1)) = (k7_xcmplx_0 (k6_xcmplx_0 (k1_newton (k7_xcmplx_0 np__1 X2) (k2_nat_1 (esk27_2 X2 X1) np__1)) X2) (k6_xcmplx_0 np__1 X2)) -> v1_xreal_0 X2 -> v1_funct_1 X1 -> v1_funct_2 X1 k5_numbers k1_numbers -> m2_subset_1 X3 k1_numbers k5_numbers -> m1_subset_1 X1 (k1_zfmisc_1 (k2_zfmisc_1 k5_numbers k1_numbers)) -> False)
  -> (forall X3 X2 X1, ((k1_seq_1 (k3_series_1 X1) X3) = (k7_xcmplx_0 (k6_xcmplx_0 (k1_newton (k7_xcmplx_0 np__1 X2) X3) X2) (k6_xcmplx_0 np__1 X2)) -> False) -> ((k1_seq_1 (k3_series_1 X1) (esk27_2 X2 X1)) = (k7_xcmplx_0 (k6_xcmplx_0 (k1_newton (k7_xcmplx_0 np__1 X2) (esk27_2 X2 X1)) X2) (k6_xcmplx_0 np__1 X2)) -> False) -> (k1_seq_1 (k3_series_1 X1) k6_numbers) = (k7_xcmplx_0 (k6_xcmplx_0 (k1_newton (k7_xcmplx_0 np__1 X2) k6_numbers) X2) (k6_xcmplx_0 np__1 X2)) -> v1_xreal_0 X2 -> v1_funct_1 X1 -> v1_funct_2 X1 k5_numbers k1_numbers -> m2_subset_1 X3 k1_numbers k5_numbers -> m1_subset_1 X1 (k1_zfmisc_1 (k2_zfmisc_1 k5_numbers k1_numbers)) -> False)
  -> (forall X3 X2 X1, ((k1_seq_1 (k3_series_1 X2) X3) = (k7_xcmplx_0 (k6_xcmplx_0 (k1_newton (k7_xcmplx_0 np__1 X1) X3) X1) (k6_xcmplx_0 np__1 X1)) -> False) -> (m2_subset_1 (esk27_2 X1 X2) k1_numbers k5_numbers -> False) -> (k1_seq_1 (k3_series_1 X2) k6_numbers) = (k7_xcmplx_0 (k6_xcmplx_0 (k1_newton (k7_xcmplx_0 np__1 X1) k6_numbers) X1) (k6_xcmplx_0 np__1 X1)) -> v1_xreal_0 X1 -> v1_funct_1 X2 -> v1_funct_2 X2 k5_numbers k1_numbers -> m2_subset_1 X3 k1_numbers k5_numbers -> m1_subset_1 X2 (k1_zfmisc_1 (k2_zfmisc_1 k5_numbers k1_numbers)) -> False)
  ...
  -> (forall X1, ((k1_newton (k7_xcmplx_0 np__1 esk1_0) X1) = (k1_seq_1 esk2_0 X1) -> False) -> m1_subset_1 X1 k5_numbers -> False)
  ...
  -> ((k7_xcmplx_0 (k6_xcmplx_0 (k1_newton (k7_xcmplx_0 np__1 esk1_0) esk3_0) esk1_0) (k6_xcmplx_0 np__1 esk1_0)) = (k1_seq_1 (k3_series_1 esk2_0) esk3_0) -> False)
