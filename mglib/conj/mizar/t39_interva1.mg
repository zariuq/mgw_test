...
Theorem t39_interva1:
 ...
 forall esk11_6:set -> set -> set -> set -> set -> set -> set,
 forall k7_subset_1:set -> set -> set -> set,
 forall r2_hidden:set -> set -> prop,
 forall a_5_2_interva1:set -> set -> set -> set -> set -> set,
 forall m1_subset_1:set -> set -> prop,
 forall k1_zfmisc_1:set -> set,
 forall v1_xboole_0:set -> prop,
     (forall X6 X4 X1 X3 X5 X2, (v1_xboole_0 X2 -> False) -> (r1_tarski (esk11_6 X1 X2 X3 X4 X5 X6) (k7_subset_1 X2 X4 X5) -> False) -> m1_subset_1 X6 (k1_zfmisc_1 X2) -> m1_subset_1 X5 (k1_zfmisc_1 X2) -> m1_subset_1 X4 (k1_zfmisc_1 X2) -> m1_subset_1 X3 (k1_zfmisc_1 X2) -> r2_hidden X1 (a_5_2_interva1 X2 X3 X4 X5 X6) -> False)
  -> (forall X6 X3 X4 X2 X5 X1, (v1_xboole_0 X1 -> False) -> (r1_tarski (k7_subset_1 X1 X2 X3) (esk11_6 X4 X1 X2 X5 X6 X3) -> False) -> m1_subset_1 X6 (k1_zfmisc_1 X1) -> m1_subset_1 X5 (k1_zfmisc_1 X1) -> m1_subset_1 X3 (k1_zfmisc_1 X1) -> m1_subset_1 X2 (k1_zfmisc_1 X1) -> r2_hidden X4 (a_5_2_interva1 X1 X2 X5 X6 X3) -> False)
  -> (forall X6 X4 X1 X3 X5 X2, (v1_xboole_0 X2 -> False) -> (m1_subset_1 (esk11_6 X1 X2 X3 X4 X5 X6) (k1_zfmisc_1 X2) -> False) -> m1_subset_1 X6 (k1_zfmisc_1 X2) -> m1_subset_1 X5 (k1_zfmisc_1 X2) -> m1_subset_1 X4 (k1_zfmisc_1 X2) -> m1_subset_1 X3 (k1_zfmisc_1 X2) -> r2_hidden X1 (a_5_2_interva1 X2 X3 X4 X5 X6) -> False)
  -> (forall X6 X4 X1 X3 X5 X2, ((esk11_6 X1 X2 X3 X4 X5 X6) = X1 -> False) -> (v1_xboole_0 X2 -> False) -> m1_subset_1 X6 (k1_zfmisc_1 X2) -> m1_subset_1 X5 (k1_zfmisc_1 X2) -> m1_subset_1 X4 (k1_zfmisc_1 X2) -> m1_subset_1 X3 (k1_zfmisc_1 X2) -> r2_hidden X1 (a_5_2_interva1 X2 X3 X4 X5 X6) -> False)
  -> (forall X3 X6 X7 X5 X4 X1 X2, (v1_xboole_0 X2 -> False) -> (r2_hidden X3 (a_5_2_interva1 X2 X4 X6 X7 X5) -> False) -> X1 = X3 -> m1_subset_1 X7 (k1_zfmisc_1 X2) -> m1_subset_1 X6 (k1_zfmisc_1 X2) -> m1_subset_1 X5 (k1_zfmisc_1 X2) -> m1_subset_1 X4 (k1_zfmisc_1 X2) -> m1_subset_1 X1 (k1_zfmisc_1 X2) -> r1_tarski X1 (k7_subset_1 X2 X6 X7) -> r1_tarski (k7_subset_1 X2 X4 X5) X1 -> False)
  -> (forall X2 X4 X1 X3, (v1_xboole_0 X3 -> False) -> (v1_xboole_0 X2 -> False) -> (v1_xboole_0 X1 -> False) -> (r1_tarski (k7_subset_1 X1 (k7_interva1 X1 X2) (k8_interva1 X1 X3)) (esk10_4 X4 X1 X2 X3) -> False) -> v1_interva1 X3 X1 -> v1_interva1 X2 X1 -> m1_subset_1 X3 (k1_zfmisc_1 (k1_zfmisc_1 X1)) -> m1_subset_1 X2 (k1_zfmisc_1 (k1_zfmisc_1 X1)) -> r2_hidden X4 (a_3_1_interva1 X1 X2 X3) -> False)
  -> (forall X3 X1 X2 X4, (v1_xboole_0 X4 -> False) -> (v1_xboole_0 X3 -> False) -> (v1_xboole_0 X2 -> False) -> (r1_tarski (esk10_4 X1 X2 X3 X4) (k7_subset_1 X2 (k8_interva1 X2 X3) (k7_interva1 X2 X4)) -> False) -> v1_interva1 X4 X2 -> v1_interva1 X3 X2 -> m1_subset_1 X4 (k1_zfmisc_1 (k1_zfmisc_1 X2)) -> m1_subset_1 X3 (k1_zfmisc_1 (k1_zfmisc_1 X2)) -> r2_hidden X1 (a_3_1_interva1 X2 X3 X4) -> False)
  ...
  -> (forall X3 X1 X2 X4, (v1_xboole_0 X4 -> False) -> (v1_xboole_0 X3 -> False) -> (v1_xboole_0 X2 -> False) -> (m1_subset_1 (esk10_4 X1 X2 X3 X4) (k1_zfmisc_1 X2) -> False) -> v1_interva1 X4 X2 -> v1_interva1 X3 X2 -> m1_subset_1 X4 (k1_zfmisc_1 (k1_zfmisc_1 X2)) -> m1_subset_1 X3 (k1_zfmisc_1 (k1_zfmisc_1 X2)) -> r2_hidden X1 (a_3_1_interva1 X2 X3 X4) -> False)
  -> (forall X3 X1 X4 X2, (m1_subset_1 (esk9_4 X1 X2 X3 X4) (k1_zfmisc_1 X2) -> False) -> m1_subset_1 X4 (k1_zfmisc_1 X2) -> m1_subset_1 X3 (k1_zfmisc_1 X2) -> r2_hidden X1 (a_3_0_interva1 X2 X3 X4) -> False)
  -> (forall X3 X1 X4 X2, (r1_tarski (esk9_4 X1 X2 X3 X4) X4 -> False) -> m1_subset_1 X4 (k1_zfmisc_1 X2) -> m1_subset_1 X3 (k1_zfmisc_1 X2) -> r2_hidden X1 (a_3_0_interva1 X2 X3 X4) -> False)
  -> (forall X1 X2 X4 X3, (r1_tarski X1 (esk9_4 X2 X3 X1 X4) -> False) -> m1_subset_1 X4 (k1_zfmisc_1 X3) -> m1_subset_1 X1 (k1_zfmisc_1 X3) -> r2_hidden X2 (a_3_0_interva1 X3 X1 X4) -> False)
  -> (forall X3 X1 X2 X4, ((esk10_4 X1 X2 X3 X4) = X1 -> False) -> (v1_xboole_0 X4 -> False) -> (v1_xboole_0 X3 -> False) -> (v1_xboole_0 X2 -> False) -> v1_interva1 X4 X2 -> v1_interva1 X3 X2 -> m1_subset_1 X4 (k1_zfmisc_1 (k1_zfmisc_1 X2)) -> m1_subset_1 X3 (k1_zfmisc_1 (k1_zfmisc_1 X2)) -> r2_hidden X1 (a_3_1_interva1 X2 X3 X4) -> False)
  -> (forall X3 X1 X4 X2, ((esk9_4 X1 X2 X3 X4) = X1 -> False) -> m1_subset_1 X4 (k1_zfmisc_1 X2) -> m1_subset_1 X3 (k1_zfmisc_1 X2) -> r2_hidden X1 (a_3_0_interva1 X2 X3 X4) -> False)
  ...
  -> (forall X3 X2 X1, (v1_xboole_0 X1 -> False) -> r1_tarski X2 X3 -> m1_subset_1 X3 (k1_zfmisc_1 X1) -> m1_subset_1 X2 (k1_zfmisc_1 X1) -> v1_xboole_0 (k2_interva1 X1 X2 X3) -> False)
  ...
  -> (forall X3 X2 X1, (v1_xboole_0 X1 -> False) -> (m1_subset_1 (k2_interva1 X1 X2 X3) (k1_zfmisc_1 (k1_zfmisc_1 X1)) -> False) -> r1_tarski X2 X3 -> m1_subset_1 X3 (k1_zfmisc_1 X1) -> m1_subset_1 X2 (k1_zfmisc_1 X1) -> False)
  ...
  -> (forall X3 X2 X1, (v1_xboole_0 X1 -> False) -> (v1_interva1 (k2_interva1 X1 X2 X3) X1 -> False) -> r1_tarski X2 X3 -> m1_subset_1 X3 (k1_zfmisc_1 X1) -> m1_subset_1 X2 (k1_zfmisc_1 X1) -> False)
  ...
  -> (forall X1, (v1_xboole_0 X1 -> False) -> (m1_interva1 (esk12_1 X1) X1 -> False) -> False)
  ...
  -> ((k4_setfam_1 (k2_interva1 esk1_0 esk2_0 esk3_0) (k2_interva1 esk1_0 esk4_0 esk5_0)) = (a_5_2_interva1 esk1_0 esk2_0 esk3_0 esk4_0 esk5_0) -> False)
  -> (forall X1, v1_subset_1 (esk18_1 X1) X1 -> False)
  -> (forall X1, v1_xboole_0 (esk15_1 X1) -> False)
  -> (forall X1, v1_xboole_0 (k1_zfmisc_1 X1) -> False)
  -> (v1_xboole_0 esk17_0 -> False)
  -> (v1_xboole_0 esk1_0 -> False)
  -> (forall X1, (m1_subset_1 (esk15_1 X1) (k1_zfmisc_1 (k1_zfmisc_1 X1)) -> False) -> False)
  -> (forall X1, (m1_subset_1 (esk18_1 X1) (k1_zfmisc_1 X1) -> False) -> False)
  -> (forall X1, (m1_subset_1 (esk16_1 X1) (k1_zfmisc_1 X1) -> False) -> False)
  -> (forall X1, (v1_interva1 (esk15_1 X1) X1 -> False) -> False)
