...
Theorem t28_yellow10:
 ...
 forall k2_zfmisc_1:set -> set -> set,
  ...
  -> (r1_tarski (k4_yellow_3 esk1_0 esk2_0 (k3_waybel_0 (k3_yellow_3 esk1_0 esk2_0) esk3_0)) (k3_waybel_0 esk1_0 (k4_yellow_3 esk1_0 esk2_0 esk3_0)) -> r1_tarski (k5_yellow_3 esk1_0 esk2_0 (k3_waybel_0 (k3_yellow_3 esk1_0 esk2_0) esk3_0)) (k3_waybel_0 esk2_0 (k5_yellow_3 esk1_0 esk2_0 esk3_0)) -> False)
  ...
  -> (forall X2 X1 X3 X4, (r1_orders_2 X1 X2 (esk10_4 X1 X3 X4 X2) -> False) -> X4 = (k3_waybel_0 X1 X3) -> l1_orders_2 X1 -> r2_hidden X2 X4 -> m1_subset_1 X2 (u1_struct_0 X1) -> m1_subset_1 X4 (k1_zfmisc_1 (u1_struct_0 X1)) -> m1_subset_1 X3 (k1_zfmisc_1 (u1_struct_0 X1)) -> False)
  -> (forall X4 X1 X2 X3, (m1_subset_1 (esk10_4 X1 X2 X3 X4) (u1_struct_0 X1) -> False) -> X3 = (k3_waybel_0 X1 X2) -> l1_orders_2 X1 -> r2_hidden X4 X3 -> m1_subset_1 X4 (u1_struct_0 X1) -> m1_subset_1 X3 (k1_zfmisc_1 (u1_struct_0 X1)) -> m1_subset_1 X2 (k1_zfmisc_1 (u1_struct_0 X1)) -> False)
  -> (forall X4 X1 X2 X3, (r2_hidden (esk10_4 X1 X2 X3 X4) X2 -> False) -> X3 = (k3_waybel_0 X1 X2) -> l1_orders_2 X1 -> r2_hidden X4 X3 -> m1_subset_1 X4 (u1_struct_0 X1) -> m1_subset_1 X3 (k1_zfmisc_1 (u1_struct_0 X1)) -> m1_subset_1 X2 (k1_zfmisc_1 (u1_struct_0 X1)) -> False)
  ...
  -> (forall X4 X1 X2 X3, (X3 = (k3_waybel_0 X1 X2) -> False) -> l1_orders_2 X1 -> r2_hidden X4 X2 -> m1_subset_1 X4 (u1_struct_0 X1) -> m1_subset_1 X3 (k1_zfmisc_1 (u1_struct_0 X1)) -> m1_subset_1 X2 (k1_zfmisc_1 (u1_struct_0 X1)) -> r2_hidden (esk11_3 X1 X2 X3) X3 -> r1_orders_2 X1 (esk11_3 X1 X2 X3) X4 -> False)
  ...
  -> (forall X2 X3 X1, (X3 = (k3_waybel_0 X1 X2) -> False) -> (r2_hidden (esk11_3 X1 X2 X3) X3 -> False) -> (r1_orders_2 X1 (esk11_3 X1 X2 X3) (esk12_3 X1 X2 X3) -> False) -> l1_orders_2 X1 -> m1_subset_1 X3 (k1_zfmisc_1 (u1_struct_0 X1)) -> m1_subset_1 X2 (k1_zfmisc_1 (u1_struct_0 X1)) -> False)
  ...
  -> (forall X2 X3 X1, (X3 = (k3_waybel_0 X1 X2) -> False) -> (r2_hidden (esk11_3 X1 X2 X3) X3 -> False) -> (m1_subset_1 (esk12_3 X1 X2 X3) (u1_struct_0 X1) -> False) -> l1_orders_2 X1 -> m1_subset_1 X3 (k1_zfmisc_1 (u1_struct_0 X1)) -> m1_subset_1 X2 (k1_zfmisc_1 (u1_struct_0 X1)) -> False)
  ...
  -> (forall X2 X3 X1, (X3 = (k3_waybel_0 X1 X2) -> False) -> (r2_hidden (esk11_3 X1 X2 X3) X3 -> False) -> (r2_hidden (esk12_3 X1 X2 X3) X2 -> False) -> l1_orders_2 X1 -> m1_subset_1 X3 (k1_zfmisc_1 (u1_struct_0 X1)) -> m1_subset_1 X2 (k1_zfmisc_1 (u1_struct_0 X1)) -> False)
  -> (forall X4 X2 X1 X3 X5, (r2_hidden X3 X5 -> False) -> X5 = (k3_waybel_0 X2 X4) -> l1_orders_2 X2 -> r2_hidden X1 X4 -> r1_orders_2 X2 X3 X1 -> m1_subset_1 X3 (u1_struct_0 X2) -> m1_subset_1 X1 (u1_struct_0 X2) -> m1_subset_1 X5 (k1_zfmisc_1 (u1_struct_0 X2)) -> m1_subset_1 X4 (k1_zfmisc_1 (u1_struct_0 X2)) -> False)
  ...
  -> (forall X2 X3 X1, (X3 = (k3_waybel_0 X1 X2) -> False) -> (m1_subset_1 (esk11_3 X1 X2 X3) (u1_struct_0 X1) -> False) -> l1_orders_2 X1 -> m1_subset_1 X3 (k1_zfmisc_1 (u1_struct_0 X1)) -> m1_subset_1 X2 (k1_zfmisc_1 (u1_struct_0 X1)) -> False)
  ...
  -> (forall X2 X1, (v1_xboole_0 (k3_waybel_0 X1 X2) -> False) -> l1_orders_2 X1 -> v1_xboole_0 X2 -> m1_subset_1 X2 (k1_zfmisc_1 (u1_struct_0 X1)) -> False)
