...
Theorem t23_yellow12:
 ...
 forall np__1:set,
 forall k3_relset_1:set -> set -> set -> set,
 ...
 forall k2_relat_1:set -> set,
     (forall X1 X2, (X2 = (k2_relat_1 X1) -> False) -> v1_relat_1 X2 -> v1_relat_1 X1 -> r2_hidden (k2_tarski (k2_tarski (esk9_2 X1 X2) (esk10_2 X1 X2)) (k1_tarski (esk9_2 X1 X2))) X2 -> r2_hidden (k2_tarski (k2_tarski (esk10_2 X1 X2) (esk9_2 X1 X2)) (k1_tarski (esk10_2 X1 X2))) X1 -> False)
  -> (forall X2 X1, (X2 = (k2_relat_1 X1) -> False) -> (r2_hidden (k2_tarski (k2_tarski (esk9_2 X1 X2) (esk10_2 X1 X2)) (k1_tarski (esk9_2 X1 X2))) X2 -> False) -> (r2_hidden (k2_tarski (k2_tarski (esk10_2 X1 X2) (esk9_2 X1 X2)) (k1_tarski (esk10_2 X1 X2))) X1 -> False) -> v1_relat_1 X2 -> v1_relat_1 X1 -> False)
  -> (forall X1 X2, (X2 = (k6_partfun1 X1) -> False) -> (esk2_2 X1 X2) = (esk3_2 X1 X2) -> v1_relat_1 X2 -> r2_hidden (esk2_2 X1 X2) X1 -> r2_hidden (k2_tarski (k2_tarski (esk2_2 X1 X2) (esk3_2 X1 X2)) (k1_tarski (esk2_2 X1 X2))) X2 -> False)
  ...
  -> (forall X1 X2, (X2 = (k6_partfun1 X1) -> False) -> (r2_hidden (esk2_2 X1 X2) X1 -> False) -> (r2_hidden (k2_tarski (k2_tarski (esk2_2 X1 X2) (esk3_2 X1 X2)) (k1_tarski (esk2_2 X1 X2))) X2 -> False) -> v1_relat_1 X2 -> False)
  -> (forall X1 X2, (X2 = (k6_partfun1 X1) -> False) -> ((esk2_2 X1 X2) = (esk3_2 X1 X2) -> False) -> (r2_hidden (k2_tarski (k2_tarski (esk2_2 X1 X2) (esk3_2 X1 X2)) (k1_tarski (esk2_2 X1 X2))) X2 -> False) -> v1_relat_1 X2 -> False)
  ...
  -> (forall X2 X1 X3, (r1_orders_2 X3 X1 X2 -> False) -> l1_orders_2 X3 -> m1_subset_1 X2 (u1_struct_0 X3) -> m1_subset_1 X1 (u1_struct_0 X3) -> r2_hidden (k2_tarski (k2_tarski X1 X2) (k1_tarski X1)) (u1_orders_2 X3) -> False)
  -> (forall X1 X2 X3, (m1_subset_1 (k3_relset_1 X2 X3 X1) (k1_zfmisc_1 (k2_zfmisc_1 X3 X2)) -> False) -> m1_subset_1 X1 (k1_zfmisc_1 (k2_zfmisc_1 X2 X3)) -> False)
  -> (forall X3 X2 X1 X4, (r2_hidden (k2_tarski (k2_tarski X2 X1) (k1_tarski X2)) X4 -> False) -> X3 = (k2_relat_1 X4) -> v1_relat_1 X4 -> v1_relat_1 X3 -> r2_hidden (k2_tarski (k2_tarski X1 X2) (k1_tarski X1)) X3 -> False)
  -> (forall X3 X2 X1 X4, (r2_hidden (k2_tarski (k2_tarski X2 X1) (k1_tarski X2)) X4 -> False) -> X4 = (k2_relat_1 X3) -> v1_relat_1 X4 -> v1_relat_1 X3 -> r2_hidden (k2_tarski (k2_tarski X1 X2) (k1_tarski X1)) X3 -> False)
  -> (forall X1 X2 X3, ((k3_relset_1 X2 X3 (k3_relset_1 X2 X3 X1)) = X1 -> False) -> m1_subset_1 X1 (k1_zfmisc_1 (k2_zfmisc_1 X2 X3)) -> False)
  -> (forall X2 X3 X1, (r2_hidden (k2_tarski (k2_tarski X2 X3) (k1_tarski X2)) (u1_orders_2 X1) -> False) -> l1_orders_2 X1 -> r1_orders_2 X1 X2 X3 -> m1_subset_1 X3 (u1_struct_0 X1) -> m1_subset_1 X2 (u1_struct_0 X1) -> False)
  ...
  -> (forall X4 X3 X1 X2, (r2_hidden X1 X2 -> False) -> X4 = (k6_partfun1 X2) -> v1_relat_1 X4 -> r2_hidden (k2_tarski (k2_tarski X1 X3) (k1_tarski X1)) X4 -> False)
  -> (forall X3 X1 X2, (v1_funct_2 X1 X2 X3 -> False) -> v1_partfun1 X1 X2 -> m1_subset_1 X1 (k1_zfmisc_1 (k2_zfmisc_1 X2 X3)) -> False)
  -> (forall X4 X3 X1 X2, (X1 = X2 -> False) -> X3 = (k6_partfun1 X4) -> v1_relat_1 X3 -> r2_hidden (k2_tarski (k2_tarski X1 X2) (k1_tarski X1)) X3 -> False)
  ...
  -> (forall X1, ((g1_orders_2 (u1_struct_0 X1) (k3_relset_1 (u1_struct_0 X1) (u1_struct_0 X1) (u1_orders_2 X1))) = (k7_lattice3 X1) -> False) -> l1_orders_2 X1 -> False)
  -> (forall X1 X2 X3, ((k3_relset_1 X2 X3 X1) = (k2_relat_1 X1) -> False) -> m1_subset_1 X1 (k1_zfmisc_1 (k2_zfmisc_1 X2 X3)) -> False)
  ...
  -> (forall X2 X1 X3 X4, (r2_hidden (k2_tarski (k2_tarski X1 X3) (k1_tarski X1)) X4 -> False) -> X1 = X3 -> X4 = (k6_partfun1 X2) -> v1_relat_1 X4 -> r2_hidden X1 X2 -> False)
  ...
  -> (forall X1, (v2_struct_0 X1 -> False) -> l1_orders_2 X1 -> v2_struct_0 (k7_lattice3 X1) -> False)
  ...
  -> (forall X1, (v2_struct_0 X1 -> False) -> (v1_orders_2 (k7_lattice3 X1) -> False) -> l1_orders_2 X1 -> False)
  ...
  -> (forall X1, (v1_orders_2 (k7_lattice3 X1) -> False) -> l1_orders_2 X1 -> False)
  -> (forall X1, (l1_orders_2 (k7_lattice3 X1) -> False) -> l1_orders_2 X1 -> False)
  ...
  -> (r1_relset_1 (u1_struct_0 (k7_lattice3 esk1_0)) (u1_struct_0 (k7_lattice3 esk1_0)) (k9_subset_1 (k2_zfmisc_1 (u1_struct_0 (k7_lattice3 esk1_0)) (u1_struct_0 (k7_lattice3 esk1_0))) (u1_orders_2 esk1_0) (u1_orders_2 (k7_lattice3 esk1_0))) (k6_partfun1 (u1_struct_0 esk1_0)) -> False)
