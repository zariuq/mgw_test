...
Theorem t34_interva1:
 ...
 forall o_2_0_interva1:set -> set -> set,
 ...
 forall r2_hidden:set -> set -> prop,
  ...
  -> (forall X3 X2 X4 X1, ((k2_xboole_0 (esk5_4 X2 X3 X4 X1) (esk6_4 X2 X3 X4 X1)) = X1 -> False) -> X4 = (k2_setfam_1 X2 X3) -> r2_hidden X1 X4 -> False)
  ...
  -> (forall X2 X1 X3 X4, (r2_hidden (esk6_4 X1 X2 X3 X4) X2 -> False) -> X3 = (k2_setfam_1 X1 X2) -> r2_hidden X4 X3 -> False)
  -> (forall X2 X1 X3 X4, (r2_hidden (esk5_4 X1 X2 X3 X4) X1 -> False) -> X3 = (k2_setfam_1 X1 X2) -> r2_hidden X4 X3 -> False)
  -> (forall X3 X2 X1, (X3 = (k2_setfam_1 X1 X2) -> False) -> ((k2_xboole_0 (esk8_3 X1 X2 X3) (esk9_3 X1 X2 X3)) = (esk7_3 X1 X2 X3) -> False) -> (r2_hidden (esk7_3 X1 X2 X3) X3 -> False) -> False)
  ...
  -> (forall X5 X4 X1 X2 X3, (X3 = (k2_setfam_1 X1 X2) -> False) -> (esk7_3 X1 X2 X3) = (k2_xboole_0 X4 X5) -> r2_hidden X5 X2 -> r2_hidden X4 X1 -> r2_hidden (esk7_3 X1 X2 X3) X3 -> False)
  ...
  -> (forall X2 X3 X1, (X3 = (k2_setfam_1 X1 X2) -> False) -> (r2_hidden (esk7_3 X1 X2 X3) X3 -> False) -> (r2_hidden (esk9_3 X1 X2 X3) X2 -> False) -> False)
  -> (forall X1 X3 X2, (X3 = (k2_setfam_1 X1 X2) -> False) -> (r2_hidden (esk7_3 X1 X2 X3) X3 -> False) -> (r2_hidden (esk8_3 X1 X2 X3) X1 -> False) -> False)
  ...
  -> (forall X2 X1, (v1_xboole_0 X1 -> False) -> (m2_subset_1 (o_2_0_interva1 X2 X1) (k1_zfmisc_1 X2) X1 -> False) -> v1_interva1 X1 X2 -> m1_subset_1 X1 (k1_zfmisc_1 (k1_zfmisc_1 X2)) -> False)
  ...
  -> ((k2_setfam_1 (k3_setfam_1 esk2_0 esk3_0) esk3_0) = esk3_0 -> False)
  ...
  -> (forall X1 X2, ((k2_xboole_0 X1 (k3_xboole_0 X1 X2)) = X1 -> False) -> False)
  -> (forall X1 X2, (r1_tarski (k3_xboole_0 X1 X2) X1 -> False) -> False)
  -> (forall X1 X2, (r1_tarski X1 (k2_xboole_0 X1 X2) -> False) -> False)
  -> (forall X1, (m1_subset_1 (esk19_1 X1) (k1_zfmisc_1 (k1_zfmisc_1 X1)) -> False) -> False)
  ...
  -> (forall X1, (v1_interva1 (esk19_1 X1) X1 -> False) -> False)
