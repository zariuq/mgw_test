...
Theorem t15_series_3:
 ...
 forall v1_xreal_0:set -> prop,
     (forall X2 X1 X3, (r1_xxreal_0 (k8_real_1 (k8_real_1 (k8_real_1 np__3 X1) X2) X3) (k2_xcmplx_0 (k2_xcmplx_0 (k1_newton X1 np__3) (k1_newton X2 np__3)) (k1_newton X3 np__3)) -> False) -> v1_xreal_0 X3 -> v1_xreal_0 X2 -> v1_xreal_0 X1 -> v2_xxreal_0 X3 -> v2_xxreal_0 X2 -> v2_xxreal_0 X1 -> False)
  -> (forall X1 X3 X2, ((k3_xcmplx_0 (k2_prepower X3 X1) (k2_prepower X3 X2)) = (k2_prepower X3 (k3_xcmplx_0 X1 X2)) -> False) -> v1_xreal_0 X2 -> v1_xreal_0 X1 -> r1_xxreal_0 k6_numbers X2 -> r1_xxreal_0 k6_numbers X1 -> r1_xxreal_0 np__1 X3 -> m2_subset_1 X3 k1_numbers k5_numbers -> False)
  ...
  -> (forall X1 X2 X3, (X1 = (k2_prepower X2 X3) -> False) -> (r1_xxreal_0 X3 k6_numbers -> False) -> (r1_xxreal_0 X1 k6_numbers -> False) -> (k1_newton X1 X2) = X3 -> v1_xreal_0 X3 -> v1_xreal_0 X1 -> v7_ordinal1 X2 -> r1_xxreal_0 np__1 X2 -> False)
  ...
  -> (forall X2 X1 X3, (r1_xxreal_0 X3 k6_numbers -> False) -> X1 = (k2_prepower X2 X3) -> v1_xreal_0 X3 -> v1_xreal_0 X1 -> v7_ordinal1 X2 -> r1_xxreal_0 X1 k6_numbers -> r1_xxreal_0 np__1 X2 -> False)
  -> (forall X1 X2, ((k1_newton (k2_prepower X1 X2) X1) = X2 -> False) -> v1_xreal_0 X2 -> v7_ordinal1 X1 -> r1_xxreal_0 k6_numbers X2 -> r1_xxreal_0 np__1 X1 -> False)
  -> (forall X1 X2, ((k2_prepower X1 (k1_newton X2 X1)) = X2 -> False) -> v1_xreal_0 X2 -> v7_ordinal1 X1 -> r1_xxreal_0 k6_numbers X2 -> r1_xxreal_0 np__1 X1 -> False)
  -> (forall X1 X2 X3, ((k1_newton X1 X2) = X3 -> False) -> (r1_xxreal_0 X3 k6_numbers -> False) -> X1 = (k2_prepower X2 X3) -> v1_xreal_0 X3 -> v1_xreal_0 X1 -> v7_ordinal1 X2 -> r1_xxreal_0 np__1 X2 -> False)
  ...
  -> (forall X2 X1, ((k2_prepower X2 X1) = (k1_power X2 X1) -> False) -> v1_xreal_0 X1 -> v7_ordinal1 X2 -> r1_xxreal_0 k6_numbers X1 -> r1_xxreal_0 np__1 X2 -> False)
  ...
  -> (forall X3 X2 X1, (X1 = k6_numbers -> False) -> X3 = k6_numbers -> X1 = (k2_prepower X2 X3) -> v1_xreal_0 X3 -> v1_xreal_0 X1 -> v7_ordinal1 X2 -> r1_xxreal_0 np__1 X2 -> False)
  ...
  -> (forall X1 X2 X3, (X1 = (k2_prepower X2 X3) -> False) -> X3 = k6_numbers -> X1 = k6_numbers -> v1_xreal_0 X3 -> v1_xreal_0 X1 -> v7_ordinal1 X2 -> r1_xxreal_0 np__1 X2 -> False)
  ...
  -> (r1_xxreal_0 (k8_real_1 np__3 (k1_power np__3 (k3_xcmplx_0 (k3_xcmplx_0 esk1_0 esk2_0) esk3_0))) (k2_xcmplx_0 (k2_xcmplx_0 esk1_0 esk2_0) esk3_0) -> False)
