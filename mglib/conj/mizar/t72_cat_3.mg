...
Theorem t72_cat_3:
 ...
 forall esk8_6:set -> set -> set -> set -> set -> set -> set,
  ...
  -> (forall X5 X2 X3 X4 X1, (v2_struct_0 X1 -> False) -> (v11_struct_0 X1 -> False) -> (r3_cat_3 X1 X2 X3 X4 -> False) -> (r2_hidden (esk13_5 X1 X2 X3 X4 X5) X3 -> False) -> (esk12_5 X1 X2 X3 X4 X5) = X5 -> v2_cat_1 X1 -> v3_cat_1 X1 -> v4_cat_1 X1 -> v5_cat_1 X1 -> v6_cat_1 X1 -> l1_cat_1 X1 -> v1_funct_1 X4 -> m1_subset_1 X5 (u4_struct_0 X1) -> m1_subset_1 X2 (u1_struct_0 X1) -> m2_cat_3 X4 X1 X2 X3 -> v1_funct_2 X4 X3 (u4_struct_0 X1) -> m1_subset_1 X4 (k1_zfmisc_1 (k2_zfmisc_1 X3 (u4_struct_0 X1))) -> r2_hidden X5 (k2_cat_1 X1 X2 (esk10_4 X1 X2 X3 X4)) -> False)
  ...
  -> (forall X3 X2 X1, (v2_struct_0 X1 -> False) -> (v11_struct_0 X1 -> False) -> (m2_cat_3 (esk21_3 X1 X2 X3) X1 X2 X3 -> False) -> v2_cat_1 X1 -> v3_cat_1 X1 -> v4_cat_1 X1 -> v5_cat_1 X1 -> v6_cat_1 X1 -> l1_cat_1 X1 -> m1_subset_1 X2 (u1_struct_0 X1) -> False)
  ...
  -> ((r2_funct_2 esk1_0 (u1_struct_0 esk2_0) (k2_cat_3 esk2_0 esk1_0 esk5_0) (k2_cat_3 esk2_0 esk1_0 esk6_0) -> False) -> False)
  -> ((r3_cat_3 esk2_0 esk4_0 esk1_0 esk6_0 -> False) -> False)
  -> ((r3_cat_3 esk2_0 esk3_0 esk1_0 esk5_0 -> False) -> False)
  -> ((m2_cat_3 esk6_0 esk2_0 esk4_0 esk1_0 -> False) -> False)
  -> ((m2_cat_3 esk5_0 esk2_0 esk3_0 esk1_0 -> False) -> False)
