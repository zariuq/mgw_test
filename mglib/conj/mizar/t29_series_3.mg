...
Theorem t29_series_3:
 ...
 forall k9_prepower:set -> set -> set,
 ...
 forall k4_prepower:set -> set -> set,
     (forall X2 X1 X3, ((k4_prepower X2 (esk22_3 X2 X3 X1)) = X1 -> False) -> X1 = (k3_power X2 X3) -> v1_int_1 X3 -> epred1_3 X1 X3 X2 -> False)
  -> (forall X1 X2, (r1_xxreal_0 (k8_real_1 np__2 (k7_square_1 (k11_binop_2 X1 X2))) (k9_binop_2 X1 X2) -> False) -> v1_xreal_0 X2 -> v1_xreal_0 X1 -> r1_xxreal_0 k6_numbers X2 -> r1_xxreal_0 k6_numbers X1 -> False)
  -> (forall X1 X3 X2, (v1_int_1 (esk22_3 X1 X2 X3) -> False) -> X3 = (k3_power X1 X2) -> v1_int_1 X2 -> epred1_3 X3 X2 X1 -> False)
  -> (forall X1 X3 X2, ((esk22_3 X1 X2 X3) = X2 -> False) -> X3 = (k3_power X1 X2) -> v1_int_1 X2 -> epred1_3 X3 X2 X1 -> False)
  -> (forall X1 X4 X2 X3, (X3 = (k3_power X4 X2) -> False) -> X1 = X2 -> X3 = (k4_prepower X4 X1) -> v1_int_1 X2 -> v1_int_1 X1 -> epred1_3 X3 X2 X4 -> False)
  -> (forall X1 X3 X2, (v1_xboole_0 X2 -> False) -> (v1_xboole_0 X1 -> False) -> (m1_subset_1 X3 X1 -> False) -> m2_subset_1 X3 X1 X2 -> m1_subset_1 X2 (k1_zfmisc_1 X1) -> False)
  -> (forall X2 X1 X3, (v1_xboole_0 X3 -> False) -> (v1_xboole_0 X2 -> False) -> (m1_subset_1 X1 X3 -> False) -> m2_subset_1 X1 X2 X3 -> m1_subset_1 X3 (k1_zfmisc_1 X2) -> False)
  -> (forall X3 X2 X1, ((k3_xcmplx_0 (k3_power X1 X2) (k3_power X1 X3)) = (k3_power X1 (k2_xcmplx_0 X2 X3)) -> False) -> (r1_xxreal_0 X1 k6_numbers -> False) -> v1_xreal_0 X3 -> v1_xreal_0 X2 -> v1_xreal_0 X1 -> False)
  -> (forall X3 X1 X2, (X1 = (k9_prepower X2 X3) -> False) -> (r1_xxreal_0 X2 k6_numbers -> False) -> X1 = (k3_power X2 X3) -> epred1_3 X1 X3 X2 -> False)
  -> (forall X3 X1 X2, (X1 = (k3_power X2 X3) -> False) -> (r1_xxreal_0 X2 k6_numbers -> False) -> X1 = (k9_prepower X2 X3) -> epred1_3 X1 X3 X2 -> False)
  ...
  -> (forall X2 X1 X3, (r1_xxreal_0 (k9_prepower X1 X3) (k9_prepower X1 X2) -> False) -> v1_xreal_0 X3 -> v1_xreal_0 X2 -> v1_xreal_0 X1 -> r1_xxreal_0 X3 X2 -> r1_xxreal_0 np__1 X1 -> False)
  ...
  -> (forall X3 X2 X1, (X1 = k6_numbers -> False) -> (r1_xxreal_0 X3 k6_numbers -> False) -> X2 = k6_numbers -> X1 = (k3_power X2 X3) -> epred1_3 X1 X3 X2 -> False)
  ...
  -> (forall X2 X1 X3, (X1 = (k3_power X2 X3) -> False) -> (r1_xxreal_0 X3 k6_numbers -> False) -> X2 = k6_numbers -> X1 = k6_numbers -> epred1_3 X1 X3 X2 -> False)
  -> (forall X2 X1 X3, (v1_xboole_0 X3 -> False) -> (v1_xboole_0 X2 -> False) -> (m2_subset_1 X1 X3 X2 -> False) -> m1_subset_1 X1 X2 -> m1_subset_1 X2 (k1_zfmisc_1 X3) -> False)
  -> (forall X3 X2 X1, ((k3_power (k3_power X1 X2) X3) = (k3_power X1 (k3_xcmplx_0 X2 X3)) -> False) -> (r1_xxreal_0 X1 k6_numbers -> False) -> v1_xreal_0 X3 -> v1_xreal_0 X2 -> v1_xreal_0 X1 -> False)
  ...
  -> (forall X2 X1, (r1_xxreal_0 X1 k6_numbers -> False) -> v1_xreal_0 X2 -> v1_xreal_0 X1 -> r1_xxreal_0 (k3_power X1 X2) k6_numbers -> False)
  ...
  -> (forall X1 X2 X3, (epred1_3 X3 X2 X1 -> False) -> v1_xreal_0 X3 -> v1_xreal_0 X2 -> v1_xreal_0 X1 -> False)
  ...
  -> (forall X1, ((k3_power X1 (k10_real_1 np__1 np__2)) = (k6_square_1 X1) -> False) -> v1_xreal_0 X1 -> r1_xxreal_0 k6_numbers X1 -> False)
  ...
  -> (forall X2 X1, (v1_xreal_0 (k9_prepower X1 X2) -> False) -> v1_xreal_0 X2 -> v1_xreal_0 X1 -> False)
  ...
  -> (r1_xxreal_0 (k8_real_1 np__2 (k3_power esk1_0 (k6_square_1 (k3_xcmplx_0 esk2_0 esk3_0)))) (k2_xcmplx_0 (k3_power esk1_0 esk2_0) (k3_power esk1_0 esk3_0)) -> False)
  ...
  -> ((v2_xxreal_0 esk3_0 -> False) -> False)
