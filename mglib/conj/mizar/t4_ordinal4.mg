...
Theorem t4_ordinal4:
 ...
 forall k1_xboole_0:set,
  ...
  -> (forall X2 X1 X3, (X1 = (k1_ordinal3 X2 X3) -> False) -> (k9_xtuple_0 X1) = (k9_xtuple_0 X3) -> (k1_funct_1 X1 (esk4_3 X2 X3 X1)) = (k10_ordinal2 X2 (k1_funct_1 X3 (esk4_3 X2 X3 X1))) -> v1_relat_1 X3 -> v1_relat_1 X1 -> v5_ordinal1 X3 -> v5_ordinal1 X1 -> v1_funct_1 X3 -> v1_funct_1 X1 -> v1_ordinal2 X3 -> v1_ordinal2 X1 -> v3_ordinal1 X2 -> False)
  ...
  -> (forall X1 X2 X3, (X3 = (k1_ordinal3 X1 X2) -> False) -> (r2_hidden (esk4_3 X1 X2 X3) (k9_xtuple_0 X2) -> False) -> (k9_xtuple_0 X2) = (k9_xtuple_0 X3) -> v1_relat_1 X3 -> v1_relat_1 X2 -> v5_ordinal1 X3 -> v5_ordinal1 X2 -> v1_funct_1 X3 -> v1_funct_1 X2 -> v1_ordinal2 X3 -> v1_ordinal2 X2 -> v3_ordinal1 X1 -> False)
  ...
  -> (forall X1 X2 X3, (X3 = (k1_ordinal3 X1 X2) -> False) -> (v3_ordinal1 (esk4_3 X1 X2 X3) -> False) -> (k9_xtuple_0 X2) = (k9_xtuple_0 X3) -> v1_relat_1 X3 -> v1_relat_1 X2 -> v5_ordinal1 X3 -> v5_ordinal1 X2 -> v1_funct_1 X3 -> v1_funct_1 X2 -> v1_ordinal2 X3 -> v1_ordinal2 X2 -> v3_ordinal1 X1 -> False)
  ...
  -> (forall X1 X4 X2 X3, ((k1_funct_1 X3 X1) = (k10_ordinal2 X4 (k1_funct_1 X2 X1)) -> False) -> X3 = (k1_ordinal3 X4 X2) -> v1_relat_1 X3 -> v1_relat_1 X2 -> v5_ordinal1 X3 -> v5_ordinal1 X2 -> v1_funct_1 X3 -> v1_funct_1 X2 -> v1_ordinal2 X3 -> v1_ordinal2 X2 -> v3_ordinal1 X4 -> v3_ordinal1 X1 -> r2_hidden X1 (k9_xtuple_0 X2) -> False)
  ...
  -> (forall X3 X2 X1, (X1 = k1_xboole_0 -> False) -> (r2_hidden (k5_ordinal3 X2 X3) X1 -> False) -> v3_ordinal1 X3 -> v3_ordinal1 X2 -> v3_ordinal1 X1 -> r2_hidden X2 (k10_ordinal2 X3 X1) -> False)
  -> (forall X2 X1 X3, (r2_hidden X2 (k5_ordinal3 X3 X1) -> False) -> v3_ordinal1 X3 -> v3_ordinal1 X2 -> v3_ordinal1 X1 -> r2_hidden (k10_ordinal2 X1 X2) X3 -> False)
  ...
  -> (forall X2 X1, (r1_ordinal1 X1 (k10_ordinal2 X2 (k5_ordinal3 X1 X2)) -> False) -> v3_ordinal1 X2 -> v3_ordinal1 X1 -> False)
  -> (forall X3 X1 X2, ((k9_xtuple_0 X1) = (k9_xtuple_0 X2) -> False) -> X1 = (k1_ordinal3 X3 X2) -> v1_relat_1 X2 -> v1_relat_1 X1 -> v5_ordinal1 X2 -> v5_ordinal1 X1 -> v1_funct_1 X2 -> v1_funct_1 X1 -> v1_ordinal2 X2 -> v1_ordinal2 X1 -> v3_ordinal1 X3 -> False)
  ...
  -> (forall X1 X2, (v1_ordinal2 (k1_ordinal3 X1 X2) -> False) -> v1_relat_1 X2 -> v5_ordinal1 X2 -> v1_funct_1 X2 -> v1_ordinal2 X2 -> v3_ordinal1 X1 -> False)
  -> (forall X1 X2, (v1_funct_1 (k1_ordinal3 X1 X2) -> False) -> v1_relat_1 X2 -> v5_ordinal1 X2 -> v1_funct_1 X2 -> v1_ordinal2 X2 -> v3_ordinal1 X1 -> False)
  -> (forall X1 X2, (v5_ordinal1 (k1_ordinal3 X1 X2) -> False) -> v1_relat_1 X2 -> v5_ordinal1 X2 -> v1_funct_1 X2 -> v1_ordinal2 X2 -> v3_ordinal1 X1 -> False)
  -> (forall X1 X2, (v1_relat_1 (k1_ordinal3 X1 X2) -> False) -> v1_relat_1 X2 -> v5_ordinal1 X2 -> v1_funct_1 X2 -> v1_ordinal2 X2 -> v3_ordinal1 X1 -> False)
  ...
  -> (r1_ordinal2 (k10_ordinal2 esk3_0 esk2_0) (k1_ordinal3 esk3_0 esk1_0) -> False)
