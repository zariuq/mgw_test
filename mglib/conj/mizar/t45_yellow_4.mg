...
Theorem t45_yellow_4:
 ...
 forall k4_yellow_4:set -> set -> set -> set,
 forall v1_xboole_0:set -> prop,
 forall k3_yellow_4:set -> set -> set -> set,
 forall v2_struct_0:set -> prop,
 forall m1_subset_1:set -> set -> prop,
 forall k1_zfmisc_1:set -> set,
 forall u1_struct_0:set -> set,
 forall a_3_18_yellow_4:set -> set -> set -> set,
 ...
 forall esk12_4:set -> set -> set -> set -> set,
     (forall X3 X1 X4 X2, ((k11_lattice3 X2 (esk12_4 X1 X2 X3 X4) (esk13_4 X1 X2 X3 X4)) = X1 -> False) -> (v2_struct_0 X2 -> False) -> l1_orders_2 X2 -> m1_subset_1 X4 (k1_zfmisc_1 (u1_struct_0 X2)) -> m1_subset_1 X3 (k1_zfmisc_1 (u1_struct_0 X2)) -> r2_hidden X1 (a_3_18_yellow_4 X2 X3 X4) -> False)
  -> (forall X4 X3 X2 X1, (X4 = (k12_lattice3 X1 X2 X3) -> False) -> v5_orders_2 X1 -> v2_lattice3 X1 -> l1_orders_2 X1 -> r1_orders_2 X1 X4 X3 -> r1_orders_2 X1 X4 X2 -> m1_subset_1 X4 (u1_struct_0 X1) -> m1_subset_1 X3 (u1_struct_0 X1) -> m1_subset_1 X2 (u1_struct_0 X1) -> r1_orders_2 X1 (esk18_4 X1 X2 X3 X4) X4 -> False)
  -> (forall X4 X3 X2 X1, (X4 = (k12_lattice3 X1 X2 X3) -> False) -> (r1_orders_2 X1 (esk18_4 X1 X2 X3 X4) X2 -> False) -> v5_orders_2 X1 -> v2_lattice3 X1 -> l1_orders_2 X1 -> r1_orders_2 X1 X4 X3 -> r1_orders_2 X1 X4 X2 -> m1_subset_1 X4 (u1_struct_0 X1) -> m1_subset_1 X3 (u1_struct_0 X1) -> m1_subset_1 X2 (u1_struct_0 X1) -> False)
  -> (forall X4 X3 X2 X1, (X4 = (k12_lattice3 X1 X2 X3) -> False) -> (r1_orders_2 X1 (esk18_4 X1 X2 X3 X4) X3 -> False) -> v5_orders_2 X1 -> v2_lattice3 X1 -> l1_orders_2 X1 -> r1_orders_2 X1 X4 X3 -> r1_orders_2 X1 X4 X2 -> m1_subset_1 X4 (u1_struct_0 X1) -> m1_subset_1 X3 (u1_struct_0 X1) -> m1_subset_1 X2 (u1_struct_0 X1) -> False)
  -> (forall X4 X3 X2 X1, (X4 = (k12_lattice3 X1 X2 X3) -> False) -> (m1_subset_1 (esk18_4 X1 X2 X3 X4) (u1_struct_0 X1) -> False) -> v5_orders_2 X1 -> v2_lattice3 X1 -> l1_orders_2 X1 -> r1_orders_2 X1 X4 X3 -> r1_orders_2 X1 X4 X2 -> m1_subset_1 X4 (u1_struct_0 X1) -> m1_subset_1 X3 (u1_struct_0 X1) -> m1_subset_1 X2 (u1_struct_0 X1) -> False)
  -> (forall X3 X1 X4 X2, (v2_struct_0 X2 -> False) -> (m1_subset_1 (esk13_4 X1 X2 X3 X4) (u1_struct_0 X2) -> False) -> l1_orders_2 X2 -> m1_subset_1 X4 (k1_zfmisc_1 (u1_struct_0 X2)) -> m1_subset_1 X3 (k1_zfmisc_1 (u1_struct_0 X2)) -> r2_hidden X1 (a_3_18_yellow_4 X2 X3 X4) -> False)
  -> (forall X3 X1 X4 X2, (v2_struct_0 X2 -> False) -> (m1_subset_1 (esk12_4 X1 X2 X3 X4) (u1_struct_0 X2) -> False) -> l1_orders_2 X2 -> m1_subset_1 X4 (k1_zfmisc_1 (u1_struct_0 X2)) -> m1_subset_1 X3 (k1_zfmisc_1 (u1_struct_0 X2)) -> r2_hidden X1 (a_3_18_yellow_4 X2 X3 X4) -> False)
  -> (forall X3 X1 X4 X2, (v2_struct_0 X2 -> False) -> (r2_hidden (esk13_4 X1 X2 X3 X4) X4 -> False) -> l1_orders_2 X2 -> m1_subset_1 X4 (k1_zfmisc_1 (u1_struct_0 X2)) -> m1_subset_1 X3 (k1_zfmisc_1 (u1_struct_0 X2)) -> r2_hidden X1 (a_3_18_yellow_4 X2 X3 X4) -> False)
  -> (forall X3 X1 X4 X2, (v2_struct_0 X2 -> False) -> (r2_hidden (esk12_4 X1 X2 X3 X4) X3 -> False) -> l1_orders_2 X2 -> m1_subset_1 X4 (k1_zfmisc_1 (u1_struct_0 X2)) -> m1_subset_1 X3 (k1_zfmisc_1 (u1_struct_0 X2)) -> r2_hidden X1 (a_3_18_yellow_4 X2 X3 X4) -> False)
  ...
  -> (forall X4 X5 X6 X3 X1 X2, (v2_struct_0 X2 -> False) -> (r2_hidden X4 (a_3_18_yellow_4 X2 X5 X6) -> False) -> X4 = (k11_lattice3 X2 X1 X3) -> l1_orders_2 X2 -> r2_hidden X3 X6 -> r2_hidden X1 X5 -> m1_subset_1 X3 (u1_struct_0 X2) -> m1_subset_1 X1 (u1_struct_0 X2) -> m1_subset_1 X6 (k1_zfmisc_1 (u1_struct_0 X2)) -> m1_subset_1 X5 (k1_zfmisc_1 (u1_struct_0 X2)) -> False)
  ...
  -> (forall X3 X2 X1, (v2_struct_0 X1 -> False) -> (v1_xboole_0 X3 -> False) -> (v1_xboole_0 X2 -> False) -> l1_orders_2 X1 -> v1_xboole_0 (k3_yellow_4 X1 X2 X3) -> m1_subset_1 X3 (k1_zfmisc_1 (u1_struct_0 X1)) -> m1_subset_1 X2 (k1_zfmisc_1 (u1_struct_0 X1)) -> False)
  -> (forall X2 X3 X4 X1, (r2_hidden X4 X1 -> False) -> l1_orders_2 X2 -> v12_waybel_0 X1 X2 -> r2_hidden X3 X1 -> r1_orders_2 X2 X4 X3 -> m1_subset_1 X4 (u1_struct_0 X2) -> m1_subset_1 X3 (u1_struct_0 X2) -> m1_subset_1 X1 (k1_zfmisc_1 (u1_struct_0 X2)) -> False)
  -> (forall X2 X3 X1, (m1_subset_1 (k4_yellow_4 X1 X2 X3) (k1_zfmisc_1 (u1_struct_0 X1)) -> False) -> v5_orders_2 X1 -> v2_lattice3 X1 -> l1_orders_2 X1 -> m1_subset_1 X3 (k1_zfmisc_1 (u1_struct_0 X1)) -> m1_subset_1 X2 (k1_zfmisc_1 (u1_struct_0 X1)) -> False)
  ...
  -> (forall X3 X2 X1, (v2_struct_0 X1 -> False) -> (m1_subset_1 (k3_yellow_4 X1 X2 X3) (k1_zfmisc_1 (u1_struct_0 X1)) -> False) -> l1_orders_2 X1 -> m1_subset_1 X3 (k1_zfmisc_1 (u1_struct_0 X1)) -> m1_subset_1 X2 (k1_zfmisc_1 (u1_struct_0 X1)) -> False)
  -> (forall X2 X3 X1, ((k4_yellow_4 X1 X2 X3) = (k3_yellow_4 X1 X2 X3) -> False) -> v5_orders_2 X1 -> v2_lattice3 X1 -> l1_orders_2 X1 -> m1_subset_1 X3 (k1_zfmisc_1 (u1_struct_0 X1)) -> m1_subset_1 X2 (k1_zfmisc_1 (u1_struct_0 X1)) -> False)
  -> (forall X2 X3 X1, ((k4_yellow_4 X1 X2 X3) = (k4_yellow_4 X1 X3 X2) -> False) -> v5_orders_2 X1 -> v2_lattice3 X1 -> l1_orders_2 X1 -> m1_subset_1 X3 (k1_zfmisc_1 (u1_struct_0 X1)) -> m1_subset_1 X2 (k1_zfmisc_1 (u1_struct_0 X1)) -> False)
  -> (forall X3 X2 X1, ((k3_yellow_4 X1 X2 X3) = (a_3_18_yellow_4 X1 X2 X3) -> False) -> (v2_struct_0 X1 -> False) -> l1_orders_2 X1 -> m1_subset_1 X3 (k1_zfmisc_1 (u1_struct_0 X1)) -> m1_subset_1 X2 (k1_zfmisc_1 (u1_struct_0 X1)) -> False)
  ...
  -> (forall X2 X1, (v12_waybel_0 X2 X1 -> False) -> (r1_orders_2 X1 (esk6_2 X1 X2) (esk5_2 X1 X2) -> False) -> l1_orders_2 X1 -> m1_subset_1 X2 (k1_zfmisc_1 (u1_struct_0 X1)) -> False)
  ...
  -> (forall X2 X1, (v12_waybel_0 X2 X1 -> False) -> l1_orders_2 X1 -> r2_hidden (esk6_2 X1 X2) X2 -> m1_subset_1 X2 (k1_zfmisc_1 (u1_struct_0 X1)) -> False)
  ...
  -> (forall X2 X1, (v12_waybel_0 X2 X1 -> False) -> (m1_subset_1 (esk6_2 X1 X2) (u1_struct_0 X1) -> False) -> l1_orders_2 X1 -> m1_subset_1 X2 (k1_zfmisc_1 (u1_struct_0 X1)) -> False)
  -> (forall X2 X1, (v12_waybel_0 X2 X1 -> False) -> (m1_subset_1 (esk5_2 X1 X2) (u1_struct_0 X1) -> False) -> l1_orders_2 X1 -> m1_subset_1 X2 (k1_zfmisc_1 (u1_struct_0 X1)) -> False)
  -> (forall X2 X1, (v12_waybel_0 X2 X1 -> False) -> (r2_hidden (esk5_2 X1 X2) X2 -> False) -> l1_orders_2 X1 -> m1_subset_1 X2 (k1_zfmisc_1 (u1_struct_0 X1)) -> False)
  ...
  -> (r1_tarski (k4_yellow_4 esk1_0 (k4_subset_1 (u1_struct_0 esk1_0) esk2_0 esk3_0) (k4_subset_1 (u1_struct_0 esk1_0) esk2_0 esk4_0)) (k4_subset_1 (u1_struct_0 esk1_0) esk2_0 (k4_yellow_4 esk1_0 esk3_0 esk4_0)) -> False)
  ...
  -> ((v12_waybel_0 esk2_0 esk1_0 -> False) -> False)
