...
Theorem t5_euclmetr:
 ...
 forall m1_subset_1:set -> set -> prop,
     (forall X1, m1_subset_1 X1 (u1_struct_0 esk1_0) -> r4_analmetr esk1_0 X1 esk2_0 esk3_0 esk4_0 -> r4_analmetr esk1_0 X1 esk3_0 esk2_0 esk4_0 -> False)
  -> (forall X3 X4 X2 X1, (X4 = (k1_aff_1 X1 X2 X3) -> False) -> (v7_struct_0 X1 -> False) -> l1_analoaf X1 -> v1_diraf X1 -> m1_subset_1 X3 (u1_struct_0 X1) -> m1_subset_1 X2 (u1_struct_0 X1) -> m1_subset_1 X4 (k1_zfmisc_1 (u1_struct_0 X1)) -> r2_hidden (esk7_4 X1 X2 X3 X4) X4 -> r1_aff_1 X1 X2 X3 (esk7_4 X1 X2 X3 X4) -> False)
  ...
  -> (forall X3 X2 X4 X1, (X4 = (k1_aff_1 X1 X2 X3) -> False) -> (v7_struct_0 X1 -> False) -> (r2_hidden (esk7_4 X1 X2 X3 X4) X4 -> False) -> (r1_aff_1 X1 X2 X3 (esk7_4 X1 X2 X3 X4) -> False) -> l1_analoaf X1 -> v1_diraf X1 -> m1_subset_1 X3 (u1_struct_0 X1) -> m1_subset_1 X2 (u1_struct_0 X1) -> m1_subset_1 X4 (k1_zfmisc_1 (u1_struct_0 X1)) -> False)
  ...
  -> (forall X3 X2 X4 X1, (X4 = (k1_aff_1 X1 X2 X3) -> False) -> (v7_struct_0 X1 -> False) -> (m1_subset_1 (esk7_4 X1 X2 X3 X4) (u1_struct_0 X1) -> False) -> l1_analoaf X1 -> v1_diraf X1 -> m1_subset_1 X3 (u1_struct_0 X1) -> m1_subset_1 X2 (u1_struct_0 X1) -> m1_subset_1 X4 (k1_zfmisc_1 (u1_struct_0 X1)) -> False)
  ...
  -> (forall X1 X2, ((k4_analmetr X2 (esk5_2 X2 X1) (esk6_2 X2 X1)) = X1 -> False) -> (v2_struct_0 X2 -> False) -> l1_analmetr X2 -> v4_analmetr X1 X2 -> m1_subset_1 X1 (k1_zfmisc_1 (u1_struct_0 X2)) -> False)
  ...
  -> (forall X2 X1, (v2_struct_0 X1 -> False) -> (m1_subset_1 (esk5_2 X1 X2) (u1_struct_0 X1) -> False) -> l1_analmetr X1 -> v4_analmetr X2 X1 -> m1_subset_1 X2 (k1_zfmisc_1 (u1_struct_0 X1)) -> False)
  -> (forall X2 X1, (v2_struct_0 X1 -> False) -> (esk6_2 X1 X2) = (esk5_2 X1 X2) -> l1_analmetr X1 -> v4_analmetr X2 X1 -> m1_subset_1 X2 (k1_zfmisc_1 (u1_struct_0 X1)) -> False)
  ...
  -> (r5_analmetr esk1_0 esk2_0 esk3_0 esk4_0 -> False)
