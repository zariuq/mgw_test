...
Theorem t3_diff_2:
 ...
 forall k7_diff_1:set -> set -> set,
  ...
  -> (forall X4 X3 X2 X1, (r2_relset_1 k1_numbers k1_numbers (k1_seqfunc k1_numbers k1_numbers X2 (k1_nat_1 X1 np__1)) (k4_diff_1 (k1_seqfunc k1_numbers k1_numbers X2 X1) X3) -> False) -> X2 = (k7_diff_1 X4 X3) -> v1_funct_1 X4 -> v1_funct_1 X2 -> v1_xreal_0 X3 -> v7_ordinal1 X1 -> m1_subset_1 X4 (k1_zfmisc_1 (k2_zfmisc_1 k1_numbers k1_numbers)) -> v1_funct_2 X2 k5_numbers (k4_partfun1 k1_numbers k1_numbers) -> m1_subset_1 X2 (k1_zfmisc_1 (k2_zfmisc_1 k5_numbers (k4_partfun1 k1_numbers k1_numbers))) -> False)
  -> (forall X1 X2 X3, (X3 = (k7_diff_1 X1 X2) -> False) -> (v7_ordinal1 (esk4_3 X1 X2 X3) -> False) -> v1_funct_1 X3 -> v1_funct_1 X1 -> v1_xreal_0 X2 -> m1_subset_1 X1 (k1_zfmisc_1 (k2_zfmisc_1 k1_numbers k1_numbers)) -> v1_funct_2 X3 k5_numbers (k4_partfun1 k1_numbers k1_numbers) -> m1_subset_1 X3 (k1_zfmisc_1 (k2_zfmisc_1 k5_numbers (k4_partfun1 k1_numbers k1_numbers))) -> r2_relset_1 k1_numbers k1_numbers (k1_seqfunc k1_numbers k1_numbers X3 k6_numbers) X1 -> False)
  ...
  -> (forall X2 X1, ((k47_valued_1 k1_numbers k1_numbers k1_numbers X1 (k1_diff_1 X1 (k4_xcmplx_0 X2))) = (k4_diff_1 X1 X2) -> False) -> v1_funct_1 X1 -> v1_xreal_0 X2 -> m1_subset_1 X1 (k1_zfmisc_1 (k2_zfmisc_1 k1_numbers k1_numbers)) -> False)
  -> (forall X3 X1 X2, (r2_relset_1 k1_numbers k1_numbers (k1_seqfunc k1_numbers k1_numbers X1 k6_numbers) X2 -> False) -> X1 = (k7_diff_1 X2 X3) -> v1_funct_1 X2 -> v1_funct_1 X1 -> v1_xreal_0 X3 -> m1_subset_1 X2 (k1_zfmisc_1 (k2_zfmisc_1 k1_numbers k1_numbers)) -> v1_funct_2 X1 k5_numbers (k4_partfun1 k1_numbers k1_numbers) -> m1_subset_1 X1 (k1_zfmisc_1 (k2_zfmisc_1 k5_numbers (k4_partfun1 k1_numbers k1_numbers))) -> False)
  ...
  -> (forall X2 X1, (m1_subset_1 (k7_diff_1 X1 X2) (k1_zfmisc_1 (k2_zfmisc_1 k5_numbers (k4_partfun1 k1_numbers k1_numbers))) -> False) -> v1_funct_1 X1 -> v1_xreal_0 X2 -> m1_subset_1 X1 (k1_zfmisc_1 (k2_zfmisc_1 k1_numbers k1_numbers)) -> False)
  ...
  -> (forall X2 X1, (v1_funct_2 (k7_diff_1 X1 X2) k5_numbers (k4_partfun1 k1_numbers k1_numbers) -> False) -> v1_funct_1 X1 -> v1_xreal_0 X2 -> m1_subset_1 X1 (k1_zfmisc_1 (k2_zfmisc_1 k1_numbers k1_numbers)) -> False)
  ...
  -> (forall X2 X1, (m1_subset_1 (k4_diff_1 X1 X2) (k1_zfmisc_1 (k2_zfmisc_1 k1_numbers k1_numbers)) -> False) -> v1_funct_1 X1 -> v1_xreal_0 X2 -> m1_subset_1 X1 (k1_zfmisc_1 (k2_zfmisc_1 k1_numbers k1_numbers)) -> False)
  ...
  -> (forall X2 X1, (v1_funct_1 (k4_diff_1 X1 X2) -> False) -> v1_funct_1 X1 -> v1_xreal_0 X2 -> m1_subset_1 X1 (k1_zfmisc_1 (k2_zfmisc_1 k1_numbers k1_numbers)) -> False)
  -> (forall X2 X1, (v1_funct_1 (k7_diff_1 X1 X2) -> False) -> v1_funct_1 X1 -> v1_xreal_0 X2 -> m1_subset_1 X1 (k1_zfmisc_1 (k2_zfmisc_1 k1_numbers k1_numbers)) -> False)
  ...
  -> ((k6_real_1 (k1_funct_1 (k1_seqfunc k1_numbers k1_numbers (k7_diff_1 esk3_0 esk2_0) np__1) esk1_0) esk2_0) = (k9_diff_1 esk3_0 (k9_real_1 esk1_0 esk2_0) esk1_0) -> False)
