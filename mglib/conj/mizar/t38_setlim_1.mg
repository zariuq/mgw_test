...
Theorem t38_setlim_1:
 ...
 forall k5_numbers:set,
     (forall X4 X1 X2 X3, ((k3_funct_2 k5_numbers (k1_zfmisc_1 X2) X3 (esk8_4 X1 X2 X3 X4)) = X1 -> False) -> v1_funct_1 X3 -> m1_subset_1 X4 k5_numbers -> r2_hidden X1 (a_3_3_setlim_1 X2 X3 X4) -> v1_funct_2 X3 k5_numbers (k1_zfmisc_1 X2) -> m1_subset_1 X3 (k1_zfmisc_1 (k2_zfmisc_1 k5_numbers (k1_zfmisc_1 X2))) -> False)
  -> (forall X1 X2 X3 X4, (r1_xxreal_0 X1 (esk8_4 X2 X3 X4 X1) -> False) -> v1_funct_1 X4 -> m1_subset_1 X1 k5_numbers -> r2_hidden X2 (a_3_3_setlim_1 X3 X4 X1) -> v1_funct_2 X4 k5_numbers (k1_zfmisc_1 X3) -> m1_subset_1 X4 (k1_zfmisc_1 (k2_zfmisc_1 k5_numbers (k1_zfmisc_1 X3))) -> False)
  -> (forall X4 X1 X2 X3, (m1_subset_1 (esk8_4 X1 X2 X3 X4) k5_numbers -> False) -> v1_funct_1 X3 -> m1_subset_1 X4 k5_numbers -> r2_hidden X1 (a_3_3_setlim_1 X2 X3 X4) -> v1_funct_2 X3 k5_numbers (k1_zfmisc_1 X2) -> m1_subset_1 X3 (k1_zfmisc_1 (k2_zfmisc_1 k5_numbers (k1_zfmisc_1 X2))) -> False)
  -> (forall X1 X5 X4 X3 X2, (r2_hidden X2 (a_3_3_setlim_1 X3 X4 X5) -> False) -> X2 = (k3_funct_2 k5_numbers (k1_zfmisc_1 X3) X4 X1) -> v1_funct_1 X4 -> r1_xxreal_0 X5 X1 -> m1_subset_1 X5 k5_numbers -> m1_subset_1 X1 k5_numbers -> v1_funct_2 X4 k5_numbers (k1_zfmisc_1 X3) -> m1_subset_1 X4 (k1_zfmisc_1 (k2_zfmisc_1 k5_numbers (k1_zfmisc_1 X3))) -> False)
  ...
  -> (forall X4 X2 X3 X1, ((k1_setfam_1 (a_3_3_setlim_1 X2 X3 X4)) = X1 -> False) -> (k3_funct_1 X3) = X1 -> v1_funct_1 X3 -> v3_funct_1 X3 -> m1_subset_1 X4 k5_numbers -> m1_subset_1 X1 (k1_zfmisc_1 X2) -> v1_funct_2 X3 k5_numbers (k1_zfmisc_1 X2) -> m1_subset_1 X3 (k1_zfmisc_1 (k2_zfmisc_1 k5_numbers (k1_zfmisc_1 X2))) -> False)
  -> (forall X1 X2, (m1_subset_1 (k2_setlim_1 X1 X2) (k1_zfmisc_1 (k2_zfmisc_1 k5_numbers (k1_zfmisc_1 X1))) -> False) -> v1_funct_1 X2 -> v1_funct_2 X2 k5_numbers (k1_zfmisc_1 X1) -> m1_subset_1 X2 (k1_zfmisc_1 (k2_zfmisc_1 k5_numbers (k1_zfmisc_1 X1))) -> False)
  -> (forall X1 X2, (v1_funct_2 (k2_setlim_1 X1 X2) k5_numbers (k1_zfmisc_1 X1) -> False) -> v1_funct_1 X2 -> v1_funct_2 X2 k5_numbers (k1_zfmisc_1 X1) -> m1_subset_1 X2 (k1_zfmisc_1 (k2_zfmisc_1 k5_numbers (k1_zfmisc_1 X1))) -> False)
  -> (forall X2 X1, (v1_funct_2 (k1_setlim_1 X1) k5_numbers (k1_zfmisc_1 X2) -> False) -> v1_funct_1 X1 -> v1_funct_2 X1 k5_numbers (k1_zfmisc_1 X2) -> m1_subset_1 X1 (k1_zfmisc_1 (k2_zfmisc_1 k5_numbers (k1_zfmisc_1 X2))) -> False)
  -> (forall X4 X2 X3 X1, (v1_relat_1 (k9_xtuple_0 X1) -> False) -> m1_subset_1 X1 (k1_zfmisc_1 (k2_zfmisc_1 (k2_zfmisc_1 X2 X3) X4)) -> False)
  -> (forall X1 X2, (v1_funct_1 (k2_setlim_1 X1 X2) -> False) -> v1_funct_1 X2 -> v1_funct_2 X2 k5_numbers (k1_zfmisc_1 X1) -> m1_subset_1 X2 (k1_zfmisc_1 (k2_zfmisc_1 k5_numbers (k1_zfmisc_1 X1))) -> False)
  -> (forall X2 X1, ((k2_setlim_1 X2 X1) = (k1_setlim_1 X1) -> False) -> v1_funct_1 X1 -> v1_funct_2 X1 k5_numbers (k1_zfmisc_1 X2) -> m1_subset_1 X1 (k1_zfmisc_1 (k2_zfmisc_1 k5_numbers (k1_zfmisc_1 X2))) -> False)
  -> (forall X2 X1, (v3_prob_1 (k1_setlim_1 X1) -> False) -> v1_funct_1 X1 -> v1_funct_2 X1 k5_numbers (k1_zfmisc_1 X2) -> m1_subset_1 X1 (k1_zfmisc_1 (k2_zfmisc_1 k5_numbers (k1_zfmisc_1 X2))) -> False)
  -> (forall X2 X1, (v1_funct_1 (k1_setlim_1 X1) -> False) -> v1_funct_1 X1 -> v1_funct_2 X1 k5_numbers (k1_zfmisc_1 X2) -> m1_subset_1 X1 (k1_zfmisc_1 (k2_zfmisc_1 k5_numbers (k1_zfmisc_1 X2))) -> False)
  -> (forall X2 X1, (X1 = (k1_setlim_1 X2) -> False) -> (k9_xtuple_0 X1) = k5_numbers -> (k1_funct_1 X1 (esk5_2 X2 X1)) = (k1_setfam_1 (a_2_1_setlim_1 X2 (esk5_2 X2 X1))) -> v1_funct_1 X2 -> v1_funct_1 X1 -> v1_relat_1 X2 -> v1_relat_1 X1 -> False)
  ...
  -> (forall X1 X2, (v1_xboole_0 X2 -> False) -> (m1_subset_1 (esk23_2 X1 X2) (k1_zfmisc_1 (k2_zfmisc_1 k5_numbers (k1_zfmisc_1 X1))) -> False) -> m1_subset_1 X2 (k1_zfmisc_1 (k1_zfmisc_1 X1)) -> False)
  ...
  -> (forall X1 X2, (v1_xboole_0 X2 -> False) -> (m1_subset_1 (esk27_2 X1 X2) X2 -> False) -> v1_prob_1 X2 X1 -> v4_prob_1 X2 X1 -> m1_subset_1 X2 (k1_zfmisc_1 (k1_zfmisc_1 X1)) -> False)
  -> (forall X1 X2, (v1_xboole_0 X2 -> False) -> (v1_funct_2 (esk23_2 X1 X2) k5_numbers (k1_zfmisc_1 X1) -> False) -> m1_subset_1 X2 (k1_zfmisc_1 (k1_zfmisc_1 X1)) -> False)
  -> (forall X1 X2, (v1_xboole_0 X2 -> False) -> (v1_xboole_0 (esk27_2 X1 X2) -> False) -> v1_prob_1 X2 X1 -> v4_prob_1 X2 X1 -> m1_subset_1 X2 (k1_zfmisc_1 (k1_zfmisc_1 X1)) -> False)
  ...
  -> (forall X2 X1, (v1_xboole_0 X1 -> False) -> (v2_finsub_1 X1 -> False) -> v1_prob_1 X1 X2 -> v4_prob_1 X1 X2 -> m1_subset_1 X1 (k1_zfmisc_1 (k1_zfmisc_1 X2)) -> False)
  -> (forall X1 X2, (v1_xboole_0 X2 -> False) -> (v5_relat_1 (esk23_2 X1 X2) (k1_zfmisc_1 X1) -> False) -> m1_subset_1 X2 (k1_zfmisc_1 (k1_zfmisc_1 X1)) -> False)
  ...
  -> (forall X1 X2, (v1_xboole_0 X2 -> False) -> (v5_relat_1 (esk23_2 X1 X2) X2 -> False) -> m1_subset_1 X2 (k1_zfmisc_1 (k1_zfmisc_1 X1)) -> False)
  -> (forall X1 X2, (v1_xboole_0 X2 -> False) -> (v4_relat_1 (esk23_2 X1 X2) k5_numbers -> False) -> m1_subset_1 X2 (k1_zfmisc_1 (k1_zfmisc_1 X1)) -> False)
  -> (forall X1 X2, (v1_xboole_0 X2 -> False) -> (v1_relat_1 (esk23_2 X1 X2) -> False) -> m1_subset_1 X2 (k1_zfmisc_1 (k1_zfmisc_1 X1)) -> False)
  -> (forall X1 X2, (v1_xboole_0 X2 -> False) -> (v1_funct_1 (esk23_2 X1 X2) -> False) -> m1_subset_1 X2 (k1_zfmisc_1 (k1_zfmisc_1 X1)) -> False)
  -> (forall X1 X2, (X2 = (k1_setlim_1 X1) -> False) -> (m1_subset_1 (esk5_2 X1 X2) k5_numbers -> False) -> (k9_xtuple_0 X2) = k5_numbers -> v1_funct_1 X2 -> v1_funct_1 X1 -> v1_relat_1 X2 -> v1_relat_1 X1 -> False)
  ...
  -> ((k3_funct_2 k5_numbers (k1_zfmisc_1 esk1_0) (k2_setlim_1 esk1_0 esk3_0) esk4_0) = esk2_0 -> False)
  ...
  -> (forall X1, (m1_subset_1 (esk18_1 X1) (k1_zfmisc_1 (k1_zfmisc_1 X1)) -> False) -> False)
  -> (forall X1, (m1_subset_1 (esk11_1 X1) (k1_zfmisc_1 (k1_zfmisc_1 X1)) -> False) -> False)
  ...
  -> (forall X1, (v4_prob_1 (k1_zfmisc_1 X1) X1 -> False) -> False)
  -> (forall X1, (v1_prob_1 (esk18_1 X1) X1 -> False) -> False)
  -> (forall X1, (v1_prob_1 (esk11_1 X1) X1 -> False) -> False)
  -> (forall X1, (v1_prob_1 (k1_zfmisc_1 X1) X1 -> False) -> False)
  ...
  -> (forall X1, (v2_finsub_1 (k1_zfmisc_1 X1) -> False) -> False)
  ...
  -> ((v3_funct_1 esk3_0 -> False) -> False)
  -> ((v1_funct_1 esk3_0 -> False) -> False)
  -> (((k3_funct_1 esk3_0) = esk2_0 -> False) -> False)
