...
Theorem t164_xxreal_1:
 ...
 forall k2_xboole_0:set -> set -> set,
  ...
  -> (forall X2 X1 X3, v1_xxreal_0 X3 -> v1_xxreal_0 X2 -> r2_hidden X1 (a_2_2_xxreal_1 X2 X3) -> r1_xxreal_0 (esk9_3 X1 X2 X3) X2 -> False)
  -> (forall X2 X1 X3, (r1_xxreal_0 (esk9_3 X1 X2 X3) X3 -> False) -> v1_xxreal_0 X3 -> v1_xxreal_0 X2 -> r2_hidden X1 (a_2_2_xxreal_1 X2 X3) -> False)
  -> (forall X2 X1 X3, (m1_subset_1 (esk9_3 X1 X2 X3) k7_numbers -> False) -> v1_xxreal_0 X3 -> v1_xxreal_0 X2 -> r2_hidden X1 (a_2_2_xxreal_1 X2 X3) -> False)
  -> (forall X1 X2, (X1 = X2 -> False) -> v2_membered X2 -> v2_membered X1 -> r2_hidden (esk5_2 X1 X2) X2 -> r2_hidden (esk5_2 X1 X2) X1 -> False)
  -> (forall X2 X1 X3, ((esk9_3 X1 X2 X3) = X1 -> False) -> v1_xxreal_0 X3 -> v1_xxreal_0 X2 -> r2_hidden X1 (a_2_2_xxreal_1 X2 X3) -> False)
  -> (forall X2 X4 X1 X3, (r1_xxreal_0 X1 X3 -> False) -> (r2_hidden X2 (a_2_2_xxreal_1 X3 X4) -> False) -> X1 = X2 -> v1_xxreal_0 X4 -> v1_xxreal_0 X3 -> r1_xxreal_0 X1 X4 -> m1_subset_1 X1 k7_numbers -> False)
  -> (forall X1 X2 X3, (r1_xxreal_0 X2 X3 -> False) -> (r1_xxreal_0 X2 X1 -> False) -> v1_xxreal_0 X3 -> v1_xxreal_0 X2 -> v1_xxreal_0 X1 -> r1_xxreal_0 X2 (k4_xxreal_0 X1 X3) -> False)
  -> (forall X1 X3 X2, r2_hidden X3 X2 -> r2_hidden X1 X2 -> r2_hidden X1 (esk23_2 X3 X2) -> False)
  -> (forall X2 X1 X3, v1_xxreal_0 X3 -> v1_xxreal_0 X2 -> v1_xxreal_0 X1 -> r1_xxreal_0 X1 X2 -> r2_hidden X1 (k3_xxreal_1 X2 X3) -> False)
  -> (forall X2 X1 X3, (r1_xxreal_0 X1 (k3_xxreal_0 X2 X3) -> False) -> v1_xxreal_0 X3 -> v1_xxreal_0 X2 -> v1_xxreal_0 X1 -> r1_xxreal_0 X1 X3 -> r1_xxreal_0 X1 X2 -> False)
  -> (forall X3 X1 X2, (r1_xxreal_0 X1 X2 -> False) -> v1_xxreal_0 X3 -> v1_xxreal_0 X2 -> v1_xxreal_0 X1 -> r1_xxreal_0 X1 (k3_xxreal_0 X2 X3) -> False)
  -> (forall X3 X1 X2, (r1_xxreal_0 X1 X2 -> False) -> v1_xxreal_0 X3 -> v1_xxreal_0 X2 -> v1_xxreal_0 X1 -> r2_hidden X1 (k3_xxreal_1 X3 X2) -> False)
  -> (forall X3 X1 X2, (r1_xxreal_0 X1 X2 -> False) -> (r2_hidden X1 (k3_xxreal_1 X2 X3) -> False) -> v1_xxreal_0 X3 -> v1_xxreal_0 X2 -> v1_xxreal_0 X1 -> r1_xxreal_0 X1 X3 -> False)
  ...
  -> (forall X2 X1 X3, (r1_xxreal_0 X3 (k4_xxreal_0 X1 X2) -> False) -> v1_xxreal_0 X3 -> v1_xxreal_0 X2 -> v1_xxreal_0 X1 -> r1_xxreal_0 X3 X1 -> False)
  ...
  -> (forall X2 X1, (v2_membered (k3_xxreal_1 X1 X2) -> False) -> v1_xxreal_0 X2 -> v1_xxreal_0 X1 -> False)
  ...
  -> (forall X2 X1, ((a_2_2_xxreal_1 X1 X2) = (k3_xxreal_1 X1 X2) -> False) -> v1_xxreal_0 X2 -> v1_xxreal_0 X1 -> False)
  ...
  -> (forall X1, (v1_xboole_0 (k3_xxreal_1 X1 X1) -> False) -> v1_xxreal_0 X1 -> False)
  ...
  -> ((k3_xxreal_1 (k3_xxreal_0 esk1_0 esk3_0) (k4_xxreal_0 esk2_0 esk4_0)) = (k2_xboole_0 (k3_xxreal_1 esk1_0 esk2_0) (k3_xxreal_1 esk3_0 esk4_0)) -> False)
  -> (r1_xboole_0 (k3_xxreal_1 esk1_0 esk2_0) (k3_xxreal_1 esk3_0 esk4_0) -> False)
