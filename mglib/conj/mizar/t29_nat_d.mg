...
Theorem t29_nat_d:
 ...
 forall k3_int_2:set -> set -> set,
  ...
  -> (forall X2 X1 X3, (X1 = (k2_int_2 X2 X3) -> False) -> v7_ordinal1 X3 -> v7_ordinal1 X2 -> v7_ordinal1 X1 -> r1_nat_d X3 X1 -> r1_nat_d X2 X1 -> r1_nat_d X1 (esk4_3 X2 X3 X1) -> False)
  ...
  -> (forall X2 X1 X3, (X3 = (k2_int_2 X1 X2) -> False) -> (r1_nat_d X1 (esk4_3 X1 X2 X3) -> False) -> v7_ordinal1 X3 -> v7_ordinal1 X2 -> v7_ordinal1 X1 -> r1_nat_d X2 X3 -> r1_nat_d X1 X3 -> False)
  -> (forall X2 X1 X3, (X3 = (k2_int_2 X2 X1) -> False) -> (r1_nat_d X1 (esk4_3 X2 X1 X3) -> False) -> v7_ordinal1 X3 -> v7_ordinal1 X2 -> v7_ordinal1 X1 -> r1_nat_d X2 X3 -> r1_nat_d X1 X3 -> False)
  ...
  -> (forall X2 X1 X3, (X3 = (k2_int_2 X1 X2) -> False) -> (v7_ordinal1 (esk4_3 X1 X2 X3) -> False) -> v7_ordinal1 X3 -> v7_ordinal1 X2 -> v7_ordinal1 X1 -> r1_nat_d X2 X3 -> r1_nat_d X1 X3 -> False)
  ...
  -> (forall X3 X2 X4 X1, (r1_nat_d X4 X1 -> False) -> X4 = (k2_int_2 X2 X3) -> v7_ordinal1 X4 -> v7_ordinal1 X3 -> v7_ordinal1 X2 -> v7_ordinal1 X1 -> r1_nat_d X3 X1 -> r1_nat_d X2 X1 -> False)
  ...
  -> (forall X1 X2, ((k3_xcmplx_0 X2 (esk3_2 X2 X1)) = X1 -> False) -> v7_ordinal1 X2 -> v7_ordinal1 X1 -> r1_nat_d X2 X1 -> False)
  ...
  -> (forall X1 X2, (v7_ordinal1 (esk3_2 X1 X2) -> False) -> v7_ordinal1 X2 -> v7_ordinal1 X1 -> r1_nat_d X1 X2 -> False)
  ...
  -> (forall X3 X1 X2, (r1_nat_d X1 X2 -> False) -> X2 = (k2_int_2 X1 X3) -> v7_ordinal1 X3 -> v7_ordinal1 X2 -> v7_ordinal1 X1 -> False)
  -> (forall X3 X1 X2, (r1_nat_d X1 X2 -> False) -> X2 = (k2_int_2 X3 X1) -> v7_ordinal1 X3 -> v7_ordinal1 X2 -> v7_ordinal1 X1 -> False)
  ...
  -> (forall X2 X1, (m1_subset_1 (k5_nat_d X1 X2) k5_numbers -> False) -> v7_ordinal1 X2 -> v7_ordinal1 X1 -> False)
  ...
  -> (forall X2 X1, (v7_ordinal1 (k2_int_2 X1 X2) -> False) -> v1_int_1 X2 -> v1_int_1 X1 -> False)
  ...
  -> (forall X2 X1, ((k2_int_2 X1 X2) = (k2_int_2 X2 X1) -> False) -> v1_int_1 X2 -> v1_int_1 X1 -> False)
  -> (forall X2 X1, ((k2_int_2 X1 X2) = (k5_nat_d X1 X2) -> False) -> v7_ordinal1 X2 -> v7_ordinal1 X1 -> False)
  -> (forall X2 X1, ((k6_nat_d X1 X2) = (k6_nat_d X2 X1) -> False) -> v7_ordinal1 X2 -> v7_ordinal1 X1 -> False)
  -> (forall X2 X1, ((k5_nat_d X1 X2) = (k5_nat_d X2 X1) -> False) -> v7_ordinal1 X2 -> v7_ordinal1 X1 -> False)
  -> (forall X2 X1, ((k3_xcmplx_0 X1 X2) = (k3_xcmplx_0 X2 X1) -> False) -> v1_xcmplx_0 X2 -> v1_xcmplx_0 X1 -> False)
  -> (forall X1 X2, (v1_xboole_0 X2 -> False) -> (r2_hidden X1 X2 -> False) -> m1_subset_1 X1 X2 -> False)
  -> (forall X1 X2, (X2 = k6_numbers -> False) -> (X1 = k6_numbers -> False) -> (k2_int_2 X1 X2) = k6_numbers -> v1_int_1 X2 -> v1_int_1 X1 -> False)
  -> (forall X2 X1, (m1_subset_1 X1 X2 -> False) -> r2_hidden X1 X2 -> False)
  -> (forall X1 X2, (v3_ordinal1 X2 -> False) -> v3_ordinal1 X1 -> m1_subset_1 X2 X1 -> False)
  -> (forall X2 X1, ((k2_int_2 X1 X2) = k6_numbers -> False) -> X1 = k6_numbers -> v1_int_1 X2 -> v1_int_1 X1 -> False)
  -> (forall X2 X1, ((k2_int_2 X2 X1) = k6_numbers -> False) -> X1 = k6_numbers -> v1_int_1 X2 -> v1_int_1 X1 -> False)
  ...
  -> ((k4_nat_1 (k5_nat_d esk1_0 esk2_0) (k6_nat_d esk1_0 esk2_0)) = (k3_xcmplx_0 esk1_0 esk2_0) -> False)
