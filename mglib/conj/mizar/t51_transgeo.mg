...
Theorem t51_transgeo:
 ...
 forall v5_transgeo:set -> set -> prop,
 forall v1_funct_1:set -> prop,
 forall v2_analoaf:set -> prop,
 forall r3_diraf:set -> set -> set -> set -> prop,
 forall u1_struct_0:set -> set,
 forall k3_funct_2:set -> set -> set -> set -> set,
     (forall X2 X4 X1 X3 X5, ((k3_funct_2 (u1_struct_0 X1) (u1_struct_0 X1) X4 X3) = (k3_funct_2 (u1_struct_0 X1) (u1_struct_0 X1) X5 X3) -> False) -> (v7_struct_0 X1 -> False) -> (r3_diraf X1 X2 (k3_funct_2 (u1_struct_0 X1) (u1_struct_0 X1) X4 X2) X3 -> False) -> (k3_funct_2 (u1_struct_0 X1) (u1_struct_0 X1) X4 X2) = (k3_funct_2 (u1_struct_0 X1) (u1_struct_0 X1) X5 X2) -> v2_analoaf X1 -> l1_analoaf X1 -> v1_funct_1 X5 -> v1_funct_1 X4 -> v5_transgeo X5 X1 -> v5_transgeo X4 X1 -> m1_subset_1 X3 (u1_struct_0 X1) -> m1_subset_1 X2 (u1_struct_0 X1) -> v1_funct_2 X5 (u1_struct_0 X1) (u1_struct_0 X1) -> v1_funct_2 X4 (u1_struct_0 X1) (u1_struct_0 X1) -> v3_funct_2 X5 (u1_struct_0 X1) (u1_struct_0 X1) -> v3_funct_2 X4 (u1_struct_0 X1) (u1_struct_0 X1) -> m1_subset_1 X5 (k1_zfmisc_1 (k2_zfmisc_1 (u1_struct_0 X1) (u1_struct_0 X1))) -> m1_subset_1 X4 (k1_zfmisc_1 (k2_zfmisc_1 (u1_struct_0 X1) (u1_struct_0 X1))) -> False)
  ...
  -> (forall X2 X3 X1, (v7_struct_0 X1 -> False) -> (r2_funct_2 (u1_struct_0 X1) (u1_struct_0 X1) X2 (k6_partfun1 (u1_struct_0 X1)) -> False) -> (k3_funct_2 (u1_struct_0 X1) (u1_struct_0 X1) X2 X3) = X3 -> v2_analoaf X1 -> l1_analoaf X1 -> v1_funct_1 X2 -> v5_transgeo X2 X1 -> m1_subset_1 X3 (u1_struct_0 X1) -> v1_funct_2 X2 (u1_struct_0 X1) (u1_struct_0 X1) -> v3_funct_2 X2 (u1_struct_0 X1) (u1_struct_0 X1) -> m1_subset_1 X2 (k1_zfmisc_1 (k2_zfmisc_1 (u1_struct_0 X1) (u1_struct_0 X1))) -> False)
  ...
  -> (forall X2 X1, (v7_struct_0 X1 -> False) -> (v5_transgeo X2 X1 -> False) -> v2_analoaf X1 -> l1_analoaf X1 -> v1_funct_1 X2 -> v4_transgeo X2 X1 -> v1_funct_2 X2 (u1_struct_0 X1) (u1_struct_0 X1) -> v3_funct_2 X2 (u1_struct_0 X1) (u1_struct_0 X1) -> m1_subset_1 X2 (k1_zfmisc_1 (k2_zfmisc_1 (u1_struct_0 X1) (u1_struct_0 X1))) -> r2_funct_2 (u1_struct_0 X1) (u1_struct_0 X1) X2 (k6_partfun1 (u1_struct_0 X1)) -> False)
  ...
  -> (forall X1 X2 X3, (X2 = X3 -> False) -> (v7_struct_0 X1 -> False) -> v2_analoaf X1 -> l1_analoaf X1 -> m1_subset_1 X3 (u1_struct_0 X1) -> m1_subset_1 X2 (u1_struct_0 X1) -> r3_diraf X1 X2 X3 (esk25_3 X1 X2 X3) -> False)
  ...
  -> (forall X2 X1, (v7_struct_0 X1 -> False) -> (v5_transgeo X2 X1 -> False) -> (m1_subset_1 (esk5_2 X1 X2) (u1_struct_0 X1) -> False) -> v2_analoaf X1 -> l1_analoaf X1 -> v1_funct_1 X2 -> v4_transgeo X2 X1 -> v1_funct_2 X2 (u1_struct_0 X1) (u1_struct_0 X1) -> v3_funct_2 X2 (u1_struct_0 X1) (u1_struct_0 X1) -> m1_subset_1 X2 (k1_zfmisc_1 (k2_zfmisc_1 (u1_struct_0 X1) (u1_struct_0 X1))) -> False)
  ...
  -> (forall X1 X2, (v7_struct_0 X2 -> False) -> (v4_transgeo X1 X2 -> False) -> v2_analoaf X2 -> l1_analoaf X2 -> v1_funct_1 X1 -> v5_transgeo X1 X2 -> v1_funct_2 X1 (u1_struct_0 X2) (u1_struct_0 X2) -> v3_funct_2 X1 (u1_struct_0 X2) (u1_struct_0 X2) -> m1_subset_1 X1 (k1_zfmisc_1 (k2_zfmisc_1 (u1_struct_0 X2) (u1_struct_0 X2))) -> False)
  ...
  -> (forall X1 X2 X3, (X2 = X3 -> False) -> (v7_struct_0 X1 -> False) -> (m1_subset_1 (esk25_3 X1 X2 X3) (u1_struct_0 X1) -> False) -> v2_analoaf X1 -> l1_analoaf X1 -> m1_subset_1 X3 (u1_struct_0 X1) -> m1_subset_1 X2 (u1_struct_0 X1) -> False)
  ...
  -> ((v5_transgeo esk4_0 esk1_0 -> False) -> False)
  -> ((v5_transgeo esk3_0 esk1_0 -> False) -> False)
