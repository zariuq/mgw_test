...
Theorem t13_pre_ff:
 ...
 forall k6_numbers:set,
     (forall X1, (r1_xxreal_0 X1 k6_numbers -> False) -> (r1_xxreal_0 (k1_int_1 (k6_power np__2 (k2_nat_1 (k4_nat_1 np__2 X1) np__1))) (k2_xcmplx_0 (k1_int_1 (k6_power np__2 (k4_nat_1 np__2 X1))) np__1) -> False) -> v7_ordinal1 X1 -> False)
  -> (forall X1, (r1_xxreal_0 X1 k6_numbers -> False) -> (k1_int_1 (k6_power np__2 (k2_nat_1 (k4_nat_1 np__2 X1) np__1))) = (k2_xcmplx_0 (k1_int_1 (k6_power np__2 (k4_nat_1 np__2 X1))) np__1) -> v7_ordinal1 X1 -> False)
  ...
  -> (forall X1 X3 X2, (r1_xxreal_0 X2 k6_numbers -> False) -> (r1_xxreal_0 X1 np__1 -> False) -> (r1_xxreal_0 (k5_power X1 X2) (k5_power X1 X3) -> False) -> v1_xreal_0 X3 -> v1_xreal_0 X2 -> v1_xreal_0 X1 -> r1_xxreal_0 X2 X3 -> False)
  ...
  -> (forall X1 X2, (r1_xxreal_0 (k1_int_1 X2) (k1_int_1 X1) -> False) -> v1_xreal_0 X2 -> v1_xreal_0 X1 -> r1_xxreal_0 X2 X1 -> False)
  ...
  -> ((k1_int_1 (k6_power np__2 (k2_nat_1 (k4_nat_1 np__2 esk1_0) np__1))) = (k1_int_1 (k6_power np__2 (k4_nat_1 np__2 esk1_0))) -> False)
  ...
  -> ((v3_finseq_1 esk28_0 -> False) -> False)
