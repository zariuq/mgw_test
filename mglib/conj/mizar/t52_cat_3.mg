...
Theorem t52_cat_3:
 ...
 forall esk4_6:set -> set -> set -> set -> set -> set -> set,
     (forall X6 X2 X7 X5 X4 X3 X1, ((esk4_6 X1 X4 X5 X3 X6 X7) = X2 -> False) -> (v2_struct_0 X1 -> False) -> (v11_struct_0 X1 -> False) -> (k1_cat_1 X1 X2 (k7_partfun1 (u4_struct_0 X1) X3 (esk5_7 X1 X4 X5 X3 X6 X7 X2))) = (k7_partfun1 (u4_struct_0 X1) X7 (esk5_7 X1 X4 X5 X3 X6 X7 X2)) -> v2_cat_1 X1 -> v3_cat_1 X1 -> v4_cat_1 X1 -> v5_cat_1 X1 -> v6_cat_1 X1 -> l1_cat_1 X1 -> v1_funct_1 X3 -> m1_subset_1 X6 (u1_struct_0 X1) -> m1_subset_1 X4 (u1_struct_0 X1) -> m1_subset_1 X2 (u4_struct_0 X1) -> r1_cat_3 X1 X4 X5 X3 -> m1_cat_3 X7 X1 X6 X5 -> v1_funct_2 X3 X5 (u4_struct_0 X1) -> r2_hidden X2 (k2_cat_1 X1 X6 X4) -> m1_subset_1 X3 (k1_zfmisc_1 (k2_zfmisc_1 X5 (u4_struct_0 X1))) -> r2_funct_2 X5 (u1_struct_0 X1) (k3_cat_3 X1 X5 X3) (k3_cat_3 X1 X5 X7) -> False)
  -> (forall X7 X2 X6 X3 X5 X4 X1, ((esk4_6 X1 X2 X3 X4 X5 X6) = X7 -> False) -> (v2_struct_0 X1 -> False) -> (v11_struct_0 X1 -> False) -> (r2_hidden (esk5_7 X1 X2 X3 X4 X5 X6 X7) X3 -> False) -> v2_cat_1 X1 -> v3_cat_1 X1 -> v4_cat_1 X1 -> v5_cat_1 X1 -> v6_cat_1 X1 -> l1_cat_1 X1 -> v1_funct_1 X4 -> m1_subset_1 X7 (u4_struct_0 X1) -> m1_subset_1 X5 (u1_struct_0 X1) -> m1_subset_1 X2 (u1_struct_0 X1) -> r1_cat_3 X1 X2 X3 X4 -> m1_cat_3 X6 X1 X5 X3 -> v1_funct_2 X4 X3 (u4_struct_0 X1) -> r2_hidden X7 (k2_cat_1 X1 X5 X2) -> m1_subset_1 X4 (k1_zfmisc_1 (k2_zfmisc_1 X3 (u4_struct_0 X1))) -> r2_funct_2 X3 (u1_struct_0 X1) (k3_cat_3 X1 X3 X4) (k3_cat_3 X1 X3 X6) -> False)
  -> (forall X5 X2 X3 X4 X1, (v2_struct_0 X1 -> False) -> (v11_struct_0 X1 -> False) -> (r1_cat_3 X1 X2 X3 X4 -> False) -> (esk8_5 X1 X2 X3 X4 X5) = X5 -> (k1_cat_1 X1 (esk8_5 X1 X2 X3 X4 X5) (k7_partfun1 (u4_struct_0 X1) X4 (esk9_5 X1 X2 X3 X4 X5))) = (k7_partfun1 (u4_struct_0 X1) (esk7_4 X1 X2 X3 X4) (esk9_5 X1 X2 X3 X4 X5)) -> v2_cat_1 X1 -> v3_cat_1 X1 -> v4_cat_1 X1 -> v5_cat_1 X1 -> v6_cat_1 X1 -> l1_cat_1 X1 -> v1_funct_1 X4 -> m1_subset_1 X5 (u4_struct_0 X1) -> m1_subset_1 X2 (u1_struct_0 X1) -> m1_cat_3 X4 X1 X2 X3 -> v1_funct_2 X4 X3 (u4_struct_0 X1) -> m1_subset_1 X4 (k1_zfmisc_1 (k2_zfmisc_1 X3 (u4_struct_0 X1))) -> r2_hidden X5 (k2_cat_1 X1 (esk6_4 X1 X2 X3 X4) X2) -> False)
  -> (forall X5 X3 X6 X2 X4 X1, (v2_struct_0 X1 -> False) -> (v11_struct_0 X1 -> False) -> (r2_hidden (esk4_6 X1 X2 X3 X4 X5 X6) (k2_cat_1 X1 X5 X2) -> False) -> v2_cat_1 X1 -> v3_cat_1 X1 -> v4_cat_1 X1 -> v5_cat_1 X1 -> v6_cat_1 X1 -> l1_cat_1 X1 -> v1_funct_1 X4 -> m1_subset_1 X5 (u1_struct_0 X1) -> m1_subset_1 X2 (u1_struct_0 X1) -> r1_cat_3 X1 X2 X3 X4 -> m1_cat_3 X6 X1 X5 X3 -> v1_funct_2 X4 X3 (u4_struct_0 X1) -> m1_subset_1 X4 (k1_zfmisc_1 (k2_zfmisc_1 X3 (u4_struct_0 X1))) -> r2_funct_2 X3 (u1_struct_0 X1) (k3_cat_3 X1 X3 X4) (k3_cat_3 X1 X3 X6) -> False)
  ...
  -> (forall X4 X3 X2 X1, (v2_struct_0 X1 -> False) -> (v11_struct_0 X1 -> False) -> (m1_cat_3 (k1_cat_3 (u4_struct_0 X1) X4 X3) X1 X2 (k1_tarski X4) -> False) -> (k3_graph_1 X1 X3) = X2 -> v2_cat_1 X1 -> v3_cat_1 X1 -> v4_cat_1 X1 -> v5_cat_1 X1 -> v6_cat_1 X1 -> l1_cat_1 X1 -> m1_subset_1 X3 (u4_struct_0 X1) -> m1_subset_1 X2 (u1_struct_0 X1) -> False)
  ...
  -> (forall X3 X2 X1, (v2_struct_0 X1 -> False) -> (v11_struct_0 X1 -> False) -> (m1_cat_3 (esk17_3 X1 X2 X3) X1 X2 X3 -> False) -> v2_cat_1 X1 -> v3_cat_1 X1 -> v4_cat_1 X1 -> v5_cat_1 X1 -> v6_cat_1 X1 -> l1_cat_1 X1 -> m1_subset_1 X2 (u1_struct_0 X1) -> False)
  ...
  -> (forall X2 X1, (X2 = (k1_tarski X1) -> False) -> (esk10_2 X1 X2) = X1 -> r2_hidden (esk10_2 X1 X2) X2 -> False)
  ...
  -> (forall X2 X1, (X2 = (k1_tarski X1) -> False) -> ((esk10_2 X1 X2) = X1 -> False) -> (r2_hidden (esk10_2 X1 X2) X2 -> False) -> False)
  ...
  -> (r1_cat_3 esk2_0 esk3_0 (k1_tarski esk1_0) (k1_cat_3 (u4_struct_0 esk2_0) esk1_0 (k4_cat_1 esk2_0 esk3_0)) -> False)
