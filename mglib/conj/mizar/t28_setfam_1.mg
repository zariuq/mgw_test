...
Theorem t28_setfam_1:
 ...
 forall r2_hidden:set -> set -> prop,
  ...
  -> (forall X3 X2 X1, (X2 = (k3_tarski X1) -> False) -> r2_hidden X3 X1 -> r2_hidden (esk5_2 X1 X2) X3 -> r2_hidden (esk5_2 X1 X2) X2 -> False)
  -> (forall X1 X2 X3, (r2_hidden (esk4_3 X1 X2 X3) X1 -> False) -> X2 = (k3_tarski X1) -> r2_hidden X3 X2 -> False)
  -> (forall X2 X3 X1, (r2_hidden X1 (esk4_3 X2 X3 X1) -> False) -> X3 = (k3_tarski X2) -> r2_hidden X1 X3 -> False)
  -> (forall X1 X2, (X2 = (k3_tarski X1) -> False) -> (r2_hidden (esk5_2 X1 X2) X2 -> False) -> (r2_hidden (esk5_2 X1 X2) (esk6_2 X1 X2) -> False) -> False)
  ...
  -> (forall X1 X2, (X2 = (k3_tarski X1) -> False) -> (r2_hidden (esk5_2 X1 X2) X2 -> False) -> (r2_hidden (esk6_2 X1 X2) X1 -> False) -> False)
  ...
  -> ((k3_tarski (k3_setfam_1 esk1_0 esk2_0)) = (k3_xboole_0 (k3_tarski esk1_0) (k3_tarski esk2_0)) -> False)
