...
Theorem t34_ordinal2:
 ...
 forall k1_xboole_0:set,
     (forall X1 X3 X2, (X2 = k1_xboole_0 -> False) -> ((k10_ordinal2 X3 X2) = (k4_ordinal2 X1) -> False) -> (k9_xtuple_0 X1) = X2 -> (k1_funct_1 X1 (esk32_3 X2 X3 X1)) = (k10_ordinal2 X3 (esk32_3 X2 X3 X1)) -> v3_ordinal1 X3 -> v3_ordinal1 X2 -> v1_funct_1 X1 -> v1_relat_1 X1 -> v5_ordinal1 X1 -> v1_ordinal2 X1 -> v4_ordinal1 X2 -> False)
  -> (forall X2 X1 X3, (r1_ordinal1 (k10_ordinal2 X1 X3) (k10_ordinal2 X2 X3) -> False) -> v3_ordinal1 X3 -> v3_ordinal1 X2 -> v3_ordinal1 X1 -> r1_ordinal1 (k10_ordinal2 X1 (esk28_2 X1 X2)) (k10_ordinal2 X2 (esk28_2 X1 X2)) -> False)
  -> (forall X1 X2 X4 X3, (r1_ordinal1 (k10_ordinal2 X2 X4) (k10_ordinal2 X3 X4) -> False) -> (r1_ordinal1 (k10_ordinal2 X2 X1) (k10_ordinal2 X3 X1) -> False) -> v3_ordinal1 X4 -> v3_ordinal1 X3 -> v3_ordinal1 X2 -> v3_ordinal1 X1 -> r2_hidden X1 (esk28_2 X2 X3) -> False)
  -> (forall X3 X2 X1, (X1 = k1_xboole_0 -> False) -> ((k10_ordinal2 X2 X1) = (k4_ordinal2 X3) -> False) -> (r2_hidden (esk32_3 X1 X2 X3) X1 -> False) -> (k9_xtuple_0 X3) = X1 -> v3_ordinal1 X2 -> v3_ordinal1 X1 -> v1_funct_1 X3 -> v1_relat_1 X3 -> v5_ordinal1 X3 -> v1_ordinal2 X3 -> v4_ordinal1 X1 -> False)
  -> (forall X3 X2 X1, (X1 = k1_xboole_0 -> False) -> ((k10_ordinal2 X2 X1) = (k4_ordinal2 X3) -> False) -> (v3_ordinal1 (esk32_3 X1 X2 X3) -> False) -> (k9_xtuple_0 X3) = X1 -> v3_ordinal1 X2 -> v3_ordinal1 X1 -> v1_funct_1 X3 -> v1_relat_1 X3 -> v5_ordinal1 X3 -> v1_ordinal2 X3 -> v4_ordinal1 X1 -> False)
  ...
  -> (forall X1 X2, (r1_ordinal1 X1 X2 -> False) -> v3_ordinal1 X2 -> v3_ordinal1 X1 -> r1_ordinal1 (k2_xboole_0 X1 (k1_tarski X1)) (k2_xboole_0 X2 (k1_tarski X2)) -> False)
  ...
  -> (forall X1 X2, (r1_ordinal1 (k2_xboole_0 X1 (k1_tarski X1)) (k2_xboole_0 X2 (k1_tarski X2)) -> False) -> v3_ordinal1 X2 -> v3_ordinal1 X1 -> r1_ordinal1 X1 X2 -> False)
  -> (forall X3 X2 X1, (v3_ordinal1 (esk28_2 X1 X2) -> False) -> (r1_ordinal1 (k10_ordinal2 X1 X3) (k10_ordinal2 X2 X3) -> False) -> v3_ordinal1 X3 -> v3_ordinal1 X2 -> v3_ordinal1 X1 -> False)
  ...
  -> (forall X2 X1 X3, ((k1_funct_1 (esk29_2 X3 X2) X1) = (k10_ordinal2 X3 X1) -> False) -> v3_ordinal1 X3 -> v3_ordinal1 X2 -> v3_ordinal1 X1 -> r2_hidden X1 X2 -> False)
  ...
  -> (forall X2 X1, (r1_ordinal1 (k3_ordinal2 X2) X1 -> False) -> v3_ordinal1 X1 -> r2_hidden (esk30_2 X1 X2) X1 -> False)
  ...
  -> (forall X2 X1, (r1_ordinal1 (k3_ordinal2 X2) X1 -> False) -> (r2_hidden (esk30_2 X1 X2) X2 -> False) -> v3_ordinal1 X1 -> False)
  ...
  -> (forall X2 X1, (v1_xboole_0 X1 -> False) -> (v1_subset_1 X2 X1 -> False) -> v1_xboole_0 X2 -> m1_subset_1 X2 (k1_zfmisc_1 X1) -> False)
  -> (forall X2 X1, (v3_ordinal1 (esk30_2 X1 X2) -> False) -> (r1_ordinal1 (k3_ordinal2 X2) X1 -> False) -> v3_ordinal1 X1 -> False)
  ...
  -> (r1_ordinal1 (k10_ordinal2 esk1_0 esk3_0) (k10_ordinal2 esk2_0 esk3_0) -> False)
