...
Theorem t46_tex_4:
 ...
 forall a_2_14_tex_4:set -> set -> set,
 forall r2_hidden:set -> set -> prop,
 forall v2_pre_topc:set -> prop,
 forall v2_struct_0:set -> prop,
     (forall X3 X1 X2, (v2_struct_0 X2 -> False) -> (m1_subset_1 (esk7_3 X1 X2 X3) (k1_zfmisc_1 (u1_struct_0 X2)) -> False) -> v2_pre_topc X2 -> l1_pre_topc X2 -> m1_subset_1 X3 (u1_struct_0 X2) -> r2_hidden X1 (a_2_14_tex_4 X2 X3) -> False)
  -> (forall X3 X1 X2, (m1_subset_1 (esk8_3 X1 X2 X3) (k1_zfmisc_1 (u1_struct_0 X2)) -> False) -> l1_pre_topc X2 -> m1_subset_1 X3 (u1_struct_0 X2) -> r2_hidden X1 (a_2_4_tex_4 X2 X3) -> False)
  -> (forall X3 X1 X2, (v2_struct_0 X2 -> False) -> (v3_pre_topc (esk7_3 X1 X2 X3) X2 -> False) -> v2_pre_topc X2 -> l1_pre_topc X2 -> m1_subset_1 X3 (u1_struct_0 X2) -> r2_hidden X1 (a_2_14_tex_4 X2 X3) -> False)
  -> (forall X1 X2 X3, (v2_struct_0 X3 -> False) -> (r2_hidden X1 (esk7_3 X2 X3 X1) -> False) -> v2_pre_topc X3 -> l1_pre_topc X3 -> m1_subset_1 X1 (u1_struct_0 X3) -> r2_hidden X2 (a_2_14_tex_4 X3 X1) -> False)
  -> (forall X3 X1 X2, (v1_tex_4 (esk8_3 X1 X2 X3) X2 -> False) -> l1_pre_topc X2 -> m1_subset_1 X3 (u1_struct_0 X2) -> r2_hidden X1 (a_2_4_tex_4 X2 X3) -> False)
  -> (forall X1 X2 X3, (r2_hidden X1 (esk8_3 X2 X3 X1) -> False) -> l1_pre_topc X3 -> m1_subset_1 X1 (u1_struct_0 X3) -> r2_hidden X2 (a_2_4_tex_4 X3 X1) -> False)
  -> (forall X3 X4 X1 X2, (v2_struct_0 X2 -> False) -> (r2_hidden X3 (a_2_14_tex_4 X2 X4) -> False) -> X1 = X3 -> v2_pre_topc X2 -> l1_pre_topc X2 -> r2_hidden X4 X1 -> v3_pre_topc X1 X2 -> m1_subset_1 X4 (u1_struct_0 X2) -> m1_subset_1 X1 (k1_zfmisc_1 (u1_struct_0 X2)) -> False)
  ...
  -> (forall X3 X1 X2, ((esk7_3 X1 X2 X3) = X1 -> False) -> (v2_struct_0 X2 -> False) -> v2_pre_topc X2 -> l1_pre_topc X2 -> m1_subset_1 X3 (u1_struct_0 X2) -> r2_hidden X1 (a_2_14_tex_4 X2 X3) -> False)
  -> (forall X3 X1 X2, ((esk8_3 X1 X2 X3) = X1 -> False) -> l1_pre_topc X2 -> m1_subset_1 X3 (u1_struct_0 X2) -> r2_hidden X1 (a_2_4_tex_4 X2 X3) -> False)
  ...
  -> (forall X1 X2, (X2 = k1_xboole_0 -> False) -> (r1_tarski X1 (k1_setfam_1 X2) -> False) -> r1_tarski X1 (esk37_2 X2 X1) -> False)
  ...
  -> (forall X2 X1, (X1 = k1_xboole_0 -> False) -> (r1_tarski X2 (k1_setfam_1 X1) -> False) -> (r2_hidden (esk37_2 X1 X2) X1 -> False) -> False)
  ...
  -> (forall X1, (v7_struct_0 X1 -> False) -> l1_struct_0 X1 -> v1_subset_1 (esk27_1 X1) (u1_struct_0 X1) -> False)
  ...
  -> (forall X1, (v7_struct_0 X1 -> False) -> (v1_subset_1 (esk29_1 X1) (u1_struct_0 X1) -> False) -> l1_struct_0 X1 -> False)
  -> (forall X1, (v7_struct_0 X1 -> False) -> (v1_subset_1 (esk23_1 X1) (u1_struct_0 X1) -> False) -> l1_struct_0 X1 -> False)
  ...
  -> (forall X1, (v1_zfmisc_1 X1 -> False) -> v1_subset_1 (esk18_1 X1) X1 -> False)
  ...
  -> (forall X1, (v1_zfmisc_1 X1 -> False) -> (m1_subset_1 (esk11_1 X1) (k1_zfmisc_1 X1) -> False) -> False)
  ...
  -> (forall X1, (v7_struct_0 X1 -> False) -> l1_struct_0 X1 -> v1_xboole_0 (esk27_1 X1) -> False)
  ...
  -> (forall X1, (v1_zfmisc_1 X1 -> False) -> (v1_subset_1 (esk11_1 X1) X1 -> False) -> False)
  -> (forall X1, (v1_xboole_0 X1 -> False) -> (v1_subset_1 (esk26_1 X1) X1 -> False) -> False)
  -> (forall X1, (v1_finset_1 (u1_struct_0 X1) -> False) -> l1_struct_0 X1 -> v8_struct_0 X1 -> False)
  -> (forall X1, (v1_zfmisc_1 (u1_struct_0 X1) -> False) -> l1_struct_0 X1 -> v7_struct_0 X1 -> False)
  -> (forall X1, (v1_xboole_0 (u1_struct_0 X1) -> False) -> v2_struct_0 X1 -> l1_struct_0 X1 -> False)
  -> (forall X1, (v7_struct_0 X1 -> False) -> (v1_zfmisc_1 (esk29_1 X1) -> False) -> l1_struct_0 X1 -> False)
  -> (forall X1, (v7_struct_0 X1 -> False) -> (v1_zfmisc_1 (esk23_1 X1) -> False) -> l1_struct_0 X1 -> False)
  ...
  -> (forall X1, (v1_zfmisc_1 X1 -> False) -> v1_xboole_0 (esk18_1 X1) -> False)
  -> (forall X1, (v1_zfmisc_1 X1 -> False) -> v1_xboole_0 (esk11_1 X1) -> False)
  ...
  -> (forall X1, (v1_zfmisc_1 X1 -> False) -> (v1_zfmisc_1 (esk11_1 X1) -> False) -> False)
  ...
  -> (r1_tarski (k2_tex_4 esk1_0 esk2_0) (k1_setfam_1 (a_2_14_tex_4 esk1_0 esk2_0)) -> False)
