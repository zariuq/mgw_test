...
Theorem t46_cfunct_1:
 forall k2_cfunct_1:set -> set -> set,
 forall k1_cfunct_1:set -> set -> set -> set,
 forall esk1_0:set,
 forall k31_valued_1:set -> set -> set -> set,
 forall esk2_0:set,
 forall esk3_0:set,
 forall k6_numbers:set,
 forall k12_complex1:set -> set,
 ...
 forall k25_valued_1:set -> set -> set -> set -> set,
 forall k1_zfmisc_1:set -> set,
 forall k2_zfmisc_1:set -> set -> set,
 forall m1_subset_1:set -> set -> prop,
 forall v1_funct_1:set -> prop,
 forall v1_xboole_0:set -> prop,
     (forall X3 X4 X2 X1, (v1_xboole_0 X1 -> False) -> (r2_relset_1 X1 k2_numbers (k25_valued_1 X1 k2_numbers (k19_valued_1 X1 k2_numbers k2_numbers X2 X3) X4) (k19_valued_1 X1 k2_numbers k2_numbers X2 (k25_valued_1 X1 k2_numbers X3 X4)) -> False) -> v1_funct_1 X3 -> v1_funct_1 X2 -> m1_subset_1 X4 k2_numbers -> m1_subset_1 X3 (k1_zfmisc_1 (k2_zfmisc_1 X1 k2_numbers)) -> m1_subset_1 X2 (k1_zfmisc_1 (k2_zfmisc_1 X1 k2_numbers)) -> False)
  -> (forall X3 X2 X1, (v1_xboole_0 X1 -> False) -> (r2_relset_1 X1 k2_numbers (k1_cfunct_1 X1 X2 X3) (k19_valued_1 X1 k2_numbers k2_numbers X2 (k2_cfunct_1 X1 X3)) -> False) -> v1_funct_1 X3 -> v1_funct_1 X2 -> m1_subset_1 X3 (k1_zfmisc_1 (k2_zfmisc_1 X1 k2_numbers)) -> m1_subset_1 X2 (k1_zfmisc_1 (k2_zfmisc_1 X1 k2_numbers)) -> False)
  ...
  -> (r2_relset_1 esk1_0 k2_numbers (k1_cfunct_1 esk1_0 esk2_0 (k31_valued_1 esk1_0 k2_numbers esk3_0)) (k31_valued_1 esk1_0 k2_numbers (k1_cfunct_1 esk1_0 esk2_0 esk3_0)) -> r2_relset_1 esk1_0 k2_numbers (k31_valued_1 esk1_0 k2_numbers (k1_cfunct_1 esk1_0 esk2_0 esk3_0)) (k1_cfunct_1 esk1_0 (k31_valued_1 esk1_0 k2_numbers esk2_0) esk3_0) -> False)
  -> (forall X3 X4 X2 X1, (v1_xboole_0 X1 -> False) -> (r2_relset_1 X1 k2_numbers (k25_valued_1 X1 k2_numbers (k1_cfunct_1 X1 X2 X3) X4) (k1_cfunct_1 X1 (k25_valued_1 X1 k2_numbers X2 X4) X3) -> False) -> v1_funct_1 X3 -> v1_funct_1 X2 -> m1_subset_1 X4 k2_numbers -> m1_subset_1 X3 (k1_zfmisc_1 (k2_zfmisc_1 X1 k2_numbers)) -> m1_subset_1 X2 (k1_zfmisc_1 (k2_zfmisc_1 X1 k2_numbers)) -> False)
  -> (forall X1 X2 X3, (X3 = k6_numbers -> False) -> (v1_xboole_0 X1 -> False) -> (r2_relset_1 X1 k2_numbers (k2_cfunct_1 X1 (k25_valued_1 X1 k2_numbers X2 X3)) (k25_valued_1 X1 k2_numbers (k2_cfunct_1 X1 X2) (k12_complex1 X3)) -> False) -> v1_funct_1 X2 -> m1_subset_1 X3 k2_numbers -> m1_subset_1 X2 (k1_zfmisc_1 (k2_zfmisc_1 X1 k2_numbers)) -> False)
  ...
  -> (forall X2 X1 X4 X3, (m1_subset_1 (k25_valued_1 X1 X2 X3 X4) (k1_zfmisc_1 (k2_zfmisc_1 X1 k2_numbers)) -> False) -> v1_funct_1 X3 -> v1_membered X2 -> v1_xcmplx_0 X4 -> m1_subset_1 X3 (k1_zfmisc_1 (k2_zfmisc_1 X1 X2)) -> False)
  -> (forall X2 X1 X4 X3, (v1_funct_1 (k25_valued_1 X1 X2 X3 X4) -> False) -> v1_funct_1 X3 -> v1_membered X2 -> v1_xcmplx_0 X4 -> m1_subset_1 X3 (k1_zfmisc_1 (k2_zfmisc_1 X1 X2)) -> False)
  ...
  -> (forall X3 X2 X1, (v1_xboole_0 X1 -> False) -> (m1_subset_1 (k1_cfunct_1 X1 X2 X3) (k1_zfmisc_1 (k2_zfmisc_1 X1 k2_numbers)) -> False) -> v1_funct_1 X3 -> v1_funct_1 X2 -> m1_subset_1 X3 (k1_zfmisc_1 (k2_zfmisc_1 X1 k2_numbers)) -> m1_subset_1 X2 (k1_zfmisc_1 (k2_zfmisc_1 X1 k2_numbers)) -> False)
  -> (forall X1 X3 X4 X2, ((k25_valued_1 X3 X1 X2 X4) = (k24_valued_1 X2 X4) -> False) -> v1_funct_1 X2 -> v1_membered X1 -> v1_xcmplx_0 X4 -> m1_subset_1 X2 (k1_zfmisc_1 (k2_zfmisc_1 X3 X1)) -> False)
  -> (forall X3 X2 X1, (v1_xboole_0 X1 -> False) -> (v1_funct_1 (k1_cfunct_1 X1 X2 X3) -> False) -> v1_funct_1 X3 -> v1_funct_1 X2 -> m1_subset_1 X3 (k1_zfmisc_1 (k2_zfmisc_1 X1 k2_numbers)) -> m1_subset_1 X2 (k1_zfmisc_1 (k2_zfmisc_1 X1 k2_numbers)) -> False)
  -> (forall X2 X1 X3, (m1_subset_1 (k31_valued_1 X1 X2 X3) (k1_zfmisc_1 (k2_zfmisc_1 X1 k2_numbers)) -> False) -> v1_funct_1 X3 -> v1_membered X2 -> m1_subset_1 X3 (k1_zfmisc_1 (k2_zfmisc_1 X1 X2)) -> False)
  -> (forall X1 X3 X2, ((k31_valued_1 X3 X1 (k31_valued_1 X3 X1 X2)) = X2 -> False) -> v1_funct_1 X2 -> v1_membered X1 -> m1_subset_1 X2 (k1_zfmisc_1 (k2_zfmisc_1 X3 X1)) -> False)
  -> (forall X2 X1 X3, (v1_funct_1 (k31_valued_1 X1 X2 X3) -> False) -> v1_funct_1 X3 -> v1_membered X2 -> m1_subset_1 X3 (k1_zfmisc_1 (k2_zfmisc_1 X1 X2)) -> False)
  -> (forall X2 X1, (v1_xboole_0 X1 -> False) -> (m1_subset_1 (k2_cfunct_1 X1 X2) (k1_zfmisc_1 (k2_zfmisc_1 X1 k2_numbers)) -> False) -> v1_funct_1 X2 -> m1_subset_1 X2 (k1_zfmisc_1 (k2_zfmisc_1 X1 k2_numbers)) -> False)
  -> (forall X1 X3 X2, ((k31_valued_1 X3 X1 X2) = (k30_valued_1 X2) -> False) -> v1_funct_1 X2 -> v1_membered X1 -> m1_subset_1 X2 (k1_zfmisc_1 (k2_zfmisc_1 X3 X1)) -> False)
  -> (forall X2 X1, (v1_xboole_0 X1 -> False) -> (v1_funct_1 (k2_cfunct_1 X1 X2) -> False) -> v1_funct_1 X2 -> m1_subset_1 X2 (k1_zfmisc_1 (k2_zfmisc_1 X1 k2_numbers)) -> False)
  ...
  -> (forall X1, (m1_subset_1 (k12_complex1 X1) k2_numbers -> False) -> m1_subset_1 X1 k2_numbers -> False)
  ...
  -> (forall X1, ((k12_complex1 (k12_complex1 X1)) = X1 -> False) -> m1_subset_1 X1 k2_numbers -> False)
  -> (forall X1, ((k10_complex1 (k10_complex1 X1)) = X1 -> False) -> m1_subset_1 X1 k2_numbers -> False)
  -> (forall X1 X2, v1_xboole_0 X2 -> r2_hidden X1 X2 -> False)
  -> (forall X1, ((k5_xcmplx_0 X1) = (k12_complex1 X1) -> False) -> m1_subset_1 X1 k2_numbers -> False)
  ...
  -> (((k12_complex1 (k10_complex1 k6_complex1)) = (k10_complex1 k6_complex1) -> False) -> False)
