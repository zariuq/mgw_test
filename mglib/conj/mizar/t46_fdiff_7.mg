...
Theorem t46_fdiff_7:
 ...
 forall k1_rfunct_1:set -> set -> set,
 ...
 forall k3_rfunct_1:set -> set -> set -> set -> set,
 forall k16_sin_cos:set,
 forall k19_sin_cos:set,
 forall k1_numbers:set,
 forall esk1_0:set,
     ((k1_fdiff_1 (k3_rfunct_1 k1_numbers k1_numbers k16_sin_cos k19_sin_cos) esk1_0) = (k10_real_1 np__1 (k5_square_1 (k1_seq_1 k19_sin_cos esk1_0))) -> r1_fdiff_1 (k3_rfunct_1 k1_numbers k1_numbers k16_sin_cos k19_sin_cos) esk1_0 -> False)
  -> (forall X1 X3 X2, ((k1_seq_1 X2 X3) = k6_numbers -> False) -> ((k10_real_1 (k9_real_1 (k8_real_1 (k1_fdiff_1 X1 X3) (k1_seq_1 X2 X3)) (k8_real_1 (k1_fdiff_1 X2 X3) (k1_seq_1 X1 X3))) (k5_square_1 (k1_seq_1 X2 X3))) = (k1_fdiff_1 (k3_rfunct_1 k1_numbers k1_numbers X1 X2) X3) -> False) -> v1_funct_1 X2 -> v1_funct_1 X1 -> r1_fdiff_1 X2 X3 -> r1_fdiff_1 X1 X3 -> m1_subset_1 X3 k1_numbers -> m1_subset_1 X2 (k1_zfmisc_1 (k2_zfmisc_1 k1_numbers k1_numbers)) -> m1_subset_1 X1 (k1_zfmisc_1 (k2_zfmisc_1 k1_numbers k1_numbers)) -> False)
  -> (forall X4 X1 X3 X2, (m1_subset_1 (k3_rfunct_1 X1 X2 X3 X4) (k1_zfmisc_1 (k2_zfmisc_1 X1 k1_numbers)) -> False) -> v3_membered X2 -> v1_funct_1 X4 -> v1_funct_1 X3 -> m1_subset_1 X4 (k1_zfmisc_1 (k2_zfmisc_1 X1 X2)) -> m1_subset_1 X3 (k1_zfmisc_1 (k2_zfmisc_1 X1 X2)) -> False)
  -> (forall X1 X3 X2, ((k1_seq_1 X2 X3) = k6_numbers -> False) -> (r1_fdiff_1 (k3_rfunct_1 k1_numbers k1_numbers X1 X2) X3 -> False) -> v1_funct_1 X2 -> v1_funct_1 X1 -> r1_fdiff_1 X2 X3 -> r1_fdiff_1 X1 X3 -> m1_subset_1 X3 k1_numbers -> m1_subset_1 X2 (k1_zfmisc_1 (k2_zfmisc_1 k1_numbers k1_numbers)) -> m1_subset_1 X1 (k1_zfmisc_1 (k2_zfmisc_1 k1_numbers k1_numbers)) -> False)
  -> (forall X4 X1 X3 X2, (v1_funct_1 (k3_rfunct_1 X1 X2 X3 X4) -> False) -> v3_membered X2 -> v1_funct_1 X4 -> v1_funct_1 X3 -> m1_subset_1 X4 (k1_zfmisc_1 (k2_zfmisc_1 X1 X2)) -> m1_subset_1 X3 (k1_zfmisc_1 (k2_zfmisc_1 X1 X2)) -> False)
  -> (forall X4 X3 X2 X1, ((k3_rfunct_1 X3 X1 X2 X4) = (k1_rfunct_1 X2 X4) -> False) -> v3_membered X1 -> v1_funct_1 X4 -> v1_funct_1 X2 -> m1_subset_1 X4 (k1_zfmisc_1 (k2_zfmisc_1 X3 X1)) -> m1_subset_1 X2 (k1_zfmisc_1 (k2_zfmisc_1 X3 X1)) -> False)
  -> (forall X1, ((k7_real_1 (k8_real_1 (k1_seq_1 k19_sin_cos X1) (k1_seq_1 k19_sin_cos X1)) (k8_real_1 (k1_seq_1 k16_sin_cos X1) (k1_seq_1 k16_sin_cos X1))) = np__1 -> False) -> v1_xreal_0 X1 -> False)
  ...
  -> (forall X1, ((k7_real_1 (k5_square_1 (k1_seq_1 k19_sin_cos X1)) (k5_square_1 (k1_seq_1 k16_sin_cos X1))) = np__1 -> False) -> v1_xreal_0 X1 -> False)
  ...
  -> (forall X1 X2, (v1_funct_1 (k1_rfunct_1 X1 X2) -> False) -> v1_relat_1 X2 -> v1_relat_1 X1 -> v1_valued_0 X2 -> v1_valued_0 X1 -> v1_funct_1 X2 -> v1_funct_1 X1 -> False)
  -> (forall X1 X2, (v1_relat_1 (k1_rfunct_1 X1 X2) -> False) -> v1_relat_1 X2 -> v1_relat_1 X1 -> v1_valued_0 X2 -> v1_valued_0 X1 -> v1_funct_1 X2 -> v1_funct_1 X1 -> False)
  ...
  -> ((k1_seq_1 k19_sin_cos esk1_0) = k6_numbers -> False)
