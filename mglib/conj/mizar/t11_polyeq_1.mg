...
Theorem t11_polyeq_1:
 forall v1_xreal_0:set -> prop,
 forall k5_polyeq_1:set -> set -> set -> set -> set,
 forall esk1_0:set,
 forall esk2_0:set,
 forall esk5_0:set,
 forall esk4_0:set,
 ...
 forall esk17_6:set -> set -> set -> set -> set -> set -> set,
 forall k3_polyeq_1:set -> set -> set -> set -> set,
     (forall X6 X4 X3 X5 X1 X2, (X1 = X2 -> False) -> (k3_polyeq_1 X1 X3 X4 (esk17_6 X1 X3 X4 X2 X5 X6)) = (k3_polyeq_1 X2 X5 X6 (esk17_6 X1 X3 X4 X2 X5 X6)) -> v1_xcmplx_0 X6 -> v1_xcmplx_0 X5 -> v1_xcmplx_0 X4 -> v1_xcmplx_0 X3 -> v1_xcmplx_0 X2 -> v1_xcmplx_0 X1 -> False)
  -> (forall X6 X4 X3 X5 X1 X2, (X1 = X2 -> False) -> (k3_polyeq_1 X3 X1 X4 (esk17_6 X3 X1 X4 X5 X2 X6)) = (k3_polyeq_1 X5 X2 X6 (esk17_6 X3 X1 X4 X5 X2 X6)) -> v1_xcmplx_0 X6 -> v1_xcmplx_0 X5 -> v1_xcmplx_0 X4 -> v1_xcmplx_0 X3 -> v1_xcmplx_0 X2 -> v1_xcmplx_0 X1 -> False)
  -> (forall X6 X4 X3 X5 X1 X2, (X1 = X2 -> False) -> (k3_polyeq_1 X3 X4 X1 (esk17_6 X3 X4 X1 X5 X6 X2)) = (k3_polyeq_1 X5 X6 X2 (esk17_6 X3 X4 X1 X5 X6 X2)) -> v1_xcmplx_0 X6 -> v1_xcmplx_0 X5 -> v1_xcmplx_0 X4 -> v1_xcmplx_0 X3 -> v1_xcmplx_0 X2 -> v1_xcmplx_0 X1 -> False)
  -> (forall X6 X4 X3 X5 X1 X2, (X1 = X2 -> False) -> (v1_xreal_0 (esk17_6 X1 X3 X4 X2 X5 X6) -> False) -> v1_xcmplx_0 X6 -> v1_xcmplx_0 X5 -> v1_xcmplx_0 X4 -> v1_xcmplx_0 X3 -> v1_xcmplx_0 X2 -> v1_xcmplx_0 X1 -> False)
  -> (forall X6 X4 X3 X5 X1 X2, (X1 = X2 -> False) -> (v1_xreal_0 (esk17_6 X3 X1 X4 X5 X2 X6) -> False) -> v1_xcmplx_0 X6 -> v1_xcmplx_0 X5 -> v1_xcmplx_0 X4 -> v1_xcmplx_0 X3 -> v1_xcmplx_0 X2 -> v1_xcmplx_0 X1 -> False)
  -> (forall X6 X4 X3 X5 X1 X2, (X1 = X2 -> False) -> (v1_xreal_0 (esk17_6 X3 X4 X1 X5 X6 X2) -> False) -> v1_xcmplx_0 X6 -> v1_xcmplx_0 X5 -> v1_xcmplx_0 X4 -> v1_xcmplx_0 X3 -> v1_xcmplx_0 X2 -> v1_xcmplx_0 X1 -> False)
  ...
  -> (forall X3 X2 X1 X4, (v1_xreal_0 (k5_polyeq_1 X1 X2 X3 X4) -> False) -> v1_xreal_0 X4 -> v1_xreal_0 X3 -> v1_xreal_0 X2 -> v1_xreal_0 X1 -> False)
  ...
  -> (forall X1, ((k5_polyeq_1 esk3_0 X1 esk1_0 esk2_0) = (k3_polyeq_1 esk3_0 esk4_0 esk5_0 X1) -> False) -> v1_xreal_0 X1 -> False)
  ...
  -> (forall X3 X2 X1 X4, ((k3_xcmplx_0 X1 (k3_xcmplx_0 (k6_xcmplx_0 X2 X3) (k6_xcmplx_0 X2 X4))) = (k5_polyeq_1 X1 X2 X3 X4) -> False) -> v1_xcmplx_0 X4 -> v1_xcmplx_0 X3 -> v1_xcmplx_0 X2 -> v1_xcmplx_0 X1 -> False)
  ...
  -> ((k3_xcmplx_0 esk1_0 esk2_0) = (k7_xcmplx_0 esk5_0 esk3_0) -> (k4_xcmplx_0 (k2_xcmplx_0 esk1_0 esk2_0)) = (k7_xcmplx_0 esk4_0 esk3_0) -> False)
