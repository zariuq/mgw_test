...
Theorem t49_ordinal3:
 ...
 forall k1_xboole_0:set,
     (forall X1 X3 X2, (X2 = k1_xboole_0 -> False) -> ((k11_ordinal2 X2 X3) = (k3_tarski (k4_ordinal2 X1)) -> False) -> (k9_xtuple_0 X1) = X2 -> (k1_funct_1 X1 (esk20_3 X2 X3 X1)) = (k11_ordinal2 (esk20_3 X2 X3 X1) X3) -> v3_ordinal1 X3 -> v3_ordinal1 X2 -> v4_ordinal1 X2 -> v5_ordinal1 X1 -> v1_relat_1 X1 -> v1_funct_1 X1 -> v1_ordinal2 X1 -> False)
  -> (forall X3 X2 X1, (X1 = k1_xboole_0 -> False) -> ((k11_ordinal2 X1 X2) = (k3_tarski (k4_ordinal2 X3)) -> False) -> (r2_hidden (esk20_3 X1 X2 X3) X1 -> False) -> (k9_xtuple_0 X3) = X1 -> v3_ordinal1 X2 -> v3_ordinal1 X1 -> v4_ordinal1 X1 -> v5_ordinal1 X3 -> v1_relat_1 X3 -> v1_funct_1 X3 -> v1_ordinal2 X3 -> False)
  -> (forall X3 X2 X1, (X1 = k1_xboole_0 -> False) -> ((k11_ordinal2 X1 X2) = (k3_tarski (k4_ordinal2 X3)) -> False) -> (v3_ordinal1 (esk20_3 X1 X2 X3) -> False) -> (k9_xtuple_0 X3) = X1 -> v3_ordinal1 X2 -> v3_ordinal1 X1 -> v4_ordinal1 X1 -> v5_ordinal1 X3 -> v1_relat_1 X3 -> v1_funct_1 X3 -> v1_ordinal2 X3 -> False)
  ...
  -> (forall X1, (v4_ordinal1 X1 -> False) -> v3_ordinal1 X1 -> r2_hidden (k2_xboole_0 (esk18_1 X1) (k1_tarski (esk18_1 X1))) X1 -> False)
  ...
  -> (forall X2 X1, (r2_hidden (esk17_2 X1 X2) X2 -> False) -> v3_ordinal1 X1 -> r2_hidden X1 (k3_ordinal2 X2) -> False)
  -> (forall X2 X1, (r1_ordinal1 X1 (esk17_2 X1 X2) -> False) -> v3_ordinal1 X1 -> r2_hidden X1 (k3_ordinal2 X2) -> False)
  -> (forall X1, v3_ordinal1 X1 -> v1_xboole_0 (k2_xboole_0 X1 (k1_tarski X1)) -> False)
  -> (forall X2 X1, (v3_ordinal1 (esk17_2 X1 X2) -> False) -> v3_ordinal1 X1 -> r2_hidden X1 (k3_ordinal2 X2) -> False)
  ...
  -> (forall X2 X1, (X1 = X2 -> False) -> (k2_xboole_0 X1 (k1_tarski X1)) = (k2_xboole_0 X2 (k1_tarski X2)) -> False)
  ...
  -> (forall X1, ((k1_funct_1 esk3_0 X1) = (k11_ordinal2 X1 esk1_0) -> False) -> v3_ordinal1 X1 -> r2_hidden X1 esk2_0 -> False)
  ...
  -> (forall X1, ((k2_xboole_0 (esk19_1 X1) (k1_tarski (esk19_1 X1))) = X1 -> False) -> (v4_ordinal1 X1 -> False) -> v3_ordinal1 X1 -> False)
  ...
  -> (forall X1 X2, (v3_ordinal1 X2 -> False) -> v3_ordinal1 X1 -> m1_subset_1 X2 X1 -> False)
  -> (forall X1, (v4_ordinal1 X1 -> False) -> (r2_hidden (esk18_1 X1) X1 -> False) -> v3_ordinal1 X1 -> False)
  ...
  -> (forall X1, (v4_ordinal1 X1 -> False) -> (v3_ordinal1 (esk19_1 X1) -> False) -> v3_ordinal1 X1 -> False)
  -> (forall X1, (v4_ordinal1 X1 -> False) -> (v3_ordinal1 (esk18_1 X1) -> False) -> v3_ordinal1 X1 -> False)
  ...
  -> ((k11_ordinal2 esk2_0 esk1_0) = (k4_ordinal2 esk3_0) -> False)
  ...
  -> (((k9_xtuple_0 esk3_0) = esk2_0 -> False) -> False)
