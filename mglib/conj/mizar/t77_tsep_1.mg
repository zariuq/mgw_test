...
Theorem t77_tsep_1:
 ...
 forall v2_pre_topc:set -> prop,
  ...
  -> (forall X3 X1 X5 X4 X2, (r1_connsp_1 X2 X4 X5 -> False) -> v2_pre_topc X2 -> l1_pre_topc X2 -> v3_pre_topc X3 X2 -> v3_pre_topc X1 X2 -> r1_tarski X5 X3 -> r1_tarski X4 X1 -> m1_subset_1 X5 (k1_zfmisc_1 (u1_struct_0 X2)) -> m1_subset_1 X4 (k1_zfmisc_1 (u1_struct_0 X2)) -> m1_subset_1 X3 (k1_zfmisc_1 (u1_struct_0 X2)) -> m1_subset_1 X1 (k1_zfmisc_1 (u1_struct_0 X2)) -> r1_xboole_0 (k9_subset_1 (u1_struct_0 X2) X1 X3) (k4_subset_1 (u1_struct_0 X2) X4 X5) -> False)
  -> (forall X1 X2, (v2_struct_0 X2 -> False) -> (v2_struct_0 X1 -> False) -> m1_pre_topc X2 esk1_0 -> m1_pre_topc X1 esk1_0 -> v1_tsep_1 X2 esk1_0 -> v1_tsep_1 X1 esk1_0 -> m1_pre_topc esk2_0 X1 -> m1_pre_topc esk3_0 X2 -> r3_tsep_1 esk1_0 esk2_0 esk3_0 -> r1_tsep_1 (k2_tsep_1 esk1_0 X1 X2) (k1_tsep_1 esk1_0 esk2_0 esk3_0) -> False)
  ...
  -> (forall X3 X2 X1, (v3_pre_topc (esk37_3 X1 X2 X3) X1 -> False) -> v2_pre_topc X1 -> l1_pre_topc X1 -> r1_connsp_1 X1 X2 X3 -> m1_subset_1 X3 (k1_zfmisc_1 (u1_struct_0 X1)) -> m1_subset_1 X2 (k1_zfmisc_1 (u1_struct_0 X1)) -> False)
  -> (forall X3 X2 X1, (v3_pre_topc (esk36_3 X1 X2 X3) X1 -> False) -> v2_pre_topc X1 -> l1_pre_topc X1 -> r1_connsp_1 X1 X2 X3 -> m1_subset_1 X3 (k1_zfmisc_1 (u1_struct_0 X1)) -> m1_subset_1 X2 (k1_zfmisc_1 (u1_struct_0 X1)) -> False)
  ...
  -> (forall X1 X2, (v2_struct_0 X2 -> False) -> (v2_struct_0 X1 -> False) -> r1_tsep_1 X1 X2 -> m1_pre_topc X2 esk1_0 -> m1_pre_topc X1 esk1_0 -> v1_tsep_1 X2 esk1_0 -> v1_tsep_1 X1 esk1_0 -> m1_pre_topc esk2_0 X1 -> m1_pre_topc esk3_0 X2 -> r3_tsep_1 esk1_0 esk2_0 esk3_0 -> False)
  ...
  -> (forall X2 X1, (v2_struct_0 X1 -> False) -> (v1_xboole_0 X2 -> False) -> v2_pre_topc X1 -> l1_pre_topc X1 -> v3_pre_topc X2 X1 -> v2_struct_0 (esk35_2 X1 X2) -> m1_subset_1 X2 (k1_zfmisc_1 (u1_struct_0 X1)) -> False)
  -> (forall X3 X2 X1, ((k9_subset_1 X2 X1 X3) = (k9_subset_1 X2 X3 X1) -> False) -> m1_subset_1 X1 (k1_zfmisc_1 X2) -> False)
  -> (forall X2 X1, (v2_struct_0 X1 -> False) -> (v1_xboole_0 X2 -> False) -> (v1_tsep_1 (esk35_2 X1 X2) X1 -> False) -> v2_pre_topc X1 -> l1_pre_topc X1 -> v3_pre_topc X2 X1 -> m1_subset_1 X2 (k1_zfmisc_1 (u1_struct_0 X1)) -> False)
  -> (forall X2 X1, (v2_struct_0 X1 -> False) -> (v1_xboole_0 X2 -> False) -> (m1_pre_topc (esk35_2 X1 X2) X1 -> False) -> v2_pre_topc X1 -> l1_pre_topc X1 -> v3_pre_topc X2 X1 -> m1_subset_1 X2 (k1_zfmisc_1 (u1_struct_0 X1)) -> False)
  ...
  -> (forall X1 X2, ((u1_struct_0 (esk35_2 X2 X1)) = X1 -> False) -> (v2_struct_0 X2 -> False) -> (v1_xboole_0 X1 -> False) -> v2_pre_topc X2 -> l1_pre_topc X2 -> v3_pre_topc X1 X2 -> m1_subset_1 X1 (k1_zfmisc_1 (u1_struct_0 X2)) -> False)
  -> (forall X2 X1, (v2_struct_0 X1 -> False) -> (v1_xboole_0 X2 -> False) -> (v1_pre_topc (esk35_2 X1 X2) -> False) -> v2_pre_topc X1 -> l1_pre_topc X1 -> v3_pre_topc X2 X1 -> m1_subset_1 X2 (k1_zfmisc_1 (u1_struct_0 X1)) -> False)
  ...
  -> ((v1_tsep_1 esk5_0 esk1_0 -> False) -> (r3_tsep_1 esk1_0 esk2_0 esk3_0 -> False) -> False)
  -> ((v1_tsep_1 esk4_0 esk1_0 -> False) -> (r3_tsep_1 esk1_0 esk2_0 esk3_0 -> False) -> False)
  ...
  -> (forall X1, (v2_struct_0 X1 -> False) -> (v1_tsep_1 (esk23_1 X1) X1 -> False) -> v2_pre_topc X1 -> l1_pre_topc X1 -> False)
  ...
  -> (forall X1, (v1_tsep_1 (esk17_1 X1) X1 -> False) -> v2_pre_topc X1 -> l1_pre_topc X1 -> False)
  -> (forall X1, (m1_pre_topc (esk29_1 X1) X1 -> False) -> v2_pre_topc X1 -> l1_pre_topc X1 -> False)
  -> (forall X1, (m1_pre_topc (esk17_1 X1) X1 -> False) -> v2_pre_topc X1 -> l1_pre_topc X1 -> False)
  ...
  -> (forall X1, (v1_pre_topc (esk17_1 X1) -> False) -> v2_pre_topc X1 -> l1_pre_topc X1 -> False)
  -> (forall X1, (v2_pre_topc (esk29_1 X1) -> False) -> v2_pre_topc X1 -> l1_pre_topc X1 -> False)
  -> (forall X1, (v2_pre_topc (esk17_1 X1) -> False) -> v2_pre_topc X1 -> l1_pre_topc X1 -> False)
  ...
  -> ((v1_pre_topc esk21_0 -> False) -> False)
