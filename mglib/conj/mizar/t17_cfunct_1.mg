...
Theorem t17_cfunct_1:
 ...
 forall k7_partfun1:set -> set -> set -> set,
  ...
  -> (forall X3 X4 X1 X2, ((k7_partfun1 k2_numbers (k25_valued_1 X2 k2_numbers X3 X4) X1) = (k9_complex1 X4 (k7_partfun1 k2_numbers X3 X1)) -> False) -> (v1_xboole_0 X2 -> False) -> v1_funct_1 X3 -> m1_subset_1 X1 X2 -> m1_subset_1 X4 k2_numbers -> m1_subset_1 X3 (k1_zfmisc_1 (k2_zfmisc_1 X2 k2_numbers)) -> r2_hidden X1 (k1_relset_1 X2 (k25_valued_1 X2 k2_numbers X3 X4)) -> False)
  -> (forall X1 X2 X4 X3, (v1_xboole_0 X3 -> False) -> (v1_xboole_0 X1 -> False) -> (r2_relset_1 X3 X1 X2 X4 -> False) -> (k1_relset_1 X3 X2) = (k1_relset_1 X3 X4) -> (k7_partfun1 X1 X2 (esk17_4 X1 X3 X2 X4)) = (k7_partfun1 X1 X4 (esk17_4 X1 X3 X2 X4)) -> v1_funct_1 X4 -> v1_funct_1 X2 -> m1_subset_1 X4 (k1_zfmisc_1 (k2_zfmisc_1 X3 X1)) -> m1_subset_1 X2 (k1_zfmisc_1 (k2_zfmisc_1 X3 X1)) -> False)
  ...
  -> (forall X1 X3 X4 X2, (v1_xboole_0 X2 -> False) -> (v1_xboole_0 X1 -> False) -> (r2_relset_1 X2 X1 X3 X4 -> False) -> (r2_hidden (esk17_4 X1 X2 X3 X4) (k1_relset_1 X2 X3) -> False) -> (k1_relset_1 X2 X3) = (k1_relset_1 X2 X4) -> v1_funct_1 X4 -> v1_funct_1 X3 -> m1_subset_1 X4 (k1_zfmisc_1 (k2_zfmisc_1 X2 X1)) -> m1_subset_1 X3 (k1_zfmisc_1 (k2_zfmisc_1 X2 X1)) -> False)
  -> (forall X1 X3 X4 X2, (v1_xboole_0 X2 -> False) -> (v1_xboole_0 X1 -> False) -> (r2_relset_1 X2 X1 X3 X4 -> False) -> (m1_subset_1 (esk17_4 X1 X2 X3 X4) X2 -> False) -> (k1_relset_1 X2 X3) = (k1_relset_1 X2 X4) -> v1_funct_1 X4 -> v1_funct_1 X3 -> m1_subset_1 X4 (k1_zfmisc_1 (k2_zfmisc_1 X2 X1)) -> m1_subset_1 X3 (k1_zfmisc_1 (k2_zfmisc_1 X2 X1)) -> False)
  ...
  -> (forall X2 X3 X1, ((k1_relset_1 X1 (k25_valued_1 X1 k2_numbers X2 X3)) = (k1_relset_1 X1 X2) -> False) -> (v1_xboole_0 X1 -> False) -> v1_funct_1 X2 -> m1_subset_1 X3 k2_numbers -> m1_subset_1 X2 (k1_zfmisc_1 (k2_zfmisc_1 X1 k2_numbers)) -> False)
  ...
  -> (r2_relset_1 esk1_0 k2_numbers (k25_valued_1 esk1_0 k2_numbers (k19_valued_1 esk1_0 k2_numbers k2_numbers esk2_0 esk3_0) esk4_0) (k19_valued_1 esk1_0 k2_numbers k2_numbers (k25_valued_1 esk1_0 k2_numbers esk2_0 esk4_0) esk3_0) -> False)
  ...
  -> ((m1_subset_1 esk4_0 k2_numbers -> False) -> False)
