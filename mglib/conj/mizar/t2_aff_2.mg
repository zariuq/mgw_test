...
Theorem t2_aff_2:
 forall esk29_8:set -> set -> set -> set -> set -> set -> set -> set -> set,
 ...
 forall epred2_8:set -> set -> set -> set -> set -> set -> set -> set -> prop,
     (forall X1 X3 X5 X7 X8 X6 X4 X2, (epred2_8 X8 X3 X2 X7 X6 X4 X5 X1 -> False) -> (r2_analoaf X1 X2 X3 (esk30_8 X1 X4 X5 X6 X7 X3 X2 X8) (esk31_8 X1 X4 X5 X6 X7 X3 X2 X8) -> False) -> False)
  -> (forall X1 X3 X5 X8 X7 X6 X4 X2, (epred2_8 X8 X3 X7 X2 X6 X4 X5 X1 -> False) -> (r2_analoaf X1 X2 X3 (esk29_8 X1 X4 X5 X6 X2 X3 X7 X8) (esk31_8 X1 X4 X5 X6 X2 X3 X7 X8) -> False) -> False)
  -> (forall X1 X3 X5 X8 X7 X6 X4 X2, (epred2_8 X8 X7 X3 X2 X6 X4 X5 X1 -> False) -> (r2_analoaf X1 X2 X3 (esk29_8 X1 X4 X5 X6 X2 X7 X3 X8) (esk30_8 X1 X4 X5 X6 X2 X7 X3 X8) -> False) -> False)
  -> (forall X1 X2 X4 X6 X7 X8 X5 X3, (epred2_8 X8 X6 X7 X5 X4 X2 X3 X1 -> False) -> (m1_subset_1 (esk31_8 X1 X2 X3 X4 X5 X6 X7 X8) (u1_struct_0 X1) -> False) -> False)
  -> (forall X1 X2 X4 X6 X7 X8 X5 X3, (epred2_8 X8 X6 X7 X5 X4 X2 X3 X1 -> False) -> (m1_subset_1 (esk30_8 X1 X2 X3 X4 X5 X6 X7 X8) (u1_struct_0 X1) -> False) -> False)
  -> (forall X1 X2 X4 X6 X7 X8 X5 X3, (epred2_8 X8 X6 X7 X5 X4 X2 X3 X1 -> False) -> (m1_subset_1 (esk29_8 X1 X2 X3 X4 X5 X6 X7 X8) (u1_struct_0 X1) -> False) -> False)
  -> (forall X4 X2 X6 X7 X8 X5 X3 X1, (epred2_8 X8 X6 X7 X5 X4 X2 X3 X1 -> False) -> (r2_hidden (esk31_8 X1 X2 X3 X4 X5 X6 X7 X8) X4 -> False) -> False)
  -> (forall X3 X2 X4 X6 X7 X8 X5 X1, (epred2_8 X8 X6 X7 X5 X4 X2 X3 X1 -> False) -> (r2_hidden (esk30_8 X1 X2 X3 X4 X5 X6 X7 X8) X3 -> False) -> False)
  -> (forall X2 X4 X6 X7 X8 X5 X3 X1, (epred2_8 X8 X6 X7 X5 X4 X2 X3 X1 -> False) -> (r2_hidden (esk29_8 X1 X2 X3 X4 X5 X6 X7 X8) X2 -> False) -> False)
  -> (forall X1 X3 X5 X7 X8 X6 X4 X2, (epred2_8 X8 X1 X7 X6 X5 X3 X4 X2 -> False) -> (esk31_8 X2 X3 X4 X5 X6 X1 X7 X8) = X1 -> False)
  -> (forall X5 X4 X1 X8 X10 X9 X3 X2 X11 X6 X7, (X6 = X7 -> False) -> (X5 = X6 -> False) -> (X2 = X11 -> False) -> (X1 = X4 -> False) -> (X1 = X3 -> False) -> (X1 = X2 -> False) -> (r2_hidden X1 X5 -> False) -> (r1_aff_1 X8 X4 X3 X2 -> False) -> r2_hidden X11 X5 -> r2_hidden X10 X7 -> r2_hidden X9 X6 -> r2_hidden X4 X6 -> r2_hidden X3 X7 -> r2_hidden X2 X5 -> r2_hidden X1 X7 -> r2_hidden X1 X6 -> v1_aff_1 X7 X8 -> v1_aff_1 X6 X8 -> v1_aff_1 X5 X8 -> m1_subset_1 X11 (u1_struct_0 X8) -> m1_subset_1 X10 (u1_struct_0 X8) -> m1_subset_1 X9 (u1_struct_0 X8) -> r2_analoaf X8 X4 X3 X9 X10 -> r2_analoaf X8 X4 X2 X9 X11 -> r2_analoaf X8 X3 X2 X10 X11 -> epred2_8 X1 X2 X3 X4 X5 X6 X7 X8 -> False)
  -> (forall X1, (v7_struct_0 X1 -> False) -> (v5_aff_2 X1 -> False) -> v1_diraf X1 -> v2_diraf X1 -> l1_analoaf X1 -> epred2_8 (esk10_1 X1) (esk13_1 X1) (esk12_1 X1) (esk11_1 X1) (esk9_1 X1) (esk7_1 X1) (esk8_1 X1) X1 -> False)
  -> (forall X5 X6 X8 X7 X1 X4 X3 X2, (epred2_8 X5 X4 X3 X2 X6 X7 X8 X1 -> False) -> r1_aff_1 X1 X2 X3 X4 -> False)
  -> (forall X8 X6 X4 X3 X2 X5 X7 X1, (v7_struct_0 X1 -> False) -> (epred2_8 X5 X8 X7 X6 X4 X2 X3 X1 -> False) -> v1_diraf X1 -> v2_diraf X1 -> l1_analoaf X1 -> v5_aff_2 X1 -> m1_subset_1 X8 (u1_struct_0 X1) -> m1_subset_1 X7 (u1_struct_0 X1) -> m1_subset_1 X6 (u1_struct_0 X1) -> m1_subset_1 X5 (u1_struct_0 X1) -> m1_subset_1 X4 (k1_zfmisc_1 (u1_struct_0 X1)) -> m1_subset_1 X3 (k1_zfmisc_1 (u1_struct_0 X1)) -> m1_subset_1 X2 (k1_zfmisc_1 (u1_struct_0 X1)) -> False)
  -> (forall X4 X8 X7 X6 X5 X3 X2 X1, (epred2_8 X1 X3 X4 X5 X2 X6 X7 X8 -> False) -> r2_hidden X1 X2 -> False)
  -> (forall X4 X6 X7 X8 X5 X3 X1 X2, (v1_aff_1 X1 X2 -> False) -> (epred2_8 X3 X4 X5 X6 X1 X7 X8 X2 -> False) -> False)
  -> (forall X4 X6 X8 X7 X5 X3 X1 X2, (v1_aff_1 X1 X2 -> False) -> (epred2_8 X3 X4 X5 X6 X7 X1 X8 X2 -> False) -> False)
  -> (forall X4 X6 X8 X7 X5 X3 X1 X2, (v1_aff_1 X1 X2 -> False) -> (epred2_8 X3 X4 X5 X6 X7 X8 X1 X2 -> False) -> False)
  -> (forall X3 X5 X7 X8 X6 X4 X1 X2, (r2_hidden X1 X2 -> False) -> (epred2_8 X1 X3 X4 X5 X6 X2 X7 X8 -> False) -> False)
  -> (forall X3 X5 X7 X8 X6 X4 X1 X2, (r2_hidden X1 X2 -> False) -> (epred2_8 X1 X3 X4 X5 X6 X7 X2 X8 -> False) -> False)
  -> (forall X5 X6 X7 X8 X4 X3 X1 X2, (r2_hidden X1 X2 -> False) -> (epred2_8 X3 X1 X4 X5 X2 X6 X7 X8 -> False) -> False)
  -> (forall X4 X5 X7 X8 X6 X3 X1 X2, (r2_hidden X1 X2 -> False) -> (epred2_8 X3 X4 X1 X5 X6 X7 X2 X8 -> False) -> False)
  -> (forall X4 X7 X8 X6 X5 X3 X1 X2, (r2_hidden X1 X2 -> False) -> (epred2_8 X3 X4 X5 X1 X6 X2 X7 X8 -> False) -> False)
  -> (forall X3 X5 X8 X7 X6 X4 X2 X1, (epred2_8 X1 X2 X3 X4 X5 X6 X7 X8 -> False) -> X1 = X2 -> False)
  -> (forall X5 X8 X7 X6 X4 X3 X2 X1, (epred2_8 X1 X3 X2 X4 X5 X6 X7 X8 -> False) -> X1 = X2 -> False)
  -> (forall X4 X5 X8 X7 X6 X3 X2 X1, (epred2_8 X1 X3 X4 X2 X5 X6 X7 X8 -> False) -> X1 = X2 -> False)
  -> (forall X3 X5 X8 X7 X6 X4 X2 X1, (epred2_8 X3 X4 X5 X6 X2 X1 X7 X8 -> False) -> X1 = X2 -> False)
  -> (forall X3 X5 X7 X8 X6 X4 X2 X1, (epred2_8 X3 X4 X5 X6 X7 X1 X2 X8 -> False) -> X1 = X2 -> False)
  -> (forall X1 X2 X4 X6 X5 X3, (epred1_6 X1 X6 X5 X4 X3 X2 -> False) -> r2_analoaf X1 (esk24_6 X2 X3 X4 X5 X6 X1) (esk25_6 X2 X3 X4 X5 X6 X1) (esk27_6 X2 X3 X4 X5 X6 X1) (esk28_6 X2 X3 X4 X5 X6 X1) -> False)
  -> (forall X1 X3 X5 X6 X4 X2, (epred1_6 X1 X6 X5 X4 X3 X2 -> False) -> (r2_analoaf X1 X2 (esk25_6 X2 X3 X4 X5 X6 X1) (esk26_6 X2 X3 X4 X5 X6 X1) (esk28_6 X2 X3 X4 X5 X6 X1) -> False) -> False)
  -> (forall X1 X3 X5 X6 X4 X2, (epred1_6 X1 X6 X5 X4 X3 X2 -> False) -> (r2_analoaf X1 X2 (esk24_6 X2 X3 X4 X5 X6 X1) (esk26_6 X2 X3 X4 X5 X6 X1) (esk27_6 X2 X3 X4 X5 X6 X1) -> False) -> False)
  ...
  -> (forall X3 X2 X4 X5 X6 X1, (epred1_6 X6 X5 X4 X3 X2 X1 -> False) -> (r2_hidden (esk28_6 X1 X2 X3 X4 X5 X6) X3 -> False) -> False)
  -> (forall X4 X2 X5 X6 X3 X1, (epred1_6 X6 X5 X4 X3 X2 X1 -> False) -> (r2_hidden (esk27_6 X1 X2 X3 X4 X5 X6) X4 -> False) -> False)
  -> (forall X5 X2 X4 X6 X3 X1, (epred1_6 X6 X5 X4 X3 X2 X1 -> False) -> (r2_hidden (esk26_6 X1 X2 X3 X4 X5 X6) X5 -> False) -> False)
  -> (forall X3 X2 X4 X5 X6 X1, (epred1_6 X6 X5 X4 X3 X2 X1 -> False) -> (r2_hidden (esk25_6 X1 X2 X3 X4 X5 X6) X3 -> False) -> False)
  -> (forall X4 X2 X5 X6 X3 X1, (epred1_6 X6 X5 X4 X3 X2 X1 -> False) -> (r2_hidden (esk24_6 X1 X2 X3 X4 X5 X6) X4 -> False) -> False)
  ...
  -> (forall X1, (v7_struct_0 X1 -> False) -> (v4_aff_2 X1 -> False) -> v1_diraf X1 -> l1_analoaf X1 -> epred1_6 X1 (esk2_1 X1) (esk3_1 X1) (esk4_1 X1) (esk5_1 X1) (esk6_1 X1) -> False)
  ...
  -> (forall X1, (v7_struct_0 X1 -> False) -> (v5_aff_2 X1 -> False) -> (m1_subset_1 (esk9_1 X1) (k1_zfmisc_1 (u1_struct_0 X1)) -> False) -> v1_diraf X1 -> v2_diraf X1 -> l1_analoaf X1 -> False)
  -> (forall X1, (v7_struct_0 X1 -> False) -> (v5_aff_2 X1 -> False) -> (m1_subset_1 (esk8_1 X1) (k1_zfmisc_1 (u1_struct_0 X1)) -> False) -> v1_diraf X1 -> v2_diraf X1 -> l1_analoaf X1 -> False)
  -> (forall X1, (v7_struct_0 X1 -> False) -> (v5_aff_2 X1 -> False) -> (m1_subset_1 (esk7_1 X1) (k1_zfmisc_1 (u1_struct_0 X1)) -> False) -> v1_diraf X1 -> v2_diraf X1 -> l1_analoaf X1 -> False)
  -> (forall X1, (v7_struct_0 X1 -> False) -> (v4_aff_2 X1 -> False) -> (m1_subset_1 (esk4_1 X1) (k1_zfmisc_1 (u1_struct_0 X1)) -> False) -> v1_diraf X1 -> l1_analoaf X1 -> False)
  -> (forall X1, (v7_struct_0 X1 -> False) -> (v4_aff_2 X1 -> False) -> (m1_subset_1 (esk3_1 X1) (k1_zfmisc_1 (u1_struct_0 X1)) -> False) -> v1_diraf X1 -> l1_analoaf X1 -> False)
  -> (forall X1, (v7_struct_0 X1 -> False) -> (v4_aff_2 X1 -> False) -> (m1_subset_1 (esk2_1 X1) (k1_zfmisc_1 (u1_struct_0 X1)) -> False) -> v1_diraf X1 -> l1_analoaf X1 -> False)
  -> (forall X1, (v7_struct_0 X1 -> False) -> (v5_aff_2 X1 -> False) -> (m1_subset_1 (esk13_1 X1) (u1_struct_0 X1) -> False) -> v1_diraf X1 -> v2_diraf X1 -> l1_analoaf X1 -> False)
  -> (forall X1, (v7_struct_0 X1 -> False) -> (v5_aff_2 X1 -> False) -> (m1_subset_1 (esk12_1 X1) (u1_struct_0 X1) -> False) -> v1_diraf X1 -> v2_diraf X1 -> l1_analoaf X1 -> False)
  -> (forall X1, (v7_struct_0 X1 -> False) -> (v5_aff_2 X1 -> False) -> (m1_subset_1 (esk11_1 X1) (u1_struct_0 X1) -> False) -> v1_diraf X1 -> v2_diraf X1 -> l1_analoaf X1 -> False)
  -> (forall X1, (v7_struct_0 X1 -> False) -> (v5_aff_2 X1 -> False) -> (m1_subset_1 (esk10_1 X1) (u1_struct_0 X1) -> False) -> v1_diraf X1 -> v2_diraf X1 -> l1_analoaf X1 -> False)
  ...
  -> (forall X1, (v7_struct_0 X1 -> False) -> (v4_aff_2 X1 -> False) -> (m1_subset_1 (esk6_1 X1) (u1_struct_0 X1) -> False) -> v1_diraf X1 -> l1_analoaf X1 -> False)
  -> (forall X1, (v7_struct_0 X1 -> False) -> (v4_aff_2 X1 -> False) -> (m1_subset_1 (esk5_1 X1) (u1_struct_0 X1) -> False) -> v1_diraf X1 -> l1_analoaf X1 -> False)
  ...
  -> (v4_aff_2 esk1_0 -> v5_aff_2 esk1_0 -> False)
  -> ((v4_aff_2 esk1_0 -> False) -> (v5_aff_2 esk1_0 -> False) -> False)
