...
Theorem t33_mboolean:
 ...
 forall k3_pboole:set -> set -> set -> set,
  ...
  -> (forall X3 X1 X2 X4, (X4 = (k3_pboole X1 X2 X3) -> False) -> (r2_hidden (esk7_4 X1 X2 X3 X4) X1 -> False) -> v1_relat_1 X4 -> v1_relat_1 X3 -> v1_relat_1 X2 -> v1_funct_1 X4 -> v1_funct_1 X3 -> v1_funct_1 X2 -> v4_relat_1 X4 X1 -> v4_relat_1 X3 X1 -> v4_relat_1 X2 X1 -> v1_partfun1 X4 X1 -> v1_partfun1 X3 X1 -> v1_partfun1 X2 X1 -> False)
  ...
  -> (forall X2 X1 X3, (X1 = X3 -> False) -> (k1_funct_1 X1 (esk20_3 X2 X1 X3)) = (k1_funct_1 X3 (esk20_3 X2 X1 X3)) -> v1_relat_1 X3 -> v1_relat_1 X1 -> v1_funct_1 X3 -> v1_funct_1 X1 -> v4_relat_1 X3 X2 -> v4_relat_1 X1 X2 -> v1_partfun1 X3 X2 -> v1_partfun1 X1 X2 -> False)
  ...
  -> (forall X1, (r6_pboole esk1_0 (k3_pboole esk1_0 X1 esk2_0) (k2_zfmisc_1 esk1_0 (k1_tarski k1_xboole_0)) -> False) -> v1_relat_1 X1 -> v1_funct_1 X1 -> v4_relat_1 X1 esk1_0 -> v1_partfun1 X1 esk1_0 -> r1_pboole esk1_0 X1 esk3_0 -> False)
  ...
  -> (forall X1 X2 X3, (X2 = X3 -> False) -> (r2_hidden (esk20_3 X1 X2 X3) X1 -> False) -> v1_relat_1 X3 -> v1_relat_1 X2 -> v1_funct_1 X3 -> v1_funct_1 X2 -> v4_relat_1 X3 X1 -> v4_relat_1 X2 X1 -> v1_partfun1 X3 X1 -> v1_partfun1 X2 X1 -> False)
  ...
  -> (forall X2 X1, (r1_xboole_0 (k3_tarski X1) X2 -> False) -> r1_xboole_0 (esk21_2 X1 X2) X2 -> False)
  ...
  -> (forall X1 X2, (r1_xboole_0 (k3_tarski X1) X2 -> False) -> (r2_hidden (esk21_2 X1 X2) X1 -> False) -> False)
  ...
  -> (r6_pboole esk1_0 (k3_pboole esk1_0 (k2_mboolean esk1_0 esk3_0) esk2_0) (k2_zfmisc_1 esk1_0 (k1_tarski k1_xboole_0)) -> False)
