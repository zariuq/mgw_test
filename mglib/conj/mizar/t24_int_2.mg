...
Theorem t24_int_2:
 ...
 forall k3_int_2:set -> set -> set,
     ((k3_int_2 (k3_xcmplx_0 esk1_0 esk3_0) (k3_xcmplx_0 esk2_0 esk3_0)) = (k1_int_2 esk3_0) -> (k3_int_2 (k3_xcmplx_0 esk1_0 esk3_0) (k3_xcmplx_0 esk3_0 esk2_0)) = (k1_int_2 esk3_0) -> (k3_int_2 (k3_xcmplx_0 esk3_0 esk1_0) (k3_xcmplx_0 esk2_0 esk3_0)) = (k1_int_2 esk3_0) -> (k3_int_2 (k3_xcmplx_0 esk3_0 esk1_0) (k3_xcmplx_0 esk3_0 esk2_0)) = (k1_int_2 esk3_0) -> False)
  -> (forall X1 X3 X2, (X3 = (k3_int_2 X1 X2) -> False) -> v1_int_1 X2 -> v1_int_1 X1 -> v7_ordinal1 X3 -> r1_int_1 X3 X2 -> r1_int_1 X3 X1 -> r1_int_1 (esk4_3 X1 X2 X3) X3 -> False)
  -> (forall X1 X3 X2, (X3 = (k3_int_2 X1 X2) -> False) -> (r1_int_1 (esk4_3 X1 X2 X3) X1 -> False) -> v1_int_1 X2 -> v1_int_1 X1 -> v7_ordinal1 X3 -> r1_int_1 X3 X2 -> r1_int_1 X3 X1 -> False)
  -> (forall X1 X3 X2, (X3 = (k3_int_2 X1 X2) -> False) -> (r1_int_1 (esk4_3 X1 X2 X3) X2 -> False) -> v1_int_1 X2 -> v1_int_1 X1 -> v7_ordinal1 X3 -> r1_int_1 X3 X2 -> r1_int_1 X3 X1 -> False)
  -> (forall X1 X3 X2, (X3 = (k3_int_2 X1 X2) -> False) -> (v1_int_1 (esk4_3 X1 X2 X3) -> False) -> v1_int_1 X2 -> v1_int_1 X1 -> v7_ordinal1 X3 -> r1_int_1 X3 X2 -> r1_int_1 X3 X1 -> False)
  ...
  -> (forall X2 X1 X3, (r1_int_1 X1 (k3_xcmplx_0 X2 X3) -> False) -> v1_int_1 X3 -> v1_int_1 X2 -> v1_int_1 X1 -> r1_int_1 X1 X2 -> False)
  -> (forall X1 X2, ((k3_xcmplx_0 X2 (esk5_2 X2 X1)) = X1 -> False) -> v1_int_1 X2 -> v1_int_1 X1 -> r1_int_1 X2 X1 -> False)
  ...
  -> (forall X1 X2, (v1_int_1 (esk5_2 X1 X2) -> False) -> v1_int_1 X2 -> v1_int_1 X1 -> r1_int_1 X1 X2 -> False)
  ...
  -> (forall X1, (X1 = np__1 -> False) -> (X1 = (k4_xcmplx_0 np__1) -> False) -> v1_int_1 X1 -> r1_int_1 X1 (k4_xcmplx_0 np__1) -> False)
  ...
  -> (forall X1, (X1 = np__1 -> False) -> (X1 = (k4_xcmplx_0 np__1) -> False) -> v1_int_1 X1 -> r1_int_1 X1 np__1 -> False)
  ...
  -> ((r1_int_2 esk1_0 esk2_0 -> False) -> False)
