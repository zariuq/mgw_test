...
Theorem t4_radix_3:
 ...
 forall a_1_1_radix_3:set -> set,
  ...
  -> (forall X2 X1, (r1_xxreal_0 (k6_xcmplx_0 (k4_xcmplx_0 (k1_radix_1 (k7_nat_d X1 np__1))) np__1) (esk6_2 X2 X1) -> False) -> v7_ordinal1 X1 -> r2_hidden X2 (a_1_1_radix_3 X1) -> False)
  ...
  -> (forall X3 X1 X2 X4, (r1_xxreal_0 (k6_xcmplx_0 X1 X3) (k6_xcmplx_0 X4 X2) -> False) -> v1_xreal_0 X4 -> v1_xreal_0 X3 -> v1_xreal_0 X2 -> v1_xreal_0 X1 -> r1_xxreal_0 (k2_xcmplx_0 X1 X2) (k2_xcmplx_0 X3 X4) -> False)
  -> (forall X3 X1 X2 X4, (r1_xxreal_0 (k2_xcmplx_0 X1 X4) (k2_xcmplx_0 X2 X3) -> False) -> v1_xreal_0 X4 -> v1_xreal_0 X3 -> v1_xreal_0 X2 -> v1_xreal_0 X1 -> r1_xxreal_0 (k6_xcmplx_0 X1 X2) (k6_xcmplx_0 X3 X4) -> False)
  -> (forall X1, ((k2_xcmplx_0 (k1_radix_1 (k7_nat_d X1 np__1)) (k1_radix_1 (k7_nat_d X1 np__1))) = (k1_radix_1 X1) -> False) -> v7_ordinal1 X1 -> r1_xxreal_0 np__1 X1 -> False)
  ...
  -> (forall X1 X2, (r1_xxreal_0 (esk6_2 X1 X2) (k1_radix_1 (k7_nat_d X2 np__1)) -> False) -> v7_ordinal1 X2 -> r2_hidden X1 (a_1_1_radix_3 X2) -> False)
  ...
  -> (forall X2 X1 X3, (r1_xxreal_0 X2 (k7_nat_d X3 X1) -> False) -> v7_ordinal1 X3 -> v7_ordinal1 X2 -> v7_ordinal1 X1 -> r1_xxreal_0 (k2_xcmplx_0 X1 X2) X3 -> False)
  ...
  -> (forall X1 X2, (m1_subset_1 (esk6_2 X1 X2) k4_numbers -> False) -> v7_ordinal1 X2 -> r2_hidden X1 (a_1_1_radix_3 X2) -> False)
  ...
  -> (forall X1 X2, ((esk6_2 X1 X2) = X1 -> False) -> v7_ordinal1 X2 -> r2_hidden X1 (a_1_1_radix_3 X2) -> False)
  ...
  -> (forall X1, (r1_xxreal_0 np__2 (k1_radix_1 X1) -> False) -> v7_ordinal1 X1 -> r1_xxreal_0 np__1 X1 -> False)
  ...
  -> (forall X1, ((k2_radix_3 X1) = (a_1_1_radix_3 X1) -> False) -> v7_ordinal1 X1 -> False)
  -> (forall X1, ((a_1_0_radix_1 X1) = (k2_radix_1 X1) -> False) -> v7_ordinal1 X1 -> False)
  -> (forall X1, ((k3_radix_1 X1) = (k2_radix_1 X1) -> False) -> v7_ordinal1 X1 -> False)
  ...
  -> (r1_tarski (k2_radix_3 esk1_0) (k3_radix_1 esk1_0) -> False)
