...
Theorem t27_ordinal1:
 ...
 forall r2_hidden:set -> set -> prop,
     (forall X2 X1 X3, (r2_hidden X1 X3 -> False) -> (r2_hidden X1 (esk24_2 X3 X2) -> False) -> v3_ordinal1 X2 -> r2_hidden X1 (k2_xboole_0 X2 (k1_tarski X2)) -> False)
  -> (forall X3 X1 X2, (r2_hidden X1 (k2_xboole_0 X2 (k1_tarski X2)) -> False) -> v3_ordinal1 X2 -> r2_hidden X1 (esk24_2 X3 X2) -> False)
  -> (forall X3 X1 X2, (X2 = k1_xboole_0 -> False) -> (r1_ordinal1 (esk25_2 X2 X3) X1 -> False) -> v3_ordinal1 X3 -> v3_ordinal1 X1 -> r2_hidden X1 X2 -> r1_tarski X2 X3 -> False)
  -> (forall X2 X1 X3, v3_ordinal1 X3 -> r2_hidden X1 X2 -> r2_hidden X1 (esk24_2 X2 X3) -> False)
  ...
  -> (forall X2 X1, (X1 = k1_xboole_0 -> False) -> (r2_hidden (esk25_2 X1 X2) X1 -> False) -> v3_ordinal1 X2 -> r1_tarski X1 X2 -> False)
  -> (forall X2 X1 X3, (m1_subset_1 X1 X3 -> False) -> r2_hidden X1 X2 -> m1_subset_1 X2 (k1_zfmisc_1 X3) -> False)
  -> (forall X2 X1, v1_xboole_0 X1 -> v1_subset_1 X2 X1 -> m1_subset_1 X2 (k1_zfmisc_1 X1) -> False)
  -> (forall X2 X1 X3, v1_xboole_0 X3 -> r2_hidden X1 X2 -> m1_subset_1 X2 (k1_zfmisc_1 X3) -> False)
  -> (forall X2 X1, (X1 = k1_xboole_0 -> False) -> (v3_ordinal1 (esk25_2 X1 X2) -> False) -> v3_ordinal1 X2 -> r1_tarski X1 X2 -> False)
  -> (forall X1 X3 X2, (r2_hidden X3 X2 -> False) -> r2_hidden X3 X1 -> r1_tarski X1 X2 -> False)
  -> (forall X2 X1, (v1_xboole_0 X1 -> False) -> (v1_subset_1 X2 X1 -> False) -> v1_xboole_0 X2 -> m1_subset_1 X2 (k1_zfmisc_1 X1) -> False)
  -> (forall X2 X1, (v1_xboole_0 X1 -> False) -> (v1_subset_1 X2 X1 -> False) -> v1_xboole_0 X2 -> m1_subset_1 X2 (k1_zfmisc_1 X1) -> False)
  -> (forall X1 X2, (r1_tarski X1 X2 -> False) -> (r2_hidden (esk4_2 X1 X2) X1 -> False) -> False)
  -> (forall X1, (r2_hidden X1 esk1_0 -> False) -> v3_ordinal1 X1 -> r1_ordinal1 X1 (esk2_1 X1) -> False)
  ...
  -> (forall X1, (r2_hidden X1 esk1_0 -> False) -> v3_ordinal1 X1 -> r2_hidden (esk2_1 X1) esk1_0 -> False)
  ...
  -> (forall X1, (v3_ordinal1 (esk2_1 X1) -> False) -> (r2_hidden X1 esk1_0 -> False) -> v3_ordinal1 X1 -> False)
  ...
  -> (forall X1, r2_hidden (esk26_1 X1) X1 -> False)
  ...
  -> (forall X1, (v3_ordinal1 (esk26_1 X1) -> False) -> False)
