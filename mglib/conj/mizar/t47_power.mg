...
Theorem t47_power:
 ...
 forall k4_prepower:set -> set -> set,
  ...
  -> (forall X2 X3 X1, ((k4_prepower (k4_prepower X1 X2) X3) = (k4_prepower X1 (k3_xcmplx_0 X2 X3)) -> False) -> v1_xreal_0 X1 -> v1_int_1 X3 -> v1_int_1 X2 -> False)
  ...
  -> (forall X1 X2, ((k3_xcmplx_0 X2 (esk3_2 X2 X1)) = X1 -> False) -> v1_int_1 X2 -> v1_int_1 X1 -> r1_int_1 X2 X1 -> False)
  ...
  -> (forall X1 X2, (v1_int_1 (esk3_2 X1 X2) -> False) -> v1_int_1 X2 -> v1_int_1 X1 -> r1_int_1 X1 X2 -> False)
  ...
  -> (forall X1, (v1_abian X1 -> False) -> v1_int_1 X1 -> r1_int_1 np__2 X1 -> False)
  ...
  -> (forall X1, (r1_int_1 np__2 X1 -> False) -> v1_int_1 X1 -> v1_abian X1 -> False)
  ...
  -> ((k3_power (k4_xcmplx_0 esk1_0) esk2_0) = (k3_power esk1_0 esk2_0) -> False)
