...
Theorem t4_bvfunc14:
 ...
 forall esk8_6:set -> set -> set -> set -> set -> set -> set,
 ...
 forall k1_xboole_0:set,
     (forall X2 X3 X1 X6 X4 X5, (X5 = k1_xboole_0 -> False) -> (v1_xboole_0 X2 -> False) -> (r2_hidden X5 X4 -> False) -> (k9_xtuple_0 X1) = X3 -> (k10_xtuple_0 X1) = X6 -> X5 = (k8_setfam_1 X2 X6) -> X4 = (k2_bvfunc_2 X2 X3) -> v1_relat_1 X1 -> v1_funct_1 X1 -> m1_eqrel_1 X4 X2 -> m1_subset_1 X6 (k1_zfmisc_1 (k1_zfmisc_1 X2)) -> m1_subset_1 X3 (k1_zfmisc_1 (k1_bvfunc_2 X2)) -> r2_hidden (k1_funct_1 X1 (esk8_6 X2 X3 X4 X5 X1 X6)) (esk8_6 X2 X3 X4 X5 X1 X6) -> False)
  -> (forall X1 X2 X5 X6 X3 X4, (X4 = k1_xboole_0 -> False) -> (v1_xboole_0 X1 -> False) -> (r2_hidden X4 X3 -> False) -> (r2_hidden (esk8_6 X1 X2 X3 X4 X5 X6) X2 -> False) -> (k9_xtuple_0 X5) = X2 -> (k10_xtuple_0 X5) = X6 -> X4 = (k8_setfam_1 X1 X6) -> X3 = (k2_bvfunc_2 X1 X2) -> v1_relat_1 X5 -> v1_funct_1 X5 -> m1_eqrel_1 X3 X1 -> m1_subset_1 X6 (k1_zfmisc_1 (k1_zfmisc_1 X1)) -> m1_subset_1 X2 (k1_zfmisc_1 (k1_bvfunc_2 X1)) -> False)
  -> (forall X1 X5 X2 X3 X4, (X4 = (k2_bvfunc_2 X2 X3) -> False) -> ((esk9_3 X2 X3 X4) = k1_xboole_0 -> False) -> (v1_xboole_0 X2 -> False) -> (k9_xtuple_0 X1) = X3 -> (k10_xtuple_0 X1) = X5 -> (esk9_3 X2 X3 X4) = (k8_setfam_1 X2 X5) -> v1_relat_1 X1 -> v1_funct_1 X1 -> m1_eqrel_1 X4 X2 -> m1_subset_1 X5 (k1_zfmisc_1 (k1_zfmisc_1 X2)) -> m1_subset_1 X3 (k1_zfmisc_1 (k1_bvfunc_2 X2)) -> r2_hidden (esk9_3 X2 X3 X4) X4 -> r2_hidden (k1_funct_1 X1 (esk10_5 X2 X3 X4 X1 X5)) (esk10_5 X2 X3 X4 X1 X5) -> False)
  -> (forall X4 X5 X1 X2 X3, (X3 = (k2_bvfunc_2 X1 X2) -> False) -> ((esk9_3 X1 X2 X3) = k1_xboole_0 -> False) -> (v1_xboole_0 X1 -> False) -> (r2_hidden (esk10_5 X1 X2 X3 X4 X5) X2 -> False) -> (k9_xtuple_0 X4) = X2 -> (k10_xtuple_0 X4) = X5 -> (esk9_3 X1 X2 X3) = (k8_setfam_1 X1 X5) -> v1_relat_1 X4 -> v1_funct_1 X4 -> m1_eqrel_1 X3 X1 -> m1_subset_1 X5 (k1_zfmisc_1 (k1_zfmisc_1 X1)) -> m1_subset_1 X2 (k1_zfmisc_1 (k1_bvfunc_2 X1)) -> r2_hidden (esk9_3 X1 X2 X3) X3 -> False)
  -> (forall X4 X2 X5 X1 X3, (v1_xboole_0 X3 -> False) -> (r2_hidden (k1_funct_1 (esk6_4 X3 X2 X4 X5) X1) X1 -> False) -> X4 = (k2_bvfunc_2 X3 X2) -> m1_eqrel_1 X4 X3 -> r2_hidden X5 X4 -> r2_hidden X1 X2 -> m1_subset_1 X2 (k1_zfmisc_1 (k1_bvfunc_2 X3)) -> False)
  ...
  -> (forall X3 X2 X4 X1, ((k10_xtuple_0 (esk6_4 X1 X2 X3 X4)) = (esk7_4 X1 X2 X3 X4) -> False) -> (v1_xboole_0 X1 -> False) -> X3 = (k2_bvfunc_2 X1 X2) -> m1_eqrel_1 X3 X1 -> r2_hidden X4 X3 -> m1_subset_1 X2 (k1_zfmisc_1 (k1_bvfunc_2 X1)) -> False)
  -> (forall X3 X2 X4 X1, (v1_xboole_0 X1 -> False) -> (m1_subset_1 (esk7_4 X1 X2 X3 X4) (k1_zfmisc_1 (k1_zfmisc_1 X1)) -> False) -> X3 = (k2_bvfunc_2 X1 X2) -> m1_eqrel_1 X3 X1 -> r2_hidden X4 X3 -> m1_subset_1 X2 (k1_zfmisc_1 (k1_bvfunc_2 X1)) -> False)
  -> (forall X4 X3 X1 X2, ((k8_setfam_1 X2 (esk7_4 X2 X3 X4 X1)) = X1 -> False) -> (v1_xboole_0 X2 -> False) -> X4 = (k2_bvfunc_2 X2 X3) -> m1_eqrel_1 X4 X2 -> r2_hidden X1 X4 -> m1_subset_1 X3 (k1_zfmisc_1 (k1_bvfunc_2 X2)) -> False)
  -> (forall X3 X2 X4 X1, ((k9_xtuple_0 (esk6_4 X1 X2 X3 X4)) = X2 -> False) -> (v1_xboole_0 X1 -> False) -> X3 = (k2_bvfunc_2 X1 X2) -> m1_eqrel_1 X3 X1 -> r2_hidden X4 X3 -> m1_subset_1 X2 (k1_zfmisc_1 (k1_bvfunc_2 X1)) -> False)
  -> (forall X3 X2 X4 X1, (v1_xboole_0 X1 -> False) -> (v1_funct_1 (esk6_4 X1 X2 X3 X4) -> False) -> X3 = (k2_bvfunc_2 X1 X2) -> m1_eqrel_1 X3 X1 -> r2_hidden X4 X3 -> m1_subset_1 X2 (k1_zfmisc_1 (k1_bvfunc_2 X1)) -> False)
  -> (forall X3 X2 X4 X1, (v1_xboole_0 X1 -> False) -> (v1_relat_1 (esk6_4 X1 X2 X3 X4) -> False) -> X3 = (k2_bvfunc_2 X1 X2) -> m1_eqrel_1 X3 X1 -> r2_hidden X4 X3 -> m1_subset_1 X2 (k1_zfmisc_1 (k1_bvfunc_2 X1)) -> False)
  -> (forall X1 X3 X2, (X3 = (k3_xboole_0 X1 X2) -> False) -> r2_hidden (esk24_3 X1 X2 X3) X3 -> r2_hidden (esk24_3 X1 X2 X3) X2 -> r2_hidden (esk24_3 X1 X2 X3) X1 -> False)
  ...
  -> (forall X3 X4 X1 X2, (X1 = X2 -> False) -> ((k10_xtuple_0 (k4_funct_4 X1 X2 X3 X4)) = (k1_enumset1 X3 X3 X4) -> False) -> False)
  ...
  -> (forall X1 X3 X2 X4, (X4 = (k2_bvfunc_2 X3 X2) -> False) -> (v1_xboole_0 X3 -> False) -> (r2_hidden (esk9_3 X3 X2 X4) X4 -> False) -> (r2_hidden (k1_funct_1 (esk11_3 X3 X2 X4) X1) X1 -> False) -> m1_eqrel_1 X4 X3 -> r2_hidden X1 X2 -> m1_subset_1 X2 (k1_zfmisc_1 (k1_bvfunc_2 X3)) -> False)
  ...
  -> (forall X2 X3 X1, (X3 = (k2_bvfunc_2 X1 X2) -> False) -> ((k8_setfam_1 X1 (esk12_3 X1 X2 X3)) = (esk9_3 X1 X2 X3) -> False) -> (v1_xboole_0 X1 -> False) -> (r2_hidden (esk9_3 X1 X2 X3) X3 -> False) -> m1_eqrel_1 X3 X1 -> m1_subset_1 X2 (k1_zfmisc_1 (k1_bvfunc_2 X1)) -> False)
  -> (forall X2 X3 X1, (X3 = (k2_bvfunc_2 X1 X2) -> False) -> ((k10_xtuple_0 (esk11_3 X1 X2 X3)) = (esk12_3 X1 X2 X3) -> False) -> (v1_xboole_0 X1 -> False) -> (r2_hidden (esk9_3 X1 X2 X3) X3 -> False) -> m1_eqrel_1 X3 X1 -> m1_subset_1 X2 (k1_zfmisc_1 (k1_bvfunc_2 X1)) -> False)
  ...
  -> (forall X2 X3 X1, (X3 = (k2_bvfunc_2 X1 X2) -> False) -> (v1_xboole_0 X1 -> False) -> (r2_hidden (esk9_3 X1 X2 X3) X3 -> False) -> (m1_subset_1 (esk12_3 X1 X2 X3) (k1_zfmisc_1 (k1_zfmisc_1 X1)) -> False) -> m1_eqrel_1 X3 X1 -> m1_subset_1 X2 (k1_zfmisc_1 (k1_bvfunc_2 X1)) -> False)
  -> (forall X3 X2 X1, (X3 = (k1_enumset1 X1 X1 X2) -> False) -> (esk17_3 X1 X2 X3) = X1 -> r2_hidden (esk17_3 X1 X2 X3) X3 -> False)
  -> (forall X3 X2 X1, (X3 = (k1_enumset1 X1 X1 X2) -> False) -> (esk17_3 X1 X2 X3) = X2 -> r2_hidden (esk17_3 X1 X2 X3) X3 -> False)
  -> (forall X2 X3 X1, (X3 = (k2_bvfunc_2 X1 X2) -> False) -> ((k9_xtuple_0 (esk11_3 X1 X2 X3)) = X2 -> False) -> (v1_xboole_0 X1 -> False) -> (r2_hidden (esk9_3 X1 X2 X3) X3 -> False) -> m1_eqrel_1 X3 X1 -> m1_subset_1 X2 (k1_zfmisc_1 (k1_bvfunc_2 X1)) -> False)
  -> (forall X2 X3 X1, (X3 = (k6_subset_1 X1 X2) -> False) -> (r2_hidden (esk30_3 X1 X2 X3) X3 -> False) -> r2_hidden (esk30_3 X1 X2 X3) X2 -> False)
  -> (forall X2 X3 X1, (X3 = (k2_bvfunc_2 X1 X2) -> False) -> (v1_xboole_0 X1 -> False) -> (v1_funct_1 (esk11_3 X1 X2 X3) -> False) -> (r2_hidden (esk9_3 X1 X2 X3) X3 -> False) -> m1_eqrel_1 X3 X1 -> m1_subset_1 X2 (k1_zfmisc_1 (k1_bvfunc_2 X1)) -> False)
  -> (forall X2 X3 X1, (X3 = (k2_bvfunc_2 X1 X2) -> False) -> (v1_xboole_0 X1 -> False) -> (v1_relat_1 (esk11_3 X1 X2 X3) -> False) -> (r2_hidden (esk9_3 X1 X2 X3) X3 -> False) -> m1_eqrel_1 X3 X1 -> m1_subset_1 X2 (k1_zfmisc_1 (k1_bvfunc_2 X1)) -> False)
  ...
  -> (forall X2 X3 X1, (X3 = (k2_bvfunc_2 X1 X2) -> False) -> (v1_xboole_0 X1 -> False) -> (r2_hidden (esk9_3 X1 X2 X3) X3 -> False) -> (esk9_3 X1 X2 X3) = k1_xboole_0 -> m1_eqrel_1 X3 X1 -> m1_subset_1 X2 (k1_zfmisc_1 (k1_bvfunc_2 X1)) -> False)
  -> (forall X3 X2 X1, (k6_subset_1 (k1_enumset1 X1 X1 X3) X2) = (k1_enumset1 X1 X1 X3) -> r2_hidden X1 X2 -> False)
  -> (forall X3 X2 X1, (k6_subset_1 (k1_enumset1 X3 X3 X1) X2) = (k1_enumset1 X3 X3 X1) -> r2_hidden X1 X2 -> False)
  -> (forall X3 X2 X1, (X3 = (k1_enumset1 X1 X1 X2) -> False) -> ((esk17_3 X1 X2 X3) = X2 -> False) -> ((esk17_3 X1 X2 X3) = X1 -> False) -> (r2_hidden (esk17_3 X1 X2 X3) X3 -> False) -> False)
  -> (forall X1 X3 X2, (X3 = (k6_subset_1 X1 X2) -> False) -> (r2_hidden (esk30_3 X1 X2 X3) X3 -> False) -> (r2_hidden (esk30_3 X1 X2 X3) X1 -> False) -> False)
  -> (forall X1 X3 X2, (X3 = (k3_xboole_0 X1 X2) -> False) -> (r2_hidden (esk24_3 X1 X2 X3) X3 -> False) -> (r2_hidden (esk24_3 X1 X2 X3) X1 -> False) -> False)
  -> (forall X2 X3 X1, (X3 = (k3_xboole_0 X1 X2) -> False) -> (r2_hidden (esk24_3 X1 X2 X3) X3 -> False) -> (r2_hidden (esk24_3 X1 X2 X3) X2 -> False) -> False)
  ...
  -> (forall X1 X2 X3 X4, (X3 = X4 -> False) -> ((k5_bvfunc_2 X1 X3 X2) = X4 -> False) -> (v1_xboole_0 X1 -> False) -> X2 = (k1_enumset1 X3 X3 X4) -> m1_eqrel_1 X4 X1 -> m1_eqrel_1 X3 X1 -> m1_subset_1 X2 (k1_zfmisc_1 (k1_bvfunc_2 X1)) -> False)
  -> (forall X3 X1 X2, (X2 = k1_xboole_0 -> False) -> (r2_hidden X1 X3 -> False) -> X3 = (k1_setfam_1 X2) -> r2_hidden X1 (esk13_3 X2 X3 X1) -> False)
  -> (forall X1 X2, ((esk22_2 X1 X2) = k1_xboole_0 -> False) -> (m1_eqrel_1 X2 X1 -> False) -> (k5_setfam_1 X1 X2) = X1 -> m1_subset_1 X2 (k1_zfmisc_1 (k1_zfmisc_1 X1)) -> r1_xboole_0 (esk22_2 X1 X2) (esk23_2 X1 X2) -> False)
  -> (forall X3 X2 X1, ((k6_subset_1 (k1_enumset1 X1 X1 X3) X2) = (k1_enumset1 X1 X1 X3) -> False) -> (r2_hidden X3 X2 -> False) -> (r2_hidden X1 X2 -> False) -> False)
  ...
  -> (forall X2 X1, (X1 = k1_xboole_0 -> False) -> (X2 = (k1_setfam_1 X1) -> False) -> r2_hidden (esk14_2 X1 X2) X2 -> r2_hidden (esk14_2 X1 X2) (esk15_2 X1 X2) -> False)
  ...
  -> (forall X1 X2, ((esk22_2 X1 X2) = k1_xboole_0 -> False) -> (m1_eqrel_1 X2 X1 -> False) -> (m1_subset_1 (esk23_2 X1 X2) (k1_zfmisc_1 X1) -> False) -> (k5_setfam_1 X1 X2) = X1 -> m1_subset_1 X2 (k1_zfmisc_1 (k1_zfmisc_1 X1)) -> False)
  -> (forall X1 X2, ((esk22_2 X1 X2) = k1_xboole_0 -> False) -> (m1_eqrel_1 X2 X1 -> False) -> (k5_setfam_1 X1 X2) = X1 -> (esk23_2 X1 X2) = (esk22_2 X1 X2) -> m1_subset_1 X2 (k1_zfmisc_1 (k1_zfmisc_1 X1)) -> False)
  ...
  -> (forall X2 X3 X1, (X1 = k1_xboole_0 -> False) -> (r2_hidden X3 X2 -> False) -> (r2_hidden (esk13_3 X1 X2 X3) X1 -> False) -> X2 = (k1_setfam_1 X1) -> False)
  -> (forall X1 X2, ((esk22_2 X1 X2) = k1_xboole_0 -> False) -> (m1_eqrel_1 X2 X1 -> False) -> (r2_hidden (esk23_2 X1 X2) X2 -> False) -> (k5_setfam_1 X1 X2) = X1 -> m1_subset_1 X2 (k1_zfmisc_1 (k1_zfmisc_1 X1)) -> False)
  -> (forall X1 X2, (m1_eqrel_1 X2 X1 -> False) -> (m1_subset_1 (esk22_2 X1 X2) (k1_zfmisc_1 X1) -> False) -> (k5_setfam_1 X1 X2) = X1 -> m1_subset_1 X2 (k1_zfmisc_1 (k1_zfmisc_1 X1)) -> False)
  ...
  -> (forall X1 X2, (m1_eqrel_1 X2 X1 -> False) -> (r2_hidden (esk22_2 X1 X2) X2 -> False) -> (k5_setfam_1 X1 X2) = X1 -> m1_subset_1 X2 (k1_zfmisc_1 (k1_zfmisc_1 X1)) -> False)
  ...
  -> (forall X3 X2 X1 X4, (X1 = X4 -> False) -> (X1 = X3 -> False) -> X2 = (k1_enumset1 X3 X3 X4) -> r2_hidden X1 X2 -> False)
  ...
  -> (forall X2 X1, (X1 = k1_xboole_0 -> False) -> (X2 = (k1_setfam_1 X1) -> False) -> (r2_hidden (esk15_2 X1 X2) X1 -> False) -> r2_hidden (esk14_2 X1 X2) X2 -> False)
  -> (forall X2 X3 X1, (X1 = k1_xboole_0 -> False) -> (X2 = (k1_setfam_1 X1) -> False) -> (r2_hidden (esk14_2 X1 X2) X3 -> False) -> (r2_hidden (esk14_2 X1 X2) X2 -> False) -> r2_hidden X3 X1 -> False)
  ...
  -> (forall X2 X4 X1 X3, (r2_hidden X1 X3 -> False) -> X1 = X2 -> X3 = (k1_enumset1 X2 X2 X4) -> False)
  -> (forall X2 X4 X1 X3, (r2_hidden X1 X3 -> False) -> X1 = X2 -> X3 = (k1_enumset1 X4 X4 X2) -> False)
  ...
  -> (forall X2 X1, (X2 = (k1_tarski X1) -> False) -> (esk16_2 X1 X2) = X1 -> r2_hidden (esk16_2 X1 X2) X2 -> False)
  ...
  -> (forall X2 X1, ((k2_partit1 X1 X2 X2) = X2 -> False) -> (v1_xboole_0 X1 -> False) -> m1_eqrel_1 X2 X1 -> False)
  ...
  -> (forall X2 X1, (X2 = (k1_tarski X1) -> False) -> ((esk16_2 X1 X2) = X1 -> False) -> (r2_hidden (esk16_2 X1 X2) X2 -> False) -> False)
  ...
  -> (forall X1 X2, (r1_tarski X1 X2 -> False) -> (k6_subset_1 X1 X2) = k1_xboole_0 -> False)
  -> (forall X2 X1, ((k6_subset_1 X1 X2) = k1_xboole_0 -> False) -> r1_tarski X1 X2 -> False)
  ...
  -> (forall X1, (v1_xboole_0 X1 -> False) -> (v1_subset_1 (esk43_1 X1) X1 -> False) -> False)
  -> (forall X1, (v1_xboole_0 X1 -> False) -> (m1_eqrel_1 (esk42_1 X1) X1 -> False) -> False)
  -> (forall X1, (v1_xboole_0 X1 -> False) -> (m1_eqrel_1 (esk37_1 X1) X1 -> False) -> False)
  ...
  -> (forall X1, (v1_xboole_0 X1 -> False) -> (v1_setfam_1 (esk42_1 X1) -> False) -> False)
  -> (forall X1, (v1_xboole_0 X1 -> False) -> (v1_setfam_1 (esk37_1 X1) -> False) -> False)
  ...
  -> (forall X2 X1, v1_xboole_0 (k1_enumset1 X1 X1 X2) -> False)
  -> (forall X3 X2 X1, v1_xboole_0 (k1_enumset1 X1 X2 X3) -> False)
  -> ((k5_bvfunc_2 esk1_0 esk3_0 esk2_0) = (k2_partit1 esk1_0 esk4_0 esk5_0) -> False)
  -> (forall X1, v1_subset_1 (esk41_1 X1) X1 -> False)
  -> (forall X1, v1_xboole_0 (esk40_1 X1) -> False)
  ...
  -> (esk5_0 = esk3_0 -> False)
  -> (esk4_0 = esk3_0 -> False)
  -> (forall X4 X3 X1 X2, (r1_tarski (k10_xtuple_0 (k4_funct_4 X1 X2 X3 X4)) (k1_enumset1 X3 X3 X4) -> False) -> False)
  -> (forall X2 X1 X4 X3, ((k9_xtuple_0 (k4_funct_4 X1 X2 X3 X4)) = (k1_enumset1 X1 X1 X2) -> False) -> False)
  ...
  -> (forall X3 X2 X1, ((k2_xboole_0 (k1_tarski X1) (k1_enumset1 X2 X2 X3)) = (k1_enumset1 X1 X2 X3) -> False) -> False)
  -> (forall X1 X2, ((k1_enumset1 X1 X1 X2) = (k1_enumset1 X2 X2 X1) -> False) -> False)
  -> (forall X1 X3 X2, ((k1_enumset1 X1 X2 X3) = (k1_enumset1 X2 X3 X1) -> False) -> False)
  -> (forall X2 X1 X3, ((k2_xboole_0 (k6_subset_1 X1 X3) (k6_subset_1 X2 X3)) = (k6_subset_1 (k2_xboole_0 X1 X2) X3) -> False) -> False)
  -> (forall X1, (m1_subset_1 (esk40_1 X1) (k1_zfmisc_1 (k1_zfmisc_1 (k1_zfmisc_1 X1))) -> False) -> False)
  ...
  -> (((k1_enumset1 esk3_0 esk4_0 esk5_0) = esk2_0 -> False) -> False)
