...
Theorem t3_aff_3:
 ...
 forall r1_aff_1:set -> set -> set -> set -> prop,
  ...
  -> (forall X1 X2 X4 X6 X5 X3, (epred2_6 X1 X6 X5 X4 X3 X2 -> False) -> r2_analoaf X1 (esk31_6 X2 X3 X4 X5 X6 X1) (esk32_6 X2 X3 X4 X5 X6 X1) (esk34_6 X2 X3 X4 X5 X6 X1) (esk35_6 X2 X3 X4 X5 X6 X1) -> False)
  -> (forall X1 X3 X5 X6 X4 X2, (epred2_6 X1 X6 X5 X4 X3 X2 -> False) -> (r2_analoaf X1 X2 (esk32_6 X2 X3 X4 X5 X6 X1) (esk33_6 X2 X3 X4 X5 X6 X1) (esk35_6 X2 X3 X4 X5 X6 X1) -> False) -> False)
  -> (forall X1 X3 X5 X6 X4 X2, (epred2_6 X1 X6 X5 X4 X3 X2 -> False) -> (r2_analoaf X1 X2 (esk31_6 X2 X3 X4 X5 X6 X1) (esk33_6 X2 X3 X4 X5 X6 X1) (esk34_6 X2 X3 X4 X5 X6 X1) -> False) -> False)
  -> (forall X6 X2 X4 X5 X3 X1, (epred2_6 X6 X5 X4 X3 X2 X1 -> False) -> (m1_subset_1 (esk35_6 X1 X2 X3 X4 X5 X6) (u1_struct_0 X6) -> False) -> False)
  -> (forall X6 X2 X4 X5 X3 X1, (epred2_6 X6 X5 X4 X3 X2 X1 -> False) -> (m1_subset_1 (esk34_6 X1 X2 X3 X4 X5 X6) (u1_struct_0 X6) -> False) -> False)
  -> (forall X6 X2 X4 X5 X3 X1, (epred2_6 X6 X5 X4 X3 X2 X1 -> False) -> (m1_subset_1 (esk33_6 X1 X2 X3 X4 X5 X6) (u1_struct_0 X6) -> False) -> False)
  -> (forall X6 X2 X4 X5 X3 X1, (epred2_6 X6 X5 X4 X3 X2 X1 -> False) -> (m1_subset_1 (esk32_6 X1 X2 X3 X4 X5 X6) (u1_struct_0 X6) -> False) -> False)
  ...
  -> (forall X3 X2 X4 X5 X6 X1, (epred2_6 X6 X5 X4 X3 X2 X1 -> False) -> (r2_hidden (esk35_6 X1 X2 X3 X4 X5 X6) X3 -> False) -> False)
  -> (forall X4 X2 X5 X6 X3 X1, (epred2_6 X6 X5 X4 X3 X2 X1 -> False) -> (r2_hidden (esk34_6 X1 X2 X3 X4 X5 X6) X4 -> False) -> False)
  -> (forall X5 X2 X4 X6 X3 X1, (epred2_6 X6 X5 X4 X3 X2 X1 -> False) -> (r2_hidden (esk33_6 X1 X2 X3 X4 X5 X6) X5 -> False) -> False)
  -> (forall X3 X2 X4 X5 X6 X1, (epred2_6 X6 X5 X4 X3 X2 X1 -> False) -> (r2_hidden (esk32_6 X1 X2 X3 X4 X5 X6) X3 -> False) -> False)
  -> (forall X4 X2 X5 X6 X3 X1, (epred2_6 X6 X5 X4 X3 X2 X1 -> False) -> (r2_hidden (esk31_6 X1 X2 X3 X4 X5 X6) X4 -> False) -> False)
  -> (forall X1 X4 X5 X6 X3 X2, (epred2_6 X6 X5 X4 X3 X1 X2 -> False) -> (esk32_6 X2 X1 X3 X4 X5 X6) = X1 -> False)
  -> (forall X1 X4 X5 X6 X3 X2, (epred2_6 X6 X5 X4 X3 X1 X2 -> False) -> (esk31_6 X2 X1 X3 X4 X5 X6) = X1 -> False)
  ...
  -> (forall X1 X2, ((k2_aff_1 X2 (esk15_2 X2 X1) (esk16_2 X2 X1)) = X1 -> False) -> (v7_struct_0 X2 -> False) -> v1_diraf X2 -> l1_analoaf X2 -> v1_aff_1 X1 X2 -> m1_subset_1 X1 (k1_zfmisc_1 (u1_struct_0 X2)) -> False)
  ...
  -> (forall X2 X1, (v7_struct_0 X1 -> False) -> (m1_subset_1 (esk15_2 X1 X2) (u1_struct_0 X1) -> False) -> v1_diraf X1 -> l1_analoaf X1 -> v1_aff_1 X2 X1 -> m1_subset_1 X2 (k1_zfmisc_1 (u1_struct_0 X1)) -> False)
  -> (forall X2 X1, (v7_struct_0 X1 -> False) -> (esk16_2 X1 X2) = (esk15_2 X1 X2) -> v1_diraf X1 -> l1_analoaf X1 -> v1_aff_1 X2 X1 -> m1_subset_1 X2 (k1_zfmisc_1 (u1_struct_0 X1)) -> False)
