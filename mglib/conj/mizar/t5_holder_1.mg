...
Theorem t5_holder_1:
 ...
 forall k10_prepower:set -> set -> set,
 forall np__1:set,
 ...
 forall esk3_0:set,
 forall esk1_0:set,
     ((k4_power esk4_0 esk2_0) = (k4_power esk3_0 esk1_0) -> (k7_real_1 (k10_real_1 (k4_power esk3_0 esk1_0) esk1_0) (k10_real_1 (k4_power esk4_0 esk2_0) esk2_0)) = (k8_real_1 esk3_0 esk4_0) -> r1_xxreal_0 (k8_real_1 esk3_0 esk4_0) (k7_real_1 (k10_real_1 (k4_power esk3_0 esk1_0) esk1_0) (k10_real_1 (k4_power esk4_0 esk2_0) esk2_0)) -> False)
  -> (((k4_power esk4_0 esk2_0) = (k4_power esk3_0 esk1_0) -> False) -> ((k7_real_1 (k10_real_1 (k4_power esk3_0 esk1_0) esk1_0) (k10_real_1 (k4_power esk4_0 esk2_0) esk2_0)) = (k8_real_1 esk3_0 esk4_0) -> False) -> r1_xxreal_0 (k8_real_1 esk3_0 esk4_0) (k7_real_1 (k10_real_1 (k4_power esk3_0 esk1_0) esk1_0) (k10_real_1 (k4_power esk4_0 esk2_0) esk2_0)) -> False)
  -> (forall X2 X4 X1 X3, (r1_xxreal_0 X3 np__1 -> False) -> (r1_xxreal_0 X2 k6_numbers -> False) -> (r1_xxreal_0 X1 k6_numbers -> False) -> (r1_xxreal_0 (k8_real_1 X1 X2) (k7_real_1 (k10_real_1 (k10_prepower X1 X3) X3) (k10_real_1 (k10_prepower X2 X4) X4)) -> False) -> (k7_real_1 (k10_real_1 np__1 X3) (k10_real_1 np__1 X4)) = np__1 -> m1_subset_1 X4 k1_numbers -> m1_subset_1 X3 k1_numbers -> m1_subset_1 X2 k1_numbers -> m1_subset_1 X1 k1_numbers -> False)
  -> (forall X2 X4 X1 X3, ((k10_prepower X1 X3) = (k10_prepower X2 X4) -> False) -> (r1_xxreal_0 X3 np__1 -> False) -> (r1_xxreal_0 X2 k6_numbers -> False) -> (r1_xxreal_0 X1 k6_numbers -> False) -> (k7_real_1 (k10_real_1 np__1 X3) (k10_real_1 np__1 X4)) = np__1 -> (k7_real_1 (k10_real_1 (k10_prepower X1 X3) X3) (k10_real_1 (k10_prepower X2 X4) X4)) = (k8_real_1 X1 X2) -> m1_subset_1 X4 k1_numbers -> m1_subset_1 X3 k1_numbers -> m1_subset_1 X2 k1_numbers -> m1_subset_1 X1 k1_numbers -> False)
  -> (forall X2 X4 X1 X3, ((k7_real_1 (k10_real_1 (k10_prepower X1 X2) X2) (k10_real_1 (k10_prepower X3 X4) X4)) = (k8_real_1 X1 X3) -> False) -> (r1_xxreal_0 X3 k6_numbers -> False) -> (r1_xxreal_0 X2 np__1 -> False) -> (r1_xxreal_0 X1 k6_numbers -> False) -> (k10_prepower X1 X2) = (k10_prepower X3 X4) -> (k7_real_1 (k10_real_1 np__1 X2) (k10_real_1 np__1 X4)) = np__1 -> m1_subset_1 X4 k1_numbers -> m1_subset_1 X3 k1_numbers -> m1_subset_1 X2 k1_numbers -> m1_subset_1 X1 k1_numbers -> False)
  -> (forall X2 X1 X3, ((k4_prepower X2 (esk25_3 X2 X3 X1)) = X1 -> False) -> X1 = (k3_power X2 X3) -> v1_int_1 X3 -> epred1_3 X1 X3 X2 -> False)
  -> (forall X1 X3 X2, (v1_int_1 (esk25_3 X1 X2 X3) -> False) -> X3 = (k3_power X1 X2) -> v1_int_1 X2 -> epred1_3 X3 X2 X1 -> False)
  -> (forall X1 X3 X2, ((esk25_3 X1 X2 X3) = X2 -> False) -> X3 = (k3_power X1 X2) -> v1_int_1 X2 -> epred1_3 X3 X2 X1 -> False)
  -> (forall X2 X1 X4 X3, (r1_xxreal_0 X4 X3 -> False) -> v1_xreal_0 X4 -> v1_xreal_0 X3 -> v1_xreal_0 X2 -> v1_xreal_0 X1 -> r1_xxreal_0 X1 X2 -> r1_xxreal_0 (k6_xcmplx_0 X2 X3) (k6_xcmplx_0 X1 X4) -> False)
  ...
  -> (forall X2 X1, (m1_subset_1 (k10_prepower X1 X2) k1_numbers -> False) -> m1_subset_1 X2 k1_numbers -> m1_subset_1 X1 k1_numbers -> False)
  ...
  -> (forall X2 X1, ((k10_prepower X1 X2) = (k9_prepower X1 X2) -> False) -> m1_subset_1 X2 k1_numbers -> m1_subset_1 X1 k1_numbers -> False)
  ...
  -> (((k7_real_1 (k10_real_1 np__1 esk1_0) (k10_real_1 np__1 esk2_0)) = np__1 -> False) -> False)
  ...
  -> ((r1_xxreal_0 k6_numbers esk4_0 -> False) -> False)
  -> ((r1_xxreal_0 k6_numbers esk3_0 -> False) -> False)
