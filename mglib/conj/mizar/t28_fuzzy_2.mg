...
Theorem t28_fuzzy_2:
 ...
 forall k3_fuzzy_2:set -> set -> set -> set,
  ...
  -> (forall X3 X1 X2, (v1_xboole_0 X2 -> False) -> (r2_fuzzy_1 X2 X1 X3 -> False) -> v1_funct_1 X3 -> v1_funct_1 X1 -> v1_funct_2 X3 X2 k1_numbers -> v1_funct_2 X1 X2 k1_numbers -> v5_relat_1 X3 (k1_rcomp_1 k6_numbers np__1) -> v5_relat_1 X1 (k1_rcomp_1 k6_numbers np__1) -> m1_subset_1 X3 (k1_zfmisc_1 (k2_zfmisc_1 X2 k1_numbers)) -> m1_subset_1 X1 (k1_zfmisc_1 (k2_zfmisc_1 X2 k1_numbers)) -> r1_xxreal_0 (k1_seq_1 X1 (esk3_3 X2 X1 X3)) (k1_seq_1 X3 (esk3_3 X2 X1 X3)) -> False)
  ...
  -> (r1_fuzzy_1 esk2_0 (k3_fuzzy_2 esk1_0 esk2_0 esk2_0) -> r1_fuzzy_1 (k2_fuzzy_2 esk1_0 esk2_0 esk2_0) esk2_0 -> False)
