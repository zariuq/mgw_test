...
Theorem t86_setlim_2:
 forall k7_setlim_2:set -> set -> set -> set,
 ...
 forall k3_kurato_0:set -> set -> set,
     (forall X4 X2 X3 X1, (r2_hidden X1 (k3_kurato_0 X2 X3) -> False) -> v1_funct_1 X3 -> m1_subset_1 X4 k5_numbers -> v1_funct_2 X3 k5_numbers (k1_zfmisc_1 X2) -> m1_subset_1 X3 (k1_zfmisc_1 (k2_zfmisc_1 k5_numbers (k1_zfmisc_1 X2))) -> r2_hidden X1 (k3_funct_2 k5_numbers (k1_zfmisc_1 X2) X3 (k2_nat_1 X4 (esk23_4 X2 X3 X1 X4))) -> False)
  -> (forall X2 X4 X1 X3, (X2 = (k7_setlim_2 X1 X3 X4) -> False) -> (k8_nat_1 (k1_zfmisc_1 X1) X2 (esk6_4 X1 X3 X4 X2)) = (k7_subset_1 X1 X4 (k8_nat_1 (k1_zfmisc_1 X1) X3 (esk6_4 X1 X3 X4 X2))) -> v1_funct_1 X3 -> v1_funct_1 X2 -> m1_subset_1 X4 (k1_zfmisc_1 X1) -> v1_funct_2 X3 k5_numbers (k1_zfmisc_1 X1) -> v1_funct_2 X2 k5_numbers (k1_zfmisc_1 X1) -> m1_subset_1 X3 (k1_zfmisc_1 (k2_zfmisc_1 k5_numbers (k1_zfmisc_1 X1))) -> m1_subset_1 X2 (k1_zfmisc_1 (k2_zfmisc_1 k5_numbers (k1_zfmisc_1 X1))) -> False)
  -> (forall X4 X1 X2 X3, (r2_hidden X1 (k3_funct_2 k5_numbers (k1_zfmisc_1 X2) X3 (k2_nat_1 X4 (esk24_4 X2 X3 X1 X4))) -> False) -> v1_funct_1 X3 -> m1_subset_1 X4 k5_numbers -> r2_hidden X1 (k4_kurato_0 X2 X3) -> v1_funct_2 X3 k5_numbers (k1_zfmisc_1 X2) -> m1_subset_1 X3 (k1_zfmisc_1 (k2_zfmisc_1 k5_numbers (k1_zfmisc_1 X2))) -> False)
  -> (forall X1 X3 X4 X2, (r2_hidden X2 (k4_kurato_0 X3 X4) -> False) -> v1_funct_1 X4 -> m1_subset_1 X1 k5_numbers -> v1_funct_2 X4 k5_numbers (k1_zfmisc_1 X3) -> m1_subset_1 X4 (k1_zfmisc_1 (k2_zfmisc_1 k5_numbers (k1_zfmisc_1 X3))) -> r2_hidden X2 (k3_funct_2 k5_numbers (k1_zfmisc_1 X3) X4 (k2_nat_1 (esk25_3 X3 X4 X2) X1)) -> False)
  -> (forall X1 X2 X3 X4, (r2_hidden X2 (k3_funct_2 k5_numbers (k1_zfmisc_1 X3) X4 (k2_nat_1 (esk22_3 X3 X4 X2) X1)) -> False) -> v1_funct_1 X4 -> m1_subset_1 X1 k5_numbers -> r2_hidden X2 (k3_kurato_0 X3 X4) -> v1_funct_2 X4 k5_numbers (k1_zfmisc_1 X3) -> m1_subset_1 X4 (k1_zfmisc_1 (k2_zfmisc_1 k5_numbers (k1_zfmisc_1 X3))) -> False)
  -> (forall X2 X3 X1 X4, (X4 = (k7_setlim_2 X1 X2 X3) -> False) -> (m1_subset_1 (esk6_4 X1 X2 X3 X4) k5_numbers -> False) -> v1_funct_1 X4 -> v1_funct_1 X2 -> m1_subset_1 X3 (k1_zfmisc_1 X1) -> v1_funct_2 X4 k5_numbers (k1_zfmisc_1 X1) -> v1_funct_2 X2 k5_numbers (k1_zfmisc_1 X1) -> m1_subset_1 X4 (k1_zfmisc_1 (k2_zfmisc_1 k5_numbers (k1_zfmisc_1 X1))) -> m1_subset_1 X2 (k1_zfmisc_1 (k2_zfmisc_1 k5_numbers (k1_zfmisc_1 X1))) -> False)
  -> (forall X5 X4 X3 X2 X1, ((k8_nat_1 (k1_zfmisc_1 X2) X1 X5) = (k7_subset_1 X2 X4 (k8_nat_1 (k1_zfmisc_1 X2) X3 X5)) -> False) -> X1 = (k7_setlim_2 X2 X3 X4) -> v1_funct_1 X3 -> v1_funct_1 X1 -> m1_subset_1 X5 k5_numbers -> m1_subset_1 X4 (k1_zfmisc_1 X2) -> v1_funct_2 X3 k5_numbers (k1_zfmisc_1 X2) -> v1_funct_2 X1 k5_numbers (k1_zfmisc_1 X2) -> m1_subset_1 X3 (k1_zfmisc_1 (k2_zfmisc_1 k5_numbers (k1_zfmisc_1 X2))) -> m1_subset_1 X1 (k1_zfmisc_1 (k2_zfmisc_1 k5_numbers (k1_zfmisc_1 X2))) -> False)
  -> (forall X4 X3 X1 X2, (m1_subset_1 (esk24_4 X1 X2 X3 X4) k5_numbers -> False) -> v1_funct_1 X2 -> m1_subset_1 X4 k5_numbers -> r2_hidden X3 (k4_kurato_0 X1 X2) -> v1_funct_2 X2 k5_numbers (k1_zfmisc_1 X1) -> m1_subset_1 X2 (k1_zfmisc_1 (k2_zfmisc_1 k5_numbers (k1_zfmisc_1 X1))) -> False)
  -> (forall X4 X1 X2 X3, (r2_hidden X3 (k3_kurato_0 X1 X2) -> False) -> (m1_subset_1 (esk23_4 X1 X2 X3 X4) k5_numbers -> False) -> v1_funct_1 X2 -> m1_subset_1 X4 k5_numbers -> v1_funct_2 X2 k5_numbers (k1_zfmisc_1 X1) -> m1_subset_1 X2 (k1_zfmisc_1 (k2_zfmisc_1 k5_numbers (k1_zfmisc_1 X1))) -> False)
  ...
  -> (forall X2 X1 X3, (r1_tarski (k7_subset_1 X2 X1 (k4_kurato_0 X2 X3)) (k4_kurato_0 X2 (k7_setlim_2 X2 X3 X1)) -> False) -> v1_funct_1 X3 -> m1_subset_1 X1 (k1_zfmisc_1 X2) -> v1_funct_2 X3 k5_numbers (k1_zfmisc_1 X2) -> m1_subset_1 X3 (k1_zfmisc_1 (k2_zfmisc_1 k5_numbers (k1_zfmisc_1 X2))) -> False)
  ...
  -> (forall X1 X3 X2, (m1_subset_1 (k7_setlim_2 X1 X2 X3) (k1_zfmisc_1 (k2_zfmisc_1 k5_numbers (k1_zfmisc_1 X1))) -> False) -> v1_funct_1 X2 -> m1_subset_1 X3 (k1_zfmisc_1 X1) -> v1_funct_2 X2 k5_numbers (k1_zfmisc_1 X1) -> m1_subset_1 X2 (k1_zfmisc_1 (k2_zfmisc_1 k5_numbers (k1_zfmisc_1 X1))) -> False)
  -> (forall X1 X3 X2, (v1_funct_2 (k7_setlim_2 X1 X2 X3) k5_numbers (k1_zfmisc_1 X1) -> False) -> v1_funct_1 X2 -> m1_subset_1 X3 (k1_zfmisc_1 X1) -> v1_funct_2 X2 k5_numbers (k1_zfmisc_1 X1) -> m1_subset_1 X2 (k1_zfmisc_1 (k2_zfmisc_1 k5_numbers (k1_zfmisc_1 X1))) -> False)
  -> (forall X1 X3 X2, (m1_subset_1 (esk22_3 X1 X2 X3) k5_numbers -> False) -> v1_funct_1 X2 -> r2_hidden X3 (k3_kurato_0 X1 X2) -> v1_funct_2 X2 k5_numbers (k1_zfmisc_1 X1) -> m1_subset_1 X2 (k1_zfmisc_1 (k2_zfmisc_1 k5_numbers (k1_zfmisc_1 X1))) -> False)
  -> (forall X3 X1 X2, (r2_hidden X3 (k4_kurato_0 X1 X2) -> False) -> (m1_subset_1 (esk25_3 X1 X2 X3) k5_numbers -> False) -> v1_funct_1 X2 -> v1_funct_2 X2 k5_numbers (k1_zfmisc_1 X1) -> m1_subset_1 X2 (k1_zfmisc_1 (k2_zfmisc_1 k5_numbers (k1_zfmisc_1 X1))) -> False)
  -> (forall X1 X3 X2, (v1_funct_1 (k7_setlim_2 X1 X2 X3) -> False) -> v1_funct_1 X2 -> m1_subset_1 X3 (k1_zfmisc_1 X1) -> v1_funct_2 X2 k5_numbers (k1_zfmisc_1 X1) -> m1_subset_1 X2 (k1_zfmisc_1 (k2_zfmisc_1 k5_numbers (k1_zfmisc_1 X1))) -> False)
  ...
  -> (forall X1 X2, (v3_kurato_0 X2 X1 -> False) -> (k3_kurato_0 X1 X2) = (k4_kurato_0 X1 X2) -> v1_funct_1 X2 -> v1_funct_2 X2 k5_numbers (k1_zfmisc_1 X1) -> m1_subset_1 X2 (k1_zfmisc_1 (k2_zfmisc_1 k5_numbers (k1_zfmisc_1 X1))) -> False)
  -> (forall X2 X1, ((k3_kurato_0 X2 X1) = (k4_kurato_0 X2 X1) -> False) -> v1_funct_1 X1 -> v3_kurato_0 X1 X2 -> v1_funct_2 X1 k5_numbers (k1_zfmisc_1 X2) -> m1_subset_1 X1 (k1_zfmisc_1 (k2_zfmisc_1 k5_numbers (k1_zfmisc_1 X2))) -> False)
  -> (forall X2 X1, (m1_subset_1 (k3_kurato_0 X2 X1) (k1_zfmisc_1 X2) -> False) -> v1_funct_1 X1 -> v1_funct_2 X1 k5_numbers (k1_zfmisc_1 X2) -> m1_subset_1 X1 (k1_zfmisc_1 (k2_zfmisc_1 k5_numbers (k1_zfmisc_1 X2))) -> False)
  -> (forall X2 X1, (m1_subset_1 (k4_kurato_0 X2 X1) (k1_zfmisc_1 X2) -> False) -> v1_funct_1 X1 -> v1_funct_2 X1 k5_numbers (k1_zfmisc_1 X2) -> m1_subset_1 X1 (k1_zfmisc_1 (k2_zfmisc_1 k5_numbers (k1_zfmisc_1 X2))) -> False)
  ...
  -> ((k7_subset_1 esk1_0 esk2_0 (k4_kurato_0 esk1_0 esk3_0)) = (k4_kurato_0 esk1_0 (k7_setlim_2 esk1_0 esk3_0 esk2_0)) -> False)
  ...
  -> ((m1_subset_1 esk3_0 (k1_zfmisc_1 (k2_zfmisc_1 k5_numbers (k1_zfmisc_1 esk1_0))) -> False) -> False)
  -> ((v1_funct_2 esk3_0 k5_numbers (k1_zfmisc_1 esk1_0) -> False) -> False)
  ...
  -> ((v3_kurato_0 esk3_0 esk1_0 -> False) -> False)
