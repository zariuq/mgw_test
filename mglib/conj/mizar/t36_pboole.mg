...
Theorem t36_pboole:
 ...
 forall r6_pboole:set -> set -> set -> prop,
     (forall X3 X2 X1 X4, (r6_pboole X2 (k2_pboole X2 X1 (k3_pboole X2 X3 X4)) (k3_pboole X2 (k2_pboole X2 X1 X3) (k2_pboole X2 X1 X4)) -> False) -> v1_relat_1 X4 -> v1_relat_1 X3 -> v1_relat_1 X1 -> v1_funct_1 X4 -> v1_funct_1 X3 -> v1_funct_1 X1 -> v4_relat_1 X4 X2 -> v4_relat_1 X3 X2 -> v4_relat_1 X1 X2 -> v1_partfun1 X4 X2 -> v1_partfun1 X3 X2 -> v1_partfun1 X1 X2 -> False)
  ...
  -> (forall X1 X2 X3, (r6_pboole X2 (k2_pboole X2 X1 (k3_pboole X2 X1 X3)) X1 -> False) -> v1_relat_1 X3 -> v1_relat_1 X1 -> v1_funct_1 X3 -> v1_funct_1 X1 -> v4_relat_1 X3 X2 -> v4_relat_1 X1 X2 -> v1_partfun1 X3 X2 -> v1_partfun1 X1 X2 -> False)
  ...
  -> (r6_pboole esk1_0 (k2_pboole esk1_0 (k2_pboole esk1_0 (k3_pboole esk1_0 esk2_0 esk3_0) (k3_pboole esk1_0 esk3_0 esk4_0)) (k3_pboole esk1_0 esk4_0 esk2_0)) (k3_pboole esk1_0 (k3_pboole esk1_0 (k2_pboole esk1_0 esk2_0 esk3_0) (k2_pboole esk1_0 esk3_0 esk4_0)) (k2_pboole esk1_0 esk4_0 esk2_0)) -> False)
