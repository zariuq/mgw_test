...
Theorem t39_ordinal3:
 ...
 forall k10_ordinal2:set -> set -> set,
     (forall X3 X1 X2, ((k10_ordinal2 X2 (esk18_3 X1 X2 X3)) = X1 -> False) -> (r2_hidden X1 X2 -> False) -> v3_ordinal1 X3 -> v3_ordinal1 X2 -> v3_ordinal1 X1 -> r2_hidden X1 (k10_ordinal2 X2 X3) -> False)
  -> (forall X3 X1 X2, (r2_hidden X1 X2 -> False) -> (r2_hidden (esk18_3 X1 X2 X3) X3 -> False) -> v3_ordinal1 X3 -> v3_ordinal1 X2 -> v3_ordinal1 X1 -> r2_hidden X1 (k10_ordinal2 X2 X3) -> False)
  -> (forall X3 X1 X2, (r2_hidden X1 X2 -> False) -> (v3_ordinal1 (esk18_3 X1 X2 X3) -> False) -> v3_ordinal1 X3 -> v3_ordinal1 X2 -> v3_ordinal1 X1 -> r2_hidden X1 (k10_ordinal2 X2 X3) -> False)
  ...
  -> (forall X2 X1, ((k10_ordinal2 esk3_0 X2) = (k1_funct_1 esk2_0 X1) -> False) -> X2 = (k1_funct_1 esk1_0 X1) -> v3_ordinal1 X2 -> v3_ordinal1 X1 -> r2_hidden X1 (k9_xtuple_0 esk1_0) -> False)
  ...
  -> (forall X2 X1, (v3_ordinal1 (k1_funct_1 X1 X2) -> False) -> v5_ordinal1 X1 -> v1_relat_1 X1 -> v1_funct_1 X1 -> v1_ordinal2 X1 -> v3_ordinal1 X2 -> False)
  -> (forall X2 X1 X3, v1_xboole_0 X3 -> r2_hidden X1 X2 -> m1_subset_1 X2 (k1_zfmisc_1 X3) -> False)
  -> (forall X1 X3 X2, (r2_hidden X3 X2 -> False) -> r2_hidden X3 X1 -> r1_tarski X1 X2 -> False)
  -> (forall X1, (m1_subset_1 (o_1_0_ordinal3 X1) (k9_xtuple_0 X1) -> False) -> v5_ordinal1 X1 -> v1_relat_1 X1 -> v1_funct_1 X1 -> v1_ordinal2 X1 -> False)
  ...
  -> ((k10_ordinal2 esk3_0 (k4_ordinal2 esk1_0)) = (k4_ordinal2 esk2_0) -> False)
