...
Theorem t14_ordinal4:
 ...
 forall k1_xboole_0:set,
     (forall X3 X1 X2 X5 X4, (X4 = k1_xboole_0 -> False) -> (r2_hidden (k1_funct_1 X1 X2) X3 -> False) -> v3_ordinal1 X5 -> v3_ordinal1 X3 -> v3_ordinal1 X2 -> r1_ordinal2 X4 X1 -> r2_hidden X5 X4 -> r2_hidden X4 X3 -> epred1_2 X1 X4 -> r2_hidden X2 (k9_xtuple_0 X1) -> r1_ordinal1 (esk31_4 X4 X1 X5 X3) X2 -> False)
  -> (forall X1 X3 X2 X5 X4, (X4 = k1_xboole_0 -> False) -> (r2_hidden X1 (k1_funct_1 X2 X3) -> False) -> v3_ordinal1 X5 -> v3_ordinal1 X3 -> v3_ordinal1 X1 -> r1_ordinal2 X4 X2 -> r2_hidden X4 X5 -> r2_hidden X1 X4 -> epred1_2 X2 X4 -> r2_hidden X3 (k9_xtuple_0 X2) -> r1_ordinal1 (esk31_4 X4 X2 X1 X5) X3 -> False)
  -> (forall X2 X3 X1, (X1 = k1_xboole_0 -> False) -> (r1_ordinal2 X1 X2 -> False) -> v3_ordinal1 X3 -> epred1_2 X2 X1 -> r2_hidden X3 (k9_xtuple_0 X2) -> r2_hidden (esk32_2 X1 X2) (k1_funct_1 X2 (esk34_3 X1 X2 X3)) -> r2_hidden (k1_funct_1 X2 (esk34_3 X1 X2 X3)) (esk33_2 X1 X2) -> False)
  -> (forall X4 X2 X3 X1, (X1 = k1_xboole_0 -> False) -> (r2_hidden (esk31_4 X1 X2 X3 X4) (k9_xtuple_0 X2) -> False) -> v3_ordinal1 X4 -> v3_ordinal1 X3 -> r1_ordinal2 X1 X2 -> r2_hidden X3 X1 -> r2_hidden X1 X4 -> epred1_2 X2 X1 -> False)
  -> (forall X4 X2 X3 X1, (X1 = k1_xboole_0 -> False) -> (v3_ordinal1 (esk31_4 X1 X2 X3 X4) -> False) -> v3_ordinal1 X4 -> v3_ordinal1 X3 -> r1_ordinal2 X1 X2 -> r2_hidden X3 X1 -> r2_hidden X1 X4 -> epred1_2 X2 X1 -> False)
  -> (forall X3 X2 X1, (r1_ordinal2 X2 X1 -> False) -> X2 = k1_xboole_0 -> (k1_funct_1 X1 (esk30_3 X2 X1 X3)) = k1_xboole_0 -> v3_ordinal1 X3 -> epred1_2 X1 X2 -> r2_hidden X3 (k9_xtuple_0 X1) -> False)
  ...
  -> (forall X3 X1 X2, (r1_ordinal2 X1 X2 -> False) -> (r2_hidden (esk30_3 X1 X2 X3) (k9_xtuple_0 X2) -> False) -> X1 = k1_xboole_0 -> v3_ordinal1 X3 -> epred1_2 X2 X1 -> r2_hidden X3 (k9_xtuple_0 X2) -> False)
  -> (forall X2 X3 X1, (X1 = k1_xboole_0 -> False) -> (r1_ordinal2 X1 X2 -> False) -> (r2_hidden (esk34_3 X1 X2 X3) (k9_xtuple_0 X2) -> False) -> v3_ordinal1 X3 -> epred1_2 X2 X1 -> r2_hidden X3 (k9_xtuple_0 X2) -> False)
  -> (forall X1 X2 X3, (r1_ordinal2 X2 X3 -> False) -> (r1_ordinal1 X1 (esk30_3 X2 X3 X1) -> False) -> X2 = k1_xboole_0 -> v3_ordinal1 X1 -> epred1_2 X3 X2 -> r2_hidden X1 (k9_xtuple_0 X3) -> False)
  -> (forall X3 X1 X2, (X2 = k1_xboole_0 -> False) -> (r1_ordinal2 X2 X3 -> False) -> (r1_ordinal1 X1 (esk34_3 X2 X3 X1) -> False) -> v3_ordinal1 X1 -> epred1_2 X3 X2 -> r2_hidden X1 (k9_xtuple_0 X3) -> False)
  -> (forall X3 X1 X2, (r1_ordinal2 X1 X2 -> False) -> (v3_ordinal1 (esk30_3 X1 X2 X3) -> False) -> X1 = k1_xboole_0 -> v3_ordinal1 X3 -> epred1_2 X2 X1 -> r2_hidden X3 (k9_xtuple_0 X2) -> False)
  -> (forall X2 X3 X1, (X1 = k1_xboole_0 -> False) -> (r1_ordinal2 X1 X2 -> False) -> (v3_ordinal1 (esk34_3 X1 X2 X3) -> False) -> v3_ordinal1 X3 -> epred1_2 X2 X1 -> r2_hidden X3 (k9_xtuple_0 X2) -> False)
  ...
  -> (forall X2 X3 X1, (r1_ordinal1 (k1_funct_1 X1 X2) (k1_funct_1 X1 X3) -> False) -> v1_relat_1 X1 -> v5_ordinal1 X1 -> v1_funct_1 X1 -> v1_ordinal2 X1 -> v3_ordinal1 X3 -> v3_ordinal1 X2 -> v2_ordinal2 X1 -> r1_ordinal1 X2 X3 -> r2_hidden X3 (k9_xtuple_0 X1) -> False)
  ...
  -> (forall X2 X1 X3, ((k1_funct_1 X3 X1) = k1_xboole_0 -> False) -> X2 = k1_xboole_0 -> v3_ordinal1 X1 -> r1_ordinal2 X2 X3 -> epred1_2 X3 X2 -> r2_hidden X1 (k9_xtuple_0 X3) -> r1_ordinal1 (esk29_2 X2 X3) X1 -> False)
  ...
  -> (forall X2 X1, (r2_hidden (esk29_2 X1 X2) (k9_xtuple_0 X2) -> False) -> X1 = k1_xboole_0 -> r1_ordinal2 X1 X2 -> epred1_2 X2 X1 -> False)
  ...
  -> (forall X2 X1, (X1 = k1_xboole_0 -> False) -> (r1_ordinal2 X1 X2 -> False) -> (r2_hidden (esk32_2 X1 X2) X1 -> False) -> epred1_2 X2 X1 -> False)
  -> (forall X2 X1, (X1 = k1_xboole_0 -> False) -> (r1_ordinal2 X1 X2 -> False) -> (r2_hidden X1 (esk33_2 X1 X2) -> False) -> epred1_2 X2 X1 -> False)
  -> (forall X2 X1, (v3_ordinal1 (esk29_2 X1 X2) -> False) -> X1 = k1_xboole_0 -> r1_ordinal2 X1 X2 -> epred1_2 X2 X1 -> False)
  ...
  -> (((k3_relat_1 esk3_0 esk4_0) = esk1_0 -> False) -> False)
  -> (forall X1, (v3_ordinal1 (k3_ordinal2 X1) -> False) -> False)
  -> (((k3_ordinal2 (k10_xtuple_0 esk3_0)) = (k9_xtuple_0 esk4_0) -> False) -> False)
  ...
  -> ((v2_ordinal2 esk3_0 -> False) -> False)
