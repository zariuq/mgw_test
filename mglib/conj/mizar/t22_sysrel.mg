...
Theorem t22_sysrel:
 ...
 forall r2_hidden:set -> set -> prop,
     (forall X2 X1 X4 X5 X3, (r2_hidden (k2_tarski (k2_tarski (esk11_5 X1 X2 X3 X4 X5) X5) (k1_tarski (esk11_5 X1 X2 X3 X4 X5))) X2 -> False) -> X3 = (k3_relat_1 X1 X2) -> v1_relat_1 X3 -> r2_hidden (k2_tarski (k2_tarski X4 X5) (k1_tarski X4)) X3 -> False)
  -> (forall X3 X2 X1 X5 X4, (r2_hidden (k2_tarski (k2_tarski X1 (esk11_5 X2 X3 X4 X1 X5)) (k1_tarski X1)) X2 -> False) -> X4 = (k3_relat_1 X2 X3) -> v1_relat_1 X4 -> r2_hidden (k2_tarski (k2_tarski X1 X5) (k1_tarski X1)) X4 -> False)
  -> (forall X4 X1 X2 X3, (X3 = (k3_relat_1 X1 X2) -> False) -> v1_relat_1 X3 -> r2_hidden (k2_tarski (k2_tarski X4 (esk13_3 X1 X2 X3)) (k1_tarski X4)) X2 -> r2_hidden (k2_tarski (k2_tarski (esk12_3 X1 X2 X3) X4) (k1_tarski (esk12_3 X1 X2 X3))) X1 -> r2_hidden (k2_tarski (k2_tarski (esk12_3 X1 X2 X3) (esk13_3 X1 X2 X3)) (k1_tarski (esk12_3 X1 X2 X3))) X3 -> False)
  -> (forall X2 X1 X3, (X3 = (k3_relat_1 X1 X2) -> False) -> (r2_hidden (k2_tarski (k2_tarski (esk12_3 X1 X2 X3) (esk13_3 X1 X2 X3)) (k1_tarski (esk12_3 X1 X2 X3))) X3 -> False) -> (r2_hidden (k2_tarski (k2_tarski (esk14_3 X1 X2 X3) (esk13_3 X1 X2 X3)) (k1_tarski (esk14_3 X1 X2 X3))) X2 -> False) -> v1_relat_1 X3 -> False)
  -> (forall X1 X2 X3, (X3 = (k3_relat_1 X1 X2) -> False) -> (r2_hidden (k2_tarski (k2_tarski (esk12_3 X1 X2 X3) (esk13_3 X1 X2 X3)) (k1_tarski (esk12_3 X1 X2 X3))) X3 -> False) -> (r2_hidden (k2_tarski (k2_tarski (esk12_3 X1 X2 X3) (esk14_3 X1 X2 X3)) (k1_tarski (esk12_3 X1 X2 X3))) X1 -> False) -> v1_relat_1 X3 -> False)
  ...
  -> (forall X1 X2, (r1_tarski (k4_relat_1 X1) X2 -> False) -> v1_relat_1 X2 -> r2_hidden (k2_tarski (k2_tarski (esk21_2 X1 X2) (esk21_2 X1 X2)) (k1_tarski (esk21_2 X1 X2))) X2 -> False)
  ...
  -> (((k3_relat_1 esk1_0 (k6_subset_1 esk1_0 (k4_relat_1 (k10_xtuple_0 esk1_0)))) = k1_xboole_0 -> False) -> ((k3_relat_1 (k6_subset_1 esk1_0 (k4_relat_1 (k9_xtuple_0 esk1_0))) esk1_0) = k1_xboole_0 -> False) -> False)
  -> (((k3_relat_1 (k6_subset_1 esk1_0 (k4_relat_1 (k9_xtuple_0 esk1_0))) esk1_0) = k1_xboole_0 -> False) -> r1_tarski (k4_relat_1 (k10_xtuple_0 esk1_0)) esk1_0 -> False)
  -> (((k3_relat_1 esk1_0 (k6_subset_1 esk1_0 (k4_relat_1 (k10_xtuple_0 esk1_0)))) = k1_xboole_0 -> False) -> r1_tarski (k4_relat_1 (k9_xtuple_0 esk1_0)) esk1_0 -> False)
  -> (((k3_relat_1 (k6_subset_1 esk1_0 (k4_relat_1 (k9_xtuple_0 esk1_0))) esk1_0) = k1_xboole_0 -> False) -> (r1_tarski esk1_0 (k3_relat_1 esk1_0 esk1_0) -> False) -> False)
  -> (((k3_relat_1 esk1_0 (k6_subset_1 esk1_0 (k4_relat_1 (k10_xtuple_0 esk1_0)))) = k1_xboole_0 -> False) -> (r1_tarski esk1_0 (k3_relat_1 esk1_0 esk1_0) -> False) -> False)
  -> (r1_tarski (k4_relat_1 (k10_xtuple_0 esk1_0)) esk1_0 -> r1_tarski (k4_relat_1 (k9_xtuple_0 esk1_0)) esk1_0 -> False)
  ...
  -> ((r1_tarski esk1_0 (k3_relat_1 esk1_0 esk1_0) -> False) -> r1_tarski (k4_relat_1 (k9_xtuple_0 esk1_0)) esk1_0 -> False)
  -> ((r1_tarski esk1_0 (k3_relat_1 esk1_0 esk1_0) -> False) -> r1_tarski (k4_relat_1 (k10_xtuple_0 esk1_0)) esk1_0 -> False)
  -> (forall X2 X1 X3, (m1_subset_1 X1 X3 -> False) -> r2_hidden X1 X2 -> m1_subset_1 X2 (k1_zfmisc_1 X3) -> False)
  -> (forall X4 X3 X2 X1, X3 = (k6_subset_1 X4 X2) -> r2_hidden X1 X3 -> r2_hidden X1 X2 -> False)
  -> (forall X1 X2, (r1_tarski (k4_relat_1 X1) X2 -> False) -> (r2_hidden (esk21_2 X1 X2) X1 -> False) -> v1_relat_1 X2 -> False)
  ...
  -> ((r1_tarski esk1_0 (k3_relat_1 esk1_0 esk1_0) -> False) -> False)
