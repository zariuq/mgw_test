...
Theorem l70_aff_4:
 ...
 forall m1_subset_1:set -> set -> prop,
  ...
  -> (forall X3 X2 X4 X1, (v7_struct_0 X1 -> False) -> (r1_tarski (k2_aff_4 X1 X2 X4) X3 -> False) -> v1_diraf X1 -> l1_analoaf X1 -> r2_hidden X2 X3 -> v1_aff_4 X3 X1 -> v1_aff_1 X4 X1 -> r1_tarski X4 X3 -> m1_subset_1 X2 (u1_struct_0 X1) -> m1_subset_1 X4 (k1_zfmisc_1 (u1_struct_0 X1)) -> m1_subset_1 X3 (k1_zfmisc_1 (u1_struct_0 X1)) -> False)
  ...
  -> ((v1_aff_4 esk7_0 esk1_0 -> False) -> False)
  -> ((r2_hidden esk5_0 esk7_0 -> False) -> False)
  -> ((r2_hidden esk4_0 esk7_0 -> False) -> False)
  -> ((r2_hidden esk3_0 esk7_0 -> False) -> False)
  -> ((r2_hidden esk2_0 esk7_0 -> False) -> False)
