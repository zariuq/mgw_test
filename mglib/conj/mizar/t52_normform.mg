...
Theorem t52_normform:
 ...
 forall r2_hidden:set -> set -> prop,
  ...
  -> (forall X1 X3 X4 X5 X2, ((k1_normform X1 X2 (k1_normform X1 X2 X3 X4) X5) = (k1_normform X1 X2 X3 (k1_normform X1 X2 X4 X5)) -> False) -> (v1_xboole_0 X2 -> False) -> (v1_xboole_0 X1 -> False) -> v4_finsub_1 X2 -> v4_finsub_1 X1 -> m1_subset_1 X5 (k2_zfmisc_1 X1 X2) -> m1_subset_1 X4 (k2_zfmisc_1 X1 X2) -> m1_subset_1 X3 (k2_zfmisc_1 X1 X2) -> False)
  -> (forall X3 X1 X4 X2, ((k1_normform (k5_finsub_1 X2) (k5_finsub_1 X2) (esk24_4 X2 X1 X3 X4) (esk25_4 X2 X1 X3 X4)) = X1 -> False) -> m1_subset_1 X4 (k5_finsub_1 (k7_normform X2)) -> m1_subset_1 X3 (k5_finsub_1 (k7_normform X2)) -> r2_hidden X1 (k10_normform X2 X3 X4) -> m1_subset_1 X1 (k2_zfmisc_1 (k5_finsub_1 X2) (k5_finsub_1 X2)) -> False)
  -> (forall X3 X1 X4 X2, ((k1_normform (k5_finsub_1 X2) (k5_finsub_1 X2) (esk11_4 X1 X2 X3 X4) (esk12_4 X1 X2 X3 X4)) = X1 -> False) -> m1_subset_1 X4 (k5_finsub_1 (k7_normform X2)) -> m1_subset_1 X3 (k5_finsub_1 (k7_normform X2)) -> r2_hidden X1 (a_3_1_normform X2 X3 X4) -> False)
  ...
  -> (forall X3 X2 X4 X1, (m2_subset_1 (esk24_4 X1 X2 X3 X4) (k2_zfmisc_1 (k5_finsub_1 X1) (k5_finsub_1 X1)) (k7_normform X1) -> False) -> m1_subset_1 X4 (k5_finsub_1 (k7_normform X1)) -> m1_subset_1 X3 (k5_finsub_1 (k7_normform X1)) -> r2_hidden X2 (k10_normform X1 X3 X4) -> m1_subset_1 X2 (k2_zfmisc_1 (k5_finsub_1 X1) (k5_finsub_1 X1)) -> False)
  ...
  -> (forall X3 X2 X4 X1, (r2_hidden (esk25_4 X1 X2 X3 X4) X4 -> False) -> m1_subset_1 X4 (k5_finsub_1 (k7_normform X1)) -> m1_subset_1 X3 (k5_finsub_1 (k7_normform X1)) -> r2_hidden X2 (k10_normform X1 X3 X4) -> m1_subset_1 X2 (k2_zfmisc_1 (k5_finsub_1 X1) (k5_finsub_1 X1)) -> False)
  -> (forall X3 X2 X4 X1, (r2_hidden (esk24_4 X1 X2 X3 X4) X3 -> False) -> m1_subset_1 X4 (k5_finsub_1 (k7_normform X1)) -> m1_subset_1 X3 (k5_finsub_1 (k7_normform X1)) -> r2_hidden X2 (k10_normform X1 X3 X4) -> m1_subset_1 X2 (k2_zfmisc_1 (k5_finsub_1 X1) (k5_finsub_1 X1)) -> False)
  ...
  -> (forall X3 X1 X4 X2, (m2_subset_1 (esk11_4 X1 X2 X3 X4) (k2_zfmisc_1 (k5_finsub_1 X2) (k5_finsub_1 X2)) (k7_normform X2) -> False) -> m1_subset_1 X4 (k5_finsub_1 (k7_normform X2)) -> m1_subset_1 X3 (k5_finsub_1 (k7_normform X2)) -> r2_hidden X1 (a_3_1_normform X2 X3 X4) -> False)
  -> (forall X1 X4 X3 X2, (v1_xboole_0 X2 -> False) -> (v1_xboole_0 X1 -> False) -> (r1_normform X1 X2 X3 (k1_normform X1 X2 X3 X4) -> False) -> v4_finsub_1 X2 -> v4_finsub_1 X1 -> m1_subset_1 X4 (k2_zfmisc_1 X1 X2) -> m1_subset_1 X3 (k2_zfmisc_1 X1 X2) -> False)
  -> (forall X1 X4 X3 X2, (v1_xboole_0 X2 -> False) -> (v1_xboole_0 X1 -> False) -> (r1_normform X1 X2 X3 (k1_normform X1 X2 X4 X3) -> False) -> v4_finsub_1 X2 -> v4_finsub_1 X1 -> m1_subset_1 X4 (k2_zfmisc_1 X1 X2) -> m1_subset_1 X3 (k2_zfmisc_1 X1 X2) -> False)
  -> (forall X3 X1 X4 X2, (r2_hidden (esk12_4 X1 X2 X3 X4) X4 -> False) -> m1_subset_1 X4 (k5_finsub_1 (k7_normform X2)) -> m1_subset_1 X3 (k5_finsub_1 (k7_normform X2)) -> r2_hidden X1 (a_3_1_normform X2 X3 X4) -> False)
  -> (forall X3 X1 X4 X2, (r2_hidden (esk11_4 X1 X2 X3 X4) X3 -> False) -> m1_subset_1 X4 (k5_finsub_1 (k7_normform X2)) -> m1_subset_1 X3 (k5_finsub_1 (k7_normform X2)) -> r2_hidden X1 (a_3_1_normform X2 X3 X4) -> False)
  -> (forall X3 X1 X2, (m2_subset_1 X1 (k2_zfmisc_1 (k5_finsub_1 X2) (k5_finsub_1 X2)) (k7_normform X2) -> False) -> r1_normform (k5_finsub_1 X2) (k5_finsub_1 X2) X1 X3 -> m1_subset_1 X1 (k2_zfmisc_1 (k5_finsub_1 X2) (k5_finsub_1 X2)) -> m2_subset_1 X3 (k2_zfmisc_1 (k5_finsub_1 X2) (k5_finsub_1 X2)) (k7_normform X2) -> False)
  ...
  -> (forall X3 X2 X1, ((k10_normform X2 X1 X3) = (k10_normform X2 X3 X1) -> False) -> m1_subset_1 X3 (k5_finsub_1 (k7_normform X2)) -> m1_subset_1 X1 (k5_finsub_1 (k7_normform X2)) -> False)
  ...
  -> ((k10_normform esk1_0 (k10_normform esk1_0 esk2_0 esk3_0) esk4_0) = (k10_normform esk1_0 esk2_0 (k10_normform esk1_0 esk3_0 esk4_0)) -> False)
