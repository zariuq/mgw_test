...
Theorem t12_bvfunc_5:
 ...
 forall k9_bvfunc_1:set -> set -> set -> set,
  ...
  -> (forall X1 X3 X2 X4, (r2_funct_2 X2 X3 X1 X4 -> False) -> (k1_funct_1 X1 (esk10_4 X2 X3 X1 X4)) = (k1_funct_1 X4 (esk10_4 X2 X3 X1 X4)) -> v1_funct_1 X4 -> v1_funct_1 X1 -> v1_funct_2 X4 X2 X3 -> v1_funct_2 X1 X2 X3 -> m1_subset_1 X4 (k1_zfmisc_1 (k2_zfmisc_1 X2 X3)) -> m1_subset_1 X1 (k1_zfmisc_1 (k2_zfmisc_1 X2 X3)) -> False)
  ...
  -> (forall X3 X2 X1 X4, (r2_funct_2 X1 X2 X3 X4 -> False) -> (m1_subset_1 (esk10_4 X1 X2 X3 X4) X1 -> False) -> v1_funct_1 X4 -> v1_funct_1 X3 -> v1_funct_2 X4 X1 X2 -> v1_funct_2 X3 X1 X2 -> m1_subset_1 X4 (k1_zfmisc_1 (k2_zfmisc_1 X1 X2)) -> m1_subset_1 X3 (k1_zfmisc_1 (k2_zfmisc_1 X1 X2)) -> False)
  ...
  -> (forall X2 X1, (X2 = (k12_bvfunc_1 X1) -> False) -> (v1_xboole_0 X1 -> False) -> (k3_funct_2 X1 k6_margrel1 X2 (esk5_2 X1 X2)) = k8_margrel1 -> v1_funct_1 X2 -> v1_funct_2 X2 X1 k6_margrel1 -> m1_subset_1 X2 (k1_zfmisc_1 (k2_zfmisc_1 X1 k6_margrel1)) -> False)
  ...
  -> (forall X1 X3 X2, ((k3_funct_2 X2 k6_margrel1 X1 X3) = k8_margrel1 -> False) -> (v1_xboole_0 X2 -> False) -> X1 = (k12_bvfunc_1 X2) -> v1_funct_1 X1 -> m1_subset_1 X3 X2 -> v1_funct_2 X1 X2 k6_margrel1 -> m1_subset_1 X1 (k1_zfmisc_1 (k2_zfmisc_1 X2 k6_margrel1)) -> False)
  ...
  -> (forall X2 X1, (X2 = (k12_bvfunc_1 X1) -> False) -> (v1_xboole_0 X1 -> False) -> (m1_subset_1 (esk5_2 X1 X2) X1 -> False) -> v1_funct_1 X2 -> v1_funct_2 X2 X1 k6_margrel1 -> m1_subset_1 X2 (k1_zfmisc_1 (k2_zfmisc_1 X1 k6_margrel1)) -> False)
  ...
  -> (forall X1 X2 X3, ((k4_xboolean (k5_xboolean X1 X2) (k5_xboolean X1 X3)) = (k5_xboolean X1 (k4_xboolean X2 X3)) -> False) -> v1_xboolean X3 -> v1_xboolean X2 -> v1_xboolean X1 -> False)
  ...
  -> (forall X1 X2 X3, ((k5_xboolean (k5_xboolean X1 X2) X3) = (k5_xboolean X1 (k5_xboolean X2 X3)) -> False) -> v1_xboolean X3 -> v1_xboolean X2 -> v1_xboolean X1 -> False)
  ...
  -> (forall X1, ((k4_xboolean k8_margrel1 X1) = X1 -> False) -> v1_xboolean X1 -> False)
  ...
  -> (r2_funct_2 esk1_0 k6_margrel1 (k9_bvfunc_1 esk1_0 (k9_bvfunc_1 esk1_0 esk2_0 esk3_0) (k9_bvfunc_1 esk1_0 (k1_bvfunc_1 esk1_0 (k2_bvfunc_1 esk1_0 esk3_0 esk4_0)) (k1_bvfunc_1 esk1_0 (k2_bvfunc_1 esk1_0 esk2_0 esk4_0)))) (k12_bvfunc_1 esk1_0) -> False)
  ...
  -> ((v1_margrel1 esk15_0 -> False) -> False)
  -> ((v1_xboolean esk14_0 -> False) -> False)
