...
Theorem t39_ordinal2:
 ...
 forall k1_xboole_0:set,
     (forall X1 X3 X2, (X2 = k1_xboole_0 -> False) -> ((k11_ordinal2 X2 X3) = (k3_tarski (k4_ordinal2 X1)) -> False) -> (k9_xtuple_0 X1) = X2 -> (k1_funct_1 X1 (esk31_3 X2 X3 X1)) = (k11_ordinal2 (esk31_3 X2 X3 X1) X3) -> v3_ordinal1 X3 -> v3_ordinal1 X2 -> v1_funct_1 X1 -> v1_relat_1 X1 -> v5_ordinal1 X1 -> v4_ordinal1 X2 -> v1_ordinal2 X1 -> False)
  -> (forall X3 X2 X1, (X1 = k1_xboole_0 -> False) -> ((k11_ordinal2 X1 X2) = (k3_tarski (k4_ordinal2 X3)) -> False) -> (r2_hidden (esk31_3 X1 X2 X3) X1 -> False) -> (k9_xtuple_0 X3) = X1 -> v3_ordinal1 X2 -> v3_ordinal1 X1 -> v1_funct_1 X3 -> v1_relat_1 X3 -> v5_ordinal1 X3 -> v4_ordinal1 X1 -> v1_ordinal2 X3 -> False)
  -> (forall X3 X2 X1, (X1 = k1_xboole_0 -> False) -> ((k11_ordinal2 X1 X2) = (k3_tarski (k4_ordinal2 X3)) -> False) -> (v3_ordinal1 (esk31_3 X1 X2 X3) -> False) -> (k9_xtuple_0 X3) = X1 -> v3_ordinal1 X2 -> v3_ordinal1 X1 -> v1_funct_1 X3 -> v1_relat_1 X3 -> v5_ordinal1 X3 -> v4_ordinal1 X1 -> v1_ordinal2 X3 -> False)
  -> (forall X3 X2 X1, (r2_hidden (esk2_3 X1 X2 X3) (k9_xtuple_0 X1) -> False) -> X2 = (k10_xtuple_0 X1) -> v1_funct_1 X1 -> v1_relat_1 X1 -> r2_hidden X3 X2 -> False)
  -> (forall X1 X3 X2, ((k1_funct_1 X2 (esk2_3 X2 X3 X1)) = X1 -> False) -> X3 = (k10_xtuple_0 X2) -> v1_funct_1 X2 -> v1_relat_1 X2 -> r2_hidden X1 X3 -> False)
  ...
  -> (forall X3 X2 X1, (X2 = (k10_xtuple_0 X1) -> False) -> (esk3_2 X1 X2) = (k1_funct_1 X1 X3) -> v1_funct_1 X1 -> v1_relat_1 X1 -> r2_hidden X3 (k9_xtuple_0 X1) -> r2_hidden (esk3_2 X1 X2) X2 -> False)
  -> (forall X1 X3 X2, (v1_xboole_0 X2 -> False) -> (v1_xboole_0 X1 -> False) -> (m1_subset_1 X3 X1 -> False) -> m2_subset_1 X3 X1 X2 -> m1_subset_1 X2 (k1_zfmisc_1 X1) -> False)
  -> (forall X2 X1 X3, (v1_xboole_0 X3 -> False) -> (v1_xboole_0 X2 -> False) -> (m1_subset_1 X1 X3 -> False) -> m2_subset_1 X1 X2 X3 -> m1_subset_1 X3 (k1_zfmisc_1 X2) -> False)
  -> (forall X1 X2, ((k11_ordinal2 X2 (k2_xboole_0 k1_xboole_0 (k1_tarski k1_xboole_0))) = X2 -> False) -> ((k11_ordinal2 X1 (k2_xboole_0 k1_xboole_0 (k1_tarski k1_xboole_0))) = X1 -> False) -> v3_ordinal1 X2 -> v3_ordinal1 X1 -> r2_hidden X1 esk28_0 -> False)
  ...
  -> (forall X1, ((k11_ordinal2 X1 (k2_xboole_0 k1_xboole_0 (k1_tarski k1_xboole_0))) = X1 -> False) -> (k11_ordinal2 esk28_0 (k2_xboole_0 k1_xboole_0 (k1_tarski k1_xboole_0))) = esk28_0 -> v3_ordinal1 X1 -> False)
  -> (forall X2 X1, (X2 = (k10_xtuple_0 X1) -> False) -> ((k1_funct_1 X1 (esk4_2 X1 X2)) = (esk3_2 X1 X2) -> False) -> (r2_hidden (esk3_2 X1 X2) X2 -> False) -> v1_funct_1 X1 -> v1_relat_1 X1 -> False)
  -> (forall X2 X1, (X2 = (k10_xtuple_0 X1) -> False) -> (r2_hidden (esk3_2 X1 X2) X2 -> False) -> (r2_hidden (esk4_2 X1 X2) (k9_xtuple_0 X1) -> False) -> v1_funct_1 X1 -> v1_relat_1 X1 -> False)
  ...
  -> (forall X1 X2, ((k1_funct_1 (esk29_1 X2) X1) = (k11_ordinal2 X1 (k2_xboole_0 k1_xboole_0 (k1_tarski k1_xboole_0))) -> False) -> v3_ordinal1 X2 -> v3_ordinal1 X1 -> r2_hidden X1 X2 -> False)
  ...
  -> (forall X1, ((k11_ordinal2 X1 (k2_xboole_0 k1_xboole_0 (k1_tarski k1_xboole_0))) = X1 -> False) -> (v3_ordinal1 esk28_0 -> False) -> v3_ordinal1 X1 -> False)
  ...
  -> ((k11_ordinal2 np__1 esk1_0) = esk1_0 -> (k11_ordinal2 esk1_0 np__1) = esk1_0 -> False)
  ...
  -> (forall X1, ((k9_xtuple_0 (esk29_1 X1)) = X1 -> False) -> v3_ordinal1 X1 -> False)
  -> (forall X2 X1, (r1_tarski X1 X2 -> False) -> X1 = X2 -> False)
  -> (forall X2 X1, (r1_tarski X1 X2 -> False) -> X1 = X2 -> False)
  -> (forall X1, (v1_ordinal2 (esk29_1 X1) -> False) -> v3_ordinal1 X1 -> False)
  -> (forall X1, (v5_ordinal1 (esk29_1 X1) -> False) -> v3_ordinal1 X1 -> False)
  -> (forall X1, (v1_relat_1 (esk29_1 X1) -> False) -> v3_ordinal1 X1 -> False)
  -> (forall X1, (v1_funct_1 (esk29_1 X1) -> False) -> v3_ordinal1 X1 -> False)
  ...
  -> (((k2_xboole_0 k1_xboole_0 (k1_tarski k1_xboole_0)) = np__1 -> False) -> False)
