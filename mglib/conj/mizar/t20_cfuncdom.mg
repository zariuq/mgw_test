...
Theorem t20_cfuncdom:
 ...
 forall k2_numbers:set,
     (forall X1 X2, m1_subset_1 X2 k2_numbers -> m1_subset_1 X1 k2_numbers -> r2_funct_2 esk3_0 k2_numbers esk6_0 (k1_funcsdom esk3_0 k2_numbers (k1_cfuncdom esk3_0) (k2_funcsdom esk3_0 k2_numbers k2_numbers (k9_funct_2 esk3_0 k2_numbers) (k3_cfuncdom esk3_0) (k1_domain_1 k2_numbers (k9_funct_2 esk3_0 k2_numbers) X1 esk4_0)) (k2_funcsdom esk3_0 k2_numbers k2_numbers (k9_funct_2 esk3_0 k2_numbers) (k3_cfuncdom esk3_0) (k1_domain_1 k2_numbers (k9_funct_2 esk3_0 k2_numbers) X2 esk5_0))) -> False)
  ...
  -> (forall X1 X3 X2 X4, (r2_relset_1 X2 X3 X1 X4 -> False) -> (k1_funct_1 X1 (esk19_4 X2 X3 X1 X4)) = (k1_funct_1 X4 (esk19_4 X2 X3 X1 X4)) -> v1_funct_1 X4 -> v1_funct_1 X1 -> v1_funct_2 X4 X2 X3 -> v1_funct_2 X1 X2 X3 -> m1_subset_1 X4 (k1_zfmisc_1 (k2_zfmisc_1 X2 X3)) -> m1_subset_1 X1 (k1_zfmisc_1 (k2_zfmisc_1 X2 X3)) -> False)
  ...
  -> (forall X5 X4 X2 X3 X1, (X1 = (k2_tarski X2 X3) -> False) -> epred1_5 X4 X5 X2 X1 X3 -> False)
  -> (forall X3 X2 X1 X4, (r2_relset_1 X1 X2 X3 X4 -> False) -> (m1_subset_1 (esk19_4 X1 X2 X3 X4) X1 -> False) -> v1_funct_1 X4 -> v1_funct_1 X3 -> v1_funct_2 X4 X1 X2 -> v1_funct_2 X3 X1 X2 -> m1_subset_1 X4 (k1_zfmisc_1 (k2_zfmisc_1 X1 X2)) -> m1_subset_1 X3 (k1_zfmisc_1 (k2_zfmisc_1 X1 X2)) -> False)
  ...
  -> ((m2_funct_2 esk6_0 esk3_0 k2_numbers (k9_funct_2 esk3_0 k2_numbers) -> False) -> False)
