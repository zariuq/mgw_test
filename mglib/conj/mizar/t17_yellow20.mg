...
Theorem t17_yellow20:
 forall k2_altcat_1:set -> set -> set,
 ...
 forall esk40_4:set -> set -> set -> set -> set,
 ...
 forall r2_hidden:set -> set -> prop,
     (forall X1 X4 X2 X3, ((k2_tarski (k2_tarski (k2_tarski (k2_tarski (esk40_4 X1 X2 X3 X4) (esk41_4 X1 X2 X3 X4)) (k1_tarski (esk40_4 X1 X2 X3 X4))) (esk42_4 X1 X2 X3 X4)) (k1_tarski (k2_tarski (k2_tarski (esk40_4 X1 X2 X3 X4) (esk41_4 X1 X2 X3 X4)) (k1_tarski (esk40_4 X1 X2 X3 X4))))) = X1 -> False) -> r2_hidden X1 (k2_zfmisc_1 (k2_zfmisc_1 X2 X3) X4) -> False)
  -> (forall X1 X2 X3, (X1 = (k2_altcat_1 X2 X3) -> False) -> (k1_multop_1 X1 (esk6_3 X2 X3 X1) (esk7_3 X2 X3 X1) (esk8_3 X2 X3 X1)) = (k1_binop_1 X3 (esk6_3 X2 X3 X1) (esk8_3 X2 X3 X1)) -> v1_relat_1 X3 -> v1_relat_1 X1 -> v1_funct_1 X3 -> v1_funct_1 X1 -> v4_relat_1 X3 (k2_zfmisc_1 X2 X2) -> v1_partfun1 X3 (k2_zfmisc_1 X2 X2) -> v4_relat_1 X1 (k2_zfmisc_1 (k2_zfmisc_1 X2 X2) X2) -> v1_partfun1 X1 (k2_zfmisc_1 (k2_zfmisc_1 X2 X2) X2) -> False)
  ...
  -> (forall X2 X1 X3, (X1 = (k1_yellow20 X2 X3) -> False) -> (k9_xtuple_0 X1) = (k3_xboole_0 (k9_xtuple_0 X2) (k9_xtuple_0 X3)) -> (k3_xboole_0 (k1_funct_1 X2 (esk5_3 X2 X3 X1)) (k1_funct_1 X3 (esk5_3 X2 X3 X1))) = (k1_funct_1 X1 (esk5_3 X2 X3 X1)) -> v1_relat_1 X3 -> v1_relat_1 X2 -> v1_relat_1 X1 -> v1_funct_1 X3 -> v1_funct_1 X2 -> v1_funct_1 X1 -> False)
  ...
  -> (forall X2 X1 X5 X3 X4 X6, ((k1_multop_1 X1 X4 X5 X6) = (k1_binop_1 X3 X4 X6) -> False) -> X1 = (k2_altcat_1 X2 X3) -> v1_relat_1 X3 -> v1_relat_1 X1 -> v1_funct_1 X3 -> v1_funct_1 X1 -> r2_hidden X6 X2 -> r2_hidden X5 X2 -> r2_hidden X4 X2 -> v4_relat_1 X3 (k2_zfmisc_1 X2 X2) -> v1_partfun1 X3 (k2_zfmisc_1 X2 X2) -> v4_relat_1 X1 (k2_zfmisc_1 (k2_zfmisc_1 X2 X2) X2) -> v1_partfun1 X1 (k2_zfmisc_1 (k2_zfmisc_1 X2 X2) X2) -> False)
  -> (forall X1 X4 X2 X3, (r2_hidden (esk42_4 X1 X2 X3 X4) X4 -> False) -> r2_hidden X1 (k2_zfmisc_1 (k2_zfmisc_1 X2 X3) X4) -> False)
  -> (forall X1 X4 X2 X3, (r2_hidden (esk41_4 X1 X2 X3 X4) X3 -> False) -> r2_hidden X1 (k2_zfmisc_1 (k2_zfmisc_1 X2 X3) X4) -> False)
  -> (forall X1 X4 X2 X3, (r2_hidden (esk40_4 X1 X2 X3 X4) X2 -> False) -> r2_hidden X1 (k2_zfmisc_1 (k2_zfmisc_1 X2 X3) X4) -> False)
  ...
  -> (forall X2 X1 X3, (X3 = (k2_altcat_1 X1 X2) -> False) -> (r2_hidden (esk8_3 X1 X2 X3) X1 -> False) -> v1_relat_1 X3 -> v1_relat_1 X2 -> v1_funct_1 X3 -> v1_funct_1 X2 -> v4_relat_1 X2 (k2_zfmisc_1 X1 X1) -> v1_partfun1 X2 (k2_zfmisc_1 X1 X1) -> v4_relat_1 X3 (k2_zfmisc_1 (k2_zfmisc_1 X1 X1) X1) -> v1_partfun1 X3 (k2_zfmisc_1 (k2_zfmisc_1 X1 X1) X1) -> False)
  -> (forall X2 X1 X3, (X3 = (k2_altcat_1 X1 X2) -> False) -> (r2_hidden (esk7_3 X1 X2 X3) X1 -> False) -> v1_relat_1 X3 -> v1_relat_1 X2 -> v1_funct_1 X3 -> v1_funct_1 X2 -> v4_relat_1 X2 (k2_zfmisc_1 X1 X1) -> v1_partfun1 X2 (k2_zfmisc_1 X1 X1) -> v4_relat_1 X3 (k2_zfmisc_1 (k2_zfmisc_1 X1 X1) X1) -> v1_partfun1 X3 (k2_zfmisc_1 (k2_zfmisc_1 X1 X1) X1) -> False)
  -> (forall X2 X1 X3, (X3 = (k2_altcat_1 X1 X2) -> False) -> (r2_hidden (esk6_3 X1 X2 X3) X1 -> False) -> v1_relat_1 X3 -> v1_relat_1 X2 -> v1_funct_1 X3 -> v1_funct_1 X2 -> v4_relat_1 X2 (k2_zfmisc_1 X1 X1) -> v1_partfun1 X2 (k2_zfmisc_1 X1 X1) -> v4_relat_1 X3 (k2_zfmisc_1 (k2_zfmisc_1 X1 X1) X1) -> v1_partfun1 X3 (k2_zfmisc_1 (k2_zfmisc_1 X1 X1) X1) -> False)
  -> (forall X1, X1 = (k1_yellow20 esk3_0 esk4_0) -> (k1_yellow20 (k2_altcat_1 esk1_0 esk3_0) (k2_altcat_1 esk2_0 esk4_0)) = (k2_altcat_1 (k3_xboole_0 esk1_0 esk2_0) X1) -> v1_relat_1 X1 -> v1_funct_1 X1 -> v4_relat_1 X1 (k2_zfmisc_1 (k3_xboole_0 esk1_0 esk2_0) (k3_xboole_0 esk1_0 esk2_0)) -> v1_partfun1 X1 (k2_zfmisc_1 (k3_xboole_0 esk1_0 esk2_0) (k3_xboole_0 esk1_0 esk2_0)) -> False)
  ...
  -> (forall X2 X1 X3, (X3 = (k1_yellow20 X1 X2) -> False) -> (r2_hidden (esk5_3 X1 X2 X3) (k3_xboole_0 (k9_xtuple_0 X1) (k9_xtuple_0 X2)) -> False) -> (k9_xtuple_0 X3) = (k3_xboole_0 (k9_xtuple_0 X1) (k9_xtuple_0 X2)) -> v1_relat_1 X3 -> v1_relat_1 X2 -> v1_relat_1 X1 -> v1_funct_1 X3 -> v1_funct_1 X2 -> v1_funct_1 X1 -> False)
  -> (forall X1 X2, (v1_partfun1 (k2_altcat_1 X1 X2) (k2_zfmisc_1 (k2_zfmisc_1 X1 X1) X1) -> False) -> v1_relat_1 X2 -> v1_funct_1 X2 -> v4_relat_1 X2 (k2_zfmisc_1 X1 X1) -> v1_partfun1 X2 (k2_zfmisc_1 X1 X1) -> False)
  -> (forall X1 X2, (v4_relat_1 (k2_altcat_1 X1 X2) (k2_zfmisc_1 (k2_zfmisc_1 X1 X1) X1) -> False) -> v1_relat_1 X2 -> v1_funct_1 X2 -> v4_relat_1 X2 (k2_zfmisc_1 X1 X1) -> v1_partfun1 X2 (k2_zfmisc_1 X1 X1) -> False)
  ...
  -> (forall X1 X2, (v1_funct_1 (k2_altcat_1 X1 X2) -> False) -> v1_relat_1 X2 -> v1_funct_1 X2 -> v4_relat_1 X2 (k2_zfmisc_1 X1 X1) -> v1_partfun1 X2 (k2_zfmisc_1 X1 X1) -> False)
  -> (forall X1 X2, (v1_relat_1 (k2_altcat_1 X1 X2) -> False) -> v1_relat_1 X2 -> v1_funct_1 X2 -> v4_relat_1 X2 (k2_zfmisc_1 X1 X1) -> v1_partfun1 X2 (k2_zfmisc_1 X1 X1) -> False)
  ...
  -> (forall X1 X2, (v1_xboole_0 X2 -> False) -> (m1_subset_1 (esk24_2 X1 X2) (k1_zfmisc_1 (k2_zfmisc_1 X1 X2)) -> False) -> False)
  ...
  -> (forall X1 X2, (v1_xboole_0 X2 -> False) -> (v5_relat_1 (esk24_2 X1 X2) X2 -> False) -> False)
  -> (forall X1 X2, (v1_xboole_0 X2 -> False) -> (v1_partfun1 (esk24_2 X1 X2) X1 -> False) -> False)
  -> (forall X1 X2, (v1_xboole_0 X2 -> False) -> (v4_relat_1 (esk24_2 X1 X2) X1 -> False) -> False)
  ...
  -> (forall X1 X2, (v1_xboole_0 X2 -> False) -> (v1_funct_1 (esk24_2 X1 X2) -> False) -> False)
  -> (forall X1 X2, (v1_xboole_0 X2 -> False) -> (v1_relat_1 (esk24_2 X1 X2) -> False) -> False)
  ...
  -> ((v1_partfun1 esk4_0 (k2_zfmisc_1 esk2_0 esk2_0) -> False) -> False)
  -> ((v1_partfun1 esk3_0 (k2_zfmisc_1 esk1_0 esk1_0) -> False) -> False)
  -> ((v4_relat_1 esk4_0 (k2_zfmisc_1 esk2_0 esk2_0) -> False) -> False)
  ...
  -> (forall X1, (v4_relat_1 (esk39_1 X1) X1 -> False) -> False)
  ...
  -> (forall X1, (v3_relat_1 (esk20_1 X1) -> False) -> False)
  -> (forall X1, (v2_relat_1 (esk39_1 X1) -> False) -> False)
  -> (forall X1, (v2_relat_1 (esk29_1 X1) -> False) -> False)
  -> (forall X1, (v2_relat_1 (esk26_1 X1) -> False) -> False)
  -> (forall X1, (v1_xboole_0 (esk22_1 X1) -> False) -> False)
  -> (forall X1, (v1_funcop_1 (esk31_1 X1) -> False) -> False)
  -> (forall X1, (v1_funct_1 (esk39_1 X1) -> False) -> False)
  ...
  -> (forall X1, (v1_relat_1 (esk39_1 X1) -> False) -> False)
  ...
  -> ((v2_xtuple_0 esk23_0 -> False) -> False)
