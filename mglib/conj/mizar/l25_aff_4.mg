...
Theorem l25_aff_4:
 ...
 forall esk19_9:set -> set -> set -> set -> set -> set -> set -> set -> set -> set,
 ...
 forall r5_aff_1:set -> set -> set -> prop,
     (forall X1 X5 X4 X3 X2 X9 X8 X6 X7, (X6 = X7 -> False) -> (v7_struct_0 X1 -> False) -> (r5_aff_1 X1 X8 X9 -> False) -> (m1_subset_1 (esk19_9 X1 X2 X3 X4 X5 X6 X7 X8 X9) (u1_struct_0 X1) -> False) -> v1_diraf X1 -> l1_analoaf X1 -> v1_aff_1 X9 X1 -> v1_aff_1 X8 X1 -> r2_hidden X5 X9 -> r2_hidden X5 X7 -> r2_hidden X4 X8 -> r2_hidden X4 X7 -> r2_hidden X3 X9 -> r2_hidden X3 X6 -> r2_hidden X2 X8 -> r2_hidden X2 X6 -> r5_aff_1 X1 X6 X7 -> m1_subset_1 X5 (u1_struct_0 X1) -> m1_subset_1 X4 (u1_struct_0 X1) -> m1_subset_1 X3 (u1_struct_0 X1) -> m1_subset_1 X2 (u1_struct_0 X1) -> m1_subset_1 X9 (k1_zfmisc_1 (u1_struct_0 X1)) -> m1_subset_1 X8 (k1_zfmisc_1 (u1_struct_0 X1)) -> m1_subset_1 X7 (k1_zfmisc_1 (u1_struct_0 X1)) -> m1_subset_1 X6 (k1_zfmisc_1 (u1_struct_0 X1)) -> False)
  -> (forall X1 X5 X4 X3 X2 X9 X8 X6 X7, (X6 = X7 -> False) -> (v7_struct_0 X1 -> False) -> (r5_aff_1 X1 X8 X9 -> False) -> (r2_hidden (esk19_9 X1 X2 X3 X4 X5 X6 X7 X8 X9) X8 -> False) -> v1_diraf X1 -> l1_analoaf X1 -> v1_aff_1 X9 X1 -> v1_aff_1 X8 X1 -> r2_hidden X5 X9 -> r2_hidden X5 X7 -> r2_hidden X4 X8 -> r2_hidden X4 X7 -> r2_hidden X3 X9 -> r2_hidden X3 X6 -> r2_hidden X2 X8 -> r2_hidden X2 X6 -> r5_aff_1 X1 X6 X7 -> m1_subset_1 X5 (u1_struct_0 X1) -> m1_subset_1 X4 (u1_struct_0 X1) -> m1_subset_1 X3 (u1_struct_0 X1) -> m1_subset_1 X2 (u1_struct_0 X1) -> m1_subset_1 X9 (k1_zfmisc_1 (u1_struct_0 X1)) -> m1_subset_1 X8 (k1_zfmisc_1 (u1_struct_0 X1)) -> m1_subset_1 X7 (k1_zfmisc_1 (u1_struct_0 X1)) -> m1_subset_1 X6 (k1_zfmisc_1 (u1_struct_0 X1)) -> False)
  -> (forall X1 X5 X4 X3 X2 X9 X8 X6 X7, (X6 = X7 -> False) -> (v7_struct_0 X1 -> False) -> (r5_aff_1 X1 X8 X9 -> False) -> (r2_hidden (esk19_9 X1 X2 X3 X4 X5 X6 X7 X8 X9) X9 -> False) -> v1_diraf X1 -> l1_analoaf X1 -> v1_aff_1 X9 X1 -> v1_aff_1 X8 X1 -> r2_hidden X5 X9 -> r2_hidden X5 X7 -> r2_hidden X4 X8 -> r2_hidden X4 X7 -> r2_hidden X3 X9 -> r2_hidden X3 X6 -> r2_hidden X2 X8 -> r2_hidden X2 X6 -> r5_aff_1 X1 X6 X7 -> m1_subset_1 X5 (u1_struct_0 X1) -> m1_subset_1 X4 (u1_struct_0 X1) -> m1_subset_1 X3 (u1_struct_0 X1) -> m1_subset_1 X2 (u1_struct_0 X1) -> m1_subset_1 X9 (k1_zfmisc_1 (u1_struct_0 X1)) -> m1_subset_1 X8 (k1_zfmisc_1 (u1_struct_0 X1)) -> m1_subset_1 X7 (k1_zfmisc_1 (u1_struct_0 X1)) -> m1_subset_1 X6 (k1_zfmisc_1 (u1_struct_0 X1)) -> False)
  -> (forall X1 X2 X5 X3 X4, (X3 = X4 -> False) -> (r2_analoaf X1 X2 X3 X3 (esk31_5 X1 X3 X2 X4 X5) -> False) -> epred1_1 X1 -> m1_subset_1 X5 (u1_struct_0 X1) -> m1_subset_1 X4 (u1_struct_0 X1) -> m1_subset_1 X3 (u1_struct_0 X1) -> m1_subset_1 X2 (u1_struct_0 X1) -> r2_analoaf X1 X4 X3 X3 X5 -> False)
  -> (forall X1 X4 X2 X3 X5, (X3 = X5 -> False) -> (r2_analoaf X1 X2 X3 X4 (esk31_5 X1 X5 X2 X3 X4) -> False) -> epred1_1 X1 -> m1_subset_1 X5 (u1_struct_0 X1) -> m1_subset_1 X4 (u1_struct_0 X1) -> m1_subset_1 X3 (u1_struct_0 X1) -> m1_subset_1 X2 (u1_struct_0 X1) -> r2_analoaf X1 X3 X5 X5 X4 -> False)
  ...
  -> (forall X1 X3 X5 X2 X4, (X2 = X4 -> False) -> (m1_subset_1 (esk31_5 X1 X2 X3 X4 X5) (u1_struct_0 X1) -> False) -> epred1_1 X1 -> m1_subset_1 X5 (u1_struct_0 X1) -> m1_subset_1 X4 (u1_struct_0 X1) -> m1_subset_1 X3 (u1_struct_0 X1) -> m1_subset_1 X2 (u1_struct_0 X1) -> r2_analoaf X1 X4 X2 X2 X5 -> False)
  ...
  -> (forall X1, epred1_1 X1 -> r2_analoaf X1 (esk26_1 X1) (esk27_1 X1) (esk26_1 X1) (esk28_1 X1) -> False)
  -> (forall X4 X3 X2 X1, (r2_analoaf X1 X2 X3 X4 (esk30_4 X1 X2 X3 X4) -> False) -> epred1_1 X1 -> m1_subset_1 X4 (u1_struct_0 X1) -> m1_subset_1 X3 (u1_struct_0 X1) -> m1_subset_1 X2 (u1_struct_0 X1) -> False)
  -> (forall X4 X3 X2 X1, (r2_analoaf X1 X2 X3 X4 (esk30_4 X1 X2 X4 X3) -> False) -> epred1_1 X1 -> m1_subset_1 X4 (u1_struct_0 X1) -> m1_subset_1 X3 (u1_struct_0 X1) -> m1_subset_1 X2 (u1_struct_0 X1) -> False)
  -> (forall X4 X3 X2 X1, (r2_analoaf X1 X2 X3 X4 (esk29_4 X1 X2 X4 X3) -> False) -> epred1_1 X1 -> m1_subset_1 X4 (u1_struct_0 X1) -> m1_subset_1 X3 (u1_struct_0 X1) -> m1_subset_1 X2 (u1_struct_0 X1) -> False)
  ...
  -> (forall X4 X3 X2 X1, (m1_subset_1 (esk30_4 X1 X2 X3 X4) (u1_struct_0 X1) -> False) -> epred1_1 X1 -> m1_subset_1 X4 (u1_struct_0 X1) -> m1_subset_1 X3 (u1_struct_0 X1) -> m1_subset_1 X2 (u1_struct_0 X1) -> False)
  -> (forall X4 X3 X2 X1, (m1_subset_1 (esk29_4 X1 X2 X3 X4) (u1_struct_0 X1) -> False) -> epred1_1 X1 -> m1_subset_1 X4 (u1_struct_0 X1) -> m1_subset_1 X3 (u1_struct_0 X1) -> m1_subset_1 X2 (u1_struct_0 X1) -> False)
  ...
  -> (forall X4 X3 X1 X2, (esk29_4 X2 X3 X1 X4) = X1 -> epred1_1 X2 -> m1_subset_1 X4 (u1_struct_0 X2) -> m1_subset_1 X3 (u1_struct_0 X2) -> m1_subset_1 X1 (u1_struct_0 X2) -> False)
  ...
  -> (forall X1, (m1_subset_1 (esk27_1 X1) (u1_struct_0 X1) -> False) -> epred1_1 X1 -> False)
  ...
  -> (forall X1, (esk25_1 X1) = (esk24_1 X1) -> epred1_1 X1 -> False)
  ...
  -> (r1_tarski esk6_0 (k1_aff_4 esk1_0 esk4_0 esk5_0) -> False)
  -> (v1_xboole_0 esk17_0 -> False)
  -> (v1_xboole_0 np__1 -> False)
  -> (v7_struct_0 esk1_0 -> False)
  -> (esk3_0 = esk2_0 -> False)
  -> ((r2_hidden esk3_0 (k1_aff_4 esk1_0 esk4_0 esk5_0) -> False) -> False)
  -> ((r2_hidden esk2_0 (k1_aff_4 esk1_0 esk4_0 esk5_0) -> False) -> False)
  ...
  -> ((v1_aff_1 esk6_0 esk1_0 -> False) -> False)
  -> ((v1_aff_1 esk5_0 esk1_0 -> False) -> False)
