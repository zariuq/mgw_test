...
Theorem t26_connsp_2:
 ...
 forall k1_connsp_2:set -> set -> set,
     (forall X4 X1 X2 X3, (X3 = (k1_connsp_2 X1 X2) -> False) -> (v2_struct_0 X1 -> False) -> (k6_setfam_1 (u1_struct_0 X1) X4) = X3 -> v2_pre_topc X1 -> l1_pre_topc X1 -> m1_subset_1 X2 (u1_struct_0 X1) -> m1_subset_1 X3 (k1_zfmisc_1 (u1_struct_0 X1)) -> r2_hidden X2 (esk5_4 X1 X2 X3 X4) -> r2_hidden (esk5_4 X1 X2 X3 X4) X4 -> v3_pre_topc (esk5_4 X1 X2 X3 X4) X1 -> v4_pre_topc (esk5_4 X1 X2 X3 X4) X1 -> m1_subset_1 X4 (k1_zfmisc_1 (k1_zfmisc_1 (u1_struct_0 X1))) -> False)
  -> (forall X4 X1 X2 X3, (X3 = (k1_connsp_2 X1 X2) -> False) -> (v2_struct_0 X1 -> False) -> (r2_hidden (esk5_4 X1 X2 X3 X4) X4 -> False) -> (v4_pre_topc (esk5_4 X1 X2 X3 X4) X1 -> False) -> (k6_setfam_1 (u1_struct_0 X1) X4) = X3 -> v2_pre_topc X1 -> l1_pre_topc X1 -> m1_subset_1 X2 (u1_struct_0 X1) -> m1_subset_1 X3 (k1_zfmisc_1 (u1_struct_0 X1)) -> m1_subset_1 X4 (k1_zfmisc_1 (k1_zfmisc_1 (u1_struct_0 X1))) -> False)
  -> (forall X4 X1 X2 X3, (X3 = (k1_connsp_2 X1 X2) -> False) -> (v2_struct_0 X1 -> False) -> (r2_hidden (esk5_4 X1 X2 X3 X4) X4 -> False) -> (v3_pre_topc (esk5_4 X1 X2 X3 X4) X1 -> False) -> (k6_setfam_1 (u1_struct_0 X1) X4) = X3 -> v2_pre_topc X1 -> l1_pre_topc X1 -> m1_subset_1 X2 (u1_struct_0 X1) -> m1_subset_1 X3 (k1_zfmisc_1 (u1_struct_0 X1)) -> m1_subset_1 X4 (k1_zfmisc_1 (k1_zfmisc_1 (u1_struct_0 X1))) -> False)
  -> (forall X4 X2 X1 X3, (X3 = (k1_connsp_2 X2 X1) -> False) -> (v2_struct_0 X2 -> False) -> (r2_hidden X1 (esk5_4 X2 X1 X3 X4) -> False) -> (r2_hidden (esk5_4 X2 X1 X3 X4) X4 -> False) -> (k6_setfam_1 (u1_struct_0 X2) X4) = X3 -> v2_pre_topc X2 -> l1_pre_topc X2 -> m1_subset_1 X1 (u1_struct_0 X2) -> m1_subset_1 X3 (k1_zfmisc_1 (u1_struct_0 X2)) -> m1_subset_1 X4 (k1_zfmisc_1 (k1_zfmisc_1 (u1_struct_0 X2))) -> False)
  -> (forall X3 X2 X1, (v2_struct_0 X1 -> False) -> X3 = k1_xboole_0 -> v2_pre_topc X1 -> l1_pre_topc X1 -> m1_subset_1 X2 (u1_struct_0 X1) -> r2_hidden X2 (esk33_3 X1 X2 X3) -> r2_hidden (esk33_3 X1 X2 X3) X3 -> v3_pre_topc (esk33_3 X1 X2 X3) X1 -> v4_pre_topc (esk33_3 X1 X2 X3) X1 -> m1_subset_1 X3 (k1_zfmisc_1 (k1_zfmisc_1 (u1_struct_0 X1))) -> False)
  -> (forall X4 X1 X2 X3, (X3 = (k1_connsp_2 X1 X2) -> False) -> (v2_struct_0 X1 -> False) -> (m1_subset_1 (esk5_4 X1 X2 X3 X4) (k1_zfmisc_1 (u1_struct_0 X1)) -> False) -> (k6_setfam_1 (u1_struct_0 X1) X4) = X3 -> v2_pre_topc X1 -> l1_pre_topc X1 -> m1_subset_1 X2 (u1_struct_0 X1) -> m1_subset_1 X3 (k1_zfmisc_1 (u1_struct_0 X1)) -> m1_subset_1 X4 (k1_zfmisc_1 (k1_zfmisc_1 (u1_struct_0 X1))) -> False)
  ...
  -> (forall X3 X2 X1, (v2_struct_0 X1 -> False) -> (r2_hidden (esk33_3 X1 X2 X3) X3 -> False) -> (v4_pre_topc (esk33_3 X1 X2 X3) X1 -> False) -> X3 = k1_xboole_0 -> v2_pre_topc X1 -> l1_pre_topc X1 -> m1_subset_1 X2 (u1_struct_0 X1) -> m1_subset_1 X3 (k1_zfmisc_1 (k1_zfmisc_1 (u1_struct_0 X1))) -> False)
  -> (forall X3 X2 X1, (v2_struct_0 X1 -> False) -> (r2_hidden (esk33_3 X1 X2 X3) X3 -> False) -> (v3_pre_topc (esk33_3 X1 X2 X3) X1 -> False) -> X3 = k1_xboole_0 -> v2_pre_topc X1 -> l1_pre_topc X1 -> m1_subset_1 X2 (u1_struct_0 X1) -> m1_subset_1 X3 (k1_zfmisc_1 (k1_zfmisc_1 (u1_struct_0 X1))) -> False)
  -> (forall X3 X1 X2, (v2_struct_0 X2 -> False) -> (r2_hidden X1 (esk33_3 X2 X1 X3) -> False) -> (r2_hidden (esk33_3 X2 X1 X3) X3 -> False) -> X3 = k1_xboole_0 -> v2_pre_topc X2 -> l1_pre_topc X2 -> m1_subset_1 X1 (u1_struct_0 X2) -> m1_subset_1 X3 (k1_zfmisc_1 (k1_zfmisc_1 (u1_struct_0 X2))) -> False)
  ...
  -> (forall X1 X3 X4 X2, (v2_struct_0 X2 -> False) -> (v4_pre_topc X1 X2 -> False) -> X4 = (k1_connsp_2 X2 X3) -> v2_pre_topc X2 -> l1_pre_topc X2 -> m1_subset_1 X3 (u1_struct_0 X2) -> m1_subset_1 X4 (k1_zfmisc_1 (u1_struct_0 X2)) -> m1_subset_1 X1 (k1_zfmisc_1 (u1_struct_0 X2)) -> r2_hidden X1 (esk4_3 X2 X3 X4) -> False)
  -> (forall X1 X3 X4 X2, (v2_struct_0 X2 -> False) -> (v3_pre_topc X1 X2 -> False) -> X4 = (k1_connsp_2 X2 X3) -> v2_pre_topc X2 -> l1_pre_topc X2 -> m1_subset_1 X3 (u1_struct_0 X2) -> m1_subset_1 X4 (k1_zfmisc_1 (u1_struct_0 X2)) -> m1_subset_1 X1 (k1_zfmisc_1 (u1_struct_0 X2)) -> r2_hidden X1 (esk4_3 X2 X3 X4) -> False)
  -> (forall X2 X1 X4 X3, (v2_struct_0 X3 -> False) -> (r2_hidden X1 X2 -> False) -> X4 = (k1_connsp_2 X3 X1) -> v2_pre_topc X3 -> l1_pre_topc X3 -> m1_subset_1 X1 (u1_struct_0 X3) -> m1_subset_1 X4 (k1_zfmisc_1 (u1_struct_0 X3)) -> m1_subset_1 X2 (k1_zfmisc_1 (u1_struct_0 X3)) -> r2_hidden X2 (esk4_3 X3 X1 X4) -> False)
  -> (forall X4 X3 X1 X2, (v2_struct_0 X2 -> False) -> (r2_hidden X1 (esk4_3 X2 X3 X4) -> False) -> X4 = (k1_connsp_2 X2 X3) -> v2_pre_topc X2 -> l1_pre_topc X2 -> r2_hidden X3 X1 -> v3_pre_topc X1 X2 -> v4_pre_topc X1 X2 -> m1_subset_1 X3 (u1_struct_0 X2) -> m1_subset_1 X4 (k1_zfmisc_1 (u1_struct_0 X2)) -> m1_subset_1 X1 (k1_zfmisc_1 (u1_struct_0 X2)) -> False)
  ...
  -> (forall X3 X2 X1, (v2_struct_0 X1 -> False) -> (m1_subset_1 (esk4_3 X1 X2 X3) (k1_zfmisc_1 (k1_zfmisc_1 (u1_struct_0 X1))) -> False) -> X3 = (k1_connsp_2 X1 X2) -> v2_pre_topc X1 -> l1_pre_topc X1 -> m1_subset_1 X2 (u1_struct_0 X1) -> m1_subset_1 X3 (k1_zfmisc_1 (u1_struct_0 X1)) -> False)
  -> (forall X3 X2 X1, (v2_struct_0 X1 -> False) -> (m1_subset_1 (esk33_3 X1 X2 X3) (k1_zfmisc_1 (u1_struct_0 X1)) -> False) -> X3 = k1_xboole_0 -> v2_pre_topc X1 -> l1_pre_topc X1 -> m1_subset_1 X2 (u1_struct_0 X1) -> m1_subset_1 X3 (k1_zfmisc_1 (k1_zfmisc_1 (u1_struct_0 X1))) -> False)
  ...
  -> (forall X3 X2 X1, ((k6_setfam_1 (u1_struct_0 X1) (esk4_3 X1 X2 X3)) = X3 -> False) -> (v2_struct_0 X1 -> False) -> X3 = (k1_connsp_2 X1 X2) -> v2_pre_topc X1 -> l1_pre_topc X1 -> m1_subset_1 X2 (u1_struct_0 X1) -> m1_subset_1 X3 (k1_zfmisc_1 (u1_struct_0 X1)) -> False)
  ...
  -> (forall X1 X2, ((k4_subset_1 (u1_struct_0 X2) (esk31_2 X2 X1) (esk32_2 X2 X1)) = X1 -> False) -> (v2_connsp_1 X1 X2 -> False) -> v2_pre_topc X2 -> l1_pre_topc X2 -> m1_subset_1 X1 (k1_zfmisc_1 (u1_struct_0 X2)) -> False)
  ...
  -> (forall X2 X1, (v2_connsp_1 X2 X1 -> False) -> (r1_connsp_1 X1 (esk31_2 X1 X2) (esk32_2 X1 X2) -> False) -> v2_pre_topc X1 -> l1_pre_topc X1 -> m1_subset_1 X2 (k1_zfmisc_1 (u1_struct_0 X1)) -> False)
  ...
  -> (forall X2 X1, (v2_connsp_1 X2 X1 -> False) -> (m1_subset_1 (esk31_2 X1 X2) (k1_zfmisc_1 (u1_struct_0 X1)) -> False) -> v2_pre_topc X1 -> l1_pre_topc X1 -> m1_subset_1 X2 (k1_zfmisc_1 (u1_struct_0 X1)) -> False)
  ...
  -> (forall X2 X1, (v2_struct_0 X1 -> False) -> (m1_subset_1 (k1_connsp_2 X1 X2) (k1_zfmisc_1 (u1_struct_0 X1)) -> False) -> v2_pre_topc X1 -> l1_pre_topc X1 -> m1_subset_1 X2 (u1_struct_0 X1) -> False)
  ...
  -> (forall X2 X1, (v2_connsp_1 X2 X1 -> False) -> (esk31_2 X1 X2) = (k1_struct_0 X1) -> v2_pre_topc X1 -> l1_pre_topc X1 -> m1_subset_1 X2 (k1_zfmisc_1 (u1_struct_0 X1)) -> False)
  ...
  -> (forall X2 X1, (v4_pre_topc X2 X1 -> False) -> (k2_pre_topc X1 X2) = X2 -> v2_pre_topc X1 -> l1_pre_topc X1 -> m1_subset_1 X2 (k1_zfmisc_1 (u1_struct_0 X1)) -> False)
  ...
  -> (forall X1 X2, ((k2_pre_topc X2 X1) = X1 -> False) -> l1_pre_topc X2 -> v4_pre_topc X1 X2 -> m1_subset_1 X1 (k1_zfmisc_1 (u1_struct_0 X2)) -> False)
  ...
  -> (forall X1 X2, (X2 = k1_xboole_0 -> False) -> (r1_tarski X1 (k1_setfam_1 X2) -> False) -> r1_tarski X1 (esk34_2 X2 X1) -> False)
  ...
  -> (forall X2 X1, (X1 = k1_xboole_0 -> False) -> (r1_tarski X2 (k1_setfam_1 X1) -> False) -> (r2_hidden (esk34_2 X1 X2) X1 -> False) -> False)
  ...
  -> (forall X1, (v2_struct_0 X1 -> False) -> (m1_subset_1 (esk28_1 X1) (k1_zfmisc_1 (u1_struct_0 X1)) -> False) -> v2_pre_topc X1 -> l1_pre_topc X1 -> False)
  -> (forall X1, (v2_struct_0 X1 -> False) -> (m1_subset_1 (esk20_1 X1) (k1_zfmisc_1 (u1_struct_0 X1)) -> False) -> v2_pre_topc X1 -> l1_pre_topc X1 -> False)
  ...
  -> (forall X1, (v2_struct_0 X1 -> False) -> v2_pre_topc X1 -> l1_pre_topc X1 -> v2_tops_1 (esk28_1 X1) X1 -> False)
  ...
  -> (forall X1, (m1_subset_1 (esk23_1 X1) (k1_zfmisc_1 (u1_struct_0 X1)) -> False) -> l1_pre_topc X1 -> False)
  -> (forall X1, (m1_subset_1 (esk10_1 X1) (k1_zfmisc_1 (u1_struct_0 X1)) -> False) -> l1_pre_topc X1 -> False)
  ...
  -> (forall X1, (v2_struct_0 X1 -> False) -> (v4_pre_topc (esk20_1 X1) X1 -> False) -> v2_pre_topc X1 -> l1_pre_topc X1 -> False)
  -> (forall X1, (v2_struct_0 X1 -> False) -> (v3_pre_topc (esk20_1 X1) X1 -> False) -> v2_pre_topc X1 -> l1_pre_topc X1 -> False)
  ...
  -> (forall X1, (v2_struct_0 X1 -> False) -> v2_pre_topc X1 -> l1_pre_topc X1 -> v1_xboole_0 (esk28_1 X1) -> False)
  -> (forall X1, (v2_struct_0 X1 -> False) -> v2_pre_topc X1 -> l1_pre_topc X1 -> v1_xboole_0 (esk20_1 X1) -> False)
  -> (forall X1, (v3_tops_1 (esk30_1 X1) X1 -> False) -> v2_pre_topc X1 -> l1_pre_topc X1 -> False)
  -> (forall X1, (v4_pre_topc (esk26_1 X1) X1 -> False) -> v2_pre_topc X1 -> l1_pre_topc X1 -> False)
  ...
  -> (forall X1, (v1_tops_1 (esk23_1 X1) X1 -> False) -> l1_pre_topc X1 -> False)
  ...
  -> (forall X1, (v7_struct_0 X1 -> False) -> v2_struct_0 X1 -> l1_struct_0 X1 -> False)
  -> (forall X1, (v7_struct_0 X1 -> False) -> v2_struct_0 X1 -> l1_struct_0 X1 -> False)
  -> (forall X1, (v1_xboole_0 (esk10_1 X1) -> False) -> l1_pre_topc X1 -> False)
  ...
  -> (r1_tarski (k1_connsp_1 esk1_0 esk2_0) (k1_connsp_2 esk1_0 esk2_0) -> False)
