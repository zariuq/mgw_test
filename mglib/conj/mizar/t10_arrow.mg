...
Theorem t10_arrow:
 ...
 forall r2_hidden:set -> set -> prop,
  ...
  -> (forall X1, (r1_arrow X1 esk3_0 esk2_0 -> False) -> (r1_arrow X1 esk4_0 esk2_0 -> False) -> m1_subset_1 X1 (k2_arrow esk1_0) -> r1_arrow X1 esk3_0 esk4_0 -> r1_arrow X1 esk4_0 esk3_0 -> r1_arrow esk5_0 esk3_0 esk4_0 -> r1_arrow esk5_0 esk4_0 esk3_0 -> False)
  ...
  -> (forall X1, (r1_arrow X1 esk3_0 esk2_0 -> False) -> (r1_arrow X1 esk4_0 esk2_0 -> False) -> (r1_arrow X1 esk4_0 esk3_0 -> False) -> (r1_arrow esk5_0 esk4_0 esk3_0 -> False) -> m1_subset_1 X1 (k2_arrow esk1_0) -> r1_arrow X1 esk3_0 esk4_0 -> r1_arrow esk5_0 esk3_0 esk4_0 -> False)
  -> (forall X1, (r1_arrow X1 esk3_0 esk2_0 -> False) -> (r1_arrow X1 esk3_0 esk4_0 -> False) -> (r1_arrow X1 esk4_0 esk2_0 -> False) -> (r1_arrow esk5_0 esk3_0 esk4_0 -> False) -> m1_subset_1 X1 (k2_arrow esk1_0) -> r1_arrow X1 esk4_0 esk3_0 -> r1_arrow esk5_0 esk4_0 esk3_0 -> False)
  -> (forall X5 X3 X1 X2 X4, (X2 = X4 -> False) -> (v1_xboole_0 X5 -> False) -> (r1_arrow X1 X2 X3 -> False) -> m1_subset_1 X4 X5 -> m1_subset_1 X3 X5 -> m1_subset_1 X2 X5 -> m1_subset_1 X1 (k2_arrow X5) -> r2_hidden (k4_tarski X2 X3) (esk22_3 X5 X4 X1) -> False)
  ...
  -> (forall X4 X5 X1 X2 X3, (X2 = X3 -> False) -> (v1_xboole_0 X4 -> False) -> X1 = X2 -> m1_subset_1 X3 X4 -> m1_subset_1 X2 X4 -> m1_subset_1 X1 X4 -> m1_subset_1 X5 (k2_arrow X4) -> r2_hidden (k4_tarski X3 X1) (esk22_3 X4 X2 X5) -> False)
  -> (forall X5 X1 X2 X3 X4, (X3 = X4 -> False) -> (v1_xboole_0 X5 -> False) -> (r2_hidden (k4_tarski X2 X3) (esk22_3 X5 X4 X1) -> False) -> m1_subset_1 X4 X5 -> m1_subset_1 X3 X5 -> m1_subset_1 X2 X5 -> r1_arrow X1 X2 X3 -> m1_subset_1 X1 (k2_arrow X5) -> False)
  -> (forall X1, (r1_arrow X1 esk3_0 esk2_0 -> False) -> (r1_arrow X1 esk3_0 esk4_0 -> False) -> (r1_arrow X1 esk4_0 esk2_0 -> False) -> (r1_arrow X1 esk4_0 esk3_0 -> False) -> (r1_arrow esk5_0 esk3_0 esk4_0 -> False) -> (r1_arrow esk5_0 esk4_0 esk3_0 -> False) -> m1_subset_1 X1 (k2_arrow esk1_0) -> False)
  ...
  -> (forall X2 X1 X5 X3 X4, (v1_xboole_0 X4 -> False) -> (r2_hidden (k4_tarski X1 X3) (esk22_3 X4 X2 X5) -> False) -> X1 = X2 -> m1_subset_1 X3 X4 -> m1_subset_1 X2 X4 -> m1_subset_1 X1 X4 -> m1_subset_1 X5 (k2_arrow X4) -> False)
