...
Theorem t3_radix_1:
 ...
 forall k6_numbers:set,
     (forall X3 X2 X1, (X1 = k6_numbers -> False) -> ((k2_xcmplx_0 (k3_xcmplx_0 X1 (esk4_3 X2 X1 X3)) X3) = X2 -> False) -> X3 = (k2_nat_d X2 X1) -> v7_ordinal1 X3 -> v7_ordinal1 X2 -> v7_ordinal1 X1 -> False)
  -> (forall X3 X2 X1, (X1 = k6_numbers -> False) -> ((k2_xcmplx_0 (k3_xcmplx_0 X3 (esk4_3 X2 X3 X1)) X1) = X2 -> False) -> X1 = (k2_nat_d X2 X3) -> v7_ordinal1 X3 -> v7_ordinal1 X2 -> v7_ordinal1 X1 -> False)
  -> (forall X3 X2 X1, (X1 = k6_numbers -> False) -> (v7_ordinal1 (esk4_3 X2 X1 X3) -> False) -> X3 = (k2_nat_d X2 X1) -> v7_ordinal1 X3 -> v7_ordinal1 X2 -> v7_ordinal1 X1 -> False)
  -> (forall X3 X2 X1, (X1 = k6_numbers -> False) -> (v7_ordinal1 (esk4_3 X2 X3 X1) -> False) -> X1 = (k2_nat_d X2 X3) -> v7_ordinal1 X3 -> v7_ordinal1 X2 -> v7_ordinal1 X1 -> False)
  ...
  -> (forall X1 X2 X3, ((k6_int_1 (k2_xcmplx_0 X1 (k3_xcmplx_0 X2 X3)) X3) = (k6_int_1 X1 X3) -> False) -> v1_int_1 X3 -> v1_int_1 X2 -> v1_int_1 X1 -> False)
  ...
  -> ((k4_nat_d (k4_nat_d esk2_0 (k3_xcmplx_0 esk1_0 esk3_0)) esk3_0) = (k4_nat_d esk2_0 esk3_0) -> False)
