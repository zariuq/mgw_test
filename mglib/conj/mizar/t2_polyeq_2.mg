...
Theorem t2_polyeq_2:
 ...
 forall v1_xcmplx_0:set -> prop,
  ...
  -> ((esk4_0 = k6_numbers -> False) -> (k6_xcmplx_0 (k2_xcmplx_0 (k2_xcmplx_0 (k3_xcmplx_0 esk1_0 (k3_square_1 esk5_0)) (k3_xcmplx_0 esk2_0 esk5_0)) esk3_0) (k3_xcmplx_0 np__2 esk1_0)) = k6_numbers -> False)
  -> (forall X2 X1 X3, ((k4_prepower X2 (esk17_3 X2 X3 X1)) = X1 -> False) -> X1 = (k3_power X2 X3) -> v1_int_1 X3 -> epred1_3 X1 X3 X2 -> False)
  -> (forall X1 X3 X2, (v1_int_1 (esk17_3 X1 X2 X3) -> False) -> X3 = (k3_power X1 X2) -> v1_int_1 X2 -> epred1_3 X3 X2 X1 -> False)
  -> (forall X1 X3 X2, ((esk17_3 X1 X2 X3) = X2 -> False) -> X3 = (k3_power X1 X2) -> v1_int_1 X2 -> epred1_3 X3 X2 X1 -> False)
  ...
  -> (forall X1 X3 X4 X2, (X2 = k6_numbers -> False) -> (X1 = k6_numbers -> False) -> ((k7_xcmplx_0 X3 X2) = (k7_xcmplx_0 X4 X1) -> False) -> (k3_xcmplx_0 X3 X1) = (k3_xcmplx_0 X4 X2) -> v1_xcmplx_0 X4 -> v1_xcmplx_0 X3 -> v1_xcmplx_0 X2 -> v1_xcmplx_0 X1 -> False)
