...
Theorem t7_ordinal4:
 ...
 forall k1_xboole_0:set,
     (forall X3 X1 X2 X5 X4, (X4 = k1_xboole_0 -> False) -> (r2_hidden (k1_funct_1 X1 X2) X3 -> False) -> v3_ordinal1 X5 -> v3_ordinal1 X3 -> v3_ordinal1 X2 -> r1_ordinal2 X4 X1 -> r2_hidden X5 X4 -> r2_hidden X4 X3 -> epred1_2 X1 X4 -> r2_hidden X2 (k9_xtuple_0 X1) -> r1_ordinal1 (esk27_4 X4 X1 X5 X3) X2 -> False)
  -> (forall X1 X3 X2 X5 X4, (X4 = k1_xboole_0 -> False) -> (r2_hidden X1 (k1_funct_1 X2 X3) -> False) -> v3_ordinal1 X5 -> v3_ordinal1 X3 -> v3_ordinal1 X1 -> r1_ordinal2 X4 X2 -> r2_hidden X4 X5 -> r2_hidden X1 X4 -> epred1_2 X2 X4 -> r2_hidden X3 (k9_xtuple_0 X2) -> r1_ordinal1 (esk27_4 X4 X2 X1 X5) X3 -> False)
  -> (forall X2 X3 X1, (X1 = k1_xboole_0 -> False) -> (r1_ordinal2 X1 X2 -> False) -> v3_ordinal1 X3 -> epred1_2 X2 X1 -> r2_hidden X3 (k9_xtuple_0 X2) -> r2_hidden (esk28_2 X1 X2) (k1_funct_1 X2 (esk30_3 X1 X2 X3)) -> r2_hidden (k1_funct_1 X2 (esk30_3 X1 X2 X3)) (esk29_2 X1 X2) -> False)
  -> (forall X4 X2 X3 X1, (X1 = k1_xboole_0 -> False) -> (r2_hidden (esk27_4 X1 X2 X3 X4) (k9_xtuple_0 X2) -> False) -> v3_ordinal1 X4 -> v3_ordinal1 X3 -> r1_ordinal2 X1 X2 -> r2_hidden X3 X1 -> r2_hidden X1 X4 -> epred1_2 X2 X1 -> False)
  -> (forall X4 X2 X3 X1, (X1 = k1_xboole_0 -> False) -> (v3_ordinal1 (esk27_4 X1 X2 X3 X4) -> False) -> v3_ordinal1 X4 -> v3_ordinal1 X3 -> r1_ordinal2 X1 X2 -> r2_hidden X3 X1 -> r2_hidden X1 X4 -> epred1_2 X2 X1 -> False)
  -> (forall X3 X2 X1, (r1_ordinal2 X2 X1 -> False) -> X2 = k1_xboole_0 -> (k1_funct_1 X1 (esk26_3 X2 X1 X3)) = k1_xboole_0 -> v3_ordinal1 X3 -> epred1_2 X1 X2 -> r2_hidden X3 (k9_xtuple_0 X1) -> False)
  -> (forall X3 X1 X2, (r1_ordinal2 X1 X2 -> False) -> (r2_hidden (esk26_3 X1 X2 X3) (k9_xtuple_0 X2) -> False) -> X1 = k1_xboole_0 -> v3_ordinal1 X3 -> epred1_2 X2 X1 -> r2_hidden X3 (k9_xtuple_0 X2) -> False)
  -> (forall X2 X3 X1, (X1 = k1_xboole_0 -> False) -> (r1_ordinal2 X1 X2 -> False) -> (r2_hidden (esk30_3 X1 X2 X3) (k9_xtuple_0 X2) -> False) -> v3_ordinal1 X3 -> epred1_2 X2 X1 -> r2_hidden X3 (k9_xtuple_0 X2) -> False)
  -> (forall X1 X2 X3, (r1_ordinal2 X2 X3 -> False) -> (r1_ordinal1 X1 (esk26_3 X2 X3 X1) -> False) -> X2 = k1_xboole_0 -> v3_ordinal1 X1 -> epred1_2 X3 X2 -> r2_hidden X1 (k9_xtuple_0 X3) -> False)
  -> (forall X3 X1 X2, (X2 = k1_xboole_0 -> False) -> (r1_ordinal2 X2 X3 -> False) -> (r1_ordinal1 X1 (esk30_3 X2 X3 X1) -> False) -> v3_ordinal1 X1 -> epred1_2 X3 X2 -> r2_hidden X1 (k9_xtuple_0 X3) -> False)
  -> (forall X3 X1 X2, (r1_ordinal2 X1 X2 -> False) -> (v3_ordinal1 (esk26_3 X1 X2 X3) -> False) -> X1 = k1_xboole_0 -> v3_ordinal1 X3 -> epred1_2 X2 X1 -> r2_hidden X3 (k9_xtuple_0 X2) -> False)
  -> (forall X2 X3 X1, (X1 = k1_xboole_0 -> False) -> (r1_ordinal2 X1 X2 -> False) -> (v3_ordinal1 (esk30_3 X1 X2 X3) -> False) -> v3_ordinal1 X3 -> epred1_2 X2 X1 -> r2_hidden X3 (k9_xtuple_0 X2) -> False)
  -> (forall X2 X1 X3, ((k1_funct_1 X3 X1) = k1_xboole_0 -> False) -> X2 = k1_xboole_0 -> v3_ordinal1 X1 -> r1_ordinal2 X2 X3 -> epred1_2 X3 X2 -> r2_hidden X1 (k9_xtuple_0 X3) -> r1_ordinal1 (esk25_2 X2 X3) X1 -> False)
  ...
  -> (forall X1, (r1_ordinal1 (k1_funct_1 esk3_0 X1) (k1_funct_1 esk1_0 X1) -> False) -> v3_ordinal1 X1 -> r2_hidden X1 (k9_xtuple_0 esk1_0) -> False)
  -> (forall X1, (r1_ordinal1 (k1_funct_1 esk1_0 X1) (k1_funct_1 esk4_0 X1) -> False) -> v3_ordinal1 X1 -> r2_hidden X1 (k9_xtuple_0 esk1_0) -> False)
  -> (forall X2 X1, (r2_hidden (esk25_2 X1 X2) (k9_xtuple_0 X2) -> False) -> X1 = k1_xboole_0 -> r1_ordinal2 X1 X2 -> epred1_2 X2 X1 -> False)
  -> (forall X2 X1 X3, (r2_hidden X1 X3 -> False) -> v3_ordinal1 X3 -> v3_ordinal1 X2 -> v1_ordinal1 X1 -> r2_hidden X2 X3 -> r1_tarski X1 X2 -> False)
  -> (forall X2 X1, (X1 = k1_xboole_0 -> False) -> (r1_ordinal2 X1 X2 -> False) -> (r2_hidden (esk28_2 X1 X2) X1 -> False) -> epred1_2 X2 X1 -> False)
  -> (forall X2 X1, (X1 = k1_xboole_0 -> False) -> (r1_ordinal2 X1 X2 -> False) -> (r2_hidden X1 (esk29_2 X1 X2) -> False) -> epred1_2 X2 X1 -> False)
  -> (forall X2 X1, (v3_ordinal1 (esk25_2 X1 X2) -> False) -> X1 = k1_xboole_0 -> r1_ordinal2 X1 X2 -> epred1_2 X2 X1 -> False)
  ...
  -> (forall X2 X1, (X1 = k1_xboole_0 -> False) -> (r1_ordinal2 X1 X2 -> False) -> (v3_ordinal1 (esk28_2 X1 X2) -> False) -> epred1_2 X2 X1 -> False)
  ...
  -> (forall X1, (v1_xboole_0 X1 -> False) -> (v3_card_1 (esk23_1 X1) np__1 -> False) -> False)
  ...
  -> (forall X1, (v1_funct_1 (esk22_1 X1) -> False) -> v1_card_1 X1 -> False)
  -> (forall X1, (v1_relat_1 (esk22_1 X1) -> False) -> v1_card_1 X1 -> False)
  ...
  -> (r1_ordinal2 esk2_0 esk1_0 -> False)
  ...
  -> ((r1_ordinal2 esk2_0 esk4_0 -> False) -> False)
  -> ((r1_ordinal2 esk2_0 esk3_0 -> False) -> False)
  -> (((k9_xtuple_0 esk4_0) = (k9_xtuple_0 esk1_0) -> False) -> False)
  -> (((k9_xtuple_0 esk3_0) = (k9_xtuple_0 esk1_0) -> False) -> False)
  ...
  -> ((v1_ordinal2 esk4_0 -> False) -> False)
  ...
  -> ((v5_ordinal1 esk4_0 -> False) -> False)
