...
Theorem t37_sin_cos5:
 ...
 forall k7_sin_cos2:set,
     (forall X1, (X1 = k7_sin_cos2 -> False) -> (k10_real_1 (k9_real_1 (k1_seq_1 k24_sin_cos (esk2_1 X1)) (k1_seq_1 k24_sin_cos (k7_binop_2 (esk2_1 X1)))) (k7_real_1 (k1_seq_1 k24_sin_cos (esk2_1 X1)) (k1_seq_1 k24_sin_cos (k7_binop_2 (esk2_1 X1))))) = (k1_seq_1 X1 (esk2_1 X1)) -> v1_funct_1 X1 -> v1_funct_2 X1 k1_numbers k1_numbers -> m1_subset_1 X1 (k1_zfmisc_1 (k2_zfmisc_1 k1_numbers k1_numbers)) -> False)
  -> (forall X2 X1, ((k1_seq_1 X1 X2) = (k10_real_1 (k9_real_1 (k1_seq_1 k24_sin_cos X2) (k1_seq_1 k24_sin_cos (k7_binop_2 X2))) (k7_real_1 (k1_seq_1 k24_sin_cos X2) (k1_seq_1 k24_sin_cos (k7_binop_2 X2)))) -> False) -> X1 = k7_sin_cos2 -> v1_xreal_0 X2 -> v1_funct_1 X1 -> v1_funct_2 X1 k1_numbers k1_numbers -> m1_subset_1 X1 (k1_zfmisc_1 (k2_zfmisc_1 k1_numbers k1_numbers)) -> False)
  -> (forall X1, (X1 = k7_sin_cos2 -> False) -> (v1_xreal_0 (esk2_1 X1) -> False) -> v1_funct_1 X1 -> v1_funct_2 X1 k1_numbers k1_numbers -> m1_subset_1 X1 (k1_zfmisc_1 (k2_zfmisc_1 k1_numbers k1_numbers)) -> False)
  -> (forall X1, ((k13_complex1 (k2_xcmplx_0 (k25_sin_cos X1) (k25_sin_cos (k4_xcmplx_0 X1))) (k6_xcmplx_0 (k25_sin_cos X1) (k25_sin_cos (k4_xcmplx_0 X1)))) = (k1_sin_cos5 X1) -> False) -> v1_xreal_0 X1 -> False)
  ...
  -> (forall X1 X2 X3, ((k7_xcmplx_0 (k3_xcmplx_0 X1 X2) X3) = (k3_xcmplx_0 X1 (k7_xcmplx_0 X2 X3)) -> False) -> v1_xcmplx_0 X3 -> v1_xcmplx_0 X2 -> v1_xcmplx_0 X1 -> False)
  -> (forall X1, ((k10_real_1 np__2 (k6_xcmplx_0 (k25_sin_cos X1) (k25_sin_cos (k4_xcmplx_0 X1)))) = (k3_sin_cos5 X1) -> False) -> v1_xreal_0 X1 -> False)
  -> (forall X1, ((k10_real_1 np__2 (k2_xcmplx_0 (k25_sin_cos X1) (k25_sin_cos (k4_xcmplx_0 X1)))) = (k2_sin_cos5 X1) -> False) -> v1_xreal_0 X1 -> False)
  ...
  -> (forall X1, ((k10_real_1 np__1 (k3_sin_cos2 X1)) = (k3_sin_cos5 X1) -> False) -> v1_xreal_0 X1 -> False)
  ...
  -> ((k8_real_1 (k1_seq_1 k7_sin_cos2 esk1_0) (k1_sin_cos5 esk1_0)) = np__1 -> False)
  ...
  -> ((k6_xcmplx_0 (k25_sin_cos esk1_0) (k25_sin_cos (k4_xcmplx_0 esk1_0))) = k6_numbers -> False)
