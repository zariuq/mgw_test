...
Theorem t29_cfunct_1:
 ...
 forall k55_valued_1:set -> set -> set -> set,
 ...
 forall k19_valued_1:set -> set -> set -> set -> set -> set,
 forall k9_complex1:set -> set -> set,
 forall k2_numbers:set,
 forall k7_partfun1:set -> set -> set -> set,
     (forall X4 X1 X3 X2, ((k7_partfun1 k2_numbers (k19_valued_1 X2 k2_numbers k2_numbers X3 X4) X1) = (k9_complex1 (k7_partfun1 k2_numbers X3 X1) (k7_partfun1 k2_numbers X4 X1)) -> False) -> (v1_xboole_0 X2 -> False) -> v1_funct_1 X4 -> v1_funct_1 X3 -> m1_subset_1 X1 X2 -> m1_subset_1 X4 (k1_zfmisc_1 (k2_zfmisc_1 X2 k2_numbers)) -> m1_subset_1 X3 (k1_zfmisc_1 (k2_zfmisc_1 X2 k2_numbers)) -> r2_hidden X1 (k1_relset_1 X2 (k19_valued_1 X2 k2_numbers k2_numbers X3 X4)) -> False)
  -> (forall X3 X2 X1, ((k9_subset_1 X1 (k1_relset_1 X1 X2) (k1_relset_1 X1 X3)) = (k1_relset_1 X1 (k19_valued_1 X1 k2_numbers k2_numbers X2 X3)) -> False) -> (v1_xboole_0 X1 -> False) -> v1_funct_1 X3 -> v1_funct_1 X2 -> m1_subset_1 X3 (k1_zfmisc_1 (k2_zfmisc_1 X1 k2_numbers)) -> m1_subset_1 X2 (k1_zfmisc_1 (k2_zfmisc_1 X1 k2_numbers)) -> False)
  ...
  -> (forall X4 X2 X1 X3 X5, (m1_subset_1 (k19_valued_1 X1 X2 X3 X4 X5) (k1_zfmisc_1 (k2_zfmisc_1 X1 k2_numbers)) -> False) -> v1_funct_1 X5 -> v1_funct_1 X4 -> v1_membered X3 -> v1_membered X2 -> m1_subset_1 X5 (k1_zfmisc_1 (k2_zfmisc_1 X1 X3)) -> m1_subset_1 X4 (k1_zfmisc_1 (k2_zfmisc_1 X1 X2)) -> False)
  ...
  -> (forall X4 X2 X1 X3 X5, (v1_funct_1 (k19_valued_1 X1 X2 X3 X4 X5) -> False) -> v1_funct_1 X5 -> v1_funct_1 X4 -> v1_membered X3 -> v1_membered X2 -> m1_subset_1 X5 (k1_zfmisc_1 (k2_zfmisc_1 X1 X3)) -> m1_subset_1 X4 (k1_zfmisc_1 (k2_zfmisc_1 X1 X2)) -> False)
  ...
  -> (forall X3 X1 X4 X2 X5, ((k19_valued_1 X4 X1 X2 X3 X5) = (k19_valued_1 X4 X1 X2 X5 X3) -> False) -> v1_funct_1 X5 -> v1_funct_1 X3 -> v1_membered X2 -> v1_membered X1 -> m1_subset_1 X5 (k1_zfmisc_1 (k2_zfmisc_1 X4 X2)) -> m1_subset_1 X3 (k1_zfmisc_1 (k2_zfmisc_1 X4 X1)) -> False)
  -> (forall X2 X3 X1 X4, (X1 = X4 -> False) -> (k1_relset_1 X2 X1) = (k1_relset_1 X2 X4) -> (k1_funct_1 X1 (esk18_4 X2 X3 X1 X4)) = (k1_funct_1 X4 (esk18_4 X2 X3 X1 X4)) -> v1_funct_1 X4 -> v1_funct_1 X1 -> m1_subset_1 X4 (k1_zfmisc_1 (k2_zfmisc_1 X2 X3)) -> m1_subset_1 X1 (k1_zfmisc_1 (k2_zfmisc_1 X2 X3)) -> False)
  ...
  -> (forall X3 X1 X4 X2 X5, ((k19_valued_1 X4 X1 X2 X3 X5) = (k18_valued_1 X3 X5) -> False) -> v1_funct_1 X5 -> v1_funct_1 X3 -> v1_membered X2 -> v1_membered X1 -> m1_subset_1 X5 (k1_zfmisc_1 (k2_zfmisc_1 X4 X2)) -> m1_subset_1 X3 (k1_zfmisc_1 (k2_zfmisc_1 X4 X1)) -> False)
  -> (forall X2 X1 X3, (X1 = (k18_valued_1 X2 X3) -> False) -> (k9_xtuple_0 X1) = (k3_xboole_0 (k9_xtuple_0 X2) (k9_xtuple_0 X3)) -> (k3_xcmplx_0 (k1_funct_1 X2 (esk5_3 X2 X3 X1)) (k1_funct_1 X3 (esk5_3 X2 X3 X1))) = (k1_funct_1 X1 (esk5_3 X2 X3 X1)) -> v1_funct_1 X3 -> v1_funct_1 X2 -> v1_funct_1 X1 -> v1_relat_1 X3 -> v1_relat_1 X2 -> v1_relat_1 X1 -> v1_valued_0 X3 -> v1_valued_0 X2 -> False)
  ...
  -> (forall X1 X2 X3 X4, (X3 = X4 -> False) -> (r2_hidden (esk18_4 X1 X2 X3 X4) (k1_relset_1 X1 X3) -> False) -> (k1_relset_1 X1 X3) = (k1_relset_1 X1 X4) -> v1_funct_1 X4 -> v1_funct_1 X3 -> m1_subset_1 X4 (k1_zfmisc_1 (k2_zfmisc_1 X1 X2)) -> m1_subset_1 X3 (k1_zfmisc_1 (k2_zfmisc_1 X1 X2)) -> False)
  -> (forall X1 X2 X3 X4, (X3 = X4 -> False) -> (m1_subset_1 (esk18_4 X1 X2 X3 X4) X1 -> False) -> (k1_relset_1 X1 X3) = (k1_relset_1 X1 X4) -> v1_funct_1 X4 -> v1_funct_1 X3 -> m1_subset_1 X4 (k1_zfmisc_1 (k2_zfmisc_1 X1 X2)) -> m1_subset_1 X3 (k1_zfmisc_1 (k2_zfmisc_1 X1 X2)) -> False)
  ...
  -> (forall X1 X3 X2, ((k55_valued_1 X3 X1 (k55_valued_1 X3 X1 X2)) = (k55_valued_1 X3 X1 X2) -> False) -> v1_funct_1 X2 -> v1_membered X1 -> m1_subset_1 X2 (k1_zfmisc_1 (k2_zfmisc_1 X3 X1)) -> False)
  -> (forall X2 X1 X3, (m1_subset_1 (k55_valued_1 X1 X2 X3) (k1_zfmisc_1 (k2_zfmisc_1 X1 k1_numbers)) -> False) -> v1_funct_1 X3 -> v1_membered X2 -> m1_subset_1 X3 (k1_zfmisc_1 (k2_zfmisc_1 X1 X2)) -> False)
  ...
  -> (forall X1 X2, (X1 = (k54_valued_1 X2) -> False) -> (k9_xtuple_0 X1) = (k9_xtuple_0 X2) -> (k1_funct_1 X1 (esk4_2 X2 X1)) = (k17_complex1 (k1_funct_1 X2 (esk4_2 X2 X1))) -> v1_funct_1 X2 -> v1_funct_1 X1 -> v1_relat_1 X2 -> v1_relat_1 X1 -> v1_valued_0 X2 -> v3_valued_0 X1 -> False)
  -> (forall X2 X1 X3, (X3 = (k18_valued_1 X1 X2) -> False) -> (r2_hidden (esk5_3 X1 X2 X3) (k9_xtuple_0 X3) -> False) -> (k9_xtuple_0 X3) = (k3_xboole_0 (k9_xtuple_0 X1) (k9_xtuple_0 X2)) -> v1_funct_1 X3 -> v1_funct_1 X2 -> v1_funct_1 X1 -> v1_relat_1 X3 -> v1_relat_1 X2 -> v1_relat_1 X1 -> v1_valued_0 X2 -> v1_valued_0 X1 -> False)
  -> (forall X2 X1 X3, (v1_funct_1 (k55_valued_1 X1 X2 X3) -> False) -> v1_funct_1 X3 -> v1_membered X2 -> m1_subset_1 X3 (k1_zfmisc_1 (k2_zfmisc_1 X1 X2)) -> False)
  -> (forall X1 X3 X4 X2, ((k1_funct_1 X2 X1) = (k3_xcmplx_0 (k1_funct_1 X3 X1) (k1_funct_1 X4 X1)) -> False) -> X2 = (k18_valued_1 X3 X4) -> v1_funct_1 X4 -> v1_funct_1 X3 -> v1_funct_1 X2 -> v1_relat_1 X4 -> v1_relat_1 X3 -> v1_relat_1 X2 -> v1_valued_0 X4 -> v1_valued_0 X3 -> r2_hidden X1 (k9_xtuple_0 X2) -> False)
  -> (forall X1 X3 X2, ((k55_valued_1 X3 X1 X2) = (k54_valued_1 X2) -> False) -> v1_funct_1 X2 -> v1_membered X1 -> m1_subset_1 X2 (k1_zfmisc_1 (k2_zfmisc_1 X3 X1)) -> False)
  ...
  -> (forall X3 X1 X2, ((k3_xcmplx_0 (k1_funct_1 X1 X3) (k1_funct_1 X2 X3)) = (k1_funct_1 (k18_valued_1 X1 X2) X3) -> False) -> v1_funct_1 X2 -> v1_funct_1 X1 -> v1_relat_1 X2 -> v1_relat_1 X1 -> v1_valued_0 X2 -> v1_valued_0 X1 -> False)
  ...
  -> (forall X1 X2 X3, ((k1_funct_1 X2 X1) = (k17_complex1 (k1_funct_1 X3 X1)) -> False) -> X2 = (k54_valued_1 X3) -> v1_funct_1 X3 -> v1_funct_1 X2 -> v1_relat_1 X3 -> v1_relat_1 X2 -> v1_valued_0 X3 -> v3_valued_0 X2 -> r2_hidden X1 (k9_xtuple_0 X2) -> False)
  ...
  -> (forall X2 X1 X3, ((k9_xtuple_0 X1) = (k3_xboole_0 (k9_xtuple_0 X2) (k9_xtuple_0 X3)) -> False) -> X1 = (k18_valued_1 X2 X3) -> v1_funct_1 X3 -> v1_funct_1 X2 -> v1_funct_1 X1 -> v1_relat_1 X3 -> v1_relat_1 X2 -> v1_relat_1 X1 -> v1_valued_0 X3 -> v1_valued_0 X2 -> False)
  -> (forall X1 X2, (X2 = (k54_valued_1 X1) -> False) -> (r2_hidden (esk4_2 X1 X2) (k9_xtuple_0 X2) -> False) -> (k9_xtuple_0 X1) = (k9_xtuple_0 X2) -> v1_funct_1 X2 -> v1_funct_1 X1 -> v1_relat_1 X2 -> v1_relat_1 X1 -> v1_valued_0 X1 -> v3_valued_0 X2 -> False)
  ...
  -> (forall X2 X1, ((k17_complex1 (k1_funct_1 X1 X2)) = (k1_funct_1 (k54_valued_1 X1) X2) -> False) -> v1_funct_1 X1 -> v1_relat_1 X1 -> v1_valued_0 X1 -> False)
  ...
  -> (forall X2 X1, ((k8_real_1 (k17_complex1 X1) (k17_complex1 X2)) = (k17_complex1 (k3_xcmplx_0 X1 X2)) -> False) -> v1_xcmplx_0 X2 -> v1_xcmplx_0 X1 -> False)
  ...
  -> (forall X1 X2, ((k9_xtuple_0 X1) = (k9_xtuple_0 X2) -> False) -> X1 = (k54_valued_1 X2) -> v1_funct_1 X2 -> v1_funct_1 X1 -> v1_relat_1 X2 -> v1_relat_1 X1 -> v1_valued_0 X2 -> v3_valued_0 X1 -> False)
  ...
  -> (forall X1, ((k54_valued_1 (k54_valued_1 X1)) = (k54_valued_1 X1) -> False) -> v1_funct_1 X1 -> v1_relat_1 X1 -> v1_valued_0 X1 -> False)
  ...
  -> (forall X1, (v2_seq_2 (k54_valued_1 X1) -> False) -> v1_funct_1 X1 -> v1_relat_1 X1 -> v3_valued_0 X1 -> False)
  -> (forall X1, (v3_valued_0 (k54_valued_1 X1) -> False) -> v1_funct_1 X1 -> v1_relat_1 X1 -> v3_valued_0 X1 -> False)
  -> (forall X1, (v3_valued_0 (k54_valued_1 X1) -> False) -> v1_funct_1 X1 -> v1_relat_1 X1 -> v1_valued_0 X1 -> False)
  -> (forall X1, (v1_relat_1 (k54_valued_1 X1) -> False) -> v1_funct_1 X1 -> v1_relat_1 X1 -> v3_valued_0 X1 -> False)
  -> (forall X1, (v1_relat_1 (k54_valued_1 X1) -> False) -> v1_funct_1 X1 -> v1_relat_1 X1 -> v1_valued_0 X1 -> False)
  -> (forall X1, (v1_funct_1 (k54_valued_1 X1) -> False) -> v1_funct_1 X1 -> v1_relat_1 X1 -> v3_valued_0 X1 -> False)
  -> (forall X1, (v1_funct_1 (k54_valued_1 X1) -> False) -> v1_funct_1 X1 -> v1_relat_1 X1 -> v1_valued_0 X1 -> False)
  ...
  -> (r2_relset_1 esk1_0 k1_numbers (k55_valued_1 esk1_0 k2_numbers (k19_valued_1 esk1_0 k2_numbers k2_numbers esk2_0 esk3_0)) (k20_valued_1 esk1_0 k1_numbers k1_numbers (k55_valued_1 esk1_0 k2_numbers esk2_0) (k55_valued_1 esk1_0 k2_numbers esk3_0)) -> False)
