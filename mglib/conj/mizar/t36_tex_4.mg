...
Theorem t36_tex_4:
 ...
 forall a_3_0_tex_4:set -> set -> set -> set,
 forall l1_pre_topc:set -> prop,
 forall v2_struct_0:set -> prop,
     (forall X3 X1 X4 X2, (v2_struct_0 X2 -> False) -> (r2_hidden (esk14_4 X1 X2 X3 X4) (k4_subset_1 (u1_struct_0 X2) X3 X4) -> False) -> l1_pre_topc X2 -> m1_subset_1 X4 (k1_zfmisc_1 (u1_struct_0 X2)) -> m1_subset_1 X3 (k1_zfmisc_1 (u1_struct_0 X2)) -> r2_hidden X1 (a_3_0_tex_4 X2 X3 X4) -> False)
  -> (forall X3 X1 X4 X2, (v2_struct_0 X2 -> False) -> (m1_subset_1 (esk14_4 X1 X2 X3 X4) (u1_struct_0 X2) -> False) -> l1_pre_topc X2 -> m1_subset_1 X4 (k1_zfmisc_1 (u1_struct_0 X2)) -> m1_subset_1 X3 (k1_zfmisc_1 (u1_struct_0 X2)) -> r2_hidden X1 (a_3_0_tex_4 X2 X3 X4) -> False)
  -> (forall X3 X1 X4 X2, ((k2_tex_4 X2 (esk14_4 X1 X2 X3 X4)) = X1 -> False) -> (v2_struct_0 X2 -> False) -> l1_pre_topc X2 -> m1_subset_1 X4 (k1_zfmisc_1 (u1_struct_0 X2)) -> m1_subset_1 X3 (k1_zfmisc_1 (u1_struct_0 X2)) -> r2_hidden X1 (a_3_0_tex_4 X2 X3 X4) -> False)
  -> (forall X3 X4 X5 X1 X2, (v2_struct_0 X2 -> False) -> (r2_hidden X3 (a_3_0_tex_4 X2 X4 X5) -> False) -> X3 = (k2_tex_4 X2 X1) -> l1_pre_topc X2 -> m1_subset_1 X1 (u1_struct_0 X2) -> m1_subset_1 X5 (k1_zfmisc_1 (u1_struct_0 X2)) -> m1_subset_1 X4 (k1_zfmisc_1 (u1_struct_0 X2)) -> r2_hidden X1 (k4_subset_1 (u1_struct_0 X2) X4 X5) -> False)
  ...
  -> (forall X1 X3 X2, (v2_struct_0 X2 -> False) -> (m1_subset_1 (esk13_3 X1 X2 X3) (u1_struct_0 X2) -> False) -> l1_pre_topc X2 -> r2_hidden X1 (a_2_8_tex_4 X2 X3) -> m1_subset_1 X3 (k1_zfmisc_1 (u1_struct_0 X2)) -> False)
  -> (forall X1 X3 X2, ((k2_tex_4 X2 (esk13_3 X1 X2 X3)) = X1 -> False) -> (v2_struct_0 X2 -> False) -> l1_pre_topc X2 -> r2_hidden X1 (a_2_8_tex_4 X2 X3) -> m1_subset_1 X3 (k1_zfmisc_1 (u1_struct_0 X2)) -> False)
  -> (forall X1 X3 X2, (v2_struct_0 X2 -> False) -> (r2_hidden (esk13_3 X1 X2 X3) X3 -> False) -> l1_pre_topc X2 -> r2_hidden X1 (a_2_8_tex_4 X2 X3) -> m1_subset_1 X3 (k1_zfmisc_1 (u1_struct_0 X2)) -> False)
  -> (forall X3 X1 X2, (m1_subset_1 (esk12_3 X1 X2 X3) (k1_zfmisc_1 (u1_struct_0 X2)) -> False) -> l1_pre_topc X2 -> m1_subset_1 X3 (u1_struct_0 X2) -> r2_hidden X1 (a_2_4_tex_4 X2 X3) -> False)
  -> (forall X3 X1 X2, (v1_tex_4 (esk12_3 X1 X2 X3) X2 -> False) -> l1_pre_topc X2 -> m1_subset_1 X3 (u1_struct_0 X2) -> r2_hidden X1 (a_2_4_tex_4 X2 X3) -> False)
  -> (forall X1 X2 X3, (r2_hidden X1 (esk12_3 X2 X3 X1) -> False) -> l1_pre_topc X3 -> m1_subset_1 X1 (u1_struct_0 X3) -> r2_hidden X2 (a_2_4_tex_4 X3 X1) -> False)
  ...
  -> (forall X3 X1 X2, ((esk12_3 X1 X2 X3) = X1 -> False) -> l1_pre_topc X2 -> m1_subset_1 X3 (u1_struct_0 X2) -> r2_hidden X1 (a_2_4_tex_4 X2 X3) -> False)
  ...
  -> (forall X1, (v7_struct_0 X1 -> False) -> (m1_subset_1 (esk31_1 X1) (k1_zfmisc_1 (u1_struct_0 X1)) -> False) -> l1_struct_0 X1 -> False)
  ...
  -> (forall X1, (v7_struct_0 X1 -> False) -> (v1_subset_1 (esk31_1 X1) (u1_struct_0 X1) -> False) -> l1_struct_0 X1 -> False)
  -> (forall X1, (v7_struct_0 X1 -> False) -> (v1_subset_1 (esk26_1 X1) (u1_struct_0 X1) -> False) -> l1_struct_0 X1 -> False)
  -> (forall X2 X1, (m1_subset_1 X1 X2 -> False) -> r2_hidden X1 X2 -> False)
  -> (forall X1, (v1_zfmisc_1 X1 -> False) -> v1_subset_1 (esk22_1 X1) X1 -> False)
  ...
  -> (forall X1, (v7_struct_0 X1 -> False) -> l1_struct_0 X1 -> v1_xboole_0 (esk31_1 X1) -> False)
  -> (forall X1, (v7_struct_0 X1 -> False) -> l1_struct_0 X1 -> v1_xboole_0 (esk29_1 X1) -> False)
  -> (forall X1, (v7_struct_0 X1 -> False) -> l1_struct_0 X1 -> v1_xboole_0 (esk26_1 X1) -> False)
  ...
  -> (forall X1, (v1_zfmisc_1 X1 -> False) -> (v1_subset_1 (esk16_1 X1) X1 -> False) -> False)
  -> (forall X1, (v1_xboole_0 X1 -> False) -> (v1_subset_1 (esk28_1 X1) X1 -> False) -> False)
  -> (forall X1, (v1_finset_1 (u1_struct_0 X1) -> False) -> l1_struct_0 X1 -> v8_struct_0 X1 -> False)
  -> (forall X1, (v1_zfmisc_1 (u1_struct_0 X1) -> False) -> l1_struct_0 X1 -> v7_struct_0 X1 -> False)
  -> (forall X1, (v1_xboole_0 (u1_struct_0 X1) -> False) -> v2_struct_0 X1 -> l1_struct_0 X1 -> False)
  -> (forall X1, (v7_struct_0 X1 -> False) -> (v1_zfmisc_1 (esk31_1 X1) -> False) -> l1_struct_0 X1 -> False)
  -> (forall X1, (v7_struct_0 X1 -> False) -> (v1_zfmisc_1 (esk26_1 X1) -> False) -> l1_struct_0 X1 -> False)
  ...
  -> (forall X1, (v1_zfmisc_1 X1 -> False) -> v1_xboole_0 (esk22_1 X1) -> False)
  ...
  -> (forall X1, (v1_zfmisc_1 X1 -> False) -> (v1_zfmisc_1 (esk16_1 X1) -> False) -> False)
  ...
  -> ((k4_subset_1 (u1_struct_0 esk1_0) (k3_tex_4 esk1_0 esk2_0) (k3_tex_4 esk1_0 esk3_0)) = (k3_tex_4 esk1_0 (k4_subset_1 (u1_struct_0 esk1_0) esk2_0 esk3_0)) -> False)
  ...
  -> ((v1_zfmisc_1 esk18_0 -> False) -> False)
