...
Theorem t9_aff_3:
 ...
 forall epred1_11:set -> set -> set -> set -> set -> set -> set -> set -> set -> set -> set -> prop,
     (forall X1 X3 X6 X7 X8 X11 X10 X9 X5 X4 X2, (epred1_11 X1 X2 X9 X3 X4 X7 X8 X6 X5 X10 X11 -> False) -> r2_analoaf X1 X2 X3 X4 (esk29_11 X5 X6 X4 X7 X3 X8 X9 X2 X10 X11 X1) -> False)
  -> (forall X1 X3 X8 X9 X11 X10 X7 X6 X5 X4 X2, (epred2_11 X1 X11 X10 X2 X8 X4 X7 X6 X3 X5 X9 -> False) -> (r2_analoaf X1 X2 X3 X4 (esk30_11 X5 X3 X6 X4 X7 X8 X2 X9 X10 X11 X1) -> False) -> False)
  -> (forall X1 X3 X4 X6 X8 X10 X11 X9 X7 X5 X2, (epred2_11 X1 X11 X10 X8 X7 X5 X6 X4 X3 X2 X9 -> False) -> (r1_aff_1 X1 X2 X3 (esk30_11 X2 X3 X4 X5 X6 X7 X8 X9 X10 X11 X1) -> False) -> False)
  -> (forall X1 X3 X4 X8 X10 X11 X9 X7 X6 X5 X2, (epred2_11 X1 X11 X10 X8 X7 X6 X3 X2 X5 X4 X9 -> False) -> (r1_aff_1 X1 X2 X3 (esk30_11 X4 X5 X2 X6 X3 X7 X8 X9 X10 X11 X1) -> False) -> False)
  -> (forall X1 X3 X4 X5 X8 X10 X11 X9 X7 X6 X2, (epred1_11 X1 X9 X8 X3 X5 X6 X7 X2 X4 X10 X11 -> False) -> (r1_aff_1 X1 X2 X3 (esk29_11 X4 X2 X5 X6 X3 X7 X8 X9 X10 X11 X1) -> False) -> False)
  -> (forall X1 X3 X4 X6 X7 X8 X10 X11 X9 X5 X2, (epred1_11 X1 X9 X8 X7 X6 X3 X2 X5 X4 X10 X11 -> False) -> (r1_aff_1 X1 X2 X3 (esk29_11 X4 X5 X6 X3 X7 X2 X8 X9 X10 X11 X1) -> False) -> False)
  -> (forall X11 X2 X4 X6 X8 X10 X9 X7 X5 X3 X1, (epred2_11 X11 X10 X9 X7 X6 X4 X5 X3 X2 X1 X8 -> False) -> (m1_subset_1 (esk30_11 X1 X2 X3 X4 X5 X6 X7 X8 X9 X10 X11) (u1_struct_0 X11) -> False) -> False)
  -> (forall X11 X2 X4 X6 X8 X10 X9 X7 X5 X3 X1, (epred1_11 X11 X8 X7 X5 X3 X4 X6 X2 X1 X9 X10 -> False) -> (m1_subset_1 (esk29_11 X1 X2 X3 X4 X5 X6 X7 X8 X9 X10 X11) (u1_struct_0 X11) -> False) -> False)
  -> (forall X1 X3 X6 X8 X11 X10 X9 X7 X5 X4 X2, (epred2_11 X11 X10 X9 X7 X6 X1 X5 X4 X3 X2 X8 -> False) -> (esk30_11 X2 X3 X4 X1 X5 X6 X7 X8 X9 X10 X11) = X1 -> False)
  -> (forall X1 X3 X4 X6 X8 X11 X10 X9 X7 X5 X2, (epred1_11 X11 X8 X7 X5 X1 X4 X6 X3 X2 X9 X10 -> False) -> (esk29_11 X2 X3 X1 X4 X5 X6 X7 X8 X9 X10 X11) = X1 -> False)
  -> (forall X5 X4 X2 X1 X7 X8 X10 X9 X3 X11 X6 X12, (X6 = X12 -> False) -> (X4 = X5 -> False) -> (X3 = X11 -> False) -> (X2 = X11 -> False) -> (X2 = X3 -> False) -> (r5_aff_1 X1 X2 X3 -> False) -> (r1_aff_1 X1 X10 X4 X9 -> False) -> (r1_aff_1 X1 X8 X5 X7 -> False) -> r2_hidden X10 X3 -> r2_hidden X9 X11 -> r2_hidden X8 X3 -> r2_hidden X7 X11 -> r2_hidden X5 X2 -> r2_hidden X4 X2 -> v1_aff_1 X11 X1 -> v1_aff_1 X3 X1 -> v1_aff_1 X2 X1 -> r5_aff_1 X1 X2 X11 -> m1_subset_1 X12 (u1_struct_0 X1) -> r1_aff_1 X1 X10 X9 X12 -> r1_aff_1 X1 X10 X4 X6 -> r1_aff_1 X1 X8 X7 X12 -> r1_aff_1 X1 X8 X5 X6 -> r2_analoaf X1 X4 X9 X6 X12 -> r2_analoaf X1 X4 X9 X5 X7 -> epred2_11 X1 X2 X3 X4 X5 X6 X7 X8 X9 X10 X11 -> False)
  ...
  -> (forall X1, (v7_struct_0 X1 -> False) -> (v7_aff_3 X1 -> False) -> v1_diraf X1 -> v2_diraf X1 -> l1_analoaf X1 -> epred2_11 X1 (esk12_1 X1) (esk13_1 X1) (esk15_1 X1) (esk16_1 X1) (esk21_1 X1) (esk20_1 X1) (esk18_1 X1) (esk19_1 X1) (esk17_1 X1) (esk14_1 X1) -> False)
  -> (forall X1, (v7_struct_0 X1 -> False) -> (v5_aff_3 X1 -> False) -> v1_diraf X1 -> v2_diraf X1 -> l1_analoaf X1 -> epred1_11 X1 (esk5_1 X1) (esk6_1 X1) (esk9_1 X1) (esk11_1 X1) (esk10_1 X1) (esk8_1 X1) (esk7_1 X1) (esk3_1 X1) (esk4_1 X1) (esk2_1 X1) -> False)
  -> (forall X6 X8 X9 X11 X10 X7 X2 X5 X4 X3 X1, (r2_analoaf X1 X2 X3 X4 X5 -> False) -> (epred2_11 X1 X6 X7 X2 X4 X8 X5 X9 X3 X10 X11 -> False) -> False)
  ...
  -> (forall X6 X7 X9 X11 X10 X8 X5 X1 X4 X3 X2, (epred2_11 X1 X5 X6 X3 X7 X8 X9 X10 X4 X2 X11 -> False) -> r1_aff_1 X1 X2 X3 X4 -> False)
  -> (forall X6 X9 X10 X11 X8 X7 X5 X1 X4 X3 X2, (epred2_11 X1 X5 X6 X7 X3 X8 X4 X2 X9 X10 X11 -> False) -> r1_aff_1 X1 X2 X3 X4 -> False)
  ...
  -> (forall X5 X9 X11 X10 X8 X7 X6 X2 X3 X4 X1, (r1_aff_1 X1 X2 X3 X4 -> False) -> (epred2_11 X1 X5 X6 X3 X7 X4 X8 X9 X10 X2 X11 -> False) -> False)
  -> (forall X5 X7 X11 X10 X9 X8 X6 X2 X3 X4 X1, (r1_aff_1 X1 X2 X3 X4 -> False) -> (epred2_11 X1 X5 X6 X7 X3 X4 X8 X2 X9 X10 X11 -> False) -> False)
  ...
  -> (forall X6 X8 X11 X10 X9 X7 X5 X4 X3 X1 X2, (r2_hidden X1 X2 -> False) -> (epred2_11 X3 X2 X4 X1 X5 X6 X7 X8 X9 X10 X11 -> False) -> False)
  -> (forall X5 X6 X8 X11 X10 X9 X7 X4 X3 X1 X2, (r2_hidden X1 X2 -> False) -> (epred2_11 X3 X2 X4 X5 X1 X6 X7 X8 X9 X10 X11 -> False) -> False)
  -> (forall X4 X5 X7 X11 X10 X9 X8 X6 X3 X1 X2, (r2_hidden X1 X2 -> False) -> (epred2_11 X3 X4 X2 X5 X6 X7 X8 X1 X9 X10 X11 -> False) -> False)
  -> (forall X4 X5 X7 X9 X11 X10 X8 X6 X3 X1 X2, (r2_hidden X1 X2 -> False) -> (epred2_11 X3 X4 X2 X5 X6 X7 X8 X9 X10 X1 X11 -> False) -> False)
  -> (forall X4 X6 X8 X9 X11 X10 X7 X5 X3 X1 X2, (r2_hidden X1 X2 -> False) -> (epred2_11 X3 X4 X5 X6 X7 X8 X1 X9 X10 X11 X2 -> False) -> False)
  ...
  -> (forall X3 X6 X8 X10 X11 X9 X7 X5 X4 X2 X1, (epred2_11 X3 X4 X1 X5 X6 X7 X8 X9 X10 X11 X2 -> False) -> X1 = X2 -> False)
  -> (forall X3 X5 X7 X9 X10 X11 X8 X6 X4 X2 X1, (epred2_11 X3 X4 X5 X1 X2 X6 X7 X8 X9 X10 X11 -> False) -> X1 = X2 -> False)
  ...
  -> (forall X1, (v7_struct_0 X1 -> False) -> (v7_aff_3 X1 -> False) -> (m1_subset_1 (esk14_1 X1) (k1_zfmisc_1 (u1_struct_0 X1)) -> False) -> v1_diraf X1 -> v2_diraf X1 -> l1_analoaf X1 -> False)
  -> (forall X1, (v7_struct_0 X1 -> False) -> (v7_aff_3 X1 -> False) -> (m1_subset_1 (esk13_1 X1) (k1_zfmisc_1 (u1_struct_0 X1)) -> False) -> v1_diraf X1 -> v2_diraf X1 -> l1_analoaf X1 -> False)
  -> (forall X1, (v7_struct_0 X1 -> False) -> (v7_aff_3 X1 -> False) -> (m1_subset_1 (esk12_1 X1) (k1_zfmisc_1 (u1_struct_0 X1)) -> False) -> v1_diraf X1 -> v2_diraf X1 -> l1_analoaf X1 -> False)
  -> (forall X1, (v7_struct_0 X1 -> False) -> (v5_aff_3 X1 -> False) -> (m1_subset_1 (esk4_1 X1) (k1_zfmisc_1 (u1_struct_0 X1)) -> False) -> v1_diraf X1 -> v2_diraf X1 -> l1_analoaf X1 -> False)
  -> (forall X1, (v7_struct_0 X1 -> False) -> (v5_aff_3 X1 -> False) -> (m1_subset_1 (esk3_1 X1) (k1_zfmisc_1 (u1_struct_0 X1)) -> False) -> v1_diraf X1 -> v2_diraf X1 -> l1_analoaf X1 -> False)
  -> (forall X1, (v7_struct_0 X1 -> False) -> (v5_aff_3 X1 -> False) -> (m1_subset_1 (esk2_1 X1) (k1_zfmisc_1 (u1_struct_0 X1)) -> False) -> v1_diraf X1 -> v2_diraf X1 -> l1_analoaf X1 -> False)
  -> (forall X1, (v7_struct_0 X1 -> False) -> (v7_aff_3 X1 -> False) -> (m1_subset_1 (esk21_1 X1) (u1_struct_0 X1) -> False) -> v1_diraf X1 -> v2_diraf X1 -> l1_analoaf X1 -> False)
  -> (forall X1, (v7_struct_0 X1 -> False) -> (v7_aff_3 X1 -> False) -> (m1_subset_1 (esk20_1 X1) (u1_struct_0 X1) -> False) -> v1_diraf X1 -> v2_diraf X1 -> l1_analoaf X1 -> False)
  -> (forall X1, (v7_struct_0 X1 -> False) -> (v7_aff_3 X1 -> False) -> (m1_subset_1 (esk19_1 X1) (u1_struct_0 X1) -> False) -> v1_diraf X1 -> v2_diraf X1 -> l1_analoaf X1 -> False)
  -> (forall X1, (v7_struct_0 X1 -> False) -> (v7_aff_3 X1 -> False) -> (m1_subset_1 (esk18_1 X1) (u1_struct_0 X1) -> False) -> v1_diraf X1 -> v2_diraf X1 -> l1_analoaf X1 -> False)
  -> (forall X1, (v7_struct_0 X1 -> False) -> (v7_aff_3 X1 -> False) -> (m1_subset_1 (esk17_1 X1) (u1_struct_0 X1) -> False) -> v1_diraf X1 -> v2_diraf X1 -> l1_analoaf X1 -> False)
  -> (forall X1, (v7_struct_0 X1 -> False) -> (v7_aff_3 X1 -> False) -> (m1_subset_1 (esk16_1 X1) (u1_struct_0 X1) -> False) -> v1_diraf X1 -> v2_diraf X1 -> l1_analoaf X1 -> False)
  -> (forall X1, (v7_struct_0 X1 -> False) -> (v7_aff_3 X1 -> False) -> (m1_subset_1 (esk15_1 X1) (u1_struct_0 X1) -> False) -> v1_diraf X1 -> v2_diraf X1 -> l1_analoaf X1 -> False)
  ...
  -> (forall X1, (v7_struct_0 X1 -> False) -> (v5_aff_3 X1 -> False) -> (m1_subset_1 (esk7_1 X1) (u1_struct_0 X1) -> False) -> v1_diraf X1 -> v2_diraf X1 -> l1_analoaf X1 -> False)
  -> (forall X1, (v7_struct_0 X1 -> False) -> (v5_aff_3 X1 -> False) -> (m1_subset_1 (esk6_1 X1) (u1_struct_0 X1) -> False) -> v1_diraf X1 -> v2_diraf X1 -> l1_analoaf X1 -> False)
  -> (forall X1, (v7_struct_0 X1 -> False) -> (v5_aff_3 X1 -> False) -> (m1_subset_1 (esk5_1 X1) (u1_struct_0 X1) -> False) -> v1_diraf X1 -> v2_diraf X1 -> l1_analoaf X1 -> False)
  ...
  -> (v5_aff_3 esk1_0 -> v7_aff_3 esk1_0 -> False)
  -> ((v5_aff_3 esk1_0 -> False) -> (v7_aff_3 esk1_0 -> False) -> False)
