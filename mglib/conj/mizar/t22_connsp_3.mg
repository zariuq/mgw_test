...
Theorem t22_connsp_3:
 ...
 forall k3_xboole_0:set -> set -> set,
  ...
  -> (forall X3 X2 X1, (m1_connsp_3 X2 X1 -> False) -> X2 = (k5_setfam_1 (u1_struct_0 X1) X3) -> l1_pre_topc X1 -> m1_subset_1 X2 (k1_zfmisc_1 (u1_struct_0 X1)) -> v3_connsp_1 (esk5_3 X1 X2 X3) X1 -> m1_subset_1 X3 (k1_zfmisc_1 (k1_zfmisc_1 (u1_struct_0 X1))) -> False)
  ...
  -> (m1_connsp_3 (k4_subset_1 (u1_struct_0 esk1_0) esk2_0 esk3_0) esk1_0 -> m1_connsp_3 (k9_subset_1 (u1_struct_0 esk1_0) esk2_0 esk3_0) esk1_0 -> False)
  -> (forall X3 X2 X1, (m1_connsp_3 X2 X1 -> False) -> (m1_subset_1 (esk5_3 X1 X2 X3) (k1_zfmisc_1 (u1_struct_0 X1)) -> False) -> X2 = (k5_setfam_1 (u1_struct_0 X1) X3) -> l1_pre_topc X1 -> m1_subset_1 X2 (k1_zfmisc_1 (u1_struct_0 X1)) -> m1_subset_1 X3 (k1_zfmisc_1 (k1_zfmisc_1 (u1_struct_0 X1))) -> False)
  -> (forall X3 X2 X1, (m1_connsp_3 X2 X1 -> False) -> (r2_hidden (esk5_3 X1 X2 X3) X3 -> False) -> X2 = (k5_setfam_1 (u1_struct_0 X1) X3) -> l1_pre_topc X1 -> m1_subset_1 X2 (k1_zfmisc_1 (u1_struct_0 X1)) -> m1_subset_1 X3 (k1_zfmisc_1 (k1_zfmisc_1 (u1_struct_0 X1))) -> False)
  ...
  -> (forall X3 X1 X2, (v3_connsp_1 X1 X2 -> False) -> l1_pre_topc X2 -> m1_connsp_3 X3 X2 -> r2_hidden X1 (esk4_2 X2 X3) -> m1_subset_1 X3 (k1_zfmisc_1 (u1_struct_0 X2)) -> m1_subset_1 X1 (k1_zfmisc_1 (u1_struct_0 X2)) -> False)
  ...
  -> (forall X1 X2 X3, (X2 = X3 -> False) -> (r1_xboole_0 X2 X3 -> False) -> v2_pre_topc X1 -> l1_pre_topc X1 -> v3_connsp_1 X3 X1 -> v3_connsp_1 X2 X1 -> m1_subset_1 X3 (k1_zfmisc_1 (u1_struct_0 X1)) -> m1_subset_1 X2 (k1_zfmisc_1 (u1_struct_0 X1)) -> False)
  ...
  -> (forall X2 X1, (m1_subset_1 (esk4_2 X1 X2) (k1_zfmisc_1 (k1_zfmisc_1 (u1_struct_0 X1))) -> False) -> l1_pre_topc X1 -> m1_connsp_3 X2 X1 -> m1_subset_1 X2 (k1_zfmisc_1 (u1_struct_0 X1)) -> False)
  ...
  -> (forall X1 X2, ((k5_setfam_1 (u1_struct_0 X2) (esk4_2 X2 X1)) = X1 -> False) -> l1_pre_topc X2 -> m1_connsp_3 X1 X2 -> m1_subset_1 X1 (k1_zfmisc_1 (u1_struct_0 X2)) -> False)
  ...
  -> (forall X1, (m1_connsp_3 (esk14_1 X1) X1 -> False) -> l1_pre_topc X1 -> False)
  ...
  -> ((m1_connsp_3 esk3_0 esk1_0 -> False) -> False)
  -> ((m1_connsp_3 esk2_0 esk1_0 -> False) -> False)
