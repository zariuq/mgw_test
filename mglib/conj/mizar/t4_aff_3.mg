...
Theorem t4_aff_3:
 ...
 forall epred3_8:set -> set -> set -> set -> set -> set -> set -> set -> prop,
 forall esk45_8:set -> set -> set -> set -> set -> set -> set -> set -> set,
 forall esk44_8:set -> set -> set -> set -> set -> set -> set -> set -> set,
 forall epred2_6:set -> set -> set -> set -> set -> set -> prop,
 forall esk38_6:set -> set -> set -> set -> set -> set -> set,
 forall esk42_6:set -> set -> set -> set -> set -> set -> set,
 forall esk41_6:set -> set -> set -> set -> set -> set -> set,
 ...
 forall esk43_8:set -> set -> set -> set -> set -> set -> set -> set -> set,
 ...
 forall r2_hidden:set -> set -> prop,
  ...
  -> (forall X1 X3 X5 X7 X8 X6 X4 X2, (epred3_8 X8 X3 X2 X7 X6 X4 X5 X1 -> False) -> (r2_analoaf X1 X2 X3 (esk44_8 X1 X4 X5 X6 X7 X3 X2 X8) (esk45_8 X1 X4 X5 X6 X7 X3 X2 X8) -> False) -> False)
  -> (forall X1 X3 X5 X8 X7 X6 X4 X2, (epred3_8 X8 X3 X7 X2 X6 X4 X5 X1 -> False) -> (r2_analoaf X1 X2 X3 (esk43_8 X1 X4 X5 X6 X2 X3 X7 X8) (esk45_8 X1 X4 X5 X6 X2 X3 X7 X8) -> False) -> False)
  -> (forall X1 X3 X5 X8 X7 X6 X4 X2, (epred3_8 X8 X7 X3 X2 X6 X4 X5 X1 -> False) -> (r2_analoaf X1 X2 X3 (esk43_8 X1 X4 X5 X6 X2 X7 X3 X8) (esk44_8 X1 X4 X5 X6 X2 X7 X3 X8) -> False) -> False)
  -> (forall X1 X2 X4 X6 X7 X8 X5 X3, (epred3_8 X8 X6 X7 X5 X4 X2 X3 X1 -> False) -> (m1_subset_1 (esk45_8 X1 X2 X3 X4 X5 X6 X7 X8) (u1_struct_0 X1) -> False) -> False)
  -> (forall X1 X2 X4 X6 X7 X8 X5 X3, (epred3_8 X8 X6 X7 X5 X4 X2 X3 X1 -> False) -> (m1_subset_1 (esk44_8 X1 X2 X3 X4 X5 X6 X7 X8) (u1_struct_0 X1) -> False) -> False)
  -> (forall X1 X2 X4 X6 X7 X8 X5 X3, (epred3_8 X8 X6 X7 X5 X4 X2 X3 X1 -> False) -> (m1_subset_1 (esk43_8 X1 X2 X3 X4 X5 X6 X7 X8) (u1_struct_0 X1) -> False) -> False)
  -> (forall X4 X2 X6 X7 X8 X5 X3 X1, (epred3_8 X8 X6 X7 X5 X4 X2 X3 X1 -> False) -> (r2_hidden (esk45_8 X1 X2 X3 X4 X5 X6 X7 X8) X4 -> False) -> False)
  -> (forall X3 X2 X4 X6 X7 X8 X5 X1, (epred3_8 X8 X6 X7 X5 X4 X2 X3 X1 -> False) -> (r2_hidden (esk44_8 X1 X2 X3 X4 X5 X6 X7 X8) X3 -> False) -> False)
  -> (forall X2 X4 X6 X7 X8 X5 X3 X1, (epred3_8 X8 X6 X7 X5 X4 X2 X3 X1 -> False) -> (r2_hidden (esk43_8 X1 X2 X3 X4 X5 X6 X7 X8) X2 -> False) -> False)
  -> (forall X1 X3 X5 X7 X8 X6 X4 X2, (epred3_8 X8 X1 X7 X6 X5 X3 X4 X2 -> False) -> (esk45_8 X2 X3 X4 X5 X6 X1 X7 X8) = X1 -> False)
  -> (forall X5 X4 X1 X8 X10 X9 X3 X2 X11 X6 X7, (X6 = X7 -> False) -> (X5 = X6 -> False) -> (X2 = X11 -> False) -> (X1 = X4 -> False) -> (X1 = X3 -> False) -> (X1 = X2 -> False) -> (r2_hidden X1 X5 -> False) -> (r1_aff_1 X8 X4 X3 X2 -> False) -> r2_hidden X11 X5 -> r2_hidden X10 X7 -> r2_hidden X9 X6 -> r2_hidden X4 X6 -> r2_hidden X3 X7 -> r2_hidden X2 X5 -> r2_hidden X1 X7 -> r2_hidden X1 X6 -> v1_aff_1 X7 X8 -> v1_aff_1 X6 X8 -> v1_aff_1 X5 X8 -> m1_subset_1 X11 (u1_struct_0 X8) -> m1_subset_1 X10 (u1_struct_0 X8) -> m1_subset_1 X9 (u1_struct_0 X8) -> r2_analoaf X8 X4 X3 X9 X10 -> r2_analoaf X8 X4 X2 X9 X11 -> r2_analoaf X8 X3 X2 X10 X11 -> epred3_8 X1 X2 X3 X4 X5 X6 X7 X8 -> False)
  -> (forall X1, (v7_struct_0 X1 -> False) -> (v5_aff_2 X1 -> False) -> v1_diraf X1 -> v2_diraf X1 -> l1_analoaf X1 -> epred3_8 (esk25_1 X1) (esk28_1 X1) (esk27_1 X1) (esk26_1 X1) (esk24_1 X1) (esk22_1 X1) (esk23_1 X1) X1 -> False)
  -> (forall X5 X6 X8 X7 X1 X4 X3 X2, (epred3_8 X5 X4 X3 X2 X6 X7 X8 X1 -> False) -> r1_aff_1 X1 X2 X3 X4 -> False)
  -> (forall X8 X6 X4 X3 X2 X5 X7 X1, (v7_struct_0 X1 -> False) -> (epred3_8 X5 X8 X7 X6 X4 X2 X3 X1 -> False) -> v1_diraf X1 -> v2_diraf X1 -> l1_analoaf X1 -> v5_aff_2 X1 -> m1_subset_1 X8 (u1_struct_0 X1) -> m1_subset_1 X7 (u1_struct_0 X1) -> m1_subset_1 X6 (u1_struct_0 X1) -> m1_subset_1 X5 (u1_struct_0 X1) -> m1_subset_1 X4 (k1_zfmisc_1 (u1_struct_0 X1)) -> m1_subset_1 X3 (k1_zfmisc_1 (u1_struct_0 X1)) -> m1_subset_1 X2 (k1_zfmisc_1 (u1_struct_0 X1)) -> False)
  -> (forall X4 X8 X7 X6 X5 X3 X2 X1, (epred3_8 X1 X3 X4 X5 X2 X6 X7 X8 -> False) -> r2_hidden X1 X2 -> False)
  -> (forall X4 X6 X7 X8 X5 X3 X1 X2, (v1_aff_1 X1 X2 -> False) -> (epred3_8 X3 X4 X5 X6 X1 X7 X8 X2 -> False) -> False)
  -> (forall X4 X6 X8 X7 X5 X3 X1 X2, (v1_aff_1 X1 X2 -> False) -> (epred3_8 X3 X4 X5 X6 X7 X1 X8 X2 -> False) -> False)
  -> (forall X4 X6 X8 X7 X5 X3 X1 X2, (v1_aff_1 X1 X2 -> False) -> (epred3_8 X3 X4 X5 X6 X7 X8 X1 X2 -> False) -> False)
  -> (forall X3 X5 X7 X8 X6 X4 X1 X2, (r2_hidden X1 X2 -> False) -> (epred3_8 X1 X3 X4 X5 X6 X2 X7 X8 -> False) -> False)
  -> (forall X3 X5 X7 X8 X6 X4 X1 X2, (r2_hidden X1 X2 -> False) -> (epred3_8 X1 X3 X4 X5 X6 X7 X2 X8 -> False) -> False)
  -> (forall X5 X6 X7 X8 X4 X3 X1 X2, (r2_hidden X1 X2 -> False) -> (epred3_8 X3 X1 X4 X5 X2 X6 X7 X8 -> False) -> False)
  -> (forall X4 X5 X7 X8 X6 X3 X1 X2, (r2_hidden X1 X2 -> False) -> (epred3_8 X3 X4 X1 X5 X6 X7 X2 X8 -> False) -> False)
  -> (forall X4 X7 X8 X6 X5 X3 X1 X2, (r2_hidden X1 X2 -> False) -> (epred3_8 X3 X4 X5 X1 X6 X2 X7 X8 -> False) -> False)
  -> (forall X3 X5 X8 X7 X6 X4 X2 X1, (epred3_8 X1 X2 X3 X4 X5 X6 X7 X8 -> False) -> X1 = X2 -> False)
  -> (forall X5 X8 X7 X6 X4 X3 X2 X1, (epred3_8 X1 X3 X2 X4 X5 X6 X7 X8 -> False) -> X1 = X2 -> False)
  -> (forall X4 X5 X8 X7 X6 X3 X2 X1, (epred3_8 X1 X3 X4 X2 X5 X6 X7 X8 -> False) -> X1 = X2 -> False)
  -> (forall X3 X5 X8 X7 X6 X4 X2 X1, (epred3_8 X3 X4 X5 X6 X2 X1 X7 X8 -> False) -> X1 = X2 -> False)
  -> (forall X3 X5 X7 X8 X6 X4 X2 X1, (epred3_8 X3 X4 X5 X6 X7 X1 X2 X8 -> False) -> X1 = X2 -> False)
  -> (forall X1 X2 X4 X6 X5 X3, (epred2_6 X1 X6 X5 X4 X3 X2 -> False) -> r2_analoaf X1 (esk38_6 X2 X3 X4 X5 X6 X1) (esk39_6 X2 X3 X4 X5 X6 X1) (esk41_6 X2 X3 X4 X5 X6 X1) (esk42_6 X2 X3 X4 X5 X6 X1) -> False)
  -> (forall X1 X3 X5 X6 X4 X2, (epred2_6 X1 X6 X5 X4 X3 X2 -> False) -> (r2_analoaf X1 X2 (esk39_6 X2 X3 X4 X5 X6 X1) (esk40_6 X2 X3 X4 X5 X6 X1) (esk42_6 X2 X3 X4 X5 X6 X1) -> False) -> False)
  -> (forall X1 X3 X5 X6 X4 X2, (epred2_6 X1 X6 X5 X4 X3 X2 -> False) -> (r2_analoaf X1 X2 (esk38_6 X2 X3 X4 X5 X6 X1) (esk40_6 X2 X3 X4 X5 X6 X1) (esk41_6 X2 X3 X4 X5 X6 X1) -> False) -> False)
  -> (forall X6 X2 X4 X5 X3 X1, (epred2_6 X6 X5 X4 X3 X2 X1 -> False) -> (m1_subset_1 (esk42_6 X1 X2 X3 X4 X5 X6) (u1_struct_0 X6) -> False) -> False)
  -> (forall X6 X2 X4 X5 X3 X1, (epred2_6 X6 X5 X4 X3 X2 X1 -> False) -> (m1_subset_1 (esk41_6 X1 X2 X3 X4 X5 X6) (u1_struct_0 X6) -> False) -> False)
  ...
  -> (forall X3 X2 X4 X5 X6 X1, (epred2_6 X6 X5 X4 X3 X2 X1 -> False) -> (r2_hidden (esk42_6 X1 X2 X3 X4 X5 X6) X3 -> False) -> False)
  -> (forall X4 X2 X5 X6 X3 X1, (epred2_6 X6 X5 X4 X3 X2 X1 -> False) -> (r2_hidden (esk41_6 X1 X2 X3 X4 X5 X6) X4 -> False) -> False)
  -> (forall X5 X2 X4 X6 X3 X1, (epred2_6 X6 X5 X4 X3 X2 X1 -> False) -> (r2_hidden (esk40_6 X1 X2 X3 X4 X5 X6) X5 -> False) -> False)
  -> (forall X3 X2 X4 X5 X6 X1, (epred2_6 X6 X5 X4 X3 X2 X1 -> False) -> (r2_hidden (esk39_6 X1 X2 X3 X4 X5 X6) X3 -> False) -> False)
  -> (forall X4 X2 X5 X6 X3 X1, (epred2_6 X6 X5 X4 X3 X2 X1 -> False) -> (r2_hidden (esk38_6 X1 X2 X3 X4 X5 X6) X4 -> False) -> False)
  -> (forall X1 X4 X5 X6 X3 X2, (epred2_6 X6 X5 X4 X3 X1 X2 -> False) -> (esk39_6 X2 X1 X3 X4 X5 X6) = X1 -> False)
  -> (forall X1 X4 X5 X6 X3 X2, (epred2_6 X6 X5 X4 X3 X1 X2 -> False) -> (esk38_6 X2 X1 X3 X4 X5 X6) = X1 -> False)
  ...
  -> (forall X2 X3 X1, (v7_struct_0 X1 -> False) -> (r5_aff_1 X1 X2 X3 -> False) -> (m1_subset_1 (esk37_3 X1 X2 X3) (u1_struct_0 X1) -> False) -> v1_diraf X1 -> v2_diraf X1 -> l1_analoaf X1 -> v1_aff_1 X3 X1 -> v1_aff_1 X2 X1 -> m1_subset_1 X3 (k1_zfmisc_1 (u1_struct_0 X1)) -> m1_subset_1 X2 (k1_zfmisc_1 (u1_struct_0 X1)) -> False)
  -> (forall X2 X3 X1, (v7_struct_0 X1 -> False) -> (r5_aff_1 X1 X2 X3 -> False) -> (r2_hidden (esk37_3 X1 X2 X3) X2 -> False) -> v1_diraf X1 -> v2_diraf X1 -> l1_analoaf X1 -> v1_aff_1 X3 X1 -> v1_aff_1 X2 X1 -> m1_subset_1 X3 (k1_zfmisc_1 (u1_struct_0 X1)) -> m1_subset_1 X2 (k1_zfmisc_1 (u1_struct_0 X1)) -> False)
  -> (forall X2 X3 X1, (v7_struct_0 X1 -> False) -> (r5_aff_1 X1 X2 X3 -> False) -> (r2_hidden (esk37_3 X1 X2 X3) X3 -> False) -> v1_diraf X1 -> v2_diraf X1 -> l1_analoaf X1 -> v1_aff_1 X3 X1 -> v1_aff_1 X2 X1 -> m1_subset_1 X3 (k1_zfmisc_1 (u1_struct_0 X1)) -> m1_subset_1 X2 (k1_zfmisc_1 (u1_struct_0 X1)) -> False)
  ...
  -> (forall X2 X3 X1, (v7_struct_0 X1 -> False) -> (r5_aff_1 X1 X2 (esk36_3 X1 X3 X2) -> False) -> v1_diraf X1 -> l1_analoaf X1 -> v1_aff_1 X2 X1 -> m1_subset_1 X3 (u1_struct_0 X1) -> m1_subset_1 X2 (k1_zfmisc_1 (u1_struct_0 X1)) -> False)
  -> (forall X3 X2 X1, (v7_struct_0 X1 -> False) -> (m1_subset_1 (esk36_3 X1 X2 X3) (k1_zfmisc_1 (u1_struct_0 X1)) -> False) -> v1_diraf X1 -> l1_analoaf X1 -> v1_aff_1 X3 X1 -> m1_subset_1 X2 (u1_struct_0 X1) -> m1_subset_1 X3 (k1_zfmisc_1 (u1_struct_0 X1)) -> False)
  ...
  -> (forall X3 X1 X2, (v7_struct_0 X2 -> False) -> (r2_hidden X1 (esk36_3 X2 X1 X3) -> False) -> v1_diraf X2 -> l1_analoaf X2 -> v1_aff_1 X3 X2 -> m1_subset_1 X1 (u1_struct_0 X2) -> m1_subset_1 X3 (k1_zfmisc_1 (u1_struct_0 X2)) -> False)
  ...
  -> (forall X1, (v7_struct_0 X1 -> False) -> (v5_aff_2 X1 -> False) -> (m1_subset_1 (esk24_1 X1) (k1_zfmisc_1 (u1_struct_0 X1)) -> False) -> v1_diraf X1 -> v2_diraf X1 -> l1_analoaf X1 -> False)
  -> (forall X1, (v7_struct_0 X1 -> False) -> (v5_aff_2 X1 -> False) -> (m1_subset_1 (esk23_1 X1) (k1_zfmisc_1 (u1_struct_0 X1)) -> False) -> v1_diraf X1 -> v2_diraf X1 -> l1_analoaf X1 -> False)
  -> (forall X1, (v7_struct_0 X1 -> False) -> (v5_aff_2 X1 -> False) -> (m1_subset_1 (esk22_1 X1) (k1_zfmisc_1 (u1_struct_0 X1)) -> False) -> v1_diraf X1 -> v2_diraf X1 -> l1_analoaf X1 -> False)
  ...
  -> (forall X1, (v7_struct_0 X1 -> False) -> (v5_aff_2 X1 -> False) -> (m1_subset_1 (esk28_1 X1) (u1_struct_0 X1) -> False) -> v1_diraf X1 -> v2_diraf X1 -> l1_analoaf X1 -> False)
  -> (forall X1, (v7_struct_0 X1 -> False) -> (v5_aff_2 X1 -> False) -> (m1_subset_1 (esk27_1 X1) (u1_struct_0 X1) -> False) -> v1_diraf X1 -> v2_diraf X1 -> l1_analoaf X1 -> False)
  -> (forall X1, (v7_struct_0 X1 -> False) -> (v5_aff_2 X1 -> False) -> (m1_subset_1 (esk26_1 X1) (u1_struct_0 X1) -> False) -> v1_diraf X1 -> v2_diraf X1 -> l1_analoaf X1 -> False)
  -> (forall X1, (v7_struct_0 X1 -> False) -> (v5_aff_2 X1 -> False) -> (m1_subset_1 (esk25_1 X1) (u1_struct_0 X1) -> False) -> v1_diraf X1 -> v2_diraf X1 -> l1_analoaf X1 -> False)
  ...
  -> (forall X1, (v7_struct_0 X1 -> False) -> (v5_aff_2 X1 -> False) -> v1_diraf X1 -> v2_diraf X1 -> l1_analoaf X1 -> v4_aff_2 X1 -> False)
  -> (forall X1, (v7_struct_0 X1 -> False) -> (v4_aff_2 X1 -> False) -> v1_diraf X1 -> v2_diraf X1 -> l1_analoaf X1 -> v5_aff_2 X1 -> False)
