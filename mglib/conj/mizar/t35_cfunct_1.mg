...
Theorem t35_cfunct_1:
 ...
 forall v1_xboole_0:set -> prop,
     (forall X3 X2 X1, ((k9_subset_1 X1 (k7_subset_1 X1 (k1_relset_1 X1 X2) (k8_relset_1 X1 k2_numbers X2 (k1_tarski k6_numbers))) (k7_subset_1 X1 (k1_relset_1 X1 X3) (k8_relset_1 X1 k2_numbers X3 (k1_tarski k6_numbers)))) = (k7_subset_1 X1 (k1_relset_1 X1 (k19_valued_1 X1 k2_numbers k2_numbers X2 X3)) (k8_relset_1 X1 k2_numbers (k19_valued_1 X1 k2_numbers k2_numbers X2 X3) (k1_tarski k6_numbers))) -> False) -> (v1_xboole_0 X1 -> False) -> v1_funct_1 X3 -> v1_funct_1 X2 -> m1_subset_1 X3 (k1_zfmisc_1 (k2_zfmisc_1 X1 k2_numbers)) -> m1_subset_1 X2 (k1_zfmisc_1 (k2_zfmisc_1 X1 k2_numbers)) -> False)
  ...
  -> (forall X3 X1 X2, (X1 = (k2_cfunct_1 X2 X3) -> False) -> (v1_xboole_0 X2 -> False) -> (k1_relset_1 X2 X1) = (k7_subset_1 X2 (k1_relset_1 X2 X3) (k8_relset_1 X2 k2_numbers X3 (k1_tarski k6_numbers))) -> (k7_partfun1 k2_numbers X1 (esk4_3 X2 X3 X1)) = (k12_complex1 (k7_partfun1 k2_numbers X3 (esk4_3 X2 X3 X1))) -> v1_funct_1 X3 -> v1_funct_1 X1 -> m1_subset_1 X3 (k1_zfmisc_1 (k2_zfmisc_1 X2 k2_numbers)) -> m1_subset_1 X1 (k1_zfmisc_1 (k2_zfmisc_1 X2 k2_numbers)) -> False)
  ...
  -> (forall X3 X2 X1, (X3 = (k2_cfunct_1 X1 X2) -> False) -> (v1_xboole_0 X1 -> False) -> (r2_hidden (esk4_3 X1 X2 X3) (k1_relset_1 X1 X3) -> False) -> (k1_relset_1 X1 X3) = (k7_subset_1 X1 (k1_relset_1 X1 X2) (k8_relset_1 X1 k2_numbers X2 (k1_tarski k6_numbers))) -> v1_funct_1 X3 -> v1_funct_1 X2 -> m1_subset_1 X3 (k1_zfmisc_1 (k2_zfmisc_1 X1 k2_numbers)) -> m1_subset_1 X2 (k1_zfmisc_1 (k2_zfmisc_1 X1 k2_numbers)) -> False)
  -> (forall X3 X2 X1, (X3 = (k2_cfunct_1 X1 X2) -> False) -> (v1_xboole_0 X1 -> False) -> (m1_subset_1 (esk4_3 X1 X2 X3) X1 -> False) -> (k1_relset_1 X1 X3) = (k7_subset_1 X1 (k1_relset_1 X1 X2) (k8_relset_1 X1 k2_numbers X2 (k1_tarski k6_numbers))) -> v1_funct_1 X3 -> v1_funct_1 X2 -> m1_subset_1 X3 (k1_zfmisc_1 (k2_zfmisc_1 X1 k2_numbers)) -> m1_subset_1 X2 (k1_zfmisc_1 (k2_zfmisc_1 X1 k2_numbers)) -> False)
  ...
  -> (forall X3 X2 X1, ((k1_relset_1 X1 X2) = (k7_subset_1 X1 (k1_relset_1 X1 X3) (k8_relset_1 X1 k2_numbers X3 (k1_tarski k6_numbers))) -> False) -> (v1_xboole_0 X1 -> False) -> X2 = (k2_cfunct_1 X1 X3) -> v1_funct_1 X3 -> v1_funct_1 X2 -> m1_subset_1 X3 (k1_zfmisc_1 (k2_zfmisc_1 X1 k2_numbers)) -> m1_subset_1 X2 (k1_zfmisc_1 (k2_zfmisc_1 X1 k2_numbers)) -> False)
  ...
  -> (forall X2 X3 X1 X4, ((k7_partfun1 k2_numbers X3 X1) = (k12_complex1 (k7_partfun1 k2_numbers X4 X1)) -> False) -> (v1_xboole_0 X2 -> False) -> X3 = (k2_cfunct_1 X2 X4) -> v1_funct_1 X4 -> v1_funct_1 X3 -> m1_subset_1 X1 X2 -> r2_hidden X1 (k1_relset_1 X2 X3) -> m1_subset_1 X4 (k1_zfmisc_1 (k2_zfmisc_1 X2 k2_numbers)) -> m1_subset_1 X3 (k1_zfmisc_1 (k2_zfmisc_1 X2 k2_numbers)) -> False)
  ...
  -> (forall X2 X1, (v5_relat_1 (k4_xboole_0 X1 X2) k3_numbers -> False) -> v1_relat_1 X2 -> v1_relat_1 X1 -> v5_relat_1 X1 k3_numbers -> False)
  -> (forall X2 X1, (v5_relat_1 (k4_xboole_0 X1 X2) k4_numbers -> False) -> v1_relat_1 X2 -> v1_relat_1 X1 -> v5_relat_1 X1 k4_numbers -> False)
  ...
  -> (forall X2 X1, (v4_valued_0 (k4_xboole_0 X1 X2) -> False) -> v1_relat_1 X2 -> v1_relat_1 X1 -> v4_valued_0 X1 -> False)
  -> (forall X2 X1, (v4_valued_0 (k3_xboole_0 X1 X2) -> False) -> v1_relat_1 X2 -> v1_relat_1 X1 -> v4_valued_0 X1 -> False)
  -> (forall X2 X1, (v3_valued_0 (k4_xboole_0 X1 X2) -> False) -> v1_relat_1 X2 -> v1_relat_1 X1 -> v3_valued_0 X1 -> False)
  -> (forall X2 X1, (v3_valued_0 (k3_xboole_0 X1 X2) -> False) -> v1_relat_1 X2 -> v1_relat_1 X1 -> v3_valued_0 X1 -> False)
  -> (forall X2 X1, (v2_valued_0 (k4_xboole_0 X1 X2) -> False) -> v1_relat_1 X2 -> v1_relat_1 X1 -> v2_valued_0 X1 -> False)
  -> (forall X2 X1, (v2_valued_0 (k3_xboole_0 X1 X2) -> False) -> v1_relat_1 X2 -> v1_relat_1 X1 -> v2_valued_0 X1 -> False)
  -> (forall X2 X1, (v1_valued_0 (k4_xboole_0 X1 X2) -> False) -> v1_relat_1 X2 -> v1_relat_1 X1 -> v1_valued_0 X1 -> False)
  ...
  -> (forall X1, ((k12_complex1 X1) = (k5_xcmplx_0 X1) -> False) -> m1_subset_1 X1 k2_numbers -> False)
  ...
  -> (r2_relset_1 esk1_0 k2_numbers (k2_cfunct_1 esk1_0 (k19_valued_1 esk1_0 k2_numbers k2_numbers esk2_0 esk3_0)) (k19_valued_1 esk1_0 k2_numbers k2_numbers (k2_cfunct_1 esk1_0 esk2_0) (k2_cfunct_1 esk1_0 esk3_0)) -> False)
