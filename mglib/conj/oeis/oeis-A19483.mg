...
(** Bounty 1 PFG TMaioAZWYh4ng9ScfZw9YcxYr7PGyJMAjg9 **)
Section A19483.
...
Hypothesis H9: (forall X :e int, (forall Y :e int, ((F0 X Y) = ((W1 X Y) + (2 * ((2 * (X + X)) + X)))))).
...
Hypothesis H15: (forall X :e int, (forall Y :e int, ((F3 X Y) = (((X + X) + X) + Y)))).
...
Hypothesis H33: (forall X :e int, ((FAST X) = ((V2 X) * (V4 X)))).
Theorem A19483: (forall N :e int, ((0 <= N) -> ((SMALL N) = (FAST N)))).
Admitted.
End A19483.