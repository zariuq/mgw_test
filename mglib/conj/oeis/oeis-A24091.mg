...
(** Bounty 1 PFG TMMjbouc1n5EY25v7Y6uyyMMUaDViXbVCB5 **)
Section A24091.
...
Hypothesis H6: (forall X :e int, ((SMALL X) = ((V0 X) + - ((X * X) * X)))).
...
Hypothesis H17: (forall X :e int, ((FAST X) = ((V1 X) + - ((X * X) * X)))).
Theorem A24091: (forall N :e int, ((0 <= N) -> ((SMALL N) = (FAST N)))).
Admitted.
End A24091.