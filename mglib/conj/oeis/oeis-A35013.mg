...
(** Bounty 1 PFG TMcNCojYB5aLum6cQFeRGP7rBovh3rsZZs7 **)
Section A35013.
...
Hypothesis H1: (forall X :e int, (forall Y :e int, ((F0 X Y) = ((1 + 2) * (((1 + 2) * (X * Y)) + X))))).
...
Theorem A35013: (forall N :e int, ((0 <= N) -> ((SMALL N) = (FAST N)))).
Admitted.
End A35013.