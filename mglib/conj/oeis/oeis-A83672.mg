...
(** Bounty 1 PFG TMUyuWTZFzjzoepY3cby5xcrYdZjvysHQh5 **)
Section A83672.
...
Hypothesis H3: (forall X :e int, ((H0 X) = (X + - 1))).
Hypothesis H4: (I0 = 1).
Hypothesis H5: (forall X :e int, ((J0 X) = (2 + X))).
...
Hypothesis H10: (forall X :e int, (forall Y :e int, ((F1 X Y) = (Y + - X)))).
Hypothesis H11: (forall X :e int, (forall Y :e int, ((G1 X Y) = ((Y + Y) + Y)))).
Hypothesis H12: (forall X :e int, ((H1 X) = (X + - 1))).
Hypothesis H13: (I1 = 1).
Hypothesis H14: (forall X :e int, ((J1 X) = (((1 + 2) + X) * 2))).
...
Hypothesis H17: (forall X :e int, ((W1 X) = (U1 (H1 X) I1 (J1 X)))).
Hypothesis H18: (forall X :e int, ((FAST X) = (W1 X))).
Theorem A83672: (forall N :e int, ((0 <= N) -> ((SMALL N) = (FAST N)))).
Admitted.
End A83672.