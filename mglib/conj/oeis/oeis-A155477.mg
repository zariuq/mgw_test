...
(** Bounty 1 PFG TMLLPqAXmPjiiveZeDNypepYBufRnMEPAkP **)
Section A155477.
...
Hypothesis H28: (I4 = 1).
Hypothesis H29: (forall X :e int, ((F5 X) = ((X * X) + X))).
Hypothesis H30: (G5 = 2).
Hypothesis H31: (H5 = 2).
Hypothesis H32: (forall X :e int, (forall Y :e int, ((U5 X Y) = (if (X <= 0) then Y else (F5 (U5 (X + - 1) Y)))))).
Hypothesis H33: (V5 = (U5 G5 H5)).
Hypothesis H34: (J4 = (1 + V5)).
...
Hypothesis H37: (forall X :e int, ((W4 X) = (U4 (H4 X) I4 J4))).
Hypothesis H38: (forall X :e int, ((FAST X) = ((W2 X) * (W4 X)))).
Theorem A155477: (forall N :e int, ((0 <= N) -> ((SMALL N) = (FAST N)))).
Admitted.
End A155477.