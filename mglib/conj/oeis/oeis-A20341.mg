...
(** Bounty 1 PFG TMbbJ1hqhXDbz8vwUVQ4yYkwgEyunb3N5v6 **)
Section A20341.
...
Hypothesis H35: (forall X :e int, (forall Y :e int, ((F4 X Y) = (((V5 X Y) + (2 * ((X + X) + X))) + X)))).
...
Theorem A20341: (forall N :e int, ((0 <= N) -> ((SMALL N) = (FAST N)))).
Admitted.
End A20341.