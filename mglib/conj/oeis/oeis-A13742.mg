...
(** Bounty 1 PFG TMT1SLoBvqs7QwhKPkBMJouzwLnDd1qmgES **)
Section A13742.
...
Hypothesis H2: (forall X :e int, ((F1 X) = ((X + X) + X))).
Hypothesis H3: (G1 = 2).
...
Hypothesis H7: (forall X :e int, ((G0 X) = (2 + (V1 X)))).
Hypothesis H8: (H0 = 2).
...
Hypothesis H12: (forall X :e int, ((F2 X) = (2 * (X * X)))).
Hypothesis H13: (G2 = 2).
...
Hypothesis H22: (forall X :e int, ((F4 X) = ((((X * X) * X) * X) * X))).
Hypothesis H23: (G4 = 1).
...
Theorem A13742: (forall N :e int, ((0 <= N) -> ((SMALL N) = (FAST N)))).
Admitted.
End A13742.