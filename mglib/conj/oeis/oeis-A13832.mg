...
(** Bounty 1 PFG TMLyrXQUUeeq5v4CGU8uypGZmEzUsmXtA2j **)
Section A13832.
...
Hypothesis H2: (forall X :e int, ((G0 X) = ((1 + (2 + 2)) * (1 + (X + X))))).
Hypothesis H3: (H0 = 2).
...
Hypothesis H23: (G4 = 1).
Hypothesis H24: (forall X :e int, ((F5 X) = ((X * 2) * X))).
Hypothesis H25: (G5 = 1).
Hypothesis H26: (forall X :e int, ((F6 X) = (X + X))).
Hypothesis H27: (forall X :e int, ((G6 X) = X)).
Hypothesis H28: (H6 = 2).
Hypothesis H29: (forall X :e int, (forall Y :e int, ((U6 X Y) = (if (X <= 0) then Y else (F6 (U6 (X + - 1) Y)))))).
Hypothesis H30: (forall X :e int, ((V6 X) = (U6 (G6 X) H6))).
Hypothesis H31: (forall X :e int, ((H5 X) = (V6 X))).
Hypothesis H32: (forall X :e int, (forall Y :e int, ((U5 X Y) = (if (X <= 0) then Y else (F5 (U5 (X + - 1) Y)))))).
Hypothesis H33: (forall X :e int, ((V5 X) = (U5 G5 (H5 X)))).
Hypothesis H34: (forall X :e int, ((H4 X) = (V5 X))).
Hypothesis H35: (forall X :e int, (forall Y :e int, ((U4 X Y) = (if (X <= 0) then Y else (F4 (U4 (X + - 1) Y)))))).
Hypothesis H36: (forall X :e int, ((V4 X) = (U4 G4 (H4 X)))).
Hypothesis H37: (forall X :e int, ((FAST X) = ((V1 X) * (V4 X)))).
Theorem A13832: (forall N :e int, ((0 <= N) -> ((SMALL N) = (FAST N)))).
Admitted.
End A13832.