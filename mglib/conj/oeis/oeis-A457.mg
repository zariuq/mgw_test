...
(** Bounty 1 PFG TMPEUp8PXqzTWpXNwvAJmq2AkYVVyJDDxrZ **)
Section A457.
...
Hypothesis H1: (forall X :e int, (forall Y :e int, ((F0 X Y) = ((2 * ((X * Y) + X)) + X)))).
...
Theorem A457: (forall N :e int, ((0 <= N) -> ((SMALL N) = (FAST N)))).
Admitted.
End A457.