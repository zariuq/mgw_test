...
(** Bounty 1 PFG TMEyVfSwd8NNBKJFz36o1kbKhtroFdt39HD **)
Section A182543.
...
Hypothesis H16: (forall X :e int, ((SMALL X) = (((((V0 X) + (V2 X)) * 2) + - (if (X <= 0) then 0 else 1)) + 1))).
...
Hypothesis H21: (forall X :e int, (forall Y :e int, ((V4 X Y) = (U4 (G4 X Y) (H4 X Y))))).
Hypothesis H22: (forall X :e int, (forall Y :e int, ((F3 X Y) = (((V4 X Y) + (X * Y)) + X)))).
...
Hypothesis H32: (forall X :e int, ((FAST X) = (((((V3 X) + (V5 X)) * 2) + 2) + - (if (X <= 0) then 1 else 2)))).
Theorem A182543: (forall N :e int, ((0 <= N) -> ((SMALL N) = (FAST N)))).
Admitted.
End A182543.