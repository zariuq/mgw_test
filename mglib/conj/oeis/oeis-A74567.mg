...
(** Bounty 1 PFG TMJSYu5k4CPqmfWKJ1ZpRsL2sGSiFM62anP **)
Section A74567.
...
Hypothesis H9: (forall X :e int, ((F1 X) = (((2 * (X + X)) + X) + X))).
...
Theorem A74567: (forall N :e int, ((0 <= N) -> ((SMALL N) = (FAST N)))).
Admitted.
End A74567.