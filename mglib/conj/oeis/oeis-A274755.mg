...
(** Bounty 1 PFG TMRuek3y6Z9WxdkAVdJgVNRf7fLnTjVSSw5 **)
Section A274755.
...
Hypothesis H3: (forall X :e int, ((H0 X) = ((X * 2) + 2))).
Hypothesis H4: (I0 = 2).
...
Hypothesis H23: (forall X :e int, ((FAST X) = ((1 + (2 + (2 * (2 + 2)))) * ((V1 X) + - 1)))).
Theorem A274755: (forall N :e int, ((0 <= N) -> ((SMALL N) = (FAST N)))).
Admitted.
End A274755.