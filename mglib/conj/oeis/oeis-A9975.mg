...
(** Bounty 1 PFG TMXDZ1RQZd7sSnesnjBZxQ4pVutZedBFTyh **)
Section A9975.
...
Hypothesis H20: (forall X :e int, ((FAST X) = ((W2 X) * (if (X <= 0) then 1 else ((2 * (2 * (2 * (2 + 2)))) + - 1))))).
Theorem A9975: (forall N :e int, ((0 <= N) -> ((SMALL N) = (FAST N)))).
Admitted.
End A9975.