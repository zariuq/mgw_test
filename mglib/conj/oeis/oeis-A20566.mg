...
(** Bounty 1 PFG TMQfF7tirM8yXjnyzA7NqzzFVxvJyaQ2F4d **)
Section A20566.
...
Hypothesis H22: (forall X :e int, (forall Y :e int, ((F6 X Y) = (((2 * (X + X)) + (Y * Y)) + X)))).
...
Theorem A20566: (forall N :e int, ((0 <= N) -> ((SMALL N) = (FAST N)))).
Admitted.
End A20566.