...
(** Bounty 1 PFG TMJgPVsB4E5eu1mDd2Zt5oLWNZfiNyAiv8a **)
Section A22362.
...
Hypothesis H23: (forall X :e int, ((FAST X) = (2 * ((1 + (2 + (2 + 2))) * (if (X <= 0) then 0 else (W2 X)))))).
Theorem A22362: (forall N :e int, ((0 <= N) -> ((SMALL N) = (FAST N)))).
Admitted.
End A22362.