...
(** Bounty 1 PFG TMH5ewpJDGJwHgd94DngQgcgP3ueBxtqZjp **)
Section A291264.
...
Hypothesis H13: (forall X :e int, ((I1 X) = (2 + (2 + X)))).
Hypothesis H14: (forall X :e int, ((J1 X) = (1 + X))).
...
Theorem A291264: (forall N :e int, ((0 <= N) -> ((SMALL N) = (FAST N)))).
Admitted.
End A291264.