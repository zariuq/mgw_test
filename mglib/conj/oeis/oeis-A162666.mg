...
(** Bounty 1 PFG TMQZkHY7g5c98GRkPHfCEv3VWbGNsdvKSwF **)
Section A162666.
...
Hypothesis H7: (forall X :e int, (forall Y :e int, ((G0 X Y) = (2 * ((2 * (Y + Y)) + X))))).
...
Hypothesis H15: (forall X :e int, (forall Y :e int, ((F2 X Y) = ((2 * (2 * (X + X))) + Y)))).
Hypothesis H16: (forall X :e int, (forall Y :e int, ((G2 X Y) = (2 * ((2 * ((Y + Y) + Y)) + - X))))).
...
Theorem A162666: (forall N :e int, ((0 <= N) -> ((SMALL N) = (FAST N)))).
Admitted.
End A162666.