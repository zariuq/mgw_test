...
(** Bounty 1 PFG TMNpHzQYdsteYniWd3xKSeTrYWEJNeJdLDZ **)
Section A24167.
...
Hypothesis H1: (forall X :e int, (forall Y :e int, ((F1 X Y) = (0 + - (X * Y))))).
...
Hypothesis H17: (forall X :e int, (forall Y :e int, ((F2 X Y) = ((V3 X Y) + - ((1 + Y) * X))))).
...
Hypothesis H22: (forall X :e int, ((F4 X) = (0 + - X))).
...
Theorem A24167: (forall N :e int, ((0 <= N) -> ((SMALL N) = (FAST N)))).
Admitted.
End A24167.