...
(** Bounty 1 PFG TMZAHhf8FWJVFp21MwAYsvAZRUxAqtCyNtW **)
Section A276.
...
Hypothesis H6: (forall X :e int, (forall Y :e int, ((F0 X Y) = (((V1 X Y) + X) * (2 + Y))))).
...
Hypothesis H22: (forall X :e int, ((FAST X) = ((V2 X) * (1 + (2 + X))))).
Theorem A276: (forall N :e int, ((0 <= N) -> ((SMALL N) = (FAST N)))).
Admitted.
End A276.