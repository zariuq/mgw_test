...
(** Bounty 1 PFG TMdVprg6cBFGHSibgMtaLJRF1w7iviU3wnk **)
Section A221904.
...
Hypothesis H1: (forall X :e int, (forall Y :e int, ((F0 X Y) = ((2 * ((2 * (X + X)) + X)) + - (Y * Y))))).
...
Theorem A221904: (forall N :e int, ((0 <= N) -> ((SMALL N) = (FAST N)))).
Admitted.
End A221904.