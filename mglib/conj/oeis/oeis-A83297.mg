...
(** Bounty 1 PFG TMTjMQACszrSmuPvgaowpZxYzDtdNe8MFYE **)
Section A83297.
...
Hypothesis H2: (forall X :e int, (forall Y :e int, ((F1 X Y) = ((2 + Y) * X)))).
Hypothesis H3: (G1 = 2).
...
Hypothesis H15: (forall X :e int, (forall Y :e int, ((F2 X Y) = (((Y + - X) + Y) + Y)))).
...
Theorem A83297: (forall N :e int, ((0 <= N) -> ((SMALL N) = (FAST N)))).
Admitted.
End A83297.