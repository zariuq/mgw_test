...
(** Bounty 1 PFG TMVsxFwWyvnnq4UbupCfof3GhUDtL7NehYg **)
Section A198845.
...
Hypothesis H6: (forall X :e int, ((SMALL X) = ((2 * (2 * (V0 X))) + - 1))).
...
Hypothesis H15: (forall X :e int, ((FAST X) = ((2 * (2 * (W1 X))) + - 1))).
Theorem A198845: (forall N :e int, ((0 <= N) -> ((SMALL N) = (FAST N)))).
Admitted.
End A198845.