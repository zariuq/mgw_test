...
(** Bounty 1 PFG TMSWRcd9q2PgHeFnNmoTT9zSNuNiaJpKqMw **)
Section A1923.
...
Hypothesis H23: (forall X :e int, (forall Y :e int, ((F2 X Y) = (((W3 X Y) * (Y * Y)) + X)))).
...
Theorem A1923: (forall N :e int, ((0 <= N) -> ((SMALL N) = (FAST N)))).
Admitted.
End A1923.