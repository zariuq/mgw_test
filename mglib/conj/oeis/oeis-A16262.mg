...
(** Bounty 1 PFG TMbLWTwWSjsmXXPJabVHym6AhdgNktKz5FE **)
Section A16262.
...
Hypothesis H16: (forall X :e int, (forall Y :e int, ((F0 X Y) = (((V1 X Y) + - X) + (V3 X))))).
...
Hypothesis H22: (forall X :e int, (forall Y :e int, ((F4 X Y) = (((2 * ((2 * (X + X)) + X)) + X) + Y)))).
Hypothesis H23: (forall X :e int, (forall Y :e int, ((G4 X Y) = (((2 * (2 * (Y + Y))) + Y) + 1)))).
...
Hypothesis H30: (forall X :e int, ((FAST X) = (W4 X))).
Theorem A16262: (forall N :e int, ((0 <= N) -> ((SMALL N) = (FAST N)))).
Admitted.
End A16262.