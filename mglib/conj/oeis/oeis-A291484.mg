...
(** Bounty 1 PFG TMUEx9EzLeXjj3Pb7EWt65nqbh97gVpC885 **)
Section A291484.
...
Hypothesis H17: (forall X :e int, (forall Y :e int, ((F5 X Y) = (1 + (((Y * Y) + - Y) * X))))).
Hypothesis H18: (forall X :e int, (forall Y :e int, ((G5 X Y) = (Y + - 2)))).
Hypothesis H19: (forall X :e int, ((H5 X) = X)).
Hypothesis H20: (I5 = 0).
Hypothesis H21: (forall X :e int, ((J5 X) = X)).
...
Hypothesis H24: (forall X :e int, ((W5 X) = (U5 (H5 X) I5 (J5 X)))).
...
Hypothesis H30: (forall X :e int, (forall Y :e int, ((F3 X Y) = ((V4 X Y) + X)))).
...
Theorem A291484: (forall N :e int, ((0 <= N) -> ((SMALL N) = (FAST N)))).
Admitted.
End A291484.