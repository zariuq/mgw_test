...
(** Bounty 1 PFG TMY7U9CKa4fPAyGd7YLhcsTqvq4S6uqRMjT **)
Section A81076.
...
Hypothesis H9: (forall X :e int, ((SMALL X) = (1 + (2 + (W0 X))))).
...
Hypothesis H15: (forall X :e int, ((I2 X) = ((if (X <= 0) then 0 else 1) + 2))).
Hypothesis H16: (J2 = 2).
...
Theorem A81076: (forall N :e int, ((0 <= N) -> ((SMALL N) = (FAST N)))).
Admitted.
End A81076.