...
(** Bounty 1 PFG TMXaZXzXq32bU1y4aTFgRu2uQJdSSjHS6ZW **)
Section A198857.
...
Hypothesis H17: (forall X :e int, ((FAST X) = ((2 * ((1 + (2 + 2)) * (V1 X))) + - 1))).
Theorem A198857: (forall N :e int, ((0 <= N) -> ((SMALL N) = (FAST N)))).
Admitted.
End A198857.