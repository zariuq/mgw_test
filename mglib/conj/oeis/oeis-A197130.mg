...
(** Bounty 1 PFG TMUyXAaPTPqeorGjqLuQwMHRuddbLfbNnYj **)
Section A197130.
...
Hypothesis H6: (forall X :e int, (forall Y :e int, ((F0 X Y) = ((((V1 X Y) + X) * (1 + (Y + Y))) + X)))).
...
Hypothesis H17: (forall X :e int, (forall Y :e int, ((F2 X Y) = ((((V3 X Y) + X) * Y) + X)))).
Hypothesis H18: (forall X :e int, ((G2 X) = X)).
Hypothesis H19: (forall X :e int, ((H2 X) = (1 + X))).
...
Hypothesis H27: (forall X :e int, ((FAST X) = ((V2 X) * (V4 X)))).
Theorem A197130: (forall N :e int, ((0 <= N) -> ((SMALL N) = (FAST N)))).
Admitted.
End A197130.