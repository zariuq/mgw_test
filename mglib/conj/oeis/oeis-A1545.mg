...
(** Bounty 1 PFG TMUoACcoEN4ZHvUq8XRr5FPYkKZkFRopfUQ **)
Section A1545.
...
Hypothesis H8: (G1 = 1).
Hypothesis H9: (forall X :e int, ((H1 X) = (2 + ((2 * (X + X)) + X)))).
...
Hypothesis H12: (forall X :e int, ((FAST X) = ((V1 X) + - 2))).
Theorem A1545: (forall N :e int, ((0 <= N) -> ((SMALL N) = (FAST N)))).
Admitted.
End A1545.