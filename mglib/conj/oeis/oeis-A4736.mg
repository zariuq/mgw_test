...
(** Bounty 1 PFG TMcUQkUPok9ztrzba1GwyYnu95pfyRsmx9m **)
Section A4736.
...
Hypothesis H1: (forall X :e int, (forall Y :e int, ((F0 X Y) = (X + - (if (X <= 0) then 0 else (1 + Y)))))).
...
Hypothesis H7: (forall X :e int, (forall Y :e int, ((F1 X Y) = (X + - (if (X <= 0) then 0 else (1 + Y)))))).
Hypothesis H8: (G1 = (1 + (2 * (2 + (2 + 2))))).
...
Hypothesis H12: (forall X :e int, ((FAST X) = (1 + - (V1 X)))).
Theorem A4736: (forall N :e int, ((0 <= N) -> ((SMALL N) = (FAST N)))).
Admitted.
End A4736.