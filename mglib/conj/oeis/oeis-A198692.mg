...
(** Bounty 1 PFG TMNCVcyijR1mzZUXghreoiu8r7U21Js71Kk **)
Section A198692.
...
Hypothesis H1: (forall X :e int, (forall Y :e int, ((F0 X Y) = (((1 + 2) * ((X + X) + Y)) + X)))).
Hypothesis H2: (G0 = 2).
...
Hypothesis H18: (forall X :e int, ((FAST X) = ((W1 X) + - 1))).
Theorem A198692: (forall N :e int, ((0 <= N) -> ((SMALL N) = (FAST N)))).
Admitted.
End A198692.