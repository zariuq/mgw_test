...
Hypothesis H9: (forall X :e int, ((F1 X) = ((X + X) + X))).
Hypothesis H10: (forall X :e int, ((G1 X) = (X + X))).
Hypothesis H11: (H1 = 1).
...
Hypothesis H31: (forall X :e int, (forall Y :e int, ((F4 X Y) = (X * Y)))).
Hypothesis H32: (forall X :e int, (forall Y :e int, ((G4 X Y) = Y))).
...
Hypothesis H39: (forall X :e int, ((FAST X) = (((W2 X) + (W3 X)) + (W4 X)))).
Theorem A74575: (forall N :e int, ((0 <= N) -> ((SMALL N) = (FAST N)))).
Admitted.
End A74575.