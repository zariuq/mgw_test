...
(** Bounty 1 PFG TMXHKPAVpQ3mDC53uaRmEnBeibkqYNDWHSq **)
Section A271939.
...
Hypothesis H1: (forall X :e int, (forall Y :e int, ((F0 X Y) = (((((Y * Y) * Y) + X) + X) + X)))).
...
Hypothesis H10: (forall X :e int, (forall Y :e int, ((F1 X Y) = ((2 * (((Y * Y) * Y) + X)) + X)))).
...
Hypothesis H18: (forall X :e int, ((FAST X) = (((W1 X) * 2) * 2))).
Theorem A271939: (forall N :e int, ((0 <= N) -> ((SMALL N) = (FAST N)))).
Admitted.
End A271939.