...
(** Bounty 1 PFG TMZvtbYytARvr946mCgem7XyaKSaTTa6Kzf **)
Section A24057.
...
Hypothesis H7: (G1 = 2).
Hypothesis H8: (forall X :e int, ((H1 X) = (X * X))).
...
Hypothesis H21: (G3 = 2).
Hypothesis H22: (forall X :e int, ((H3 X) = (X * X))).
...
Theorem A24057: (forall N :e int, ((0 <= N) -> ((SMALL N) = (FAST N)))).
Admitted.
End A24057.