...
(** Bounty 1 PFG TMHLibArZa3Qx9spgD8y3DrbRJPNb4e81f6 **)
Section A95807.
...
Hypothesis H10: (G2 = 2).
Hypothesis H11: (forall X :e int, ((H2 X) = (X + - 1))).
...
Hypothesis H21: (forall X :e int, (forall Y :e int, ((G4 X Y) = Y))).
Hypothesis H22: (forall X :e int, ((H4 X) = (X + - 1))).
Hypothesis H23: (I4 = 1).
Hypothesis H24: (J4 = (2 + (2 * (2 + 2)))).
...
Hypothesis H28: (forall X :e int, (forall Y :e int, ((F5 X Y) = ((X + - 1) * Y)))).
Hypothesis H29: (forall X :e int, (forall Y :e int, ((G5 X Y) = Y))).
Hypothesis H30: (forall X :e int, ((H5 X) = X)).
Hypothesis H31: (I5 = 1).
Hypothesis H32: (J5 = (1 + (2 * (2 + 2)))).
Hypothesis H33: (forall X :e int, (forall Y :e int, (forall Z :e int, ((U5 X Y Z) = (if (X <= 0) then Y else (F5 (U5 (X + - 1) Y Z) (V5 (X + - 1) Y Z))))))).
Hypothesis H34: (forall X :e int, (forall Y :e int, (forall Z :e int, ((V5 X Y Z) = (if (X <= 0) then Z else (G5 (U5 (X + - 1) Y Z) (V5 (X + - 1) Y Z))))))).
Hypothesis H35: (forall X :e int, ((W5 X) = (U5 (H5 X) I5 J5))).
Hypothesis H36: (forall X :e int, ((F3 X) = ((W4 X) + (W5 X)))).
Hypothesis H37: (G3 = 1).
Hypothesis H38: (forall X :e int, ((H3 X) = (2 + X))).
Hypothesis H39: (forall X :e int, (forall Y :e int, ((U3 X Y) = (if (X <= 0) then Y else (F3 (U3 (X + - 1) Y)))))).
Hypothesis H40: (forall X :e int, ((V3 X) = (U3 G3 (H3 X)))).
Hypothesis H41: (forall X :e int, ((FAST X) = (V3 X))).
Theorem A95807: (forall N :e int, ((0 <= N) -> ((SMALL N) = (FAST N)))).
Admitted.
End A95807.