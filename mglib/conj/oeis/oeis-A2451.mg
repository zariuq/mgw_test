...
(** Bounty 1 PFG TMNmDS18st5pUfgmkzMDRvJxNxtRoyW3VKL **)
Section A2451.
...
Hypothesis H17: (forall X :e int, (forall Y :e int, ((F3 X Y) = (((1 + (2 * (2 + 2))) * X) + Y)))).
...
Theorem A2451: (forall N :e int, ((0 <= N) -> ((SMALL N) = (FAST N)))).
Admitted.
End A2451.