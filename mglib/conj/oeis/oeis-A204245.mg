...
(** Bounty 1 PFG TMXmDXiqqKtJ8pZZkBnCAs2ssVd5iBL1ejs **)
Section A204245.
...
Hypothesis H1: (forall X :e int, (forall Y :e int, ((F0 X Y) = (((X * Y) + - 1) + X)))).
...
Hypothesis H6: (forall X :e int, (forall Y :e int, ((F2 X Y) = (X * Y)))).
...
Hypothesis H22: (forall X :e int, (forall Y :e int, ((F3 X Y) = ((V4 X Y) * X)))).
...
Hypothesis H28: (forall X :e int, ((G5 X) = X)).
Hypothesis H29: (H5 = 1).
Hypothesis H30: (forall X :e int, (forall Y :e int, ((U5 X Y) = (if (X <= 0) then Y else (F5 (U5 (X + - 1) Y) X))))).
Hypothesis H31: (forall X :e int, ((V5 X) = (U5 (G5 X) H5))).
Hypothesis H32: (forall X :e int, (forall Y :e int, ((F6 X Y) = ((X * Y) + (X + - 1))))).
Hypothesis H33: (forall X :e int, ((G6 X) = X)).
Hypothesis H34: (H6 = 1).
Hypothesis H35: (forall X :e int, (forall Y :e int, ((U6 X Y) = (if (X <= 0) then Y else (F6 (U6 (X + - 1) Y) X))))).
Hypothesis H36: (forall X :e int, ((V6 X) = (U6 (G6 X) H6))).
Hypothesis H37: (forall X :e int, ((FAST X) = (((V3 X) * (V5 X)) * (V6 X)))).
Theorem A204245: (forall N :e int, ((0 <= N) -> ((SMALL N) = (FAST N)))).
Admitted.
End A204245.