...
(** Bounty 1 PFG TMdLLXWCHze6PC2XEJvbvsse5THKbthRU64 **)
Section A16293.
...
Hypothesis H1: (forall X :e int, (forall Y :e int, ((F0 X Y) = (((2 * (((2 * (X + X)) + (Y * Y)) + X)) + - Y) + X)))).
...
Hypothesis H10: (forall X :e int, (forall Y :e int, ((F1 X Y) = (((2 * (((Y * Y) + X) + (2 * (X + X)))) + - Y) + X)))).
...
Theorem A16293: (forall N :e int, ((0 <= N) -> ((SMALL N) = (FAST N)))).
Admitted.
End A16293.