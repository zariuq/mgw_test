...
(** Bounty 1 PFG TMb49aYB2AGsqbJwgEzNTCQZWi1QSU2W5dJ **)
Section A2282.
...
Hypothesis H10: (forall X :e int, ((I1 X) = (if (X <= 0) then 0 else 2))).
...
Hypothesis H15: (forall X :e int, ((FAST X) = (((W1 X) * 2) * 2))).
Theorem A2282: (forall N :e int, ((0 <= N) -> ((SMALL N) = (FAST N)))).
Admitted.
End A2282.