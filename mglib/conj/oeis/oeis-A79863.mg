...
(** Bounty 1 PFG TMTyCzk2JNM2MB317uQJbJ35Br6Z9ucnAZt **)
Section A79863.
...
Hypothesis H8: (forall X :e int, ((H0 X) = (2 + ((2 * V1) + X)))).
...
Hypothesis H14: (forall X :e int, ((H2 X) = (2 + ((2 * (2 * (2 * (2 + 2)))) + X)))).
...
Theorem A79863: (forall N :e int, ((0 <= N) -> ((SMALL N) = (FAST N)))).
Admitted.
End A79863.