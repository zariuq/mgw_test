...
(** Bounty 1 PFG TMTYCG2dmgpCWjAEkUxr3GwnKPeHGVt6Pwz **)
Section A42300.
...
Hypothesis H15: (forall X :e int, (forall Y :e int, ((F2 X Y) = (((2 * (2 + (2 * (2 * (2 + (2 + 2)))))) * X) + Y)))).
Hypothesis H16: (forall X :e int, ((G2 X) = X)).
Hypothesis H17: (forall X :e int, ((H2 X) = X)).
Hypothesis H18: (I2 = (2 + (2 * (2 * (2 + (2 + 2)))))).
Hypothesis H19: (J2 = 1).
...
Theorem A42300: (forall N :e int, ((0 <= N) -> ((SMALL N) = (FAST N)))).
Admitted.
End A42300.