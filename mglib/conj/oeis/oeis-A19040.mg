...
(** Bounty 1 PFG TMRLMMjdWr8VNF1RG8zBZrRkQ8QH4hKmc8v **)
Section A19040.
...
Hypothesis H20: (forall X :e int, (forall Y :e int, ((F4 X Y) = (((2 * (X + X)) + (Y * Y)) + X)))).
...
Theorem A19040: (forall N :e int, ((0 <= N) -> ((SMALL N) = (FAST N)))).
Admitted.
End A19040.