...
(** Bounty 1 PFG TMacgTcARoeAuGdHnVGTpUPt6Syi97Sa6st **)
Section A79472.
...
Hypothesis H26: (forall X :e int, ((I3 X) = (if ((X + - 1) <= 0) then X else 2))).
Hypothesis H27: (J3 = 1).
...
Theorem A79472: (forall N :e int, ((0 <= N) -> ((SMALL N) = (FAST N)))).
Admitted.
End A79472.