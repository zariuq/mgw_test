...
(** Bounty 1 PFG TML9a4YXWqFnyCnCtv3PV3KRAWAJfgUtRkJ **)
Section A20871.
...
Hypothesis H9: (forall X :e int, ((SMALL X) = ((X * (W0 X)) + X))).
...
Hypothesis H18: (forall X :e int, ((FAST X) = ((X * (W1 X)) + X))).
Theorem A20871: (forall N :e int, ((0 <= N) -> ((SMALL N) = (FAST N)))).
Admitted.
End A20871.