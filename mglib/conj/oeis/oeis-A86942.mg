...
(** Bounty 1 PFG TMJnLisiNqR4yvXu1N7if4UwxcsqofppZU7 **)
Section A86942.
...
Hypothesis H6: (forall X :e int, ((SMALL X) = ((((V0 X) + - 2) + - 2) * 2))).
...
Hypothesis H15: (forall X :e int, ((FAST X) = (((2 + (2 * (2 + 2))) * ((W1 X) + - 1)) + 2))).
Theorem A86942: (forall N :e int, ((0 <= N) -> ((SMALL N) = (FAST N)))).
Admitted.
End A86942.