...
(** Bounty 1 PFG TMFeX6hx6T1XLSNao5racgSgMABFHDfzW88 **)
Section A45756.
...
Hypothesis H1: (forall X :e int, ((F1 X) = (((X + - 2) + X) + X))).
Hypothesis H2: (G1 = 2).
...
Hypothesis H12: (forall X :e int, (forall Y :e int, ((F2 X Y) = ((1 + ((2 * (2 * (Y + Y))) + Y)) * X)))).
...
Theorem A45756: (forall N :e int, ((0 <= N) -> ((SMALL N) = (FAST N)))).
Admitted.
End A45756.