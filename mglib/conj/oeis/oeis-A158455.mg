...
(** Bounty 1 PFG TMdXBuaGgBvynsEjFDYgSSfQi8SRNcsAPRV **)
Section A158455.
...
Hypothesis H3: (forall X :e int, ((H0 X) = (1 + (2 * (2 + (X + X)))))).
...
Hypothesis H9: (forall X :e int, ((H1 X) = (1 + (2 * (2 + (X + X)))))).
...
Theorem A158455: (forall N :e int, ((0 <= N) -> ((SMALL N) = (FAST N)))).
Admitted.
End A158455.