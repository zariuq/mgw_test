...
(** Bounty 1 PFG TMVHACudNpyLVs4j6QxWioooeSH7u8n6oLD **)
Section A24067.
...
Hypothesis H11: (forall X :e int, ((SMALL X) = ((V0 X) + - ((V1 X) * X)))).
...
Hypothesis H20: (forall X :e int, ((FAST X) = ((W2 X) + - ((((X * X) * X) * X) * X)))).
Theorem A24067: (forall N :e int, ((0 <= N) -> ((SMALL N) = (FAST N)))).
Admitted.
End A24067.