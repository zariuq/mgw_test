...
(** Bounty 1 PFG TMWVRRiLah31NG8DVS9sSBobdw8Bm7xtVqr **)
Section A224329.
...
Hypothesis H6: (forall X :e int, ((SMALL X) = ((1 + X) * ((V0 X) + - 1)))).
...
Hypothesis H15: (forall X :e int, ((FAST X) = ((1 + X) * ((W1 X) + - 1)))).
Theorem A224329: (forall N :e int, ((0 <= N) -> ((SMALL N) = (FAST N)))).
Admitted.
End A224329.