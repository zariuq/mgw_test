...
(** Bounty 1 PFG TMKiMPADQYAePSRUuijWsySM9a9Q19iikwK **)
Section A86948.
...
Hypothesis H15: (forall X :e int, ((FAST X) = (2 * (2 * ((W1 X) + - 2))))).
Theorem A86948: (forall N :e int, ((0 <= N) -> ((SMALL N) = (FAST N)))).
Admitted.
End A86948.