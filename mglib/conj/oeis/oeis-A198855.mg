...
(** Bounty 1 PFG TMLtsk3KdH5CgWnXpLcULm3jhubZ2hN6Q9P **)
Section A198855.
...
Hypothesis H17: (forall X :e int, ((FAST X) = (((1 + (2 + (2 + 2))) * (V1 X)) + - 1))).
Theorem A198855: (forall N :e int, ((0 <= N) -> ((SMALL N) = (FAST N)))).
Admitted.
End A198855.