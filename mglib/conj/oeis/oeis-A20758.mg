...
(** Bounty 1 PFG TMaYzPpkFnp8E2JR2jt8QsfpugnKmDUFKqx **)
Section A20758.
...
Hypothesis H16: (forall X :e int, (forall Y :e int, ((F0 X Y) = ((V1 X Y) + (2 * ((2 * (X + X)) + X)))))).
...
Hypothesis H40: (forall X :e int, (forall Y :e int, ((F4 X Y) = (((V5 X Y) + (2 * (X + X))) + X)))).
...
Hypothesis H45: (forall X :e int, ((F8 X) = (X + X))).
Hypothesis H46: (forall X :e int, ((G8 X) = X)).
Hypothesis H47: (H8 = 1).
Hypothesis H48: (forall X :e int, (forall Y :e int, ((U8 X Y) = (if (X <= 0) then Y else (F8 (U8 (X + - 1) Y)))))).
Hypothesis H49: (forall X :e int, ((V8 X) = (U8 (G8 X) H8))).
Hypothesis H50: (forall X :e int, ((FAST X) = ((V4 X) * (V8 X)))).
Theorem A20758: (forall N :e int, ((0 <= N) -> ((SMALL N) = (FAST N)))).
Admitted.
End A20758.