...
(** Bounty 1 PFG TMbEDcBhvVsqU3Jz3g3yjY6smtusrkXufss **)
Section A7574.
...
Hypothesis H2: (forall X :e int, ((G0 X) = (2 + X))).
...
Hypothesis H9: (forall X :e int, ((SMALL X) = (1 + ((W0 X) + - X)))).
...
Hypothesis H18: (forall X :e int, ((FAST X) = (((W1 X) + - 1) + - X))).
Theorem A7574: (forall N :e int, ((0 <= N) -> ((SMALL N) = (FAST N)))).
Admitted.
End A7574.