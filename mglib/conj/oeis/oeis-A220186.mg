...
(** Bounty 1 PFG TMEqt7XTZ7mVhQyUTzhJm765JCK2pgRfSCD **)
Section A220186.
...
Hypothesis H1: (forall X :e int, (forall Y :e int, ((F0 X Y) = (((2 + - (X + X)) * (1 + (2 + 2))) + - Y)))).
...
Theorem A220186: (forall N :e int, ((0 <= N) -> ((SMALL N) = (FAST N)))).
Admitted.
End A220186.