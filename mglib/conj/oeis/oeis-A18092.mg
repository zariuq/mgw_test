...
(** Bounty 1 PFG TMLUgX4ticrovCq5bCg5jT5rdmF27K7uCyj **)
Section A18092.
...
Hypothesis H17: (forall X :e int, (forall Y :e int, ((F3 X Y) = ((2 * (X + X)) + Y)))).
...
Theorem A18092: (forall N :e int, ((0 <= N) -> ((SMALL N) = (FAST N)))).
Admitted.
End A18092.