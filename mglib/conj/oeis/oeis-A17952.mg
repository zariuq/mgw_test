...
(** Bounty 1 PFG TMJnL1F8ws48bPCv2GQycBCSJSbHtQ5BWbb **)
Section A17952.
...
Hypothesis H1: (forall X :e int, (forall Y :e int, ((F1 X Y) = (2 * (2 * ((X + X) + Y)))))).
Hypothesis H2: (forall X :e int, (forall Y :e int, ((G1 X Y) = ((2 * (2 * (Y + Y))) + X)))).
...
Hypothesis H19: (forall X :e int, ((V4 X) = (U4 (G4 X) H4))).
Hypothesis H20: (forall X :e int, (forall Y :e int, ((F5 X Y) = (X * Y)))).
Hypothesis H21: (forall X :e int, (forall Y :e int, ((G5 X Y) = Y))).
Hypothesis H22: (forall X :e int, ((H5 X) = X)).
Hypothesis H23: (I5 = 1).
Hypothesis H24: (J5 = (1 + 2)).
...
Hypothesis H28: (forall X :e int, ((F3 X) = (((V4 X) + - 1) * (W5 X)))).
Hypothesis H29: (G3 = 1).
...
Hypothesis H33: (forall X :e int, (forall Y :e int, ((F2 X Y) = ((V3 X Y) + (2 * ((2 * (X + X)) + X)))))).
...
Theorem A17952: (forall N :e int, ((0 <= N) -> ((SMALL N) = (FAST N)))).
Admitted.
End A17952.