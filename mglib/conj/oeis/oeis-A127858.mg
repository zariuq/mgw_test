...
(** Bounty 1 PFG TMZCeV6KpBn1ZQcFKVuJY41276tbeX4gCY7 **)
Section A127858.
...
Hypothesis H12: (forall X :e int, (forall Y :e int, ((F2 X Y) = ((X * Y) + - 2)))).
...
Hypothesis H20: (forall X :e int, ((FAST X) = ((W2 X) * (1 + 2)))).
Theorem A127858: (forall N :e int, ((0 <= N) -> ((SMALL N) = (FAST N)))).
Admitted.
End A127858.