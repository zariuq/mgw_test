...
(** Bounty 1 PFG TMSYGB8o664rUUtPbNbDv6F6qLUb67B57pK **)
Section A93130.
...
Hypothesis H2: (forall X :e int, (forall Y :e int, ((G0 X Y) = (2 * (2 * ((Y + - X) + Y)))))).
...
Hypothesis H13: (forall X :e int, ((I1 X) = (if (X <= 0) then 0 else 1))).
Hypothesis H14: (J1 = 1).
...
Theorem A93130: (forall N :e int, ((0 <= N) -> ((SMALL N) = (FAST N)))).
Admitted.
End A93130.