...
(** Bounty 1 PFG TMMNer4KJAvxTpMLaX9GxG69v7PYLtJPAAo **)
Section A219205.
...
Hypothesis H1: (forall X :e int, (forall Y :e int, ((F0 X Y) = ((2 * ((Y * Y) + X)) + X)))).
...
Theorem A219205: (forall N :e int, ((0 <= N) -> ((SMALL N) = (FAST N)))).
Admitted.
End A219205.