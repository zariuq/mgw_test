...
(** Bounty 1 PFG TMGrKZ5d3ms4WPwxWS9PQsMMo51gBbFo55c **)
Section A13835.
...
Hypothesis H33: (forall X :e int, ((FAST X) = ((V1 X) * (V3 X)))).
Theorem A13835: (forall N :e int, ((0 <= N) -> ((SMALL N) = (FAST N)))).
Admitted.
End A13835.