...
(** Bounty 1 PFG TMaeir9eDLiPMA6QFknMjciv8WLURLtL5oc **)
Section A16294.
...
Hypothesis H8: (forall X :e int, (forall Y :e int, ((F1 X Y) = (((V2 X Y) + X) + X)))).
...
Hypothesis H17: (forall X :e int, ((F3 X) = ((2 * ((X + X) + X)) + - 1))).
...
Hypothesis H27: (forall X :e int, ((F5 X) = (X + X))).
...
Hypothesis H32: (forall X :e int, ((FAST X) = (((V3 X) + - (V4 X)) * (V5 X)))).
Theorem A16294: (forall N :e int, ((0 <= N) -> ((SMALL N) = (FAST N)))).
Admitted.
End A16294.