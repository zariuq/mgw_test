...
(** Bounty 1 PFG TMTeDA8Yxephg6wCZdMS6S2EL1hUryP6JT9 **)
Section A13812.
...
Hypothesis H7: (forall X :e int, ((G0 X) = (1 + (2 * (X + X))))).
Hypothesis H8: (H0 = 1).
...
Hypothesis H27: (forall X :e int, ((H4 X) = (1 + (X + X)))).
Hypothesis H28: (I4 = 1).
...
Theorem A13812: (forall N :e int, ((0 <= N) -> ((SMALL N) = (FAST N)))).
Admitted.
End A13812.