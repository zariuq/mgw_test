...
(** Bounty 1 PFG TMMEXLRTJKnaoJweUE3RV5bUYANARPRY4cB **)
Section A81045.
...
Hypothesis H2: (G1 = 2).
Hypothesis H3: (forall X :e int, (forall Y :e int, ((H1 X Y) = (X + Y)))).
...
Hypothesis H15: (forall X :e int, (forall Y :e int, ((F2 X Y) = ((2 * ((2 * (X + X)) + X)) + - Y)))).
Hypothesis H16: (G2 = 0).
Hypothesis H17: (forall X :e int, ((H2 X) = X)).
Hypothesis H18: (forall X :e int, ((I2 X) = (1 + X))).
Hypothesis H19: (forall X :e int, ((J2 X) = X)).
Hypothesis H20: (forall X :e int, (forall Y :e int, (forall Z :e int, ((U2 X Y Z) = (if (X <= 0) then Y else (F2 (U2 (X + - 1) Y Z) (V2 (X + - 1) Y Z))))))).
Hypothesis H21: (forall X :e int, (forall Y :e int, (forall Z :e int, ((V2 X Y Z) = (if (X <= 0) then Z else G2))))).
Hypothesis H22: (forall X :e int, ((W2 X) = (U2 (H2 X) (I2 X) (J2 X)))).
Hypothesis H23: (forall X :e int, ((FAST X) = (W2 X))).
Theorem A81045: (forall N :e int, ((0 <= N) -> ((SMALL N) = (FAST N)))).
Admitted.
End A81045.