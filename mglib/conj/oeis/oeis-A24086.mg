...
(** Bounty 1 PFG TMRHza4KaEP6Ph1H2QbxqYVNmdW3jZ3ez6s **)
Section A24086.
...
Hypothesis H10: (forall X :e int, ((V1 X) = (U1 G1 (H1 X)))).
Hypothesis H11: (forall X :e int, ((SMALL X) = ((V0 X) + - (((V1 X) * X) * X)))).
...
Hypothesis H21: (G3 = 1).
Hypothesis H22: (forall X :e int, ((H3 X) = ((X * X) * X))).
Hypothesis H23: (forall X :e int, (forall Y :e int, ((U3 X Y) = (if (X <= 0) then Y else (F3 (U3 (X + - 1) Y)))))).
Hypothesis H24: (forall X :e int, ((V3 X) = (U3 G3 (H3 X)))).
Hypothesis H25: (forall X :e int, ((FAST X) = ((W2 X) + - (((V3 X) * X) * X)))).
Theorem A24086: (forall N :e int, ((0 <= N) -> ((SMALL N) = (FAST N)))).
Admitted.
End A24086.