...
(** Bounty 1 PFG TMLLSzaa3zE6fqyPVs7aXCxiDC2N7eM9vu6 **)
Section A250212.
...
Hypothesis H5: (forall X :e int, (forall Y :e int, ((V2 X Y) = (U2 G2 (H2 X Y))))).
Hypothesis H6: (forall X :e int, (forall Y :e int, ((F1 X Y) = (((((V2 X Y) * Y) * Y) * Y) + X)))).
Hypothesis H7: (forall X :e int, (forall Y :e int, ((G1 X Y) = (1 + Y)))).
...
Hypothesis H17: (forall X :e int, ((F5 X) = ((X * X) * X))).
Hypothesis H18: (G5 = 1).
Hypothesis H19: (forall X :e int, (forall Y :e int, ((H5 X Y) = (Y * Y)))).
Hypothesis H20: (forall X :e int, (forall Y :e int, ((U5 X Y) = (if (X <= 0) then Y else (F5 (U5 (X + - 1) Y)))))).
Hypothesis H21: (forall X :e int, (forall Y :e int, ((V5 X Y) = (U5 G5 (H5 X Y))))).
Hypothesis H22: (forall X :e int, (forall Y :e int, ((F4 X Y) = (((V5 X Y) * Y) + X)))).
...
Hypothesis H26: (forall X :e int, (forall Y :e int, ((V4 X Y) = (U4 (G4 X Y) (H4 X))))).
Hypothesis H27: (forall X :e int, (forall Y :e int, ((F3 X Y) = (V4 X Y)))).
Hypothesis H28: (forall X :e int, ((G3 X) = (1 + X))).
Hypothesis H29: (H3 = 0).
...
Theorem A250212: (forall N :e int, ((0 <= N) -> ((SMALL N) = (FAST N)))).
Admitted.
End A250212.