...
(** Bounty 1 PFG TMYb9fdJePE21w8ohmqhDMzPy9Qbq4QWy8F **)
Section A73554.
...
Hypothesis H1: (forall X :e int, ((F1 X) = ((X + - 1) + X))).
Hypothesis H2: (G1 = 2).
...
Hypothesis H10: (forall X :e int, ((H2 X) = X)).
Hypothesis H11: (forall X :e int, (forall Y :e int, ((U2 X Y) = (if (X <= 0) then Y else F2)))).
Hypothesis H12: (forall X :e int, ((V2 X) = (U2 (G2 X) (H2 X)))).
...
Hypothesis H17: (forall X :e int, (forall Y :e int, ((F3 X Y) = ((X * Y) + - 1)))).
...
Hypothesis H25: (forall X :e int, ((FAST X) = (((W3 X) * (if (X <= 0) then 1 else ((2 * (2 * (2 + 2))) + - 1))) + - 1))).
Theorem A73554: (forall N :e int, ((0 <= N) -> ((SMALL N) = (FAST N)))).
Admitted.
End A73554.