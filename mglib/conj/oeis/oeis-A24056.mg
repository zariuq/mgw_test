...
(** Bounty 1 PFG TMM6fZXudpA6jSaiMiraRJZEtt7V7e3x3bY **)
Section A24056.
...
Hypothesis H24: (G3 = 1).
Hypothesis H25: (forall X :e int, ((H3 X) = (X * X))).
Hypothesis H26: (forall X :e int, (forall Y :e int, ((U3 X Y) = (if (X <= 0) then Y else (F3 (U3 (X + - 1) Y)))))).
Hypothesis H27: (forall X :e int, ((V3 X) = (U3 G3 (H3 X)))).
Hypothesis H28: (forall X :e int, ((FAST X) = ((W2 X) + - ((V3 X) * X)))).
Theorem A24056: (forall N :e int, ((0 <= N) -> ((SMALL N) = (FAST N)))).
Admitted.
End A24056.