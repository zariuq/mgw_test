...
(** Bounty 1 PFG TMXdsciUKhd1t2o5TuUuSvmZV2RzS2pwk6i **)
Section A302612.
...
Hypothesis H1: (forall X :e int, (forall Y :e int, ((F1 X Y) = ((Y * Y) + X)))).
Hypothesis H2: (forall X :e int, (forall Y :e int, ((G1 X Y) = (Y + - 2)))).
...
Hypothesis H6: (forall X :e int, (forall Y :e int, ((F0 X Y) = ((V1 X Y) + Y)))).
...
Hypothesis H11: (forall X :e int, ((SMALL X) = (((V0 X) + - X) * (1 + X)))).
Hypothesis H12: (forall X :e int, (forall Y :e int, ((F3 X Y) = ((Y * Y) + X)))).
...
Hypothesis H16: (forall X :e int, (forall Y :e int, ((V3 X Y) = (U3 (G3 X Y) (H3 X))))).
Hypothesis H17: (forall X :e int, (forall Y :e int, ((F2 X Y) = ((V3 X Y) + Y)))).
...
Hypothesis H22: (forall X :e int, ((FAST X) = ((V2 X) * (X + 1)))).
Theorem A302612: (forall N :e int, ((0 <= N) -> ((SMALL N) = (FAST N)))).
Admitted.
End A302612.