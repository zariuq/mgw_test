...
(** Bounty 1 PFG TMZKuyPALkVqF6Q6CFiRz6einJTY3sAQuhR **)
Section A88920.
...
Hypothesis H1: (forall X :e int, (forall Y :e int, ((F0 X Y) = (1 + ((Y + - X) + - X))))).
...
Theorem A88920: (forall N :e int, ((0 <= N) -> ((SMALL N) = (FAST N)))).
Admitted.
End A88920.