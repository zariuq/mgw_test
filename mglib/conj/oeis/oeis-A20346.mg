...
(** Bounty 1 PFG TMZffDxh6NpV9xWJjUjVaaSBzh7YtzXtB2X **)
Section A20346.
...
Hypothesis H40: (forall X :e int, (forall Y :e int, ((F4 X Y) = ((V5 X Y) + (2 * (2 * (X + X))))))).
...
Theorem A20346: (forall N :e int, ((0 <= N) -> ((SMALL N) = (FAST N)))).
Admitted.
End A20346.