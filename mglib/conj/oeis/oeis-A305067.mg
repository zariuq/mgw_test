...
(** Bounty 1 PFG TMMzWJbWrvm8LPtHYfBuRmJfofazt4ep11H **)
Section A305067.
...
Hypothesis H6: (forall X :e int, ((F0 X) = (((V1 + - 1) + X) + X))).
...
Hypothesis H11: (forall X :e int, ((SMALL X) = ((((V0 X) + - 1) + - 2) * (1 + 2)))).
...
Hypothesis H17: (forall X :e int, ((FAST X) = (((((((2 * (2 * (2 * (2 + (2 + 2))))) + - 1) * ((V2 X) + - 1)) + - 2) * (1 + 2)) + - 1) + - 2))).
Theorem A305067: (forall N :e int, ((0 <= N) -> ((SMALL N) = (FAST N)))).
Admitted.
End A305067.