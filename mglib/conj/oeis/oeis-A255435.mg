...
(** Bounty 1 PFG TMRbkFAR94ViUp3RBWyiwbHjYc6j1C2aHLu **)
Section A255435.
...
Hypothesis H6: (forall X :e int, (forall Y :e int, ((F0 X Y) = ((((V1 X Y) * X) * Y) + X)))).
...
Hypothesis H12: (forall X :e int, (forall Y :e int, ((F2 X Y) = ((1 + ((((Y * Y) * Y) * Y) * Y)) * X)))).
...
Theorem A255435: (forall N :e int, ((0 <= N) -> ((SMALL N) = (FAST N)))).
Admitted.
End A255435.