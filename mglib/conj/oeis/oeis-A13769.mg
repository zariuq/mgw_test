...
(** Bounty 1 PFG TMTj9aQyzkrJgYFos8essg46FPt3ZDyshc4 **)
Section A13769.
...
Hypothesis H27: (forall X :e int, ((H4 X) = (2 + X))).
Hypothesis H28: (I4 = 1).
Hypothesis H29: (J4 = (1 + (2 * (2 + (2 * (2 + 2)))))).
...
Theorem A13769: (forall N :e int, ((0 <= N) -> ((SMALL N) = (FAST N)))).
Admitted.
End A13769.