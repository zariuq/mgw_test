...
(** Bounty 1 PFG TMM57NttvmWhsVfdjMS8zMMmUYTmJ8d4bnx **)
Section A229136.
...
Hypothesis H1: (forall X :e int, (forall Y :e int, ((F0 X Y) = (2 * (2 * (X + - (Y + Y))))))).
...
Hypothesis H9: (forall X :e int, ((F1 X) = (X + X))).
...
Hypothesis H16: (forall X :e int, (forall Y :e int, ((G2 X Y) = (Y + - X)))).
Hypothesis H17: (forall X :e int, ((H2 X) = (X + - 1))).
Hypothesis H18: (forall X :e int, ((I2 X) = (if (X <= 0) then 1 else 2))).
Hypothesis H19: (J2 = 0).
...
Hypothesis H33: (forall X :e int, ((FAST X) = (((W2 X) + (V3 X)) * (V4 X)))).
Theorem A229136: (forall N :e int, ((0 <= N) -> ((SMALL N) = (FAST N)))).
Admitted.
End A229136.