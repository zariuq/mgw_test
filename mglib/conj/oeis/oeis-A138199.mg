...
Hypothesis H11: (forall X :e int, ((F2 X) = ((2 * X) + X))).
Hypothesis H12: (forall X :e int, ((G2 X) = ((X + 1) + X))).
Hypothesis H13: (H2 = 1).
...
Hypothesis H19: (forall X :e int, ((H3 X) = (1 + (X + X)))).
Hypothesis H20: (I3 = 1).
...
Hypothesis H25: (forall X :e int, ((F4 X) = (X * (X * (1 + 2))))).
Hypothesis H26: (G4 = 1).
Hypothesis H27: (forall X :e int, ((F5 X) = ((X + X) + X))).
Hypothesis H28: (forall X :e int, ((G5 X) = X)).
Hypothesis H29: (H5 = 1).
Hypothesis H30: (forall X :e int, (forall Y :e int, ((U5 X Y) = (if (X <= 0) then Y else (F5 (U5 (X + - 1) Y)))))).
Hypothesis H31: (forall X :e int, ((V5 X) = (U5 (G5 X) H5))).
Hypothesis H32: (forall X :e int, ((H4 X) = (V5 X))).
Hypothesis H33: (forall X :e int, (forall Y :e int, ((U4 X Y) = (if (X <= 0) then Y else (F4 (U4 (X + - 1) Y)))))).
Hypothesis H34: (forall X :e int, ((V4 X) = (U4 G4 (H4 X)))).
Hypothesis H35: (forall X :e int, ((FAST X) = ((W3 X) + (V4 X)))).
Theorem A138199: (forall N :e int, ((0 <= N) -> ((SMALL N) = (FAST N)))).
Admitted.
End A138199.