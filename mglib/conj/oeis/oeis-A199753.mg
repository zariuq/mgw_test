...
(** Bounty 1 PFG TMHKnaQMjCD4LUJz2hKdVGgRvQdouUEudXY **)
Section A199753.
...
Hypothesis H11: (forall X :e int, ((SMALL X) = (1 + (2 * (V0 X))))).
...
Hypothesis H20: (forall X :e int, ((FAST X) = (1 + (2 * (W2 X))))).
Theorem A199753: (forall N :e int, ((0 <= N) -> ((SMALL N) = (FAST N)))).
Admitted.
End A199753.