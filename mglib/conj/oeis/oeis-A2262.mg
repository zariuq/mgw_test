...
(** Bounty 1 PFG TMJwV3Ka43d8p1MXSyb8zcd8bH18g2fkCsS **)
Section A2262.
...
Hypothesis H1: (forall X :e int, (forall Y :e int, ((F0 X Y) = (X + - (if ((Y + - X) <= 0) then Y else 0))))).
...
Hypothesis H7: (forall X :e int, (forall Y :e int, ((F1 X Y) = (X + - (if ((Y + - X) <= 0) then Y else 0))))).
...
Theorem A2262: (forall N :e int, ((0 <= N) -> ((SMALL N) = (FAST N)))).
Admitted.
End A2262.