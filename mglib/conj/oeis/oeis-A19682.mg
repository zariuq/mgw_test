...
(** Bounty 1 PFG TMKU8N9XEzeYstPh1ou7oVYMCtG2up8ViDH **)
Section A19682.
...
Hypothesis H17: (forall X :e int, (forall Y :e int, ((F5 X Y) = ((2 * (X + X)) + (Y * Y))))).
...
Hypothesis H30: (forall X :e int, (forall Y :e int, ((F3 X Y) = ((V4 X Y) + (2 * ((2 * (X + X)) + X)))))).
...
Theorem A19682: (forall N :e int, ((0 <= N) -> ((SMALL N) = (FAST N)))).
Admitted.
End A19682.