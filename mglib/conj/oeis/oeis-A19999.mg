...
(** Bounty 1 PFG TMSv9fQ8MCC9nyM2ELqY3vLg94bAHJpCVzC **)
Section A19999.
...
Hypothesis H7: (forall X :e int, (forall Y :e int, ((F1 X Y) = ((X * 2) * Y)))).
...
Hypothesis H12: (forall X :e int, ((FAST X) = (((1 + X) * (2 + X)) * (V1 X)))).
Theorem A19999: (forall N :e int, ((0 <= N) -> ((SMALL N) = (FAST N)))).
Admitted.
End A19999.