...
(** Bounty 1 PFG TMbsB6CjTGfA14gSK75SykBPw5PxmCp8RWZ **)
Section A7559.
...
Hypothesis H1: (forall X :e int, (forall Y :e int, ((F0 X Y) = ((((Y + - 2) + Y) + Y) * X)))).
...
Theorem A7559: (forall N :e int, ((0 <= N) -> ((SMALL N) = (FAST N)))).
Admitted.
End A7559.