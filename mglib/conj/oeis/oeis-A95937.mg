...
(** Bounty 1 PFG TMV6JpMoKmzPTke5oan5Ca8xosqmUxUKh52 **)
Section A95937.
...
Hypothesis H4: (forall X :e int, (forall Y :e int, ((I1 X Y) = Y))).
...
Hypothesis H8: (forall X :e int, (forall Y :e int, ((W1 X Y) = (U1 (H1 X Y) (I1 X Y) (J1 X Y))))).
...
Hypothesis H17: (forall X :e int, (forall Y :e int, ((H3 X Y) = (Y + - 2)))).
Hypothesis H18: (I3 = 1).
Hypothesis H19: (forall X :e int, (forall Y :e int, ((J3 X Y) = Y))).
...
Hypothesis H23: (forall X :e int, (forall Y :e int, ((F2 X Y) = (((W3 X Y) * ((Y * Y) * Y)) + X)))).
...
Theorem A95937: (forall N :e int, ((0 <= N) -> ((SMALL N) = (FAST N)))).
Admitted.
End A95937.