...
(** Bounty 1 PFG TMU1nvAQ512pCAWAm6HFtLB4p4EV4r4jnPX **)
Section A15259.
...
Hypothesis H1: (forall X :e int, (forall Y :e int, ((F2 X Y) = (((Y * Y) * Y) + - X)))).
...
Hypothesis H9: (forall X :e int, (forall Y :e int, ((F3 X Y) = (X * Y)))).
Hypothesis H10: (forall X :e int, (forall Y :e int, ((G3 X Y) = Y))).
Hypothesis H11: (forall X :e int, ((H3 X) = X)).
Hypothesis H12: (I3 = 1).
Hypothesis H13: (J3 = (2 * (2 + 2))).
Hypothesis H14: (forall X :e int, (forall Y :e int, (forall Z :e int, ((U3 X Y Z) = (if (X <= 0) then Y else (F3 (U3 (X + - 1) Y Z) (V3 (X + - 1) Y Z))))))).
Hypothesis H15: (forall X :e int, (forall Y :e int, (forall Z :e int, ((V3 X Y Z) = (if (X <= 0) then Z else (G3 (U3 (X + - 1) Y Z) (V3 (X + - 1) Y Z))))))).
Hypothesis H16: (forall X :e int, ((W3 X) = (U3 (H3 X) I3 J3))).
Hypothesis H17: (forall X :e int, ((F1 X) = ((W2 X) * (W3 X)))).
Hypothesis H18: (G1 = 1).
Hypothesis H19: (forall X :e int, (forall Y :e int, ((H1 X Y) = Y))).
Hypothesis H20: (forall X :e int, (forall Y :e int, ((U1 X Y) = (if (X <= 0) then Y else (F1 (U1 (X + - 1) Y)))))).
Hypothesis H21: (forall X :e int, (forall Y :e int, ((V1 X Y) = (U1 G1 (H1 X Y))))).
Hypothesis H22: (forall X :e int, (forall Y :e int, ((F0 X Y) = ((V1 X Y) + X)))).
Hypothesis H23: (forall X :e int, ((G0 X) = X)).
Hypothesis H24: (H0 = 1).
Hypothesis H25: (forall X :e int, (forall Y :e int, ((U0 X Y) = (if (X <= 0) then Y else (F0 (U0 (X + - 1) Y) X))))).
Hypothesis H26: (forall X :e int, ((V0 X) = (U0 (G0 X) H0))).
Hypothesis H27: (forall X :e int, ((SMALL X) = (V0 X))).
Hypothesis H28: (forall X :e int, (forall Y :e int, ((F6 X Y) = (((Y * Y) * Y) + - X)))).
Hypothesis H29: (forall X :e int, (forall Y :e int, ((G6 X Y) = (Y + Y)))).
...
Hypothesis H36: (forall X :e int, ((F7 X) = ((X * X) * X))).
Hypothesis H37: (G7 = 1).
...
Hypothesis H43: (forall X :e int, ((H7 X) = (V8 X))).
Hypothesis H44: (forall X :e int, (forall Y :e int, ((U7 X Y) = (if (X <= 0) then Y else (F7 (U7 (X + - 1) Y)))))).
Hypothesis H45: (forall X :e int, ((V7 X) = (U7 G7 (H7 X)))).
Hypothesis H46: (forall X :e int, ((F5 X) = ((W6 X) * (V7 X)))).
Hypothesis H47: (G5 = 1).
Hypothesis H48: (forall X :e int, (forall Y :e int, ((H5 X Y) = Y))).
Hypothesis H49: (forall X :e int, (forall Y :e int, ((U5 X Y) = (if (X <= 0) then Y else (F5 (U5 (X + - 1) Y)))))).
Hypothesis H50: (forall X :e int, (forall Y :e int, ((V5 X Y) = (U5 G5 (H5 X Y))))).
Hypothesis H51: (forall X :e int, (forall Y :e int, ((F4 X Y) = ((V5 X Y) + X)))).
Hypothesis H52: (forall X :e int, ((G4 X) = X)).
Hypothesis H53: (H4 = 1).
Hypothesis H54: (forall X :e int, (forall Y :e int, ((U4 X Y) = (if (X <= 0) then Y else (F4 (U4 (X + - 1) Y) X))))).
Hypothesis H55: (forall X :e int, ((V4 X) = (U4 (G4 X) H4))).
Hypothesis H56: (forall X :e int, ((FAST X) = (V4 X))).
Theorem A15259: (forall N :e int, ((0 <= N) -> ((SMALL N) = (FAST N)))).
Admitted.
End A15259.