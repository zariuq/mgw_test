...
(** Bounty 1 PFG TMM2UGPvcTfA81fxshEFbubsD1rMte2skyj **)
Section A2671.
...
Hypothesis H7: (forall X :e int, (forall Y :e int, ((F1 X Y) = (2 * (2 * (X * Y)))))).
...
Hypothesis H15: (I2 = 1).
Hypothesis H16: (forall X :e int, ((J2 X) = (2 + X))).
...
Hypothesis H20: (forall X :e int, ((FAST X) = ((V1 X) * (W2 X)))).
Theorem A2671: (forall N :e int, ((0 <= N) -> ((SMALL N) = (FAST N)))).
Admitted.
End A2671.