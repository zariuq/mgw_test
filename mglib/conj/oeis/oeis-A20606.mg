...
(** Bounty 1 PFG TMFV51gU3JbT6D3eDEntTrwjArjHabuB3aM **)
Section A20606.
...
Hypothesis H22: (forall X :e int, (forall Y :e int, ((F6 X Y) = (((X + X) + X) + Y)))).
Hypothesis H23: (forall X :e int, (forall Y :e int, ((G6 X Y) = (Y + Y)))).
...
Hypothesis H31: (forall X :e int, (forall Y :e int, ((G7 X Y) = Y))).
Hypothesis H32: (forall X :e int, ((H7 X) = X)).
Hypothesis H33: (I7 = 1).
Hypothesis H34: (J7 = (1 + 2)).
...
Hypothesis H38: (forall X :e int, ((F5 X) = ((W6 X) * (W7 X)))).
Hypothesis H39: (G5 = 1).
...
Theorem A20606: (forall N :e int, ((0 <= N) -> ((SMALL N) = (FAST N)))).
Admitted.
End A20606.