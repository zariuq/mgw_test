...
(** Bounty 1 PFG TMULpzWw4G9dAH7zwcg3D2o63vxwph6tyZs **)
Section A346896.
...
Hypothesis H12: (forall X :e int, (forall Y :e int, ((F2 X Y) = (((2 * (2 * ((Y + Y) + Y))) + - 1) * X)))).
...
Theorem A346896: (forall N :e int, ((0 <= N) -> ((SMALL N) = (FAST N)))).
Admitted.
End A346896.