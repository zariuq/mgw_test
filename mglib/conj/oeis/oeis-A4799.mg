...
(** Bounty 1 PFG TMXVWNixmDcvTjs3R6zMboFhSoWVYjKQY3o **)
Section A4799.
...
Hypothesis H4: (forall X :e int, ((I0 X) = (X + X))).
...
Hypothesis H13: (forall X :e int, ((I1 X) = (1 + ((X + X) + X)))).
...
Theorem A4799: (forall N :e int, ((0 <= N) -> ((SMALL N) = (FAST N)))).
Admitted.
End A4799.