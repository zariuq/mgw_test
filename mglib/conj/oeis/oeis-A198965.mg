...
(** Bounty 1 PFG TMTURBg9m27kjkouSQf6uj4H4B9iFoe9PYr **)
Section A198965.
...
Hypothesis H1: (forall X :e int, ((F0 X) = ((1 + 2) * (1 + X)))).
...
Hypothesis H15: (forall X :e int, ((FAST X) = ((W1 X) + - 1))).
Theorem A198965: (forall N :e int, ((0 <= N) -> ((SMALL N) = (FAST N)))).
Admitted.
End A198965.