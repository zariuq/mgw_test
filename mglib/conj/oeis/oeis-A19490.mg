...
(** Bounty 1 PFG TMR5MBFpBqeFHHSKWjJfbacNmgkDhfRCFQs **)
Section A19490.
...
Hypothesis H22: (forall X :e int, ((F4 X) = ((X * X) + - X))).
Hypothesis H23: (G4 = 1).
...
Hypothesis H35: (I6 = (1 + 2)).
Hypothesis H36: (J6 = (1 + 2)).
...
Hypothesis H42: (forall X :e int, ((H7 X) = X)).
Hypothesis H43: (I7 = 1).
Hypothesis H44: (J7 = (2 + 2)).
...
Hypothesis H48: (forall X :e int, ((FAST X) = (((V4 X) * (W6 X)) + (W7 X)))).
Theorem A19490: (forall N :e int, ((0 <= N) -> ((SMALL N) = (FAST N)))).
Admitted.
End A19490.