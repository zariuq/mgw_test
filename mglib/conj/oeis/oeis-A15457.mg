...
(** Bounty 1 PFG TMWj1fq4tE2XDzndnhmYPrhkrL9Lwa99w59 **)
Section A15457.
...
Hypothesis H18: (forall X :e int, ((I2 X) = (if ((X + - 1) <= 0) then 1 else (2 * (2 + (2 + 2)))))).
Hypothesis H19: (J2 = 1).
...
Theorem A15457: (forall N :e int, ((0 <= N) -> ((SMALL N) = (FAST N)))).
Admitted.
End A15457.