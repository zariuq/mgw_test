...
(** Bounty 1 PFG TMcJsGj7NHM7eAexHcN14NGNKkBSfsVXaLY **)
Section A199107.
...
Hypothesis H1: (forall X :e int, (forall Y :e int, ((F1 X Y) = ((2 + Y) * (2 + X))))).
Hypothesis H2: (G1 = 2).
...
Hypothesis H11: (forall X :e int, ((SMALL X) = (2 + (V0 X)))).
...
Hypothesis H20: (forall X :e int, ((FAST X) = (((1 + (2 + 2)) * (W2 X)) + - 1))).
Theorem A199107: (forall N :e int, ((0 <= N) -> ((SMALL N) = (FAST N)))).
Admitted.
End A199107.