...
(** Bounty 1 PFG TMRQgSqN7euWcuuVzhp4bvwLvVB9eqv9k8S **)
Section A19854.
...
Hypothesis H23: (forall X :e int, (forall Y :e int, ((G6 X Y) = (2 * ((Y + Y) + Y))))).
...
Hypothesis H35: (forall X :e int, (forall Y :e int, ((F4 X Y) = (((V5 X Y) + X) + ((((X * 2) * 2) + X) * 2))))).
...
Theorem A19854: (forall N :e int, ((0 <= N) -> ((SMALL N) = (FAST N)))).
Admitted.
End A19854.