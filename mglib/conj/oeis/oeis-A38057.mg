...
(** Bounty 1 PFG TMQFCKr81EVCb4KYmonT7MxjiVxZz19tJNF **)
Section A38057.
...
Hypothesis H18: (I2 = 2).
Hypothesis H19: (forall X :e int, ((J2 X) = (1 + X))).
...
Hypothesis H23: (forall X :e int, ((FAST X) = ((V1 X) * (W2 X)))).
Theorem A38057: (forall N :e int, ((0 <= N) -> ((SMALL N) = (FAST N)))).
Admitted.
End A38057.