...
(** Bounty 1 PFG TMcB2ddLopKj82EjQ59Nd3Lhofw76ox1sVi **)
Section A226265.
...
Hypothesis H7: (forall X :e int, ((G0 X) = (2 + X))).
Hypothesis H8: (H0 = 0).
...
Hypothesis H17: (forall X :e int, ((F3 X) = ((2 + X) * X))).
Hypothesis H18: (G3 = 1).
Hypothesis H19: (H3 = (2 * (2 + (2 + 2)))).
Hypothesis H20: (forall X :e int, (forall Y :e int, ((U3 X Y) = (if (X <= 0) then Y else (F3 (U3 (X + - 1) Y)))))).
Hypothesis H21: (V3 = (U3 G3 H3)).
Hypothesis H22: (forall X :e int, ((FAST X) = (((2 * (V2 X)) + - 1) * V3))).
Theorem A226265: (forall N :e int, ((0 <= N) -> ((SMALL N) = (FAST N)))).
Admitted.
End A226265.