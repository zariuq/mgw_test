...
(** Bounty 1 PFG TMMwwmZk1LuqzhnJfZ412ddKNyC27vxnyGr **)
Section A2276.
...
Hypothesis H15: (forall X :e int, ((FAST X) = (if (X <= 0) then 0 else (W1 X)))).
Theorem A2276: (forall N :e int, ((0 <= N) -> ((SMALL N) = (FAST N)))).
Admitted.
End A2276.