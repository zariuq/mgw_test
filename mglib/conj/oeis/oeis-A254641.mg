...
(** Bounty 1 PFG TMWAXXFnBtz9otp4VeT2b9FhRQ7yM6T5DcN **)
Section A254641.
...
Hypothesis H6: (forall X :e int, (forall Y :e int, ((F2 X Y) = (((((V3 X Y) * Y) * Y) * Y) + X)))).
...
Hypothesis H22: (forall X :e int, ((F7 X) = ((X * X) * X))).
Hypothesis H23: (G7 = 1).
Hypothesis H24: (forall X :e int, (forall Y :e int, ((H7 X Y) = (Y * Y)))).
Hypothesis H25: (forall X :e int, (forall Y :e int, ((U7 X Y) = (if (X <= 0) then Y else (F7 (U7 (X + - 1) Y)))))).
Hypothesis H26: (forall X :e int, (forall Y :e int, ((V7 X Y) = (U7 G7 (H7 X Y))))).
Hypothesis H27: (forall X :e int, (forall Y :e int, ((F6 X Y) = (((V7 X Y) * Y) + X)))).
Hypothesis H28: (forall X :e int, (forall Y :e int, ((G6 X Y) = Y))).
...
Hypothesis H32: (forall X :e int, (forall Y :e int, ((F5 X Y) = (V6 X Y)))).
Hypothesis H33: (forall X :e int, (forall Y :e int, ((G5 X Y) = Y))).
...
Hypothesis H38: (forall X :e int, ((G4 X) = (1 + X))).
Hypothesis H39: (H4 = 0).
...
Theorem A254641: (forall N :e int, ((0 <= N) -> ((SMALL N) = (FAST N)))).
Admitted.
End A254641.