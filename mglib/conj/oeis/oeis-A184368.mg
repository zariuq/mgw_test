...
(** Bounty 1 PFG TMKT3UZzqZwpCBV3L6WEFV1BvJ7Np5orCCx **)
Section A184368.
...
Hypothesis H5: (forall X :e int, ((H1 X) = (2 + X))).
Hypothesis H6: (I1 = 2).
Hypothesis H7: (J1 = 2).
...
Hypothesis H15: (forall X :e int, (forall Y :e int, ((F2 X Y) = ((X + X) + Y)))).
Hypothesis H16: (forall X :e int, ((G2 X) = X)).
Hypothesis H17: (forall X :e int, ((H2 X) = (1 + X))).
Hypothesis H18: (I2 = (2 + 1)).
Hypothesis H19: (J2 = 1).
...
Theorem A184368: (forall N :e int, ((0 <= N) -> ((SMALL N) = (FAST N)))).
Admitted.
End A184368.