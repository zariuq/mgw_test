...
(** Bounty 1 PFG TMQSCjsZzGwMmAFpU2sYPpLwovcsj5Wjmpn **)
Section A80250.
...
Hypothesis H11: (forall X :e int, (forall Y :e int, ((F3 X Y) = (((2 + Y) * X) + X)))).
Hypothesis H12: (G3 = 2).
...
Hypothesis H35: (forall X :e int, (forall Y :e int, ((F4 X Y) = ((V5 X Y) + (2 * (2 * ((2 * (X + X)) + X))))))).
...
Theorem A80250: (forall N :e int, ((0 <= N) -> ((SMALL N) = (FAST N)))).
Admitted.
End A80250.