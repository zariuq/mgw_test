...
(** Bounty 1 PFG TMVyvXPjMrHJcyKKQyyHPJqCYKbpSFattTN **)
Section A41481.
...
Hypothesis H15: (forall X :e int, (forall Y :e int, ((F2 X Y) = (((2 * (2 * (2 * (2 + 2)))) * X) + Y)))).
...
Theorem A41481: (forall N :e int, ((0 <= N) -> ((SMALL N) = (FAST N)))).
Admitted.
End A41481.