...
(** Bounty 1 PFG TMJeCnbE77D54aYmGWnwNo5ohsNhrknrJH6 **)
Section A43699.
...
Hypothesis H16: (forall X :e int, ((W0 X) = (U0 (H0 X) I0 (J0 X)))).
Hypothesis H17: (forall X :e int, ((SMALL X) = (W0 X))).
Hypothesis H18: (forall X :e int, ((F2 X) = (X * X))).
Hypothesis H19: (G2 = 1).
Hypothesis H20: (forall X :e int, (forall Y :e int, ((F3 X Y) = ((X + X) + Y)))).
...
Hypothesis H28: (forall X :e int, ((H2 X) = (W3 X))).
Hypothesis H29: (forall X :e int, (forall Y :e int, ((U2 X Y) = (if (X <= 0) then Y else (F2 (U2 (X + - 1) Y)))))).
Hypothesis H30: (forall X :e int, ((V2 X) = (U2 G2 (H2 X)))).
Hypothesis H31: (forall X :e int, (forall Y :e int, ((F4 X Y) = Y))).
Hypothesis H32: (forall X :e int, (forall Y :e int, ((G4 X Y) = ((X + Y) + Y)))).
Hypothesis H33: (forall X :e int, ((H4 X) = X)).
Hypothesis H34: (I4 = 1).
Hypothesis H35: (J4 = 1).
Hypothesis H36: (forall X :e int, (forall Y :e int, (forall Z :e int, ((U4 X Y Z) = (if (X <= 0) then Y else (F4 (U4 (X + - 1) Y Z) (V4 (X + - 1) Y Z))))))).
Hypothesis H37: (forall X :e int, (forall Y :e int, (forall Z :e int, ((V4 X Y Z) = (if (X <= 0) then Z else (G4 (U4 (X + - 1) Y Z) (V4 (X + - 1) Y Z))))))).
Hypothesis H38: (forall X :e int, ((W4 X) = (U4 (H4 X) I4 J4))).
Hypothesis H39: (forall X :e int, ((FAST X) = (((V2 X) * (W4 X)) * 2))).
Theorem A43699: (forall N :e int, ((0 <= N) -> ((SMALL N) = (FAST N)))).
Admitted.
End A43699.