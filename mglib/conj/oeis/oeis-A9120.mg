...
(** Bounty 1 PFG TMQwKFmBMPHwKSPnXHHY1sirUYtpt9U4tru **)
Section A9120.
...
Hypothesis H8: (forall X :e int, (forall Y :e int, ((G1 X Y) = (Y + - 1)))).
Hypothesis H9: (forall X :e int, ((H1 X) = X)).
Hypothesis H10: (I1 = 1).
Hypothesis H11: (forall X :e int, ((J1 X) = (2 * (X + X)))).
...
Hypothesis H16: (forall X :e int, (forall Y :e int, ((G2 X Y) = (1 + Y)))).
...
Theorem A9120: (forall N :e int, ((0 <= N) -> ((SMALL N) = (FAST N)))).
Admitted.
End A9120.