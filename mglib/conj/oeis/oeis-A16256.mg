...
(** Bounty 1 PFG TMWYQG2LTGMeoqyrGqku79DhnQbgoSYsd6U **)
Section A16256.
...
Hypothesis H1: (forall X :e int, ((F1 X) = (1 + (2 * (2 * (X + X)))))).
...
Hypothesis H6: (forall X :e int, ((F2 X) = ((X + X) + X))).
Hypothesis H7: (G2 = 2).
...
Hypothesis H17: (forall X :e int, (forall Y :e int, ((F3 X Y) = (((1 + 2) * ((X + X) + X)) + Y)))).
Hypothesis H18: (forall X :e int, (forall Y :e int, ((G3 X Y) = (1 + (2 * (2 * (Y + Y))))))).
...
Theorem A16256: (forall N :e int, ((0 <= N) -> ((SMALL N) = (FAST N)))).
Admitted.
End A16256.