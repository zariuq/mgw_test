...
(** Bounty 1 PFG TMHjYyUmS1vgLrncCesvkg4V2QBgQkqvfbL **)
Section A276509.
...
Hypothesis H18: (forall X :e int, ((FAST X) = (((W1 X) * ((if (X <= 0) then 1 else (2 + (2 * (2 + 2)))) * (1 + (2 + 2)))) + - (1 + 2)))).
Theorem A276509: (forall N :e int, ((0 <= N) -> ((SMALL N) = (FAST N)))).
Admitted.
End A276509.