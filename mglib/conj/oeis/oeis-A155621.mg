...
(** Bounty 1 PFG TMQYJ3hBP8acWSnuFw555v3HJWPGYHg1usz **)
Section A155621.
...
Hypothesis H11: (forall X :e int, ((SMALL X) = (((V0 X) + - 1) + (V1 X)))).
...
Hypothesis H30: (forall X :e int, ((FAST X) = (((V2 X) + - 1) + (W4 X)))).
Theorem A155621: (forall N :e int, ((0 <= N) -> ((SMALL N) = (FAST N)))).
Admitted.
End A155621.