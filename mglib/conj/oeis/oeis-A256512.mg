...
(** Bounty 1 PFG TMFN26z87GRJKdP75Suz8Jsmtj1B7i5StxE **)
Section A256512.
...
Hypothesis H9: (forall X :e int, ((SMALL X) = (X + (W0 X)))).
...
Hypothesis H18: (forall X :e int, ((I2 X) = X)).
...
Hypothesis H23: (forall X :e int, ((FAST X) = ((((V1 X) * X) * (W2 X)) + X))).
Theorem A256512: (forall N :e int, ((0 <= N) -> ((SMALL N) = (FAST N)))).
Admitted.
End A256512.