...
(** Bounty 1 PFG TMXoCAmbFwUhQQvTw36fkvLEknYLvDfzc3f **)
Section A132911.
...
Hypothesis H1: (forall X :e int, (forall Y :e int, ((F0 X Y) = (((1 + (Y + Y)) * (X * Y)) + - X)))).
...
Theorem A132911: (forall N :e int, ((0 <= N) -> ((SMALL N) = (FAST N)))).
Admitted.
End A132911.