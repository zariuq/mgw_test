...
(** Bounty 1 PFG TMHCUtVai261vGTLb5CkHVnmE9idtYnmat3 **)
Section A186947.
...
Hypothesis H8: (forall X :e int, ((H0 X) = ((V1 X) + - X))).
...
Hypothesis H20: (forall X :e int, ((I2 X) = (V3 X))).
...
Hypothesis H23: (forall X :e int, (forall Y :e int, (forall Z :e int, ((V2 X Y Z) = (if (X <= 0) then Z else G2))))).
Hypothesis H24: (forall X :e int, ((W2 X) = (U2 H2 (I2 X) (J2 X)))).
Hypothesis H25: (forall X :e int, ((FAST X) = (W2 X))).
Theorem A186947: (forall N :e int, ((0 <= N) -> ((SMALL N) = (FAST N)))).
Admitted.
End A186947.