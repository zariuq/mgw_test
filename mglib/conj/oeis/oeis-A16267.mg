...
(** Bounty 1 PFG TMcvFKogY86CtkTfgJhANdYPYg8vtxRLSPV **)
Section A16267.
...
Hypothesis H1: (forall X :e int, ((F1 X) = (1 + (2 * ((2 * (X + X)) + X))))).
...
Hypothesis H19: (forall X :e int, (forall Y :e int, ((H4 X Y) = Y))).
Hypothesis H20: (I4 = 1).
Hypothesis H21: (J4 = (2 + (2 * (2 + 2)))).
...
Hypothesis H24: (forall X :e int, (forall Y :e int, ((W4 X Y) = (U4 (H4 X Y) I4 J4)))).
Hypothesis H25: (forall X :e int, (forall Y :e int, ((F3 X Y) = ((W4 X Y) + (2 * (2 * ((X + X) + X))))))).
Hypothesis H26: (forall X :e int, ((G3 X) = X)).
Hypothesis H27: (H3 = 1).
Hypothesis H28: (forall X :e int, (forall Y :e int, ((U3 X Y) = (if (X <= 0) then Y else (F3 (U3 (X + - 1) Y) X))))).
Hypothesis H29: (forall X :e int, ((V3 X) = (U3 (G3 X) H3))).
Hypothesis H30: (forall X :e int, ((FAST X) = (V3 X))).
Theorem A16267: (forall N :e int, ((0 <= N) -> ((SMALL N) = (FAST N)))).
Admitted.
End A16267.