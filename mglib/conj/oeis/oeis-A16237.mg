...
(** Bounty 1 PFG TMbW648BsbNmTM74rbZ8im7dgQm2VPyNEuU **)
Section A16237.
...
Hypothesis H3: (forall X :e int, ((F2 X) = (1 + (X + X)))).
...
Hypothesis H8: (forall X :e int, (forall Y :e int, ((H1 X Y) = (V2 X Y)))).
...
Hypothesis H17: (forall X :e int, (forall Y :e int, ((F3 X Y) = (2 + (X * Y))))).
...
Hypothesis H25: (forall X :e int, (forall Y :e int, ((F4 X Y) = (1 + (X * Y))))).
...
Hypothesis H33: (forall X :e int, ((FAST X) = ((W3 X) + - (W4 X)))).
Theorem A16237: (forall N :e int, ((0 <= N) -> ((SMALL N) = (FAST N)))).
Admitted.
End A16237.