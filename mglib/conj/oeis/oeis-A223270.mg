...
(** Bounty 1 PFG TMUhb4b1TKUB54wNuZNU7AM3VQYxfU5Crc2 **)
Section A223270.
...
Hypothesis H30: (forall X :e int, ((H3 X) = (V4 X))).
...
Hypothesis H33: (forall X :e int, ((FAST X) = ((2 * (W2 X)) * (V3 X)))).
Theorem A223270: (forall N :e int, ((0 <= N) -> ((SMALL N) = (FAST N)))).
Admitted.
End A223270.