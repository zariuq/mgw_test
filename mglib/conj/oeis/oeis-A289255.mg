...
(** Bounty 1 PFG TMV48yHxm5XgiUudsTixJNVZSyz3GGKNRex **)
Section A289255.
...
Hypothesis H6: (forall X :e int, ((SMALL X) = ((V0 X) + - 1))).
...
Hypothesis H17: (forall X :e int, ((FAST X) = (1 + ((V1 X) + - (2 * (2 + X)))))).
Theorem A289255: (forall N :e int, ((0 <= N) -> ((SMALL N) = (FAST N)))).
Admitted.
End A289255.