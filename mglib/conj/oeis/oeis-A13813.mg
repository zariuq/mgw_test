...
(** Bounty 1 PFG TMJAmjFQDcu7rqjrZba8CP5pPk7TSS2H3uB **)
Section A13813.
...
Hypothesis H37: (forall X :e int, ((H6 X) = (1 + X))).
Hypothesis H38: (I6 = 1).
...
Hypothesis H46: (forall X :e int, ((FAST X) = (((W3 X) * (W4 X)) * (V5 X)))).
Theorem A13813: (forall N :e int, ((0 <= N) -> ((SMALL N) = (FAST N)))).
Admitted.
End A13813.