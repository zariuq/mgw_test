...
(** Bounty 1 PFG TMM1yfqEjVwAEW8axZQfHYDKrUphs2HFv3C **)
Section A179135.
...
Hypothesis H2: (forall X :e int, (forall Y :e int, ((G0 X Y) = ((2 * (Y + Y)) + - X)))).
...
Theorem A179135: (forall N :e int, ((0 <= N) -> ((SMALL N) = (FAST N)))).
Admitted.
End A179135.