...
(** Bounty 1 PFG TMEtSnVRXt3dUqb1D8k5tTUy78yA8ojMb1a **)
Section A28403.
...
Hypothesis H8: (forall X :e int, ((H0 X) = (2 + (V1 X)))).
...
Hypothesis H22: (forall X :e int, ((FAST X) = (2 * (V2 X)))).
Theorem A28403: (forall N :e int, ((0 <= N) -> ((SMALL N) = (FAST N)))).
Admitted.
End A28403.