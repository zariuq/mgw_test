...
(** Bounty 1 PFG TMUN9pJwFvvyeXR5Vvg9zkS4hBoxHvwhRL9 **)
Section A155657.
...
Hypothesis H31: (forall X :e int, ((FAST X) = (((W2 X) + - 1) + (W3 X)))).
Theorem A155657: (forall N :e int, ((0 <= N) -> ((SMALL N) = (FAST N)))).
Admitted.
End A155657.