...
(** Bounty 1 PFG TMSHat6RxyzYGuWdJyQB9HVn7CNnd2yMAsV **)
Section A288516.
...
Hypothesis H11: (forall X :e int, (forall Y :e int, ((F0 X Y) = (((V1 X Y) + X) + Y)))).
...
Hypothesis H16: (forall X :e int, ((SMALL X) = ((((V0 X) * 2) + - 1) + - X))).
Hypothesis H17: (forall X :e int, (forall Y :e int, ((F4 X Y) = (((Y * Y) + X) + Y)))).
Hypothesis H18: (forall X :e int, (forall Y :e int, ((G4 X Y) = (1 + Y)))).
Hypothesis H19: (forall X :e int, ((H4 X) = (1 + X))).
Hypothesis H20: (forall X :e int, (forall Y :e int, ((U4 X Y) = (if (X <= 0) then Y else (F4 (U4 (X + - 1) Y) X))))).
Hypothesis H21: (forall X :e int, (forall Y :e int, ((V4 X Y) = (U4 (G4 X Y) (H4 X))))).
Hypothesis H22: (forall X :e int, (forall Y :e int, ((F3 X Y) = ((((V4 X Y) + X) + Y) + Y)))).
Hypothesis H23: (forall X :e int, ((G3 X) = X)).
Hypothesis H24: (H3 = 1).
...
Hypothesis H27: (forall X :e int, ((FAST X) = ((V3 X) + - X))).
Theorem A288516: (forall N :e int, ((0 <= N) -> ((SMALL N) = (FAST N)))).
Admitted.
End A288516.