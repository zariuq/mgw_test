...
(** Bounty 1 PFG TMT8oCUmwAsXMxZa6W5zgtZ3doDHJ7GCuZy **)
Section A127859.
...
Hypothesis H1: (forall X :e int, (forall Y :e int, ((F1 X Y) = (((2 + Y) * X) + - 1)))).
Hypothesis H2: (G1 = 2).
...
Hypothesis H20: (forall X :e int, ((FAST X) = (((1 + 2) * (W2 X)) + 1))).
Theorem A127859: (forall N :e int, ((0 <= N) -> ((SMALL N) = (FAST N)))).
Admitted.
End A127859.