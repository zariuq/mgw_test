...
(** Bounty 1 PFG TMbLXYPZJLXGwZrTjTJctW6hhdmAZRrcHG8 **)
Section A24772.
...
Variable W8:set -> set -> set.
Hypothesis HW8: forall x0 :e int, forall x1 :e int, W8 x0 x1 :e int.
...
Hypothesis H1: (forall X :e int, ((F2 X) = (1 + (2 * (2 * (X + X)))))).
...
Hypothesis H6: (forall X :e int, ((F3 X) = ((X + X) + X))).
Hypothesis H7: (G3 = 2).
...
Hypothesis H27: (forall X :e int, (forall Y :e int, ((F8 X Y) = (1 + (X * Y))))).
Hypothesis H28: (forall X :e int, (forall Y :e int, ((G8 X Y) = Y))).
Hypothesis H29: (forall X :e int, (forall Y :e int, ((H8 X Y) = Y))).
Hypothesis H30: (I8 = 1).
Hypothesis H31: (J8 = (2 * (2 + 2))).
Hypothesis H32: (forall X :e int, (forall Y :e int, (forall Z :e int, ((U8 X Y Z) = (if (X <= 0) then Y else (F8 (U8 (X + - 1) Y Z) (V8 (X + - 1) Y Z))))))).
Hypothesis H33: (forall X :e int, (forall Y :e int, (forall Z :e int, ((V8 X Y Z) = (if (X <= 0) then Z else (G8 (U8 (X + - 1) Y Z) (V8 (X + - 1) Y Z))))))).
Hypothesis H34: (forall X :e int, (forall Y :e int, ((W8 X Y) = (U8 (H8 X Y) I8 J8)))).
Hypothesis H35: (forall X :e int, (forall Y :e int, ((F7 X Y) = (((W8 X Y) + (((X + X) * 2) * 2)) + X)))).
Hypothesis H36: (forall X :e int, ((G7 X) = X)).
Hypothesis H37: (H7 = 1).
Hypothesis H38: (forall X :e int, (forall Y :e int, ((U7 X Y) = (if (X <= 0) then Y else (F7 (U7 (X + - 1) Y) X))))).
Hypothesis H39: (forall X :e int, ((V7 X) = (U7 (G7 X) H7))).
Hypothesis H40: (forall X :e int, ((F6 X) = (V7 X))).
Hypothesis H41: (G6 = 1).
...
Hypothesis H45: (forall X :e int, (forall Y :e int, ((F5 X Y) = (((V6 X Y) + X) + ((((X + X) * 2) + X) * 2))))).
...
Theorem A24772: (forall N :e int, ((0 <= N) -> ((SMALL N) = (FAST N)))).
Admitted.
End A24772.