...
(** Bounty 1 PFG TMVSttYZEJSADxrCNvm15yKnDsBwJCy7Wq8 **)
Section A189356.
...
Hypothesis H21: (forall X :e int, ((I2 X) = ((if (X <= 0) then 0 else 2) + 1))).
Hypothesis H22: (J2 = 1).
...
Hypothesis H26: (forall X :e int, ((FAST X) = ((((W1 X) * (W2 X)) * 2) + - 1))).
Theorem A189356: (forall N :e int, ((0 <= N) -> ((SMALL N) = (FAST N)))).
Admitted.
End A189356.