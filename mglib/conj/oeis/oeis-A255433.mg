...
(** Bounty 1 PFG TMTXRxy4UJfX613Fxi5j2PgyPwCATkuZHQd **)
Section A255433.
...
Hypothesis H7: (forall X :e int, (forall Y :e int, ((F1 X Y) = ((1 + ((Y * Y) + Y)) * X)))).
Hypothesis H8: (forall X :e int, ((G1 X) = (X + - 1))).
Hypothesis H9: (H1 = 1).
...
Theorem A255433: (forall N :e int, ((0 <= N) -> ((SMALL N) = (FAST N)))).
Admitted.
End A255433.