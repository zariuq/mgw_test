...
(** Bounty 1 PFG TMPHqMRrHYkjAnFBGaQ4xrkJjkm51tdo42f **)
Section A20343.
...
Hypothesis H6: (forall X :e int, (forall Y :e int, ((F1 X Y) = ((V2 X Y) + (2 * (2 * (X + X))))))).
...
Hypothesis H40: (forall X :e int, (forall Y :e int, ((F3 X Y) = ((((((V4 X Y) + X) + X) + X) + X) + X)))).
...
Theorem A20343: (forall N :e int, ((0 <= N) -> ((SMALL N) = (FAST N)))).
Admitted.
End A20343.