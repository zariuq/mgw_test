...
(** Bounty 1 PFG TMHeaw7PzmGNQVouPzHcAgAJMCDWgeQmr4M **)
Section A74539.
...
Hypothesis H6: (forall X :e int, (forall Y :e int, ((F1 X Y) = (((Y * Y) * Y) + Y)))).
...
Hypothesis H15: (forall X :e int, ((F2 X) = (((X * X) * X) + X))).
Hypothesis H16: (G2 = 1).
...
Theorem A74539: (forall N :e int, ((0 <= N) -> ((SMALL N) = (FAST N)))).
Admitted.
End A74539.