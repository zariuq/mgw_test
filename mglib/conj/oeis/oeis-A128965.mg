...
(** Bounty 1 PFG TMVN2rmp9nyP7n1SJ3f71awg9YcUq78qLrN **)
Section A128965.
...
Hypothesis H6: (forall X :e int, ((SMALL X) = (((1 + X) * (V0 X)) * X))).
...
Hypothesis H15: (forall X :e int, ((FAST X) = (((W1 X) * (2 + X)) * X))).
Theorem A128965: (forall N :e int, ((0 <= N) -> ((SMALL N) = (FAST N)))).
Admitted.
End A128965.