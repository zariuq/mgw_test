...
(** Bounty 1 PFG TMXhgBdGSWmZ2oBpoWWK8mRnn4e7XLNQwS3 **)
Section A7566.
...
Hypothesis H10: (forall X :e int, (forall Y :e int, ((F1 X Y) = (2 + (2 * (X * Y)))))).
...
Hypothesis H15: (forall X :e int, ((FAST X) = ((((V1 X) + - 1) * (X + X)) + 1))).
Theorem A7566: (forall N :e int, ((0 <= N) -> ((SMALL N) = (FAST N)))).
Admitted.
End A7566.