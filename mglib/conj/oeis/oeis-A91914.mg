...
(** Bounty 1 PFG TMKSPLAq9fxzyyaUHsYUPcAGqCVyDPVXnkE **)
Section A91914.
...
Hypothesis H1: (forall X :e int, (forall Y :e int, ((F0 X Y) = ((2 * (X + Y)) + Y)))).
...
Hypothesis H10: (forall X :e int, (forall Y :e int, ((F1 X Y) = (((X + Y) + Y) + Y)))).
Hypothesis H11: (forall X :e int, ((G1 X) = X)).
Hypothesis H12: (forall X :e int, ((H1 X) = (X + - 2))).
Hypothesis H13: (forall X :e int, ((I1 X) = (if ((X + - 1) <= 0) then 1 else (2 + 2)))).
Hypothesis H14: (J1 = 1).
...
Theorem A91914: (forall N :e int, ((0 <= N) -> ((SMALL N) = (FAST N)))).
Admitted.
End A91914.