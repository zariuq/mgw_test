...
(** Bounty 1 PFG TMRtuDasyWKh1ryqo6ukusFm5uYGz6nnEy3 **)
Section A269025.
...
Hypothesis H15: (I2 = 1).
Hypothesis H16: (forall X :e int, ((F3 X) = (((X * X) * X) + - X))).
Hypothesis H17: (G3 = 1).
Hypothesis H18: (H3 = (2 + 2)).
...
Theorem A269025: (forall N :e int, ((0 <= N) -> ((SMALL N) = (FAST N)))).
Admitted.
End A269025.