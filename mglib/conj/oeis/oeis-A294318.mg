...
Hypothesis H12: (forall X :e int, (forall Y :e int, ((F2 X Y) = (((1 + 2) * (X * Y)) + X)))).
...
Hypothesis H18: (forall X :e int, (forall Y :e int, ((G4 X Y) = ((Y + Y) + Y)))).
Hypothesis H19: (H4 = 1).
...
Hypothesis H27: (forall X :e int, ((FAST X) = ((V2 X) * (V3 X)))).
Theorem A294318: (forall N :e int, ((0 <= N) -> ((SMALL N) = (FAST N)))).
Admitted.
End A294318.