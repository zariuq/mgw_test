...
(** Bounty 1 PFG TMSZ9q8tXjur37ZTztgz3giQpvrhEjv978g **)
Section A190966.
...
Hypothesis H2: (forall X :e int, (forall Y :e int, ((G0 X Y) = (2 * (2 * ((Y + - X) + - X)))))).
...
Hypothesis H15: (forall X :e int, ((G2 X) = (X + - 1))).
Hypothesis H16: (H2 = 1).
...
Hypothesis H19: (forall X :e int, ((J1 X) = (V2 X))).
Hypothesis H20: (forall X :e int, (forall Y :e int, (forall Z :e int, ((U1 X Y Z) = (if (X <= 0) then Y else (F1 (U1 (X + - 1) Y Z) (V1 (X + - 1) Y Z))))))).
Hypothesis H21: (forall X :e int, (forall Y :e int, (forall Z :e int, ((V1 X Y Z) = (if (X <= 0) then Z else (G1 (U1 (X + - 1) Y Z) (V1 (X + - 1) Y Z))))))).
Hypothesis H22: (forall X :e int, ((W1 X) = (U1 (H1 X) I1 (J1 X)))).
Hypothesis H23: (forall X :e int, ((FAST X) = (W1 X))).
Theorem A190966: (forall N :e int, ((0 <= N) -> ((SMALL N) = (FAST N)))).
Admitted.
End A190966.