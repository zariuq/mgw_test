...
(** Bounty 1 PFG TMYwjY1fcAMh5LKEM5f8ZKWjM3cxrfXtqH2 **)
Section A3013.
...
Hypothesis H6: (forall X :e int, ((SMALL X) = (if (X <= 0) then 1 else ((V0 X) * X)))).
...
Hypothesis H12: (forall X :e int, ((FAST X) = (((V1 X) * X) + (if (X <= 0) then 1 else X)))).
Theorem A3013: (forall N :e int, ((0 <= N) -> ((SMALL N) = (FAST N)))).
Admitted.
End A3013.