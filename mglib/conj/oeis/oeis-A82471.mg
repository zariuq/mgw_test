...
(** Bounty 1 PFG TMaDiqCQb53w3yHWmPKaGpFRb2E8nb7NUJ4 **)
Section A82471.
...
Hypothesis H8: (forall X :e int, (forall Y :e int, ((W1 X Y) = (U1 (H1 X Y) (I1 X) J1)))).
...
Hypothesis H23: (forall X :e int, (forall Y :e int, ((F2 X Y) = ((1 + (W3 X Y)) * X)))).
...
Theorem A82471: (forall N :e int, ((0 <= N) -> ((SMALL N) = (FAST N)))).
Admitted.
End A82471.