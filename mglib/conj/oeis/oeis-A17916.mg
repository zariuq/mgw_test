...
(** Bounty 1 PFG TMMfaJ8PWYnUexbjtWPKxMobT5iQgHjtA98 **)
Section A17916.
...
Hypothesis H40: (forall X :e int, (forall Y :e int, ((F4 X Y) = ((((V5 X Y) + X) + X) + X)))).
...
Theorem A17916: (forall N :e int, ((0 <= N) -> ((SMALL N) = (FAST N)))).
Admitted.
End A17916.