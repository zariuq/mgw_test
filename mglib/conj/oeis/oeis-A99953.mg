...
(** Bounty 1 PFG TMPqjAVqHuMc75atyVdpV45u9guHvR5wu5C **)
Section A99953.
...
Hypothesis H1: (forall X :e int, (forall Y :e int, ((F1 X Y) = ((2 * (X * Y)) + - X)))).
...
Theorem A99953: (forall N :e int, ((0 <= N) -> ((SMALL N) = (FAST N)))).
Admitted.
End A99953.