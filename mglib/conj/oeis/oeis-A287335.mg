...
(** Bounty 1 PFG TMU8i9sdqxbyunwMFxqfFWwkvuWfRHqw18h **)
Section A287335.
...
Hypothesis H8: (G1 = 1).
Hypothesis H9: (forall X :e int, ((H1 X) = ((1 + 2) * (1 + X)))).
...
Hypothesis H12: (forall X :e int, ((FAST X) = (2 + (((2 + (V1 X)) * X) + X)))).
Theorem A287335: (forall N :e int, ((0 <= N) -> ((SMALL N) = (FAST N)))).
Admitted.
End A287335.