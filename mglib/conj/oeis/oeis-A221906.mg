...
(** Bounty 1 PFG TMWpxs64sCpmwzJu89gZDsroVxssmoiUoxS **)
Section A221906.
...
Hypothesis H1: (forall X :e int, (forall Y :e int, ((F0 X Y) = (2 * (2 + (X + - Y)))))).
...
Hypothesis H17: (forall X :e int, ((FAST X) = ((2 * (X + X)) + (V1 X)))).
Theorem A221906: (forall N :e int, ((0 <= N) -> ((SMALL N) = (FAST N)))).
Admitted.
End A221906.