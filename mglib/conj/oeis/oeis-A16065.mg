...
(** Bounty 1 PFG TMSF3DNVDdvCRvsnf3G911RKnqbe1mrvWb1 **)
Section A16065.
...
Hypothesis H1: (forall X :e int, (forall Y :e int, ((F1 X Y) = ((1 + Y) * (X * Y))))).
...
Theorem A16065: (forall N :e int, ((0 <= N) -> ((SMALL N) = (FAST N)))).
Admitted.
End A16065.