...
(** Bounty 1 PFG TMKq76H7jsTopHvBD8rkDomKGgRPa5UQX82 **)
Section A17932.
...
Hypothesis H33: (forall X :e int, (forall Y :e int, ((F2 X Y) = ((V3 X Y) + (2 * (2 * (X + X))))))).
...
Theorem A17932: (forall N :e int, ((0 <= N) -> ((SMALL N) = (FAST N)))).
Admitted.
End A17932.