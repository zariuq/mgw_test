...
(** Bounty 1 PFG TMUdPcfBFYbiRTKmdD2cUqVjGweu5PcFMiN **)
Section A277168.
...
Hypothesis H9: (I1 = 1).
Hypothesis H10: (forall X :e int, ((J1 X) = (2 + (2 * (X + X))))).
...
Hypothesis H13: (forall X :e int, ((W1 X) = (U1 (H1 X) I1 (J1 X)))).
...
Hypothesis H24: (forall X :e int, (forall Y :e int, ((G3 X Y) = (1 + Y)))).
Hypothesis H25: (forall X :e int, ((H3 X) = X)).
Hypothesis H26: (I3 = 1).
Hypothesis H27: (forall X :e int, ((J3 X) = (1 + X))).
...
Hypothesis H30: (forall X :e int, ((W3 X) = (U3 (H3 X) I3 (J3 X)))).
Hypothesis H31: (forall X :e int, ((FAST X) = (((1 + (X + X)) * (W2 X)) * (W3 X)))).
Theorem A277168: (forall N :e int, ((0 <= N) -> ((SMALL N) = (FAST N)))).
Admitted.
End A277168.