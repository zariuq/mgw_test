...
(** Bounty 1 PFG TMPfmX85mcR1diyv2H3Jm557Hj1wQHRheN1 **)
Section A7667.
...
Hypothesis H1: (forall X :e int, (forall Y :e int, ((F0 X Y) = (((2 * ((2 * (X + X)) + X)) + - 2) + - Y)))).
Hypothesis H2: (forall X :e int, ((G0 X) = X)).
Hypothesis H3: (forall X :e int, ((H0 X) = (X + X))).
Hypothesis H4: (I0 = (2 + 2)).
Hypothesis H5: (J0 = 1).
...
Hypothesis H10: (forall X :e int, ((F1 X) = (((X + X) + X) * X))).
Hypothesis H11: (G1 = 1).
...
Theorem A7667: (forall N :e int, ((0 <= N) -> ((SMALL N) = (FAST N)))).
Admitted.
End A7667.