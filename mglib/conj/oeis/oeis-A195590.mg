...
(** Bounty 1 PFG TMa7ynZJns9BKxQUehx7i8Rp62uwj4MFvn5 **)
Section A195590.
...
Hypothesis H2: (forall X :e int, (forall Y :e int, ((G0 X Y) = (2 * (2 + Y))))).
...
Hypothesis H12: (forall X :e int, ((H1 X) = (2 + ((2 * (X + X)) + X)))).
...
Hypothesis H15: (forall X :e int, ((FAST X) = (2 * (2 + (V1 X))))).
Theorem A195590: (forall N :e int, ((0 <= N) -> ((SMALL N) = (FAST N)))).
Admitted.
End A195590.