...
(** Bounty 1 PFG TMVEN3YYaA3CFqY6WEmP9yfxsVzyAMrgwZd **)
Section A97039.
...
Hypothesis H9: (forall X :e int, (forall Y :e int, ((F0 X Y) = ((Y * (W1 X Y)) + X)))).
...
Hypothesis H23: (forall X :e int, (forall Y :e int, ((F2 X Y) = (((W3 X Y) * Y) + X)))).
...
Theorem A97039: (forall N :e int, ((0 <= N) -> ((SMALL N) = (FAST N)))).
Admitted.
End A97039.