...
(** Bounty 1 PFG TMHxyw1T3hJFbCrBeWyHLBws3CNf3PFPSVJ **)
Section A19623.
...
Hypothesis H20: (forall X :e int, (forall Y :e int, ((F4 X Y) = (((2 * ((X + X) + X)) + (Y * Y)) + X)))).
...
Theorem A19623: (forall N :e int, ((0 <= N) -> ((SMALL N) = (FAST N)))).
Admitted.
End A19623.