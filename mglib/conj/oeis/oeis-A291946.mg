...
(** Bounty 1 PFG TMVSXPVuGmm2Y3e8jEcyGwPgMQyMRYH4fMo **)
Section A291946.
...
Hypothesis H15: (I2 = 1).
Hypothesis H16: (forall X :e int, ((F3 X) = (1 + (2 * ((2 * (X + X)) + X))))).
Hypothesis H17: (G3 = (2 + 2)).
Hypothesis H18: (H3 = 1).
...
Theorem A291946: (forall N :e int, ((0 <= N) -> ((SMALL N) = (FAST N)))).
Admitted.
End A291946.