...
(** Bounty 1 PFG TMcM5waNFfFcLANRndUX2i8F8oJioknBKdv **)
Section A1814.
...
Hypothesis H10: (I1 = 1).
Hypothesis H11: (forall X :e int, ((J1 X) = (1 + X))).
...
Hypothesis H15: (forall X :e int, ((FAST X) = (((1 + (X + X)) * (1 + X)) * (W1 X)))).
Theorem A1814: (forall N :e int, ((0 <= N) -> ((SMALL N) = (FAST N)))).
Admitted.
End A1814.