...
(** Bounty 1 PFG TMWvLTQCuZ8HGrAR2F31RhpdXbzWXvjSTR5 **)
Section A22117.
...
Hypothesis H6: (forall X :e int, (forall Y :e int, ((F0 X Y) = (V1 + - Y)))).
Hypothesis H7: (forall X :e int, (forall Y :e int, ((G0 X Y) = (Y + - X)))).
...
Theorem A22117: (forall N :e int, ((0 <= N) -> ((SMALL N) = (FAST N)))).
Admitted.
End A22117.