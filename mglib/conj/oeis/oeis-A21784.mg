...
(** Bounty 1 PFG TMLk5YBKL7tVfq5si56JaHaXCTJZ3Ys991X **)
Section A21784.
...
Hypothesis H11: (forall X :e int, (forall Y :e int, ((F1 X Y) = ((V2 X Y) + (2 * (X + X)))))).
...
Theorem A21784: (forall N :e int, ((0 <= N) -> ((SMALL N) = (FAST N)))).
Admitted.
End A21784.