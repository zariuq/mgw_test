...
(** Bounty 1 PFG TMSFxKJHfFVwdbJXboD5Y7mDcvdLxaLo5ff **)
Section A26543.
...
Hypothesis H45: (forall X :e int, (forall Y :e int, ((F5 X Y) = (((V6 X Y) + (2 * ((X + X) + X))) + X)))).
...
Theorem A26543: (forall N :e int, ((0 <= N) -> ((SMALL N) = (FAST N)))).
Admitted.
End A26543.