...
(** Bounty 1 PFG TMaHiNyrpFRZoX2nj7gTFTvv9Whshrrdqnu **)
Section A20448.
...
Hypothesis H43: (forall X :e int, (forall Y :e int, ((F3 X Y) = (((V4 X Y) + (2 * (X + X))) + X)))).
...
Theorem A20448: (forall N :e int, ((0 <= N) -> ((SMALL N) = (FAST N)))).
Admitted.
End A20448.