...
(** Bounty 1 PFG TMc7EAhGq4jJKu2zLFVPRHVygqYhEGFb6GN **)
Section A268730.
...
Hypothesis H1: (forall X :e int, ((F1 X) = (2 + - (2 * (X + X))))).
Hypothesis H2: (G1 = 2).
...
Hypothesis H13: (forall X :e int, (forall Y :e int, ((G2 X Y) = ((2 * (2 * (2 + 2))) + Y)))).
...
Theorem A268730: (forall N :e int, ((0 <= N) -> ((SMALL N) = (FAST N)))).
Admitted.
End A268730.