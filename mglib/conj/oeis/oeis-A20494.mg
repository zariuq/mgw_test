...
(** Bounty 1 PFG TMUCTHS9ZxPs64An2koJsM3xgXbgnecFJdW **)
Section A20494.
...
Hypothesis H16: (forall X :e int, ((F4 X) = ((X + X) + X))).
Hypothesis H17: (G4 = 2).
...
Hypothesis H21: (forall X :e int, (forall Y :e int, ((F0 X Y) = ((V1 X Y) + (V4 X))))).
...
Theorem A20494: (forall N :e int, ((0 <= N) -> ((SMALL N) = (FAST N)))).
Admitted.
End A20494.