...
(** Bounty 1 PFG TMFpmuLsF67zE1Nm8etAtmi3hwTyymzv6aj **)
Section A19869.
...
Hypothesis H16: (forall X :e int, (forall Y :e int, ((F0 X Y) = (((V1 X Y) + (2 * (X + X))) + X)))).
...
Hypothesis H27: (forall X :e int, (forall Y :e int, ((F8 X Y) = (X * Y)))).
Hypothesis H28: (forall X :e int, (forall Y :e int, ((G8 X Y) = Y))).
Hypothesis H29: (forall X :e int, ((H8 X) = X)).
Hypothesis H30: (I8 = 1).
...
Hypothesis H34: (forall X :e int, ((W8 X) = (U8 (H8 X) I8 J8))).
Hypothesis H35: (forall X :e int, ((F6 X) = (((V7 X) + - 1) * (W8 X)))).
Hypothesis H36: (G6 = 1).
...
Hypothesis H40: (forall X :e int, (forall Y :e int, ((F5 X Y) = (((V6 X Y) + (2 * (X + X))) + X)))).
...
Hypothesis H45: (forall X :e int, ((F4 X) = (V5 X))).
Hypothesis H46: (G4 = 1).
Hypothesis H47: (forall X :e int, ((H4 X) = X)).
Hypothesis H48: (forall X :e int, (forall Y :e int, ((U4 X Y) = (if (X <= 0) then Y else (F4 (U4 (X + - 1) Y)))))).
Hypothesis H49: (forall X :e int, ((V4 X) = (U4 G4 (H4 X)))).
Hypothesis H50: (forall X :e int, ((FAST X) = (V4 X))).
Theorem A19869: (forall N :e int, ((0 <= N) -> ((SMALL N) = (FAST N)))).
Admitted.
End A19869.