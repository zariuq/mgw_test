...
(** Bounty 1 PFG TMMxbAdaJVErXBqTJYpV7MX4p4KQgeuFqgS **)
Section A203579.
...
Hypothesis H2: (forall X :e int, (forall Y :e int, ((G0 X Y) = (2 * ((X + X) + Y))))).
...
Theorem A203579: (forall N :e int, ((0 <= N) -> ((SMALL N) = (FAST N)))).
Admitted.
End A203579.