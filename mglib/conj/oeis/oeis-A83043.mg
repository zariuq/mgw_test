...
(** Bounty 1 PFG TMLjnyVBRL7UJ8JNwFyuFTvP6Gfgm2SAHfV **)
Section A83043.
...
Hypothesis H15: (forall X :e int, (forall Y :e int, ((F2 X Y) = (((2 + (2 * (2 + 2))) * (X + X)) + - Y)))).
Hypothesis H16: (forall X :e int, ((G2 X) = X)).
Hypothesis H17: (forall X :e int, ((H2 X) = (X + - 1))).
Hypothesis H18: (forall X :e int, ((I2 X) = ((if (X <= 0) then 0 else (2 * (2 + (2 * (2 + 2))))) + 1))).
Hypothesis H19: (J2 = 1).
...
Theorem A83043: (forall N :e int, ((0 <= N) -> ((SMALL N) = (FAST N)))).
Admitted.
End A83043.