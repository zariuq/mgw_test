...
(** Bounty 1 PFG TMX3hKRvpsPZQ6ohdzxvdUJ2ZJgqB2QT4Sv **)
Section A16299.
...
Hypothesis H40: (forall X :e int, (forall Y :e int, ((F4 X Y) = (((V5 X Y) + X) + X)))).
...
Theorem A16299: (forall N :e int, ((0 <= N) -> ((SMALL N) = (FAST N)))).
Admitted.
End A16299.