...
(** Bounty 1 PFG TMG39eiXp2UKBVh6uk6iHWUKPFx6esw7Q7X **)
Section A200441.
...
Hypothesis H15: (forall X :e int, (forall Y :e int, ((F2 X Y) = (((1 + (2 * (2 * (2 * (2 + 2))))) * X) + - Y)))).
...
Theorem A200441: (forall N :e int, ((0 <= N) -> ((SMALL N) = (FAST N)))).
Admitted.
End A200441.