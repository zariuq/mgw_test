...
(** Bounty 1 PFG TMQMcAwsLdPxrDkL4vYt2kkynBYxnHqP2wW **)
Section A138119.
...
Hypothesis H6: (forall X :e int, ((F1 X) = (1 + (2 * ((2 * (X + X)) + X))))).
...
Hypothesis H33: (forall X :e int, ((FAST X) = (((W2 X) + - 1) * (V3 X)))).
Theorem A138119: (forall N :e int, ((0 <= N) -> ((SMALL N) = (FAST N)))).
Admitted.
End A138119.