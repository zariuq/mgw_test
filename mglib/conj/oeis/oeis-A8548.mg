...
(** Bounty 1 PFG TMLeJQXpzDYxxs9v66qsP1u4wvHjwzD9jLM **)
Section A8548.
...
Hypothesis H1: (forall X :e int, (forall Y :e int, ((F0 X Y) = (((2 * ((Y + - 2) + Y)) + Y) * X)))).
...
Theorem A8548: (forall N :e int, ((0 <= N) -> ((SMALL N) = (FAST N)))).
Admitted.
End A8548.