...
(** Bounty 1 PFG TMY5iZTFAmoAnSpr726cM4r5x4BvwCAVQKP **)
Section A13803.
...
Hypothesis H21: (forall X :e int, ((H4 X) = (1 + X))).
Hypothesis H22: (I4 = 1).
Hypothesis H23: (J4 = ((2 * (2 * (2 + 2))) + - 1)).
...
Hypothesis H32: (forall X :e int, ((H5 X) = (1 + (X + X)))).
Hypothesis H33: (I5 = 1).
...
Theorem A13803: (forall N :e int, ((0 <= N) -> ((SMALL N) = (FAST N)))).
Admitted.
End A13803.