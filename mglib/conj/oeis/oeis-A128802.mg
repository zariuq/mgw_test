...
(** Bounty 1 PFG TMbom29tsd34stiNtFBNVX6LRLiA78bcCe6 **)
Section A128802.
...
Hypothesis H6: (forall X :e int, ((SMALL X) = ((X + - 1) * (V0 X)))).
...
Hypothesis H17: (forall X :e int, ((FAST X) = (((X * X) + - X) * (V1 X)))).
Theorem A128802: (forall N :e int, ((0 <= N) -> ((SMALL N) = (FAST N)))).
Admitted.
End A128802.