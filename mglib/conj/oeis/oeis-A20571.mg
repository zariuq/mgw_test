...
(** Bounty 1 PFG TMb3kMSDZ5EfqBAmH4FSWmbo9uQM4YMxmbp **)
Section A20571.
...
Hypothesis H11: (forall X :e int, (forall Y :e int, ((F0 X Y) = (((V1 X Y) + (2 * ((X + X) + X))) + X)))).
...
Theorem A20571: (forall N :e int, ((0 <= N) -> ((SMALL N) = (FAST N)))).
Admitted.
End A20571.