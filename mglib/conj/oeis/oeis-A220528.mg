...
(** Bounty 1 PFG TMby3kpZxg6SSECe6GKDYkkTvdQKRg3ooDc **)
Section A220528.
...
Hypothesis H8: (forall X :e int, ((W0 X) = (U0 H0 (I0 X) (J0 X)))).
...
Hypothesis H14: (forall X :e int, ((SMALL X) = (((W0 X) + (V1 X)) + ((2 * ((X + X) + X)) + X)))).
...
Hypothesis H28: (forall X :e int, ((FAST X) = ((((V2 X) * X) + (W3 X)) + (((2 * X) * (1 + 2)) + X)))).
Theorem A220528: (forall N :e int, ((0 <= N) -> ((SMALL N) = (FAST N)))).
Admitted.
End A220528.