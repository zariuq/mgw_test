...
(** Bounty 1 PFG TMYQX1VkhurEmePRQzxrbCV6x9xwZivpsv6 **)
Section A289948.
...
Hypothesis H1: (forall X :e int, (forall Y :e int, ((F1 X Y) = (((X * Y) * Y) * Y)))).
...
Hypothesis H12: (forall X :e int, (forall Y :e int, ((F2 X Y) = (1 + (((Y * Y) * Y) * X))))).
...
Theorem A289948: (forall N :e int, ((0 <= N) -> ((SMALL N) = (FAST N)))).
Admitted.
End A289948.