...
Hypothesis H1: (forall X :e int, (forall Y :e int, ((F0 X Y) = ((((Y * Y) + - Y) + X) + X)))).
...
Hypothesis H15: (forall X :e int, ((F2 X) = (2 * X))).
Hypothesis H16: (forall X :e int, ((G2 X) = (X + - 2))).
Hypothesis H17: (H2 = 1).
...
Hypothesis H20: (forall X :e int, ((FAST X) = (((V1 X) + - (if ((X + - 1) <= 0) then 1 else X)) * (V2 X)))).
Theorem A431: (forall N :e int, ((0 <= N) -> ((SMALL N) = (FAST N)))).
Admitted.
End A431.