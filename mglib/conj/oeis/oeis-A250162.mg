...
(** Bounty 1 PFG TMdzXkgpJzxhqnvXbVJnFFT35QBFQN1GfmL **)
Section A250162.
...
Hypothesis H19: (forall X :e int, ((H2 X) = (1 + - (V3 X)))).
...
Hypothesis H22: (forall X :e int, ((FAST X) = (((((V2 X) + 2) + X) + X) * 2))).
Theorem A250162: (forall N :e int, ((0 <= N) -> ((SMALL N) = (FAST N)))).
Admitted.
End A250162.