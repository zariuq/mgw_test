...
(** Bounty 1 PFG TMMupMqcdUyHTSbs8Dwf1Pp59HTMTyxC4F5 **)
Section A71539.
...
Hypothesis H11: (forall X :e int, ((SMALL X) = ((1 + (V0 X)) * ((V1 X) + - 1)))).
...
Hypothesis H25: (forall X :e int, ((FAST X) = ((((V2 X) + - 1) * ((W3 X) + - 1)) * (1 + 2)))).
Theorem A71539: (forall N :e int, ((0 <= N) -> ((SMALL N) = (FAST N)))).
Admitted.
End A71539.