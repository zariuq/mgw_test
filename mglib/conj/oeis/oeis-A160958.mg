...
(** Bounty 1 PFG TML9SC1TuR26r3ALieuoHbD6PTWBrXNBH8d **)
Section A160958.
...
Hypothesis H15: (forall X :e int, (forall Y :e int, ((F2 X Y) = ((2 * ((2 * (2 * (2 * (2 * (Y + Y))))) + X)) + - Y)))).
...
Theorem A160958: (forall N :e int, ((0 <= N) -> ((SMALL N) = (FAST N)))).
Admitted.
End A160958.