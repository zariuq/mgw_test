...
(** Bounty 1 PFG TMMys1CEvuaLdpUn4EUkkuYxmHwyms3C5yt **)
Section A74546.
...
Hypothesis H6: (forall X :e int, ((F1 X) = (((X * X) * X) + X))).
Hypothesis H7: (G1 = 1).
...
Hypothesis H35: (forall X :e int, ((FAST X) = ((V3 X) + (W5 X)))).
Theorem A74546: (forall N :e int, ((0 <= N) -> ((SMALL N) = (FAST N)))).
Admitted.
End A74546.