...
(** Bounty 1 PFG TMGoCCv6yYnTAUkTrc8dveAgwgg5UZarXPd **)
Section A20726.
...
Hypothesis H35: (forall X :e int, ((F5 X) = ((W6 X) * (V7 X)))).
Hypothesis H36: (G5 = 1).
...
Hypothesis H40: (forall X :e int, (forall Y :e int, ((F4 X Y) = (((V5 X Y) + (2 * ((2 * (X + X)) + X))) + X)))).
...
Theorem A20726: (forall N :e int, ((0 <= N) -> ((SMALL N) = (FAST N)))).
Admitted.
End A20726.