...
(** Bounty 1 PFG TMcYQjhzNR5nzDMJQJVjprw9ajNrwssrkbT **)
Section A7487.
...
Hypothesis H12: (forall X :e int, ((F3 X) = ((X * X) * X))).
Hypothesis H13: (G3 = 1).
Hypothesis H14: (forall X :e int, (forall Y :e int, ((H3 X Y) = ((Y * Y) * Y)))).
Hypothesis H15: (forall X :e int, (forall Y :e int, ((U3 X Y) = (if (X <= 0) then Y else (F3 (U3 (X + - 1) Y)))))).
Hypothesis H16: (forall X :e int, (forall Y :e int, ((V3 X Y) = (U3 G3 (H3 X Y))))).
Hypothesis H17: (forall X :e int, (forall Y :e int, ((F2 X Y) = ((V3 X Y) + X)))).
...
Theorem A7487: (forall N :e int, ((0 <= N) -> ((SMALL N) = (FAST N)))).
Admitted.
End A7487.