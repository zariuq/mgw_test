...
(** Bounty 1 PFG TMHRBGAJSorkHLf5Jd7RJkYRAPW38JWoin5 **)
Section A95917.
...
Hypothesis H19: (forall X :e int, (forall Y :e int, ((F3 X Y) = (X + Y)))).
Hypothesis H20: (forall X :e int, ((G3 X) = X)).
Hypothesis H21: (forall X :e int, ((H3 X) = X)).
Hypothesis H22: (I3 = 1).
Hypothesis H23: (J3 = 0).
Hypothesis H24: (forall X :e int, (forall Y :e int, (forall Z :e int, ((U3 X Y Z) = (if (X <= 0) then Y else (F3 (U3 (X + - 1) Y Z) (V3 (X + - 1) Y Z))))))).
Hypothesis H25: (forall X :e int, (forall Y :e int, (forall Z :e int, ((V3 X Y Z) = (if (X <= 0) then Z else (G3 (U3 (X + - 1) Y Z))))))).
Hypothesis H26: (forall X :e int, ((W3 X) = (U3 (H3 X) I3 J3))).
Hypothesis H27: (forall X :e int, ((SMALL X) = ((V0 X) * (W3 X)))).
Hypothesis H28: (forall X :e int, ((F5 X) = (X * X))).
Hypothesis H29: (G5 = 1).
Hypothesis H30: (forall X :e int, (forall Y :e int, ((F6 X Y) = (X + Y)))).
Hypothesis H31: (forall X :e int, ((G6 X) = X)).
Hypothesis H32: (forall X :e int, (forall Y :e int, ((H6 X Y) = Y))).
Hypothesis H33: (I6 = 1).
Hypothesis H34: (J6 = 1).
Hypothesis H35: (forall X :e int, (forall Y :e int, (forall Z :e int, ((U6 X Y Z) = (if (X <= 0) then Y else (F6 (U6 (X + - 1) Y Z) (V6 (X + - 1) Y Z))))))).
Hypothesis H36: (forall X :e int, (forall Y :e int, (forall Z :e int, ((V6 X Y Z) = (if (X <= 0) then Z else (G6 (U6 (X + - 1) Y Z))))))).
Hypothesis H37: (forall X :e int, (forall Y :e int, ((W6 X Y) = (U6 (H6 X Y) I6 J6)))).
Hypothesis H38: (forall X :e int, (forall Y :e int, ((H5 X Y) = (W6 X Y)))).
Hypothesis H39: (forall X :e int, (forall Y :e int, ((U5 X Y) = (if (X <= 0) then Y else (F5 (U5 (X + - 1) Y)))))).
Hypothesis H40: (forall X :e int, (forall Y :e int, ((V5 X Y) = (U5 G5 (H5 X Y))))).
Hypothesis H41: (forall X :e int, (forall Y :e int, ((F4 X Y) = ((V5 X Y) * X)))).
Hypothesis H42: (forall X :e int, ((G4 X) = (X + - 1))).
Hypothesis H43: (H4 = 1).
Hypothesis H44: (forall X :e int, (forall Y :e int, ((U4 X Y) = (if (X <= 0) then Y else (F4 (U4 (X + - 1) Y) X))))).
Hypothesis H45: (forall X :e int, ((V4 X) = (U4 (G4 X) H4))).
Hypothesis H46: (forall X :e int, (forall Y :e int, ((F7 X Y) = (X + Y)))).
Hypothesis H47: (forall X :e int, ((G7 X) = X)).
Hypothesis H48: (forall X :e int, ((H7 X) = (X + - 1))).
Hypothesis H49: (I7 = 1).
Hypothesis H50: (J7 = 1).
Hypothesis H51: (forall X :e int, (forall Y :e int, (forall Z :e int, ((U7 X Y Z) = (if (X <= 0) then Y else (F7 (U7 (X + - 1) Y Z) (V7 (X + - 1) Y Z))))))).
Hypothesis H52: (forall X :e int, (forall Y :e int, (forall Z :e int, ((V7 X Y Z) = (if (X <= 0) then Z else (G7 (U7 (X + - 1) Y Z))))))).
Hypothesis H53: (forall X :e int, ((W7 X) = (U7 (H7 X) I7 J7))).
Hypothesis H54: (forall X :e int, ((FAST X) = ((V4 X) * (W7 X)))).
Theorem A95917: (forall N :e int, ((0 <= N) -> ((SMALL N) = (FAST N)))).
Admitted.
End A95917.