...
(** Bounty 1 PFG TMZ3DWEuvabQXiaZsD5dbGZwtvBiPhCFCdu **)
Section A199027.
...
Hypothesis H11: (forall X :e int, ((SMALL X) = ((2 * (2 * (V0 X))) + - 1))).
...
Hypothesis H20: (forall X :e int, ((FAST X) = ((2 * (2 * (W2 X))) + - 1))).
Theorem A199027: (forall N :e int, ((0 <= N) -> ((SMALL N) = (FAST N)))).
Admitted.
End A199027.