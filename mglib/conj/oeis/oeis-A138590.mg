...
(** Bounty 1 PFG TMF7oibnY5JebpnqTeyHrhWJfaMSBw5PgwP **)
Section A138590.
...
Hypothesis H15: (forall X :e int, (forall Y :e int, ((F2 X Y) = (((2 + 2) * X) + Y)))).
...
Theorem A138590: (forall N :e int, ((0 <= N) -> ((SMALL N) = (FAST N)))).
Admitted.
End A138590.