...
(** Bounty 1 PFG TMVW2YEitXXqu6YQfnoHvgA5A1ztvJTKWWR **)
Section A20595.
...
Hypothesis H11: (forall X :e int, (forall Y :e int, ((F0 X Y) = ((V1 X Y) + (2 * ((2 * (X + X)) + X)))))).
...
Hypothesis H17: (forall X :e int, (forall Y :e int, ((F5 X Y) = (((X + X) + X) + Y)))).
Hypothesis H18: (forall X :e int, (forall Y :e int, ((G5 X Y) = (Y + Y)))).
...
Hypothesis H25: (forall X :e int, (forall Y :e int, ((F6 X Y) = (X * Y)))).
Hypothesis H26: (forall X :e int, (forall Y :e int, ((G6 X Y) = Y))).
Hypothesis H27: (forall X :e int, ((H6 X) = X)).
Hypothesis H28: (I6 = 1).
Hypothesis H29: (J6 = (1 + 2)).
...
Hypothesis H33: (forall X :e int, ((F4 X) = ((W5 X) * (W6 X)))).
Hypothesis H34: (G4 = 1).
...
Hypothesis H38: (forall X :e int, (forall Y :e int, ((F3 X Y) = ((V4 X Y) + (2 * ((2 * (X + X)) + X)))))).
...
Theorem A20595: (forall N :e int, ((0 <= N) -> ((SMALL N) = (FAST N)))).
Admitted.
End A20595.