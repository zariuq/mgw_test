...
(** Bounty 1 PFG TMXaeTc3j4puvWiNKVtd6sXP11sKz8yws2c **)
Section A779.
...
Hypothesis H20: (forall X :e int, (forall Y :e int, ((F3 X Y) = ((Y + Y) * X)))).
...
Theorem A779: (forall N :e int, ((0 <= N) -> ((SMALL N) = (FAST N)))).
Admitted.
End A779.