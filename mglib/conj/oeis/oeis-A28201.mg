...
(** Bounty 1 PFG TMccSTifTsqNuym51ZQS7sAQxMRV3qKESdF **)
Section A28201.
...
Hypothesis H14: (forall X :e int, (forall Y :e int, ((F0 X Y) = (((V1 X Y) + (2 * ((X + X) + X))) + X)))).
...
Hypothesis H20: (forall X :e int, (forall Y :e int, ((F6 X Y) = ((((Y * Y) + X) + X) + X)))).
Hypothesis H21: (forall X :e int, (forall Y :e int, ((G6 X Y) = (Y + Y)))).
Hypothesis H22: (forall X :e int, (forall Y :e int, ((H6 X Y) = Y))).
Hypothesis H23: (I6 = 1).
Hypothesis H24: (J6 = 2).
Hypothesis H25: (forall X :e int, (forall Y :e int, (forall Z :e int, ((U6 X Y Z) = (if (X <= 0) then Y else (F6 (U6 (X + - 1) Y Z) (V6 (X + - 1) Y Z))))))).
Hypothesis H26: (forall X :e int, (forall Y :e int, (forall Z :e int, ((V6 X Y Z) = (if (X <= 0) then Z else (G6 (U6 (X + - 1) Y Z) (V6 (X + - 1) Y Z))))))).
Hypothesis H27: (forall X :e int, (forall Y :e int, ((W6 X Y) = (U6 (H6 X Y) I6 J6)))).
Hypothesis H28: (forall X :e int, (forall Y :e int, ((F5 X Y) = (((W6 X Y) + (2 * (X + X))) + X)))).
Hypothesis H29: (forall X :e int, ((G5 X) = X)).
Hypothesis H30: (H5 = 1).
Hypothesis H31: (forall X :e int, (forall Y :e int, ((U5 X Y) = (if (X <= 0) then Y else (F5 (U5 (X + - 1) Y) X))))).
...
Hypothesis H38: (forall X :e int, ((F4 X) = ((V5 X) * (V7 X)))).
Hypothesis H39: (G4 = 1).
...
Theorem A28201: (forall N :e int, ((0 <= N) -> ((SMALL N) = (FAST N)))).
Admitted.
End A28201.