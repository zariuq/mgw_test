...
(** Bounty 1 PFG TMQrLMstPjAnH4veAXyXJ5qu212LRwVvwsb **)
Section A74524.
...
Hypothesis H1: (forall X :e int, (forall Y :e int, ((F0 X Y) = ((2 * ((((Y * Y) + X) + X) + X)) + X)))).
Hypothesis H2: (forall X :e int, (forall Y :e int, ((G0 X Y) = ((Y + Y) + Y)))).
...
Hypothesis H26: (forall X :e int, ((FAST X) = (1 + ((W1 X) + (W2 X))))).
Theorem A74524: (forall N :e int, ((0 <= N) -> ((SMALL N) = (FAST N)))).
Admitted.
End A74524.