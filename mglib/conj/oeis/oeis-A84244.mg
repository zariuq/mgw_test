...
(** Bounty 1 PFG TMe1LymHMY9QoH384j1FtXbYnLStMP2Cvrt **)
Section A84244.
...
Hypothesis H1: (forall X :e int, (forall Y :e int, ((F0 X Y) = ((2 * (2 * (Y + - X))) + X)))).
Hypothesis H2: (G0 = 0).
...
Hypothesis H13: (I1 = (1 + (2 + 2))).
Hypothesis H14: (J1 = (0 + - (1 + 2))).
...
Theorem A84244: (forall N :e int, ((0 <= N) -> ((SMALL N) = (FAST N)))).
Admitted.
End A84244.