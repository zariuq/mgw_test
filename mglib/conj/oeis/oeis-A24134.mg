...
(** Bounty 1 PFG TMbYnAidyCMQvAjA4EWcLSnMfqiVWHQtcsE **)
Section A24134.
...
Hypothesis H11: (forall X :e int, (forall Y :e int, ((F2 X Y) = ((X * X) * Y)))).
Hypothesis H12: (forall X :e int, ((G2 X) = X)).
Hypothesis H13: (H2 = 2).
Hypothesis H14: (forall X :e int, ((I2 X) = X)).
Hypothesis H15: (forall X :e int, ((J2 X) = X)).
Hypothesis H16: (forall X :e int, (forall Y :e int, (forall Z :e int, ((U2 X Y Z) = (if (X <= 0) then Y else (F2 (U2 (X + - 1) Y Z) (V2 (X + - 1) Y Z))))))).
Hypothesis H17: (forall X :e int, (forall Y :e int, (forall Z :e int, ((V2 X Y Z) = (if (X <= 0) then Z else (G2 (U2 (X + - 1) Y Z))))))).
Hypothesis H18: (forall X :e int, ((W2 X) = (U2 H2 (I2 X) (J2 X)))).
Hypothesis H19: (forall X :e int, ((SMALL X) = ((V0 X) + - (W2 X)))).
...
Hypothesis H28: (forall X :e int, ((F4 X) = ((X * X) * X))).
Hypothesis H29: (G4 = 1).
Hypothesis H30: (forall X :e int, ((H4 X) = (X * X))).
Hypothesis H31: (forall X :e int, (forall Y :e int, ((U4 X Y) = (if (X <= 0) then Y else (F4 (U4 (X + - 1) Y)))))).
Hypothesis H32: (forall X :e int, ((V4 X) = (U4 G4 (H4 X)))).
Hypothesis H33: (forall X :e int, ((FAST X) = ((W3 X) + - ((V4 X) * X)))).
Theorem A24134: (forall N :e int, ((0 <= N) -> ((SMALL N) = (FAST N)))).
Admitted.
End A24134.