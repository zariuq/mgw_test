...
(** Bounty 1 PFG TMFDrWHm2MY4n8F53t5wLyuy5kwnNHMuX1y **)
Section A24439.
...
Hypothesis H11: (forall X :e int, (forall Y :e int, ((F1 X Y) = (((V2 X Y) + - X) + (V3 X))))).
...
Hypothesis H22: (forall X :e int, (forall Y :e int, ((F6 X Y) = ((2 * (2 * (X + X))) + Y)))).
Hypothesis H23: (forall X :e int, (forall Y :e int, ((G6 X Y) = (1 + ((2 * ((Y + Y) + Y)) + Y))))).
...
Theorem A24439: (forall N :e int, ((0 <= N) -> ((SMALL N) = (FAST N)))).
Admitted.
End A24439.