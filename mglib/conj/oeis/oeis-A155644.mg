...
(** Bounty 1 PFG TMMgxSthCnUy6CmgfTU5ZTJjMXc7y2hxkbK **)
Section A155644.
...
Hypothesis H16: (forall X :e int, ((SMALL X) = (1 + ((V0 X) + - (V2 X))))).
...
Hypothesis H33: (forall X :e int, ((FAST X) = (1 + ((W3 X) + - (W4 X))))).
Theorem A155644: (forall N :e int, ((0 <= N) -> ((SMALL N) = (FAST N)))).
Admitted.
End A155644.