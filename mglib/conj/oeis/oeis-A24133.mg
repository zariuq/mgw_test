...
(** Bounty 1 PFG TMSxz4v6atthbuzbuZiePLRhymA374hawsV **)
Section A24133.
...
Hypothesis H15: (forall X :e int, ((V2 X) = (U2 G2 (H2 X)))).
Hypothesis H16: (forall X :e int, ((SMALL X) = ((V0 X) + - (((V2 X) * X) * X)))).
...
Hypothesis H25: (forall X :e int, ((F4 X) = ((X * X) * X))).
Hypothesis H26: (G4 = 1).
Hypothesis H27: (forall X :e int, ((H4 X) = (X * X))).
Hypothesis H28: (forall X :e int, (forall Y :e int, ((U4 X Y) = (if (X <= 0) then Y else (F4 (U4 (X + - 1) Y)))))).
Hypothesis H29: (forall X :e int, ((V4 X) = (U4 G4 (H4 X)))).
Hypothesis H30: (forall X :e int, ((FAST X) = ((W3 X) + - (V4 X)))).
Theorem A24133: (forall N :e int, ((0 <= N) -> ((SMALL N) = (FAST N)))).
Admitted.
End A24133.