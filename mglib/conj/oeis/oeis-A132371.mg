...
(** Bounty 1 PFG TMGj9iFLeGBzShG8K9ffsiBXXHTiYVtbUUV **)
Section A132371.
...
Hypothesis H12: (forall X :e int, (forall Y :e int, ((F2 X Y) = ((X + - 1) * Y)))).
...
Theorem A132371: (forall N :e int, ((0 <= N) -> ((SMALL N) = (FAST N)))).
Admitted.
End A132371.