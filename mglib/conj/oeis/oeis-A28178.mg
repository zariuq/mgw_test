...
(** Bounty 1 PFG TMdozxuGMQJE1DfSwjhLigTyP1PnsM2iiUi **)
Section A28178.
...
Hypothesis H26: (forall X :e int, (forall Y :e int, ((F0 X Y) = ((V1 X Y) + (V5 X))))).
...
Hypothesis H55: (forall X :e int, ((F12 X) = (X + X))).
Hypothesis H56: (forall X :e int, ((G12 X) = X)).
Hypothesis H57: (H12 = 1).
Hypothesis H58: (forall X :e int, (forall Y :e int, ((U12 X Y) = (if (X <= 0) then Y else (F12 (U12 (X + - 1) Y)))))).
Hypothesis H59: (forall X :e int, ((V12 X) = (U12 (G12 X) H12))).
Hypothesis H60: (forall X :e int, ((F7 X) = ((V8 X) * (V12 X)))).
Hypothesis H61: (G7 = 1).
...
Hypothesis H65: (forall X :e int, (forall Y :e int, ((F6 X Y) = (((V7 X Y) + (2 * (X + X))) + X)))).
...
Theorem A28178: (forall N :e int, ((0 <= N) -> ((SMALL N) = (FAST N)))).
Admitted.
End A28178.