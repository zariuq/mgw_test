...
(** Bounty 1 PFG TMYu5rHtMveAMYqyNBWySyg7JEDpQfwxsHp **)
Section A20573.
...
Hypothesis H22: (forall X :e int, (forall Y :e int, ((F6 X Y) = (((1 + 2) * ((X + X) + Y)) + X)))).
...
Theorem A20573: (forall N :e int, ((0 <= N) -> ((SMALL N) = (FAST N)))).
Admitted.
End A20573.