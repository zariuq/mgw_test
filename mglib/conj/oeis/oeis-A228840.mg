...
(** Bounty 1 PFG TMXj4QktDNat5etziaP7XiKWEfzsDaY6VWQ **)
Section A228840.
...
Hypothesis H1: (forall X :e int, (forall Y :e int, ((F0 X Y) = ((2 * ((1 + (2 + (2 + 2))) * (X + - Y))) + Y)))).
...
Hypothesis H11: (forall X :e int, (forall Y :e int, ((G1 X Y) = ((2 * (Y + Y)) + X)))).
...
Theorem A228840: (forall N :e int, ((0 <= N) -> ((SMALL N) = (FAST N)))).
Admitted.
End A228840.