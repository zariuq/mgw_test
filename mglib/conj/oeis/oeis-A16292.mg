...
(** Bounty 1 PFG TMKxL3RDAajYeVLX8d8bhzkSNQrK2Zg3j5A **)
Section A16292.
...
Hypothesis H17: (forall X :e int, (forall Y :e int, ((F3 X Y) = (((2 * ((X + X) + Y)) + - 1) + X)))).
Hypothesis H18: (forall X :e int, (forall Y :e int, ((G3 X Y) = (Y + Y)))).
...
Theorem A16292: (forall N :e int, ((0 <= N) -> ((SMALL N) = (FAST N)))).
Admitted.
End A16292.