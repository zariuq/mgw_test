...
(** Bounty 1 PFG TMc65niH3pCZf4yaUamNf72USy392iyuu7a **)
Section A24170.
...
Hypothesis H11: (forall X :e int, ((F3 X) = ((X + X) + X))).
Hypothesis H12: (G3 = 2).
...
Hypothesis H23: (forall X :e int, (forall Y :e int, ((G6 X Y) = (1 + (2 * ((Y + Y) + Y)))))).
...
Theorem A24170: (forall N :e int, ((0 <= N) -> ((SMALL N) = (FAST N)))).
Admitted.
End A24170.