...
(** Bounty 1 PFG TMQbfj12FNbgQXp9643wqBo2tPQnMrYfVSg **)
Section A34911.
...
Hypothesis H1: (forall X :e int, (forall Y :e int, ((F1 X Y) = (1 + (2 * (X * Y)))))).
Hypothesis H2: (G1 = 2).
...
Theorem A34911: (forall N :e int, ((0 <= N) -> ((SMALL N) = (FAST N)))).
Admitted.
End A34911.