...
(** Bounty 1 PFG TMXsc36Q4mp6cPWPdfec5h8ex8eVNEEBFHy **)
Section A16263.
...
Hypothesis H22: (forall X :e int, (forall Y :e int, ((F4 X Y) = ((2 * (2 * ((X + X) + X))) + Y)))).
Hypothesis H23: (forall X :e int, (forall Y :e int, ((G4 X Y) = (1 + ((2 * (((Y + Y) + Y) + Y)) + Y))))).
...
Theorem A16263: (forall N :e int, ((0 <= N) -> ((SMALL N) = (FAST N)))).
Admitted.
End A16263.