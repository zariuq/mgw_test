...
(** Bounty 1 PFG TMPbbeWPh6ZTKDNGKjnoYUNfmgPsvPDL2sa **)
Section A74557.
...
Hypothesis H38: (forall X :e int, ((FAST X) = ((V3 X) + (W5 X)))).
Theorem A74557: (forall N :e int, ((0 <= N) -> ((SMALL N) = (FAST N)))).
Admitted.
End A74557.