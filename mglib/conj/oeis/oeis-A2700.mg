...
(** Bounty 1 PFG TMZXVvfQoHA1MYkpqcTUGXKqjEhub5PanHG **)
Section A2700.
...
Hypothesis H6: (forall X :e int, ((SMALL X) = ((1 + (2 + (X + X))) * (V0 X)))).
...
Hypothesis H17: (forall X :e int, ((FAST X) = ((1 + (2 + (X + X))) * ((1 + X) * (V1 X))))).
Theorem A2700: (forall N :e int, ((0 <= N) -> ((SMALL N) = (FAST N)))).
Admitted.
End A2700.