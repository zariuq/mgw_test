...
(** Bounty 1 PFG TMTCRkmvHFmSaQHeFomhHY5vNDZ63qFkkS7 **)
Section A198797.
...
Hypothesis H6: (forall X :e int, ((SMALL X) = ((2 * (V0 X)) + - 1))).
...
Hypothesis H15: (forall X :e int, ((FAST X) = ((2 * (W1 X)) + - 1))).
Theorem A198797: (forall N :e int, ((0 <= N) -> ((SMALL N) = (FAST N)))).
Admitted.
End A198797.