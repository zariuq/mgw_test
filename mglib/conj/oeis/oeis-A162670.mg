...
(** Bounty 1 PFG TMbeA4y5av8sUbQUskQDtHX4jMSiGi6FTTG **)
Section A162670.
...
Hypothesis H20: (forall X :e int, (forall Y :e int, ((F2 X Y) = ((V3 * Y) + X)))).
...
Theorem A162670: (forall N :e int, ((0 <= N) -> ((SMALL N) = (FAST N)))).
Admitted.
End A162670.