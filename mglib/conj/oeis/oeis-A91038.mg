...
(** Bounty 1 PFG TMNM4u6sxAcZ9dptWUceFgrNsg4h6kSZV9o **)
Section A91038.
...
Hypothesis H8: (forall X :e int, ((F2 X) = (1 + (2 * ((X + X) + X))))).
...
Hypothesis H13: (forall X :e int, ((H0 X) = (V2 X))).
...
Hypothesis H17: (forall X :e int, ((F3 X) = ((X * X) * X))).
Hypothesis H18: (G3 = 1).
...
Hypothesis H27: (forall X :e int, (forall Y :e int, ((F5 X Y) = (X * Y)))).
Hypothesis H28: (forall X :e int, (forall Y :e int, ((G5 X Y) = Y))).
Hypothesis H29: (forall X :e int, ((H5 X) = X)).
Hypothesis H30: (I5 = 1).
Hypothesis H31: (J5 = ((2 * (2 * (2 + 2))) + - 1)).
Hypothesis H32: (forall X :e int, (forall Y :e int, (forall Z :e int, ((U5 X Y Z) = (if (X <= 0) then Y else (F5 (U5 (X + - 1) Y Z) (V5 (X + - 1) Y Z))))))).
Hypothesis H33: (forall X :e int, (forall Y :e int, (forall Z :e int, ((V5 X Y Z) = (if (X <= 0) then Z else (G5 (U5 (X + - 1) Y Z) (V5 (X + - 1) Y Z))))))).
Hypothesis H34: (forall X :e int, ((W5 X) = (U5 (H5 X) I5 J5))).
Hypothesis H35: (forall X :e int, ((F6 X) = (1 + (2 * ((X + X) + X))))).
Hypothesis H36: (forall X :e int, ((G6 X) = X)).
Hypothesis H37: (H6 = 1).
Hypothesis H38: (forall X :e int, (forall Y :e int, ((U6 X Y) = (if (X <= 0) then Y else (F6 (U6 (X + - 1) Y)))))).
Hypothesis H39: (forall X :e int, ((V6 X) = (U6 (G6 X) H6))).
Hypothesis H40: (forall X :e int, ((FAST X) = (((V3 X) * (W5 X)) * (V6 X)))).
Theorem A91038: (forall N :e int, ((0 <= N) -> ((SMALL N) = (FAST N)))).
Admitted.
End A91038.