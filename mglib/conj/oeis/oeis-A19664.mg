...
(** Bounty 1 PFG TMLvy44y73XMwpxxMSEKQFdNYNmVKPR5EBj **)
Section A19664.
...
Hypothesis H1: (forall X :e int, (forall Y :e int, ((F1 X Y) = (((Y + - 1) + Y) * (Y * Y))))).
...
Hypothesis H20: (forall X :e int, ((F5 X) = (((X + - 1) + X) * (X * X)))).
Hypothesis H21: (G5 = 1).
...
Hypothesis H27: (forall X :e int, ((H5 X) = (V6 X))).
Hypothesis H28: (forall X :e int, (forall Y :e int, ((U5 X Y) = (if (X <= 0) then Y else (F5 (U5 (X + - 1) Y)))))).
Hypothesis H29: (forall X :e int, ((V5 X) = (U5 G5 (H5 X)))).
Hypothesis H30: (forall X :e int, ((F4 X) = (V5 X))).
Hypothesis H31: (G4 = 1).
...
Hypothesis H35: (forall X :e int, (forall Y :e int, ((F3 X Y) = (((V4 X Y) + X) + (((X + X) * 2) * 2))))).
...
Theorem A19664: (forall N :e int, ((0 <= N) -> ((SMALL N) = (FAST N)))).
Admitted.
End A19664.