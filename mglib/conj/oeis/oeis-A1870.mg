...
(** Bounty 1 PFG TMbsEBeLt1etfv2LoQAeuvPnUKjkR2UeeQY **)
Section A1870.
...
Hypothesis H15: (forall X :e int, (forall Y :e int, ((F3 X Y) = (((X + - Y) + X) + X)))).
...
Theorem A1870: (forall N :e int, ((0 <= N) -> ((SMALL N) = (FAST N)))).
Admitted.
End A1870.