...
(** Bounty 1 PFG TMZPZD2uHfDvwc6whoqjeTdZiuCFfRqBQrx **)
Section A256832.
...
Hypothesis H25: (forall X :e int, ((H2 X) = (if (X <= 0) then 1 else 2))).
...
Theorem A256832: (forall N :e int, ((0 <= N) -> ((SMALL N) = (FAST N)))).
Admitted.
End A256832.