...
(** Bounty 1 PFG TMZ8nJxGxAm23iWMXEYdfJ9mCPeXWGJfDky **)
Section A74542.
...
Hypothesis H3: (forall X :e int, ((F1 X) = ((X + X) + X))).
...
Hypothesis H8: (forall X :e int, ((F2 X) = (2 * (X + X)))).
...
Hypothesis H13: (forall X :e int, ((H0 X) = (1 + ((V1 X) + (V2 X))))).
...
Theorem A74542: (forall N :e int, ((0 <= N) -> ((SMALL N) = (FAST N)))).
Admitted.
End A74542.