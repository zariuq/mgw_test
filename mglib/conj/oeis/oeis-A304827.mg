...
(** Bounty 1 PFG TMT2FvDPoN3XLzdtQQ49s2WkdkkD6Ezwbti **)
Section A304827.
...
Hypothesis H15: (forall X :e int, ((FAST X) = (((2 * (W1 X)) + - 1) * (2 + 2)))).
Theorem A304827: (forall N :e int, ((0 <= N) -> ((SMALL N) = (FAST N)))).
Admitted.
End A304827.