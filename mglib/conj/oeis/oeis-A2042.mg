...
(** Bounty 1 PFG TMUprizfRXVzbVYdXDNHzrXFHwrR4zim2Hy **)
Section A2042.
...
Hypothesis H17: (forall X :e int, ((FAST X) = ((1 + (2 + (2 + 2))) * (V1 X)))).
Theorem A2042: (forall N :e int, ((0 <= N) -> ((SMALL N) = (FAST N)))).
Admitted.
End A2042.