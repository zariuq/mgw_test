...
(** Bounty 1 PFG TMY495E52ceuBMKGDb8YZuhEKcYBpR9no2q **)
Section A282901.
...
Hypothesis H2: (forall X :e int, (forall Y :e int, ((G0 X Y) = (((X + Y) + Y) + Y)))).
Hypothesis H3: (forall X :e int, ((H0 X) = X)).
Hypothesis H4: (forall X :e int, ((I0 X) = (if (X <= 0) then 1 else 2))).
...
Hypothesis H10: (forall X :e int, (forall Y :e int, ((F1 X Y) = (2 * ((X + - Y) + X))))).
...
Theorem A282901: (forall N :e int, ((0 <= N) -> ((SMALL N) = (FAST N)))).
Admitted.
End A282901.