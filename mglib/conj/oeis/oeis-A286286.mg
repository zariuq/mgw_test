...
(** Bounty 1 PFG TMRbxgtJq8Qxo1niJ4mNY3AMQCJCRRaShaX **)
Section A286286.
...
Hypothesis H10: (forall X :e int, ((I1 X) = (if (X <= 0) then 0 else 1))).
...
Theorem A286286: (forall N :e int, ((0 <= N) -> ((SMALL N) = (FAST N)))).
Admitted.
End A286286.