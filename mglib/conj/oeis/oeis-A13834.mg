...
(** Bounty 1 PFG TMLcADbTgv3zMtb1KFTvgiWi97vZRdybmgi **)
Section A13834.
...
Hypothesis H2: (forall X :e int, ((G0 X) = (1 + ((2 * (X + X)) + X)))).
Hypothesis H3: (H0 = 1).
...
Hypothesis H7: (forall X :e int, ((F1 X) = ((((X * X) * ((2 * 2) + 1)) * X) * (X * X)))).
Hypothesis H8: (G1 = 1).
Hypothesis H9: (forall X :e int, ((F2 X) = ((2 * (X + X)) + X))).
...
Theorem A13834: (forall N :e int, ((0 <= N) -> ((SMALL N) = (FAST N)))).
Admitted.
End A13834.