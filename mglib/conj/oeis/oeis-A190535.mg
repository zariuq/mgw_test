...
(** Bounty 1 PFG TMQo3bDcsnwh5iU9Ng3zE65ia5SNHCVpuqj **)
Section A190535.
...
Hypothesis H8: (forall X :e int, (forall Y :e int, ((W1 X Y) = (U1 (H1 X Y) (I1 X) (J1 X))))).
Hypothesis H9: (forall X :e int, (forall Y :e int, ((F0 X Y) = ((W1 X Y) + - X)))).
Hypothesis H10: (forall X :e int, ((G0 X) = (2 + X))).
Hypothesis H11: (H0 = 2).
...
Hypothesis H24: (forall X :e int, ((G2 X) = (2 + X))).
Hypothesis H25: (H2 = 2).
...
Theorem A190535: (forall N :e int, ((0 <= N) -> ((SMALL N) = (FAST N)))).
Admitted.
End A190535.