...
(** Bounty 1 PFG TMWMTCqifLBGGFGYPTSrevhBX1kKuyVDEB9 **)
Section A24139.
...
Hypothesis H12: (G2 = 2).
Hypothesis H13: (forall X :e int, ((H2 X) = ((X * X) * X))).
...
Hypothesis H26: (G4 = 2).
Hypothesis H27: (forall X :e int, ((H4 X) = ((X * X) * X))).
...
Theorem A24139: (forall N :e int, ((0 <= N) -> ((SMALL N) = (FAST N)))).
Admitted.
End A24139.