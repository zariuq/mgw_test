...
(** Bounty 1 PFG TMVb6r4N2kzbtTNCCBCb6oEFPemSDBnHC3C **)
Section A13792.
...
Hypothesis H2: (forall X :e int, ((G0 X) = (1 + (2 * (X + X))))).
Hypothesis H3: (H0 = 1).
...
Hypothesis H33: (forall X :e int, ((FAST X) = (((V1 X) * (2 + (2 * (2 + 2)))) * (V3 X)))).
Theorem A13792: (forall N :e int, ((0 <= N) -> ((SMALL N) = (FAST N)))).
Admitted.
End A13792.