...
(** Bounty 1 PFG TMVcfR1MHnErhEEqiEh5ECm4azo5gPYiZui **)
Section A289945.
...
Hypothesis H2: (G2 = 2).
Hypothesis H3: (forall X :e int, (forall Y :e int, ((H2 X Y) = (1 + Y)))).
...
Hypothesis H18: (G4 = 2).
Hypothesis H19: (forall X :e int, (forall Y :e int, ((F5 X Y) = (X * Y)))).
Hypothesis H20: (forall X :e int, (forall Y :e int, ((G5 X Y) = Y))).
Hypothesis H21: (forall X :e int, (forall Y :e int, ((H5 X Y) = (1 + Y)))).
Hypothesis H22: (forall X :e int, (forall Y :e int, ((U5 X Y) = (if (X <= 0) then Y else (F5 (U5 (X + - 1) Y) X))))).
Hypothesis H23: (forall X :e int, (forall Y :e int, ((V5 X Y) = (U5 (G5 X Y) (H5 X Y))))).
Hypothesis H24: (forall X :e int, (forall Y :e int, ((H4 X Y) = (V5 X Y)))).
Hypothesis H25: (forall X :e int, (forall Y :e int, ((U4 X Y) = (if (X <= 0) then Y else (F4 (U4 (X + - 1) Y)))))).
Hypothesis H26: (forall X :e int, (forall Y :e int, ((V4 X Y) = (U4 G4 (H4 X Y))))).
...
Theorem A289945: (forall N :e int, ((0 <= N) -> ((SMALL N) = (FAST N)))).
Admitted.
End A289945.