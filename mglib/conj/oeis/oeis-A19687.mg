...
(** Bounty 1 PFG TMaq4TSDy7v3p82NCytCFsLAEoQdpG5Wmr1 **)
Section A19687.
...
Hypothesis H22: (forall X :e int, (forall Y :e int, ((F6 X Y) = ((2 * (X + X)) + (Y * Y))))).
...
Theorem A19687: (forall N :e int, ((0 <= N) -> ((SMALL N) = (FAST N)))).
Admitted.
End A19687.