...
(** Bounty 1 PFG TMdhpBHYa6ZsoNvr6C3Z95wuPULhg7XSNhJ **)
Section A13806.
...
Hypothesis H38: (forall X :e int, ((H4 X) = (W5 X))).
Hypothesis H39: (forall X :e int, (forall Y :e int, ((U4 X Y) = (if (X <= 0) then Y else (F4 (U4 (X + - 1) Y)))))).
Hypothesis H40: (forall X :e int, ((V4 X) = (U4 G4 (H4 X)))).
Hypothesis H41: (forall X :e int, ((FAST X) = (((W2 X) * (W3 X)) * (V4 X)))).
Theorem A13806: (forall N :e int, ((0 <= N) -> ((SMALL N) = (FAST N)))).
Admitted.
End A13806.