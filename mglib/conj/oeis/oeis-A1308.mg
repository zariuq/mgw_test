...
(** Bounty 1 PFG TMVWJtDgir5qMRBJ8nSkwkan3XmJFmfYAMJ **)
Section A1308.
...
Hypothesis H1: (forall X :e int, (forall Y :e int, ((F0 X Y) = (((2 * (X * Y)) + - X) * (((1 + Y) * Y) * Y))))).
...
Theorem A1308: (forall N :e int, ((0 <= N) -> ((SMALL N) = (FAST N)))).
Admitted.
End A1308.