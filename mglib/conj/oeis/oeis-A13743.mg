...
(** Bounty 1 PFG TMFNuY7j13438xeKRJ33MtAj4yKc4h4ATsK **)
Section A13743.
...
Hypothesis H2: (forall X :e int, (forall Y :e int, ((F1 X Y) = (((X + X) + X) + Y)))).
Hypothesis H3: (G1 = 2).
...
Hypothesis H22: (forall X :e int, ((F4 X) = ((X * X) * (2 * ((X * X) * X))))).
Hypothesis H23: (G4 = 1).
...
Hypothesis H32: (forall X :e int, ((FAST X) = ((V2 X) * (V4 X)))).
Theorem A13743: (forall N :e int, ((0 <= N) -> ((SMALL N) = (FAST N)))).
Admitted.
End A13743.