...
(** Bounty 1 PFG TMcGrNB1trT3hQMCcx2bJC7Ssi7HVbQf5tP **)
Section A268839.
...
Hypothesis H6: (forall X :e int, ((F0 X) = (((V1 X) + - 1) + - X))).
...
Hypothesis H11: (forall X :e int, ((SMALL X) = ((V0 X) + - 1))).
...
Hypothesis H20: (forall X :e int, ((FAST X) = ((1 + (2 * (2 + 2))) * (W2 X)))).
Theorem A268839: (forall N :e int, ((0 <= N) -> ((SMALL N) = (FAST N)))).
Admitted.
End A268839.