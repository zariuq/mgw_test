...
(** Bounty 1 PFG TMcTLukZR1V5yw7QDXp7EP4NEg4PKa3viP8 **)
Section A20572.
...
Hypothesis H6: (forall X :e int, (forall Y :e int, ((F1 X Y) = ((V2 X Y) + (2 * ((2 * (X + X)) + X)))))).
...
Hypothesis H17: (forall X :e int, (forall Y :e int, ((F5 X Y) = (((2 * (X + X)) + X) + Y)))).
...
Hypothesis H30: (forall X :e int, ((F4 X) = ((W5 X) * (V6 X)))).
Hypothesis H31: (G4 = 1).
...
Hypothesis H35: (forall X :e int, (forall Y :e int, ((F3 X Y) = (((V4 X Y) + (2 * ((X + X) + X))) + X)))).
...
Theorem A20572: (forall N :e int, ((0 <= N) -> ((SMALL N) = (FAST N)))).
Admitted.
End A20572.