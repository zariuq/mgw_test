...
(** Bounty 1 PFG TMR31NnbmtWQ9VNvwp2JDHjbts9NnqoqAwJ **)
Section A20579.
...
Hypothesis H11: (forall X :e int, (forall Y :e int, ((F0 X Y) = ((V1 X Y) + (2 * (2 * (X + X))))))).
...
Hypothesis H18: (forall X :e int, (forall Y :e int, ((G5 X Y) = Y))).
Hypothesis H19: (forall X :e int, ((H5 X) = (1 + X))).
Hypothesis H20: (I5 = 1).
Hypothesis H21: (J5 = (1 + (2 * (2 + 2)))).
...
Hypothesis H25: (forall X :e int, ((F6 X) = ((X * X) * X))).
Hypothesis H26: (G6 = 1).
...
Hypothesis H32: (forall X :e int, ((H6 X) = (V7 X))).
Hypothesis H33: (forall X :e int, (forall Y :e int, ((U6 X Y) = (if (X <= 0) then Y else (F6 (U6 (X + - 1) Y)))))).
Hypothesis H34: (forall X :e int, ((V6 X) = (U6 G6 (H6 X)))).
Hypothesis H35: (forall X :e int, ((F4 X) = ((W5 X) + - (V6 X)))).
Hypothesis H36: (G4 = 1).
Hypothesis H37: (forall X :e int, (forall Y :e int, ((H4 X Y) = Y))).
Hypothesis H38: (forall X :e int, (forall Y :e int, ((U4 X Y) = (if (X <= 0) then Y else (F4 (U4 (X + - 1) Y)))))).
Hypothesis H39: (forall X :e int, (forall Y :e int, ((V4 X Y) = (U4 G4 (H4 X Y))))).
Hypothesis H40: (forall X :e int, (forall Y :e int, ((F3 X Y) = (((((((V4 X Y) + X) + X) + X) + X) + X) + X)))).
...
Theorem A20579: (forall N :e int, ((0 <= N) -> ((SMALL N) = (FAST N)))).
Admitted.
End A20579.