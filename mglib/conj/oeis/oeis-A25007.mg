...
(** Bounty 1 PFG TMLmETAFd5Eu1FbLmr82YgirNshK9txZLXT **)
Section A25007.
...
Hypothesis H1: (forall X :e int, ((F2 X) = (1 + (2 * ((2 * (X + X)) + X))))).
...
Hypothesis H11: (forall X :e int, (forall Y :e int, ((F3 X Y) = ((2 + Y) * X)))).
Hypothesis H12: (G3 = 2).
...
Hypothesis H16: (forall X :e int, (forall Y :e int, ((F0 X Y) = ((V1 X Y) + (V3 X))))).
...
Hypothesis H23: (forall X :e int, (forall Y :e int, ((G6 X Y) = (1 + (2 * (2 * (Y + Y))))))).
Hypothesis H24: (forall X :e int, ((H6 X) = X)).
Hypothesis H25: (I6 = 1).
Hypothesis H26: (J6 = (1 + (2 * (2 + 2)))).
...
Hypothesis H35: (forall X :e int, (forall Y :e int, ((F7 X Y) = ((2 + Y) * X)))).
Hypothesis H36: (G7 = 2).
Hypothesis H37: (forall X :e int, ((H7 X) = X)).
Hypothesis H38: (forall X :e int, (forall Y :e int, ((U7 X Y) = (if (X <= 0) then Y else (F7 (U7 (X + - 1) Y) X))))).
Hypothesis H39: (forall X :e int, ((V7 X) = (U7 G7 (H7 X)))).
Hypothesis H40: (forall X :e int, (forall Y :e int, ((F4 X Y) = ((V5 X Y) + (V7 X))))).
...
Theorem A25007: (forall N :e int, ((0 <= N) -> ((SMALL N) = (FAST N)))).
Admitted.
End A25007.