...
(** Bounty 1 PFG TMbQ5C8QXXFoLEFWGtBus4qBcs7if6t4KNf **)
Section A6625.
...
Hypothesis H1: (forall X :e int, (forall Y :e int, ((F0 X Y) = (1 + (X + Y))))).
Hypothesis H2: (forall X :e int, ((G0 X) = ((2 + X) + 2))).
Hypothesis H3: (forall X :e int, ((H0 X) = (if (X <= 0) then 0 else 1))).
...
Hypothesis H9: (forall X :e int, ((H1 X) = ((2 + X) * (1 + (2 + (2 + 2)))))).
...
Theorem A6625: (forall N :e int, ((0 <= N) -> ((SMALL N) = (FAST N)))).
Admitted.
End A6625.