...
(** Bounty 1 PFG TMGpbcuxEgSvEeTNzCXciKjYgrZoo3Q9nk5 **)
Section A13824.
...
Hypothesis H8: (G2 = 1).
Hypothesis H9: (forall X :e int, ((H2 X) = (2 * (X * X)))).
...
Hypothesis H12: (forall X :e int, ((F1 X) = ((2 * (V2 X)) * X))).
Hypothesis H13: (G1 = 1).
...
Hypothesis H19: (forall X :e int, ((H1 X) = (V3 X))).
...
Theorem A13824: (forall N :e int, ((0 <= N) -> ((SMALL N) = (FAST N)))).
Admitted.
End A13824.