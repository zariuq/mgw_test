...
(** Bounty 1 PFG TMSq6XqbiVq5wCypodRpfRtH4WDTkKZywEu **)
Section A20527.
...
Hypothesis H8: (forall X :e int, ((H0 X) = ((V1 X) + - 2))).
...
Hypothesis H22: (forall X :e int, ((FAST X) = (1 + (2 * ((1 + 2) * (V2 X)))))).
Theorem A20527: (forall N :e int, ((0 <= N) -> ((SMALL N) = (FAST N)))).
Admitted.
End A20527.