...
(** Bounty 1 PFG TMJ8sia2Girz7KbRZzQm9WkmzSQthm7mAtA **)
Section A42625.
...
Hypothesis H1: (forall X :e int, (forall Y :e int, ((F1 X Y) = (((X * X) + X) + Y)))).
Hypothesis H2: (G1 = 2).
Hypothesis H3: (H1 = 2).
...
Theorem A42625: (forall N :e int, ((0 <= N) -> ((SMALL N) = (FAST N)))).
Admitted.
End A42625.