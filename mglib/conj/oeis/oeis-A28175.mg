...
(** Bounty 1 PFG TMUQuMhSG7UqAtPbBphuBG1rXyaBUABPYSB **)
Section A28175.
...
Hypothesis H11: (forall X :e int, (forall Y :e int, ((F2 X Y) = ((V3 X Y) + ((V4 X) + - X))))).
...
Hypothesis H35: (forall X :e int, (forall Y :e int, ((F10 X Y) = (X * Y)))).
Hypothesis H36: (forall X :e int, (forall Y :e int, ((G10 X Y) = Y))).
Hypothesis H37: (forall X :e int, ((H10 X) = X)).
Hypothesis H38: (I10 = 1).
Hypothesis H39: (J10 = (1 + 2)).
Hypothesis H40: (forall X :e int, (forall Y :e int, (forall Z :e int, ((U10 X Y Z) = (if (X <= 0) then Y else (F10 (U10 (X + - 1) Y Z) (V10 (X + - 1) Y Z))))))).
Hypothesis H41: (forall X :e int, (forall Y :e int, (forall Z :e int, ((V10 X Y Z) = (if (X <= 0) then Z else (G10 (U10 (X + - 1) Y Z) (V10 (X + - 1) Y Z))))))).
Hypothesis H42: (forall X :e int, ((W10 X) = (U10 (H10 X) I10 J10))).
Hypothesis H43: (forall X :e int, ((F8 X) = ((W9 X) * (W10 X)))).
Hypothesis H44: (G8 = 1).
Hypothesis H45: (forall X :e int, (forall Y :e int, ((H8 X Y) = Y))).
Hypothesis H46: (forall X :e int, (forall Y :e int, ((U8 X Y) = (if (X <= 0) then Y else (F8 (U8 (X + - 1) Y)))))).
Hypothesis H47: (forall X :e int, (forall Y :e int, ((V8 X Y) = (U8 G8 (H8 X Y))))).
Hypothesis H48: (forall X :e int, (forall Y :e int, ((F7 X Y) = (((V8 X Y) + (2 * (X + X))) + X)))).
Hypothesis H49: (forall X :e int, ((G7 X) = X)).
Hypothesis H50: (H7 = 1).
Hypothesis H51: (forall X :e int, (forall Y :e int, ((U7 X Y) = (if (X <= 0) then Y else (F7 (U7 (X + - 1) Y) X))))).
Hypothesis H52: (forall X :e int, ((V7 X) = (U7 (G7 X) H7))).
Hypothesis H53: (forall X :e int, ((F6 X) = (V7 X))).
Hypothesis H54: (G6 = 1).
Hypothesis H55: (forall X :e int, (forall Y :e int, ((H6 X Y) = Y))).
Hypothesis H56: (forall X :e int, (forall Y :e int, ((U6 X Y) = (if (X <= 0) then Y else (F6 (U6 (X + - 1) Y)))))).
Hypothesis H57: (forall X :e int, (forall Y :e int, ((V6 X Y) = (U6 G6 (H6 X Y))))).
Hypothesis H58: (forall X :e int, (forall Y :e int, ((F5 X Y) = (((V6 X Y) + (2 * ((2 * (X + X)) + X))) + X)))).
Hypothesis H59: (forall X :e int, ((G5 X) = X)).
Hypothesis H60: (H5 = 1).
Hypothesis H61: (forall X :e int, (forall Y :e int, ((U5 X Y) = (if (X <= 0) then Y else (F5 (U5 (X + - 1) Y) X))))).
Hypothesis H62: (forall X :e int, ((V5 X) = (U5 (G5 X) H5))).
Hypothesis H63: (forall X :e int, ((FAST X) = (V5 X))).
Theorem A28175: (forall N :e int, ((0 <= N) -> ((SMALL N) = (FAST N)))).
Admitted.
End A28175.