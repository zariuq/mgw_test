...
(** Bounty 1 PFG TMTK8rDd71Fe53pDNEYmeqqM4ALp5t5k52z **)
Section A28147.
...
Hypothesis H20: (forall X :e int, (forall Y :e int, ((F4 X Y) = (((((Y + - 1) + Y) * (Y * Y)) + X) + (2 * ((X + X) + X)))))).
...
Theorem A28147: (forall N :e int, ((0 <= N) -> ((SMALL N) = (FAST N)))).
Admitted.
End A28147.