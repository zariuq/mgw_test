...
(** Bounty 1 PFG TMFr8x4vyT9nYMu1pGj1xGGp6mXfbg96JYc **)
Section A262787.
...
Hypothesis H15: (I2 = 1).
Hypothesis H16: (J2 = (1 + (2 * (2 * (2 + (2 * (2 + 2))))))).
...
Hypothesis H23: (I3 = 1).
Hypothesis H24: (J3 = (1 + (2 * (2 * (2 + (2 * (2 + 2))))))).
...
Theorem A262787: (forall N :e int, ((0 <= N) -> ((SMALL N) = (FAST N)))).
Admitted.
End A262787.