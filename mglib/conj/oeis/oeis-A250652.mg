...
(** Bounty 1 PFG TMd5fmDJEhpDRxsaLYDMF1nb2XKk5jMJp92 **)
Section A250652.
...
Hypothesis H3: (forall X :e int, ((H0 X) = (2 + (2 + X)))).
...
Hypothesis H6: (forall X :e int, ((SMALL X) = (((V0 X) * (2 + X)) + 1))).
Hypothesis H7: (forall X :e int, ((F1 X) = (X + X))).
Hypothesis H8: (forall X :e int, ((G1 X) = X)).
Hypothesis H9: (forall X :e int, ((H1 X) = (1 + (2 + (2 + X))))).
...
Hypothesis H12: (forall X :e int, ((FAST X) = ((((V1 X) + - 1) * (2 + X)) + 1))).
Theorem A250652: (forall N :e int, ((0 <= N) -> ((SMALL N) = (FAST N)))).
Admitted.
End A250652.