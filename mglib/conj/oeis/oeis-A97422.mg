...
(** Bounty 1 PFG TMapzYLEhUvSorQF81UFERAdG5hLVuxhni4 **)
Section A97422.
...
Hypothesis H6: (forall X :e int, (forall Y :e int, ((F1 X Y) = ((X * Y) + (V2 X Y))))).
...
Hypothesis H22: (forall X :e int, (forall Y :e int, ((F4 X Y) = ((X * Y) + (V5 X Y))))).
...
Hypothesis H27: (forall X :e int, (forall Y :e int, ((F3 X Y) = (((V4 X Y) * Y) + X)))).
...
Hypothesis H37: (forall X :e int, ((FAST X) = ((V3 X) + - (V6 X)))).
Theorem A97422: (forall N :e int, ((0 <= N) -> ((SMALL N) = (FAST N)))).
Admitted.
End A97422.