...
(** Bounty 1 PFG TMR5Y16qwaeEioyRLUa2wvDmQx5wZkKhYzi **)
Section A196666.
...
Hypothesis H1: (forall X :e int, (forall Y :e int, ((F0 X Y) = (((2 * ((2 * (2 + Y)) + Y)) + Y) * X)))).
Hypothesis H2: (G0 = 2).
...
Hypothesis H13: (forall X :e int, ((I1 X) = (if (X <= 0) then 1 else ((2 * (2 * (2 + 2))) + - 1)))).
Hypothesis H14: (J1 = (1 + (2 + (2 * (2 + 2))))).
...
Hypothesis H19: (forall X :e int, ((G2 X) = (X + - 1))).
Hypothesis H20: (H2 = 1).
...
Theorem A196666: (forall N :e int, ((0 <= N) -> ((SMALL N) = (FAST N)))).
Admitted.
End A196666.