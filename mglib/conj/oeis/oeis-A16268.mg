...
(** Bounty 1 PFG TMK6Z3R2ugGUwYjRpFtoqvLhLrjm3HZpqiH **)
Section A16268.
...
Hypothesis H30: (forall X :e int, (forall Y :e int, ((F4 X Y) = (((W5 X Y) + (2 * ((2 * (X + X)) + X))) + X)))).
...
Theorem A16268: (forall N :e int, ((0 <= N) -> ((SMALL N) = (FAST N)))).
Admitted.
End A16268.