...
(** Bounty 1 PFG TMPxzHggMXZ1axpWQsDeFkzCEHau3zBDsz3 **)
Section A195615.
...
Hypothesis H10: (forall X :e int, ((G0 X) = ((1 + 2) * (1 + X)))).
Hypothesis H11: (H0 = 1).
...
Hypothesis H17: (forall X :e int, ((H2 X) = (2 + ((X + X) + X)))).
Hypothesis H18: (I2 = 2).
Hypothesis H19: (J2 = 1).
...
Theorem A195615: (forall N :e int, ((0 <= N) -> ((SMALL N) = (FAST N)))).
Admitted.
End A195615.