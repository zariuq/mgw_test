...
(** Bounty 1 PFG TMUGCZ7AQq42STBeyvKjSEBR737vupmHhiY **)
Section A253826.
...
Hypothesis H1: (forall X :e int, (forall Y :e int, ((F1 X Y) = ((Y + - X) + - X)))).
Hypothesis H2: (forall X :e int, ((G1 X) = X)).
Hypothesis H3: (forall X :e int, (forall Y :e int, ((H1 X Y) = (2 * (Y + Y))))).
Hypothesis H4: (I1 = 1).
Hypothesis H5: (J1 = 1).
...
Hypothesis H15: (forall X :e int, (forall Y :e int, ((F2 X Y) = ((2 * ((X + X) + X)) + - Y)))).
Hypothesis H16: (forall X :e int, ((G2 X) = X)).
Hypothesis H17: (forall X :e int, ((H2 X) = (X + - 1))).
Hypothesis H18: (forall X :e int, ((I2 X) = ((if (X <= 0) then 0 else 2) + 1))).
Hypothesis H19: (J2 = 1).
...
Hypothesis H23: (forall X :e int, (forall Y :e int, ((F3 X Y) = ((2 * ((X + X) + X)) + - Y)))).
...
Theorem A253826: (forall N :e int, ((0 <= N) -> ((SMALL N) = (FAST N)))).
Admitted.
End A253826.