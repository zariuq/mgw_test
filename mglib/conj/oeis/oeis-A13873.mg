...
(** Bounty 1 PFG TMVAy7zFV4zkRgVkPmvtEbpPb39w5MMhqQJ **)
Section A13873.
...
Hypothesis H7: (forall X :e int, ((G0 X) = ((2 * (2 + (X + X))) + X))).
Hypothesis H8: (H0 = 1).
...
Hypothesis H29: (forall X :e int, ((H5 X) = (2 + X))).
Hypothesis H30: (I5 = 1).
Hypothesis H31: (J5 = (2 + (2 * (2 + (2 + 2))))).
...
Theorem A13873: (forall N :e int, ((0 <= N) -> ((SMALL N) = (FAST N)))).
Admitted.
End A13873.