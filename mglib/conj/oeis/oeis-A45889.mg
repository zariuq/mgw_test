...
(** Bounty 1 PFG TMYfcLBoUdn6MvC2vkkTQUScxS4owBTC9g9 **)
Section A45889.
...
Hypothesis H1: (forall X :e int, ((F2 X) = ((X + - 1) + X))).
...
Hypothesis H5: (forall X :e int, (forall Y :e int, ((V2 X Y) = (U2 (G2 X Y) (H2 X Y))))).
...
Hypothesis H17: (forall X :e int, ((F5 X) = (X + X))).
Hypothesis H18: (forall X :e int, ((G5 X) = X)).
Hypothesis H19: (H5 = 2).
Hypothesis H20: (forall X :e int, (forall Y :e int, ((U5 X Y) = (if (X <= 0) then Y else (F5 (U5 (X + - 1) Y)))))).
Hypothesis H21: (forall X :e int, ((V5 X) = (U5 (G5 X) H5))).
Hypothesis H22: (forall X :e int, ((F4 X) = ((((((X + - 1) * (V5 X)) + 2) * 2) + 1) + X))).
Hypothesis H23: (G4 = 1).
Hypothesis H24: (forall X :e int, (forall Y :e int, ((H4 X Y) = Y))).
...
Theorem A45889: (forall N :e int, ((0 <= N) -> ((SMALL N) = (FAST N)))).
Admitted.
End A45889.