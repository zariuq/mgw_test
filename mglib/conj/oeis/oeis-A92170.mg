...
(** Bounty 1 PFG TMLCKW1uXMhS8KKcAyRe5XbSATuWEUG3A79 **)
Section A92170.
...
Hypothesis H13: (G3 = 1).
Hypothesis H14: (forall X :e int, (forall Y :e int, ((F4 X Y) = (X * Y)))).
Hypothesis H15: (forall X :e int, (forall Y :e int, ((G4 X Y) = Y))).
Hypothesis H16: (forall X :e int, (forall Y :e int, ((H4 X Y) = (1 + Y)))).
Hypothesis H17: (forall X :e int, (forall Y :e int, ((U4 X Y) = (if (X <= 0) then Y else (F4 (U4 (X + - 1) Y) X))))).
Hypothesis H18: (forall X :e int, (forall Y :e int, ((V4 X Y) = (U4 (G4 X Y) (H4 X Y))))).
Hypothesis H19: (forall X :e int, (forall Y :e int, ((H3 X Y) = (V4 X Y)))).
Hypothesis H20: (forall X :e int, (forall Y :e int, ((U3 X Y) = (if (X <= 0) then Y else (F3 (U3 (X + - 1) Y)))))).
Hypothesis H21: (forall X :e int, (forall Y :e int, ((V3 X Y) = (U3 G3 (H3 X Y))))).
Hypothesis H22: (forall X :e int, (forall Y :e int, ((F2 X Y) = ((V3 X Y) + - X)))).
Hypothesis H23: (forall X :e int, ((G2 X) = X)).
Hypothesis H24: (H2 = 1).
Hypothesis H25: (forall X :e int, (forall Y :e int, ((U2 X Y) = (if (X <= 0) then Y else (F2 (U2 (X + - 1) Y) X))))).
Hypothesis H26: (forall X :e int, ((V2 X) = (U2 (G2 X) H2))).
Hypothesis H27: (forall X :e int, ((FAST X) = (V2 X))).
Theorem A92170: (forall N :e int, ((0 <= N) -> ((SMALL N) = (FAST N)))).
Admitted.
End A92170.