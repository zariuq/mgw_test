...
(** Bounty 1 PFG TMUxpu2CF3Xfurxn7JXdmGZn9Le2jwBJgGb **)
Section A70969.
...
Hypothesis H7: (forall X :e int, (forall Y :e int, ((F1 X Y) = ((X * Y) * X)))).
Hypothesis H8: (forall X :e int, (forall Y :e int, ((G1 X Y) = (Y + Y)))).
...
Hypothesis H20: (forall X :e int, ((FAST X) = (((W1 X) * (V2 X)) + 1))).
Theorem A70969: (forall N :e int, ((0 <= N) -> ((SMALL N) = (FAST N)))).
Admitted.
End A70969.