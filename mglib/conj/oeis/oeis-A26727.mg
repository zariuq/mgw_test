...
(** Bounty 1 PFG TMKksjvy5u3eGju1Z6y3s9K4Rv6vxcoxGFT **)
Section A26727.
...
Hypothesis H25: (forall X :e int, (forall Y :e int, ((F6 X Y) = ((2 * (X + X)) + Y)))).
Hypothesis H26: (forall X :e int, (forall Y :e int, ((G6 X Y) = (1 + ((Y + Y) + Y))))).
Hypothesis H27: (forall X :e int, ((H6 X) = X)).
Hypothesis H28: (I6 = 1).
Hypothesis H29: (J6 = (2 + 2)).
...
Theorem A26727: (forall N :e int, ((0 <= N) -> ((SMALL N) = (FAST N)))).
Admitted.
End A26727.