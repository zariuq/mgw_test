...
(** Bounty 1 PFG TMQYMy6Cd7KhsiDf4WWtW6t272YmZbJXg1w **)
Section A15013.
...
Hypothesis H13: (forall X :e int, (forall Y :e int, ((G2 X Y) = (1 + - (Y + Y))))).
...
Theorem A15013: (forall N :e int, ((0 <= N) -> ((SMALL N) = (FAST N)))).
Admitted.
End A15013.