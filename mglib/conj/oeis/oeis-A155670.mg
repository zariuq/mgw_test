...
(** Bounty 1 PFG TMPoaw2PJReNLus6qbEw3TsPFMKVY84YjGm **)
Section A155670.
...
Hypothesis H16: (forall X :e int, ((SMALL X) = (((V0 X) + - 1) + (V1 X)))).
...
Hypothesis H33: (forall X :e int, ((FAST X) = (((W3 X) + - 1) + (W4 X)))).
Theorem A155670: (forall N :e int, ((0 <= N) -> ((SMALL N) = (FAST N)))).
Admitted.
End A155670.