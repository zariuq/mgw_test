...
(** Bounty 1 PFG TMGHQ3K4NkUxL5V5jWNHLrNPZx1tbKRzg2J **)
Section A28221.
...
Hypothesis H50: (forall X :e int, (forall Y :e int, ((F7 X Y) = (((V8 X Y) + (2 * ((X + X) + X))) + X)))).
...
Theorem A28221: (forall N :e int, ((0 <= N) -> ((SMALL N) = (FAST N)))).
Admitted.
End A28221.