...
(** Bounty 1 PFG TMJeCNhP6CgCWrg4yMnpVxWvuzjuogucy99 **)
Section A302999.
...
Hypothesis H23: (forall X :e int, (forall Y :e int, ((F2 X Y) = (((W3 X Y) + - 1) * X)))).
...
Theorem A302999: (forall N :e int, ((0 <= N) -> ((SMALL N) = (FAST N)))).
Admitted.
End A302999.