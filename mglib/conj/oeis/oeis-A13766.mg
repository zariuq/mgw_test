...
(** Bounty 1 PFG TMGHjrZ91yEQrgsqv3TPdzBwwXUfEdSrtLp **)
Section A13766.
...
Hypothesis H43: (forall X :e int, ((FAST X) = (((2 * (V2 X)) * (W4 X)) * (V5 X)))).
Theorem A13766: (forall N :e int, ((0 <= N) -> ((SMALL N) = (FAST N)))).
Admitted.
End A13766.