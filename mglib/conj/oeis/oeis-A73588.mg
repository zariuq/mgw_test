...
(** Bounty 1 PFG TMLhiSBkJeWLHpQsvPCgnVvz5anGhdzwQLp **)
Section A73588.
...
Hypothesis H6: (forall X :e int, (forall Y :e int, ((F0 X Y) = ((2 * (V1 X Y)) + - 1)))).
...
Hypothesis H12: (forall X :e int, (forall Y :e int, ((F2 X Y) = ((X * Y) + - 1)))).
...
Theorem A73588: (forall N :e int, ((0 <= N) -> ((SMALL N) = (FAST N)))).
Admitted.
End A73588.