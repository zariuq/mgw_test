...
(** Bounty 1 PFG TMVNm5XKCM2HHUuLqSPf27eNqMhxRv6HbJg **)
Section A199020.
...
Hypothesis H1: (forall X :e int, (forall Y :e int, ((F1 X Y) = ((2 + Y) * (X + Y))))).
Hypothesis H2: (G1 = 2).
...
Hypothesis H20: (forall X :e int, ((FAST X) = ((2 * (W2 X)) + - 1))).
Theorem A199020: (forall N :e int, ((0 <= N) -> ((SMALL N) = (FAST N)))).
Admitted.
End A199020.