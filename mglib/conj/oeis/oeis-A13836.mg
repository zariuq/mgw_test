...
(** Bounty 1 PFG TMc441Ne5ijEadZk4ABmmxSzrgjVRdPknbQ **)
Section A13836.
...
Hypothesis H7: (forall X :e int, ((G0 X) = ((V1 X) + X))).
Hypothesis H8: (H0 = 1).
...
Hypothesis H16: (forall X :e int, ((H3 X) = (1 + X))).
Hypothesis H17: (I3 = 1).
...
Hypothesis H38: (forall X :e int, ((FAST X) = ((V2 X) * (V4 X)))).
Theorem A13836: (forall N :e int, ((0 <= N) -> ((SMALL N) = (FAST N)))).
Admitted.
End A13836.