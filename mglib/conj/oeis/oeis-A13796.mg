...
(** Bounty 1 PFG TMXU5cfXp3yQ4CvZCkgrq79F3M5rhPLC4Cr **)
Section A13796.
...
Hypothesis H38: (forall X :e int, ((FAST X) = (((V2 X) * (2 * (2 + (2 + 2)))) * (V4 X)))).
Theorem A13796: (forall N :e int, ((0 <= N) -> ((SMALL N) = (FAST N)))).
Admitted.
End A13796.