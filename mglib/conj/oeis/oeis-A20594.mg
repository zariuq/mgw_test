...
(** Bounty 1 PFG TMQ8Bm7aWYCxk4wtfYa41smKyPpCJx5jSPY **)
Section A20594.
...
Hypothesis H16: (forall X :e int, (forall Y :e int, ((F0 X Y) = ((V1 X Y) + (2 * (2 * (X + X))))))).
...
Hypothesis H40: (forall X :e int, (forall Y :e int, ((F4 X Y) = ((V5 X Y) + (2 * (X + X)))))).
...
Theorem A20594: (forall N :e int, ((0 <= N) -> ((SMALL N) = (FAST N)))).
Admitted.
End A20594.