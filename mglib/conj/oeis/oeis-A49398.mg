...
(** Bounty 1 PFG TMM8Jsv18AMq9ahgEso3LCPA9YYABn8QutN **)
Section A49398.
...
Hypothesis H1: (forall X :e int, (forall Y :e int, ((F0 X Y) = ((((2 * (2 + 2)) + Y) * X) + X)))).
...
Theorem A49398: (forall N :e int, ((0 <= N) -> ((SMALL N) = (FAST N)))).
Admitted.
End A49398.