...
(** Bounty 1 PFG TMEi2VVQ55YqDqUuTh2aaYtLEw1tER2tniM **)
Section A6675.
...
Hypothesis H7: (forall X :e int, ((G0 X) = (X + - 1))).
Hypothesis H8: (H0 = 0).
...
Hypothesis H17: (forall X :e int, (forall Y :e int, ((F2 X Y) = (((X * Y) + (V3 X Y)) + X)))).
...
Theorem A6675: (forall N :e int, ((0 <= N) -> ((SMALL N) = (FAST N)))).
Admitted.
End A6675.