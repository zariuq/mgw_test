...
(** Bounty 1 PFG TMF7qh2DfrCj6kKB4cKYCffmcK99HNBzUqJ **)
Section A218722.
...
Hypothesis H6: (forall X :e int, ((F0 X) = (1 + ((2 * (V1 X)) + X)))).
...
Hypothesis H15: (forall X :e int, ((I2 X) = (if (X <= 0) then 0 else 1))).
...
Theorem A218722: (forall N :e int, ((0 <= N) -> ((SMALL N) = (FAST N)))).
Admitted.
End A218722.