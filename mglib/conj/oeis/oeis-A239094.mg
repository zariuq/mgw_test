...
(** Bounty 1 PFG TMXjiboaTrV8U4EeSWQi3a6HEDNTz8UhdjW **)
Section A239094.
...
Hypothesis H6: (forall X :e int, (forall Y :e int, ((F1 X Y) = (((V2 X Y) * Y) + X)))).
...
Hypothesis H28: (forall X :e int, ((G3 X) = (X + - 1))).
Hypothesis H29: (H3 = 0).
...
Theorem A239094: (forall N :e int, ((0 <= N) -> ((SMALL N) = (FAST N)))).
Admitted.
End A239094.