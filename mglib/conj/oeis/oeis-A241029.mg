...
(** Bounty 1 PFG TMXDVMbfhu9HfRYwFYoM8N2U7VY6A4JScp7 **)
Section A241029.
...
Hypothesis H16: (forall X :e int, ((SMALL X) = ((1 + (V0 X)) * (1 + (V1 X))))).
...
Hypothesis H30: (forall X :e int, ((FAST X) = ((1 + (V3 X)) * (1 + (W4 X))))).
Theorem A241029: (forall N :e int, ((0 <= N) -> ((SMALL N) = (FAST N)))).
Admitted.
End A241029.